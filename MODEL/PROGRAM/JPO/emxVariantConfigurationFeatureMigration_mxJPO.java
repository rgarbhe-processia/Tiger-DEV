...
/*
 * emxVariantConfigurationFeatureMigration.java program migrates the data into Common Document model i.e. to 10.5 schema.
 *
...
public class emxVariantConfigurationFeatureMigration_mxJPO extends emxVariantConfigurationFeatureMigrationBase_mxJPO {
     ...
     * @grade 0
     */
    public emxVariantConfigurationFeatureMigration_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
