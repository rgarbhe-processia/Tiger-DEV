...
/**
 * The <code>ChangeBinaryUpgradeMigrationBase.java class contains the utilities necessary to migrate the stored binary data for Effectiviy expression to new format. It must be run on all CFF data
...
public class ChangeBinaryUpgradeMigrationBase_mxJPO extends emxCommonMigration_mxJPO {
     ...
     */
    public ChangeBinaryUpgradeMigrationBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    public void migrateObjects(Context context, StringList objectIdList) throws Exception {
        ...
        /*
         * Uncomment the code once migration checks are implemented if(migrationStatus < 2) { mqlLogRequiredInformationWriter(
         * "Migration pre-check is not complete.Please complete migration pre-check before running CFF Binary Upgrade migration. \n"); bIsException=true; return; }
         */
        try {
    ...
    public int getAdminMigrationStatus(Context context) throws Exception {
        ...
        String result = MqlUtil.mqlCommand(context, "print program $1 select $2 dump", "eServiceSystemInformation.tcl", "property[ChangeBinaryUpgradeMigration].value");
    ...
    public void setAdminMigrationStatus(Context context, String strStatus) throws Exception {
        MqlUtil.mqlCommand(context, "modify program $1 property $2 value $3", "eServiceSystemInformation.tcl", "ChangeBinaryUpgradeMigration", strStatus);
