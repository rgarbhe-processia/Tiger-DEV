...
/**
 * The <code>emxOfficeIntegrationMenus</code> class represents the JPO for obtaining the MS Office integration menus
...
public class IEFBuildFolderStructure_mxJPO {
     ...
     * @param args
     *            [0] - language of the Client machine
     * @param args
     *            [1] - Symbolic Name of the menu
     * @throws Exception
     *             if the operation fails
     */
    ...
    /**
     * Checks out a Project Space for synchronization. Generates XML string representing the Project Space.
     * @param busid
     *            String value of the BusID identifying the Project Space object
     * @throws Exception
     *             if the operation fails
     */
    ...
    /**
     * For a Menu/Command provided the program reads the HRef and obtains an inquiry or program and renders the output into a table Generates XML string representing the output.
     * @param busid
     *            String value of the BusID identifying the Project Space object
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * Generic function that the CSE calls for any clicks in the CSE This function evaluates the data sent and channels the request to appropriate function returns an xml response after traversing the
     * object
     * @param args
     *            input details as provided by the CSE
     * @throws Exception
     *             if the operation fails
     */
    ...
    public String getBasicProperties(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MCADMxUtil _util = new MCADMxUtil(context, new com.matrixone.MCADIntegration.server.MCADServerLogger(""), new com.matrixone.MCADIntegration.server.MCADServerResourceBundle(lang),
                    _GlobalCache);
            ...
            if (busId != null) {
                ...
                String attributeOrder = DomainObject.SELECT_NAME + "," + DomainObject.SELECT_TYPE + "," + DomainObject.SELECT_REVISION + "," + DomainObject.SELECT_POLICY + ","
                        + DomainObject.SELECT_VAULT + "," + DomainObject.SELECT_DESCRIPTION + "," + DomainObject.SELECT_OWNER + "," + DomainObject.SELECT_LOCKED + "," + DomainObject.SELECT_FILE_NAME
    ...
    /**
     * Generic function that the CSE uses for updating attributes of an Object returns an xml response after updating the object
     * @param args
     *            input details as provided by the CSE
     * @throws Exception
     *             if the operation fails
                                ...
                                while (itr.hasNext()) {
                                    ...
                                    if (ObjMxAttribValue instanceof StringList) {
                                        ...
                                        while (itrnew.hasNext()) {
                                            ...
                                            String attribValueTemp = generalUtil.getAttributeValueForDateTimeForJPO(context, MxAttribName, tempValueAttr, null, true, datetimepattern, locale,
                                                    timezoneoffset);
                                        ...
                                        AttributeList attList = new AttributeList();
                                        attList.addElement(att);
                                        if (minorDocument != null && !(MxAttribName.equalsIgnoreCase(attrTitle))) { // _util.setAttributeValue(context,minorDocument, MxAttribName, MxAttribValue);
                                            minorDocument.setAttributes(context, attList);
                                        }
                                        if (majorDocument != null) {
        ...
        try {
            ...
            while (attributeListItr.next()) {
                ...
                if (!notAllowedAttributes.contains(attributeName)) {
                    ...
                    if (sRangevalues == null)
                        sRangevalues = "";
                    if ("|".equals((sRangevalues.trim())))
                        sRangevalues = "";
    ...
    /**
     * list all revisons of a document Based on the parameter passed a major object or version object could be deleted
     * @param busid
     *            String value of the BusID identifying the Project Space object
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * list all versions of a document Based on the parameter passed a major object or version object could be deleted
     * @param busid
     *            String value of the BusID identifying the Project Space object
     * @throws Exception
     *             if the operation fails
    ...
    public String listDocumentVersions(Context context, String[] args) throws MatrixException {
        ...
        try {
            ...
            com.matrixone.apps.domain.DomainObject versionObject = new com.matrixone.apps.domain.DomainObject();
    ...
    /**
     * Add newly created document object to a parent object [eg. Book, Workspace Folder, Project Folder etc]
     * @param TNR
    ...
    public String addDocumentToContainer(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            com.matrixone.apps.domain.DomainObject docObject = new com.matrixone.apps.domain.DomainObject();
            ...
            if (sRelationshipName != null) {
                ...
                com.matrixone.apps.domain.DomainObject parentObject = new com.matrixone.apps.domain.DomainObject();
                parentObject.setId(parentId);
                DomainRelationship.connect(context, parentObject, actRelName, docObject);
            }
        } catch (Exception ex) {
            ContextUtil.abortTransaction(context);
             ...
             * String emxExceptionString = (ex.toString()).trim();
             * 
             * // set the error string in the Error object if ( (emxExceptionString != null) && (emxExceptionString.trim().length() > 0) ) throw new MatrixException(emxExceptionString);
             */
