...
/*
 * ${CLASSNAME}.java program migrates the data into Common Document model i.e. to 10.5 schema.
 *
...
/**
 * The <code>emxProductConfigurationMigrationBase</code> class contains the utilities necessary to migrate the Variant Configuration schema to V6R2012x. It must be run on all FTR data created prior to
 * V6R2012x.
 */
public class emxProductConfigurationMigrationBase_mxJPO extends emxCommonMigration_mxJPO {
    ...
    public final static String SELECT_CONFIGURATUION_STRUCTURE_OBJECTTYPE = "to[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.from["
            + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES + "].to.type";

    public final static String SELECT_CONFIGURATION_STRUCTURE_OBJECTID = "to[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.from["
            + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES + "].to.id";

    public final static String SELECT_CONFIGURATION_STRUCTURE_RELID = "to[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.from["
            + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES + "].id";

    public final static String SELECT_SELECTED_OPTIONS_TO_OBJECTS = "from[" + ConfigurationConstants.RELATIONSHIP_SELECTED_OPTIONS + "].to.id";

    public final static String SELECT_SELECTED_OPTIONS_RELID = "from[" + ConfigurationConstants.RELATIONSHIP_SELECTED_OPTIONS + "].id";

    public final static String SELECT_PC_FROMTYPE = "to[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.type";

    public final static String SELECT_PC_FROMID = "to[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.id";

    public final static String SELECT_FPC_FROMTYPE = "to[" + ConfigurationConstants.RELATIONSHIP_FEATURE_PRODUCT_CONFIGURATION + "].from.type";

    public final static String SELECT_FPC_FROMID = "to[" + ConfigurationConstants.RELATIONSHIP_FEATURE_PRODUCT_CONFIGURATION + "].from.id";

    public final static String SELECT_SO_TO_LF_OBJECTID = "from[" + ConfigurationConstants.RELATIONSHIP_SELECTED_OPTIONS + "].torel[" + ConfigurationConstants.RELATIONSHIP_LOGICAL_FEATURES
            + "].to.id";

    public final static String SELECT_SO_TO_LF_RELID = "from[" + ConfigurationConstants.RELATIONSHIP_SELECTED_OPTIONS + "].torel[" + ConfigurationConstants.RELATIONSHIP_LOGICAL_FEATURES + "].id";
    ...
    public final static String SELECT_SO_TOREL_ATTR_FORCEPARTREUSE = "from[" + ConfigurationConstants.RELATIONSHIP_SELECTED_OPTIONS + "].torel.attribute["
    ...
    public final static String SELECT_SO_TOREL_ATTR_CONFIGURATIONSELECTIONCRITERIA = "from[" + ConfigurationConstants.RELATIONSHIP_SELECTED_OPTIONS + "].torel.attribute["
     ...
     */
    public emxProductConfigurationMigrationBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    private void updatePCBOMXML(Context context, StringList objectIdList) throws Exception {
        try {
            ...
            while (itr.hasNext()) {
                ...
                for (int i = 0; i < sLCFIds.size(); i++) {
                    ...
                    if (sLSOCFds.contains(strCFId)) {
                        ...
                        connectObject(context, strRelType, strPCId, strConfigStructureRelId, true);
                ...
                if (mxType.isOfParentType(context, strContextType, ConfigurationConstants.TYPE_LOGICAL_FEATURE)) {
                    ...
                    while (tokens.hasMoreTokens()) {
                        ...
                        String strRel = ConfigurationConstants.RELATIONSHIP_SELECTED_OPTIONS;
                        RelationshipType strRelType = new RelationshipType(strRel);
                        connectObject(context, strRelType, strPCId, strVariesById, true);
                    }
     ...
     * @param featueDO
     *            the Feature Object
     * @param objProductConfiguration
     *            the Product Configuration Object
     * @throws Exception
     *             if the operation fails
     */
    private MapList getEvaluatedQuantityRules(Context context, DomainObject featueDO, String pcid) throws Exception {
        ...
        MapList quantityRuleObjects = featueDO.getRelatedObjects(context, ConfigurationConstants.RELATIONSHIP_QUANTITY_RULE, ConfigurationConstants.TYPE_QUANTITY_RULE, objectSelects,
                new StringList(ConfigurationConstants.SELECT_RELATIONSHIP_ID), false, true, (short) 1, "", relWhere.toString(), 0);
    ...
    /**
     * This method is for Evaluating the Part Inclusion Rules It gets the Inclusion Rule from the GBOM object and fetches the expression for it. Then it evaluates the expression to true or false.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param strObjectID
     *            - ObjectID of the GBOM object
     * @param strProductConfigurationID
     *            - ProductConfiguration ID of the ProductConfiguration for which the GBOM is generated.
     * @param errorHolder
     *            - the bean instance
     ...
     *             if the operation fails
     */
    private String evaluateIRExpression(Context context, String strGBOMRelID, String strProductConfigurationID, String strRightExpression) throws Exception {
        ...
        String strIRErrorMsg = i18nnow.GetString("emxConfigurationStringResource", strLanguage, "emxProduct.Error.InlcusionRuleFailed");
        try {
            ...
            if (!(strRightExpression == null || ("".equals(strRightExpression)) || ("null".equals(strRightExpression)))) {
                ...
                for (int k = 0; k < tempList.size(); k++) {
                    ...
                    if (b_rIDS.length() > 0 && !(b_rIDS.equals(AND) || b_rIDS.equals(OR) || b_rIDS.equals(NOT) || b_rIDS.charAt(0) == OPEN_BRACE_CHAR || b_rIDS.charAt(0) == CLOSE_BRACE_CHAR)) {
                        ...
                        if (b_rIDS.startsWith("R")) {
                            ...
                            String strObjId = (String) ((HashMap) (DomainObject.getInfo(context, new String[] { b_rIDS.substring(1) }, new StringList(ConfigurationConstants.SELECT_ID)).get(0)))
                ...
                if (domObj.exists(context)) {
                    strBuffer.append("evaluate expression \"").append(boolleanExpression).append("\" on bus ").append(strGBOMRelID);
                } else {
                    strBuffer.append("evaluate expression \"").append(boolleanExpression).append("\" on relationship ").append(strGBOMRelID);
                }
                ...
                if (bMQLResult == true) {
                    ...
                    String strEvaluateExpressionFailure = i18nnow.GetString("emxConfigurationStringResource", strLanguage, "emxProduct.Error.EvaluateExpressionFailure");
    ...
    private MapList getSelectedOptions(Context context, String objectId, StringList strLFObjIds, boolean getLF, boolean getCF) throws Exception {
        ...
        DomainObject domProductConfig = DomainObject.newInstance(context, objectId);
    ...
    private String getGBOMElementBOMXML(Context context, Map gbomElementMap, String pcID) throws Exception {
        ...
        if (ProductLineCommon.isNotNull(strPrdCtxtObjType) && mxType.isOfParentType(context, strPrdCtxtObjType, ConfigurationConstants.TYPE_PRODUCT_VARIANT)) {
        ...
        for (Iterator actDVIttr = listActiveDVs.iterator(); actDVIttr.hasNext();) {
        ...
        for (Iterator actDVIttr = partsToEvaluate.iterator(); actDVIttr.hasNext();) {
        ...
        if (partFamily.size() > 0) {
            ...
            for (int i = 0; i < partFamily.size(); i++) {
                ...
                sbXML.append("\t\t<Part " + ConfigurationConstants.SELECT_ID + "=\"").append(strPfId).append("\" " + ConfigurationConstants.SELECT_PHYSICAL_ID + "=\"").append(strPfPhyId)
                        .append("\" " + ConfigurationConstants.SELECT_TYPE + "=\"").append(strPfType).append("\" " + ConfigurationConstants.SELECT_NAME + "=\"").append(strPfName).append("\" rev=\"")
                        .append(strPfRev).append("\"/>\n");
            }
            sbXML.append("\t</PartFamily>\n");
        }
        if (strForcePartReuse.equalsIgnoreCase("Yes")) {
            if (mlPartInfo.size() > 0) {
                ...
                if (mlStdParts.size() == 1 && mlParts.size() == 1) {
                    ...
                    String strPartCommitted = "to[" + ConfigurationConstants.RELATIONSHIP_GBOM + "]." + STR_ATTRIBUTE_OPEN_BRACE + ConfigurationConstants.ATTRIBUTE_COMMITTED + EXPRESSION_CLOSE;
                    ...
                    String strPartStatus = hasEBOM ? "Resolved" : "Pending";
                    sbXML.append("\t<").append(strPartStatus).append(" " + ConfigurationConstants.SELECT_ID + "=\"").append(strPartId).append("\" " + ConfigurationConstants.SELECT_PHYSICAL_ID + "=\"")
                            .append(strPfPhyId).append("\" " + ConfigurationConstants.SELECT_TYPE + "=\"").append(strPartType).append("\" " + ConfigurationConstants.SELECT_NAME + "=\"")
                            .append(strPartName).append("\" rev=\"").append(strPartRev).append("\" " + ConfigurationConstants.PARTUSAGE + "=\"").append(strPartUsage)
                            .append("\" " + ConfigurationConstants.GBOMRELID + "=\"").append(strGBOMRelId).append("\"/>\n");
                    ...
                    if (mlStdParts.size() == 1) {
                        ...
                        strPartCommitted = (String) mapInfo.get(strPartCommitted);
                        String strPartStatus = hasEBOM ? "Resolved" : "Pending";
                        sbXML.append("\t<").append(strPartStatus).append(" " + ConfigurationConstants.SELECT_ID + "=\"").append(strPartId)
                                .append("\" " + ConfigurationConstants.SELECT_PHYSICAL_ID + "=\"").append(strPfPhyId).append("\" " + ConfigurationConstants.SELECT_TYPE + "=\"").append(strPartType)
                                .append("\" " + ConfigurationConstants.SELECT_NAME + "=\"").append(strPartName).append("\" rev=\"").append(strPartRev)
                                .append("\" " + ConfigurationConstants.PARTUSAGE + "=\"").append(strPartUsage).append("\" " + ConfigurationConstants.GBOMRELID + "=\"").append(strGBOMRelId)
                                .append("\"/>\n");
                    ...
                    for (int i = 0; i < mlParts.size(); i++) {
                        ...
                        String strPartName = (String) mapInfo.get(DomainConstants.SELECT_NAME);
                        String strPartRev = (String) mapInfo.get(DomainConstants.SELECT_REVISION);
                        sbXML.append("\t\t<Part " + ConfigurationConstants.SELECT_ID + "=\"").append(strPartId).append("\" " + ConfigurationConstants.SELECT_PHYSICAL_ID + "=\"").append(strPfPhyId)
                                .append("\" " + ConfigurationConstants.SELECT_TYPE + "=\"").append(strPartType).append("\" " + ConfigurationConstants.SELECT_NAME + "=\"").append(strPartName)
                                .append("\" rev=\"").append(strPartRev).append("\" " + ConfigurationConstants.PARTUSAGE + "=\"").append(strPartUsage)
                                .append("\" " + ConfigurationConstants.GBOMRELID + "=\"").append(strGBOMRelId).append("\"/>\n");
    ...
    private static StringList getRelSelectsForGBOM() {
        ...
        relSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.attribute[" + ConfigurationConstants.ATTRIBUTE_RULE_COMPLEXITY + "]");
        relSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.attribute[" + ConfigurationConstants.ATTRIBUTE_DESIGNVARIANTS + "]");
        ...
        relSelects.add(STR_ATTRIBUTE_OPEN_BRACE + ConfigurationConstants.ATTRIBUTE_RULE_TYPE + EXPRESSION_CLOSE);
    ...
    private HashMap getEvaluatedListsIdBased(Context context, MapList arrPartObjectIds, boolean isVariantExists, String pcID) throws Exception {
        ...
        for (int l = 0; l < arrPartObjectIds.size(); l++) {
            ...
            String strRuleExp = (String) mapProductPartId
            ...
            String strDVs = (String) mapProductPartId.get("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.attribute[" + ConfigurationConstants.ATTRIBUTE_DESIGNVARIANTS + "]");
            if (strRuleExp == null) {
                strRuleExp = "";
            }
            if (strDVs == null) {
     ...
     * @throws Exception
     */
    private ArrayList gbomParseRulesIdBased(Context context, ArrayList objectsToEvaluate, String calledFrom, boolean isVariantExists, boolean isForPart, String pcID) throws Exception {
        ...
        lstFeatureSelects.add("to[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.id");
        lstFeatureSelects.add("to[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.type");
        Map mapInfo = domPC.getInfo(context, (StringList) lstFeatureSelects);
        String strContextId = (String) mapInfo.get("to[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.id");
        String strContextType = (String) mapInfo.get("to[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.type");
        ...
        try {
            ...
            while (itrFeatures.hasNext()) {
                ...
                if (strFeatureId != null && !strFeatIdXML.contains(strFeatureId)) {
                    ...
                    String strRuleType = (String) hsFeatures.get(STR_ATTRIBUTE_OPEN_BRACE + ConfigurationConstants.ATTRIBUTE_RULE_TYPE + EXPRESSION_CLOSE);
                    String strForcePartReuse = (String) hsFeatures.get(STR_ATTRIBUTE_OPEN_BRACE + ConfigurationConstants.ATTRIBUTE_FORCE_PART_REUSE + EXPRESSION_CLOSE);
                    String strUsage = (String) hsFeatures.get(STR_ATTRIBUTE_OPEN_BRACE + ConfigurationConstants.ATTRIBUTE_USAGE + EXPRESSION_CLOSE);
                    String strQuantity = (String) hsFeatures.get(STR_ATTRIBUTE_OPEN_BRACE + ConfigurationConstants.ATTRIBUTE_QUANTITY + EXPRESSION_CLOSE);

                    strFeatIdXML.addElement(strFeatureId);

                    strFeatureName = stringDecode(context, strFeatureName);

                    sbXml.append("<Feature id=\"").append(strFeatureId).append("\" physicalid=\"").append(strFeatPhyId).append("\" type=\"").append(strObjectType).append("\" name=\"")
                            .append(strFeatureName).append("\" rev=\"").append(strFeatureRevision).append("\">\n");
    ...
    private MapList getPVLogicalStructure(Context context, String prodVarId, StringList selectedOptionRelIds) throws Exception {
        ...
        try {
            DomainObject domProdVarObj = DomainObject.newInstance(context, prodVarId);
            ...
            DomainConstants.MULTI_VALUE_LIST.clear();
            if (logicalFeatureDataMap != null && !logicalFeatureDataMap.isEmpty()) {
    ...
    private MapList getProductLogicalStructure(Context context, String productId, StringList selectedOptionRelIds) throws Exception {
        ...
        try {
            ...
            prodLogicalFeatureList = domContextBus.getRelatedObjects(context, strRelPattern, strTypePattern.toString(), slObjSelects, slRelSelects, false, true, (short) 0, DomainObject.EMPTY_STRING,
                    DomainObject.EMPTY_STRING, (short) limit, DomainObject.CHECK_HIDDEN, DomainObject.PREVENT_DUPLICATES, (short) DomainObject.PAGE_SIZE, null, null, null, DomainObject.EMPTY_STRING,
    ...
    public StringList getObjectSelects() {
        ...
        slObjSelects.addElement("to[" + ConfigurationConstants.RELATIONSHIP_LOGICAL_FEATURES + "]");

        slObjSelects.addElement("to[" + ConfigurationConstants.RELATIONSHIP_LOGICAL_FEATURES + "]" + ".tomid[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST + "].id");

        slObjSelects.addElement("to[" + ConfigurationConstants.RELATIONSHIP_LOGICAL_FEATURES + "]" + ".tomid[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST + "].attribute["
                + ConfigurationConstants.ATTRIBUTE_FEATURE_ALLOCATION_TYPE + "]");
        slObjSelects.addElement("from[" + ConfigurationConstants.RELATIONSHIP_LOGICAL_FEATURES + "].to.id");
    ...
    private StringList getRelSelects() {
        ...
        slRelSelects.addElement("attribute[" + ConfigurationConstants.ATTRIBUTE_FORCE_PART_REUSE + "]");
