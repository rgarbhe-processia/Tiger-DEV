...
public class emxAEFFullSearchUtilBase_mxJPO {
    ...
    public MapList getSavedSearches(Context context, String[] args) throws Exception {
        ...
        while (it.hasNext()) {
            ...
            String href = "javascript:window.parent.FullSearch.loadSavedSearch(" + squote(strippedName) + ", " + squote(encData) + ")";
    ...
    public HashMap getCollectionCommands(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (!"".equalsIgnoreCase(strRes) && !"null".equalsIgnoreCase(strRes)) {
                ...
                for (int i = 0; i < st.size(); i++) {
                    ...
                    if (strCollectName.equalsIgnoreCase(strSystemGeneratedCollection)) {
                        ...
                        clipBoardMap.put("href", "javascript:window.parent.searchWithinCollection('" + strSystemGeneratedCollection + "')");
            ...
            for (int i = 0; i < collectList.size(); i++) {
                ...
                sCollectionName = XSSUtil.encodeForURL(context, sCollectionName);
                childrenMap.put("href", "javascript:window.parent.searchWithinCollection('" + sCollectionName + "')");
