...
public class emxSortPersonFullNameBase_mxJPO extends emxCommonBaseComparator_mxJPO {
     ...
     * @throws Exception
     */
    public emxSortPersonFullNameBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    public int compare(Object object1, Object object2) {
        ...
        try {
            diff = str1Empty && str2Empty ? 0 : str1Empty ? -1 : str2Empty ? 1 : PersonUtil.getFullName(context, stringValue1).compareToIgnoreCase(PersonUtil.getFullName(context, stringValue2));
