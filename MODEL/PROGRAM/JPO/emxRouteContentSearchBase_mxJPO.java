...
public class emxRouteContentSearchBase_mxJPO {
    ...
    public MapList getContents(Context context, String args[]) throws Exception {
        ...
        if (stype.equals(DomainConstants.TYPE_INBOX_TASK)) {
            strObjectId = (String) mp.get("relationship[Route Task].to.id");
        }
        ...
        if ("Organization".equals(restrictMembers)) {
            ...
            searchResults = DomainObject.findObjects(context, // eMatrix context
            ...
            String sTypeName = (String) infoMap.get(DomainObject.SELECT_TYPE);
            ...
            if (isProjectSpaceOrConcept) {
                ...
                String symbolicType = FrameworkUtil.getAliasForAdmin(context, "type", typePattern.getPattern(), true);

                // Append name condition
                if (!"*".equals(txtName)) {
                    if (UIUtil.isNotNullAndNotEmpty(sWhereExp)) {
                        sWhereExp += " && ";
                    }
                ...
                if (contentTypes.contains(symbolicType)) {
                    ...
                    // Get all the folders under Project Space/Concept recursively
                    MapList mlFolderList = domainObject.getRelatedObjects(context, DomainObject.RELATIONSHIP_WORKSPACE_VAULTS + "," + DomainObject.RELATIONSHIP_SUB_VAULTS,
                            DomainObject.TYPE_WORKSPACE_VAULT, objectSelects, null, false, true, (short) 0, null, null, 0);
                    ...
                    if ((sWorkspaceFolderId != null) && (!sWorkspaceFolderId.equals(""))) {
                        ...
                        while (folderListSt.hasMoreTokens()) {
                            ...
                            MapList searchResultsForFolder = domainObject.getRelatedObjects(context, relPattern.getPattern(), typePattern.getPattern(), resultSelects, null, false, true, (short) 0,
                                    sWhereExp, null, 0);
                    ...
                    searchResults = domainObject.getRelatedObjects(context, "*", typePattern.getPattern(), resultSelects, null, false, true, (short) 0, sWhereExp, null, Integer.parseInt(queryLimit),
                            null, null, null);
                }
            } else {
                if (bIsTypeWorkspace == true || bIsTypeWorkspaceVault == true) {
                    if (bIsTypeWorkspace == true) {
                        StringList objectSelects = new StringList(DomainObject.SELECT_ID);
                        // Get all the folders under Project Space/Workspace recursively
                        MapList mlFolderList = domainObject.getRelatedObjects(context, DomainObject.RELATIONSHIP_WORKSPACE_VAULTS + "," + DomainObject.RELATIONSHIP_SUB_VAULTS,
                                DomainObject.TYPE_WORKSPACE_VAULT, objectSelects, null, false, true, (short) 0, null, null);
    ...
    public StringList getAllWorkspaceContents(Context context, String folderId) throws Exception {
        ...
        MapList searchResultsForFolder = folderObj.getRelatedObjects(context, relPattern.getPattern(), "*", resultSelects, null, false, true, (short) 0, sWhereExp, null, (short) 0, null, null, null);
        for (int i = 0; i < searchResultsForFolder.size(); i++) {
