...
public class IEFCreateObjectUsingTemplate_mxJPO {
     ...
     * the JPO name of which is got from IEF-StartDesignJPO attribute on the template object). If the template object is of assembly type, structure below this template object is traversed and design
     ...
     * @param context
     * @param args
     *            args[0] & args[1] = packed Global Config Object args[2] = locale language name args[3] = Template object ID args[4] = Type of the design object to be created args[5] = Name of the
     *            design object to be created. If AutoName is selected, it should be a blank string args[6] = Revision of the design object to be created args[7] = Policy for the design object to be
     *            created args[8] = "true" if AutoName is selected; "false" otherwise args[9] = autoname series args[10] = "true" if the selected template object is a component or the topmost
     *            assembly; "false" otherwise args[11] & args[12] = packed HashMap containing actual attribute names as key and values as value args[14] = parentType to which the major object will be
     *            connected args[15] = parentName to which the major object will be connected args[16] = parentRev to which the major object will be connected args[17] = cadType
     * @return
     * @throws Exception
     */
    public String createDesignObject(Context context, String[] args) throws MCADException {
        ...
        try {
            ...
            /*
             * String[] packedAttrNameValMap = new String[2]; packedAttrNameValMap[0] = args[11]; packedAttrNameValMap[1] = args[12];
             */
            ...
            /*
             * String[] packedAttrNameValMap = new String[2]; packedAttrNameValMap[0] = args[11]; packedAttrNameValMap[1] = args[12]; String parentType = args[14]; String parentName = args[15]; String
             * parentRev = args[16]; String cadType = args[17]; String relationship = args[18];
             */
            ...
            // object = objIEFCDMSupport.iefCreateAndConnect(context, designObjType, designObjName, designObjRevision, designObjPolicy, "", vaultName, strTitle, null, docHolder, relationship, null,
            // (Map)attrNameValMap, cmmObject, languageName);
            ...
            if ((parentType != null && "collections".equalsIgnoreCase(parentType)) && (parentRev == null || "null".equalsIgnoreCase(parentRev) || "".equalsIgnoreCase(parentRev))) {
