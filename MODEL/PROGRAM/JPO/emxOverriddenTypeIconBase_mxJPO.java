...
public class emxOverriddenTypeIconBase_mxJPO {
     ...
     * @return MapList
     * @throws Exception
     * @Description This method can be customized based upon the user requirement. But it should return the MapList with Size same as ObjectList. For ObjectList key is objectId and value will be image
     *              Name For Alternate Objects Maplist will contain HashMaps where object id as a key and alternate object Map(HashMap) as Value. This alternate object map again contains alternate
     *              object ids corresponding to current object id and image name as value.
     */
    ...
    /*
     * User Need to write logic to return the icon name Which is present in common/images directory Below sample code is based on state of object i.e. User can return a image w.r.t to objectid based
     * upon the state of object. User can change the signature of this method but it should return string(image Name)
     */
