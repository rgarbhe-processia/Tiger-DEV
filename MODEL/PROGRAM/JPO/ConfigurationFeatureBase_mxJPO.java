 ...
 ** ${CLASSNAME}
 **
 ** Copyright (c) 1993-2015 Dassault Systemes. This program contains proprietary and trade secret information of Dassault Systemes. Copyright notice is precautionary only and does not evidence any
...
public class ConfigurationFeatureBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    protected static final String RELATIONSHIP_APPLICABLE_ITEM = PropertyUtil.getSchemaProperty("relationship_ApplicableItem");
     ...
     * @since R210
     */
    public ConfigurationFeatureBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public MapList getConfigurationFeatureStructure(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            slRelSelects.addElement("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.attribute[" + ConfigurationConstants.ATTRIBUTE_RULE_COMPLEXITY + "]");
            slRelSelects.addElement("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.attribute[" + ConfigurationConstants.ATTRIBUTE_LEFT_EXPRESSION + "]");
            slRelSelects.addElement("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.attribute[" + ConfigurationConstants.ATTRIBUTE_RIGHT_EXPRESSION + "]");
            slRelSelects.addElement("attribute[" + ConfigurationConstants.ATTRIBUTE_CONFIGURATION_SELECTION_CRITERIA + "]");

            mapConfigurationStructure = (MapList) cfBean.getConfigurationFeatureStructure(context, strTypePattern, strRelPattern, slObjSelects, slRelSelects, false, true, iLevel, limit,
                    strObjWhere.toString(), DomainObject.EMPTY_STRING, DomainObject.FILTER_STR_AND_ITEM, filterExpression);
    ...
    /**
     * This Methods is used to get the top level Configuration Features. This is used while launching the Configuration Features from My Desk
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getTopLevelConfigurationFeatures(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            strWhere.append(" || ");
            strWhere.append("(to[" + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_FEATURES + "].from.type.kindof[" + ConfigurationConstants.TYPE_CONFIGURATION_FEATURE + "]!=TRUE)");
            ...
            mapTop = DomainObject.findObjects(context, ConfigurationConstants.TYPE_CONFIGURATION_FEATURE, "*", "*", "*", "*", strWhere.toString(), queryName, true,
    ...
    /**
     * This Methods is used to get the top level Configuration Features owned by user. This is used while launching the Configuration Features from My Desk
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getTopLevelOwnedConfigurationFeatures(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            mapTop = DomainObject.findObjects(context, ConfigurationConstants.TYPE_CONFIGURATION_FEATURE, "*", "*", context.getUser(), "*", strWhere.toString(), queryName, true,
                    ConfigurationUtil.getBasicObjectSelects(context), (short) limit);
    ...
    /**
     * This Method is used to get the range HREF for second ProductLine in Structure Compare
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    /**
     * This Method is used to get the range HREF for second Product Variant in Structure Compare
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments Object Id Field Name
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments Feature Type Match Based On
    ...
    public Object getMatchBasedOnCriteria(Context context, String[] args) throws Exception {
        ...
        if (!"".equals(strMatchBasedOn) && !"null".equals(strMatchBasedOn) && strMatchBasedOn != null) {
            strvalues = strMatchBasedOn.split(",");
        }
        if (strFeatureType.equalsIgnoreCase("ConfigurationFeature")) {
            columns = uiTable.getColumns(context, PropertyUtil.getSchemaProperty(context, "table_FTRConfigurationFeaturesStructureCompareTable"), null);
        } else if (strFeatureType.equalsIgnoreCase("LogicalFeature") || strFeatureType.equalsIgnoreCase("BOMCompare") || strFeatureType.equalsIgnoreCase("PVLogicalFeature")
                || strFeatureType.equalsIgnoreCase("PVBOMCompare") || strFeatureType.equalsIgnoreCase("ManufacturingFeature")) {
            columns = uiTable.getColumns(context, PropertyUtil.getSchemaProperty(context, "table_FTRLogicalFeaturesStructureCompareTable"), null);
        }
        ...
        if (MapListSize > 0) {
            ...
            for (int i = 0; i < MapListSize; i++) {
                ...
                String sSelected = "";
                if (sStrResourceValue != null && sStrResourceValue.equalsIgnoreCase(sStrNameLabel) && strvalues == null) {
                    sSelected = "checked=\"true\"";
                }
                if (strvalues != null) {
                    for (int j = 0; j < strvalues.length; j++) {
                        if (strvalues[j] != null || "".equals(strvalues[j]) || "null".equals(strvalues[j])) {
                ...
                if ("true".equalsIgnoreCase(strMBO)) {
                    ...
                    strBuf.append("<input type=\"checkbox\" " + sSelected + "  id=\"MatchBasedOn\" name=\"MatchBasedOn\" value=\"" + XSSUtil.encodeForHTMLAttribute(context, sStrResourceActualValue)
                            + "\" onclick=\"checkMatchBasedOnAndDisableCheckBoxForCompareBy(" + strValueIndex + ");\"  />" + XSSUtil.encodeForXML(context, sStrResourceValue));
                    strBuf.append("<input type=\"hidden\" id=\"MatchBasedOnActual\" name=\"MatchBasedOnActual\" value=\"" + XSSUtil.encodeForHTMLAttribute(context, sStrResourceActualValue) + "\" />");
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments Feature Type compare By
    ...
    public Object getCompareByCriteria(Context context, String[] args) throws Exception {
        ...
        if (!"".equals(strCompareBy) && !"null".equals(strCompareBy) && strCompareBy != null) {
        ...
        int MapListSize = columns.size();
        if (MapListSize > 0) {
            String sStrDefaults = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.StructureCompare.ReportDifferencesDefault", strLanguage);
            String sStrNameLabel = (EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxFramework.Basic.Name", strLanguage)).trim();
            String sStrResourceActualValue = null;
            ...
            for (int i = 0; i < MapListSize; i++) {
                ...
                if (null != strFieldName && !"".equals(strFieldName) && !"null".equals(strFieldName)) {
                    // Obtaining Value from String Resource File
                    sStrResourceValue = EnoviaResourceBundle.getProperty(context, SUITE_KEY, strFieldName, strLanguage);
                    sStrResourceActualValue = EnoviaResourceBundle.getProperty(context, SUITE_KEY, new Locale("en-us"), strFieldName);
                    String sSelected = "";
                    StringTokenizer strToken = new StringTokenizer(sStrDefaults, ",");
                    while (strToken.hasMoreTokens()) {
                        strToken.nextToken();
                        if (sStrResourceValue != null && sStrResourceValue.equals(sStrNameLabel)) {
                            sSelected = "disabled";
                        }
                    }
                    if (strvalues != null) {
                    ...
                    if (strComparable != null && "true".equalsIgnoreCase(strComparable)) {

                        // Adding the HTML code with obtained values
                        strBuf.append("<input id=\"CompareBy\" type=\"checkbox\" " + sSelected + " onclick=\"disableCheckBoxForMatchBasedOn();\"  name=\"CompareBy\" value=\""
                                + XSSUtil.encodeForHTMLAttribute(context, sStrResourceValue) + "\"  />" + XSSUtil.encodeForXML(context, sStrResourceValue));
                        strBuf.append("<input id=\"CompareByActual\" type=\"hidden\" name=\"CompareByActual\" value=\"" + XSSUtil.encodeForHTMLAttribute(context, sStrResourceActualValue) + "\"  />");
                        strBuf.append("</td></tr><tr><td>");
                    }
                }
            }
            ...
            strBuf.append("disableCheckBoxForMatchBasedOn();disableCheckBoxForCompareBy();");
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments Expand Level
     * @return expandLevels
     * @throws Exception
     *             if the operation fails. Since Feature Configuration X3
     * @author KXB
     * @since FTR R212
     */
    public Object getExpandLevel(Context context, String[] args) throws Exception {
        ...
        String strLanguage = context.getSession().getLanguage();
        String sOne = EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.FreezePane.1", strLanguage);
        String sTwo = EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.FreezePane.2", strLanguage);
        String sThree = EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.FreezePane.3", strLanguage);
        String sFour = EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.FreezePane.4", strLanguage);
        String sFive = EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.FreezePane.5", strLanguage);
        String sAll = EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.FreezePane.All", strLanguage);
        // the Expand level drop down
        strBuf.append("<table><tr><td>");
        strBuf.append("<SELECT name=\"ExpandLevel\">");
        if ("1".equals(strExpandLevel))
            strBuf.append("<OPTION value=\"1\" SELECTED>" + XSSUtil.encodeForXML(context, sOne) + "</OPTION><OPTION value=\"2\">" + XSSUtil.encodeForXML(context, sTwo) + "<OPTION value=\"3\">"
                    + XSSUtil.encodeForXML(context, sThree) + "<OPTION value=\"4\">" + XSSUtil.encodeForXML(context, sFour) + "<OPTION value=\"5\">" + XSSUtil.encodeForXML(context, sFive)
                    + "<OPTION value=\"All\">" + XSSUtil.encodeForXML(context, sAll) + "</SELECT>");
        else if ("2".equals(strExpandLevel))
            strBuf.append("<OPTION value=\"1\">" + XSSUtil.encodeForXML(context, sOne) + "</OPTION><OPTION value=\"2\" SELECTED>" + XSSUtil.encodeForXML(context, sTwo) + "<OPTION value=\"3\">"
                    + XSSUtil.encodeForXML(context, sThree) + "<OPTION value=\"4\">" + XSSUtil.encodeForXML(context, sFour) + "<OPTION value=\"5\">" + XSSUtil.encodeForXML(context, sFive)
                    + "<OPTION value=\"All\">" + XSSUtil.encodeForXML(context, sAll) + "</SELECT>");
        else if ("3".equals(strExpandLevel))
            strBuf.append("<OPTION value=\"1\">" + XSSUtil.encodeForXML(context, sOne) + "</OPTION><OPTION value=\"2\">" + XSSUtil.encodeForXML(context, sTwo) + "<OPTION value=\"3\" SELECTED>"
                    + XSSUtil.encodeForXML(context, sThree) + "<OPTION value=\"4\">" + XSSUtil.encodeForXML(context, sFour) + "<OPTION value=\"5\">" + XSSUtil.encodeForXML(context, sFive)
                    + "<OPTION value=\"All\">" + XSSUtil.encodeForXML(context, sAll) + "</SELECT>");
        else if ("4".equals(strExpandLevel))
            strBuf.append("<OPTION value=\"1\">" + XSSUtil.encodeForXML(context, sOne) + "</OPTION><OPTION value=\"2\">" + XSSUtil.encodeForXML(context, sTwo) + "<OPTION value=\"3\">"
                    + XSSUtil.encodeForXML(context, sThree) + "<OPTION value=\"4\" SELECTED>" + XSSUtil.encodeForXML(context, sFour) + "<OPTION value=\"5\">" + XSSUtil.encodeForXML(context, sFive)
                    + "<OPTION value=\"All\">" + XSSUtil.encodeForXML(context, sAll) + "</SELECT>");
        else if ("5".equals(strExpandLevel))
            strBuf.append("<OPTION value=\"1\">" + XSSUtil.encodeForXML(context, sOne) + "</OPTION><OPTION value=\"2\">" + XSSUtil.encodeForXML(context, sTwo) + "<OPTION value=\"3\">"
                    + XSSUtil.encodeForXML(context, sThree) + "<OPTION value=\"4\">" + XSSUtil.encodeForXML(context, sFour) + "<OPTION value=\"5\" SELECTED>" + XSSUtil.encodeForXML(context, sFive)
                    + "<OPTION value=\"All\">" + XSSUtil.encodeForXML(context, sAll) + "</SELECT>");
        else if ("All".equals(strExpandLevel))
            strBuf.append("<OPTION value=\"1\">" + XSSUtil.encodeForXML(context, sOne) + "</OPTION><OPTION value=\"2\">" + XSSUtil.encodeForXML(context, sTwo) + "<OPTION value=\"3\">"
                    + XSSUtil.encodeForXML(context, sThree) + "<OPTION value=\"4\">" + XSSUtil.encodeForXML(context, sFour) + "<OPTION value=\"5\">" + XSSUtil.encodeForXML(context, sFive)
                    + "<OPTION value=\"All\" SELECTED>" + XSSUtil.encodeForXML(context, sAll) + "</SELECT>");
        else
            strBuf.append("<OPTION value=\"1\">" + XSSUtil.encodeForXML(context, sOne) + "</OPTION><OPTION value=\"2\">" + XSSUtil.encodeForXML(context, sTwo) + "<OPTION value=\"3\">"
                    + XSSUtil.encodeForXML(context, sThree) + "<OPTION value=\"4\">" + XSSUtil.encodeForXML(context, sFour) + "<OPTION value=\"5\">" + XSSUtil.encodeForXML(context, sFive)
                    + "<OPTION value=\"All\">" + XSSUtil.encodeForXML(context, sAll) + "</SELECT>");
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments Format
    ...
    public Object getFormats(Context context, String[] args) throws Exception {
        ...
        if ("Difference_Only_Report".equals(strFormat)) {
            String sCompleteSummary = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.StructureCompare.CompleteSummary", strLanguage);
            strBuf.append("<input type=\"radio\"  id=\"Format\"  name=\"Format\" value=\"Complete_Summary_Report\" />" + XSSUtil.encodeForXML(context, sCompleteSummary));
            strBuf.append("</td></tr><tr><td>");

            String sDiffOnlySummary = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.StructureCompare.DiffOnlySummary", strLanguage);
            strBuf.append("<input type=\"radio\" id=\"Format\"  name=\"Format\" value=\"Difference_Only_Report\" checked=\"true\" />" + XSSUtil.encodeForXML(context, sDiffOnlySummary));
            strBuf.append("</td></tr><tr><td>");

            String sObj1Unique = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.StructureCompare.Obj1Unique", strLanguage);
            strBuf.append("<input type=\"radio\"  id=\"Format\" name=\"Format\" value=\"Unique_toLeft_Report\" />" + XSSUtil.encodeForXML(context, sObj1Unique));
            strBuf.append("</td></tr><tr><td>");

            String sObj2Unique = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.StructureCompare.Obj2Unique", strLanguage);
            strBuf.append("<input type=\"radio\" id=\"Format\"  name=\"Format\" value=\"Unique_toRight_Report\" />" + XSSUtil.encodeForXML(context, sObj2Unique));
            strBuf.append("</td></tr><tr><td>");

            String sCommonComponents = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.StructureCompare.CommonComponents", strLanguage);
            strBuf.append("<input type=\"radio\" id=\"Format\" name=\"Format\" value=\"Common_Report\" />" + XSSUtil.encodeForXML(context, sCommonComponents));
            ...
            String sDiffOnlySummary = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.StructureCompare.DiffOnlySummary", strLanguage);
            strBuf.append("<input type=\"radio\" id=\"Format\"  name=\"Format\" value=\"Difference_Only_Report\" />" + XSSUtil.encodeForXML(context, sDiffOnlySummary));
            strBuf.append("</td></tr><tr><td>");

            String sObj1Unique = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.StructureCompare.Obj1Unique", strLanguage);
            strBuf.append("<input type=\"radio\"  id=\"Format\" name=\"Format\" value=\"Unique_toLeft_Report\" checked=\"true\" />" + XSSUtil.encodeForXML(context, sObj1Unique));
            strBuf.append("</td></tr><tr><td>");
            ...
            String sObj2Unique = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.StructureCompare.Obj2Unique", strLanguage);
            strBuf.append("<input type=\"radio\" id=\"Format\"  name=\"Format\" value=\"Unique_toRight_Report\" checked=\"true\" />" + XSSUtil.encodeForXML(context, sObj2Unique));
            strBuf.append("</td></tr><tr><td>");
            ...
            String sCommonComponents = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.StructureCompare.CommonComponents", strLanguage);
            strBuf.append("<input type=\"radio\" id=\"Format\" name=\"Format\" value=\"Common_Report\" checked=\"true\" />" + XSSUtil.encodeForXML(context, sCommonComponents));
        } else {
            String sCompleteSummary = EnoviaResourceBundle.getProperty(context, strSuiteKey, "emxConfiguration.StructureCompare.CompleteSummary", strLanguage);
            strBuf.append("<input type=\"radio\"  id=\"Format\"  name=\"Format\" value=\"Complete_Summary_Report\" checked=\"true\" />" + XSSUtil.encodeForXML(context, sCompleteSummary));
            strBuf.append("</td></tr><tr><td>");

            String sDiffOnlySummary = EnoviaResourceBundle.getProperty(context, strSuiteKey, "emxConfiguration.StructureCompare.DiffOnlySummary", strLanguage);
            strBuf.append("<input type=\"radio\" id=\"Format\"  name=\"Format\" value=\"Difference_Only_Report\" />" + XSSUtil.encodeForXML(context, sDiffOnlySummary));
            strBuf.append("</td></tr><tr><td>");

            String sObj1Unique = EnoviaResourceBundle.getProperty(context, strSuiteKey, "emxConfiguration.StructureCompare.Obj1Unique", strLanguage);
            strBuf.append("<input type=\"radio\"  id=\"Format\" name=\"Format\" value=\"Unique_toLeft_Report\" />" + XSSUtil.encodeForXML(context, sObj1Unique));
            strBuf.append("</td></tr><tr><td>");

            String sObj2Unique = EnoviaResourceBundle.getProperty(context, strSuiteKey, "emxConfiguration.StructureCompare.Obj2Unique", strLanguage);
            strBuf.append("<input type=\"radio\" id=\"Format\"  name=\"Format\" value=\"Unique_toRight_Report\" />" + XSSUtil.encodeForXML(context, sObj2Unique));
            strBuf.append("</td></tr><tr><td>");

            String sCommonComponents = EnoviaResourceBundle.getProperty(context, strSuiteKey, "emxConfiguration.StructureCompare.CommonComponents", strLanguage);
            strBuf.append("<input type=\"radio\" id=\"Format\" name=\"Format\" value=\"Common_Report\" />" + XSSUtil.encodeForXML(context, sCommonComponents));
        }
     ...
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments Object ID
    ...
    public StringList includeContextProducts(Context context, String[] args) throws Exception {
        ...
        MapList relBusObjPageList = prodObj.getRelatedObjects(context, strRelName, strTypeName, objectSelects, relSelects, true, false, sLevel, "", "", 0);
        ...
        mapProductObjsList = modelObj.getRelatedObjects(context, stbRelPattern.toString(), stbTypePattern.toString(), selectStmts, relSelects, false, true, (short) 1, stbObjWhere.toString(), null,
                (short) limit);
    ...
    public StringList includeContextProductVariants(Context context, String[] args) throws Exception {
        ...
        stbTypePattern = stbTypePattern.append(ConfigurationConstants.TYPE_PRODUCTS);
        StringBuffer stbObjWhere = new StringBuffer(50);
        mapProductVariantsObjsList = prodObj.getRelatedObjects(context, stbRelPattern.toString(), stbTypePattern.toString(), selectStmts, relSelects, false, true, (short) 1, stbObjWhere.toString(),
                null, (short) limit);
     ...
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments Object List
    ...
    public StringList getOwningParent(Context context, String[] args) throws Exception {
        ...
        for (int j = 0; j < lstObjectIdsList.size(); j++) {
            ...
            if (tempMap.get("Root Node") != null && !tempMap.get("Root Node").toString().equals("") && tempMap.get("Root Node").toString().equalsIgnoreCase("true")) {
        ...
        if (lstPar.size() > 0) {
            mapList = DomainObject.getInfo(context, (String[]) lstPar.toArray(oidsArray), ConfigurationUtil.getBasicObjectSelects(context));
        }
    ...
    /**
     * This program used to render value in Table FTRProductContextGBOMDesignChoicesTable-- Feature selection Table in used while changing DV
     * @param context
     * @param args
     * @return
     * @throws Exception
     * @since FTR R211 TODO- Need to revisit for Common Group
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getRangeValuesForDesignVariant(Context context, String[] args) throws Exception {
        MapList limitedMapList = new MapList();
        MapList mapResult = new MapList();
        int limit = 0;
        boolean isGlobalCG = false;
        MapList mapBusIds = new MapList();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            String strDesignVariantId = (String) programMap.get("designVariantID");
            String strRelId = (String) programMap.get("strVarBId");
            String strContextProdId = (String) programMap.get("strContextProdObjId");
            String strFeatureId = (String) programMap.get("strFeatureObjId");
            String strNameValue = (String) programMap.get("FTRGBOMDVNameCustomFilterCommand");
            String strLimitValue = (String) programMap.get("FTRGBOMDVLimitCustomFilterCommand");

            String strMaxQueryLimit = EnoviaResourceBundle.getProperty(context, "emxConfiguration.MaxQueryLimit");
            int mxLimit = Integer.parseInt(strMaxQueryLimit);

            if (strLimitValue != null && !"".equalsIgnoreCase(strLimitValue) && !strLimitValue.equalsIgnoreCase("*")) {
                limit = (short) Integer.parseInt(strLimitValue);
                if (limit < 0) {
                    limit = mxLimit;
                }
            }
            String strMrktingChoiceValue = (String) programMap.get("FTRGBOMDVChoicesCustomFilterCommand");
            if (strMrktingChoiceValue == null) {
                strMrktingChoiceValue = ConfigurationConstants.RELATIONSHIP_COMMON_GROUP;
            }
            // String isOnLoad = (String) programMap.get("isOnLoad");

            CommonValues commonValuesBean = new CommonValues();
            MapList commonGroupList = null;
            commonGroupList = commonValuesBean.getCommonGroups(context, strFeatureId, strDesignVariantId);
            String strGlobalCG = commonValuesBean.getGlobalCommonGroupAttributeValue(context, strRelId);

            if ((strNameValue != null && !"".equalsIgnoreCase(strNameValue))) {// || "true".equalsIgnoreCase(isOnLoad)){

                if ("ConfigurationOption".equals(strMrktingChoiceValue)) {// && ("false".equalsIgnoreCase(isOnLoad))) {

                    // retrieving all the immediate subfeatures for Design Variant
                    String strObjPattern = "";
                    String strRelPattern = "";
                    StringList objSelects = null;
                    StringList relSelects = null;
                    short sRecurse = 1;

                    strRelPattern = ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES;
                    strObjPattern = ConfigurationConstants.TYPE_CONFIGURATION_FEATURES;

                    objSelects = new StringList();
                    objSelects.addElement(DomainObject.SELECT_POLICY);
                    objSelects.addElement(DomainObject.SELECT_CURRENT);
                    objSelects.addElement("attribute[" + ConfigurationConstants.ATTRIBUTE_DISPLAY_NAME + "]");

                    relSelects = new StringList();

                    // Creating Where clause for name
                    StringBuffer sbWhere = new StringBuffer();
                    String strWhere = "";

                    if (!"*".equalsIgnoreCase(strNameValue)) {
                        sbWhere.append("attribute[");
                        sbWhere.append(ConfigurationConstants.ATTRIBUTE_DISPLAY_NAME);
                        sbWhere.append("] ~~ '");
                        sbWhere.append(strNameValue);
                        sbWhere.append("'");
                        strWhere = sbWhere.toString();
                    }
                    // CFF Filter expression
                    String filterExpression = (String) programMap.get("CFFExpressionFilterInput_OID");

                    // Use getObjectStructure() API to retrieve all 1 level childs
                    ConfigurationUtil confUtil = new ConfigurationUtil(strDesignVariantId);
                    mapBusIds = confUtil.getObjectStructure(context, strObjPattern, strRelPattern, objSelects, relSelects, false, true, sRecurse, 0, strWhere, DomainConstants.EMPTY_STRING,
                            DomainObject.FILTER_STR_AND_ITEM, filterExpression);
                    // ------------------------------------------------------
                    // updating the MapList retrieved
                    Map htTempTable = null;
                    Map tempMap = null;
                    // ------------------------------------------------------
                    // Modified the design to filter out the
                    // DV options with Common Group
                    // ------------------------------------------------------
                    Map commonGroupsMap = null;
                    String curentRelID = "";
                    for (int i = 0; i < mapBusIds.size(); i++) {
                        htTempTable = (Hashtable) mapBusIds.get(i);
                        curentRelID = (String) htTempTable.get(DomainRelationship.SELECT_ID);
                        boolean check = false;
                        for (int cnt = 0; cnt < commonGroupList.size(); cnt++) {
                            commonGroupsMap = (Map) commonGroupList.get(cnt);
                            StringList confOptionsRels = (StringList) commonGroupsMap.get("Config Options RelIds");
                            String strGlobalCG_Current = (String) commonGroupsMap.get("Global Common Group");
                            String prdId = (String) (commonGroupsMap.get("Context Prod Id"));
                            for (int j = 0; j < confOptionsRels.size(); j++) {
                                String confOptionInCG = (String) confOptionsRels.get(j);
                                if (strGlobalCG_Current != null && strGlobalCG_Current.equalsIgnoreCase("Yes") && curentRelID.equalsIgnoreCase(confOptionInCG) || strGlobalCG_Current != null
                                        && strGlobalCG_Current.equalsIgnoreCase("No") && curentRelID.equalsIgnoreCase(confOptionInCG) && prdId.equalsIgnoreCase(strContextProdId)) {
                                    mapBusIds.remove(i--);
                                    check = true;
                                    break;
                                }
                    ...
                    // iterate and create Map of required value,this is done to add custom blank row
                    for (int finalcount = 0; finalcount < mapBusIds.size(); finalcount++) {
                        tempMap = new Hashtable();
                        htTempTable = (Hashtable) mapBusIds.get(finalcount);
                        String state = htTempTable.get(ConfigurationConstants.SELECT_CURRENT).toString();
                        String policy = htTempTable.get(ConfigurationConstants.SELECT_POLICY).toString();
                        policy = policy.trim().replace(" ", "_");
                        state = state.trim().replace(" ", "_");

                        tempMap.put(DomainConstants.SELECT_ID, (String) htTempTable.get(DomainObject.SELECT_ID));
                        tempMap.put(DomainConstants.SELECT_RELATIONSHIP_ID, (String) htTempTable.get(DomainRelationship.SELECT_ID));
                        tempMap.put(DomainObject.SELECT_NAME, (String) htTempTable.get(DomainObject.SELECT_NAME));
                        tempMap.put(DomainObject.SELECT_CURRENT, policy + "." + state);
                        tempMap.put(DomainObject.SELECT_TYPE, (String) htTempTable.get(DomainObject.SELECT_TYPE));

                        tempMap.put("attribute[" + ConfigurationConstants.ATTRIBUTE_DISPLAY_NAME + "]", (String) htTempTable.get("attribute[" + ConfigurationConstants.ATTRIBUTE_DISPLAY_NAME + "]"));
                        tempMap.put(DomainObject.SELECT_REVISION, (String) htTempTable.get(DomainObject.SELECT_REVISION));
                        tempMap.put(DomainObject.SELECT_LEVEL, (String) htTempTable.get("level"));
                        tempMap.put("relationship", (String) htTempTable.get("relationship"));
                        mapResult.add(tempMap);
                    }
                } else if ("Common Groups".equals(strMrktingChoiceValue)) {// || "true".equalsIgnoreCase(isOnLoad)){
                    // TODO Done---------------COMMON GROUP
                    if (commonGroupList != null || commonGroupList.size() != 0) {
                        if (strGlobalCG.equalsIgnoreCase("No")) {
                            ...
                            while (it.hasNext()) {
                                ...
                                String prdId = (String) (idMap.get("Context Prod Id"));
                                if (!prdId.equalsIgnoreCase(strContextProdId)) {
                                    it.remove();
                                }
                            }
                        }
                    ...
                    if ((!isGlobalCG) || (strContextProdId != null)) {
                        mapResult.addAll(getFilteredCGList(commonGroupList, strNameValue, 0));
                    }
                }
            }
            if (limit == 0) {
                limitedMapList = mapResult;
            } else {
                if (mapResult.size() > limit) {
                    for (int i = 0; i < limit; i++) {
                        limitedMapList.add(mapResult.get(i));
                    }
            ...
            // adding for the blank row, if final mapResult is not null/empty
            if (limitedMapList != null && !limitedMapList.isEmpty()) {
                Map hm = new Hashtable();
                hm.put("Blank", "-");
                hm.put("level", "1");
                limitedMapList.add(hm);
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        return limitedMapList;
    }

    /**
     * This method is used to return the value of Mandatory column, which depends upon the relationship with which feature is connected to with the context
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds arguments
     ...
     * @author A69
     */
    public List getMandatoryValue(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            for (int j = 0; j < lstObjectIdsList.size(); j++) {
                ...
                if (strRelationship == null || strRelationship.trim().isEmpty()) {
                    if (tempMap.containsKey(DomainRelationship.SELECT_ID) && ProductLineCommon.isNotNull((String) tempMap.get(DomainRelationship.SELECT_ID))) {
                        String strRelID = (String) tempMap.get(DomainRelationship.SELECT_ID);
                ...
                if (strRelationship == null || "null".equals(strRelationship)) {
     ...
     * @param args
     *            holds arguments
     * @return mapConfigurationStructure- MapList Containing the Maps of Configuration Features. Each Map will consist of: id= Configuration Feature ID, type = Configuration Feature or Sub-types of
     *         Configuration Features name = name of Configuration feature revision = revision of Configuration feature name[connection]= name of the relationship id[connection] = relationship id
     * @throws FrameworkException
     * @author A69
     * @since R212
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getCandidateConfigurationFeatures(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (strObjectid.equals(parentOID)) {
                ...
                mapConfigurationStructure = configModel.getCandidateConfigurationFeatures(context, DomainObject.EMPTY_STRING, DomainObject.EMPTY_STRING, slObjSelects, null, false, true, iLevel, 0,
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getMandatoryConfigurationFeatures(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            if (strObjectid.equals(parentOID)) {
                ...
                Model configModel = new Model(strObjectid);
                mapConfigurationStructure = configModel.getMandatoryConfigurationFeatures(context, DomainObject.EMPTY_STRING, DomainObject.EMPTY_STRING, slObjSelects, slRelSelects, false, true,
                        iLevel, 0, DomainObject.EMPTY_STRING, DomainObject.EMPTY_STRING, DomainObject.FILTER_STR_AND_ITEM, filterExpression);
            } else {
                mapConfigurationStructure = getConfigurationFeatureStructure(context, args);
            }
    ...
    public MapList getCommittedConfigurationFeatures(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            Model configModel = new Model(strObjectid);
            mapConfigurationStructure = configModel.getCommittedConfigurationFeatures(context, DomainObject.EMPTY_STRING, DomainObject.EMPTY_STRING, slObjSelects, slRelSelects, false, true, iLevel, 0,
                    DomainObject.EMPTY_STRING, DomainObject.EMPTY_STRING, DomainObject.FILTER_STR_AND_ITEM, filterExpression);
    ...
    public StringList excludeAvailableConfigurationFeature(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            if (mxType.isOfParentType(context, txtType, ConfigurationConstants.TYPE_PRODUCT_LINE)) {
                ...
                strRelPattern = ConfigurationConstants.RELATIONSHIP_CANDIDTAE_CONFIGURATION_FEATURES + "," + ConfigurationConstants.RELATIONSHIP_COMMITTED_CONFIGURATION_FEATURES + ","
                ...
                strRelPattern = ConfigurationConstants.RELATIONSHIP_CONFIGURATION_FEATURES + "," + ConfigurationConstants.RELATIONSHIP_VARIES_BY;

            } else if (mxType.isOfParentType(context, txtType, ConfigurationConstants.TYPE_CONFIGURATION_FEATURE)) {
                strRelPattern = ConfigurationConstants.RELATIONSHIP_CONFIGURATION_FEATURES + "," + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_OPTIONS;
            ...
            relatedFromFeatureList = domContextObj.getRelatedObjects(context, strRelPattern, strObjectPattern, objectSelects, relSelects, false, true, level, strWhereExp, strWhereExp, limit);
     ...
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            Holds ParamMap having the key "context" which will determine if the columns need to be displayed or not
     ...
     * @since R212
     */
    public Object isCommittedToAcceessible(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
     ...
     * @param args
     *            Holds ParamMap having the key "context" which will determine if the columns need to be displayed or not
     * @return bResult - true - if the context is Mandatory Features false - if the Context is not Mandatory Features
     * @throws FrameworkException
     *             - throws Exception if any operation fails.
     * @author A69
     * @since R212
     */
    public Object isInheritanceTypeAcceessible(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap requestValuesMap = (HashMap) programMap.get("RequestValuesMap");
            String[] arrCTX = (String[]) requestValuesMap.get("context");
     ...
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            - contain the ParamMap with the ObjectList of all the Committed Configuration Features
     ...
     * @since R212
     */
    public StringList getCommittedToProductList(Context context, String[] args) throws FrameworkException {
    ...
    /**
     * This is a Access Function to show or hide the Column ConfigurationSelectionType and Edit command in property page depends upon the param context=ConfigurationFeature passed in request parameter
     * @param context
     *            - the eMatrix <code>Context</code> object
     * @param args
     ...
     * @since R212
     */
    public Object isConfigurationFeatureContext(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap requestValuesMap = (HashMap) programMap.get("RequestValuesMap");
            String[] ctx = null;
    ...
    /**
     * This is a Access Function to show or hide Edit command in property page depends upon the param context=ConfigurationOption passed in request parameter
     * @param context
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            Holds ParamMap having the key "context", value of which will determine if the columns need to be displayed or not
     ...
     * @since R212
     */
    public Object isConfigurationOptionContext(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap requestValuesMap = (HashMap) programMap.get("RequestValuesMap");
            String[] ctx = null;
     ...
     *            - Source product ID from which the structure need to be copy
     * @param destinationObjectId
     *            - Destination product ID to which the structure need to be copy
     * @throws FrameworkException
     *             - - when operation fails
     * @author A69
     * @since R212
     */
    public void copyConfigurationFeature(Context context, String[] args) throws FrameworkException {
        try {
    ...
    /**
     * This method gets the object Structure List for the context Configuration Feature.This method gets invoked by settings in the command which displays the Structure Navigator for Configuration
    ...
    public static MapList getStructureList(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            if (strAllowedSTRel != null && !strAllowedSTRel.equals("")) {
                ...
                confFeatureStructList = confUtil.getObjectStructure(context, "*", strRelPattern, objectSelects, null, false, true, (short) 1, 0, "", "", DomainObject.FILTER_STR_AND_ITEM,
    ...
    /**
     * In case Configuration Option is getting created under a Configuration Feature, it display Context Configuration Feature name in the WebForm In case stand-alone Configuration Option is getting
     * created (Global Action), it Provite facility to choose context Configuration Feature
     * @param context
     *            the Matrix Context
     * @param args
    ...
    public String displayContextConfigurationFeature(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            if ((ProductLineCommon.isNotNull(strUIContext) && !(strUIContext.equals("GlobalActions") || strUIContext.equals("Classification"))) || strObjectID.length() != 0) {
                ...
                sb = sb.append("\"\"").append(strEndHrefTitle).append("<img border=\'0\' src=\'../common/images/" + strTypeIcon + "\'/>").append(strEndHref).append(" ");
     ...
     *            - Matrix Context Object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments objectId ConfigurationFeatureOID
     * @throws FrameworkException
     *             if the operation fails
     * @since R212
     */
    ...
    public static int isUsedInRulesForTypeCheck(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            String strRelBCRLE = "to[" + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.type.kindof["
                    + ConfigurationConstants.TYPE_BOOLEAN_COMPATIBILITY_RULE + "]";
            String strRelBCRRE = "to[" + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].from.type.kindof["
                    + ConfigurationConstants.TYPE_BOOLEAN_COMPATIBILITY_RULE + "]";
            String strRelMPRLE = "to[" + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.type.kindof["
                    + ConfigurationConstants.TYPE_MARKETING_PREFERENCE + "]";
            String strRelMPRRE = "to[" + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].from.type.kindof["
                    + ConfigurationConstants.TYPE_MARKETING_PREFERENCE + "]";
            String strRelQRLE = "to[" + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.type.kindof["
                    + ConfigurationConstants.TYPE_QUANTITY_RULE + "]";
            String strRelQRRE = "to[" + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].from.type.kindof["
                    + ConfigurationConstants.TYPE_QUANTITY_RULE + "]";
            String strRelIRRE = "to[" + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].from.type.kindof["
    ...
    public static int isInherited(Context context, String[] args) throws FrameworkException {
        try {
            ...
            String strLanguage = context.getSession().getLanguage();
            String strSubjectKey = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Alert.CanNotRemoveDeleteInherited", strLanguage);
    ...
    /**
     * This Methods is used to get the Configuration Options. This is used while 1)launching the Design Variants of a Logical Feature in Product Context 2)launching Split View from ProductLine Context
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList expandConfigurationOptions(Context context, String[] args) throws Exception {

        Map programMap = (Map) JPO.unpackArgs(args);
        String strObjectId = (String) programMap.get("objectId");
        MapList mapList = new MapList();
        String strType = "";
        if (!ConfigurationUtil.isObjectNull(context, strObjectId)) {
        ...
        if (mxType.isOfParentType(context, strType, ConfigurationConstants.TYPE_CONFIGURATION_FEATURES)) {
            ...
            if (sNameFilterValue != null && !(sNameFilterValue.equalsIgnoreCase("*"))) {
                ...
                strObjWhere = "attribute[" + ConfigurationConstants.ATTRIBUTE_DISPLAY_NAME + "] ~~ '" + sNameFilterValue + "'";
            }
            String strTypePattern = ConfigurationConstants.TYPE_CONFIGURATION_FEATURES;
            ...
            mapList = utilObj.getObjectStructure(context, strTypePattern, strRelPattern, slObjSelects, slRelSelects, false, true, level, limit, strObjWhere, ConfigurationConstants.EMPTY_STRING,
                    (short) 0, null);
        }
    ...
    /**
     * Method call as a trigger to check if the sub-features associated with the Configuration Feature are in Release state.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     * @author A69
     */
    public int checkSubFeaturesForConfigurationFeaturePromote(Context context, String args[]) throws Exception {
        ...
        MapList relBusObjList = configurationFeature.getConfigurationFeatureStructure(context, ConfigurationConstants.TYPE_CONFIGURATION_FEATURE,
                ConfigurationConstants.RELATIONSHIP_CONFIGURATION_FEATURES, objectSelects, tempStringList, false, true, 0, 0, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, (short) 1,
        ...
        if (iNumberOfObjects > 0) {
            ...
            for (int i = 0; i < iNumberOfObjects; i++) {
                ...
                if (!isFrozen) {
                    String strAlertMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Alert.ConfigurationFeaturesPromoteFailedStateNotRelease",
    ...
    public int promoteSubFeatures(Context context, String args[]) throws Exception {
        ...
        // Replaced DomainConstants.EMPTY_STRINGLIST with tempStringList for stale object issue
        MapList relBusObjList = configurationFeature.getConfigurationFeatureStructure(context, strTypePattern, strRelationshipPattern, objectSelects, tempStringList, false, true, 0, 0,
                strObjectWhere.toString(), DomainConstants.EMPTY_STRING, (short) 1, DomainConstants.EMPTY_STRING);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - args[0] - holding newly created relationship id args[1] - holding parent feature id
     * @return int - Returns 0 in case of Check trigger is success and 1 in case of failure
     * @throws Exception
     *             if the operation fails
     * @since R212
    ...
    /**
     * It is a check trigger method. Fires when a relationship Configuration Features is getting created It is used to check the cyclic condition
     * @param context
     *            The ematrix context object.
     * @param String
     *            [] The args .
    ...
    public int multiLevelRecursionCheck(Context context, String[] args) throws FrameworkException {
        ...
        if (strRemovedLFId == null || strRemovedLFId.length() == 0 || strRemovedLFId.equalsIgnoreCase("")) {
            ...
            try {
                ...
                if (recursionCheck) {
                    String strAlertMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.Add.CyclicCheck.Error", context.getSession().getLanguage());
    ...
    /**
     * It is a trigger method. Fires when a "Configuration Feature" promoted from review state to release state. If the promoted CF have previous revision than it will replace with the latest revision
     * in context which are not in Release state.
     * @param context
     *            The ematrix context object.
     * @param String
     *            [] The args .
    ...
    public void configurationFeatureFloatOnRelease(Context context, String[] args) throws FrameworkException {
        try {
            ...
            if (boPreviousRevision.exists(context)) {
                ...
                // Rel PAttern
                String strRelPattern = ConfigurationConstants.RELATIONSHIP_CONFIGURATION_FEATURES + "," + ConfigurationConstants.RELATIONSHIP_VARIES_BY + ","
                ...
                MapList configurationFeaturesRelIDListUp = util.getObjectStructure(context, strTypePattern, strRelPattern, objSelect, relSelect, true, false, 1, 0, strBusWhereClause,
                ...
                for (int i = 0; i < configurationFeaturesRelIDListUp.size(); i++) {
                    ...
                    if ((bApplicabilityApplies && !applicableItemsList.contains(strParentObjId)) || mxType.isOfParentType(context, strParentObjType, ConfigurationConstants.TYPE_PRODUCT_LINE)
    ...
    /**
     * This method is used to restrict from displaying the row in Configuration Feature Property page if Library Central is not installed
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            : args for the method
    ...
    /**
     * This is a trigger method called when the Varied By relationship is deleted, this method handle the delete check at the Product context.
     * @param context
     * @param args
     * @return If inherited return 0
     * @throws FrameworkException
        ...
        try {
            ...
            if (strDVRemoveContext == null || strDVRemoveContext.equals("")) {
                ...
                if (mxType.isOfParentType(context, strToType, ConfigurationConstants.TYPE_PRODUCTS)) {
                    String strLanguage = context.getSession().getLanguage();
                    String strSubjectKey = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.Alert.CanNotRemoveDeleteVariesBy", strLanguage);
                    throw new FrameworkException(strSubjectKey);
                }
            }
        } catch (Exception e) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - args[0] - From side id of Mandatory Configuration Features relationship args[1] - To side id of Mandatory Configuration Features relationship
     * @return int - Returns 0 in case of Check trigger is success and 1 in case of failure
     * @throws Exception
     *             if the operation fails
     * @since R212
    ...
    /**
     * Method call as a trigger to update the structure of added Object for all the Mandatory Configuration Feature connected to context
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - args[0] - From side id of Mandatory Configuration Features relationship args[1] - To side id of Mandatory Configuration Features relationship
    ...
    public static int inheritMandatoryConfigurationFeatures(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            if (mxType.isOfParentType(context, fromType, ConfigurationConstants.TYPE_PRODUCTS) && !mxType.isOfParentType(context, toType, ConfigurationConstants.TYPE_PRODUCT_VARIANT)) {
                return 0;
            } else {
                String strTypePattern = ConfigurationConstants.TYPE_CONFIGURATION_FEATURE;
                ...
                MapList mapConfigurationStructure = confUtil.getObjectStructure(context, strTypePattern, strRelPattern, objSelect, relSelects, false, true, 1, 0, DomainObject.EMPTY_STRING,
                ...
                for (int count = 0; count < mapConfigurationStructure.size(); count++) {
                    if (mapConfigurationStructure != null && mapConfigurationStructure.size() > 0) {
                        ...
                        if (relType != null && (relType.equals(ConfigurationConstants.RELATIONSHIP_MANDATORY_CONFIGURATION_FEATURES)
                                || (relType.equals(ConfigurationConstants.RELATIONSHIP_VARIES_BY) && ConfigurationConstants.RANGE_VALUE_MANDATORY.equals(configurationType)))) {
    ...
    /**
     * Method call as a trigger to flag all Active Design variant Inactive if context Configuration Feature is getting used This will get fire when Configuration Feature will be promoted to Obsolete
     * state
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public int InactiveDesignVariants(Context context, String args[]) throws Exception {
        ...
        MapList relBusObjList = configurationFeature.getConfigurationFeatureStructure(context, strTypePattern, strRelationshipPattern, objectSelects, relSelects, true, false, 1, 0,
        ...
        if (relBusObjList != null) {
            ...
            if (iNumberOfObjects > 0) {
                ...
                for (int i = 0; i < iNumberOfObjects; i++) {
                    ...
                    String strRelId = (String) ((Hashtable) relBusObjList.get(i)).get(ConfigurationConstants.SELECT_RELATIONSHIP_ID);
    ...
    /**
     * Method to search Configuration features need to exclude from emxFullSearchPage
     * @param context
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            holds arguments
     * @return feature List - String list of Object IDs to exclude
     * @throws Exception
     * @author A69
     * @since R211
     */
    public StringList excludeConnectedFeatureOptionsInCG(Context context, String[] args) throws FrameworkException {
        StringList sLConnectedCOs = new StringList();
        try {
            Map programMap = (Map) JPO.unpackArgs(args);

            String strCommonGrpId = (String) programMap.get("strCGId");

            // Get the Feature Options connected to CG with Common Values
            Vector vConnectedCOs = new Vector();
            CommonValues CV = new CommonValues();
            vConnectedCOs = CV.getCommonValuesDataForCG(context, strCommonGrpId);

            for (int y = 0; y < vConnectedCOs.size(); y++) {

                sLConnectedCOs = (StringList) ((Map) vConnectedCOs.get(y)).get("Config Options Ids");
            }
     ...
     * @param context
     * @param args
     * @return Map containing old created Configuration Feature rel id as key and pipe separated old rel physical id, new rel physical id, new rel id as value
     * @throws FrameworkException
     * @exclude
     */
    public Map copyConfigurationFeatureStructure(Context context, String[] args) throws FrameworkException {
    ...
    /**
     * Method call as a update function setting of column, to check if the changed object has Configuration Feature type subfeatures and blocked the update even if check failed, else update Key-In
     * Type attribute.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public static void updateKeyInType(Context context, String[] args) throws FrameworkException {
        try {
            String strLanguage = context.getSession().getLanguage();
            String strSubjectKey = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.Feature.Modify.KeyInTypeCheck", strLanguage);
    ...
    /**
     * Method returns the First Sequence revision for the policy Configuration Feature. It is called for the create page of Configuration Feature
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds parameters passed from the calling method
    ...
    /**
     * Exclude DV choices which will be used while creating CG, view CG list, add Common group
     * @param context
     *            - the eMatrix <code>Context</code> object
     * @param args
    ...
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList excludeDesignVariantOptions(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);

        StringList featurestoExcludeList = new StringList();
        CommonValues commonValues = new CommonValues();
        String strCurentContext = programMap.get("strProductId").toString();
        String strVariesBYConnectionId = programMap.get("strVBId").toString();
        String strLFId = programMap.get("strLFId").toString();

        String strDesignVariantId = programMap.get("strDVId").toString();
        DomainRelationship designVariantRel = new DomainRelationship(strVariesBYConnectionId);
        String isGlobalCommonGroup = designVariantRel.getAttributeValue(context, ConfigurationConstants.ATTRIBUTE_GLOBAL_COMMON_GROUP);
        // MapList
        // commonGroupList=commonValues.getCommonGroupList(context,strDesignVariantOptionId,strDesignVariantId);
        MapList commonGroupList = commonValues.getCommonGroups(context, strLFId, strDesignVariantId);
        StringList slRelSelects = new StringList("torel.to.id");
        // Proccessing for Global Common Group
        if (isGlobalCommonGroup.equals("Yes")) {
            // get all the common groups and remove all the options in that
            // common group to the list of excludes
            for (int i = 0; i < commonGroupList.size(); i++) {
                Map temp = new HashMap();
                temp = (Map) commonGroupList.get(i);
                StringList cgValues = (StringList) temp.get("Common Values");
                for (int j = 0; j < cgValues.size(); j++) {
                    String strCommonValueId = (String) cgValues.get(j);
                    String[] relIdList = new String[] { strCommonValueId };
                    MapList resultList = DomainRelationship.getInfo(context, relIdList, slRelSelects);
                    Map mpREToDetails = (Map) resultList.get(0);
                    String strFeatureId = mpREToDetails.get("torel.to.id").toString();
                    featurestoExcludeList.add(strFeatureId);

                }
            }
        } else {
            // Processing for context specific common group
            // Iterate through the list of common groups. If the current context
            // and context of the common group is same then add all the options
            // of the common group to the list of exlcudes

            for (int i = 0; i < commonGroupList.size(); i++) {
                Map temp = new HashMap();
                temp = (Map) commonGroupList.get(i);
                StringList cgValues = (StringList) temp.get("Common Values");
                String strCommmonGroupContext = temp.get("Context Prod Id").toString();
                if (strCommmonGroupContext.equals(strCurentContext)) {
                    for (int j = 0; j < cgValues.size(); j++) {
                        String strCommonValueId = (String) cgValues.get(j);
                        String[] relIdList = new String[] { strCommonValueId };
                        MapList resultList = DomainRelationship.getInfo(context, relIdList, slRelSelects);
    ...
    public Vector getContextProductLine(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        for (int i = 0; i < lstObjectIdsList.size(); i++) {
            ...
            strParentId = (String) ((Map) lstObjectIdsList.get(i)).get("id[parent]");
            ...
            String strProductRev = domObjProd.getInfo(context, "to[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_VERSION + "].from.id");
            if (strProductRev != null && !(("").equals(strProductRev)) && !(("null").equals(strProductRev)))
            ...
            String strPLId = domObjModel.getInfo(context, "to[" + ConfigurationConstants.RELATIONSHIP_PRODUCTLINE_MODELS + "].from.id");

            if (strPLId != null && !(("").equals(strPLId)) && !(("null").equals(strPLId))) {
                String strPL = new DomainObject(strPLId).getInfo(context, DomainConstants.SELECT_NAME);
     ...
     * @since FTR R212
     */
    public void connectREToConfigurationFeature(Context context, String[] args) throws Exception {
        // configuration feature Id
        String ObjectId = args[0];
        DomainObject domObject = new DomainObject(ObjectId);
        BusinessObject boPreviousRevision = domObject.getPreviousRevision(context);
        ...
        if (boPreviousRevision.exists(context)) {
            ...
            String strNewId = domObject.getInfo(context, ConfigurationConstants.SELECT_PHYSICAL_ID);
            String strOldId = prevObj.getInfo(context, ConfigurationConstants.SELECT_PHYSICAL_ID);
            StringList selectables = new StringList();
            selectables.add(DomainObject.SELECT_ID);
            selectables.add(ConfigurationConstants.SELECT_ATTRIBUTE_RIGHT_EXPRESSION);

            // IR connected with Object
            MapList irList = prevObj.getRelatedObjects(context, ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION, ConfigurationConstants.TYPE_INCLUSION_RULE, selectables,
                    new StringList(DomainRelationship.SELECT_ID), true, false, (short) 1, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, 1);
            ...
            if (irList.size() != 0) {
                for (int i = 0; i < irList.size(); i++) {
                    ...
                    sb_attr.append(ConfigurationConstants.SELECT_ATTRIBUTE_RIGHT_EXPRESSION);
                    String strAttr = sb_attr.toString();
                    String rightexpression = (String) connectIdMap.get(strAttr);

                    StringList newRElID = ConfigurationUtil.convertObjToStringList(context, (Object) connectIdMap.get(strrelId));
                    for (int j = 0; j < newRElID.size(); j++) {
                        String relIdconnect = (String) newRElID.get(j);
                        DomainRelationship.setToObject(context, relIdconnect, domObject);
                    }
                    StringList newRuleID = ConfigurationUtil.convertObjToStringList(context, (Object) connectIdMap.get(strId));
                    for (int j = 0; j < newRuleID.size(); j++) {
                        DomainObject dom = new DomainObject((String) newRuleID.get(j));

                        String finalRightexpression = rightexpression.replace("B" + strOldId, "B" + strNewId);
                        dom.setAttributeValue(context, ConfigurationConstants.ATTRIBUTE_RIGHT_EXPRESSION, finalRightexpression);
                    }
                }
            }
            StringBuffer sb = new StringBuffer();
            ...
            MapList newList = prevObj.getRelatedObjects(context, ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES, ConfigurationConstants.TYPE_CONFIGURATION_FEATURES, objSel, relSel,
                    false, true, (short) 0, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, 1);
            if (newList.size() != 0) {
                for (int i = 0; i < newList.size(); i++) {
                    ...
                    resultruleIds = ConfigurationUtil.convertObjToStringList(context, (Object) connectIdMap.get(coIR));
                    resultruleIds_1 = ConfigurationUtil.convertObjToStringList(context, (Object) connectIdMap.get(cfIR));

                    resultruleIds.addAll(resultruleIds_1);
                    if (resultruleIds.size() != 0) {
                        for (int j = 0; j < resultruleIds.size(); j++) {
                            DomainObject dom = new DomainObject((String) resultruleIds.get(j));
                            dom.setAttributeValue(context, ConfigurationConstants.ATTRIBUTE_RULE_COMPLEXITY, ConfigurationConstants.RANGE_VALUE_COMPLEX);
    ...
    public static StringList isConfigurationObjectEditable(Context context, String[] args) throws FrameworkException {
        try {
            ...
            for (int i = 0; i < objectMap.size(); i++) {
                ...
                if (objectType != null && mxType.isOfParentType(context, objectType, ConfigurationConstants.TYPE_CONFIGURATION_FEATURE)) {
    ...
    public static StringList getSelectionCriteria(Context context, String[] args) throws FrameworkException {
        try {
            ...
            for (int i = 0; i < objectMap.size(); i++) {
                ...
                String strI18Value = "";
                if (outerMap.containsKey(ConfigurationConstants.SELECT_ATTRIBUTE_CONFIGURATION_SELECTION_TYPE)
                        && ProductLineCommon.isNotNull((String) outerMap.get(ConfigurationConstants.SELECT_ATTRIBUTE_CONFIGURATION_SELECTION_TYPE))) {
                ...
                if (strSelectionCriteria != null && strSelectionCriteria.equalsIgnoreCase(ConfigurationConstants.RANGE_VALUE_MUST)) {
                    strI18Value = strSelectionCriteriaMust;

                } else if (strSelectionCriteria != null && strSelectionCriteria.equalsIgnoreCase(ConfigurationConstants.RANGE_VALUE_MAY)) {
    ...
    public Map getRangeValuesForSelectionCriteria(Context context, String[] args) throws Exception {
        ...
        List attributeDisplayRange = i18nNow.getAttrRangeI18NStringList(ConfigurationConstants.ATTRIBUTE_CONFIGURATION_SELECTION_CRITERIA, (StringList) attributeRange,
                context.getSession().getLanguage());
    ...
    public void updateSelectionCriteria(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            domRel.setAttributeValue(context, ConfigurationConstants.ATTRIBUTE_CONFIGURATION_SELECTION_CRITERIA, strNewAttributeValue);
        } catch (FrameworkException e) {
            e.printStackTrace();
            throw new FrameworkException(e.getMessage());
        }
    ...
    /**
     * This method is used to return the value of Inheritance Type column, which depends upon the relationship with which feature is connected to with the context
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds arguments
     ...
     * @author A69
     */
    public void connectConfigurationFeatureOnRevise(Context context, String args[]) throws FrameworkException {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - args[0] - holding relationship id to be deleted args[1] - holding parent feature id
     * @return int - Returns 0 in case of Check trigger is success and 1 in case of failure
     * @throws Exception
     *             if the operation fails
     */
    ...
    public static int updateCountForDeletion(Context context, String[] args) throws FrameworkException {
        try {
            ...
            MapList mLCVRelId = ProductLineCommon.queryConnection(context, ConfigurationConstants.RELATIONSHIP_COMMON_VALUES, RelationshipSelect, strWhere);
            ...
            for (int i = 0; i < mLCVRelId.size(); i++) {
                ...
                MapList mLCGRelId = ProductLineCommon.queryConnection(context, ConfigurationConstants.RELATIONSHIP_COMMON_GROUP, RelationshipSelectForCG, strWhereForCG);
    ...
    /**
     * This is a Access Function to show the read only context Configuration Feature field on form, while creating Configuration Option under a selected context
     * @param context
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            Holds ParamMap having the key "context", value of which will determine if the columns need to be displayed or not
     ...
     * @exclude
     */
    public Object noShowContextChooser(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
    ...
    /**
     * This is a Access Function to show the editable context Configuration Feature field on form, while creating Configuration Option from Global Actions
     * @param context
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            Holds ParamMap having the key "context", value of which will determine if the columns need to be displayed or not
     ...
     * @exclude
     */
    public Object showContextChooser(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap requestValuesMap = (HashMap) programMap.get("requestMap");
            String ctx = null;
    ...
    public StringList parentConfigurationFeatureName(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            for (int i = 0; i < mpCFParentDetails.size(); i++) {
                ...
                StringList strParentCFNameofCO = ConfigurationUtil.convertObjToStringList(context,
                        objectMap.get("to[" + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_FEATURES + "].from[" + ConfigurationConstants.TYPE_CONFIGURATION_FEATURE + "].name"));
                StringList strParentCFNameofCF = ConfigurationUtil.convertObjToStringList(context,
                        objectMap.get("to[" + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_OPTIONS + "].from[" + ConfigurationConstants.TYPE_CONFIGURATION_FEATURE + "].name"));
    ...
    /**
     * Method called as a trigger to set the Usage Effectivity date to date of promotion to Obsolete for Configuration Feature.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the parameters passed from the calling method
    ...
    public int updateUsageEffectivityOnPromote(Context context, String args[]) throws Exception {
        ...
        MapList relBusObjList = configurationFeature.getConfigurationFeatureStructure(context, sbTypePattern.toString(), strRelationshipPattern, objectSelects, relSelects, true, false, 1, 0,
                DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, (short) 1, DomainConstants.EMPTY_STRING);
    ...
    /**
     * Method called as a trigger to reset the Usage Effectivity on Configuration Feature demote from Obsolete.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the parameters passed from the calling method
     ...
     * @since R212
     */
    public MapList getModConfigurationFeatureStructure(Context context, String[] args) throws FrameworkException {
        MapList mapConfigurationStructure = null;
        ...
        try {
            ...
            mapConfigurationStructure = domContextObj.getRelatedObjects(context, strRelPattern.toString(), DomainObject.QUERY_WILDCARD, objectSelects, relationshipSelects, false, true, (short) 0,
    ...
    /**
     * Relationship trigger invoked on modifying attribute on relationship Configuration Structures to not allow setting of Effectivity while structure is in frozen state.
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    public int checkAccessForSettingEffectivity(Context context, String[] args) throws Exception {
        int iResult = 0;
        String strNoAccessMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxConfiguration.DateEffectivity.ObjectFrozen", context.getSession().getLanguage());
    ...
    public static int deleteSelectedOptionsRelOnConfigOptions(Context context, String[] args) throws Exception {
        try {
            ...
            String logFeatFromInclusionBOM = "tomid[" + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].from.from[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].torel["
                    + ConfigurationConstants.RELATIONSHIP_GBOM + "].from.id";
            ...
            MapList mapCFStructure = (MapList) removedConfigFeat.getConfigurationFeatureStructure(context, strTypePattern, strRelPattern, slObjSelects, slRelSelects, false, true, 0, 0,
                    DomainConstants.EMPTY_STRING, DomainObject.EMPTY_STRING, DomainObject.FILTER_STR_AND_ITEM, DomainConstants.EMPTY_STRING);
    ...
    /**
     * Wrapper method which will call method to check Product delete to restrict removal of Product if any of the Product's Configuration Feature/Option structure is used in FO Effectivity Expression.
     * @param context
     * @param args
     * @return
     * @throws Exception
     */
    public int checkIfProductStructureUsedInFOEffectivity(Context context, String args[]) throws Exception {
    ...
    public int checkIfCFStructureUsedInFOEffectivity(Context context, String args[]) throws Exception {
        ...
        int iReturn = 0;
        try {
            if (UIUtil.isNotNullAndNotEmpty(_sRelTypeToDisconnect) && ConfigurationUtil.isOfParentRel(context, _sRelTypeToDisconnect, ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES)) {
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getConfigurationFeatureStructureForProductContext(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            slRelSelects.addElement("tomid[" + ConfigurationConstants.ATTRIBUTE_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].attribute["
    ...
    public List getStatusIconForProductContext(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            String strStateCFExists = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxFramework.State.Configuration_Feature.Exists", strLanguage);
            ...
            while (objectListItr.hasNext()) {
                ...
                if (flag) {
                    ...
                    if (reportFormat != null && !("null".equalsIgnoreCase(reportFormat)) && reportFormat.length() > 0) {
                        ...
                        stbNameRev = stbNameRev.append("<img src=\"../common/images/").append(strIcon).append("\" border=\"0\"  align=\"middle\" TITLE=\" ")
    ...
    public Map getRangeValuesForSelectionType(Context context, String[] args) throws Exception {
        ...
        List attributeRange = attribName.getChoices();
        List attributeDisplayRange = i18nNow.getAttrRangeI18NStringList(ConfigurationConstants.ATTRIBUTE_CONFIGURATION_SELECTION_TYPE, (StringList) attributeRange, context.getSession().getLanguage());
        rangeMap.put(FIELD_CHOICES, attributeRange);
        rangeMap.put(FIELD_DISPLAY_CHOICES, attributeDisplayRange);
        return rangeMap;
    }
    ...
    public void updateSelectionType(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            domObj.setAttributeValue(context, ConfigurationConstants.ATTRIBUTE_CONFIGURATION_SELECTION_TYPE, strNewAttributeValue);
        } catch (FrameworkException e) {
            e.printStackTrace();
            throw new FrameworkException(e.getMessage());
        }
    ...
    public static StringList getKeyInType(Context context, String[] args) throws FrameworkException {
        try {
            ...
            for (int i = 0; i < objectMap.size(); i++) {
                Map outerMap = new HashMap();
                outerMap = (Map) objectMap.get(i);
                if (outerMap.containsKey(ConfigurationConstants.SELECT_ATTRIBUTE_KEYIN_TYPE)
                        && ProductLineCommon.isNotNull((String) outerMap.get(ConfigurationConstants.SELECT_ATTRIBUTE_KEYIN_TYPE))) {
                ...
                if (strKeyInType != null) {
                    if (strKeyInType.equalsIgnoreCase(ConfigurationConstants.RANGE_VALUE_DATE)) {
                        strI18Value = KeyInTypeDate;

                    } else if (strKeyInType.equalsIgnoreCase(ConfigurationConstants.RANGE_VALUE_TEXTAREA)) {
                        strI18Value = KeyInTypeTestArea;
                    } else if (strKeyInType.equalsIgnoreCase(ConfigurationConstants.RANGE_VALUE_INTEGER)) {
                        strI18Value = KeyInTypeInteger;
                    } else if (strKeyInType.equalsIgnoreCase(ConfigurationConstants.RANGE_VALUE_REAL)) {
                        strI18Value = KeyInTypeReal;
                    } else if (strKeyInType.equalsIgnoreCase(ConfigurationConstants.RANGE_VALUE_INPUT)) {
                        strI18Value = KeyInTypeInput;
                    } else if (strKeyInType.equalsIgnoreCase(ConfigurationConstants.RANGE_VALUE_BLANK)) {
    ...
    public Map getRangeValuesForKeyInType(Context context, String[] args) throws Exception {
        ...
        List attributeRange = attribName.getChoices();
        List attributeDisplayRange = i18nNow.getAttrRangeI18NStringList(ConfigurationConstants.ATTRIBUTE_KEY_IN_TYPE, (StringList) attributeRange, context.getSession().getLanguage());
        rangeMap.put(FIELD_CHOICES, attributeRange);
        rangeMap.put(FIELD_DISPLAY_CHOICES, attributeDisplayRange);
        return rangeMap;
    }
    ...
    public void updateKeyInTypeValue(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strNewAttributeValue = (String) paramMap.get("New Value");
            DomainObject domObj = new DomainObject(strObjId);
            domObj.setAttributeValue(context, ConfigurationConstants.ATTRIBUTE_KEY_IN_TYPE, strNewAttributeValue);
        } catch (FrameworkException e) {
            e.printStackTrace();
            throw new FrameworkException(e.getMessage());
        }
    ...
    public static StringList getSequenceNumber(Context context, String[] args) throws FrameworkException {
        try {
            ...
            for (int i = 0; i < objectMap.size(); i++) {
                Map outerMap = new HashMap();
                outerMap = (Map) objectMap.get(i);
                if (outerMap.containsKey(ConfigurationConstants.SELECT_ATTRIBUTE_SEQUENCE_ORDER)
                        && ProductLineCommon.isNotNull((String) outerMap.get(ConfigurationConstants.SELECT_ATTRIBUTE_SEQUENCE_ORDER))) {
    ...
    public void updateSequenceNumber(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strNewAttributeValue = (String) paramMap.get("New Value");
            DomainRelationship domRel = new DomainRelationship(strRelId);
            domRel.setAttributeValue(context, ConfigurationConstants.ATTRIBUTE_SEQUENCE_ORDER, strNewAttributeValue);
        } catch (FrameworkException e) {
            e.printStackTrace();
            throw new FrameworkException(e.getMessage());
        }
    ...
    public static StringList getDefaultSelection(Context context, String[] args) throws FrameworkException {
        try {
            ...
            for (int i = 0; i < objectMap.size(); i++) {
                Map outerMap = new HashMap();
                outerMap = (Map) objectMap.get(i);
                if (outerMap.containsKey(ConfigurationConstants.SELECT_DEFAULT_SELECTION) && ProductLineCommon.isNotNull((String) outerMap.get(ConfigurationConstants.SELECT_DEFAULT_SELECTION))) {
    ...
    public Map getRangeValuesForDefaultSelection(Context context, String[] args) throws Exception {
        ...
        List attributeRange = attribName.getChoices();
        List attributeDisplayRange = i18nNow.getAttrRangeI18NStringList(ConfigurationConstants.ATTRIBUTE_DEFAULT_SELECTION, (StringList) attributeRange, context.getSession().getLanguage());
        rangeMap.put(FIELD_CHOICES, attributeRange);
        rangeMap.put(FIELD_DISPLAY_CHOICES, attributeDisplayRange);
        return rangeMap;
    }
    ...
    public void updateDefaultSelection(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strNewAttributeValue = (String) paramMap.get("New Value");
            DomainRelationship domRel = new DomainRelationship(strRelId);
            domRel.setAttributeValue(context, ConfigurationConstants.ATTRIBUTE_DEFAULT_SELECTION, strNewAttributeValue);
        } catch (FrameworkException e) {
            e.printStackTrace();
            throw new FrameworkException(e.getMessage());
        }
    ...
    public static StringList getListPrice(Context context, String[] args) throws FrameworkException {
        try {
            ...
            for (int i = 0; i < objectMap.size(); i++) {
                Map outerMap = new HashMap();
                outerMap = (Map) objectMap.get(i);
                if (outerMap.containsKey(ConfigurationConstants.SELECT_LIST_PRICE) && ProductLineCommon.isNotNull((String) outerMap.get(ConfigurationConstants.SELECT_LIST_PRICE))) {
    ...
    public void updateListPrice(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strNewAttributeValue = (String) paramMap.get("New Value");
            DomainRelationship domRel = new DomainRelationship(strRelId);
            domRel.setAttributeValue(context, ConfigurationConstants.ATTRIBUTE_LIST_PRICE, strNewAttributeValue);
        } catch (FrameworkException e) {
            e.printStackTrace();
            throw new FrameworkException(e.getMessage());
        }
    ...
    public static StringList getMinimumQuantity(Context context, String[] args) throws FrameworkException {
        try {
            ...
            for (int i = 0; i < objectMap.size(); i++) {
                Map outerMap = new HashMap();
                outerMap = (Map) objectMap.get(i);
                if (outerMap.containsKey(ConfigurationConstants.SELECT_MINIMUM_QUANTITY) && ProductLineCommon.isNotNull((String) outerMap.get(ConfigurationConstants.SELECT_MINIMUM_QUANTITY))) {
    ...
    public void updateMinimumQuantity(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strNewAttributeValue = (String) paramMap.get("New Value");
            DomainRelationship domRel = new DomainRelationship(strRelId);
            domRel.setAttributeValue(context, ConfigurationConstants.ATTRIBUTE_MINIMUM_QUANTITY, strNewAttributeValue);
        } catch (FrameworkException e) {
            e.printStackTrace();
            throw new FrameworkException(e.getMessage());
        }
    ...
    public static StringList getMaximumQuantity(Context context, String[] args) throws FrameworkException {
        try {
            ...
            for (int i = 0; i < objectMap.size(); i++) {
                Map outerMap = new HashMap();
                outerMap = (Map) objectMap.get(i);
                if (outerMap.containsKey(ConfigurationConstants.SELECT_MAXIMUM_QUANTITY) && ProductLineCommon.isNotNull((String) outerMap.get(ConfigurationConstants.SELECT_MAXIMUM_QUANTITY))) {
    ...
    public void updateMaximumQuantity(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strNewAttributeValue = (String) paramMap.get("New Value");
            DomainRelationship domRel = new DomainRelationship(strRelId);
            domRel.setAttributeValue(context, ConfigurationConstants.ATTRIBUTE_MAXIMUM_QUANTITY, strNewAttributeValue);
        } catch (FrameworkException e) {
            e.printStackTrace();
            throw new FrameworkException(e.getMessage());
        }
    ...
    /**
     * Trigger will be invoked on Configuration Features Delete Action. It will remove the Committed Context relationship and Change the Committed Configuration Features relation to Candidate
     * Configuration Features relation.
     * @param context
     * @param args
     * @return
     * @throws FrameworkException
     ...
     * @since R417
     */
    public void connectIROnRevise(Context context, String args[]) throws FrameworkException {
        String featureId = args[0];
        ...
        try {
            ...
            MapList oldIROnCFList = contextFeature.getRelatedObjects(context, strRelPattern, // Rel pattern
                    ...
                    DomainConstants.EMPTY_STRING, 0); // Relationship where

            MapList newIROnCFList = newRevision.getRelatedObjects(context, strRelPattern, // Rel pattern
                    DomainConstants.QUERY_WILDCARD, // Type pattern
                    slObjSelects, // Object selectables
                    slRelSelects, // Relationship selectables
                    false, // From side
    ...
    /**
     * Returns a MapList of selected Ids from full search results when using relational effectivity Relational View This will expand the selected objects and return a row for each parent/child pair
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a packed hashmap with the following arguments RequestValuesMap HashMap of request values - emxTableRowId
     * @throws Exception
     *             if the operation fails
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getModelConfigurationDictionaryForEffectivity(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        StringList dvIdList = new StringList();
        DomainRelationship domRel = new DomainRelationship(relationshipId);
        String dvSelects = "from.from[" + ConfigurationConstants.RELATIONSHIP_VARIES_BY + "].to.id";
        Hashtable relData = (Hashtable) domRel.getRelationshipData(context, new StringList(dvSelects));
        dvIdList = (StringList) relData.get(dvSelects);
        ...
        if (!programMap.keySet().contains("parentId")) {
            ...
            if (dvIdList.size() > 0) {
                for (int ii = returnList.size() - 1; ii >= 0; ii--) {
                    Map objMap = (Map) returnList.get(ii);
                    String currentType = (String) objMap.get("type");
                    String currentID = (String) objMap.get("id");
                    String currentParentID = (String) objMap.get("from.id");
                    if (UIUtil.isNotNullAndNotEmpty(currentType) && (cfSubTypes.contains(currentType) || coSubTypes.contains(currentType))) {
                        if (cfSubTypes.contains(currentType) && !dvIdList.contains(currentID) || coSubTypes.contains(currentType) && !dvIdList.contains(currentParentID)) {
                            returnList.remove(ii);
                        }
                    }
                }
            }
    ...
    public static Map refreshTree(Context context, String[] args) throws Exception {
        Map returnMap = new HashMap();
        returnMap.put("Action", "execScript");
        returnMap.put("Message", "{ main:function __main(){refreshTreeForCFAddRemove(xmlResponse)}}");
        return returnMap;
    }
