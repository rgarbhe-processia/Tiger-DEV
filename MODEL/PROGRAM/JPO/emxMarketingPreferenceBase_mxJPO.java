...
/*
 ** emxMarketingPreferenceBase Copyright (c) 1993-2015 Dassault Systemes. All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systemes. Copyright notice is
...
public class emxMarketingPreferenceBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        ...
        /*
         * if (!context.isConnected()){ String sContentLabel = i18nNow.getI18nString(\\\"emxProduct.Error.UnsupportedClient\\\", \\\"emxProductCentralStringResource\\\",
    ...
    public MapList getMarketingPreferences(Context context, String[] args) throws Exception {
        ...
        relBusObjPageList = contextObj.getObjectStructure(context, ConfigurationConstants.RELATIONSHIP_MARKETING_PREFERENCE, ConfigurationConstants.TYPE_MARKETING_PREFERENCE, objectSelects,
                relSelects, false, true, 1, 0, DomainObject.EMPTY_STRING, DomainObject.EMPTY_STRING, DomainObject.FILTER_ITEM, DomainObject.EMPTY_STRING);
    ...
    /**
     * Wrapper method to display the Right Expression value in MPR List Page Called from Table Column settings
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * Wrapper method to display the Left Expression value in MPR List Page Called from Table Column settings
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * Wrapper method to display the Right Expression value in MPR Properties Page Called from Webform field settings
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * Wrapper method to display the Left Expression value in MPR Properties Page Called from Webform field settings
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    public StringList excludeConnectedMPR(Context context, String[] args) throws Exception {
        ...
        MapList objectList = confUtil.getObjectStructure(context, ConfigurationConstants.TYPE_MARKETING_PREFERENCE, ConfigurationConstants.RELATIONSHIP_MARKETING_PREFERENCE, objSelects, relSelects,
                false, true, (short) 1, 0, objWhere, relWhere, DomainObject.FILTER_ITEM, filterExpression);
