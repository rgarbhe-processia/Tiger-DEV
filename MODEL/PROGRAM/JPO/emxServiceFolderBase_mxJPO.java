...
public class emxServiceFolderBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    /**
     * Get the list of Service Folder objects which don't have parent Service Folder.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments:
     * @return a <code>MapList</code> object having the list of Service Folder objects that don't have parent Service Folder.
     * @throws Exception
     *             if the operation fails
    ...
    public MapList getServices(Context context, String[] args) throws Exception {
        ...
        MapList mapServiceList = boKey.expandSelect(context, sRelServiceCategory, sTypeWebService, busSelects, relSelects, false, true, (short) 1, "", "", null, false);
    ...
    public MapList getServiceFolders(Context context, String[] args) throws Exception {
        ...
        MapList mapServiceFolderList = boKey.expandSelect(context, sRelServiceCategory, sTypeServiceFolder, busSelects, relSelects, false, true, (short) 1, "", "", null, false);
     ...
     *            containing a Revision pattern to search for txtDesc - a String containing a Description pattern to search for vaultOption - a String containing a Vault pattern to search for txtOwner
     *            - a String containing an Owner pattern to search for txtOrginator - a String containing an Originator pattern to search for objectId - a String containing the root business object
     *            selType - a String containing the target Service Folder relType - a String containing the relationship between root bo and target bo
    ...
    public MapList getFolderSearchResult(Context context, String[] args) throws Exception {
        ...
        tmpresultList = DomainObject.findObjects(context, selType, txtName, txtRev, txtOwner, txtVault, sWhereExp, null, true, resultSelects, Short.parseShort(queryLimit), null, null);
        ...
        if (objectId != null && !objectId.equals("null")) {
            ...
            // Sub Service Folders
            subServiceFoldersConnectedList = boServiceFolder.expandSelect(context, relType, TYPE_SF, busSelects, relSelects, false, true, (short) 1, null, null, null, null, null, null, false);

            // parent, grandparent, ... Service Folders
            parentServiceFoldersConnectedList = boServiceFolder.expandSelect(context, relType, TYPE_SF, busSelects, relSelects, true, false, (short) 0, null, null, null, null, null, null, false);
