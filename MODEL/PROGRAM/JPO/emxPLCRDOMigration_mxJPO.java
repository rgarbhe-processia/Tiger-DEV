...
public class emxPLCRDOMigration_mxJPO extends emxPLCRDOMigrationBase_mxJPO {
     ...
     * @grade 0
     */
    public emxPLCRDOMigration_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
