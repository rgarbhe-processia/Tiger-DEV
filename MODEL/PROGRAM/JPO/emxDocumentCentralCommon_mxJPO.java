 ...
 **
 ** FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.8 $" Date : "$Date: Wed Oct 22 16:02:27 2008 $"
 **
 */
...
public class emxDocumentCentralCommon_mxJPO extends emxDocumentCentralCommonBase_mxJPO {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("must specify method on emxDocumentCentralCommon invocation");
        }
