...
public class IEFShowSynchronizeEBOMLink_mxJPO {
    ...
    public IEFShowSynchronizeEBOMLink_mxJPO(Context context, String[] args) throws Exception {
    }
            ...
            try {
                ...
                if (integrationName != null && integrationNameGCOTable.containsKey(integrationName)) {
                    ...
                    if (bEBOMSynch) {
                        ...
                        String synchEBOMHref = "javascript:parent.emxShowModalDialog('" + synchEBOMURL + "', 400, 400, false)";
