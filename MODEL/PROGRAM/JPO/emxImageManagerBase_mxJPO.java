...
public class emxImageManagerBase_mxJPO extends emxCommonDocument_mxJPO {
     ...
     * @grade 0
     */
    public emxImageManagerBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    static public String addSeparator(String path) {
        if (path.lastIndexOf(java.io.File.separatorChar) != path.length() - 1 || path.lastIndexOf('/') != path.length() - 1)
    ...
    /**
     * This method actually checks if the property for background job is set or not and accordingly invokes method generateTransformatedImagesInBackground or method generateTransformatedImages method
     * generateTransformatedImagesInBackground again invokes generateTransformatedImages method through background job
     * @param context
     ...
     *            The ematrix context of the request.
     * @param args
     *            holds context object id,fileName
     * @returns nothing
     * @throws Exception
     * @since R213
     */
    ...
    private void generateTransformatedImages(Context context, Map objMap) throws Exception {
        try {
            ...
            for (int i = 0; i < fileNames.size(); i++) {
                ...
                /*
                 * Commented for IR-047886V6R2011x, this check is not required after the fix is done for IR-047901V6R2011x if(strImageFormat.equalsIgnoreCase(fileExt)){ strImageFormat = fileExt; }
                 */
    ...
    /**
     * This method is used to generate the new thumbnail image and places in workspace path based on the drawImage param Assumption: Only JPEG format will be the output irrespective of the image
     * format inputs.
     * @param context
     *            The ematrix context of the request.
     ...
     * @param imageWidth
     * @param imageHeight
     * @param strImageUtilityLoc
     *            Location of the image magick.
     * @param drawImage
     * @throws Exception
     * @since AppsCommon
     */

    public void generateImageThumbnail(Context context, String strWorkspacePath, String strSourceFileName, String strNewFileName, int imageWidth, int imageHeight, Image image, boolean drawImage)
            throws Exception {
    ...
    public void generateImageThumbnail(Context context, String strWorkspacePath, String strSourceFileName, String strNewFileName, int imageWidth, int imageHeight, Image image) throws Exception {
        generateImageThumbnail(context, strWorkspacePath, strSourceFileName, strNewFileName, imageWidth, imageHeight, image, false);
    }

    /**
     * This method is used to generate the thumbnail from the image file using either image magick or nConvert.
     * @param context
     *            The ematrix context of the request.
     * @param strWorkspacePath
     *            The wordspace path.
     ...
     */
    public void generateImageUtilityThumbnail(Context context, String strWorkspacePath, String strSourceFileName, String strNewFileName, int imageWidth, int imageHeight, String strImageUtilityLoc)
            throws Exception {
        ...
        if (UTILITY_NAME.equalsIgnoreCase(NCONVERT)) {
            ...
            generateImageUtilityThumbnailnConvert(context, strWorkspacePath, strSourceFileName, strNewFileName, imageWidth, imageHeight, strImageUtilityLoc);
            return;
        }
        // nconvert code ends
        ...
        // Image Magick code starts
            ...
            generateImageUtilityThumbnailImagick(context, strWorkspacePath, strSourceFileName, strNewFileName, imageWidth, imageHeight, strImageUtilityLoc);
            return;
        }
        // Image Magick code ends
    }

    /**
     * This method is used to generate the thumbnail from the image file using image magick.
     * @param context
     *            The ematrix context of the request.
     * @param strWorkspacePath
     *            The wordspace path.
    ...
    public void generateImageUtilityThumbnailImagick(Context context, String strWorkspacePath, String strSourceFileName, String strNewFileName, int imageWidth, int imageHeight,
            String strImageUtilityLoc) throws Exception {
        ...
        /*
         * IR-047901V6R2011x For jpg image if (newFile.exists()){ newFile.delete(); }
         */
        ...
        if (!bSucess) {
            String errorMessage = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(context.getSession().getLanguage()), "emxComponents.Image.ImageConversionFail");
    ...
    /**
     * This method is used to generate the thumbnail from the image file using nConvert.
     * @param context
     *            The ematrix context of the request.
     * @param strWorkspacePath
     *            The wordspace path.
     ...
     * @since AppsCommon V6R2008-1
     */
    public void generateImageUtilityThumbnailnConvert(Context context, String strWorkspacePath, String strSourceFileName, String strNewFileName, int imageWidth, int imageHeight,
            String strImageUtilityLoc) throws Exception {
        java.io.File workingDirectory = new java.io.File(strWorkspacePath);
    ...
    /**
     * This method is used to get the base name of the file from the complete file name.
     * @param context
     *            The ematrix context of the request.
     * @param strFileName
     *            Thie complete name of the file.
    ...
    /**
     * This method is used to get the extension of the file from the complete file name.
     * @param context
     *            The ematrix context of the request.
     * @param strFileName
     *            Thie complete name of the file.
     ...
     *            The ematrix context of the request.
     * @param args
     *            holds context object id,new clone name,new close revision,vault
     * @return nothing
     * @since AppsCommon
     */
    public void copyImagesOnClone(Context context, String[] args) throws Exception {
        try {
            ...
            if (objectId == null || objectId.equals("null") || objectId.equals("") || newName == null || newName.equals("null") || newName.equals("") || newRev == null || newRev.equals("null")
                    || newRev.equals("")) {
                return;
            }
     ...
     *            The ematrix context of the request.
     * @param Packed
     *            arguments which has objectList, paramlist and imagedata
    ...
    public Vector getImageURLs(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            DomainConstants.MULTI_VALUE_LIST.add("format[" + format + "].file.name");
                ...
                if (imageHolderId != null && hasReadAccess) {
                    ...
                    if ("Yes".equalsIgnoreCase(primImgFromAltPath)) {
                        if ("Yes".equalsIgnoreCase(traverseAltPath)) {
                            altMap = getImagesFromAltPath(context, oidsArray[i], fileName, imageData, true, objMap);
                        ...
                        if (!UIUtil.isNullOrEmpty(fileName)) {
                            ...
                            tempString = searchFileBaseNameIgnoreCase(tempStringList, fileName);
                            if (tempString != null) {
                                BusinessObjectProxy bop = new BusinessObjectProxy(imageHolderId, format, tempString, false, false);
                                bopArrayList.add(bop);
                                indexList.add(i);
                            ...
                            if ("3dxml".equalsIgnoreCase(getFileExtension(fileName))) {
                                allCADImages.add(fileName);
                            }
                        } else {
            ...
            String imageViewerURL = !UIUtil.isNullOrEmpty(href) ? encodeURL(href) : "../components/emxImageManager.jsp?HelpMarker=emxhelpimagesview&amp;objectId=";
            ...
            if (!bopArrayList.isEmpty()) {
                try {
                    ...
                    prdImageUrls.insertElementAt("../common/images/brokenimage.png", (Integer) indexList.get(countIncr));
                }
            }
            ...
            while (imageItr.hasNext()) {
                ...
                finalImageURLs.add(getImageColumnInfo(imageSize, allCADImages, fcsImageURLs[count], count, (String) imageItr.next(), oidsArray[count], imageViewerLink, generateHTML,
                        (String) objectTypeList.get(count)));
                count++;
            }
    ...
    protected Object getImageColumnInfo(String imageSize, StringList allCADImages, String fcsImageURL, int count, String imageName, String oid, String imageViewerURL, boolean generateHTML,
            String objectType) {
        ...
        boolean is3dImage = allCADImages.contains(imageName) && ("3dxml".equals(getFileExtension(imageName)) || "cgr".equals(getFileExtension(imageName)));
    ...
    protected Object getImageColumnInfo(String imageSize, StringList allCADImages, String fcsImageURL, int count, String imageName, String oid, String imageViewerURL, boolean generateHTML) {
        return getImageColumnInfo(imageSize, allCADImages, fcsImageURL, count, imageName, oid, imageViewerURL, generateHTML, null);
    }

    private Map objectMap;

    /**
     * This method is used to get the URLs for the Images in Thumbnail format and mxImage foramt in addition to the fileNames and Sequence Numbers.
     * @param context
     *            The ematrix context of the request.
     * @param Packed
     *            arguments which has Context ObjectId, Image Object Id connected via PRIMARY IMAGE Relationship to the Context Object and Imagedata Map
    ...
    public Map getImagesFromImageObjects(Context context, String[] args) throws Exception {
        ...
        if (strPrimaryImageObjectId != null) {
            ...
            String strNames = "";
            String strId = "";
            MapList mlImageList = object.getRelatedObjects(context, DomainConstants.RELATIONSHIP_IMAGES, DomainConstants.TYPE_IMAGE, objselects, relselects, false, true, (short) 1,
    ...
    /**
     * This method is used in the trigger and is called on checkin of the file. Gets the Image Holder Id, Name of the file being checked in and format of the file as input. First the method checks if
     * the format is generic and the file extension is cgr or 3dxml and then it proceeds to execute the * desired logic.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            holds ImageHolderId,checkinfilename,format
     * @return nothing
     * @since AppsCommon 10.7.SP1
     */
    public void uploadProcessCADFiles(matrix.db.Context context, String[] args) throws Exception {
        ...
        if ((genericFormat.equalsIgnoreCase(fileFormat) && strFileName != null && !"".equals(strFileName) && !"null".equals(strFileName) && imageHolderId != null && !"".equals(imageHolderId)
                && !"null".equals(imageHolderId)) && ("3dxml".equalsIgnoreCase(fileExtn) || "cgr".equalsIgnoreCase(fileExtn))) {
            ...
            if (strFirstFileName != null && !"".equals(strFirstFileName.trim())) {
                ...
                if (!"jpg".equals(getFileExtension(strFirstFileName).toLowerCase())) {
                    if (imageUtility != null && !"".equals(imageUtility) && !"null".equals(imageUtility)) {
                        generateImageUtilityThumbnail(context, strWorkspacePath, strFirstFileName, strNewFileName, imgWidth, imgHeight, imageUtility);
                    } else {
                        generateImageThumbnail(context, strWorkspacePath, strFirstFileName, strNewFileName, imgWidth, imgHeight, null);
                    }
            ...
            /*
             * if(strFirstFileName != null && !"".equals(strFirstFileName.trim())) { checkinFilesInImagesFormats(context, imageHolderId, strWorkspacePath, strFirstFileName, strNewFileName); }
             * 
             * java.io.File tmpFile = new java.io.File(strWorkspacePath, strFileName); tmpFile.delete(); tmpFile = new java.io.File(strWorkspacePath, strFirstFileName); tmpFile.delete(); if
             * (!strFirstFileName.equalsIgnoreCase(strNewFileName)) { tmpFile = new java.io.File(strWorkspacePath, strNewFileName); tmpFile.delete(); } if ("cgr".equalsIgnoreCase(fileExtn)) { tmpFile
             * = new java.io.File(strWorkspacePath, getFileBaseName(strFileName)+".3dxml"); tmpFile.delete(); }
             */
        }
    }

    /**
     * This method is used in the trigger and is called on checkin of the file. Gets the Document Id, Name of the file being checked in and format of the file as input. First the method checks if the
     * format is generic and the file extension is ImageHolder Supported Format and then it proceeds to execute the * desired logic.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            holds ImageHolderId,strFileName,fileFormat
     * @return nothing
    ...
    public void checkinThumbnailImagetoDocument(Context context, String args[]) throws Exception {
        ...
        if (checkImageFormat(context, supportedFormat)) {
            try {
                String imageUtility = EnoviaResourceBundle.getProperty(context, "emxComponents.ImageManager.ImageUtility.Directory");
                ...
                if ((genericFormat.equalsIgnoreCase(fileFormat) && strFileName != null && !"".equals(strFileName) && !"null".equals(strFileName) && docObjectID != null && !"".equals(docObjectID)
                        && !"null".equals(docObjectID) && !("3dxml".equalsIgnoreCase(fileExtn) || "cgr".equalsIgnoreCase(fileExtn)))) {
                    String strWorkspacePath = context.createWorkspace();
                    FileList files = new FileList();
                    matrix.db.File file = new matrix.db.File(strFileName, genericFormat);
                    files.addElement(file);
                    ...
                    if (strImageHeight != null && !"".equals(strImageHeight)) {
                        ...
                        if (imageUtility != null && !"".equals(imageUtility) && !"null".equals(imageUtility)) {
                            generateImageUtilityThumbnail(context, strWorkspacePath, tempFileName, strNewFileName, imageWidth, imageHeight, imageUtility);
    ...
    /**
     * This method is used to copy the contents from the given Inputstream to output stream
     * @param InputStream
     *            for source,OutputStream for destination
     * @return nothing
     * @since AppsCommon
     */

    public static void copyFiles(InputStream inStr, OutputStream outStr) throws IOException {
    ...
    /**
     * This method is called in "uploadProcessCADFiles" method i.e. the trigger method. It gets the name of the 3dxml file and the path where the file exists as input. It extracts the image file from
     * the 3dxml file if any exists, and copies it to the workspace path and returns the name of the copied file.
     * @param String
     *            workspace path,String filename of the 3dxml
     ...
     */
    public static String extractImageFrom3DXMLFile(String workspacePath, String fileName) throws Exception {
        return extractImageFrom3DXMLFile(null, workspacePath, fileName);
    }

    /**
     * This method is called in "checkinThumbnailImagetoDocument" method i.e. the trigger method. It gets the name of the Image file and the path where the file exists as input. It extracts the image
     * file from the file and scales down to 0.80% of the Image and copies it to the workspace path and returns the name of the copied file.
     * @param String
     *            strWorkspacePath,String filename of the Image
    ...
    /**
     * This method is called in "uploadProcessCADFiles" method i.e. the trigger method. It converts any image file which is obtained as input to the .jpg file and also converts it in different formats
     * like thumbnail, small, medium etc. and then checks in those files in the respective formats.
     * @param context
     *            The ematrix context of the request.
     * @param String
     *            imageholder object id,String workspace path,String childfilename,String newfilename
     * @return nothing @ Checkin the thmnbnail format files to object
     * @since AppsCommon
     */

    public void checkinFilesInImagesFormats(Context context, String imageHolderId, String strWorkspacePath, String strChildFileName, String sbNewFileName) throws Exception {
        DomainObject object = DomainObject.newInstance(context, imageHolderId);
        StringList fileList = new StringList(1);
        String policy = object.getInfo(context, "policy");
        String cmd = "print policy '" + policy + "' select format dump |";
        String formats = MqlUtil.mqlCommand(context, cmd);
        String strImageFormat = "jpg";
        ...
        if (!"jpg".equals(getFileExtension(strChildFileName).toLowerCase())) {
            if (imageUtility != null && !"".equals(imageUtility) && !"null".equals(imageUtility)) {
                generateImageUtilityThumbnail(context, strWorkspacePath, strChildFileName, sbNewFileName, imgWidth, imgHeight, imageUtility);
            } else {
                generateImageThumbnail(context, strWorkspacePath, strChildFileName, sbNewFileName, imgWidth, imgHeight, null);
            }
        ...
        while (formatItr.hasNext()) {
            ...
            if (!format.equals(FORMAT_MX_IMAGE) && !format.equals(PropertyUtil.getSchemaProperty(context, "format_3DXML"))) {
                ...
                if (strImageHeight != null && !"".equals(strImageHeight)) {
                    ...
                    if (imageUtility != null && !"".equals(imageUtility) && !"null".equals(imageUtility)) {
                        generateImageUtilityThumbnail(context, strWorkspacePath, sbPrimaryFileName.toString(), sbNewFileName, imageWidth, imageHeight, imageUtility);
                    } else {
                        generateImageThumbnail(context, strWorkspacePath, sbPrimaryFileName.toString(), sbNewFileName, imageWidth, imageHeight, image);
                    }
                    object.checkinFromServer(context, true, true, format, null, fileList);
                }
            }
    ...
    /**
     * This method is used to get thumbnail urls, Image urls of the alt path images (cgr and 3dxml) to support the 3dxml integration feature.
     * @param context
     *            The ematrix context of the request.
     * @param Packed
     *            arguments which has Context ObjectId,imageData using UINavigatorUtil.getImageData(context,pageContext)
    ...
    public HashMap getAltPathImages(Context context, String[] args) throws Exception {
        ...
        imageMap = getImagesFromAltPath(context, parentId, null, imageData, false, new HashMap());
        return imageMap;
    }

    /**
     * This method is called from getImageURLS and getAltPathImages. All the CAD Images and 2D images connected to alt path are obtained by this method and are returned through the Hash map, along
     * with the URLs. This is used two cases 1) To obtain the primary image from alt path 2) obtain all the alt path images and their modify access.
     * @param context
     *            The ematrix context of the request.
     * @param parentId
     *            to hold Parent object Id
     * @param primaryImage
     *            to hold Primary Image Name
     * @param imageData
     *            to hold imageData object
     * @param forPrimaryImage
     *            to hold if for Primary Image
     * @return Map containing Thumbnailurls,imageurls,modifyaccess on the parent object.
     * @since AppsCommon 10.7.SP1
     */
    public HashMap getImagesFromAltPath(Context context, String parentId, String primaryImage, HashMap imageData, boolean forPrimaryImage, Map imageInfo) throws Exception {
        ...
        try {
            ...
            if (altPathList != null && altPathList.size() > 0 && altPathListLength == altCgrFormatListLength && altPathListLength == altXmlFormatListLength
                ...
                for (int i = 0; i < altPathList.size(); i++) {
                    ...
                    try {
                        ...
                        String Output = MqlUtil.mqlCommand(context, "print bus " + parentId + " select " + strKey + " dump |");
                        objectsList = (StringList) FrameworkUtil.split(Output, "|");
                        // TIGTK-14837 END
                    ...
                    if (objectsList != null && objectsList.size() > 0) {
                        ...
                        for (int j = 0; j < objectsList.size(); j++) {
                            ...
                            if (("true".equalsIgnoreCase((String) altObjectMap.get("type.kindof[" + TYPE_3DXML + "]"))
                                    ...
                                    || "true".equalsIgnoreCase((String) altObjectMap.get("type.kindof[" + TYPE_THUMBNAIL + "]"))) && !processedObjects.contains(CADImageID)) {
                                ...
                                // String viewParentId = (String)altObjectMap.get("to["+REL_VIEWABLE+"].from.id");
                                ...
                                if (xmlViewable != null && xmlFiles != null && xmlFiles.size() > 0) {
                                    for (int k = 0; k < xmlFiles.size(); k++) {
                                        ...
                                        if (fileName != null && !"".equals(fileName.trim()) && !CheckforDuplicate.contains(fileName)) {
                                ...
                                if (thumbnailViewable != null && thumbnailFiles != null && thumbnailFiles.size() > 0) {
                                    for (int k = 0; k < thumbnailFiles.size(); k++) {
                                        ...
                                        if (fileName != null && !"".equals(fileName.trim())
                                            ...
                                            if (returnToCaller == false && forPrimaryImage && (primaryImage != null && !"".equals(primaryImage.trim()) && fileName.equals(primaryImage))
                        ...
                        if (objectsList.size() > 0 && (!returnToCaller)) {
                            for (int j = 0; j < objectsList.size(); j++) {
                                ...
                                if (parentId != null && !parentId.equals(CADImageID) && !altPathObject.isLastRevision(context)) {
                                ...
                                if (altCgrFormatList != null && altXmlFormatList != null && altThumbnailFormatList != null && altPathListLength == altCgrFormatListLength
                                        && altPathListLength == altXmlFormatListLength && altPathListLength == altThumbnailFormatListLength) {
                                ...
                                if (formatList != null && formatList.size() > 0
                                        && (formatList.contains(alt3dxmlFormat) || formatList.contains(altCgrFormat) || formatList.contains(altThumbnailFormat))) {
                                    ...
                                    if ((xmlFileList != null && xmlFileList.size() > 0) || (cgrFileList != null && cgrFileList.size() > 0)
                                        ...
                                        if (forPrimaryImage) {
                                            ...
                                            while (thumbnailItr.hasNext()) {
                                                ...
                                                if (fileName != null && !"".equals(fileName.trim())
                                                    ...
                                                    if (Image2dFormatList.contains(fileExt.toLowerCase()) && altPathListLength == altThumbnailFormatListLength) {
                                                        CheckforDuplicate.add(fileName);
                                                        ArrayList templist = new ArrayList();
                                                        String[] tempArray;
    ...
    /**
     * This method is used to search and get the altpath expression for context type
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            holds type,vault,altpath setting string,optional suffix
    ...
    /**
     * This method is called by getAltPathFromParent() method to get the altpath expression for specified type
     * @param context
     *            The ematrix context of the request.
     * @param symbolicType
     *            String holds Symbolic name of the type
     * @param vault
     *            String holds vault name
     * @param prefix
     *            String holds prefix to be added to form the key
     * @param suffix
     *            String holds suffix to be added to form the key
     * @return String alt path expression
     * @since AppsCommon 10.7.SP1
     */
    ...
    /**
     * This method is used to prepare the manifest.xml contents which is used in 3dxml file creation
     * @param String
     *            fileName of the 3dxml
    ...
    /**
     * This method is used to prepare the 3dxml file contents for the creation of 3dxml file.
     * @param String
     *            encoded cgr contents and String filename of the 3dxml
     ...
     * @param fileNameCollection
     *            collection of String objects
     * @param searchBaseFileName
     *            string to be searched in sourceColletion
     * @return String the Filename whose base name mathhes searchString in this list of the first occurrence of the specified element, or -1 if this list does not contain this element
     * @since AppsCommon 10.7.SP1
     */
    ...
    public static String searchFileBaseNameIgnoreCase(Collection fileNameCollection, String FileName) {
        try {
            if (fileNameCollection != null && FileName != null && !"".equals(FileName.trim())) {
                Iterator itr = fileNameCollection.iterator();
                for (int i = 0; itr.hasNext(); i++) {
                    String collElement = (String) itr.next();
                    if (collElement.contains(getFileBaseName(FileName) + ".")) {
                        return collElement;
                    }
                }
            }
     ...
     * @param imageList
     *            StringList of image names
     * @param forFormatList
     *            StringList of file extensions list
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds one argument args[0] - imageHolderID - id of the from Object
    ...
    /**
     * Method verifies if the format of the file to be checked-in is supported. If the format is supported, it returns true.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public void deletePreviousVersionThumbnailImages(Context context, String objectid, String newfile) throws Exception {
        String filename = MqlUtil.mqlCommand(context, "print bus $1 select $2 dump $3", objectid, "format[mxMedium Image].file.name", "|");
