...
public class emxRoleUtilBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    protected RoleList getChildRoles(Context context, Role matrixRole) throws FrameworkException {
        RoleList roleList;
        try {
            roleList = RoleUtil.getChildRoles(context, matrixRole);
        } catch (Exception e) {
            throw new FrameworkException(e);
        }
        return roleList;
    ...
    public String getRolesTypeHTML(Context context, String[] args) throws FrameworkException {
        try {
            ...
            sb.append(EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.Common.Role"));
            return sb.toString();
