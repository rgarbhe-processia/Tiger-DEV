...
/**
 * The <code>emxLibraryCentralClassificationRule</code> class contains utility methods for disconnecting the non released revisions
...
public class emxLibraryCentralClassificationRule_mxJPO extends emxLibraryCentralClassificationRuleBase_mxJPO {
    ...
    public emxLibraryCentralClassificationRule_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
