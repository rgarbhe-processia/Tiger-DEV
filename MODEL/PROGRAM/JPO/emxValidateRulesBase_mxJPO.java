...
public class emxValidateRulesBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     *             if the operation fails
     * @since ProductCentral 10.0.0.0
     * @grade 0 referenced for migration
     */
     ...
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.0.0.0 referenced for migration
     */
     ...
     * @param strExp
     *            The expression from which the Feature Option pairs need to be separated out
     * @param cDelimiter
     *            The delimiter on the basis of which the Expression will be Tokenized
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            String Product ObjectId
     * @return Map contains key value pairs for all the BCR objects found related to the Product key-> String:name of BCR object value->ArrayList:contains 2 strings for Left and Right Expressions
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.0.0.0 referenced for migration
     */
    ...
    /**
     * Method to check whether all the feature Option pairs List obtained from the expression. is present in the All feature Option List.
     * @param expList
     *            List containing Strings of feature Option TNR
     * @param allFOMapList
     *            MapList containing Maps. The Map contains 2 elements : effective Seq num and TNR of Feature Option
     * @return boolean: true : if all the Strings of expList are present in the Maps of allFOMapList false : else false
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.0.0.0
     * @grade 0 referenced for migration
     ...
     * @param strTNR
     *            String The string having T::N::R~T::N::R format
     ...
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param invalidReferenceList
     *            list containing invalid feature options.
     * @param strObjectId
     *            object id of product or feature..
     * @param changeValFlag
     *            flag indicating to change the validity status of the BCR .
     * @param fromProductFlag
     *            flag indicating whether the object is product or feature.
     ...
     * @param expList
     *            List containing the expressions of BCR
     * @param allFOMapList
     *            list containing all feature options.
     ...
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.5 referenced for migration
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            object id of the BCR
     * @param strValidationValue
     *            String containing validation value
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.0.0.0
     * @grade 0 referenced for migration
     ...
     *            - Object id of the BCR
     * @param isLeft
     *            - boolean value indicating whether to consider left expression or right expression of the rule.
     ...
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param strFeatureListID
     *            - Object id of the Feature list
    ...
    public int promoteRules(Context context, String args[]) throws Exception {
         ...
         */
        String strComma = ",";
        String strRelationshipPattern = ProductLineConstants.RELATIONSHIP_BOOLEAN_COMPATIBILITY_RULE + strComma + ProductLineConstants.RELATIONSHIP_PRODUCT_RULEEXTENSION + strComma
    ...
    public int demoteRules(Context context, String args[]) throws Exception {
        ...
        setId(objectId);
        /*
         * The relationship pattern is initialized to obtain all the rules and feature list connectedto the product object. These object will be demoted to preliminary state when the product objectis
         * promoted to release state.
         */
        String strComma = ",";
        String strRelationshipPattern = ProductLineConstants.RELATIONSHIP_BOOLEAN_COMPATIBILITY_RULE + strComma + ProductLineConstants.RELATIONSHIP_PRODUCT_RULEEXTENSION + strComma
