 ...
 **
 ** Copyright (c) 1993-2015 Dassault Systemes. All Rights Reserved. This program contains proprietary and trade secret information of MatrixOne, Inc. Copyright notice is precautionary only and does not
...
public class emxCustomTableDynamicMenu_mxJPO extends emxCustomTableDynamicMenuBase_mxJPO {
     ...
     * @grade 0
     */
    public emxCustomTableDynamicMenu_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
