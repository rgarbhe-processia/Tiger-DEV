...
public class MCADIntegGetLatestInWorkRevisionBase_mxJPO {
    ...
    public MCADIntegGetLatestInWorkRevisionBase_mxJPO() {
    }

    public MCADIntegGetLatestInWorkRevisionBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    public Hashtable getLatestForObjectIds(Context context, String[] args) throws Exception {
        ...
        retTable = util.getObjectIdForParticularView(context, "state_Preliminary", args);
