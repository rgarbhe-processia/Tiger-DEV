 ...
 **
 ** This program is used as a check trigger on the events on versioned types.The purpose of this program is to control access to the versioned type objects through the access on on the corresponding
 * major type object.
 **
 ** Parameters - sEvent - Event name sOID - versioned type object's id
 ** 
 ** Returns - 0 - if access for the input event is found on the corresponding major object 1 - if access for the input event is not found on the corresponding major object
 ** 
 **
 */
...
public class MCADLockVersionedTypeToMajorType_mxJPO {
    ...
    public int checkMajorAccess(Context context, String[] args) throws Exception {
        ...
        if ((sAccess.equals("Modify") || isDataModelRelationshipsConnnectOrDisconnect) && (isCheckin || isCheckinEx)) {
            ...
            if ((majorObjId.equals("") || majorExist.equals("false") || majorExist.equals("FALSE")) && (sAccess.equals("ChangeOwner") || sAccess.equals("CheckIn") || sAccess.equals("Modify")
                    || sAccess.equals("ToConnect") || sAccess.equals("FromConnect") || sAccess.equals("ToDisconnect") || sAccess.equals("FromDisconnect") || sAccess.equals("Delete")
                    || sAccess.equals("ChangeType") || sAccess.equals("ChangePolicy") || sAccess.equals("ChangeName"))) {
                returnValue = 0;
            } else {
        ...
        if (returnValue == 0 && !isCheckin && !isCheckinEx && !isAttributeSynch && !isLockUnlock && !isCheckout && !isCheckoutEx) {
