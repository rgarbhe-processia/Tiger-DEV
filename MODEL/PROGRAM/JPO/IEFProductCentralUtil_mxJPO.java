...
/**
 * The <code>IEFProductCentralUtil</code> class represents the JPO for obtaining the MS Office integration menus
...
public class IEFProductCentralUtil_mxJPO {
    ...
    /**
     * Get Products of a the current user Returns a maplist of the current users Product ids
     * @param context
     *            the eMatrix <code>Context</code> object
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * Get the folders of a Product Returns a maplist of features
     * @param context
     *            the eMatrix <code>Context</code> object
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * Get the sub folders of a Product Returns a maplist of sub features
     * @param context
     *            the eMatrix <code>Context</code> object
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * Get the requirements of a Product Returns a maplist of requirements
     * @param context
     *            the eMatrix <code>Context</code> object
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * Get the builds of a Product Returns a maplist of builds
     * @param context
     *            the eMatrix <code>Context</code> object
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * Get the test cases of a Product Returns a maplist of test cases
     * @param context
     *            the eMatrix <code>Context</code> object
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * Get the use cases of a Product Returns a maplist of use cases
     * @param context
     *            the eMatrix <code>Context</code> object
     * @throws Exception
     *             if the operation fails
