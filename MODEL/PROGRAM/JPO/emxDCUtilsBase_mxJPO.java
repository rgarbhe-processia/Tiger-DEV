...
/**
 * The <code>${CLASSNAME}</code> class is used to for DocumentCentral Utilty Programs
 * @exclude
 */

public class emxDCUtilsBase_mxJPO implements LibraryCentralConstants {

    public static final String SELECT_ATTR_FIRST_NAME = "attribute[" + ATTRIBUTE_FIRST_NAME + "]";

    public static final String SELECT_ATTR_LAST_NAME = "attribute[" + ATTRIBUTE_LAST_NAME + "]";
     ...
     * @since DC 10.5
     */
    public emxDCUtilsBase_mxJPO(Context context, String[] args) throws Exception {
        /*
         * Author : DL Date : 11/7/2002 Notes : History :
         */
    ...
    /**
     * Get Maplist containing Revisions Infor for Id passed In Used for Revision Summary Page
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public static MapList getRevisions(Context context, String[] args) throws Exception {
        ...
        /*
         * Author : AnilJ Date : 11/7/2002 Notes : History :
         */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Java <code>HashMap</code>, programMap with the following entries: objectList - a MapList with Java <code>Map</code> containing one String entry for the eMatrix
     *            <code>WorkspaceVault</code> id paramList - a Java <code>HashMap</code> containing list of request parameters list including: languageStr - language to localize to.
     * @return Vector object that contains a vector of html code to construct the Lock Column.
     * @throws Exception
     *             if the operation fails
     * @since DC 10.5
     */
    public static Vector getFolderAttributeGlobalReadValues(Context context, String[] args) throws Exception {
        ...
        MapList foldersDetailMapList = DomainObject.getInfo(context, objectIds, selectList);

        for (int i = 0; i < foldersDetailMapList.size(); i++) {
            Map folderMap = (Map) foldersDetailMapList.get(i);
            String attrGlobalReadValue = (String) folderMap.get("attribute[" + ATTRIBUTE_GLOBAL_READ + "]");

            i18nNow loc = new i18nNow();

            // if attribute value is false, security is private
            //
            String localizedValue = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.CreateFolder.Private");

            // else security is global
            //
            if (attrGlobalReadValue != null && attrGlobalReadValue.equalsIgnoreCase("True")) {
                localizedValue = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.CreateFolder.Global");
            }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Java <code>HashMap</code>, programMap with the following entries: objectList - a MapList with Java <code>Map</code> containing one String entry for id of the
     *            BusinessObject to which lock info is obtained paramList - a Java <code>HashMap</code> containing list of request parameters list including: languageStr - language to localize to.
     * @return Vector object that contains a vector of html code to construct the Lock Column.
     * @throws Exception
     *             if the operation fails
     * @since DC 10.5
    ...
    public static Vector getLockIcon(Context context, String[] args) throws Exception {
        ...
        String sLockedby = i18obj.GetString("emxDocumentCentralStringResource", locale, "emxDocumentCentral.Common.LockedBy");
        ...
        if (relBusObjPageList != null) {
            ...
            while (iterator.hasNext()) {
                ...
                if (lock.equalsIgnoreCase("TRUE")) {
                    ...
                    lockInfo.add("<img border='0' " + "src='images/iconStatusLocked.gif' " + "alt=\"" + sLockedby + " " + XSSUtil.encodeForHTML(context, formatedLocker) + "\"/>");
                } else {
                    lockInfo.add(" ");
                }
     ...
     * @param args
     *            contains a Java <code>HashMap</code>, programMap with the following entries: objectList - a MapList with Java <code>Map</code> containing one String entry for id of the
     *            BusinessObject on which Owner info is obtained
     ...
     * @param args
     *            contains a Java <code>HashMap</code>, programMap with the following entries: objectList - a MapList with Java <code>Map</code> containing one String entry for id of the
     *            BusinessObject on which Originator info is obtained
     * @returns Java <code>Vector</code> containing Originator information
     * @throws Exception
     *             if the operation fails
     * @since DC 10.5
     */
    public Vector showOriginator(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objectList = (MapList) programMap.get("objectList");
     ...
     * @param args
     *            contains a Java <code>HashMap</code>, programMap with the following entries: objectList - a MapList with Java <code>Map</code> containing one String entry for id of the
     *            BusinessObject on which Approver info is obtained
     * @returns Java <code>Approver</code>
     * @throws Exception
     *             if the operation fails
     * @since DC 10.5
     */
    public Vector showApprover(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objectList = (MapList) programMap.get("objectList");
                ...
                while (objectInfoIterator.hasNext()) {
                    ...
                    if (typeName != null && !typeName.equals("null") && !typeName.equals("")) {
                        ...
                        if (typeName.equalsIgnoreCase(strLibrary)) {
                            typeName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.Library");
                        } else if (typeName.equalsIgnoreCase(strBook)) {
                            typeName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.Book");
                        } else if (typeName.equalsIgnoreCase(strBookShelf)) {
                            typeName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.BookShelf");
                        } else if (typeName.equalsIgnoreCase(strDocument)) {
                            typeName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.Document");
                        } else if (typeName.equalsIgnoreCase(strGeneric_Document)) {
                            typeName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.Generic_Document");
                        } else if (typeName.equalsIgnoreCase(strDocument_Sheet)) {
                            typeName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.Document_Sheet");
                        }
                        // added for the bug 314802
                        else if (typeName.equalsIgnoreCase(strworkSpaceVault)) {
                            typeName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.WorkSpaceVault");
                        }
                ...
                while (objectInfoIterator.hasNext()) {
                    ...
                    if (stateName != null && !stateName.equals("null") && !stateName.equals("")) {
                        ...
                        if (stateName.equalsIgnoreCase("Create")) {
                            stateName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.Create");
                        } else if (stateName.equalsIgnoreCase("Approved")) {
                            stateName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.Approved");
                        } else if (stateName.equalsIgnoreCase("Review")) {
                            stateName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.Review");
                        } else if (stateName.equalsIgnoreCase("Locked")) {
                            stateName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.Locked");
                        } else if (stateName.equalsIgnoreCase("WIP")) {
                            stateName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.WIP");
                        } else if (stateName.equalsIgnoreCase("Released")) {
                            stateName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.Released");
                        } else if (stateName.equalsIgnoreCase("Obsolete")) {
                            stateName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.Obsolete");
                        } else if (stateName.equalsIgnoreCase("ACTIVE")) {
                            stateName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.ACTIVE");

                        } else if (stateName.equalsIgnoreCase("IN-ACTIVE")) {
                            stateName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.IN-ACTIVE");
                        } else if (stateName.equalsIgnoreCase("Exists")) {
                            stateName = loc.GetString("emxDocumentCentralStringResource", languageStr, "emxDocumentCentral.Common.Exists");
                        }
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getAllFolders(Context context, String[] args) throws Exception {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getAllTopLevelFolders(Context context, String[] args) throws Exception {
     ...
     * @since LC 10.6.SP2
     */
    protected MapList getFolders(Context context, String[] args, String whereExpression) throws Exception {
        try {
            ...
            MapList mpList = DomainObject.findObjects(context, PropertyUtil.getSchemaProperty(context, "type_ProjectVault"), "*", "", "*", "*", whereExpression, false, busSelects);
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getFoldersIOwn(Context context, String[] args) throws Exception {
        StringBuffer where = new StringBuffer(DomainConstants.EMPTY_STRING);
        where.append("(");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing the parameters - Object id
     * @return Maplist of sub-folders
     * @throws Exception
     *             if the operation fails
     * @since LC 10.6.SP2
     */
    public static MapList getSubFolderList(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        try {
            ...
            folderList = domainObject.getRelatedObjects(context, DomainObject.RELATIONSHIP_SUB_VAULTS, DomainObject.TYPE_PROJECT_VAULT, typeSelects, new StringList(), false, true, (short) 1, null,
                    null);
        } catch (Exception e) {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getTopLevelFoldersIOwn(Context context, String[] args) throws Exception {
        StringBuffer where = new StringBuffer(DomainConstants.EMPTY_STRING);
        where.append("(");
        where.append(DomainConstants.SELECT_OWNER);
        where.append("==\"");
    ...
    /**
     * getMyCheckedOutDocs - Get the list of Master Documents which have at least one file (Version Document) checked out by context user
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    public MapList getMyCheckedOutDocs(Context context, String[] args) throws Exception {
        try {
            ...
            MapList tempList = DomainObject.findObjects(context, TYPE_DOCUMENTS, "*", objectWhere, busSelects);
            ...
            if (tempList != null && tempList.size() > 0) {
                for (int i = 0; i < tempList.size(); i++) {
                    ...
                    if (id != null && !"".equals(id) && !"null".equals(id) && !processedIdsList.contains(id)) {
     ...
     * 
     * @return the Java <code>boolean</code> true or false depending on object state and access
     * @throws Exception
     *             if the operation fails
     * @since AEF 10-5
     */

    public boolean showReviseLinks(Context context, String[] args) throws Exception {
        ...
        if (objectId != null) {
            ...
            showReviseLinks = (LibraryCentralCommon.hasReviseAccess(context, objectId) && domainObject.isLastRevision(context));
        }
        return showReviseLinks;
    }

    /**
     * Trigger to perform the promote check on a Document to Reeview State It does the following: - Ensure Approver is not empty
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds the following input arguments: 0 - objectId String
    ...
    public int checkApprover(Context context, String[] args) throws Exception {
        ...
        if (sApproverVal == null || "".equals(sApproverVal) || "null".equals(sApproverVal)) {
            ...
            throw new FrameworkException(
                    EnoviaResourceBundle.getProperty(context, "emxDocumentCentralStringResource", new Locale(context.getSession().getLanguage()), "emxDocumentCentral.Message.ApproverEmtpy"));
        }
        return checkApprover;
    }

    /**
     * Checks whether the logged in user can create Document Sheet Object Create New link for creating document sheet object will be displayed on check of following condition 1. Parent Generic
     * document object should be in Create or WIP state
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Object Id of the Generic Document Object
    ...
    public boolean checkCreateAccessForDocumentSheet(Context context, String[] args) throws Exception {
    ...
    public MapList getAllDocumentsList(Context context, String[] args) throws Exception {
        try {
            ...
            MapList result = DomainObject.findObjects(context, TYPE_DOCUMENTS, "*", objectWhere.toString(), selectList);
            return result;
        } catch (Exception exp) {
    ...
    /**
     * Get the list of all the pending Documents of type Generic Document and DOCUMENT CLASSIFICATION
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    public MapList getPendingDocumentsList(Context context, String[] args) throws Exception {
        try {
            ...
            MapList result = DomainObject.findObjects(context, buf.toString(), "*", objectWhere.toString(), selectList);
            return result;
        } catch (Exception exp) {
            throw new Exception(exp.toString());
        }
    ...
    /**
     * Get the list of rejected Documents of type Generic Document and DOCUMENT CLASSIFICATION
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    public MapList getFolderContents(Context context, String[] args) throws Exception {
        ...
        relList.append(RELATIONSHIP_VAULTED_DOCUMENTS_REV2).append(",");

        MapList folderList = new MapList();
        try {
            StringList typeSelects = new StringList(1);
            typeSelects.add(DomainObject.SELECT_ID);
            folderList = domainObject.getRelatedObjects(context, relList.toString(), "*", typeSelects, new StringList(), false, true, (short) 1, null, null);
        } catch (Exception e) {
            throw new FrameworkException(e);
        }
        return folderList;
