...
public class emxCommonDownloadBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public emxCommonDownloadBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public static String getWhereExp(HashMap hmSearchElements) {
        ...
        while (iterator.hasNext()) {
            ...
            if (strSearchElementValue != null && (!strSearchElementValue.equals(DomainConstants.QUERY_WILDCARD)) && (!strSearchElementValue.equals(""))
    ...
    public MapList getRelatedParts(Context context, String[] args) throws Exception {
        ...
        if (PersonUtil.SEARCH_DEFAULT_VAULT.equalsIgnoreCase(strVaultOption) || PersonUtil.SEARCH_LOCAL_VAULTS.equalsIgnoreCase(strVaultOption)
        ...
        ExpansionIterator expIter = domDocument.getExpansionIterator(context, strRelName, strType, slSelect, new StringList(0), true, true, (short) 1, strWhereExp, "", sQueryLimit, true, false,
                (short) 100, false);
    ...
    public int create(Context context, HashMap mapParam) throws Exception {
        ...
        if (strDownloadHolderId == null || "".equals(strDownloadHolderId)) {
            ...
            MapList mapList = domDownloadHolder.getRelatedObjects(context, Download.RELATIONSHIP_HAS_DOWNLOAD, Download.TYPE_DOWNLOAD, slObjSelect, null, false, true, (short) 1, strObjectWhere, null);
            if (mapList.size() > 0) {
            ...
            createObjects(context, strDownloadHolderId, strDownloadId, strPartId, strDocumentId, "true".equalsIgnoreCase(strCreateUsage), "true".equalsIgnoreCase(strCreateDownload), mapUsageAttrInfo,
                    mapDownloadAttrInfo);
        }
        return 0;
    }
    ...
    private DomainObject createObjects(Context context, String strDownloadHolderId, String strDownloadId, String strPartId, String strDocumentId, boolean createUsage, boolean createDownload,
            Map usageAttributeInfo, Map downloadAttrInfo) throws Exception {
        ...
        if (strDownloadId == null || "".equals(strDownloadId)) {
            ...
            if (strDownloadHolderId == null) {
                ...
                domDownloadHolder.createAndConnect(context, Download.TYPE_DOWNLOAD_HOLDER, null, null, Download.POLICY_DOWNLOAD, null, Download.RELATIONSHIP_DOWNLOAD_HOLDER, Person.getPerson(context),
                        true);
        ...
        try {
            ...
            if (isWriteDownloadDocHistory) {
                String strhistory = "modify bus " + strDownloadObjectId + " add history Connect comment 'connect " + Download.RELATIONSHIP_DOWNLOAD_DOCUMENT + " to " + strDocInfo + "' ;";
                MqlUtil.mqlCommand(context, strhistory);
                strhistory = "modify bus " + strDocumentId + " add history Connect comment 'connect " + Download.RELATIONSHIP_DOWNLOAD_DOCUMENT + " from  " + strDownloadInfo + "' ;";
                MqlUtil.mqlCommand(context, strhistory);

            }
            if (isWriteDocUsageHistory) {
                String strhistory = "modify bus " + strDownloadObjectId + " add history Connect comment 'connect " + Download.RELATIONSHIP_DOCUMENT_USAGE + " to " + strDocInfo + "' ;";
                MqlUtil.mqlCommand(context, strhistory);
                strhistory = "modify bus " + strDocumentId + " add history Connect comment 'connect " + Download.RELATIONSHIP_DOCUMENT_USAGE + " from  " + strDownloadInfo + "' ;";
                MqlUtil.mqlCommand(context, strhistory);
            }

            if (isWriteDownloadContextHistory) {
                String strPartInfo = getTypeNameRevision(context, strPartId);
                String strhistory = "modify bus " + strDownloadObjectId + " add history Connect comment 'connect " + Download.RELATIONSHIP_DOWNLOAD_CONTEXT + " to " + strPartInfo + "' ;";
                MqlUtil.mqlCommand(context, strhistory);
                strhistory = "modify bus " + strPartId + " add history Connect comment 'connect " + Download.RELATIONSHIP_DOWNLOAD_CONTEXT + " from  " + strDownloadInfo + "' ;";
                MqlUtil.mqlCommand(context, strhistory);
            }
        }
        return domDownload;
    ...
    public Map getUsageIds(Context context, String[] args) throws Exception {
        ...
        MapList mapList = domPart.getRelatedObjects(context, Download.RELATIONSHIP_DOWNLOAD_CONTEXT, Download.TYPE_DOWNLOAD, slBusSelect, null, true, false, (short) 1, strBusWhere, null);
    ...
    public Vector getUsageIcon(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < mapList.size(); i++) {
            ...
            if (strUsageId == null) {
                ...
                strUsageId = "<a href=\"javascript:showModalDialog('../components/emxCommonUsageDialogFS.jsp?relId=" + XSSUtil.encodeForJavaScript(context, strUsageId) + "&amp;documentId="
                        + XSSUtil.encodeForJavaScript(context, strDocId) + "', 570, 520)\"><img border=\"0\" src=\"../common/images/iconSmallUsage.gif\"></img></a>";
            }
            vec.add(strUsageId);
        }
        return vec;
    ...
    public MapList getUsage(Context context, String[] args) throws Exception {
        ...
        if (strOriginator != null && !QUERY_WILDCARD.equals(strOriginator) && !"".equals(strOriginator)) {
            ...
            /*
             * ExpansionWithSelect expanSelList = domDownloadHolder.expandSelect(context, Download.RELATIONSHIP_HAS_DOWNLOAD, Download.TYPE_DOWNLOAD, slBusSelect, new StringList(), false, true,
             * (short)1, sbBusWhere.toString(), "", sQueryLimit, true); mapList = FrameworkUtil.toMapList(expanSelList);
             */
            ContextUtil.startTransaction(context, false);
            ExpansionIterator expIter = domDownloadHolder.getExpansionIterator(context, Download.RELATIONSHIP_HAS_DOWNLOAD, Download.TYPE_DOWNLOAD, slBusSelect, new StringList(0), false, true,
                    (short) 1, sbBusWhere.toString(), null, sQueryLimit, true, false, (short) 100, false);
            mapList = FrameworkUtil.toMapList(expIter, sQueryLimit, null, null, null, null);
            expIter.close();
            ContextUtil.commitTransaction(context);
            ...
            /*
             * ExpansionWithSelect expanSelList = domDocument.expandSelect(context, Download.RELATIONSHIP_DOCUMENT_USAGE, Download.TYPE_DOWNLOAD, slBusSelect, slRelSelect, true, false, (short)1, "",
             * sbRelWhere.toString(), sQueryLimit, true); mapList = FrameworkUtil.toMapList(expanSelList);
             */

            ContextUtil.startTransaction(context, false);
            ExpansionIterator expIter = domDocument.getExpansionIterator(context, Download.RELATIONSHIP_DOCUMENT_USAGE, Download.TYPE_DOWNLOAD, slBusSelect, slRelSelect, true, false, (short) 1, null,
                    sbRelWhere.toString(), sQueryLimit, true, false, (short) 100, false);
            mapList = FrameworkUtil.toMapList(expIter, sQueryLimit, null, null, null, null);
            expIter.close();
            ContextUtil.commitTransaction(context);
            ...
            slBusSelect.add("from[" + strSelWhere + "]." + SELECT_ORIGINATED);
            slBusSelect.add("from[" + strSelWhere + "]." + SELECT_ID);
            mapList = DomainObject.findObjects(context, Download.TYPE_DOWNLOAD, QUERY_WILDCARD, QUERY_WILDCARD, QUERY_WILDCARD, QUERY_WILDCARD, sbWhere.toString(), "", false, slBusSelect,
                    sQueryLimit);
        ...
        for (int i = 0; i < mapList.size(); i++) {
            ...
            if (bExport) {
                ...
                vec.add("<a href=\"javascript:emxTableColumnLinkClick('../components/emxCommonUsageDialogFS.jsp?refreshContent=true&relId=" + (String) map.get(SELECT_RELATIONSHIP_ID)
                        + "&documentName=" + XSSUtil.encodeForURL(context, XSSUtil.encodeForURL(context, (String) map.get("DocumentName")))
                        + "',%20'570',%20'520',%20'false',%20'popup',%20'')\"  class=\"object\"><img border=\"0\" src=\"images/iconActionEdit.gif\"></a>");
            }
        }
        return vec;
    }
    ...
    public Vector getOwner(Context context, String[] args) throws Exception {
        ...
        MapList mlPersonInfo = DomainObject.findObjects(context, TYPE_PERSON, sbPerNames.toString(), "*", null, null, "revision == last", false, slObjectSelects);
        ...
        for (int i = 0; i < mlPersonInfo.size(); i++) {
            ...
            if (bExportPrint) {
                strURL = XSSUtil.encodeForHTML(context, (String) map.get("attribute[" + ATTRIBUTE_LAST_NAME + "]")) + ", "
                        + XSSUtil.encodeForHTML(context, (String) map.get("attribute[" + ATTRIBUTE_FIRST_NAME + "]"));
            } else {
                strURL = strLink + XSSUtil.encodeForJavaScript(context, (String) map.get(SELECT_ID)) + "','570','520','false','popup','')\">"
                        + XSSUtil.encodeForHTML(context, (String) map.get("attribute[" + ATTRIBUTE_LAST_NAME + "]")) + ", "
                        + XSSUtil.encodeForHTML(context, (String) map.get("attribute[" + ATTRIBUTE_FIRST_NAME + "]")) + "</a>";
            }
    ...
    public Vector getDownloadNewWindow(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < mapList.size(); i++) {
            ...
            if (bExport) {
                ...
                vec.add("<a href=\"javascript:emxTableColumnLinkClick('../components/emxCommonDownloadEditDialogFS.jsp?relId=" + (String) map.get(SELECT_RELATIONSHIP_ID) + "&partName="
                        + XSSUtil.encodeForURL(context, XSSUtil.encodeForURL(context, (String) map.get("PartName"))) + "&documentName="
                        + XSSUtil.encodeForURL(context, XSSUtil.encodeForURL(context, (String) map.get("DocumentName"))) + "&originator="
                        + XSSUtil.encodeForURL(context, XSSUtil.encodeForURL(context, (String) map.get(SELECT_OWNER)))
                        + "',%20'570',%20'520',%20'false',%20'popup',%20'')\"  class=\"object\"><img border=\"0\" src=\"images/iconActionEdit.gif\"></a>");
            }
        }
        return vec;
    ...
    public MapList getDownloads(Context context, String[] args) throws Exception {
        ...
        if (strOriginator != null && !QUERY_WILDCARD.equals(strOriginator) && !"".equals(strOriginator)) {
            ...
            mapList = domDownloadHolder.getRelatedObjects(context, Download.RELATIONSHIP_HAS_DOWNLOAD, Download.TYPE_DOWNLOAD, slBusSelect, null, false, true, (short) 1, sbBusWhere.toString(), null);
            ...
            DomainObject domDocument = new DomainObject(strDocumentId);
            /*
             * ExpansionWithSelect expanSelList = domDocument.expandSelect(context, Download.RELATIONSHIP_DOWNLOAD_DOCUMENT, Download.TYPE_DOWNLOAD, slBusSelect, slRelSelect, true, false, (short)1,
             * "", sbBusWhere.toString(), sQueryLimit, true); mapList = FrameworkUtil.toMapList(expanSelList);
             */

            ContextUtil.startTransaction(context, false);
            ExpansionIterator expIter = domDocument.getExpansionIterator(context, Download.RELATIONSHIP_DOWNLOAD_DOCUMENT, Download.TYPE_DOWNLOAD, slBusSelect, slRelSelect, true, false, (short) 1,
                    null, sbBusWhere.toString(), sQueryLimit, true, false, (short) 100, false);
            mapList = FrameworkUtil.toMapList(expIter, sQueryLimit, null, null, null, null);
            expIter.close();
            ContextUtil.commitTransaction(context);
            mapListResult = new MapList(mapList.size());

            String strDocumentLink = "<a href=\"javascript:emxTableColumnLinkClick('../common/emxTree.jsp?emxSuiteDirectory=components&treeMenu=&objectId=" + strDocumentId
                    + "', '860', '520', 'false', 'popup')\">" + strDocumentName + "</a>";
        ...
        if (processMapList) {
            ...
            for (int i = 0; i < mapList.size(); i++) {
                ...
                if (objPartId != null) {
                    ...
                    strPartLink = "<a href=\"javascript:emxTableColumnLinkClick('../common/emxTree.jsp?emxSuiteDirectory=components&treeMenu=&objectId=" + (String) objPartId
                            + "', '860', '520', 'false', 'popup')\">" + strPartName + "</a>";
                }
                ...
                for (int j = 0; j < slId.size(); j++) {
                    ...
                    String strDocLink = "<a href=\"javascript:emxTableColumnLinkClick('../common/emxTree.jsp?emxSuiteDirectory=components&treeMenu=&objectId=" + slDocumentIds.get(0)
                            + "', '860', '520', 'false', 'popup')\">" + slDocumentNames.get(0) + "</a>";
