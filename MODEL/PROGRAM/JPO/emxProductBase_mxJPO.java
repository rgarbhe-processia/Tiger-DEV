...
/**
 * The <code>emxProductBase</code> class contains methods related to the admin type Products. This includes methods for the Filter, Create, Delete, Remove and Copy Products.
...
public class emxProductBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     */
    protected static final String SELECT_TASK_ACTUAL_FINISH_DATE = "attribute[" + DomainConstants.ATTRIBUTE_TASK_ACTUAL_FINISH_DATE + "]";

    /**
     * Alias used for select expression of attribute Estimated Finish Date.
     */
    protected static final String SELECT_TASK_ESTIMATED_FINISH_DATE = "attribute[" + DomainConstants.ATTRIBUTE_TASK_ESTIMATED_FINISH_DATE + "]";

    /**
     * Alias used for select expression of attribute Baseline Initial End Date.
     */
    protected static final String SELECT_BASELINE_INITIAL_END_DATE = "attribute[" + DomainConstants.ATTRIBUTE_BASELINE_INITIAL_END_DATE + "]";

    /**
     * Alias used for select expression of attribute Baseline Current End Date.
     */
    protected static final String SELECT_BASELINE_CURRENT_END_DATE = "attribute[" + DomainConstants.ATTRIBUTE_BASELINE_CURRENT_END_DATE + "]";
    ...
    /**
     * This method is used to get All the Products, connected to the context users company. This is invoked, when the Filter is set to All in the Products list page.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    /**
     * This method is used to get All the Products owned by the context user, connected to the context users company. This is invoked, when the Filter is set to Owned in the Products list page.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    /**
     * This method accepts WHERE condition and OWNER condition as parameters and retrives Products connected to the context users company from the database based on the conditions.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param whereCondition
     *            - String value containing the condition based on which results are to be filtered.
     * @param ownerCondition
     *            - String value containing the user name for owner of the Product object.
     * @return MapList - MapList containing the id of Product objects
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.0.0.0
    ...
    /**
     * This method is used to create a Product. This method is invoked from the Bean.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the FormBean contents
     * @throws Exception
     *             if the operation fails
    ...
    public String createProduct(Context context, String args[]) throws Exception {
        ...
        if (strStartEffectivity != null && strStartEffectivity.length() > 0) {
            ...
            strStartEffectivity = eMatrixDateFormat.getFormattedInputDate(strStartEffectivity, iClientTimeOffset, Local);

        }
        if (strEndEffectivity != null && strEndEffectivity.length() > 0) {
            strEndEffectivity = strEndEffectivity.trim();
            // If the field is date, get the value converted to input format
            strEndEffectivity = eMatrixDateFormat.getFormattedInputDate(strEndEffectivity, iClientTimeOffset, Local);
        }
        // HashMap to store the attribute name value pairs.
        // The attribute values to be set for the object are put in the map.
        //
        HashMap attributeMap = new HashMap();
        attributeMap.put(ProductLineConstants.ATTRIBUTE_MARKETING_NAME, strMarketingName);
        attributeMap.put(ProductLineConstants.ATTRIBUTE_MARKETING_TEXT, strMarketingText);
        attributeMap.put(ProductLineConstants.ATTRIBUTE_BASE_PRICE, strBasePrice);
        attributeMap.put(ProductLineConstants.ATTRIBUTE_END_EFFECTIVITY, strEndEffectivity);
        attributeMap.put(ProductLineConstants.ATTRIBUTE_START_EFFECTIVITY, strStartEffectivity);
        attributeMap.put(ProductLineConstants.ATTRIBUTE_WEB_AVAILABILITY, strWebAvailability);
        ...
        String productId = pcBean.create(context, strType, strName, strRevision, strDescription, strPolicy, strVault, attributeMap, strOwner, parentObjId, DomainConstants.EMPTY_STRING, true);
        ...
        if (!(strDesignResId == null || "".equalsIgnoreCase(strDesignResId) || "null".equalsIgnoreCase(strDesignResId))) {
            ...
            boolean bHasFromConnectAccess = (organizationObject.getInfo(context, "current.access[fromconnect]")).equalsIgnoreCase("true") ? true : false;
        ...
        if (strCompanyId == null || "".equalsIgnoreCase(strCompanyId) || "null".equalsIgnoreCase(strCompanyId)) {
            ...
            Map companyList = getRelatedObject(context, DomainConstants.RELATIONSHIP_EMPLOYEE, false, objectSelects, null);
        ...
        Map mpModel = domProduct.getRelatedObject(context, ProductLineConstants.RELATIONSHIP_PRODUCTS, false, new StringList(DomainConstants.SELECT_ID), new StringList(DomainRelationship.SELECT_ID));
        ...
        if (mpModel != null && (strModelId == null || strModelId.equals("null") || strModelId.equals(""))) {
            ...
            attributeMap.clear();
            attributeMap.put(ProductLineConstants.ATTRIBUTE_MARKETING_NAME, strMarketingName);
            attributeMap.put(ProductLineConstants.ATTRIBUTE_ORIGINATOR, context.getUser());
            attributeMap.put("Prefix", strModelPrefix);
            domModelObj.setAttributeValues(context, attributeMap);

            // Begin of modify by Enovia MatrixOne for bug 304670 on 19-May-2005
            domModelObj.setOwner(context, strOwner);
    ...
    /**
     * This method is used to create a Model on creation of a new Product. This method is invoked on Trigger Action of Product Creation.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds object id of the product as argument
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.6
     */
    public void createModelOnCreate(Context context, String args[]) throws Exception {
        ...
        if (strIPMLCommandName == null || "".equalsIgnoreCase(strIPMLCommandName) || "null".equalsIgnoreCase(strIPMLCommandName)) {
            ...
            if (strCreateModel != null && !"TRUE".equals(strCreateModel)) {
                ...
                /*
                 * MapList mpObjList = DomainObject.findObjects(context, PropertyUtil.getSchemaProperty(context,strModelType), strProductName, "", WILD_CHAR, vaultPattern, null, true, objectSelects);
                 * if(mpObjList.size() == 0){
                 */
                if (strCreateModelContext != null && !"TRUE".equals(strCreateModelContext)) {
                    ...
                    DomainRelationship domRel = domModelObj.createAndConnect(context, PropertyUtil.getSchemaProperty(context, strModelType), strProductName, null, null, null, strReltoConnect,
                            domProductObj, false);
                }
            }
        }
    ...
    /**
     * This method is used to retrieve all the Products connected with the Model object. This method is invoked, when the Filter value is set to All under Models.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    /**
     * This method is used to retrieve all the latest revisions of Products connected with the Model object. This method is invoked, when the Filter value is set to Latest under Models.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    /**
     * This method accepts Relationship name and WHERE condition and expands the context object based on the speicified relationship, to retrievel all the Products matching the where condition.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Has the packed Hashmap having information of the object in context.
     * @param relationshipName
     *            - Name of the relationship that has to be traversed to get the Products
     * @param strWhereCondition
     *            - Where Condition, that needs to be used to filter the Product objects.
    ...
    /**
     * This method is called by the Check trigger to verify if the there is a model connected to the product. value is returned to indicate the failure of Check trigger.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - String containing the object id of the context Product
    ...
    public int checkforRelatedModel(Context context, String args[]) throws Exception {
        ...
        MapList mL = getRelatedObjects(context, relationshipName, strFromType, new StringList(), new StringList(), true, false, (short) 1, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING,
                0);
        if (mL.size() == 0) {
            // Begin of modify by Enovia MatrixOne for bug 304670 on 19-May-2005
    ...
    /**
     * This method is called by the Check trigger to verify if the first level Features connected with Product are in Release state. If any of the top level Feature is not in Release state, then a non
     * zero value is returned to indicate the failure of Check trigger.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - String containing the object id of the context Product
    ...
    public int checkFeatureForProductPromote(Context context, String args[]) throws Exception {
        ...
        if (iNumberOfObjects > 0) {
            /*
             * For each of the feature that is connected, check is made on its state.Validation fails if it not in Release state
             */
    ...
    /**
     * This method is called by the Check trigger to verify if the parts connected with Product are in Complete state. If any of the Part is not in Complete state, then a non zero value is returned to
     * indicate the failure of Check trigger.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - String containing the object id of the context Product
    ...
    public int checkPartForProductPromote(Context context, String args[]) throws Exception {
        ...
        if (iNumberOfObjects > 0) {
            /*
             * For each of the part that is connected, check is made on its state.Validation fails if it not in Complete state
             */
            for (int i = 0; i < iNumberOfObjects; i++) {
                // The state is retreived from the MapList obtained.
                String strState = (String) ((Hashtable) relBusObjList.get(i)).get(strSelect);
    ...
    /**
     * This method is called by the Action trigger to promote the Rules and Feature List associated to the Release state. when the Product is promoted to the Release state.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - args holds the following input arguments: 0 - String containing the object id of the context Product
    ...
    public int promoteRules(Context context, String args[]) throws Exception {
        ...
        setId(objectId);
        /*
         * The relationship pattern is initialized to obtain all the rules and feature list connectedto the product object. These object will be promoted to release state when the product objectis
         * promoted to release state.
         */
        String strComma = ",";
        String strRelationshipPattern = ProductLineConstants.RELATIONSHIP_BOOLEAN_COMPATIBILITY_RULE + strComma + ProductLineConstants.RELATIONSHIP_FEATURE_LIST_FROM + strComma
                + ProductLineConstants.RELATIONSHIP_GBOM_FROM + strComma + ProductLineConstants.RELATIONSHIP_PRODUCT_RULEEXTENSION + strComma + ProductLineConstants.RELATIONSHIP_PRODUCT_FIXEDRESOURCE;
    ...
    /**
     * This method is called by the Check trigger to verify if the Previous releases of the product are in Frozen state. If any of the previous releases is not in Frozen state, then a non zero value
     * is returned to indicate the failure of Check trigger.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - args holds the following input arguments: 0 - String containing the object id of the context Product
    ...
    /**
     * This method is used to edit the Governing Project of the Product from the Edit Details page. If the selected Project is already connected to the Product then it is connected to the Product by
     * Governing Project Relationship but if it is not connected to Product then first it is connectded to the Product by Related Projects relationship and then by Governing Project relationship. If
     * Product already has a Governing Project then it is disconnected.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Has the packed Hashmap having information of the object in context.
    ...
    public int updateGoverningProject(Context context, String[] args) throws Exception {
        ...
        Map mGoverningProject = domObj.getRelatedObject(context, ProductLineConstants.RELATIONSHIP_GOVERNING_PROJECT, true, slBusTypes, null);
        ...
        if (bHasReadAccess) // if the context user has access n the Project, then operations performed else nothing done.
        {
            ...
            DomainObject domProject = DomainObject.newInstance(context, strNewValue);

            // Form the object select
            StringBuffer sbProductSelect = new StringBuffer();
            sbProductSelect.append("to[");
            sbProductSelect.append(ProductLineConstants.RELATIONSHIP_RELATED_PROJECTS);
            ...
            List slProducts = (StringList) domProject.getInfoList(context, sbProductSelect.toString());

            ContextUtil.startTransaction(context, true);
            try {
                // Check whether context Product is present in the List
                if (slProducts == null || slProducts.isEmpty() || !slProducts.contains(strObjectId)) {
                    ...
                    DomainObject domProduct = DomainObject.newInstance(context, strObjectId);
                    domProduct.addFromObjects(context, new RelationshipType(ProductLineConstants.RELATIONSHIP_RELATED_PROJECTS), arrProjIds);
                }
     ...
     *            - Object id of the context object, in this case it is Product
     * @param strRelationshipName
     *            - Relationship name that is getting modified.
     * @param strNewObjectId
     *            - The new object id that is to be connected with the above mentioned relationship, after replacing the old one.
     * @param bIsFrom
     *            - Denotes if the new object id mentioned is to be connected in the from side or the to side.
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.0.0.0
     */
    ...
    /**
     * This column JPO method is used to get the name of the Current Phase of the Governing Project of the product.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Has the packed Hashmap with following information: objectList - List of object ids of Product in the table
     * @return List
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.6
    ...
    public List getCurrentPhase(Context context, String[] args) throws Exception {
        ...
        List lstPhaseList = (MapList) currentPhaseProcess(context, args, DomainConstants.SELECT_NAME);
        ...
        for (int i = 0; i < lstPhaseList.size(); i++) {
            ...
            String strPhaseName = (String) ((Map) lstPhaseList.get(i)).get(DomainConstants.SELECT_NAME);
            if (strPhaseName != null && !strPhaseName.equals(DomainConstants.EMPTY_STRING) && !strPhaseName.equalsIgnoreCase("null")) {
                // Added by Vibhu,Enovia MatrixOne for Bug 311803 on 11/22/2005
                ...
                if (!bhasAccess || (strReportFormat != null && !strReportFormat.equals("null") && !strReportFormat.equals(DomainConstants.EMPTY_STRING))) {
                    sbHref.append(strPhaseName);
                } else {
                    sbHref.append("<A HREF=\"javascript:showDetailsPopup('../common/emxTree.jsp?objectId=");
                    sbHref.append(XSSUtil.encodeForHTMLAttribute(context, (String) ((Map) lstPhaseList.get(i)).get(DomainConstants.SELECT_ID)));
    ...
    /**
     * This column JPO method is used to get the Phase Completion date of the Current Phase of the Governing Project of the product.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Has the packed Hashmap with following information: objectList - List of object ids of Product in the table
    ...
    public List getPhaseCompletion(Context context, String[] args) throws Exception {
        List lstPhaseList = (MapList) currentPhaseProcess(context, args, "date");
    ...
    /**
     * This method is used to retrieve perticular details the current phase of the Governing Project of the Product. The current phase of Project is decided as follows: 1.If all the tasks under the
     * Governing Project are in Complete State then the Task with last "Actual Finish Date" will be the Current Phase of the Project. In ideal case if the Task is finished then it's Actual Finish Date
     * should not be empty or null but if such situation arises then complete task with maximum Actual Finish Date which is not null will be the current phase.If Actual finish date is null for all the
     * Tasks then empty string is returned. 2.If there are some incomplete tasks under then incomplete task with the earliest "Estimated Finish Date" will be the current phase.In ideal case Estimated
     * Finish Date for any Task should not be empty or null but if such situation arises then incomplete task with least Estimated Finish Date which is not null will be the current phase.If Estimeted
     * finish date is null for all incomplete Tasks then empty string is returned. 3.If there are no tasks under the Governing Project of the Product then empty string is returned. 4.If there is no
     * Governing Project associated with the Product then blnk string is returned.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Has the packed Hashmap with following information: objectList - List of object ids of Product in the table
     * @param strSelect
     *            The actual name of attribute of the current phase that that has to be selected. The word "date" is reserved. If this passed then either actual or estimated finish date is selected.
     * @return List of Maps containing the following key value pair: strSelect - The required field of the current phase id - The object id of the current phase
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.6
     */

    protected List currentPhaseProcess(Context context, String[] args, String strSelect) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        for (int i = 0; i < lstProdList.size(); i++) {
            arrObjId[i] = (String) ((Map) lstProdList.get(i)).get(DomainConstants.SELECT_ID);
        }

        // Form the select expression to get the Governing Project of the
        // Product
        StringBuffer sbGovProjSelect = new StringBuffer("from[");
        sbGovProjSelect.append(ProductLineConstants.RELATIONSHIP_GOVERNING_PROJECT);
        ...
        ContextUtil.pushContext(context);
        BusinessObjectWithSelectList lstProductData = BusinessObject.getSelectBusinessObjectData(context, arrObjId, (StringList) lstProdSelects);
        ...
        for (int i = 0; i < lstProdList.size(); i++) {
            ...
            strGoverningProject = lstProductData.getElement(i).getSelectData(sbGovProjSelect.toString());

            if (strGoverningProject != null && !strGoverningProject.equals(DomainConstants.EMPTY_STRING) && !strGoverningProject.equalsIgnoreCase("null")) {
                // Added by Vibhu,Enovia MatrixOne for Bug 311803 on 11/22/2005
                ...
                // relationship
                DomainObject domProject = DomainObject.newInstance(context, strGoverningProject);
                lstTasksList = (MapList) domProject.getRelatedObjects(context, sbRelPattern.toString(), DomainConstants.QUERY_WILDCARD, (StringList) lstTaskObjSelects, null, true, true, (short) 1,
                ...
                for (int j = 0; j < lstTasksList.size(); j++) {
                    String strCompleteState = FrameworkUtil.lookupStateName(context, (String) ((Map) lstTasksList.get(j)).get(DomainConstants.SELECT_POLICY), "state_Complete");
                    if (strCompleteState.equals((String) ((Map) lstTasksList.get(j)).get(DomainConstants.SELECT_CURRENT))) {
                ...
                if (lstIncompleteTasksList != null && !lstIncompleteTasksList.isEmpty()) {
                    // sort the incomplete tasks list in ascending order of
                    // Estimeted finish date
                    int index = getMinDatekey((MapList) lstIncompleteTasksList, SELECT_TASK_ESTIMATED_FINISH_DATE);
                    if (index != -1) {
                        if (strSelect.equals("date")) {
                            returnMap.put(strSelect, (String) ((Map) lstIncompleteTasksList.get(index)).get(SELECT_TASK_ESTIMATED_FINISH_DATE));
                        } else {
                            returnMap.put(strSelect, (String) ((Map) lstIncompleteTasksList.get(index)).get(strSelect));
                        }
                        returnMap.put(DomainConstants.SELECT_ID, (String) ((Map) lstIncompleteTasksList.get(index)).get(DomainConstants.SELECT_ID));
                    } else {
                        returnMap.put(strSelect, DomainConstants.EMPTY_STRING);
                    }
                    lstReturnList.add(returnMap);
                } else if (lstCompleteTasksList != null && !lstCompleteTasksList.isEmpty()) {
                    ...
                    // Actual finish date
                    int index = getMaxDatekey((MapList) lstCompleteTasksList, SELECT_TASK_ACTUAL_FINISH_DATE);
                    if (index != -1) {
                        // The first tasks in the maplist is the current phase
                        if (strSelect.equals("date")) {
                            returnMap.put(strSelect, (String) ((Map) lstCompleteTasksList.get(index)).get(SELECT_TASK_ACTUAL_FINISH_DATE));
                        } else {
                            returnMap.put(strSelect, (String) ((Map) lstCompleteTasksList.get(index)).get(strSelect));
                        }
                        returnMap.put(DomainConstants.SELECT_ID, (String) ((Map) lstCompleteTasksList.get(index)).get(DomainConstants.SELECT_ID));
                    } else {
                        returnMap.put(strSelect, DomainConstants.EMPTY_STRING);
                    }
                    lstReturnList.add(returnMap);
    ...
    /**
     * This method is used to get the index of the Map in a MapList for which the value of the passed key is maximum amoung the other maps in the list. The passed key should contain the date string in
     * ematrix format.
     * @param lstMaps
     *            The input maplist.
     * @param strKey
     *            The key.
     * @return The index of the map. -1 - If all the Maps doesn't contain the passed key.
     * @throws ParseException
     *             If the passed key contains string which is not in ematrix date format.
     * @since ProductCentral10.6
     */
    private int getMaxDatekey(MapList lstMaps, String strKey) throws ParseException {
        ...
        for (int i = 0; i < lstMaps.size(); i++) {
            ...
            if (strTaskDate != null && !strTaskDate.equals(DomainConstants.EMPTY_STRING) && !strTaskDate.equalsIgnoreCase("null")) {
                bNotNull = true;
                Date dtTaskDate = dateFormat.parse(strTaskDate);
                if (strMaxDate != null && !strMaxDate.equals(DomainConstants.EMPTY_STRING) && !strMaxDate.equalsIgnoreCase("null")) {
    ...
    /**
     * This method is used to get the index of the Map in a MapList for which the value of the passed key is minimum amoung the other maps in the list. The passed key should contain the date string in
     * ematrix format.
     * @param lstMaps
     *            The input maplist.
     * @param strKey
     ...
     * @since ProductCentral10.6
     */
    private int getMinDatekey(MapList lstMaps, String strKey) throws ParseException {
        ...
        for (int i = 0; i < lstMaps.size(); i++) {
            ...
            if (strTaskDate != null && !strTaskDate.equals(DomainConstants.EMPTY_STRING) && !strTaskDate.equalsIgnoreCase("null")) {
                bNotNull = true;
                Date dtTaskDate = dateFormat.parse(strTaskDate);
                if (strMinDate != null && !strMinDate.equals(DomainConstants.EMPTY_STRING) && !strMinDate.equalsIgnoreCase("null")) {
    ...
    /**
     * This column JPO method is used to get the Governing Project name of the Product.
     * @param context
     ...
     * @since ProductCentral10.6
     */
    public List getGoverningProject(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        List lstProdList = (MapList) programMap.get("objectList");
        ...
        for (int i = 0; i < lstProdList.size(); i++) {
            bhasAccess = false;
            strGoverningProjectId = lstProductData.getElement(i).getSelectData(sbGovProjIdSelect.toString());
            strGoverningProjectName = lstProductData.getElement(i).getSelectData(sbGovProjNameSelect.toString());

            if (strGoverningProjectId != null && !strGoverningProjectId.equals(DomainConstants.EMPTY_STRING) && !strGoverningProjectId.equalsIgnoreCase("null")) {
                sbHref = new StringBuffer();
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getProductsForRoadmap(Context context, String args[]) throws Exception {
        ...
        String[] strProductIds = (String[]) requestValuesMap.get("emxTableRowId");
        ...
        for (int i = 0; i < strSourceObjectId.length; i++) {
            ...
            obTemp = hmTemp.put(DomainConstants.SELECT_ID, strSourceObjectId[i]);
            mlSelectedProductIds.add(i, hmTemp);
        }
    ...
    public List getLabel1(Context context, String[] args) throws Exception {
        ...
        return getDisplayLabel(context, lstProductList, strRangeLabel, localeObj, dblTZOffset);
    ...
    public List getLabel2(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        List lstProductList = (MapList) programMap.get("objectList");
    ...
    public List getLabel3(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        List lstProductList = (MapList) programMap.get("objectList");
    ...
    public List getLabel4(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        List lstProductList = (MapList) programMap.get("objectList");
    ...
    public List getDisplayLabel(Context context, List lstProductList, String strRangeLabel, Locale localeObj, double dblTZOffset) throws Exception {
        ...
        sbRelWhereExp.append(ProductLineConstants.SELECT_ATTRIBUTE_ROADMAP_LABEL);
        ...
        for (int i = 0; i < lstProductList.size(); i++) {
            ...
            lstTaskList = (MapList) domProduct.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_ROADMAP_TASK, WILD_CHAR, (StringList) lstObjSelects, (StringList) lstRelSelects, false,
                    true, (short) 1, null, sbRelWhereExp.toString());
            if (lstTaskList != null && !lstTaskList.isEmpty()) {
                ...
                for (int j = 0; j < lstTaskList.size(); j++) {
                    ...
                    String strTaskName = (String) ((Map) lstTaskList.get(j)).get(DomainConstants.SELECT_NAME);
                    String strTaskEstDate = (String) ((Map) lstTaskList.get(j)).get(SELECT_TASK_ESTIMATED_FINISH_DATE);
                    String strTaskActDate = (String) ((Map) lstTaskList.get(j)).get(SELECT_TASK_ACTUAL_FINISH_DATE);
                    String strTaskId = (String) ((Map) lstTaskList.get(j)).get(DomainConstants.SELECT_ID);
                    sbReturnString.append(strTaskName);
                    sbReturnString.append("\n (");
                    /* Begin of Modify:Raman,Enovia MatrixOne for Bug#302847 on 4/21/2005 */
                    String strAttrRegion = (String) ((Map) lstTaskList.get(j)).get(ProductLineConstants.SELECT_ATTRIBUTE_REGION);
                    String strAttrSeason = (String) ((Map) lstTaskList.get(j)).get(ProductLineConstants.SELECT_ATTRIBUTE_SEASON);
                    String strAttrSegment = (String) ((Map) lstTaskList.get(j)).get(ProductLineConstants.SELECT_ATTRIBUTE_SEGMENT);
                    // End of modify by Enovia MatrixOne for Bug# 302972 on 25 Apr 05
                    if (strAttrRegion != null && !strAttrRegion.equals(EMPTY_STRING) && !strAttrRegion.equalsIgnoreCase("null")) {
                        sbReturnString.append(strAttrRegion);
                        sbReturnString.append("|");
                    }
                    if (strAttrSeason != null && !strAttrSeason.equals(EMPTY_STRING) && !strAttrSeason.equalsIgnoreCase("null")) {
                        // Added by Vibhu,Enovia MatrixOne for Bug301154 on 5/3/2005
                        strAttrSeason = i18nNow.getRangeI18NString(ProductLineConstants.ATTRIBUTE_SEASON, strAttrSeason, context.getSession().getLanguage());
                        sbReturnString.append(strAttrSeason);
                        sbReturnString.append("|");
                    }
                    if (strAttrSegment != null && !strAttrSegment.equals(EMPTY_STRING) && !strAttrSegment.equalsIgnoreCase("null")) {
                        // Added by Vibhu,Enovia MatrixOne for Bug301154 on 5/3/2005
                        strAttrSegment = i18nNow.getRangeI18NString(ProductLineConstants.ATTRIBUTE_SEGMENT, strAttrSegment, context.getSession().getLanguage());
                        sbReturnString.append(strAttrSegment);
                        sbReturnString.append("|");
                    }
                    /* End of Add:Raman,Enovia MatrixOne for Bug#302847 on 4/21/2005 */
                    if (strTaskActDate != null && !strTaskActDate.equals(EMPTY_STRING) && !strTaskActDate.equalsIgnoreCase("null")) {
                        // Added by Vibhu,Enovia MatrixOne for Bug301154 on 5/3/2005
                        strTaskActDate = getDisplayDate(context, strTaskActDate, localeObj, dblTZOffset);
                        sbReturnString.append(strTaskActDate);
                    } else if (strTaskEstDate != null && !strTaskEstDate.equals(EMPTY_STRING) && !strTaskEstDate.equalsIgnoreCase("null")) {
                        // Added by Vibhu,Enovia MatrixOne for Bug301154 on 5/3/2005
    ...
    /**
     * This method returns all the Projects connected to the Product with "Related Projects" relationship.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            The packed arguments that contains the Map with following key value pair: objectId - Object id of the context product
     * @return MapList containing the information of projects connected to the Product
     * @throws Exception
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getRelatedProjects(Context context, String[] args) throws Exception, FrameworkException {
        ...
        if (null != strProductId && !"null".equals(strProductId) && !"".equals(strProductId)) {
            ...
            // relationship
            lstProjectsList = domProduct.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_RELATED_PROJECTS, ProductLineConstants.TYPE_PROJECT_MANAGEMENT, (StringList) lstObjectSelects,
    ...
    /**
     * This column JPO method is invoked while displaying the Projets list page under products and is used to display the "Governing Project" icon.
     * @param context
     *            The ematrix context of the request
     * @param args
     *            The packed arguments containing Map with following key value pairs: objectId - The objec id of the context product objectList - The maplist containing the related projects
     *            information
     * @return Vector containing the HTML tag to generate the Governing Project icon.
     * @throws Exception
     * @throws FrameworkException
     * @since ProductCentral10.6
     */
    public Vector getGoverningProjectIcon(Context context, String[] args) throws Exception, FrameworkException {

        // Unpack the arguments
        Map mapProgram = (HashMap) JPO.unpackArgs(args);

        // Get the object id of the Product and related project list
        String strProductId = (String) ((Map) mapProgram.get("paramList")).get(STR_OBJECTID);
        ...
        sbSelectGoverning.append(ProductLineConstants.RELATIONSHIP_GOVERNING_PROJECT);
        ...
        DomainObject domProduct = DomainObject.newInstance(context, strProductId);
        Map mapGoverningProject = domProduct.getInfo(context, (StringList) lstObjectSelects);
        String strGoverningProject = (String) mapGoverningProject.get(sbSelectGoverning.toString());
        ...
        StringBuffer sbGoverningIconTag = new StringBuffer();
        sbGoverningIconTag.append("<img src=\"../common/images/iconSmallPrimary.gif\" border=\"0\" align=\"middle\" TITLE=\"");
        sbGoverningIconTag.append(XSSUtil.encodeForHTMLAttribute(context, strTipGoverningProj));
        sbGoverningIconTag.append("\"/>");

        for (int i = 0; i < lstProjectList.size(); i++) {
            if (strGoverningProject != null && strGoverningProject.equals((String) ((Map) lstProjectList.get(i)).get(DomainConstants.SELECT_ID))) {
    ...
    /**
     * This column JPO method is invoked while displaying the Projets list page under products and is used to display the slip days icon.The logic to display the icon is as follows: Green Icon - The
     * Project is in Complete State Red Icon - The Project is not complete and the difference between the current system date and esteemated finish date is greater than threshold specified in property
     * file Yellow Icon - The Project is not complete and the difference between the current system date and esteemated finish date is less than or equal to the threshold specified in property file.
     * If the Baseline Current End Date is specified for the project then it is taken into consideration to determine the slip days otherwise Task Esteemated End Date is used.
     * @param context
     *            The ematrix context of the request
     * @param args
     *            The packed arguments containing Map with following key value pairs: objectList - The maplist containing the related projects information
     * @return Vector containing the HTML tag to generate the Slip days icon.
     * @throws Exception
     * @throws FrameworkException
     * @since ProductCentral10.6
     */
    public Vector getSlipDaysIcon(Context context, String[] args) throws Exception, FrameworkException {
        // Unpack the arguments
        Map mapProgram = (HashMap) JPO.unpackArgs(args);
        ...
        Date dtSysDate = new Date(dtTmpDate.getYear(), dtTmpDate.getMonth(), dtTmpDate.getDate());
        SimpleDateFormat sdfDateFormat = new SimpleDateFormat(eMatrixDateFormat.getEMatrixDateFormat(), Locale.US);
        ...
        int iThreshold = Integer.parseInt(EnoviaResourceBundle.getProperty(context, "emxProduct.Roadmap.SlipDaysThreshold"));
        // Get the actual name of the state complete
        String strStateComplete = FrameworkUtil.lookupStateName(context, DomainConstants.POLICY_PROJECT_SPACE, "state_Complete");
        ...
        for (int i = 0; i < lstProjectList.size(); i++) {
            ...
            strBlEndDate = (String) mapProject.get(SELECT_BASELINE_CURRENT_END_DATE);
            strEstEndDate = (String) mapProject.get(SELECT_TASK_ESTIMATED_FINISH_DATE);
            strState = (String) mapProject.get(DomainConstants.SELECT_CURRENT);
            strType = (String) mapProject.get(DomainConstants.SELECT_TYPE);

            if (strBlEndDate != null && !strBlEndDate.equals(STR_BLANK) && !strBlEndDate.equalsIgnoreCase("null")) {
                dtFinishDate = sdfDateFormat.parse(strBlEndDate);
            } else if (strEstEndDate != null && !strEstEndDate.equals(STR_BLANK) && !strEstEndDate.equalsIgnoreCase("null")) {
            ...
            if (!dtSysDate.after(dtFinishDate)) {
                lDaysRemain = DateUtil.computeDuration(dtSysDate, dtFinishDate);
            }
            ...
            if (strType.equals(DomainConstants.TYPE_PROJECT_CONCEPT)) {
                ...
                if (strState.equals(strStateComplete)) {
                    sbHtmlTag.append("<img src=\"../common/images/iconStatusGreen.gif\" border=\"0\" alt=\"");
                    sbHtmlTag.append(XSSUtil.encodeForHTMLAttribute(context, strLegendOnTime));
                    sbHtmlTag.append("\"/>");
                }
                // Begin of Modify by Enovia MatrixOne for bug no. 303522, dated 05/24/2005
                else if (dtSysDate.after(dtFinishDate)) {
                    sbHtmlTag.append("<img src=\"../common/images/iconStatusRed.gif\" border=\"0\" alt=\"");
                    sbHtmlTag.append(XSSUtil.encodeForHTMLAttribute(context, strLegendLate));
                    sbHtmlTag.append("\"/>");
                } else if (lDaysRemain <= iThreshold) {
                    sbHtmlTag.append("<img src=\"../common/images/iconStatusYellow.gif\" border=\"0\" alt=\"");
                    sbHtmlTag.append(XSSUtil.encodeForHTMLAttribute(context, strLegendBehind));
                    sbHtmlTag.append("\"/>");
                } else {
     ...
     * @param args
     *            - Has the packed Hashmap having information of the object in context.
     * @return MapList - contains level,name,type,revision and Index of the Products which are connected to the context product
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-6
     */
    ...
    public MapList getConnectedProducts(Context context, String args[]) throws Exception {
        ...
        List lstAllObjList = (MapList) dom.getRelatedObjects(context, strRelationshipType, DomainConstants.QUERY_WILDCARD, (StringList) slObjectSelects, null, false, true, (short) 0,
                DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
    ...
    /**
     * This method is used to get the level for all the Products which are associated with context Product.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the parameters passed from the calling method When this array is unpacked, arguments corresponding to the following String keys are found:- objectList- MapList Containing the
     *            objectIds.
     * @return Vector
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * This method is called by a check trigger on Delete of 'Product'. This method checks whether the product being deleted has connected product compatibility rules. In case it has then the trigger
     * will return 1 and stop the deletion of that product.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public int checkForCompatibilityRules(Context context, String[] args) throws Exception {
        ...
        List mlRuleList = (MapList) domobj.getRelatedObjects(context, strRelPattern, strTypePatten, (StringList) lstObjectSelects, null, true, false, (short) 0, DomainConstants.EMPTY_STRING,
    ...
    /**
     * This method is used to get the list of top level Projects and Programs The method returns the MapList contains Map with following key value pairs: id - The object id name - The object name type
     * - The object type Child The MapList containing the information about the child of this Program. Selectable The string(true/false) indicating whether this Object is already connected to Product
     * @param context
     *            The ematrix context object.
     * @param args
     *            The String array containing Packed arguments as follows: HashMap containing the object id
     * @return MapList
     * @throws Exception
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getAllProjects(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList tempList = DomainObject.findObjects(context, sbProjectTypes.toString(), DomainConstants.QUERY_WILDCARD, sbWhereExpression.toString(), // whereclause
    ...
    /**
     * This method is used to get the list of Projects that are conencted to the Programs and projects The method returns the MapList contains Map with following key value pairs: id - The object id
     * name - The object name type - The object type Child The MapList containing the information about the child of this Program. Selectable The string(true/false) indicating whether this Object is
     * already connected to Product
     * @param context
     *            The ematrix context object.
     * @param args
     *            The String array containing Packed arguments as follows: HashMap containing the object id
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList expandProjects(Context context, String[] args) throws Exception {
        MapList projList = new MapList();
        try {
            // Unpack the arguments to get the object id of the Product
            Map programMap = (HashMap) JPO.unpackArgs(args);
            ...
            projList = new DomainObject(strObjectId).getRelatedObjects(context, sbrelPattern.toString(), WILD_CHAR, lstObjectSelects, slRelSelects, false, true, (short) 1, null, null, 0);
    ...
    /**
     * This method is used disable the programs , projects that are already connected to context Product and updates teh Map with key value pair key: disableSelection , value :True/false
     **/

    private void disabledSelectedProjects(Context context, MapList relatedobjMap, String strProductId) throws Exception {
        try {
    ...
    /**
     * This method is used to convert the MapList into StringList by passing perticular key.
     * @param lstProjectList
     *            The MapList.
     * @param strKey
     *            The key.:
     * @return StringList
    ...
    /**
     * This method returns all the Tasks connected to the Product with "Roadmap Task" relationship.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            The packed arguments that contains the Map with following key value pair: objectId - Object id of the context product
     * @return MapList containing the information of Tasks connected to the Product
     * @throws Exception
     * @throws FrameworkException
     * @since ProductCentral10.6
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public List getRelatedTasks(Context context, String[] args) throws Exception, FrameworkException {
        ...
        /*
         * Get the Tasks connected to the Product by "Roadmap Task" relationship
         */
        List lstTasksList = domProduct.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_ROADMAP_TASK, DomainConstants.QUERY_WILDCARD, (StringList) lstObjectSelects,
    ...
    /**
     * Method to generate the HTML to display Project name(Hyperlinked) for the Product Tasks Table.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Has the packed Hashmap having information of the object in context.
    ...
    public List getParentProjectForTask(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        BusinessObjectWithSelectList lstProjects = getSelectBusinessObjectData(context, arrObjId, (StringList) lstProjSelects);
        ...
        for (int i = 0; i < lstTaskList.size(); i++) {
            ...
            strProjectId = (String) (lstProjects.getElement(i).getSelectData(sbSelProjId.toString()));
            strProjectName = (String) (lstProjects.getElement(i).getSelectData(sbSelProjName.toString()));
            ...
            if (strProjectId != null && !strProjectId.equals(DomainConstants.EMPTY_STRING)
    ...
    /**
     * Method to generate the HTML to display Program name(Hyperlinked) for the PRCProducttaskList Table.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Has the packed Hashmap having information of the object in context.
    ...
    public Vector getParentProgramForTask(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        List lstTaskList = (MapList) programMap.get("objectList");
        Map paramMap = (Map) programMap.get("paramList");
        // strReportFormat indicates whether method is called from table or report.
        ...
        BusinessObjectWithSelectList lstPrograms = getSelectBusinessObjectData(context, arrObjId, (StringList) lstProgSelects);
        // End of Modify by Enovia MatrixOne on 24-May-05 for the bug about Task List page

        for (int i = 0; i < lstTaskList.size(); i++) {
            // Begin of Modify by Enovia MatrixOne on 24-May-05 for the bug about Task List page
            strProgramId = (String) (lstPrograms.getElement(i).getSelectData(sbSelProgId.toString()));
            strProgramName = (String) (lstPrograms.getElement(i).getSelectData(sbSelProgName.toString()));
            // End of Modify by Enovia MatrixOne on 24-May-05 for the bug about Task List page

            // clear the buffer on the every iteration
            sbHref.delete(0, sbHref.length());
            if (strProgramId != null && !strProgramId.equals(DomainConstants.EMPTY_STRING) && !strProgramId.equalsIgnoreCase("null")) {
                // if in table mode
                if (!(strReportFormat != null && strReportFormat.equals("null") == false && strReportFormat.equals("") == false)) {
                    sbHref.append("<A HREF=\"javascript:showDetailsPopup('../common/emxTree.jsp?objectId=");
    ...
    /**
     * This method is used to get the list of Projects taht are connected to Product and The method returns MapList contianing Map with following key value pairs: id - The object id name - The object
     * name type - The object type Selectable The string(true/false) indicating whether this Object is already connected to Product
     * @param context
     *            The ematrix context object.
     * @param args
     *            The String array containing Packed arguments as follows: HashMap containing the object id
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getConnectedProjects(Context context, String[] args) throws Exception {
        MapList projList = new MapList();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            String strObjectId = (String) programMap.get("objectId");
            ...
            projList = new DomainObject(strObjectId).getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_RELATED_PROJECTS, ProductLineConstants.TYPE_PROJECT_SPACE, lstObjectSelects,
                    slRelSelects, false, true, (short) 1, null, // objewhere
                    null, // relwhere
                    0);
    ...
    /**
     * This method is used to get the list of Tasks that are connected to the Project and The method returns MapList contianing Map with following key value pairs: id - The object id name - The object
     * name type - The object type Selectable The string(true/false) indicating whether this Object is already connected to Product
     * @param context
     *            The ematrix context object.
     * @param args
     *            The String array containing Packed arguments as follows: HashMap containing the object id, parent object id
     * @return MapList
     * @throws Exception
     * @since ProductCentral10.6
     */
    ...
    public MapList getAllProjectTasks(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            lstTasksList = new DomainObject(strObjectId).getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_SUBTASK, ProductLineConstants.TYPE_TASK_MANAGEMENT, lstObjectSelects,
                    slRelSelects, false, true, (short) 1, "current.access[toconnect]==TRUE", // objewhere
                    null, // relwhere
                    0);
            ...
            while (itrTasks.hasNext()) {
                ...
                /*
                 * If this Task is already connected to the context product through relationship Roadmap Task then make 'Selectable' as false
                 */
                if (lstTasksIdList.contains(mapObject.get(DomainObject.SELECT_ID))) {
                    mapObject.put("disableSelection", "True");
                }
            } // end while
        } catch (Exception e) {
    ...
    /**
     * This method returns all the Tasks connected to the Product with "Roadmap Task" relationship.It is used as Table JPO method for table PRCProductTaskList when opened in Edit mode for "Associate
     * Tasks"
     * @param context
     *            The ematrix context of the request.
     * @param args
     ...
     * @throws FrameworkException
     */
    public List getSelectedTasks(Context context, String[] args) throws Exception, FrameworkException {
        // Get the object id of the context Product and create a domain object
        Map mapProgram = (HashMap) JPO.unpackArgs(args);
        ...
        /*
         * strTaskIds contains objIds and RelIds in the following format: objId1|relId1,objId2|relId2,objId3|relId3 and so on.
         */
        ...
        for (int i = 0; stTaskIds.hasMoreTokens(); i++) {
            ...
            mpId.put(SELECT_BASELINE_CURRENT_END_DATE, (String) mpObj.get(SELECT_BASELINE_CURRENT_END_DATE));
            mpId.put(SELECT_TASK_ESTIMATED_FINISH_DATE, (String) mpObj.get(SELECT_TASK_ESTIMATED_FINISH_DATE));
    ...
    /**
     * Returns the Range Values for Relationship attributes. This method is used in Table PRCProductTaskList(in edit mode).
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    /**
     * This method gets the object Structure List for the context Product object.This method gets invoked by settings in the command which displays the Structure Navigator for Product type objects
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: paramMap - Map having object Id String
     ...
     * @since ProductCentral10.6
     */
    public List getProjectProgram(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        for (int i = 0; i < lstProjList.size(); i++) {
            arrObjId[i] = (String) ((Map) lstProjList.get(i)).get(DomainConstants.SELECT_ID);
        }

        // Form the select expression to get the Program of the
        // Project
        StringBuffer sbProgIdSelect = new StringBuffer("to[");
        sbProgIdSelect.append(ProductLineConstants.RELATIONSHIP_PROGRAM_PROJECT);
        ...
        sbProgNameSelect.append(ProductLineConstants.RELATIONSHIP_PROGRAM_PROJECT);
        ...
        // Get the Governing Project for all the Products
        BusinessObjectWithSelectList lstProductData = BusinessObject.getSelectBusinessObjectData(context, arrObjId, (StringList) lstProjSelects);
        ...
        for (int i = 0; i < lstProjList.size(); i++) {
            strProgramId = lstProductData.getElement(i).getSelectData(sbProgIdSelect.toString());
            strProgramName = lstProductData.getElement(i).getSelectData(sbProgNameSelect.toString());
            if (strProgramId != null && !strProgramId.equals(DomainConstants.EMPTY_STRING) && !strProgramId.equalsIgnoreCase("null")) {
                sbHref = new StringBuffer();
    ...
    /**
     * This method is called by an action trigger on Revise of 'Product' to connect the new revision of the product to all the Featres/sub Features under it.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public void copyStructureOnRevise(Context context, String args[]) throws Exception {
        ...
        MapList objModel = domObject.getRelatedObjects(context, strProductModelReln, DomainConstants.QUERY_WILDCARD, objectSelects, null, true, false, (short) 1, DomainConstants.EMPTY_STRING,
                DomainConstants.EMPTY_STRING);

        // To get the Model Id from Query result.
        String strModelId = (String) ((Hashtable) objModel.get(0)).get(DomainConstants.SELECT_ID);
        ...
        if (isConfigurationInstall) {
            ...
            JPO.invoke(context, "emxProductVariant", arrPacked, "cloneProductVariantOnProductReviseAndCopy", arrPacked, null);
            ...
            String strComma = ",";
            String relationshipPattern = sb.append(ProductLineConstants.RELATIONSHIP_LOGICAL_STRUCTURES).append(strComma).append(ProductLineConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES)
                    .append(strComma).append(ProductLineConstants.RELATIONSHIP_MANUFACTURING_STRUCTURES).append(strComma).toString();

            sb = new StringBuffer(250);
            String typePattern = sb.append(ProductLineConstants.TYPE_LOGICAL_STRUCTURES).append(strComma).append(ProductLineConstants.TYPE_PRODUCTS).append(strComma)
            ...
            JPO.invoke(context, "emxConfigurableRules", arrPackedArgument, "copyRuleStructure", arrPackedArgument, null);
        }
    ...
    /**
     * This method is called to show the higher revision column for product list pages other than revisions list page .
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            0 - contains the objectID of the context product
    ...
    public boolean showHigherRevisionColumn(Context context, String[] args) throws Exception {
        ...
        if (strShowColumn != null && !(strShowColumn.equalsIgnoreCase("")) && !("null".equalsIgnoreCase(strShowColumn)) && strShowColumn.equals("false")) {
    ...
    /**
     * This method is used to return the Formatted date corrosponding to date display setting in the properties file.
     * @param context
     *            The ematrix context object.
     * @param String
     *            The Date string to be format.
    ...
    public MapList expandStatusObjects(Context context, String[] args) throws Exception {
        ...
        if (mxType.isOfParentType(context, strType, ProductLineConstants.TYPE_PRODUCT_VARIANT)) {
            ...
            productVariantTechFtrStructure = domObject.getRelatedObjects(context, strRelPattern, strObjPattern, objSelects, null, false, true, (short) 0, DomainConstants.EMPTY_STRING,
                    DomainConstants.EMPTY_STRING);
            ...
            List lstProductChildTypes = ProductLineUtil.getChildrenTypes(context, ProductLineConstants.TYPE_PRODUCTS);
            ...
            List lstFeatureChildTypes = ProductLineUtil.getChildrenTypes(context, ProductLineConstants.TYPE_FEATURES);
            sbBuffer1 = sbBuffer1.append(STR_COMMA);
            ...
            stbTypeSelect1 = stbTypeSelect1.append(ProductLineConstants.TYPE_FEATURE_LIST).append(STR_COMMA).append(ProductLineConstants.TYPE_FEATURES).append(STR_COMMA)
                    .append(ProductLineConstants.TYPE_PRODUCTS);
            StringBuffer stbRelSelect1 = new StringBuffer(50);
            stbRelSelect1 = stbRelSelect1.append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_FROM).append(STR_COMMA).append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_TO);

            productVariantMarFtrStructure = domObject.getRelatedObjects(context, stbRelSelect1.toString(), stbTypeSelect1.toString(), false, true, recurseLevel, selectStmts1, selectRelStmts1, null,
                    null, null, sbBuffer1.toString(), null);
        ...
        try {
            ...
            stbTypeSelect = stbTypeSelect.append(ProductLineConstants.TYPE_FEATURE_LIST).append(STR_COMMA).append(ProductLineConstants.TYPE_FEATURES).append(STR_COMMA)
                    .append(ProductLineConstants.TYPE_PRODUCTS);
            StringBuffer stbRelSelect = new StringBuffer(50);
            stbRelSelect = stbRelSelect.append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_FROM).append(STR_COMMA).append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_TO);
            featureList = domObject.getRelatedObjects(context, stbRelSelect.toString(), stbTypeSelect.toString(), false, true, recurseLevel, selectStmts, selectRelStmts, null, null, null, null, // sbBuffer.toString(),
                    null);
            ...
            if (productVariantMarFtrStructure != null) {
                 ...
                 * 
                 * for(int iCount = 0; iCount < productVariantTechFtrStructure.size(); iCount++) { mapChildMap.put(DomainObject.SELECT_ID, productVariantMarFtrStructure.get(iCount));
                 * 
    ...
    public MapList expandSelectionObjects(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * if ((lstFeatureChildTypes.contains(domObject.getInfo(context, DomainConstants.SELECT_TYPE))) || (strLevel == null || strLevel.equalsIgnoreCase("null") || strLevel.equalsIgnoreCase("")))
             * {
             */
            StringList selectStmts = new StringList(2);
            selectStmts.addElement(DomainConstants.SELECT_ID);
            ...
            StringBuffer stbRelSelect = new StringBuffer(50);
            stbRelSelect = stbRelSelect.append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_FROM).append(STR_COMMA).append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_TO);
            featureList = domObject.getRelatedObjects(context, stbRelSelect.toString(), stbTypeSelect.toString(), false, true, recurseLevel, selectStmts, selectRelStmts, null, null, null,
    ...
    public MapList expandRuleObjects(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            // get the children types of Feature and make it a comma seperated string
            List lstRuleChildTypes = ProductLineUtil.getChildrenTypes(context, ProductLineConstants.TYPE_RULE);
            sbBuffer = sbBuffer.append(STR_COMMA);
            ...
            sbBuffer = sbBuffer.append(STR_COMMA).append(ProductLineConstants.TYPE_FIXED_RESOURCE).append(STR_COMMA).append(ProductLineConstants.TYPE_RULE_EXTENSION);
            ...
            StringBuffer stbTypeSelect = new StringBuffer(50);
            stbTypeSelect = stbTypeSelect.append(ProductLineConstants.TYPE_FEATURE_LIST).append(STR_COMMA).append(ProductLineConstants.TYPE_FEATURES).append(STR_COMMA)
                    .append(ProductLineConstants.TYPE_PRODUCTS).append(STR_COMMA).append(ProductLineConstants.TYPE_RULE).append(STR_COMMA).append(ProductLineConstants.TYPE_FIXED_RESOURCE)
                    .append(STR_COMMA).append(ProductLineConstants.TYPE_RULE_EXTENSION);

            StringBuffer stbRelSelect = new StringBuffer(50);
            stbRelSelect = stbRelSelect.append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_FROM).append(STR_COMMA).append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_TO).append(STR_COMMA)
                    .append(ProductLineConstants.RELATIONSHIP_BOOLEAN_COMPATIBILITY_RULE).append(STR_COMMA).append(ProductLineConstants.RELATIONSHIP_PRODUCT_RULEEXTENSION).append(STR_COMMA)
    ...
    public MapList expandGBOMObjects(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            stbTypeSelect = stbTypeSelect.append(ProductLineConstants.TYPE_FEATURE_LIST).append(STR_COMMA).append(ProductLineConstants.TYPE_FEATURES).append(STR_COMMA)
                    .append(ProductLineConstants.TYPE_PRODUCTS).append(STR_COMMA).append(ProductLineConstants.TYPE_GBOM);
            ...
            StringBuffer stbRelSelect = new StringBuffer(50);
            stbRelSelect = stbRelSelect.append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_FROM).append(STR_COMMA).append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_TO).append(STR_COMMA)
                    .append(ProductLineConstants.RELATIONSHIP_GBOM_FROM).append(STR_COMMA).append(ProductLineConstants.RELATIONSHIP_GBOM_TO);
            featureList = domObject.getRelatedObjects(context, stbRelSelect.toString(), stbTypeSelect.toString(), false, true, recurseLevel, selectStmts, selectRelStmts, null, null, null, null, // sbBuffer.toString(),
                    null);
            // Added for Bug No. 372374
            MapList listMF = addPlatformFeature(context, domObject, recurseLevel, stbRelSelect, stbTypeSelect, selectStmts, selectRelStmts);
     ...
     *            The ematrix context object.
     * @param strProjectId
     *            String containing the ID of the Project.
    ...
    public static boolean hasAccessOnProject(Context context, String strProjectId) throws Exception {
        ...
        MapList mlMemberList = domTemp.getRelatedObjects(context, DomainConstants.RELATIONSHIP_MEMBER, DomainConstants.QUERY_WILDCARD, null, null, false, true, (short) 1, sbWhere.toString(), null);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - String array containing following packed HashMap with following elements: paramMap - The HashMap containig the object id.
    ...
    public Boolean getFeatureActivePCs(Context context, String[] args) throws Exception {
        ...
        MapList tempMapListPC = domProd.getRelatedObjects(context, relationshipPatternPC, DomainConstants.QUERY_WILDCARD, objectSelects, null, false, true, (short) 1, DomainConstants.EMPTY_STRING,
                DomainConstants.EMPTY_STRING);
        ...
        if (iNumberOfPCList > 0) {
            ...
            while (htbActivePCKeys.hasMoreElements()) {
                ...
                MapList mpSoList = domPC.getRelatedObjects(context, relationshipPatternPC, "*", objectSelects, null, false, true, (short) 1, "", "");
    ...
    /*
     * This Method Added to Include the Feature from Platform to the Product Feature Structure Created for Bug No. 372374
     * 
    ...
    private MapList addPlatformFeature(Context context, DomainObject domObject, short recurseLevel, StringBuffer stbRelSelect, StringBuffer stbTypeSelect, StringList selectStmts,
        ...
        MapList prodRelObjs = domObject.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST, ProductLineConstants.TYPE_FEATURE_LIST, strObjSelect, null, false, true,
                recurseLevel, "", ProductLineConstants.EMPTY_STRING);

        StringBuffer strMatchList = new StringBuffer();
        strMatchList.append("\"");
        String strPVFLId = "";
        for (int j = 0; j < prodRelObjs.size(); j++) {
            strPVFLId = (String) ((Map) prodRelObjs.get(j)).get(DomainObject.SELECT_ID);
        ...
        String strPlatFormId = domObject.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCTS + "].from.from[" + ProductLineConstants.RELATIONSHIP_PRODUCT_PLATFORM + "].to.id");
        ...
        if (strPlatFormId != null && !("").equals(strPlatFormId)) {
            ...
            productPlatformRelObjs = objPlatForm.getRelatedObjects(context, stbRelSelect.toString(), stbTypeSelect.toString(), selectStmts, selectRelStmts, false, true, recurseLevel,
     ...
     *            - Matrix context
     * @param args
     *            - FROMOBJID /ToOBJECTID
     * @return int - Return 0 is From object is not in release/beyond state.
     * @throws Exception
     */
    public int checkFromObjectIsReleased(Context context, String args[]) throws Exception {
        int result = 0;
    ...
    /**
     * This function gets the Icon file name for any given type from the emxSystem.properties file NOTE:This method has been copied from UINavigatorUtil.java because when we use this method through UI
     * navigator we are getting the compile error in "adele mkmk" "cannot access javax.servlet.ServletContext". (this is due to the overloaded method using this ServletContext as parameter).
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param type
     *            object type name
    ...
    public void setModelPrefix(Context context, String[] args) throws Exception {
        ...
        StringList slBusTypes = new StringList();
        slBusTypes.addElement(DomainConstants.SELECT_ID);
        Map structure = domObj.getRelatedObject(context, ProductLineConstants.RELATIONSHIP_PRODUCTS, false, slBusTypes, null);
    ...
    public void copyProductAttributesToModel(Context context, String[] args) throws Exception {
        ...
        Map mpProd = domProd.getRelatedObject(context, ProductLineConstants.RELATIONSHIP_MAIN_PRODUCT, false, new StringList(DomainConstants.SELECT_ID), new StringList(DomainRelationship.SELECT_ID));
        ...
        if (mpProd != null && mpProd.size() != 0) {
            ...
            MapList mLstModelRelatedData = domProd.getRelatedObjects(context, strRels.toString(), "*", new StringList(DomainObject.SELECT_ID), strRelSelect, true, true, (short) 1,
     ...
     *             if the operation fails
     */
    public int connectDesignResponsibility(Context context, String[] args) throws Exception {
        Map programMap = (HashMap) JPO.unpackArgs(args);
        ...
        if (strNewOrganizationId != null && !"null".equalsIgnoreCase(strNewOrganizationId) && !"".equals(strNewOrganizationId)) {
            ...
            DomainRelationship.connect(context, this, ProductLineConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY, domainObjectToType);
    ...
    /**
     * This COLUMN JPO method is used to get the Name and Revision of the Product from which the Product is derived from.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            string array containing packed arguments.
    ...
    /**
     * Used to get data for the Product Evolutions Product Context Structure Browser Note that the Product Display should be fully expanded on display.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            string array containing packed arguments.
        ...
        for (int i = 0; i < lstProductList.size(); i++) {
            ...
            if (derType.equals(DerivationUtil.DERIVATION_TYPE_DERIVATION)) {
                ...
                if (reportFormat != null && "CSV".equalsIgnoreCase(reportFormat)) {
                    ...
                    strNewIcon = "<img src=\"../common/images/" + XSSUtil.encodeForHTMLAttribute(context, strIconDerivationCue) + "\" border=\"0\"  align=\"middle\" " + "TITLE=\"" + " "
    ...
    public Vector getColumnLatestCue(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < lstProductList.size(); i++) {
            ...
            if (strDerivationType.equals(DerivationUtil.DERIVATION_TYPE_REVISION)) {
                ...
                MapList mlRevisionsOnChain = DerivationUtil.getAllDerivationsOfRelationship(context, objectID, DerivationUtil.RELATIONSHIP_MAIN_DERIVED);
            ...
            if (isLatestReleased) {
                if (reportFormat != null && "CSV".equalsIgnoreCase(reportFormat)) {
                    ...
                    strNewIcon = "<img src=\"../common/images/" + XSSUtil.encodeForHTMLAttribute(context, strIconLatestReleasedCue) + "\" border=\"0\"  align=\"middle\" " + "TITLE=\"" + " "
                ...
                if (reportFormat != null && "CSV".equalsIgnoreCase(reportFormat)) {
                    ...
                    strNewIcon = "<img src=\"../common/images/" + XSSUtil.encodeForHTMLAttribute(context, strIconLatestCue) + "\" border=\"0\"  align=\"middle\" " + "TITLE=\"" + " "
    ...
    public Vector getColumnDerivationLevel(Context context, String[] args) throws Exception {
        ...
        BusinessObjectWithSelectList lstProductData = BusinessObject.getSelectBusinessObjectData(context, arrObjId, (StringList) lstSelect);
    ...
    public Vector getColumnDerivedFrom(Context context, String[] args) throws Exception {
        ...
        // Get the Derived From for all the Products
        BusinessObjectWithSelectList lstProductData = BusinessObject.getSelectBusinessObjectData(context, arrObjId, (StringList) lstDerivedSelects);
    ...
    /**
     * This FORM JPO method is used to get the Name and Revision of the Product from which the Product is derived from.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            string array containing packed arguments.
    ...
    /**
     * This FORM JPO method is used to get Derivation Type field. This is now a read only field, based on whether the user selected to create a Revision or Derivation.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            string array containing packed arguments.
    ...
    public String getFormDerivationLevelField(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            displayHTML = DerivationUtil.getDerivationLevelFormField(context, objectId, strSymbolicType, fieldName, strSuiteKey, strDerivationType);
    ...
    /**
     * This FORM JPO method will return a Revision suggestion if the type is Revision or will return nothing for a Derivation
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            string array containing packed arguments.
    ...
    /**
     * This FORM JPO will populate the name field on the Product Derivations FORM IF Product Evolutions is turned OFF
     * @param Context
     *            context
     * @param String
     *            [] args
    ...
    /**
     * Used when the Engineering Change needs to automatically revise an affected item. Creates the next Product Revision in this chain.
     * @param context
     *            The eMatrix <code>Context</code> object
     * @param args
     *            Holds the arguments
     * @return String The objectId of the new Product Revision
     * @throws FrameworkException
     */
    ...
    /**
     * Used as the CreateJPO parameter of the Create New Derivation action, this method creates the new Product Derivation.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
    ...
    public Map createProductDerivation(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            // Create the new Product Derivation.
            Product productBean = new Product();
            String strProductId = productBean.createProductDerivation(context, strType, strName, strRevision, strPolicy, strVault, strOwner, strDescription, objAttributeMap, strDerivationType,
                    strDerivedFromID);
    ...
    /**
     * Used as the PostProcessJPO parameter of the Create New Derivation action, this method connects the Product Derivation with the correct derivation relationships.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
     ...
     */
    @com.matrixone.apps.framework.ui.PostProcessCallable
    public String connectProductDerivationToModel(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            strResult = connectProductDerivationToModel(context, strObjectId, strModelId, strCopyObjId, isRootProduct);
        } catch (Exception e) {
            throw (new FrameworkException(e));
        }
        return strResult;
     ...
     */
    @com.matrixone.apps.framework.ui.PostProcessCallable
    public String connectProductDerivationToModel(Context context, String strObjectId, String strModelId, String strCopyObjId, boolean isRootProduct) throws Exception {
        try {
     ...
     *             if operation fails
     */
    public static String postCreateGetRowXML(Context context, String[] args) throws FrameworkException {
    ...
    /**
     * This will be used to refresh the SB after a Product has been inserted in the Derivation Chain.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            JPO argument
     ...
     *             if operation fails
     */
    public static String postInsertGetRowXML(Context context, String[] args) throws FrameworkException {
        StringBuffer xmlString = new StringBuffer();
        ...
        try {
            ...
            xmlString.append("<item location=\"" + location + "\" oid=\"" + objId + "\" relId=\"" + relId + "\" pid=\"" + selParentId);
    ...
    public String getInsertFormDerivationLevelField(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            slDerivationLevels = DerivationUtil.getAvailableDerivationLevelsForInsert(context, fromObjectId, toObjectId, strParentType);
    ...
    /**
     * To insert the Product from create component, and insert before the selected Product.
     * @param context
     * @param args
     * @return Map
     * @throws Exception
    ...
    public Map insertProductDerivation(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            // Create the attributes to be sent to create by calling the Create Derived Node function. This will fill the
            // Map with the attributes we will need for the new nodes.
            HashMap nodeAttrs = DerivationUtil.insertDerivedNode(context, strDerivedFromID, strDerivedToID, strDerivationLevel, strType);
            if (nodeAttrs != null && nodeAttrs.size() > 0) {
                objAttributeMap.putAll(nodeAttrs);
            }
            ...
            try {
                Product productBean = new Product();
                strProductId = productBean.insertProductDerivation(context, strType, strName, strRevision, strPolicy, strVault, strOwner, strDescription, objAttributeMap, strDerivedFromID,
                        strDerivedToID);
                returnMap.put("id", strProductId);
    ...
    /**
     * Trigger program to enforce the delete Rules for a Product Derivation. Product cannot be frozen and product can have NO children!
     * @param Context
     *            context
     * @param String
     *            [] args
    ...
    public String getProductFormProductLineField(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            String strRootSelectable = "to[" + strLookupRel + "].from.to[" + ProductLineConstants.RELATIONSHIP_PRODUCTLINE_MODELS + "].from.";
    ...
    /**
     * Updates the composition binary when a Product Build relationship is created or deleted. This overrides the generic Composition Binary trigger in order to check if UNT is installed.
     * @param context
    ...
    /**
     * Updates the composition binary when Feature Allocation Type attribute on Product Feature List relationship is modified.
     * @param context
     *            the ENOVIA <code>Context</code> object
     * @param args
     *            String array of arguments in the following order [0] = relationship id [1] = relationship type [2] = from object id [3] = to object id
    ...
    public MapList getAllMilestones(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList mlMilestoneTrack = domProduct.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_CONFIGURATION_CRITERIA, DomainConstants.QUERY_WILDCARD, objectSelects,
                    relationshipSelects, false, // to relationship
            ...
            for (int m = 0; m < mlMilestoneTrack.size(); m++) {
                ...
                MapList mlResult = domMilestoneTrack.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_CONFIGURATION_ITEM, DomainConstants.QUERY_WILDCARD, objectSelects1,
                        relationshipSelects1, false, // to relationship - chagned
                        true, // from relationship
                        (short) 1, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, 0);
    ...
    public MapList getMilestoneTracks(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            mlProductMilestoneTrack = domProduct.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_CONFIGURATION_CRITERIA, DomainConstants.QUERY_WILDCARD, objectSelects,
                    relationshipSelects, false, // to relationship
                    true, // from relationship
                    (short) 1, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, 0);
            ...
            MapList mlModelMT = domModelId.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_CONFIGURATION_CRITERIA, DomainConstants.QUERY_WILDCARD, objectSelects, relationshipSelects,
            ...
            for (int p = 0; p < mlProductMilestoneTrack.size(); p++) {
                ...
                for (int m = 0; m < mlModelMT.size(); m++) {
                    ...
                    MapList mlMT = domModelMT.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_TRACK_TRACEABILITY, ProductLineConstants.TYPE_MILESTONE_TRACK, objectSelects,
                            relationshipSelects, true, // to relationship
    ...
    private static void setCandidateFeaturesOnModelForProduct(Context context, String modelId, String prodId, final String RELATIONSHIP_COMMITTED_CONTEXT) throws Exception {
        ...
        String relPattern = RELATIONSHIP_COMMITTED_CONFIGURATION_FEATURES + "," + RELATIONSHIP_COMMITTED_LOGICAL_FEATURES + "," + RELATIONSHIP_COMMITTED_MANUFACTURING_FEATURES;
        ...
        MapList commitedFeaturesMapList = new DomainObject(modelId).getRelatedObjects(context, relPattern, DomainObject.QUERY_WILDCARD, objSelectables, relSelectables, false, true, (short) 1, null,
                null, 0);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds Type, Name, Revision and Vault of the newly created cloned Product.
     * @throws Exception
     *             if the operation fails
     * @since R217
     */
