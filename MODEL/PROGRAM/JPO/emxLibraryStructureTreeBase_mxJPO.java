...
public class emxLibraryStructureTreeBase_mxJPO {
     ...
     */
    public emxLibraryStructureTreeBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    public static MapList getStructure(Context context, String[] args) throws Exception {
        try {
        ...
        try {
            result = (MapList) subFolder.getRelatedObjects(context, "Subclass", "*", selectTypeStmts, selectRelStmts, false, true, (short) 1, null, null);
