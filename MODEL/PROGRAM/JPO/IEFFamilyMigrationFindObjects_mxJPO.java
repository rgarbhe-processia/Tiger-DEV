...
public class IEFFamilyMigrationFindObjects_mxJPO {
     ...
     * @grade 0
     */
    public IEFFamilyMigrationFindObjects_mxJPO(Context context, String[] args) throws Exception {
    ...
    private void getIds(Context context) throws Exception {
        ...
        String command = "temp query bus '" + familyBusTypeList + "' '*' '*' select attribute[" + attrSource + "] revisions.id revisions.to[" + relVersionOf + "].from.id dump |";
