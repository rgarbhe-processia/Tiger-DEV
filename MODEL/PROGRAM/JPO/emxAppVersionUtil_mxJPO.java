...
public class emxAppVersionUtil_mxJPO extends emxAppVersionUtilBase_mxJPO {
     ...
     */
    @Deprecated
    public emxAppVersionUtil_mxJPO(Context context, String sApplicationName, String sAppInfoFile) throws Exception {
        super(context, sApplicationName, sAppInfoFile);
    }

    public emxAppVersionUtil_mxJPO(Context context, String sApplicationName, String sAppInfoFile, String schemaName) throws Exception {
