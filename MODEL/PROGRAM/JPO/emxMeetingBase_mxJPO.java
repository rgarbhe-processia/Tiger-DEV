...
public class emxMeetingBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @param String
     *            array contains Meetingid, flag to send mail to Existing Attendees
     * @return void
     * @throws Exception
     *             if the operation fails
     * @since AEF Rossini
     * @grade 0
     */
    public void meetingNotification(matrix.db.Context context, String sMeetingId, String strNotification) throws Exception {
        ...
        MapList mapPerson = busMeeting.getRelatedObjects(context, patternRelationship.getPattern(), // String relPattern
        ...
        try {
            ...
            while (mapItr.hasNext()) {
                ...
                if ("Add".equals(sAttributeValue) || ("".equals(sAttributeValue) && sOwner.equals(sAttendeeName))) {
     ...
     *            the eMatrix Context object
     * @param String
     *            array contains Context of Meetings Id
     * @return MapList
     * @throws Exception
     *             if the operation fails
    ...
    public MapList getMeetings(matrix.db.Context context, String[] args) throws Exception {
        ...
        totalresultList = meetingContextObj.getRelatedObjects(context, relPattern.getPattern(), // String relPattern
    ...
    /**
     * This method returns the meeting date and time in 'MMM DD, YYYY HH:MM:SS a' from e.g. 5/8/2009 18:30:00 will be return as 'May 8, 2009 6:30:00 PM'
     * @param context
     * @param meetingObj
    ...
    private String getFormattedMeetingStartDate(Context context, Meeting meetingObj, double clientTZOffset) throws FrameworkException {
        StringList formattedDisplayDateTimeList = FrameworkUtil.split(getFormattedDisplayMeetingStartDateTime(context, meetingObj, clientTZOffset), " ");
        return (String) formattedDisplayDateTimeList.get(0) + " " + (String) formattedDisplayDateTimeList.get(1) + " " + (String) formattedDisplayDateTimeList.get(2);
    }
    ...
    public MapList getMeetingAgendas(Context context, String[] args) throws Exception {
        ...
        ContextUtil.pushContext(context, PropertyUtil.getSchemaProperty(context, "person_UserAgent"), null, context.getVault().getName());
        MapList agendaItemList = MeetingObj.getRelatedObjects(context, RELATIONSHIP_AGENDA_ITEM, // String relPattern
    ...
    public MapList getMeetingSummaryList(Context context, String[] args) throws Exception {
        ...
        MeetingList = personDom.getRelatedObjects(context, relPattern.toString(), // String relPattern
    ...
    /**
     * Access Program to display Context Column on Meeting Summary Page. If it is for Global Meeting Summary page Context colun will be displayed
     * @param context
     *            the eMatrix Context object
     * @param String
     *            array contains Meetings Id
    ...
    /**
     * Program HTML output value to display Actions column on Meeting Summary Page. If it is for Global Meeting Summary page Context colun will be displayed
     * @param context
     *            the eMatrix Context object
     * @param String
     *            array contains Meetings Id
    ...
    public Vector getMeetingSummaryActions(Context context, String[] args) throws Exception {
        ...
        String stateScheduled = (String) FrameworkUtil.lookupStateName(context, DomainObject.POLICY_MEETING, // java.lang.String absolutePolicyName,
                STATE_SCHEDULED);// java.lang.String symbolicStateName)
        // state_InProgress

        String stateInProgress = (String) FrameworkUtil.lookupStateName(context, DomainObject.POLICY_MEETING, // java.lang.String absolutePolicyName,
        ...
        if (businessUnit == null || "null".equals(businessUnit) || "".equals(businessUnit)) {
            ...
            if (strBusMeetSiteName == null || "".equals(strBusMeetSiteName) || "null".equals(strBusMeetSiteName) || strBusMeetSiteId == null || "".equals(strBusMeetSiteId)
                    || "null".equals(strBusMeetSiteId)) {
                busContextOrganization = personObject.getCompany(context);
        ...
        for (Iterator itr = objectList.iterator(); itr.hasNext();) {
            ...
            java.util.Map MeetingInfoList = (java.util.Map) MeetingDom.getInfo(context, select);
            ...
            if (!"None".equals(strMeetingType)) {
                ...
                if (context.getUser().equals(strMeetingOwner)) {
                    if (stateScheduled.equals(strMeetingStatus)) {
                        ...
                        stringbuffer.append(
                                "<a href=\"javascript:emxTableColumnLinkClick('" + FrameworkUtil.encodeURL("../components/emxMeetingProcess.jsp?action=StartMeeting&notification=Yes&sReturnPage="
                                        + strReturnPage + "&objectId=" + XSSUtil.encodeForJavaScript(context, strMeetingId)) + "','700','600','false','popup','');\">");

                        stringbuffer.append("<img src=\"" + FrameworkUtil.encodeURL("images/iconMeetingStart.gif") + "\" valign=\"middle\" border=\"0\" alt=\"Start Meeting\"/></a>");
                    } else if (stateInProgress.equals(strMeetingStatus)) {
                        stringbuffer.append(strRangesLanguage1.toString());
                        stringbuffer.append(
                                "<a href=\"javascript:emxTableColumnLinkClick('" + FrameworkUtil.encodeURL("../components/emxMeetingProcess.jsp?action=JoinMeeting&notification=Yes&sReturnPage="
                                        + strReturnPage + "&objectId=" + XSSUtil.encodeForJavaScript(context, strMeetingId)) + "','700','600','false','popup','');\">");
                        stringbuffer.append("<img src=\"" + FrameworkUtil.encodeURL("images/iconMeetingJoin.gif") + "\" valign=\"middle\" border=\"0\" alt=\"Join Meeting\"/></a>");
                        stringbuffer.append(
                                "<a href=\"javascript:emxTableColumnLinkClick('" + FrameworkUtil.encodeURL("../components/emxMeetingProcess.jsp?action=CloseMeeting&notification=Yes&sReturnPage="
                                        + strReturnPage + "&objectId=" + XSSUtil.encodeForJavaScript(context, strMeetingId)) + "','700','600','false','listHidden','');\">");
                        stringbuffer.append("<img src=\"" + FrameworkUtil.encodeURL("images/iconCloseMeetingSmall.gif") + "\" valign=\"middle\" border=\"0\" alt=\"Close Meeting\"/></a>");
                    } else {
                        stringbuffer.append("");
                    }
                    ...
                    stringbuffer.append(strRangesLanguage1.toString());
                    stringbuffer.append("<img src=\"" + FrameworkUtil.encodeURL("images/iconMeetingJoin.gif") + "\" valign=\"middle\" border=\"0\" alt=\"Join Meeting\"/>");
                } else {
                    stringbuffer.append("");
                }
    ...
    public Vector getMeetingSummaryStartTime(Context context, String[] args) throws Exception {
        ...
        for (Iterator itr = objectList.iterator(); itr.hasNext();) {
            ...
            if (TYPE_MEETING.equals(strObjectType)) {
                meetingStartTime.add(getFormattedMeetingStartTime(context, new Meeting(strObjectId), clientTZOffset, true));
            }
    ...
    public boolean checkEditMeeting(Context context, String[] args) throws Exception {
        ...
        String stateInProgress = (String) FrameworkUtil.lookupStateName(context, DomainObject.POLICY_MEETING, // java.lang.String absolutePolicyName,
                STATE_IN_PROGRESS);// java.lang.String symbolicStateName)
        String stateComplete = (String) FrameworkUtil.lookupStateName(context, DomainObject.POLICY_MEETING, // java.lang.String absolutePolicyName,
    ...
    /**
     * Post process method after Promote or Demote Meeting. Send notification to the recipients when the Meeting is Scheduled
     * @param context
     *            the eMatrix Context object
     * @param String
     *            array contains Meetings Id
    ...
    public void postPromoteDemoteProcess(Context context, String[] args) throws Exception {
        ...
        if (strStatus.equals(stateScheduled)) {
            ...
            MapList mapPerson = busMeeting.getRelatedObjects(context, patternRelationship.getPattern(), // String relPattern
                    ...
                    "", // String relationshipWhere,
                    null, null, // Pattern includeRelationship,
                    null);
            try {
                ContextUtil.startTransaction(context, true);
                Iterator mapItr = mapPerson.iterator();
     ...
     *            the eMatrix Context object
     * @param String
     *            array contains Meetings Ids to delete
     * @return void
     * @throws Exception
     *             if the operation fails
     * @since V6 R207 Author : Louis M
    ...
    public HashMap deleteMeeting(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < meetingIds.length; i++) {
                ...
                MapList docMapList = meetingObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_MEETING_ATTACHMENTS, DomainConstants.TYPE_DOCUMENT, selStmts, new StringList(), false, true,
                        (short) 1, "", "");
                if (docMapList != null) {
     ...
     * @grade 0
     */
    public TreeMap getRangeValuesForAttribute(Context context, String[] args, String strAttributeName) throws Exception {
     ...
     * @grade 0
     */
    public TreeMap getRangeValuesForMeetingType(Context context, String[] args) throws Exception {
    ...
    public String getRangeValuesForLanguage(Context context, String[] args) throws Exception {
        ...
        String strWebExLanguageURL = EnoviaResourceBundle.getProperty(context, "emxCommon.WebExLanguageURL");
        // String strWebExLanguageURL =
        // "emxTeamCentral.Language.English,http://mcapi-latest.webex.com;emxTeamCentral.Language.Japanese,http://mcapi-latest.webex.com;emxTeamCentral.Language.French,http://mcapi-latest.webex.com;emxTeamCentral.Language.Italy,http://mcapi-latest_it.webex.com;emxTeamCentral.Language.Korean,http://mcapi_ko.webex.com;";
        if (strWebExLanguageURL != null && !"".equals(strWebExLanguageURL) && strWebExLanguageURL.indexOf(",") > 0) {
            StringTokenizer sTokGeneric = new StringTokenizer(strWebExLanguageURL, ";");
            // strRangesLanguage += "<select name = meetingKey >";
     ...
     *            the eMatrix Context object
     * @param String
     *            array contains Program Map, Sequence
     * @return StringList
     * @throws Exception
     *             if the operation fails
     * @since V6 R207 Author : Louis M
    ...
    /**
     * This will update the meeting start date time with the given date and time. This will consider user locale and time zone preference and convert it to system time zone. Updates the 'Formatted
     * Input Date Time' this method gets formatted input date time using using eMatrixDateFormat.getFormattedInputDateTime() method.
     * @param context
     * @param meetingObj
     * @param meetingDate
     * @param meetingTime
    ...
    public MapList getMeetingttendee(Context context, String[] args) throws Exception {
        ...
        AgendaItemList = MeetingObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ASSIGNED_MEETINGS, // String relPattern
    ...
    public void deleteAgendaItem(Context context, String[] args) throws Exception {
        ...
        try {
            for (int j = 0; j < agendaItemArray.length; j++) {
                ...
                MapList objList = meetingDom.getRelatedObjects(context, RELATIONSHIP_AGENDA_ITEM, // relPattern.getPattern(),
                        SYMB_WILD, // typePattern.getPattern(),
                        null, selStmts, false, true, (short) 1, "", whereSB.toString());
    ...
    public static MapList findTypesForAgendaItems(Context context, String[] args) throws Exception {
    ...
    /**
     * The function do the processing of Creating Agenda item. Connects the Meeting object to the associatedobject with the relationship "Agenda item"
     * @param context
     *            - the eMatrix <code>Context</code> object
     * @param String
     *            array args containing the programMap, Meeting Id
     * @author Louis M
     * @return - void
     * @throws Exception
    ...
    public void createAgendaPostProcess(Context context, String[] args) throws Exception {
        ...
        DomainObject meetingDom = DomainObject.newInstance(context, strMeetingId);
        MapList agendaItemsWithSameSeq = meetingDom.getRelatedObjects(context, RELATIONSHIP_AGENDA_ITEM, // relPattern.getPattern(),
                SYMB_WILD, // typePattern.getPattern(),
                selStmts, new StringList(), false, true, (short) 1, "", whereSB.toString());
        ...
        StringList associatedObjectIDsList = associatedObjectIDs == null || associatedObjectIDs.equals("") || associatedObjectIDs.equals("null") ? new StringList(strMeetingId)
                : FrameworkUtil.split(associatedObjectIDs, "|");
        ...
        for (int i = 0; i < associatedObjectIDsList.size(); i++) {
            ...
            for (int count = 0; count < responsiblePersonIDs.size(); count++) {
                ...
                mqlCommandSB.append("add connection \"").append(RELATIONSHIP_AGENDA_RESPONSIBILITY).append("\" fromrel \"");
                mqlCommandSB.append(strAgendaRelId);
                mqlCommandSB.append("\" to \"");
                mqlCommandSB.append(strPersonId);
                mqlCommandSB.append("\";");
                MqlUtil.mqlCommand(context, mqlCommandSB.toString());
            }
        }
    }
    ...
    public Vector getAgendaResponsiblePerson(Context context, String[] args) throws Exception {
        ...
        while (agendaObjectListItr.hasNext()) {
            ...
            try {
                String strResult = MqlUtil.mqlCommand(context, "print connection " + sRelationshipId + " select frommid.to.name frommid.to.id dump |");
     ...
     * @grade 0
     */
    public static Boolean showPromoteMeeting(Context context, String[] args) throws Exception {
    ...
    public void updateResponsiblePerson(Context context, String[] args) throws Exception {
        ...
        for (Iterator iter = existingAgendaItemRelIdList.iterator(); iter.hasNext();) {
            ...
            String strAgendaResponsibleRelID = MqlUtil.mqlCommand(context, "print connection " + agendaRelId + " select frommid.id dump ,");
            ...
            for (Iterator iterator = resPersonConnectionIds.iterator(); iterator.hasNext();) {
                ...
                buffer.append("delete connection ").append(iterator.next()).append(';');
                MqlUtil.mqlCommand(context, buffer.toString());
            }
        }
        ...
        for (Iterator iter = existingAgendaItemRelIdList.iterator(); iter.hasNext();) {
            ...
            for (Iterator personIdItr = personIds.iterator(); personIdItr.hasNext();) {
                ...
                buffer.append("add connection \"").append(RELATIONSHIP_AGENDA_RESPONSIBILITY).append("\" fromrel ").append(agendaRelId).append(" to ").append(personIdItr.next());
                MqlUtil.mqlCommand(context, buffer.toString());
            }
        }
    }
     ...
     * @grade 0
     */
    public static Boolean showCloseMeetingCommand(Context context, String[] args) throws Exception {
     ...
     * @grade 0
     */
    public static Boolean showStartMeetingCommand(Context context, String[] args) throws Exception {
    ...
    public boolean checkWorkspaceMeeting(Context context, String args[]) throws Exception {
        ...
        // in toolbar.
        MapList workspaceList = dObj.getRelatedObjects(context, relationship, "*", new StringList("id"), null, true, false, (short) 1, null, null);
    ...
    public String getSequenceNumOnCreate(Context context, String[] args) throws Exception {
        ...
        StringList selectTypeStmts = new StringList();
        selectTypeStmts.add(MeetingObj.SELECT_ID);
        agendaItemList = MeetingObj.getRelatedObjects(context, RELATIONSHIP_AGENDA_ITEM, // String relPattern
                SYMB_WILD, // String typePattern
                selectTypeStmts, // StringList objectSelects,
                selectRelStmts, // StringList relationshipSelects,
                false, // boolean getTo,
     ...
     *            the eMatrix Context object
     * @param String
     *            array contains connected context object object id
     * @throws Matrix
    ...
    public BusinessObject getProjectMember(matrix.db.Context context, String projectId, BusinessObject person) throws MatrixException {
        ...
        ExpansionIterator expItr = person.getExpansionIterator(context, relPattern, typePattern, EMPTY_STRING_LIST, EMPTY_STRING_LIST, false, true, (short) 1, strWhereClause, null, (short) 0, false,
    ...
    public static String getCompanyFieldHTMLOutput(Context context, String[] args) throws Exception {
        ...
        if (!compName.equals(hostCompanyName)) {
            ...
            companySelect.append("<input type=\"hidden\" name=\"Company\"  value=\"").append(XSSUtil.encodeForHTMLAttribute(context, company.getId())).append("\">").append("&nbsp;")
                    .append(XSSUtil.encodeForHTML(context, company.getName()));
            ...
            for (Iterator iter = companies.iterator(); iter.hasNext();) {
                ...
                companySelect.append("<option value=\"").append(XSSUtil.encodeForHTMLAttribute(context, id)).append('"').append(selected).append('>').append(XSSUtil.encodeForHTML(context, name))
                        .append("</option>");
            }
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static MapList getMeetingAttendeeSearchPersons(Context context, String[] args) throws Exception {
        ...
        if (searchInMeetingAttendees) {
            ...
            return meetingObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ASSIGNED_MEETINGS, // String relPattern
                    DomainConstants.TYPE_PERSON, // String typePattern
            ...
            return DomainObject.findObjects(context, strType, isEmpty(strName) ? SYMB_WILD : strName, SYMB_WILD, SYMB_WILD, strVault, sbWhereExp.toString(), "", true, slSelect, sQueryLimit);
        }
    }
    ...
    private Map getMeetingContextObject(Context context, DomainObject meetingObject, StringList selectItems, boolean userSuperUserContext) throws Exception {
        ...
        try {
            ...
            MapList mapList = meetingObject.getRelatedObjects(context, DomainConstants.RELATIONSHIP_MEETING_CONTEXT, SYMB_WILD, // String typePattern
    ...
    public void updateAgendaReportedAgainst(Context context, String[] args) throws Exception {
        ...
        String connectedPersons = MqlUtil.mqlCommand(context, "print connection " + strAgendaItemRelId + " select frommid.to.id dump ,");
        ...
        for (Iterator iter = existingAgendaItemRelIdList.iterator(); iter.hasNext();) {
            ...
            removeAgendaItemsCommand.append("delete connection ").append(iter.next()).append(';');
            MqlUtil.mqlCommand(context, removeAgendaItemsCommand.toString());
        }
        ...
        for (Iterator iter = newReportedAgainstList.iterator(); iter.hasNext();) {
            ...
            for (Iterator personIdItr = connectedPersonIdList.iterator(); personIdItr.hasNext();) {
                ...
                connectPersonsCommand.append("add connection \"").append(RELATIONSHIP_AGENDA_RESPONSIBILITY).append("\" fromrel ").append(relAgendaItem.toString().trim()).append(" to ")
                        .append(personIdItr.next()).append(';');
                MqlUtil.mqlCommand(context, connectPersonsCommand.toString());
            }
        }
    }
    ...
    /**
     * This method return boolean value to show or hide command Returns false if the context user is not the meeting host Returns false if the current state of meeting is not in the given array of
     * states
     * @param context
     * @param args
    ...
    /**
     * This method return boolean value to show or hide MeetingSend Or UpdateInvitations commands Returns false if the context user is not the meeting host Returns false if the current state of
     * meeting is not Create If updateInvitation is true and the meeting is promoted to scheduled state returns true otherwise return false If updateInvitation is false and the meeting is not promoted
     * to scheduled state returns true otherwise return false
     * @param context
     * @param args
     * @param updateInvitation
     * @return
    ...
    private static Boolean showSendOrUpdateInvitationsCommand(Context context, String[] args, boolean updateInvitation) throws Exception {
        ...
        String strMeetingId = (String) programMap.get("objectId");
        /**
         * Check whether this meeting is promoted to Scheduled state If the start time stamp is not blank this meeting is promoted to Scheduled state earlier state[Scheduled].start returns empty
         * string if the object has never been in the state.
         */
        boolean promoted = MqlUtil.mqlCommand(context, "print bus " + strMeetingId + " select state[" + STATE_MEETING_SCHEDULED + "].start dump ,").trim().length() > 0;
        return updateInvitation ? Boolean.valueOf(promoted) : Boolean.valueOf(!promoted);
    }

    /**
     * Access Program for APPMeetingPromoteSendInvitations command This method return boolean value to show or hide Send Invitations command also see
     * <code>showMeetingSendOrUpdateInvitationsCommand(context, args[], pdateInvitation)</code> method
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * Access Program for APPMeetingPromoteUpdateInvitations command This method return boolean value to show or hide Update Invitations command also see
     * <code>showMeetingSendOrUpdateInvitationsCommand(context, args[], pdateInvitation)</code> method
     * @param context
     * @param args
     * @return
    ...
    /**
     * Access Program for APPMeetingPromoteStartMeeting command This method return boolean value to show or hide 'Start Meeting' command Retrun true when logged in user is meeting host and meeting is
     * in Scheduled state also see <code>showCommandInStates(context, args[], states)</code> method
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * Access Program for APPMeetingPromoteCompleteMeeting command This method return boolean value to show or hide 'Close Meeting' command Retrun true when logged in user is meeting host and meeting
     * is in In Progress state also see <code>showCommandInStates(context, args[], states)</code> method
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * Access Program for APPMeetingDemoteForEdit command This method return boolean value to show or hide 'Demote for Editing' command Retrun true when logged in user is meeting host and meeting is
     * in Scheduled state also see <code>showCommandInStates(context, args[], states)</code> method
     * @param context
     * @param args
     * @return
    ...
    /**
     * Access Program for APPMeetingDomote command This method return boolean value to show or hide 'Close Meeting' command Retrun true when logged in user is meeting host and meeting is in In
     * Progress or Complete state also see <code>showCommandInStates(context, args[], states)</code> method
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    public Map meetingAgendaItemEditPreProcess(Context context, String[] args) throws Exception {
        ...
        String agendaRelIds = MqlUtil.mqlCommand(context, "print bus " + meetingId + " select relationship[" + RELATIONSHIP_AGENDA_ITEM + "].id dump");
        ...
        if (agendaRelIds.equals("")) {
            ...
            returnMap.put("Action", "stop");
            returnMap.put("Message", EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", strLocale, "emxComponents.Meeting.Agenda.EditByNonHostPerson"));
        }
     ...
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            - string array containing the packed program information
    ...
    public boolean isMeetingAttendee(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (doMeeting.getType(context).equals(DomainObject.TYPE_MEETING)) {
                ...
                MapList mlAttendees = doMeeting.getRelatedObjects(context, RELATIONSHIP_ASSIGNED_MEETINGS, TYPE_PERSON, new StringList(SELECT_ID), new StringList(SELECT_RELATIONSHIP_ID), true, false,
                        (short) 1, sWhereExp, EMPTY_STRING, 0);
                if (mlAttendees.size() < 1)
                    bReturn = false;
            }
    ...
    /**
     * Returns the related objects for Meeting (i.e. Agendaitem/Decision/Person) object in APPMeetingSummary
     * @param context
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getTableMeetingData(Context context, String[] args) throws Exception {
        ...
        if (null != parentId && null != objectId && !parentId.equals(objectId)) {
            ...
            MapList decisionList = (MapList) JPO.invoke(context, "emxDecision", null, "getRelatedDecisions", args, MapList.class);

            for (int i = 0; i < agendaList.size(); i++) {
                tempMap = (Map) agendaList.get(i);
                tempMap.put(DomainConstants.SELECT_TYPE, RELATIONSHIP_AGENDA_ITEM);
    ...
    /**
     * Returns the name values for Meeting/Agendaitem/Decision/person object in APPMeetingSummary
     * @param context
     *            Matrix Context object
     * @param args
     *            String array
    ...
    /**
     * Returns the Description for Meeting and its realted objects Item/Decision/person object in APPMeetingSummary
     * @param context
     *            Matrix Context object
     * @param args
     *            String array
    ...
    public Vector getColumnMeetingDescriptionData(Context context, String[] args) throws Exception {
        try {
            // Create result vector
            Vector vecResult = new Vector();
            // Get object list information from packed arguments
    ...
    /**
     * Returns the Start Date value for Meeting and its related object in APPMeetingSummary
     * @param context
     *            Matrix Context object
     * @param args
     *            String array
        ...
        try {
            ...
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext();) {
                ...
                if (strObjectType.equals(TYPE_MEETING)) {
                    ...
                    vecResult.add(new Meeting(strObjectId).getInfo(context, "attribute[" + DomainConstants.ATTRIBUTE_MEETING_START_DATETIME + "]"));
    ...
    /**
     * Returns the Meeting Duration attribute value for Meeting/Agenda Item/Decision/person object in APPMeetingSummary
     * @param context
     *            Matrix Context object
     * @param args
     *            String array
    ...
    public Vector getColumnMeetingDurationData(Context context, String[] args) throws Exception {
        try {
            // Create result vector
            Vector vecResult = new Vector();
            // Get object list information from packed arguments
            ...
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext();) {
                ...
                if (objDbo.isKindOf(context, TYPE_MEETING)) {
                    ...
                    Map resultList = null;
                    if (null == strObjRelId || "".equals(strObjRelId) || "null".equalsIgnoreCase(strObjRelId)) {
                        strColumnValues = objDbo.getAttributeValue(context, ATTRIBUTE_MEETING_DURATION);
                    } else {
                        ContextUtil.pushContext(context, PropertyUtil.getSchemaProperty(context, "person_UserAgent"), null, context.getVault().getName());
                        DomainRelationship RelDobj = DomainRelationship.newInstance(context, strObjRelId);
                        strColumnValues = RelDobj.getAttributeValue(context, ATTRIBUTE_TOPIC_DURATION);
                        ContextUtil.popContext(context);
                    }
                } else {
                    strColumnValues = "";
    ...
    /**
     * Returns the Current State for Meeting/Agenda Item/Decision/person object in APPMeetingSummary
     * @param context
     *            Matrix Context object
     * @param args
     *            String array
    ...
    public Vector getColumnMeetingCurrentStateData(Context context, String[] args) throws Exception {
        try {
            // Create result vector
            Vector vecResult = new Vector();
            // Get object list information from packed arguments
    ...
    /**
     * Returns the Relationship between Meeting and Agenda Item/Decision/Person object in APPMeetingSummary
     * @param context
     *            Matrix Context object
     * @param args
     *            String array
    ...
    public Vector getColumnMeetingRelationshipData(Context context, String[] args) throws Exception {
        try {
            // Create result vector
            Vector vecResult = new Vector();
            // Get object list information from packed arguments
    ...
    /**
     * Returns the Type for Meeting/Agenda Item/Decision/person object in APPMeetingSummary
     * @param context
     *            Matrix Context object
     * @param args
     *            String array
    ...
    public Vector getColumnMeetingTypeData(Context context, String[] args) throws Exception {
    ...
    /**
     * Returns the Object Owner value for Meeting/Agenda Item/Decision/Person object in APPMeetingSummary
     * @param context
     *            Matrix Context object
     * @param args
     *            String array
    ...
    public Vector getColumnMeetingOwnerData(Context context, String[] args) throws Exception {
        try {
            // Create result vector
            Vector vecResult = new Vector();
            // Get object list information from packed arguments
    ...
    /**
     * Returns the Popup icon & its related links for Meeting/Agenda Item/Decision/Person object in APPMeetingSummary
     * @param context
     *            Matrix Context object
     * @param args
     *            String array
    ...
    public Vector getColumnMeetingPopup(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            while (itrObjects.hasNext()) {
                ...
                if (!isPrinterFriendly) {
                    ...
                    strObjType = (String) mapRowData.get(SELECT_TYPE);
                    if (TYPE_MEETING.equals(strObjType) || TYPE_PERSON.equals(strObjType) || TYPE_DECISION.equals(strObjType)) {
                        strObjectId = (String) mapRowData.get(SELECT_ID);
                        popuplink.append("<a href=\"javascript:emxTableColumnLinkClick('");
                        popuplink.append(FrameworkUtil.encodeURL("emxTree.jsp?mode=replace&objectId=" + strObjectId));
                        popuplink.append("','700','600','false','popup','');\" >");
                        popuplink.append("<img src=\"images/iconNewWindow.gif\" valign=\"middle\" border=\"0\" />");
                        popuplink.append("</a>");
                    } else {
                        strObjectId = (String) mapRowData.get(SELECT_ID);
                        popuplink.append("<a href=\"javascript:emxTableColumnLinkClick('");
                        popuplink.append(FrameworkUtil.encodeURL("emxTree.jsp?mode=replace&treeNodeKey=node.Meeting&DefaultCategory=APPMeetingAgenda&objectId=" + strObjectId));
                        popuplink.append("','700','600','false','popup','');\" >");
                        popuplink.append("<img src=\"images/iconNewWindow.gif\" valign=\"middle\" border=\"0\" />");
                        popuplink.append("</a>");
                    }
    ...
    public static StringList getCellAccessforMeetingSummary(Context context, String args[]) throws Exception {
        HashMap inputMap = (HashMap) JPO.unpackArgs(args);
        ...
        for (Iterator objectItr = objectMap.iterator(); objectItr.hasNext();) {
            ...
            strCurrent = (String) curObjectMap.get(DomainConstants.SELECT_CURRENT);
    ...
    public StringList getAgendaResponsiblePersonIncludeIDs(Context context, String[] args) throws FrameworkException {
        try {
            ...
            DomainObject meetingObj = DomainObject.newInstance(context);
            meetingObj.setId(meetingObjectId);
            MapList attendees = meetingObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ASSIGNED_MEETINGS, // String relPattern
                    DomainConstants.TYPE_PERSON, // String typePattern
                    new StringList(SELECT_ID), // StringList objectSelects,
                    null, // StringList relationshipSelects,
                    true, // boolean getTo,
