...
/*
 ** MCADIntegGetLatesFrozenRevisionBase
 **
...
public class MCADIntegGetLatestFrozenRevisionBase_mxJPO {
    ...
    public MCADIntegGetLatestFrozenRevisionBase_mxJPO() {
    }

    public MCADIntegGetLatestFrozenRevisionBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    public Hashtable getLatestForObjectIds(Context context, String[] args) throws Exception {
        ...
        retTable = util.getObjectIdForParticularView(context, "state_Approved", args);
        return retTable;
    }
}
