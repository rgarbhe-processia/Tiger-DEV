...
public class emxCommonFileBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @grade 0
     */
    public emxCommonFileBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
     ...
     * @since Common 10.0.0.0
     */
    public static void checkinUpdate(Context context, String objectId, String store, String format, String fileName, String append, String unlock, String receiptValue) throws Exception {
        try {
     ...
     *            the eMatrix <code>Context</code> object
     * @param type
     *            the String type name for the new document - default to Document if - null
     * @param name
     *            the String name of the document objecct getting created
     * @param policy
     *            the String policy for the new Document object
     * @param description
     *            the String description of the document objecct
     * @param title
     *            the String title attribute vaule of the document objecct
     * @param language
     *            the String language attribute vaule of the document objecct
     * @param parentId
     *            the String parent object id of the document objecct
     * @param parentRelName
     *            the String parentRelationship name of the document objecct
     * @returns String new Document Id
     * @throws Exception
     *             if the operation fails
     * @since Common 10.0.0.0
     */
    public String checkinCreate(Context context, String type, String name, String policy, String description, String title, String language, String parentId, String parentRelName) throws Exception {
        return checkinCreate(context, type, name, policy, description, title, language, parentId, parentRelName, true);
    }
     ...
     * @since Common 10.0.0.0
     */
    public String checkinCreate(Context context, String type, String name, String policy, String description, String title, String language, String parentId, String parentRelName, boolean isFrom)
            throws Exception {
        try {
            ContextUtil.startTransaction(context, true);
    ...
    public String mcsCheckinCreate(Context context, String[] args) throws Exception {
        ...
        return mcsCheckinCreate(context, fileList, type, name, policy, title, description, store, append, format, unlock, language, parentId, parentRelName, isFrom);
     ...
     *            the eMatrix <code>Context</code> object
     * @param fileList
     *            the StringList of files need to checkin to this document Object
     * @param name
     *            the String name of the document objecct getting created
     * @param title
     *            the String title attribute vaule of the document objecct
     * @param description
     *            String of Description of the document this string will be set as Description of the document created in this method
     * @param store
     *            String to specify in which store these files need to get checked in
     * @param append
     *            boolean true if these files need to get appended to the existing file false if these files need to over-write existing files
     * @param format
     *            String the specifies in which format the files should get checked in if this is null then file will be checked in to generic format
     * @param unlock
     *            boolean true to unlock this file after checkin false to hold lock on this document
     * @param language
     *            String specifies the language of the file getting checked in
     * @param parentId
     *            the String parent object id of the document objecct
     * @param parentRelName
     *            the String parentRelationship name of the document objecct
     ...
     */
    public String mcsCheckinCreate(Context context, StringList fileList, String type, String name, String policy, String title, String description, String store, boolean append, String format,
            boolean unlock, String language, String parentId, String parentRelName, boolean isFrom) throws Exception {
        try {
            ContextUtil.startTransaction(context, true);
            Document document = (Document) DomainObject.newInstance(context, DomainConstants.TYPE_DOCUMENT);
            document = document.create(context, type, name, policy, description, title, language);
     ...
     * @since Common 10.0.0.0
     */
    public String mcsCheckinCreate(Context context, StringList fileList, String name, String title, String description, String store, boolean append, String format, boolean unlock, String language,
            String parentId, String parentRelName) throws Exception {
        return mcsCheckinCreate(context, fileList, name, title, description, store, append, format, unlock, language, parentId, parentRelName, true);
    }
     ...
     */
    public String mcsCheckinCreate(Context context, StringList fileList, String name, String title, String description, String store, boolean append, String format, boolean unlock, String language,
            String parentId, String parentRelName, boolean isFrom) throws Exception {
        try {
            ContextUtil.startTransaction(context, true);
            Document document = (Document) DomainObject.newInstance(context, DomainConstants.TYPE_DOCUMENT);
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            the String of Object id of the document
     * @param description
     *            String of Description of the document this string will be set as Description of the document created in this method
     * @param language
     *            String specifies the language of the file getting checked in
     * @param reason
     *            String specifies the Reason For Change of the file getting checked in
     * @returns String new Document Id
     * @throws Exception
     *             if the operation fails
     * @since Common 10.0.0.0
     */
    public String checkinRevise(Context context, String objectId, String description, String language, String reason) throws Exception {
        try {
            ContextUtil.startTransaction(context, true);
     ...
     * @since Common 10.0.0.0
     */
    public static void multiFileCheckinUpdate(Context context, StringList objectIds, String store, StringList formats, StringList fileNames, String receiptValue) throws Exception {
        try {
     ...
     * @since Common 10.0.0.0
     */
    public static void multiFileCheckinUpdate(Context context, StringList objectIds, String store, StringList formats, StringList fileNames, StringList appends, StringList unlocks,
            String receiptValue) throws Exception {
        try {
            if (appends != null)
    ...
    public Map mcsMultiFileCheckinCreate(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (title != null && !"".equals(title) && !"null".equals(title)) {
                ...
                preCheckin(context, args);
                String objectId = mcsCheckinCreate(context, fileList, null, title, description, store, defaultAppend, format, defaultUnlock, language, parentId, parentRelName);
    ...
    public Map mcsMultiFileCheckinRevise(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (title != null && !"".equals(title) && !"null".equals(title)) {
                ...
                Document document = (Document) DomainObject.newInstance(context, objectId);
                preCheckin(context, args);
                document = document.checkinRevise(context, strFileList, description, store, defaultAppend, format, defaultUnlock, language);
                if (reason != null) {
        ...
        try {
            ...
            if (fileNames.size() == descriptions.size()) {
                for (int i = 0; i < descriptions.size(); i++) {
                    ...
                    versionDoc.createObject(context, DomainConstants.TYPE_VERSION_DOCUMENT, getUniqueName(default_Version_Doc_Extension), FIRST_VERSION_DOCUMENT_REV,
                    ...
                    DomainRelationship.connect(context, object, DomainConstants.RELATIONSHIP_VERSION, versionDoc);
                }
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public String updateVersionDocument(Context context, String[] args) throws Exception {
        try {
            ...
            short level = 1;
            MapList versionList = busObject.getRelatedObjects(context, DomainConstants.RELATIONSHIP_VERSION, DomainConstants.TYPE_VERSION_DOCUMENT, objectSelects, null, false, true, level,
                    objWhereExpr, "");
            ...
            String strCommand = "modify bus " + latestVerDocId + " move from " + objectId + " format '" + format + "' file " + "'" + fileName + "'";

            MQLCommand mqlCommand = new MQLCommand();
            mqlCommand.executeCommand(context, strCommand);
            ...
            verDocObject.createAndConnect(context, DomainConstants.TYPE_VERSION_DOCUMENT, uniqueName, DomainConstants.RELATIONSHIP_VERSION, busObject, true);
