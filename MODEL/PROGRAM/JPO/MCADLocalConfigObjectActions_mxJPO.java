...
public class MCADLocalConfigObjectActions_mxJPO {
    ...
    /**
     * Entry Point This method adds the local config object with input TNR if it does not already exist in the database and returns "true". If the object with given TNR already exists, "true" is
     * returned.
     */
