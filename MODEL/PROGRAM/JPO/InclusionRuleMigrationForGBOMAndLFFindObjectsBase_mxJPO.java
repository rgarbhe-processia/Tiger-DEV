...
/**
 * The <code>FTRGBOMEffectivityMigrationFindObjectsBase</code> class contains implementation code for list out all the Models in the system. This is the very first step of Migration.
 */
public class InclusionRuleMigrationForGBOMAndLFFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO {
     ...
     */
    public InclusionRuleMigrationForGBOMAndLFFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }

    /**
     * This method is executed if a specific method is not specified. This is the actual method to get all the Model ids in system and write them in file name objectids_xx.txt
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    /**
     * Sets the migration status as a property setting. Status could be :- FindObjectInProgress FindObjectCompleted MigrationInProgress MigrationCompleted MigrationKO
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param strStatus
