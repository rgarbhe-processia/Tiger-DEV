...
public class emxRouteTaskTitleSortBase_mxJPO extends emxCommonBaseComparator_mxJPO {
     ...
     * @throws Exception
     */
    public emxRouteTaskTitleSortBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    public emxRouteTaskTitleSortBase_mxJPO() {
        try {
    ...
    public int compare(Object object1, Object object2) {
        ...
        /*
         * values will be retrieved for the lower case column names, this has been done to get actual data displayed in html output If the value for lower case key is null, then get column values for
         * original column name passed.
         */
        // String htmlOutPutDisplayKey = keyName.toLowerCase();
        String stringValue1 = (String) map1.get("attribute[Title]");
        // stringValue1 = !(stringValue1 == null) ? stringValue1 : (String) map1.get(keyName);
        String stringValue2 = (String) map2.get("attribute[Title]");
        ...
        try {
            diff = str1Empty && str2Empty ? 0 : str1Empty ? -1 : str2Empty ? 1 : stringValue1.compareToIgnoreCase(stringValue2);
        } catch (Exception e) {
