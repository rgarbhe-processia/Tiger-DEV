...
public class IEFCreateDesignObject_mxJPO {
     ...
     * @param context
     * @param args
     *            Key and value in the packed Hastable "GCO" = packed Global Config Object "languageName" = locale language name "templateObjID" = Template object ID "type" = Type of the design object
     *            to be created "name" = Name of the design object to be created. If AutoName is selected, it should be a blank string "customRevision" = Revision of the design object to be created
     *            "policy" = Policy for the design object to be created "autoName" = "true" if AutoName is selected; "false" otherwise "autoNameSeries" = autoname series "isRootObject" = "true" if the
     *            selected template object is a component or the topmost assembly; "false" otherwise "attributesMap" = HashMap containing actual attribute names as key and values as value
     * @return
     * @throws Exception
     */
