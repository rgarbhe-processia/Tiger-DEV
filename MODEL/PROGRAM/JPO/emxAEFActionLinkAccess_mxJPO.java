...
/**
 * The <code>emxAEFActionLinkAccess</code> class contains methods for ActionLinkAccess.
 * @version AEF 10.0.Patch1.0 - Copyright (c) 2003, MatrixOne, Inc.
 */

public class emxAEFActionLinkAccess_mxJPO extends emxAEFActionLinkAccessBase_mxJPO {
    ...
    public emxAEFActionLinkAccess_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
