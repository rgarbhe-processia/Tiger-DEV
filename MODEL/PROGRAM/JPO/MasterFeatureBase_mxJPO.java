...
public class MasterFeatureBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @author IVU
     */
    public MasterFeatureBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    /**
     * This is method is used to retrieve the context Master Feature/Model. Master Feature of the Technical feature if present.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
            ...
            if (lstObjectIdsList.size() != 0) {
                for (int iCnt = 0; iCnt < lstObjectIdsList.size(); iCnt++) {
                    ...
                    if ((mxType.isOfParentType(context, strType, ManufacturingPlanConstants.TYPE_LOGICAL_FEATURE) || mxType.isOfParentType(context, strType, ManufacturingPlanConstants.TYPE_PRODUCTS))
                        ...
                        relPattern = ManufacturingPlanConstants.RELATIONSHIP_MANAGED_REVISION + "," + ManufacturingPlanConstants.RELATIONSHIP_PRODUCTS;

                        objPattern = ManufacturingPlanConstants.TYPE_MASTER_FEATURE + "," + ManufacturingPlanConstants.TYPE_MODEL;

                        objSelects.add(DomainConstants.SELECT_ID);
                        objSelects.add(DomainConstants.SELECT_TYPE);
                        objSelects.add(DomainConstants.SELECT_NAME);

                        MapList mLCntxtMasterFeatures = domFeatId.getRelatedObjects(context, relPattern, objPattern, objSelects, null, true, false, (short) 1, null, null, 0);
                            ...
                            for (int i = 0; i < mLCntxtMasterFeatures.size(); i++) {
                                ...
                                if (strCntxtMasterFeatType != null) {
                                    if (exportToExcel) {
                                        ...
                                        sb = sb.append(XSSUtil.encodeForXML(context, strCntxtMasterFeatName)).append(strEndTitle).append(strStartImage);
                                        ...
                                        sb = sb.append(strImageEnd).append(XSSUtil.encodeForXML(context, strCntxtMasterFeatName)).append(strEndHref);
    ...
    /**
     * This is a trigger method used to update the Revision Count attribute on the Master Feature Object, when the Feature Revision object is connected to Master Feature with Feature Revisions
     * relationship. This method is called on the create trigger on "Feature Revisions" relationship.
     * @param Context
     *            context - Matrix Context Object
     * @param String
     *            args - holds the FromID on the relationship which is Master Feature.
     * @return int iResult - 0 if operation is successful - 1 if operation fails.
     * @throws Exception
     * @author IVU
     * @since CFP R209
     */
    public int updateRevisionCountOnMasterFeature(Context context, String args[]) throws Exception {
        int iResult = 0;
        try {
    ...
    /**
     * This is a trigger method used to update the Revision Count attribute on the Master Feature Object, when the Feature Revision object is revised and connected to Master Feature with Feature
     * Revisions relationship. This method is called on the ModifyTo trigger on "Feature Revisions" relationship.
     * @param Context
     *            context - Matrix Context Object
     * @param String
     *            args - holds the FromID on the relationship which is Master Feature.
     ...
     * @since CFP R209
     */
    public int updateRevisionCountOnMasterFeatureModifyTo(Context context, String args[]) throws Exception {
        int iResult = 0;
        try {
            String strMasterFeatureId = args[0];
            iResult = updateRevisionCount(context, strMasterFeatureId, ManufacturingPlanConstants.RELATIONSHIP_MANAGED_REVISION);
    ...
    private int updateRevisionCount(Context context, String strObjId, String strRelName) throws Exception {
        ...
        try {
            ...
            /*
             * String strMQLQuery = "eval expr \"Count TRUE\"  on expand bus "+strObjId+" rel \""+strRelName+"\" dump"; String strCount = MqlUtil.mqlCommand(context, strMQLQuery);
             */
     ...
     * @param context
     *            - Holds the matrix Context
     * @param args
     *            - holds model tempalte ID and context Product ID
     ...
     * @since CFP R209
     */
    public int deleteMasterFeature(Context context, String args[]) throws Exception {
        int iResult = 0;
        try {
            ...
            if (strFeatureId != null && !strFeatureId.equals("")) {
                ...
                if (strMasterFeatureId != null && !strMasterFeatureId.equals("")) {
                    /*
                     * String strMQLQuery = "eval expr \"Count TRUE\"  on expand bus "+strMasterFeatureId+" rel \""+ManufacturingPlanConstants.RELATIONSHIP_MANAGED_REVISION+"\" dump"; String strCount
                     * = MqlUtil.mqlCommand(context, strMQLQuery);
                     */
                    String strMQLQuery = "eval expr $1 on expand bus $2 rel $3 dump";
    ...
    /**
     * This method is called from the Model context to get the Master Features associated to Model and the Managed Revisions of the corresponding Master Feature
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
     * @return MapList - Contain the Master Feature, Products, Feature
     * @throws Exception
     *             if the operation fails
     * @author IVU
     * @since DMCPlanning R209
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getMasterFeatureStructure(Context context, String[] args) throws Exception {
    ...
    /**
     * This is a public method, which call createAndConnectFeatureRevision to create the Logical Feature and connect to the context Master Feature with Managed Revision Relationship.
     * @param context
    ...
    public void createLogicalFeature(Context context, String[] args) throws FrameworkException {
        try {
    ...
    public MapList getProductRevisionsWithSelectedFeatures(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            if (objType != null && (isModel)) {
                mapChildParts = dom.getRelatedObjects(context, ManufacturingPlanConstants.RELATIONSHIP_PRODUCTS, ManufacturingPlanConstants.TYPE_PRODUCTS, strListSelectstmts, new StringList(), false,
                        true, (short) 0, strSelIdsWhrClause, "", 0);
                if (mapChildParts.isEmpty()) {
                    String language = context.getSession().getLanguage();
                    String strAlertMessage = EnoviaResourceBundle.getProperty(context, "Configuration", "emxProduct.Error.Model.NoProductRevision", language);
    ...
    public List getDynamicColumnDataForReport(Context context, String args[]) throws Exception {
        ...
        mapList = utilObj.getObjectStructure(context, strTypePattern, strRelPattern, slObjSelects, slRelSelects, false, true, level, limit, strObjWhere, strRelWhere, (short) 0, null);
        ...
        for (int i = 0; i < mapList.size(); i++) {
            ...
            pflconnectedidsobject = (Object) newmap.get("tomid[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST + "]." + DomainConstants.SELECT_FROM_ID);
            pflconnectedidslist = ManufacturingPlanUtil.convertObjToStringList(context,
                    newmap.get("tomid[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST + "]." + DomainConstants.SELECT_FROM_ID));
    ...
    public List getMasterFeatureUsage(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            slObjSelects.addElement(ManufacturingPlanConstants.SELECT_NAME);
            slObjSelects.addElement(ManufacturingPlanConstants.SELECT_REVISION);
            slObjSelects.addElement("to[" + ManufacturingPlanConstants.RELATIONSHIP_LOGICAL_FEATURES + "]" + ".tomid[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST + "].attribute["
                    + ManufacturingPlanConstants.ATTRIBUTE_FEATURE_ALLOCATION_TYPE + "]");
            // Selectables on Relationship
            StringList slRelSelects = new StringList();
            slRelSelects.addElement("tomid[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST + "].from.id");
            slRelSelects.addElement("tomid[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST + "].attribute[" + ManufacturingPlanConstants.ATTRIBUTE_FEATURE_ALLOCATION_TYPE + "]");
            ManufacturingPlanUtil utilObj = new ManufacturingPlanUtil(strProdId);
            // Where clause on relationship
            String strRelWhere = "tomid[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST + "].from.id==" + strProdId;
            mapList = utilObj.getObjectStructure(context, strTypePattern, strRelPattern, slObjSelects, slRelSelects, false, true, level, limit, strObjWhere, strRelWhere, (short) 0, null);
            ...
            for (int i = 0; i < mapList.size(); i++) {
                ...
                pflusageobject = (Object) newmap
                        .get("tomid[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST + "].attribute[" + ManufacturingPlanConstants.ATTRIBUTE_FEATURE_ALLOCATION_TYPE + "]");
            ...
            for (int i = 0; i < objectList.size(); i++) {
                ...
                if (domobj.isKindOf(context, ManufacturingPlanConstants.TYPE_LOGICAL_FEATURE) || domobj.isKindOf(context, ManufacturingPlanConstants.TYPE_PRODUCTS)) {
                    ...
                    if (usage != null) {
                        ...
                        /*
                         * if(usage.equalsIgnoreCase(strFeatureRequired)) { usageList.addElement(strFeatureUsageRequiredDisplay); }
                         */
                    } else {
                        usageList.addElement("");
                    }
    ...
    /**
     * This method gets the range of values for the displayed Product Feature List Usage feild.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public void updateFeatureUsage(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList mapList = mapList = utilObj.getObjectStructure(context, strTypePattern, strRelPattern, slObjSelects, slRelSelects, true, false, (short) 0, (short) 0, null, strRelWhere, (short) 0,
                    null);
     ...
     */
    public void creationmasterfeature(Context context, String[] args) throws FrameworkException {
        try {
            String objectid = args[0];
            String strCreateLogicalFeature = PropertyUtil.getGlobalRPEValue(context, "CreateLogicalFeatureMFContext");
            String strCreateMasterFeatureLFContextInheritedTrigger = PropertyUtil.getGlobalRPEValue(context, "CreateMasterFeatureLFContextInheritedTrigger");
            if (strCreateLogicalFeature != null && !"TRUE".equals(strCreateLogicalFeature) && strCreateMasterFeatureLFContextInheritedTrigger != null
                    && !"TRUE".equals(strCreateMasterFeatureLFContextInheritedTrigger)) {
                ...
                String strMasterrFeatureID = masterFeature.create(context, strModelId, strType, strName, strRevision, strPolicy, strVault, strOwner, strDescription, AttributeMap,
                        hmManagedRevisionDetails);
                // Connecting Logical And Master Feature
                com.matrixone.apps.domain.DomainRelationship.connect(context, strMasterrFeatureID, ManufacturingPlanConstants.RELATIONSHIP_MANAGED_REVISION, objectid, false);
     ...
     *            Holds the eMatrix <code>Context</code> object
     * @param args
     *            [0] Holds Master Feature Id
     * @throws Exception
     * @author WKU
     * @since CFP R211
     */
    public void triggerToCreateLogicalFeature(Context context, String[] args) throws Exception {
        // TODO remove Buisness referececes as well
    }

    /**
     * This is a public method used to display list of Policies of selected type in create page of Master Feature . It is Reload program.
     * @param context
     *            Holds the eMatrix <code>Context</code> object
     * @param args
     * @throws Exception
     ...
     * @since CFP R211
     */
    public HashMap getLogicalFeaturePolicies(Context context, String[] args) throws Exception {
    ...
    public String logicalFeaturePolicyHTML(Context context, String[] args) throws Exception {
     ...
     * @throws FrameworkException
     */
    public void creationOfMasterFeatureInheritedTrigger(Context context, String[] args) throws FrameworkException {
        try {
            String objectid = args[0];
