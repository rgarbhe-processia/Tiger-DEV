...
public class emxPLCMilestonesBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @param args
     *            holds the following input arguments: 0 - String containing the id
     * @throws Exception
     *             if the operation fails
     * @since AEF 9.5.1.1
     */
    public emxPLCMilestonesBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
        ...
        try {
            ...
            while (objectListItr.hasNext()) {
                ...
                if (object != null && object.size() > 0) {
                    ...
                    MapList mlPRojMile = domProjectMilestone.getRelatedObjects(context, strRelation, strSelectType, objectSelects, relationshipSelects, true, // to relationship
                            false, // from relationship
                            (short) 0, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, 0, strTypeIncludePattern, null, null);
    ...
    public void updateMilestoneDate(Context context, String[] args) throws Exception {
        ...
        if (strProjectMilestoneobjectId.size() != 0)
            for (int i = 0; i < strProjectMilestoneobjectId.size(); i++) {
                if (null != strProjectMilestoneobjectId.elementAt(i) && !"null".equalsIgnoreCase((String) strProjectMilestoneobjectId.elementAt(i))
                        && !"".equalsIgnoreCase((String) strProjectMilestoneobjectId.elementAt(i))) {
        ...
        try {
            ...
            if (bProgram && bCFF) {
                ...
                if (dmoObject.isKindOf(context, ProductLineConstants.TYPE_HARDWARE_PRODUCT)) {
                    ...
                    MapList relatedProducts = dmoObject.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_RELATED_PROJECTS, ProductLineConstants.TYPE_PROJECT_SPACE, objectSelects,
    ...
    public int addInterfaceDerivationIndex(Context context, String[] args) {
        ...
        try {
            ...
            if (null != strModelId && !"".equals(strModelId) && !"null".equals(strModelId)) {
                ...
                MapList mlPublishedMilestones = Model.getModelMilestoneTracks(context, strModelId, new StringList(strProductMTDiscipline), objSelectablesMS, null, false, true);
            ...
            MapList mlProjectMilestones = domProductMTObj.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_CONFIGURATION_ITEM, ProductLineConstants.TYPE_MILESTONE, objectSelectables,
                    relationshipSelectables, false, // to relationship - changed
                    true, // from relationship
                    (short) 1, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, 0);
            ...
            /*
             * for(int m=0;m<mlProjectMilestones.size();m++){ Map mapMilestone = (Map)mlProjectMilestones.get(m); String strState = (String)mapMilestone.get(SELECT_CURRENT);
             * 
             * if("Complete".equalsIgnoreCase(strState) ){ mlClubMilestones.remove(mapMilestone); }
             * 
             * }
             */
    ...
    public MapList sortProjectMilestonesWithDate(Context context, MapList mlSortedProjecTmilestones) throws Exception {
        ...
        Collections.sort(mlSortedProjecTmilestones, new Comparator() {
            public int compare(final Object object1, final Object object2) {
                ...
                return (eMatrixDateFormat.getJavaDate((String) map1.get(ProductLineConstants.SELECT_ATTRIBUTE_MILESTONE_DATE)))
                        .compareTo(eMatrixDateFormat.getJavaDate((String) map2.get(ProductLineConstants.SELECT_ATTRIBUTE_MILESTONE_DATE)));
            }
        });
     ...
     *            the ENOVIA <code>Context</code> object
     * @param args
     *            holds the MAplist containing the sorted Milestones
     * @return
     * @throws Exception
     *             if the operation fails
     */
    public void addInterfaceDerivationIndex(Context context, MapList mlSortedProjecTmilestones) throws Exception {
        ...
        for (int p = 0; p < mlSortedProjecTmilestones.size(); p++) {
            ...
            if (!"TRUE".equalsIgnoreCase(strInterface)) {
                ...
                MileTrack.addInterfaceAndSetAttributes(context, strProjectMilestoneObj, "bus", ProductLineConstants.INTERFACE_DERIVATION_INDEX, nodeAttributeMap);
    ...
    public void addDerivationIndexInterfaceonInsertion(Context context, String args[]) throws Exception {
        ...
        for (int p = 0; p < mlNewSortedMilestones.size(); p++) {
            ...
            if (bInterfaceFalse && ifTrue) {
                ...
                MileTrack.addInterfaceAndSetAttributes(context, strNewMilestone, "bus", ProductLineConstants.INTERFACE_DERIVATION_INDEX, nodeAttributeMap);
