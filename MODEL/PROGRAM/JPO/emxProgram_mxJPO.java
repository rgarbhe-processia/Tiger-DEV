...
/**
 * The <code>emxProgram</code> class represents the Program JPO functionality for the AEF type.
...
public class emxProgram_mxJPO extends emxProgramBase_mxJPO {
     ...
     * @grade 0
     */
    public emxProgram_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
