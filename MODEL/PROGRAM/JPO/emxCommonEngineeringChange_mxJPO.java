...
/**
 * The <code>emxCommonEngineeringChange</code> JPO class is Wrapper JPO for emxCommonEngineeringChangeBase JPO which holds methods for executing JPO operations related to objects of the type
 * Engineering Change.
 * @author Wipro
...
public class emxCommonEngineeringChange_mxJPO extends emxCommonEngineeringChangeBase_mxJPO {
    ...
    public emxCommonEngineeringChange_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
