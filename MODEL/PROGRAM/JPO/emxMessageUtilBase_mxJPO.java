...
public class emxMessageUtilBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     *            the eMatrix <code>Context</code> object
     * @param info
     *            - Map containing information about notification and subscription
     * @return xml Document
     * @throws Exception
     *             if the operation fails
     * @since AEF 10-7
    ...
    public static Document getMailXML(Context context, Map info) throws Exception {
        ...
        headerInfo.put("creatorText", FrameworkUtil.findAndReplace((String) newMsgMap.get(SELECT_DESCRIPTION), "\n", "<br/>"));
        ...
        basicInfo.put(EnoviaResourceBundle.getProperty(context, bundleName, new Locale(locale), "emxComponents.Common.Name"), rootObjName.toString());
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Map containing notification and subscription information
     * @return xml String
     * @throws Exception
     *             if the operation fails
     * @since AEF 10-7
     ...
     *            the eMatrix <code>Context</code> object
     * @param messageObjId
     *            the object id to which the parent message object id has to be fetched
     * @return object id
     * @throws Exception
     *             if the operation fails
     * @since AEF 10-7
    ...
    public static String getRootMessageId(Context context, String messageObjId) throws Exception {
        ...
        if (isReplyObj.equalsIgnoreCase("True")) {
            rootMsgObjId = MqlUtil.mqlCommand(context, "expand bus " + messageObjId + " to rel " + DomainConstants.RELATIONSHIP_REPLY + " recurse to end select bus id dump |");
