...
/*
 ** MCADIntegGetLatestApprovedRevision
 **
...
public class MCADIntegGetLatestApprovedRevision_mxJPO extends MCADIntegGetLatestApprovedRevisionBase_mxJPO {
    /**
     * Constructor.
     * @since Sourcing V6R2008-2
     */
    public MCADIntegGetLatestApprovedRevision_mxJPO() {
        super();
    }
     ...
     * @since Sourcing V6R2008-2
     */
    public MCADIntegGetLatestApprovedRevision_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
