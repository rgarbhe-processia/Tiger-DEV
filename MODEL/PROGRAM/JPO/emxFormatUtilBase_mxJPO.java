...
public class emxFormatUtilBase_mxJPO {
    ...
    public emxFormatUtilBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    public static void cacheFormatViewers(Context context, String[] args) throws Exception {
        try {
