 ...
 *
 * FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.8 $" Date : "$Date: Wed Oct 22 15:53:03 2008 $"
 *
 */
import java.util.LinkedList;

/**
 * A Queue based on java.util.LinkedList that is intended to contain PDFDocuments that are to be printed/rendered
 * @author Devon Jones
...
public class emxPDFQueueBase_mxJPO extends LinkedList {
     ...
     * @param document
     *            The feature to be added to the PDFDocument attribute
     * @since AEF 9.5.4.0
     */
