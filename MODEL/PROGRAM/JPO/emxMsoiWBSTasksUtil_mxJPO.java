...
/**
 * The <code>emxMsoiWBSTasksUtil</code> class represents the JPO for obtaining the MS Office integration menus
...
public class emxMsoiWBSTasksUtil_mxJPO {
     ...
     * @since AEF 10.5
     */
    public emxMsoiWBSTasksUtil_mxJPO(Context context, String[] args) throws Exception {
    ...
    public MapList getCurrentUserWBSTasks(Context context, String[] args) throws MatrixException {
         ...
         * 
         * Iterator aListItr = aList.iterator(); while (aListItr.hasNext()) { String Id = (String) aListItr.next();
         * 
         * DomainObject Obj = DomainObject.newInstance(context, Id); MapList aMapList = Obj.getRelatedObjects(context, DomainObject.RELATIONSHIP_SUBTASK, DomainObject.TYPE_TASK, false, true, (short)
         * 0, busSelects, null, busWhere, null, null, DomainObject.TYPE_TASK, null);
         * 
