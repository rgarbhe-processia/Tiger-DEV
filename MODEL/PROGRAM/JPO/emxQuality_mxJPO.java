...
/**
 * The <code>emxQuality</code> class represents the Quality JPO functionality for the AEF type.
...
public class emxQuality_mxJPO extends emxQualityBase_mxJPO {
     ...
     * @grade 0
     */
    public emxQuality_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
