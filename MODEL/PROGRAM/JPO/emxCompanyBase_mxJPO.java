...
public class emxCompanyBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @grade 0
     */
    public emxCompanyBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getSubsidiaries(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getEmployeeMembers(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
    ...
    /**
     * Trigger on the employee relationship creation. When a person is connected as an employee to a company, make sure a member relationship is also created and its roles parameter filled with all of
     * the person's roles.
     * @param context
     *            The Matrix Context.
     * @param args
     ...
     */
    public void addMemberRelationship(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            com.matrixone.apps.common.Person person = (com.matrixone.apps.common.Person) newInstance(context, personId);
     ...
     * @since Common 10-0-0-0
     */
    public Vector getLoginType(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        // getting the MapList of the objects.
        MapList objList = (MapList) programMap.get("objectList");
        Vector columnVals = new Vector(objList.size());
     ...
     * @grade 0
     */
    public boolean isHostRep(Context context, String[] args) throws Exception {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getDepartmentsforPeople(Context context, String[] args) throws Exception {
        if (args.length == 0) {
            throw new IllegalArgumentException();
        }
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getInactivePeople(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            ExpansionIterator expIter = organization.getExpansionIterator(context, "Employee", "Person", busSelects, new StringList(0), false, true, (short) 1, null, null, (short) 0, false, false,
                    (short) 100, false);
     ...
     * @since Common 10.0.0.0
     */
    public MapList getAllCompanies(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
    ...
    /**
     * This method return true if user have permissions on the command otherwise return false.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     ...
     * @since EC 10-5.
     */
    public Boolean hasAccessToPotentialSuppliers(Context context, String[] args) throws Exception {
        ...
        /*
         * if(isSetupAsPublicExchange != null && isSetupAsPublicExchange.equalsIgnoreCase("false")) { isPublicExchange = false; }
         */
     ...
     * @since EC 10-5.
     */
    public Boolean hasAccessToPotentialCustomers(Context context, String[] args) throws Exception {
        Boolean showCommand = Boolean.valueOf(false);
     ...
     * @since EC 10-5.
     */
    public Boolean hasAccessToCreateCompanies(Context context, String[] args) throws Exception {
     ...
     * @since EC 10-5.
     */
    public Boolean hasAccessToDeleteCompanies(Context context, String[] args) throws Exception {
        return Boolean.valueOf(Company.isHostRep(context, Person.getPerson(context)));
    }
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getCustomers(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
    ...
    /**
     * Gets Telephone Numbers ... added for #295605 fix (internationalization issue)
     * @param context
     *            The Matrix Context.
     * @param
    ...
    // added
    public static String ROLES_REQUIRED_GROUP_PER_COMPANY = null;

    public static void assignPersonToGroups(Context context, String[] args) throws Exception {
        try {
            String companyId = args[0];
            String personId = args[1];
            if (ROLES_REQUIRED_GROUP_PER_COMPANY == null) {
                ROLES_REQUIRED_GROUP_PER_COMPANY = EnoviaResourceBundle.getProperty(context, "emxComponents.rolesRequireGroupPerCompany");
            }
            DebugUtil.debug("companyId = " + companyId);
            DebugUtil.debug("personId  = " + personId);
            ...
            if (personId != null) {
                ...
                if (Role != null && Role != "") {
                    try {
                        ...
                        MqlUtil.mqlCommand(context, "modify person $1 remove  $2 $3 $4 ", personName, "assign", "role", Role);
                    } finally {
    ...
    // till here
    /**
     * Gets Company type based on relationship.The Company Type column will have values as below: "Customer" for non host company connected to host with Customer relatioship. "Supplier" for non host
     * company connected to host with Supplier relatioship. "Host" for the host company. "" do not show anything (or empty space) for non host company which are neither customer nor supplier.
     * @param context
     *            The Matrix Context.
     * @param
    ...
    public MapList getHostCompanyCustomers(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList tempList = companyObj.getRelatedObjects(context, relCustomer, // relationship pattern
    ...
    /**
     * Access method to show mandatory and non mandatory Cage Code fileds on company properties webform mutually exclusive based on the property setting emxComponents.cageCode.Uniqueness and Required
     ...
     * @since V6R2009-1
     */
    public boolean isCageCodeRequired(Context context, String[] args) throws Exception {
        boolean bCageCodeRequired = false;
        try {
            String sCageCodeRequired = EnoviaResourceBundle.getProperty(context, "emxComponents.cageCode.Uniqueness");
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            ...
            if (("true".equalsIgnoreCase(sCageCodeRequired) && "true".equals(strSetting)) || (!"true".equalsIgnoreCase(sCageCodeRequired) && !"true".equals(strSetting))) {
     ...
     *            The Matrix Context.
     * @param args
     * @return Boolean false if person is host rep, true if Person is not host rep
     * @throws Exception
     *             If the operation fails.
     * @since V6R2009-1
     */
    public boolean isNotHostRep(Context context, String[] args) throws Exception {
        return (!Company.isHostRep(context, com.matrixone.apps.common.Person.getPerson(context)));
    }

    /**
     * Access Method for the Meeting fields in the company properties returns true if the emxComponents.enableWebEx is true. Always returns true when mode is view.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     * @return boolean value
     ...
     * @since V6R2009-1
     */
    public boolean isWebExEnabled(Context context, String[] args) throws Exception {
        boolean bWebExEnabled = false;
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            String sMode = (String) programMap.get("mode");

            String sEnableWebEx = EnoviaResourceBundle.getProperty(context, "emxComponents.enableWebEx");
     ...
     * @since V6R2009-1
     */
    public HashMap getRangeValuesForFileStore(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            while (storeListItr.hasNext()) {
                ...
                sSYMStoreName = i18nNow.getAdminI18NString("Store", sStoreName, languageStr);
                listDispChoices.add(sSYMStoreName);
                sSYMStoreName = FrameworkUtil.getAliasForAdmin(context, "Store", sStoreName, true);
    ...
    /**
     * This method returns the given attribute value of the company. Returns the i18n value if its value is Unknown. Attribute name will be taken from Sym Name setting.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains objectId
     ...
     * @since V6R2009-1
     */
    public StringList getI18NAttributeDefaultValue(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strAttrValue = objComp.getInfo(context, "attribute[" + attrName + "]");

            if ("Unknown".equals(strAttrValue)) {
                String strAttrName = FrameworkUtil.findAndReplace(attrName, " ", "_");
                String sKey = "emxFramework.Default." + strAttrName;
                strAttrValue = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, sKey);
            }
     ...
     * @since V6R2009-1
     */
    public StringList getValueForFileStore(Context context, String[] args) throws Exception {
        StringList attrValueList = new StringList();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            Map paramMap = (Map) programMap.get("paramMap");
            ...
            DomainObject objComp = new DomainObject(objectId);
            String attrName = PropertyUtil.getSchemaProperty(context, SYMBOLIC_attribute_FileStoreSymbolicName);
            String strAttrValue = objComp.getInfo(context, "attribute[" + attrName + "]");
            strAttrValue = PropertyUtil.getSchemaProperty(context, strAttrValue);
            if (strAttrValue == null) {
                strAttrValue = "";
            } else {
                strAttrValue = i18nNow.getAdminI18NString("Store", strAttrValue, languageStr);
            }
     ...
     * @since V6R2009-1
     */
    public String getValueForSecondaryVaults(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            Company companyObj = (Company) DomainObject.newInstance(context, objectId);
            ...
            StringList secVaultList = FrameworkUtil.split(sSecondaryVaults, ",");
            ...
            if ("edit".equals(sMode)) {
                ...
                sVaultName.append("Display\" cols=\"25\" rows=\"5\" wrap READONLY>");
                sVaultName.append(sSecondaryVaults);
                sVaultName.append("</textarea><input type=\"button\" name=\"\" id=\"\" value=\"...\" onClick=\"javascript:showSecondaryVaultsSelector('");
                sVaultName.append(objectId);
                sVaultName.append("')\"");
                if (!Company.isHostRep(context, com.matrixone.apps.common.Person.getPerson(context))) {
                    sVaultName.append("disabled");
                }
                sVaultName.append("/>&nbsp;&nbsp;<input type=\"hidden\" name=\"");
                sVaultName.append(sFieldName);
     ...
     * @since V6R2009-1
     */
    public String getValueForPrimaryVaults(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String languageStr = (String) paramMap.get("languageStr");
            bufVaults.append(i18nNow.getAdminI18NString("Vault", vault, languageStr));
            bufVaults.append("<input type=\"hidden\" name=\"vaultPrime\" value=\"");
     ...
     * @since V6R2009-1
     */
    public String formatSiteURL(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String sTypeBU = PropertyUtil.getSchemaProperty(context, SYMBOLIC_type_BusinessUnit);
            DomainObject objComp = new DomainObject(objectId);
            String attrWebSite = PropertyUtil.getSchemaProperty(context, SYMBOLIC_attribute_WebSite);
            ...
            if ("Unknown".equals(strWebSite)) {
                i18nWebSite = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, "emxFramework.Default.Web_Site");
            }
            ...
            if ("edit".equals(sMode)) {
                ...
                if ((strWebSiteTemp.startsWith("http://") || strWebSiteTemp.startsWith("https://")) && !objComp.isKindOf(context, sTypeBU)) {
                    ...
                    if (!(strWebSiteTemp.startsWith("http://") || strWebSiteTemp.startsWith("https://"))) {
     ...
     * @since V6R2009-1
     */
    public void updateParentCompany(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            Map paramMap = (Map) programMap.get("paramMap");
            ...
            if (!parentId.equals(oldParentId)) {
                String relSubsidiary = PropertyUtil.getSchemaProperty(context, SYMBOLIC_relationship_Subsidiary);
                Company boParentCompany = (Company) newInstance(context, DomainConstants.TYPE_COMPANY);
                Company company = (Company) newInstance(context, DomainConstants.TYPE_COMPANY);
                ...
                if (parentId != null && !"".equals(parentId)) {
                    company.addRelatedObject(context, new RelationshipType(relSubsidiary), true, parentId);
                }
    ...
    /**
     * This method updates attribute value of the company. Attribute name will be taken from setting Sym Name
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     * @since V6R2009-1
     */
    public void updateI18NAttributeDefaultValue(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            Map paramMap = (Map) programMap.get("paramMap");
     ...
     * @since V6R2009-1
     */
    public void updateFileStore(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            Map paramMap = (Map) programMap.get("paramMap");
            String sFileStore = (String) paramMap.get("New Value");
            String objectId = (String) paramMap.get("objectId");
            Company company = (Company) DomainObject.newInstance(context, objectId);
            String attrName = PropertyUtil.getSchemaProperty(context, SYMBOLIC_attribute_FileStoreSymbolicName);
            if (!sFileStore.startsWith("store_") && !"".equals(sFileStore)) {
                PropertyUtil.setRPEValue(context, "FileStore", sFileStore, false);
     ...
     * @since V6R2009-1
     */
    public void updateSecondaryVaults(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            Map paramMap = (Map) programMap.get("paramMap");
            ...
            String objectId = (String) paramMap.get("objectId");
            Company company = (Company) DomainObject.newInstance(context, objectId);
            String attrSecondaryVaults = PropertyUtil.getSchemaProperty(context, SYMBOLIC_attribute_SecondaryVaults);

            String sVault = "";
            String strVaultName = "";
            StringItr vaultItr = new StringItr(FrameworkUtil.split(sSecondaryVaults, ","));
            StringList secondaryVaultList = new StringList();
            StringBuffer bufSecVaults = new StringBuffer();

            while (vaultItr.next()) {
                strVaultName = (String) vaultItr.obj();
                sVault = FrameworkUtil.getAliasForAdmin(context, "vault", strVaultName, true);

                // Bug 306725 Fix Start
                if (sVault == null || "".equals(sVault)) {
                    sVault = FrameworkUtil.getAliasForAdmin(context, "vault", strVaultName, false);
                }
                // Bug 306725 Fix End
            ...
            if (bufSecVaults.length() > 0) {
                PropertyUtil.setRPEValue(context, "SecondaryVaults", bufSecVaults.toString(), false);
            }
    ...
    /**
     * This is postProcessJPO method. It validates the unique ness of Ord ID , Cage Cage and Company Name. And also validates File store and secondary vaults.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public HashMap validateUniqueness(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            bContinueProcess = validateCageCodeAndOrgID(context, paramMap, actionMap, false);
            if (bContinueProcess) {
                ...
                if ("true".equalsIgnoreCase(isUniqueCageCode)) {
                    bContinueProcess = validateCageCodeAndOrgID(context, paramMap, actionMap, true);
                }
                if (bContinueProcess) {
                    bContinueProcess = validateCompanyName(context, paramMap, actionMap);
                }

                if (bContinueProcess && !isBU) {
                    bContinueProcess = validateStoreAndVault(context, paramMap, actionMap, "FileStore");
                }
                if (bContinueProcess && !isBU) {
                    bContinueProcess = validateStoreAndVault(context, paramMap, actionMap, "SecondaryVaults");
                }
                if (bContinueProcess) {
     ...
     * @since V6R2009-1
     */
    private boolean validateCageCodeAndOrgID(Context context, Map paramMap, HashMap actionMap, boolean bCageCode) throws Exception {
        ...
        try {
            ...
            String attrName = "";
            if (bCageCode) {
                attrName = PropertyUtil.getSchemaProperty(context, SYMBOLIC_attribute_CageCode);
            } else {
                attrName = PropertyUtil.getSchemaProperty(context, SYMBOLIC_attribute_OrganizationID);
            }

            String attrValue = bCageCode ? sCageCode : sOrdId;
            String sType = PropertyUtil.getSchemaProperty(context, SYMBOLIC_type_Company);
            if (bBUId) {
                sType = PropertyUtil.getSchemaProperty(context, SYMBOLIC_type_BusinessUnit);
            }

            StringList strlistObjectSelect = new StringList(1);
            strlistObjectSelect.addElement(DomainObject.SELECT_ID);

            String whereStr = DomainObject.getAttributeSelect(attrName) + " == \"" + attrValue + "\" && id !=" + objectId;

            if (!bBUId) {
                orgList = DomainObject.findObjects(context, sType, "*", whereStr, strlistObjectSelect);
            } else {
            ...
            if (orgCount > 0) {
                if (bCageCode) {
                    bufMessage.append(i18nNow.getI18nString("emxComponents.CreateOrEditCompany.CageCodeAlreadyExists", "emxComponentsStringResource", languageStr));
                } else {
                    if (bCompanyId) {
                        bufMessage.append(i18nNow.getI18nString("emxComponents.CreateOrEditCompany.CompanyIdAlreadyExists", "emxComponentsStringResource", languageStr));
                    } else if (bBUId) {
                        bufMessage.append(i18nNow.getI18nString("emxComponents.CreateOrEditOrganization.OrganizationIdAlreadyExists", "emxComponentsStringResource", languageStr));
                    } else {
                        bufMessage.append(i18nNow.getI18nString("emxComponents.CreateOrEditCompany.SubsidiaryIdAlreadyExists", "emxComponentsStringResource", languageStr));
                    }
     ...
     * @since V6R2009-1
     */
    private boolean validateCompanyName(Context context, Map paramMap, HashMap actionMap) throws Exception {
        ...
        try {
            ...
            if (sCompNewName != null && !"".equals(sCompNewName) && !"null".equals(sCompNewName)) {
                ...
                if (bBUId) {
                    ...
                    String sType = PropertyUtil.getSchemaProperty(context, SYMBOLIC_type_BusinessUnit);
                    ...
                    if (buList.size() > 0) {
                        bufMessage.append(i18nNow.getI18nString("emxComponents.BusinessUnit.BusinessAlreadyExists", "emxComponentsStringResource", languageStr));
                        actionMap.put("Message", bufMessage.toString());
                        actionMap.put("Action", "stop");
                        bValidName = false;
                    }
                    ...
                    if (!"".equals(strResult)) {
                        bufMessage.append(i18nNow.getI18nString("emxComponents.CreateOrEditCompany.CompanyNameAlreadyExists1", "emxComponentsStringResource", languageStr));
                        bufMessage.append(sCompNewName);
                        bufMessage.append(i18nNow.getI18nString("emxComponents.CreateOrEditCompany.CompanyNameAlreadyExists2", "emxComponentsStringResource", languageStr));
                        actionMap.put("Message", bufMessage.toString());
                        actionMap.put("Action", "stop");
                        bValidName = false;
                    }
     ...
     * @since V6R2009-1
     */
    private boolean validateStoreAndVault(Context context, Map paramMap, HashMap actionMap, String sRPEKey) throws Exception {
        ...
        try {
            ...
            if (sError != null && !"".equals(sError)) {
                if ("SecondaryVaults".equals(sRPEKey)) {
                    strBufMessage.append(EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", strLocale, "emxComponents.CompanyEdit.SecondaryVaultMessage1"));
                    strBufMessage.append(" '");
                    strBufMessage.append(sError);
                    strBufMessage.append("' ");
                    strBufMessage.append(EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", strLocale, "emxComponents.CompanyEdit.SecondaryVaultMessage2"));

                } else {
                    strBufMessage.append(EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", strLocale, "emxComponents.CompanyEdit.StoreMessage1"));
                    strBufMessage.append(" '");
                    strBufMessage.append(sError);
                    strBufMessage.append("' ");
                    strBufMessage.append(EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", strLocale, "emxComponents.CompanyEdit.StoreMessage2"));
                }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Object Id of the newly created object
     * @returns nothing
     * @throws Exception
     *             if the operation fails
     * @since Common 10.0.0.0
        ...
        try {
            ...
            if (typeCompany.equals(type)) {
                ...
                if (countCompanyId > 0) {
                     ...
                     * if(isSubsidiaryCreate != null && "true".equals(isSubsidiaryCreate)) { session.setAttribute("error.message", strMessage2); } else { session.setAttribute("error.message",
                     * strMessage1); }
                     */
    ...
    /**
     * This method will be invoked on post editing the company details. This method will check for uniqueness of the fields and also updates schema property cache. If host company name is changed
     * system need to update the schema property 'role_CompanyName'
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    public HashMap companyEditPostProcess(Context context, String[] args) throws Exception {
        ...
        // <Fix for 374428>
        /**
         * Reload PropertyUtil schemaProperty Cache If the Company Name is changed and it has corresponding role attached. we need to update this in schema property 'role_CompanyName'
         */
    ...
    public Object getOrganizationTypesOnExpansion(Context context, String[] args) throws Exception {
        ...
        resultsList = (MapList) wsObj.getRelatedObjects(context, DomainObject.RELATIONSHIP_ORGANIZATION_PLANT + "," + DomainObject.RELATIONSHIP_DIVISION + "," + DomainObject.RELATIONSHIP_DIVISION,
                DomainObject.TYPE_BUSINESS_UNIT + "," + DomainObject.TYPE_ORGANIZATION, objectSelects, null, false, true, (short) 1, "", null);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Object Id of the removed person 1 - Username of the person
     * @returns nothing
     * @throws Exception
     *             if the operation fails
     * @since Common R213
