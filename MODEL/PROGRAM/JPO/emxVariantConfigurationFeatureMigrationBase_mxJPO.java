...
/*
 * emxVariantConfigurationFeatureMigrationBase.java program migrates the data into Common Document model i.e. to 10.5 schema.
 *
...
public class emxVariantConfigurationFeatureMigrationBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @grade 0
     */
    public emxVariantConfigurationFeatureMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    /**
     * This method goes through all objects which will be migrated. It will get count of subfeatures of particular feature and update that as attribute value for attribute 'Sub Feature Count'
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param objectList
     *            contains the list of objects to be migrated.
     * @throws Exception
     */
