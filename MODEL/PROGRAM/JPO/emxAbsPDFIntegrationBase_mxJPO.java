 ...
 *
 * FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.10 $" Date : "$Date: Wed Oct 22 15:53:03 2008 $"
 *
 */
...
/**
 * This is an abstract class intended to be the base of integration classes to various PDF Renderers/Batch Printers. This class provides a number of utility methods.
 * @author Devon Jones
...
public abstract class emxAbsPDFIntegrationBase_mxJPO extends Thread {
     ...
     *            Object Id
     * @param stagingFolder
     *            name of the folder to create the job folder in
     * @return String The name of the Job Folder
     * @since AEF 9.5.4.0
     */
    protected String createFolder(String objectId, String stagingFolder) throws Exception {
        /*
         * Author : DJ Date : 02/04/2003 Notes : History :
         */
        String jobFolder = "";
        ...
        fId.delete();
        if (!fId.mkdir()) {
            throw new Exception("Directory creation failed: \n" + stagingFolder + java.io.File.separator + jobFolder);
        }
        return jobFolder;
    }
     ...
     * @param dir
     *            Name of the top level directory to delete
    ...
    /**
     * Parses a string into an int, and if it fails or is less then one, it returns 1
     * @param stringInt
