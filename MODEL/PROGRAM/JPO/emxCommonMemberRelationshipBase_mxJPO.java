...
/**
 * The <code>emxMemberRelationshipBase</code> class represents the Member relationship JPO functionality for the AEF type.
...
public class emxCommonMemberRelationshipBase_mxJPO extends com.matrixone.apps.common.MemberRelationship {
    ...
    protected static final String RANGE_FINANCIAL_REVIEWER = "Financial Reviewer";

    /** select the Project Access List ID from Project */
    public static final String SELECT_PROJECT_ACCESS_LIST_ID_FOR_PROJECT = "to[" + RELATIONSHIP_PROJECT_ACCESS_LIST + "].from.id";
     ...
     * @since AEF 9.5.1.3
     */
    public emxCommonMemberRelationshipBase_mxJPO(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param projectId
     *            the project id for retrieving the access list object
     * @throws Exception
     *             if the operation fails
     * @since AEF 9.5.1.3
     * @grade 0
     */
    protected DomainObject getAccessListObject(Context context, String projectId) throws Exception {
        ...
        String accessListObjectId = (String) palMap.get(SELECT_PROJECT_ACCESS_LIST_ID_FOR_PROJECT);

        if (accessListObjectId != null && !"".equals(accessListObjectId) && !"null".equals(accessListObjectId)) {
            accessListObject = (DomainObject) DomainObject.newInstance(context, accessListObjectId);
        }
    ...
    /**
     * When a Member relationship is created, grant the new member the proper permissions to the "Project Access List" Object. Note: RELID is not needed for this trigger.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            FROMOBJECTID TONAME
    ...
    public void triggerCreateAction(Context context, String[] args) throws Exception {
        ...
        DomainObject projectAccessObject = getAccessListObject(context, fromObjectId);
        ...
        if (projectAccessObject != null) {
            ...
            ContextUtil.pushContext(context, PERSON_WORKSPACE_ACCESS_GRANTOR, null, null);
            try {
                BusinessObject.grantAccessRights(context, objects, accessMask);
            } catch (Exception e) {
                DebugUtil.debug("Exception MemberRelationship connect - ", e.getMessage());
                throw e;
            } finally {
    ...
    public void removeFromBUDepAndSub(Context context, String[] args) throws Exception {
        String orgId = args[0];
        ...
        MapList ml = currOrg.getRelatedObjects(context, // matrix context
                RELATIONSHIP_SUBSIDIARY + "," + RELATIONSHIP_DIVISION + "," + RELATIONSHIP_COMPANY_DEPARTMENT, // relationship pattern
    ...
    public void removeSecurityContext(Context context, String[] args) throws Exception {
        String orgId = args[0];
        String personId = args[1];
        ...
        MapList ml = person.getRelatedObjects(context, // matrix context
    ...
    /**
     * When a Member relationship is deleted, remove the member from the Project Access List object. Note: No RELID is required here.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            FROMOBJECTID TONAME
    ...
    public void triggerDeleteAction(Context context, String[] args) throws Exception {
        ...
        if (projectAccessObject != null) {
            ...
            try {
                ...
                DebugUtil.debug("Exception MemberRelationship triggerDeleteAction- ", e.getMessage());
                throw e;
            } finally {
                ContextUtil.popContext(context);
            }
    ...
    /**
     * This trigger is invoked when "Project Access" attribute is modified on the Member relationship. The trigger is on the relationship it self which means it will fire for all attribute on this
     * relationship. Note: No RELID is required here.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            FROMOBJECTID TONAME ATTRNAME ATTRVALUE NEWATTRVALUE
     * @throws Exception
     *             if operation fails
     * @since AEF 9.5.1.0
     * @grade 0
    ...
    public void triggerModifyAttributeAction(Context context, String[] args) throws Exception {
        ...
        if (!attrName.equals(ATTRIBUTE_PROJECT_ACCESS)) {
            ...
            DebugUtil.debug("Exiting triggerModifyAttributeAction - " + "not Project Access attribute");
        } else {
            DomainObject projectAccessObject = getAccessListObject(context, fromObjectId);
            ...
            if (projectAccessObject != null) {
                ...
                try {
                    ...
                    DebugUtil.debug("Exception triggerModifyAttributeAction - ", e.getMessage());
                    throw e;
                } finally {
                    ContextUtil.popContext(context);
                }
