...
public class MCADIntegGetLatestReviewRevision_mxJPO extends MCADIntegGetLatestReviewRevisionBase_mxJPO {
    /**
     * Constructor.
     * @since Sourcing V6R2008-2
     */
    public MCADIntegGetLatestReviewRevision_mxJPO() {
        super();
    }
     ...
     * @since Sourcing V6R2008-2
     */
    public MCADIntegGetLatestReviewRevision_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
