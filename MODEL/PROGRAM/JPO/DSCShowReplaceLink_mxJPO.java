...
/**
 * DSCShowReplaceLink.java Copyright Dassault Systemes, 1992-2007. All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systemes and its subsidiaries,
...
public class DSCShowReplaceLink_mxJPO {
    ...
    public String getURL(Context context, String[] args) throws Exception {
        ...
        if (integrationName != null && integrationNameGCOTable.containsKey(integrationName)) {
            replaceURL = "IEFReplaceTableFS.jsp?header=mcadIntegration.Server.Title.Replace&funcPageName=" + "&relName=CAD SubComponent&end=to&objectId=" + currentObjectId + "&integrationName="
                    + integrationName + "&selectedRows=" + whereUsedSelectedParents.toString();
