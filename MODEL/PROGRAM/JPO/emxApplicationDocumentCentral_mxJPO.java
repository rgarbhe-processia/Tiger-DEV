 ...
 * evidence any actual or intended publication of such program. FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.9 $" Date : "$Date: Wed Oct 22
 * 16:02:24 2008 $"
 */
...
/**
 * The <code>${CLASSNAME}</code> extends the Base JPO class used Copyright (c) 2002, MatrixOne, Inc.
 */
...
public class emxApplicationDocumentCentral_mxJPO extends emxApplicationDocumentCentralBase_mxJPO {
    ...
    public emxApplicationDocumentCentral_mxJPO(Context context, String[] args) throws Exception {
        super();
    }
