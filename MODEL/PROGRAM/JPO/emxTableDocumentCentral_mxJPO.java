...
/**
 * The <code>${CLASSNAME}</code> extends the base JPO class that is used to generate HTML code for the business type column on business type list page for display rule.
...
public class emxTableDocumentCentral_mxJPO extends emxTableDocumentCentralBase_mxJPO {
     ...
     */
    public emxTableDocumentCentral_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
