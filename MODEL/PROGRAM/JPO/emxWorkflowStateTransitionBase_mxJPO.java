...
public class emxWorkflowStateTransitionBase_mxJPO {
    ...
    public int checkWorkflowsCompleted(Context context, String[] args) throws Exception {
        ...
        String sStateComplete = PropertyUtil.getSchemaProperty(context, "policy", PropertyUtil.getSchemaProperty(context, "policy_Workflow"), "state_Completed");
        ...
        if (dObject != null) {
            ...
            wfList = dObject.getRelatedObjects(context, relPattern.getPattern(), "*", objectSelects, relSelects, true, false, (short) 0, null, // objectWhere
                    null, // relWhere,
                    null, null, null);
        }
        ...
        if (wfList != null && wfList.size() > 0) {
            ...
            while (itr.hasNext()) {
                ...
                if ((adHocWorkflowBlock && rBaseState.equals("Ad Hoc")) || (sState.equals(rBaseState) && sPolicy.equals(rBasePolicy))) {
        ...
        if (doNotPromote) {
            ...
            try {
                ...
                String message = emxMailUtil_mxJPO.getMessage(context, "emxComponents.Workflow.WorkflowNotComplete", messageKeys, messageValues, "", "emxComponentsStringResource");
