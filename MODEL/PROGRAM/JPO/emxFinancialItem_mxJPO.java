...
/**
 * The <code>emxFinancialItem</code> class represents the Financial Item types functionality for the AEF.
 * @version AEF 10.0.SP4 - Copyright (c) 2002, MatrixOne, Inc.
 */
public class emxFinancialItem_mxJPO extends emxFinancialItemBase_mxJPO {
     ...
     * @grade 0
     */
    public emxFinancialItem_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
