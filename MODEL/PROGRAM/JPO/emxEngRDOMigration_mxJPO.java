 ...
 */
public class emxEngRDOMigration_mxJPO extends emxEngRDOMigrationBase_mxJPO {
     ...
     * @grade 0
     */
    public emxEngRDOMigration_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
