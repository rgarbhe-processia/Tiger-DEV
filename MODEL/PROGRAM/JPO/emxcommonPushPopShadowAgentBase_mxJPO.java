...
public class emxcommonPushPopShadowAgentBase_mxJPO {
    ...
    public emxcommonPushPopShadowAgentBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    public static String getShadowAgentPassword(Context context, String[] args) throws Exception {
    ...
    private static void setAgentPassword(Context context, String agentSymbolicName, String agentPassword) throws Exception {
        ...
        if (agentName != null && agentName.length() > 0) {
            StringBuffer strBuff = new StringBuffer(125);
            strBuff.append("escape modify person '");
            strBuff.append(agentName);
            strBuff.append("' password '");
            strBuff.append(escape(agentPassword));
            strBuff.append("'");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            [0] should be User Agent Password
     * @return nothing
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.1.0
     */
    public static void setShadowAgentPassword(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            strBuff.append("modify program emxcommonSessionInfo code '");
            strBuff.append(agentPassword);
            strBuff.append("'");
            MqlUtil.mqlCommand(context, strBuff.toString());
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - a String which contains userName
     * @return int 0, status code
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.1.0
