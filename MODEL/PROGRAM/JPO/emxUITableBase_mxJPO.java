...
public class emxUITableBase_mxJPO {
    ...
    public emxUITableBase_mxJPO(Context context, String[] args) throws Exception {
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: comparatorName - a String of the comparator name used in comparision list - a MapList which contains a list of objects to be sorted
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: comparatorName - a String of the comparator name used in comparision first - firstobject for comparison second - secondobject for
     *            comparison
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: requestMap - a HashMap having the request object data timeZone - a String representing the Time zone tableData - a HashMap having the table
     *            data
     * @return HashMap
     * @throws Exception
     *             if the operation fails
    ...
    public HashMap updateTableObjects(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: timeZone - a String representing the Time zone document - the XML Document Object
     * @return void
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0
    ...
    public HashMap updateIndentedTableObjects(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String timeZone = (String) programMap.get("timeZone");
    ...
    private void saveTypeAheadValues(Context context, String strSelectedTable, Map columnsMap, String[] valuesMap) throws Exception {
        ...
        while (columnIterator.hasNext()) {
            ...
            if (strTypeAheadFunction == null && valuesMap[i].trim().length() != 0) {
                storeTypeAhead = true;
        ...
        while (Keyitr.hasNext()) {
            ...
            for (int k = 0; ObjWidSamePol != null && k < ObjWidSamePol.size(); k++) {
                ...
                if (relationship != null && !"".equals(relationship)) {
                    ...
                    MapList mplRelatedObjs = domain.getRelatedObjects(context, relList, "*", objectselects, relselects, getFrom, !getFrom, (short) 1, "", "", 0, null, null, null);
