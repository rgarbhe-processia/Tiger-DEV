 ...
 **
 ** static const char RCSID[] = $Id: /java/JPOsrc/base/emxBuildBase.java 1.4.2.22.1.1.1.5 Sat Dec 20 12:57:12 2008 GMT ds-spaul ExperimentalemxBuildBase.java 1.4.2.2 Thu May 22 13:48:21 2008 GMT
 * ds-avvs Experimental$
 *
...
/**
 * The <code>emxBuildBase</code> class contains methods related to Build admin type.
...
public class emxBuildBase_mxJPO extends emxProductFile_mxJPO {
    ...
    public MapList getAllBuilds(Context context, String[] args) throws Exception {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getOwnedBuilds(Context context, String[] args) throws Exception {
        // When all the Builds are to be fetched the where condition is empty
    ...
    /**
     * Method call to get all the builds in the data base satisfying the nescessary condition.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param strOwnerCondition
     *            - String value containing the owner condition based on which results are to be filtered
     ...
     * @grade 0
     */
    protected MapList findBuilds(Context context, String strOwnerCondition) throws Exception {
        ...
        MapList relBusObjList = findObjects(context, strType, DomainConstants.QUERY_WILDCARD, DomainConstants.QUERY_WILDCARD, strOwnerCondition, DomainConstants.QUERY_WILDCARD, null, true,
                objectList);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containg the following arguments: paramList - HashMap containing the Object Id and relationship name
     * @return MapList - MapList containing the id of Build objects
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.0.0.0
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public List getAllRelatedBuilds(Context context, String[] args) throws Exception {
        // When all the Builds are to be fetched the where condition is empty
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap having the following arguments: paramList - HashMap containing the Object Id
     * @return MapList - MapList containing the id of Build objects
     * @throws Exception
     *             if the operation fails
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public List getAllProductBuilds(Context context, String[] args) throws Exception {
        // When all the Builds are to be fetched the where condition is empty
        String strWhereCondition = null;
        // Calls the protected method to retrieve the data
        List objectList = getRelatedBuilds(context, strWhereCondition, ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD, args);
        return objectList;
    }

    /**
     * Method to get all the Product Configuration Builds related to a Product Configuration in context.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containg the following arguments: paramList - HashMap containing the Object Id and relationship name
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public List getAllProductConfigurationBuilds(Context context, String[] args) throws Exception {
        // When all the Builds are to be fetched the where condition is empty
        String strWhereCondition = null;
        // Calls the protected method to retrieve the data
        List objectList = getRelatedBuilds(context, strWhereCondition, ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION_BUILD, args);
        return objectList;
    }
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public List getAllModelBuilds(Context context, String[] args) throws Exception {
        // When all the Builds are to be fetched the where condition is empty
        String strWhereCondition = null;
        String RELATIONSHIP_MODEL_BUILD = PropertyUtil.getSchemaProperty(context, "relationship_ModelBuild");
        // Calls the protected method to retrieve the data
        List objectList = getRelatedBuilds(context, strWhereCondition, RELATIONSHIP_MODEL_BUILD, args);
        return objectList;
    }
     ...
     * @throws Exception
     */
    public List getAllPartBuilds(Context context, String[] args) throws Exception {
        // When all the Builds are to be fetched the where condition is empty
        String strWhereCondition = null;
        String RELATIONSHIP_ASSOCIATED_BUILD = PropertyUtil.getSchemaProperty(context, "relationship_AssociatedBuild");
        // Calls the protected method to retrieve the data
        List objectList = getRelatedBuilds(context, strWhereCondition, RELATIONSHIP_ASSOCIATED_BUILD, args);
        return objectList;
    }
     ...
     * @throws Exception
     */
    public List getOwnedPartBuilds(Context context, String[] args) throws Exception {
        // When all the Builds are to be fetched the where condition is empty
        String strWhereCondition = new StringBuffer(35).append("owner== \"").append(context.getUser()).append("\"").toString();
        String RELATIONSHIP_ASSOCIATED_BUILD = PropertyUtil.getSchemaProperty(context, "relationship_AssociatedBuild");
        // Calls the protected method to retrieve the data
        List objectList = getRelatedBuilds(context, strWhereCondition, RELATIONSHIP_ASSOCIATED_BUILD, args);
        return objectList;
    ...
    /**
     * Method to get all the builds related to an object in context owned by the context user.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containg the following arguments: paramList - HashMap containing the Object Id and relationship name
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public List getOwnedRelatedBuilds(Context context, String[] args) throws Exception {
        // When all the Builds are to be fetched the where condition is empty
        String strWhereCondition = new StringBuffer(35).append("owner== \"").append(context.getUser()).append("\"").toString();
        // Calls the protected method to retrieve the data
        List objectList = getRelatedBuilds(context, strWhereCondition, args);
    ...
    /**
     * Method to get all the Product Builds connected to the context Product and owned by the context user.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments: paramList - HashMap containing the Object Id and relationship name
     * @return MapList - MapList containing the id of Build objects
     * @throws Exception
     *             if the operation fails
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public List getOwnedProductBuilds(Context context, String[] args) throws Exception {
        // When all the Builds are to be fetched the where condition is empty
        String strWhereCondition = new StringBuffer(35).append("owner== \"").append(context.getUser()).append("\"").toString();
        // Calls the protected method to retrieve the data
        List objectList = getRelatedBuilds(context, strWhereCondition, ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD, args);
    ...
    /**
     * Method to get all the Product Configuration Builds connected to the context Product and owned by the context user.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containg the following arguments: paramList - HashMap containing the Object Id and relationship name
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public List getOwnedProductConfigurationBuilds(Context context, String[] args) throws Exception {
        // When all the Builds are to be fetched the where condition is empty
        String strWhereCondition = new StringBuffer(35).append("owner== \"").append(context.getUser()).append("\"").toString();
        // Calls the protected method to retrieve the data
        List objectList = getRelatedBuilds(context, strWhereCondition, ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION_BUILD, args);
     ...
     * @since ProductCentral 10.0.0.0
     */
    protected List getRelatedBuilds(Context context, String strWhereCondition, String[] args) throws Exception {
        ...
        relObjIdList = domainObject.getRelatedObjects(context, strRelationshipName, strType, ObjectSelectsList, RelSelectsList, false, true, sRecurseLevel, strWhereCondition,
     ...
     *             if the operation fails
     */
    protected List getRelatedBuilds(Context context, String strWhereCondition, String strRelationshipName, String[] args) throws Exception {
        // Unpacking the arguments
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        // Obtaining the object id and relationship name from the arguments
        String strObjectId = (String) programMap.get("objectId");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the HashMap containing the following arguments paramMap - contains ObjectId, Old Value for organization name and new value
     * @return int - returns zero if connect successful
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.0.0.0
     */
    public int connectBuildResponsibility(Context context, String[] args) throws Exception {
        ...
        if (!strOldOrganizationName.equals("")) {
            ...
            organizationList = getRelatedObjects(context, strDesignRespRelationship, strOrganizationType, ObjectSelectsList, RelSelectsList, true, true, (short) 1, strWhereCondition,
                    DomainConstants.EMPTY_STRING);

            String strRelId = (String) ((Hashtable) organizationList.get(0)).get(DomainConstants.SELECT_RELATIONSHIP_ID);
        ...
        DomainRelationship.connect(context, this, strDesignRespRelationship, domainObjectToType);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the HashMap containing the following arguments paramMap - contains ObjectId, Old Value for product name and new value
     * @return int - returns zero if connect successful
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.0.0.0
    ...
    public int connectProduct(Context context, String[] args) throws Exception {
        ...
        if (!strOldProductName.equals("")) {
            ...
            sbWhereCondition = sbWhereCondition.append("\"");
            String strWhereCondition = sbWhereCondition.toString();
            productList = getRelatedObjects(context, strProductBuildRelationship, strProductType, ObjectSelectsList, RelSelectsList, true, true, (short) 1, strWhereCondition,
                    DomainConstants.EMPTY_STRING);
            String strRelId = (String) ((Hashtable) productList.get(0)).get(DomainConstants.SELECT_RELATIONSHIP_ID);
            // Disconnecting the existing relationship
            DomainRelationship.disconnect(context, strRelId);
        }
        ...
        DomainRelationship.connect(context, this, strProductBuildRelationship, domainObjectToType);
     ...
     * @since ProductCentral 10.0.0.0
     */
    public int connectAssignedPart(Context context, String[] args) throws Exception {
        ...
        if (!strOldPartName.equals("")) {
            ...
            sbWhereCondition = sbWhereCondition.append("\"");
            String strWhereCondition = sbWhereCondition.toString();
            partList = getRelatedObjects(context, strAssignedPartRelationship, strPartType, ObjectSelectsList, RelSelectsList, true, true, (short) 1, strWhereCondition, DomainConstants.EMPTY_STRING);
            String strRelId = (String) ((Hashtable) partList.get(0)).get(DomainConstants.SELECT_RELATIONSHIP_ID);
            // Disconnecting the existing relationship
            DomainRelationship.disconnect(context, strRelId);
        }

        DomainObject domainObjectToType = newInstance(context, strNewPartId);
        DomainRelationship.connect(context, this, strAssignedPartRelationship, domainObjectToType);

        return 0;
    }

    /**
     * Gets the Status icon based on the Estimated and Actual Date comparisons. if the Estimated or the Actual Date is null then it does not give any icon.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the hashmap containing the folowing arguments objectList MapList containing the object list paramList.Hashmap containing the parameters like object id
    ...
    public List slipDaysIcon(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            // 04/29/2005
            strStatusRed = EnoviaResourceBundle.getProperty(context, "emxProduct.Build.IconRedDays");
            strStatusGreen = EnoviaResourceBundle.getProperty(context, "emxProduct.Build.IconGreenDays");
            // End of Modify by Enovia MatrixOne for Bug # 303528 Date
            // 04/29/2005
        } catch (Exception e) {
            String strContentLabel = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Error.MissingStatusIkonValue", strLanguage);
            throw new Exception(strContentLabel);
        }
        ...
        String strAttrb1 = "attribute[" + ProductLineConstants.ATTRIBUTE_PLANNED_BUILD_DATE + "]";
        String strAttrb2 = "attribute[" + ProductLineConstants.ATTRIBUTE_ACTUAL_BUILD_DATE + "]";
        ...
        for (int i = 0; i < iNumOfObjects; i++) {
            strPlannedDate = attributeList.getElement(i).getSelectData(strAttrb1);
            strActualDate = attributeList.getElement(i).getSelectData(strAttrb2);
            ...
            if (strActualDate.equalsIgnoreCase(DomainConstants.EMPTY_STRING) || strPlannedDate.equalsIgnoreCase(DomainConstants.EMPTY_STRING)) {
                strStatusIconTag = DomainConstants.EMPTY_STRING;
            }
            // If both the dates are non null values go ahead with the
            // processing
            else if (!(strActualDate.equalsIgnoreCase(DomainConstants.EMPTY_STRING)) && !(strPlannedDate.equalsIgnoreCase(DomainConstants.EMPTY_STRING))) {
                int nDuration = ProductLineUtil.daysBetween(strActualDate, strPlannedDate);
                ...
                } else if ((nDuration < nRedIconDays) && (nDuration >= nGreenIconDays)) {
     ...
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            Holds the following arguments 0 - HashMap containing the parent object id.
     * @return boolean returns true if check successful
     * @throws Exception
     *             if the operation fails
     */
    public boolean checkAccessForProdConfig(Context context, String args[]) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        if (strParentObjId != null && !DomainConstants.EMPTY_STRING.equals(strParentObjId) && !"null".equals(strParentObjId)) {
            DomainObject prodConfig = new DomainObject(strParentObjId);
            if (prodConfig.isKindOf(context, ProductLineConstants.TYPE_PRODUCT_CONFIGURATION)) {
                return PolicyUtil.checkState(context, strParentObjId, ProductLineConstants.STATE_PRODUCT_CONFIGURATION_VALIDATE_CONFIGURATION, PolicyUtil.LE);
            }
        }
        return true;
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            Holds the HashMap with following arguments fcsEnabled store paramList objectId format fileName.
     * @return map of files
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.0.0.0
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments fcsEnabled noOfFiles parentId parentRelId format fileName.
    ...
    public Map multiFileCheckinCreate(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (title != null && !"".equals(title) && !"null".equals(title)) {
                ...
                distribObject.createAndConnect(context, ProductLineConstants.TYPE_DISTRIBUTION_FILE, uniqueName, parentRelName, this, true);
                String objectId = distribObject.getInfo(context, DomainConstants.SELECT_ID);
                ...
                if ("false".equalsIgnoreCase(fcsEnabled)) {
                    ...
                    distribObject.checkinFromServer(context, unlock, append, format, null, strFileList);
                } else {
     ...
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            Holds the following arguments 0 - HashMap containing the object id
     * @return map of files
     * @since Product Central 10.0.0.0
     * @throws Exception
     *             if the operation fails
     */
    public HashMap getDistributionFilesInfo(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        MapList distribList = getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_DISTRIBUTION_FILE, ProductLineConstants.TYPE_DISTRIBUTION_FILE, objectSelects, null, false, true, level, "",
                "");
        ...
        for (int i = 0; i < distribList.size(); i++) {
            ...
            String description = (String) tmpMap.get("attribute[" + DomainConstants.ATTRIBUTE_NOTES + "]");
            String distribObjId = (String) tmpMap.get(DomainConstants.SELECT_ID);
            distribObject.setId(distribObjId);

            Map distribInfo = distribObject.getInfo(context, selectList);

            StringList fileNameList = (StringList) distribInfo.get(DomainConstants.SELECT_FILE_NAME);
            StringList fileSizeList = (StringList) distribInfo.get(DomainConstants.SELECT_FILE_SIZE);
            ...
            String strFormat = "";
            if (formatList == null) {
                throw new Exception("No formats associated with Business Object");
            }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments fcsEnabled store paramList objectId format fileName.
     * @return Map objectMap which contains objectId, filename, format pairs and errorMessage if any error.
     * @throws Exception
     *             if the operation fails
     * @since VCP 10.5.0.0
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the HashMap with following arguments fcsEnabled noOfFiles parentId parentRelId.
     * @return String new Document Id
     * @throws Exception
     *             if the operation fails
    ...
    public Map CheckinProcess(Context context, String[] args) throws Exception {
        ...
        if (!errorMessage.equals("")) {
            ...
            errorMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Alert.FileAlreadyCheckedIn", context.getSession().getLanguage());
    ...
    /**
     * This method is used to get the information about files related to a Distribution Object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the parameters to be passed to the method getDistribFileInfo which is called from this method.
     * @return MapList mapList which contains objectId, filename,filesize format and comments
     * @throws Exception
     *             if the operation fails
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getDistribFiles(Context context, String[] args) throws Exception {
    ...
    /**
     * This method is used to get the filenames of all the files. which are associated with Distribution File object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public Vector getDistributionFileNames(Context context, String[] args) throws Exception {
    ...
    /**
     * This method is used to get the Comments for all the files. which are associated with Distribution File object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the parameters passed from the calling method When this array is unpacked, arguments corresponding to the following String keys are found:- objectList- MapList Containing the
     ...
     * @since ProductCentral 10.5SP1
     **/
    public Vector getDistributionFileComments(Context context, String[] args) throws Exception {
    ...
    /**
     * This method is used to get the filesize for all the files. which are associated with Distribution File object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the parameters passed from the calling method When this array is unpacked, arguments corresponding to the following String keys are found:- objectList- MapList Containing the
    ...
    public Vector getDistributionFileSizes(Context context, String[] args) throws Exception {
    ...
    /**
     * This method is used to get the format for all the files. which are associated with Distribution File object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the parameters passed from the calling method When this array is unpacked, arguments corresponding to the following String keys are found:- objectList- MapList Containing the
    ...
    public Vector getDistributionFileFormats(Context context, String[] args) throws Exception {
        ...
        while (objectListItr.hasNext()) {
            ...
            // 16-Nov-05
            strFileFormat = i18nNow.getFormatI18NString(strFileFormat, context.getSession().getLanguage());
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            an array of arguments corresponding to the following String keys are found:- objectList:a MapList containing all the objectIds paramList a Map containing parameters like reportFormat
     *            and languageStr
     * @return Vector object that contains a vector of html code to construct the DownLoad Column.
     * @throws Exception
     *             if the operation fails
     * @since Common 10.5SP1
     **/

    public static Vector getDistributionFileDownLoad(Context context, String[] args) throws Exception {
        ...
        String strTipDownload = EnoviaResourceBundle.getProperty(context, "Components", "emxComponents.DocumentSummary.ToolTipDownload", languageStr);
    ...
    /**
     * This method gets the object Structure List for the context Build object.This method gets invoked by settings in the command which displays the Structure Navigator for Build type objects
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: paramMap - Map having object Id String
     * @return MapList containing the object list to display in Build structure navigator
     * @throws Exception
     *             if the operation fails
    ...
    public static MapList getStructureList(Context context, String[] args) throws Exception {
        ...
        if (objectParentType != null && objectParentType.equals(ProductLineConstants.TYPE_UNIT)) {
            // X+5 PLC Build Enhancements 05/09/2008
            Pattern relPattern = new Pattern(ProductLineConstants.RELATIONSHIP_BUILD_SATISFIES);
            // include type 'Features' in Builds structure navigation list
            Pattern typePattern = new Pattern(ProductLineConstants.TYPE_FEATURES);

            try {
                buildStructList = ProductLineCommon.getObjectStructureList(context, objectId, relPattern, typePattern);
            } catch (Exception ex) {
                throw new FrameworkException(ex);
            }
        } else {
            buildStructList = (MapList) emxPLCCommon_mxJPO.getStructureListForType(context, args);
        }
     ...
     * @since PLC X4
     */
    public Object getNoOfBuildstoCreate(Context context, String[] args) throws Exception {
     ...
     * @since PLC X4
     */
    public String displayContextProduct(Context context, String[] args) throws Exception {
        ...
        if (objID != null && parentObjID.equals(objID)) {
            ...
            if (!dstrObjId1.isKindOf(context, ProductLineConstants.TYPE_PRODUCTS)) {
                ...
                if (emxTableRowId != null) {
                    ...
                    relId = st.nextToken();
                    if (relId != null) {
                        DomainRelationship domrelPCBId = new DomainRelationship(relId);
                        StringList sList = new StringList();
                        sList.add(DomainRelationship.SELECT_FROM_ID);
                        String[] arr = new String[1];
                        arr[0] = relId;
                        MapList objMapList = DomainRelationship.getInfo(context, arr, sList);
                        // To get the PC Id
                        for (int j = 0; j < objMapList.size(); j++) {
                            Map objFLMap = (Map) objMapList.get(j);
                            strObjId = (String) objFLMap.get(DomainRelationship.SELECT_FROM_ID);
                        }
        ...
        if (dstrObjId.isKindOf(context, ProductLineConstants.TYPE_PRODUCTS)) {
            if (strObjId != null && strObjId.length() > 0) {
                setId(strObjId);
                DomainObject dProductId = DomainObject.newInstance(context, strObjId);
                // getting the value
                String sProductName = dProductId.getInfo(context, DomainObject.SELECT_NAME);
                ...
                sbBuffer.append("Display\" id=\"" + XSSUtil.encodeForHTMLAttribute(context, strObjId) + "\" value=\"" + XSSUtil.encodeForHTMLAttribute(context, sProductName) + "\"");
                sbBuffer.append("/>");
            ...
            if (strObjId != null && strObjId.length() > 0) {
                setId(strObjId);
                DomainObject dProductConfigurationId = DomainObject.newInstance(context, strObjId);
                ...
                MapList productConfigurationRelatedObjects = dProductConfigurationId.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION,
                        ProductLineConstants.TYPE_PRODUCTS, strListSelectstmts, null, true, true, (short) 1, null, null);
                if (productConfigurationRelatedObjects != null) {
                    for (int i = 0; i < productConfigurationRelatedObjects.size(); i++) {
                        Hashtable productMap = (Hashtable) productConfigurationRelatedObjects.get(i);
                ...
                sbBuffer.append("name=\"");
                sbBuffer.append(XSSUtil.encodeForHTMLAttribute(context, strFieldName));
                sbBuffer.append("Display\" id=\"" + XSSUtil.encodeForHTMLAttribute(context, strProductId) + "\" value=\"" + XSSUtil.encodeForHTMLAttribute(context, strProductName) + "\"");
                sbBuffer.append("/>");
                sbBuffer.append("<input type=\"hidden\" name=\"");
                sbBuffer.append(XSSUtil.encodeForHTMLAttribute(context, strFieldName));
     ...
     * @since PLC X4
     */
    public String displayContextProductConfiguration(Context context, String[] args) throws Exception {
        // unpacking the Arguments from variable args
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        // fixed for Mx378056
        ...
        if (objID != null && parentObjID != null && parentObjID.equals(objID)) {
            ...
            if (!dstrObjId1.isKindOf(context, ProductLineConstants.TYPE_PRODUCT_CONFIGURATION)) {
                Object emxTableRowId = requestMap.get("emxTableRowId");
                String emxTableRowIdstr = emxTableRowId.toString();
                StringTokenizer st = new StringTokenizer(emxTableRowIdstr, "|");
                String relId = "";
        ...
        if (dstrObjId.isKindOf(context, ProductLineConstants.TYPE_PRODUCTS)) {
            if (strObjId != null && strObjId.length() > 0) {
                ...
                /*
                 * String strClear = EnoviaResourceBundle.getProperty(context,SUITE_KEY, context.getSession().getLanguage(),"emxProduct.Button.Clear");
                 */
            ...
            if (strObjId != null && strObjId.length() > 0) {
                ...
                // getting the value
                String sProductConfigurationtName = dProductConfigurationId.getInfo(context, DomainObject.SELECT_NAME);

                sbBuffer.append("<input type=\"text\" readonly=\"true\" ");
                sbBuffer.append("name=\"");
                sbBuffer.append(XSSUtil.encodeForHTMLAttribute(context, strFieldName));
                sbBuffer.append("Display\" id=\"" + XSSUtil.encodeForHTMLAttribute(context, strObjId) + "\" value=\"" + XSSUtil.encodeForHTMLAttribute(context, sProductConfigurationtName) + "\"");
                sbBuffer.append("/>");
                sbBuffer.append("<input type=\"hidden\" name=\"");
                sbBuffer.append(XSSUtil.encodeForHTMLAttribute(context, strFieldName));
                sbBuffer.append("\" value=\"" + XSSUtil.encodeForHTMLAttribute(context, strObjId) + "\"");
     ...
     * @since PLC X4
     */
    public Object displayContextDesignResponsibility(Context context, String[] args) throws Exception {
        // unpacking the Arguments from variable args
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        // fixed for Mx378056
        ...
        if (dstrObjId.isKindOf(context, ProductLineConstants.TYPE_PRODUCTS) || dstrObjId.isKindOf(context, ProductLineConstants.TYPE_PRODUCT_CONFIGURATION)) {
            if (strObjId != null && strObjId.length() > 0) {
                setId(strObjId);
                if (dstrObjId.isKindOf(context, ProductLineConstants.TYPE_PRODUCTS)) {
                    DomainObject dProductId = DomainObject.newInstance(context, strObjId);
                    ...
                    // getting the value
                    strDesignResponsibilityId = dProductId.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "].from.id");
                    strDesignResponsibilitytName = dProductId.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "].from.name");
                } else {
                    // It is in PCContext
                    DomainObject dProductConfigurationId = DomainObject.newInstance(context, strObjId);
                    ...
                    String strProductId = " ";
                    strProductId = dProductConfigurationId.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.id");
                    DomainObject dProductId = DomainObject.newInstance(context, strProductId);

                    // If Product Configuration is created in context of Feature
                    if ((strProductId != null) && !(strProductId.equals("")) || "Unassigned".equalsIgnoreCase(strProductId) || "null".equalsIgnoreCase(strProductId)) {
                        strDesignResponsibilityId = dProductId.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "].from.id");
                        strDesignResponsibilitytName = dProductId.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "].from.name");
                    }
                }
                ...
                sbBuffer.append("name=\"");
                sbBuffer.append(XSSUtil.encodeForHTMLAttribute(context, strFieldName));
                sbBuffer.append("Display\" id=\"\" value=\"" + XSSUtil.encodeForHTMLAttribute(context, strDesignResponsibilitytName));
                sbBuffer.append("\" />");
                sbBuffer.append("<input type=\"hidden\" name=\"");
                sbBuffer.append(XSSUtil.encodeForHTMLAttribute(context, strFieldName));
     ...
     * @since PLC X4
     */
    public void connectToProduct(Context context, String[] args) throws Exception {
        // unpacking the Arguments from variable args
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        ...
        if ((strProductID != null) && !(strProductID.equals("")) || "Unassigned".equalsIgnoreCase(strProductID) || "null".equalsIgnoreCase(strProductID)) {
            ...
            DomainRelationship.connect(context, this, ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD, domBuild);
     ...
     * @since PLC X4
     */
    public void connectToProductConfiguration(Context context, String[] args) throws Exception {
        // unpacking the Arguments from variable args
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        HashMap requestMap = (HashMap) programMap.get("requestMap");

        String[] strProductConfigurationOID = (String[]) requestMap.get("ProductConfigurationOID");

        if ((strProductConfigurationOID != null) && !(strProductConfigurationOID.equals("")) || "null".equals(strProductConfigurationOID)) {
            ...
            if ((strProductConfigurationID != null) && !(strProductConfigurationID.equals("")) || "Unassigned".equalsIgnoreCase(strProductConfigurationID)
                    || "null".equalsIgnoreCase(strProductConfigurationID)) {
                DomainObject domProductConfiguration = new DomainObject(strProductConfigurationID);
                DomainRelationship domRel = DomainRelationship.connect(context, domProductConfiguration, ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION_BUILD, domBuild);
            }
        }
     ...
     * @since PLC X4
     */
    public void connectToDesignResponsibility(Context context, String[] args) throws Exception {
        // unpacking the Arguments from variable args
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");

        String strDesignResponsibilityId = (String) paramMap.get("New OID");
        if ((strDesignResponsibilityId == null) || (strDesignResponsibilityId.equals("")))
            strDesignResponsibilityId = (String) paramMap.get("New Value");
        String strbuildIdId = (String) paramMap.get("objectId");

        if ((strDesignResponsibilityId != null) && !(strDesignResponsibilityId.equals("")) || "Unassigned".equalsIgnoreCase(strDesignResponsibilityId)
                || "null".equalsIgnoreCase(strDesignResponsibilityId)) {
            DomainObject domDesignResponsibility = new DomainObject(strDesignResponsibilityId);
            DomainObject domBuild = new DomainObject(strbuildIdId);
            DomainRelationship domRel = DomainRelationship.connect(context, domDesignResponsibility, ProductLineConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY, domBuild);
        }
    }
    ...
    public void connectToPlant(Context context, String[] args) throws Exception {
        try {
            ...
            if ((strPlantId != null) && !(strPlantId.equals("")) || "Unassigned".equalsIgnoreCase(strPlantId) || "null".equalsIgnoreCase(strPlantId)) {
                DomainObject domPlant = new DomainObject(strPlantId);
                DomainObject domBuild = new DomainObject(strbuildIdId);
                DomainRelationship domRel = DomainRelationship.connect(context, domBuild, ProductLineConstants.RELATIONSHIP_MANUFACTURING_PLANT, domPlant);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
     ...
     * @since PLC X4
     */
    public void connectToCustomer(Context context, String[] args) throws Exception {
        try {
            ContextUtil.pushContext(context, PropertyUtil.getSchemaProperty(context, "person_UserAgent"), DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
            // unpacking the Arguments from variable args
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            ...
            if ((strCustomerId != null) && !(strCustomerId.equals("")) || "Unassigned".equalsIgnoreCase(strCustomerId) || "null".equalsIgnoreCase(strCustomerId)) {
                DomainObject domCompany = new DomainObject(strCustomerId);
                DomainObject domBuild = new DomainObject(strbuildIdId);
                DomainRelationship domRel = DomainRelationship.connect(context, domCompany, ProductLineConstants.RELATIONSHIP_CUSTOMER_UNIT, domBuild);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    /**
     * Added for Bug 356766 - To make creation of Multiple Builds a background job
     * @param context
     *            the Matrix Context
     * @param args
     * @throws Exception
     *             if the operation fails
     */
    public void createMultipleBuildsUsingBgpJob(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap requestMap = (HashMap) programMap.get("requestMap");
            ...
            String strProductConfigurationID = (String) requestMap.get("ProductConfigurationOID");

            String strDesignResponsibilityId = (String) requestMap.get("DesignResponsibilityOID");
            ...
            String strActualBuildDate = (String) requestMap.get("ActualBuildDate");
            String strPlannedBuildDate = (String) requestMap.get("PlannedBuildDate");
            ...
            attributeMap.put(ProductLineConstants.ATTRIBUTE_ACTUAL_BUILD_DATE, strActualBuildDate);
            attributeMap.put(ProductLineConstants.ATTRIBUTE_PLANNED_BUILD_DATE, strPlannedBuildDate);
            attributeMap.put(ProductLineConstants.ATTRIBUTE_DATE_SHIPPED, strDateShipped);

            if (isUNTInstalled) {
                String strBuildDisposition = (String) requestMap.get("BuildDisposition");
                String strContractNumber = (String) requestMap.get("ContractNumber");
                attributeMap.put(ProductLineConstants.ATTRIBUTE_BUILD_DISPOSITION, strBuildDisposition);
                attributeMap.put(ProductLineConstants.ATTRIBUTE_CONTRACT_NUMBER, strContractNumber);
            }
            String strRevision = "";
            ...
            for (int iSize = 0; iSize < iNoOfBuilds - 1; iSize++) {
                strbuildId = (String) createBuild.create(context, strBuildType, "", strRevision, strBuildDescription, strPolicy, strVaultName, attributeMap, "", "", "", false);
            ...
            ContextUtil.pushContext(context, PropertyUtil.getSchemaProperty(context, "person_UserAgent"), DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
            // Added for X+5 build on parts 08/10/08
            if (isUNTInstalled && "connectToPart".equals(createMode) && partId != null && !"".equals(partId)) {
                DomainObject domPartID = new DomainObject(partId);
                DomainRelationship.connect(context, domPartID, ProductLineConstants.RELATIONSHIP_ASSIGNED_PART, false, arrBuildId);
            }
            // End for X+5
            if ((strProductID != null) && !(strProductID.equals("")) || "Unassigned".equalsIgnoreCase(strProductID) || "null".equalsIgnoreCase(strProductID)) {
                DomainObject domProductID = new DomainObject(strProductID);
                DomainRelationship.connect(context, domProductID, ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD, true, arrBuildId);
            }

            if ((strProductConfigurationID != null) && !(strProductConfigurationID.equals("")) || "Unassigned".equalsIgnoreCase(strProductConfigurationID)
                    || "null".equalsIgnoreCase(strProductConfigurationID)) {
                DomainObject domProductConfigurationID = new DomainObject(strProductConfigurationID);
                DomainRelationship.connect(context, domProductConfigurationID, ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION_BUILD, true, arrBuildId);
            }

            if ((strDesignResponsibilityId != null) && !(strDesignResponsibilityId.equals("")) || "Unassigned".equalsIgnoreCase(strDesignResponsibilityId)
                    || "null".equalsIgnoreCase(strDesignResponsibilityId)) {
                DomainObject domDesignResponsibilityId = new DomainObject(strDesignResponsibilityId);
                DomainRelationship.connect(context, domDesignResponsibilityId, ProductLineConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY, true, arrBuildId);
            }

            if ((strCustomerID != null) && !(strCustomerID.equals("")) || "Unassigned".equalsIgnoreCase(strCustomerID) || "null".equalsIgnoreCase(strCustomerID)) {
                DomainObject domCustomerID = new DomainObject(strCustomerID);
                DomainRelationship.connect(context, domCustomerID, ProductLineConstants.RELATIONSHIP_CUSTOMER_UNIT, true, arrBuildId);
            }

            if ((strPlantID != null) && !(strPlantID.equals("")) || "Unassigned".equalsIgnoreCase(strPlantID) || "null".equalsIgnoreCase(strPlantID)) {
                DomainObject domPlantID = new DomainObject(strPlantID);
                DomainRelationship.connect(context, domPlantID, ProductLineConstants.RELATIONSHIP_MANUFACTURING_PLANT, false, arrBuildId);
            }
            ...
            if ((strModelContext != null) && (strModelContext.equals("true"))) {
                ...
                if (strModelId != null && strModelId.length() > 0) {
                    ...
                    DomainRelationship.connect(context, domModel, ProductLineConstants.RELATIONSHIP_MODEL_BUILD, true, arrBuildId);
                }
            }
    ...
    public StringList createMultipleBuilds(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            programMap.get("objectid");
            HashMap paramMap = (HashMap) programMap.get("paramMap");
            HashMap requestMap = (HashMap) programMap.get("requestMap");
            String objectId = (String) paramMap.get("objectId");
    ...
    public int updateCustomer(Context context, String[] args) throws Exception {
        ...
        if (strOldProductName != null && !strOldProductName.equals("")) {
            String strRelId = domainObjectToType.getInfo(context, "to[" + strCustomerUnitRelationship + "].id");
            // Disconnecting the existing relationship
            DomainRelationship.disconnect(context, strRelId);
        }
        setId(strNewCustomerId);
        if (!strNewCustomerId.equals("")) {
            DomainRelationship.connect(context, this, strCustomerUnitRelationship, domainObjectToType);
        }
    ...
    public int updateManufacturingPlant(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        String strBuildId = (String) paramMap.get("objectId");
        ...
        if ("true".equalsIgnoreCase(hasEditAccess)) {
            try {
                ...
                if (strNewPlantId != null && strNewPlantId.length() > 0) {
                    DomainRelationship.connect(context, build, ProductLineConstants.RELATIONSHIP_MANUFACTURING_PLANT, new DomainObject(strNewPlantId));
                }
            ...
            throw new FrameworkException(UINavigatorUtil.getI18nString("emxProduct.Alert.PlantEditBeyondCompleteState", "emxProductLineStringResource", context.getSession().getLanguage()));
        }
    }
    ...
    public int updateProductConfiguration(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        String strBuildId = (String) paramMap.get("objectId");
        ...
        setId(strBuildId);
        DomainObject domainObjectToType = newInstance(context, strBuildId);
        if ((strOldProductConfiguraionName != null) && !(strOldProductConfiguraionName.equals("")) || "null".equals(strOldProductConfiguraionName))
        // if (!strOldProductConfiguraionName.equals("") )
        {
            String strRelId = domainObjectToType.getInfo(context, "to[" + strProductConfigurationRelationship + "].id");
        ...
        if (!strNewProductConfiguraionId.equals("")) {
            DomainRelationship.connect(context, this, strProductConfigurationRelationship, domainObjectToType);
        }
    ...
    public int updateProduct(Context context, String[] args) throws Exception {
        try {
            ...
            DomainObject domainObjectToType = newInstance(context, strBuildId);
            if (!strOldProductName.equals("")) {
                String strRelId = domainObjectToType.getInfo(context, "to[" + strProductBuildRelationship + "].id");
                if (strRelId != null) {
                    ...
                    MapList objMapList = DomainRelationship.getInfo(context, relIdarr, relSelects);
                    if (!objMapList.isEmpty()) {
                        Map objProductMap = (Map) objMapList.get(0);
                        String strOldProductId = (String) objProductMap.get(DomainRelationship.SELECT_FROM_ID);

                        // Chanages done on 3rd July 2008, to fix 356862 -
                        // Starts
                        DomainObject domainObject = new DomainObject(strOldProductId);

                        StringList sList = new StringList(1);
                        sList.addElement(DomainConstants.SELECT_ID);
                        StringList selectRelStmts = new StringList(1);
                        MapList mListRelatedData = domainObject.getRelatedObjects(context, "", PropertyUtil.getSchemaProperty(context, "type_PUEECO"), sList, selectRelStmts, true, false, (short) 0,
                                "", "");

                        if (mListRelatedData != null && !mListRelatedData.isEmpty()) {
                            String strAlertMessage = UINavigatorUtil.getI18nString("emxProduct.Confirm.ProductPUEECO.Clear", "emxProductLineStringResource", context.getSession().getLanguage());
                            throw new FrameworkException(strAlertMessage);
                        }
                        // Made Changes to fix Bug #356851
                        if (strOldProductId != null && !strOldProductId.equals("null") && !strOldProductId.equals("")) {
                            DomainObject objOldProduct = newInstance(context, strOldProductId);
                            strOldModelId = objOldProduct.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCTS + "].from.id");
                            if (strOldModelId == null || "".equals(strOldModelId)) {
                                strOldModelId = objOldProduct.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_MAIN_PRODUCT + "].from.id");
                            }
                        }
                        // Chanages done on 3rd July 2009, to fix 356862 - Ends
                        if (strNewProductId != null && strOldProductId != null && strNewProductId.equals(strOldProductId)) {
                            return 0;
                        }
                    }
                }
            ...
            if (strNewProductId != null && !strNewProductId.equals("null") && !strNewProductId.equals("")) {
                setId(strNewProductId);
                // Made Changes to fix Bug #356851
                strNewModelId = this.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCTS + "].from.id");
                if (strNewModelId == null || "".equals(strNewModelId)) {
                    strNewModelId = this.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_MAIN_PRODUCT + "].from.id");
                }

                strOldUnitNumber = domainObjectToType.getAttributeValue(context, ProductLineConstants.ATTRIBUTE_BUILD_UNIT_NUMBER);
                strOldShorthandNotation = domainObjectToType.getAttributeValue(context, ProductLineConstants.ATTRIBUTE_PREFIX);

                DomainRelationship.connect(context, this, strProductBuildRelationship, domainObjectToType);

                // Made Changes to fix Bug #356851
                if (strOldModelId != null && !strOldModelId.equals("null") && strNewModelId != null && !strNewModelId.equals("null") && strOldModelId.equals(strNewModelId)) {
                    HashMap objAttribMap = new HashMap(2);
                    objAttribMap.put(ProductLineConstants.ATTRIBUTE_BUILD_UNIT_NUMBER, strOldUnitNumber);
                    objAttribMap.put(ProductLineConstants.ATTRIBUTE_PREFIX, strOldShorthandNotation);
                    domainObjectToType.setAttributeValues(context, objAttribMap);
                }
            } else {
                // If condition added for IR-019598
                if (!isModelBuild(context, domainObjectToType)) {
                    HashMap objAttribMap = new HashMap(2);
                    objAttribMap.put(ProductLineConstants.ATTRIBUTE_BUILD_UNIT_NUMBER, strDefaultUnitNumber);

                    ContextUtil.pushContext(context, PropertyUtil.getSchemaProperty(context, "person_UserAgent"), DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
                    objAttribMap.put(ProductLineConstants.ATTRIBUTE_PREFIX, strDefaultShorthandNotation);
                    domainObjectToType.setAttributeValues(context, objAttribMap);
                    ContextUtil.popContext(context);
                }
            }
    ...
    private boolean isModelBuild(Context context, DomainObject domObj) throws Exception {
        if (isUNTInstalled(context, null)) {
            String strModel = domObj.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_MODEL_BUILD + "].from.id");
    ...
    public int updateAssignedPart(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        String strBuildId = (String) paramMap.get("objectId");
        ...
        if (!strOldAssignedPartName.equals("")) {
            String strRelId = domainObjectToType.getInfo(context, "from[" + strAssignedPartRelationship + "].id");
            // Disconnecting the existing relationship
            DomainRelationship.disconnect(context, strRelId);
        }
        setId(strNewAssignedPartId);
        if (!strNewAssignedPartId.equals("")) {
            DomainRelationship.connect(context, domainObjectToType, strAssignedPartRelationship, this);
        }
    ...
    public int updateDesignResponsibility(Context context, String[] args) throws Exception {
        try {
            ...
            String strOldDesignResponsibilityName = (String) paramMap.get("Old OID");
            // String strNewDesignResponsibilityId =
            // (String)paramMap.get("New Value");

            String strNewDesignResponsibilityId = (String) paramMap.get("New OID");

            String strDesignResponsibilityRelationship = ProductLineConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY;

            setId(strBuildId);
            DomainObject domainObjectToType = newInstance(context, strBuildId);
            strOldDesignResponsibilityName = domainObjectToType.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "].from.name");
            String strRelId = null;
            if (strOldDesignResponsibilityName != null) {
                if ((!strOldDesignResponsibilityName.equals(""))) {
                    strRelId = domainObjectToType.getInfo(context, "to[" + strDesignResponsibilityRelationship + "].id");
                    // Disconnecting the existing relationship
                    DomainRelationship.disconnect(context, strRelId);
                }
            }
            ...
            if (!strNewDesignResponsibilityId.equals("")) {
                DomainRelationship.connect(context, this, strDesignResponsibilityRelationship, domainObjectToType);
            }

            if (strNewDesignResponsibilityId != null && strNewDesignResponsibilityId.equals("") && strOldDesignResponsibilityName != null && !strOldDesignResponsibilityName.equals("")) {
                // String strRelId =
    ...
    /**
     * Method to get only the Product Configurations based on the selected Product Shows all the Product Configurations if the Product is not selected.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the HashMap containing the following arguments paramMap - contains ObjectId, Old Value for product name and new value
    ...
    public StringList filterRelatedProductConfiguration(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            ...
            if (strProductId != null && !"".equalsIgnoreCase(strProductId)) {
                DomainObject domProductId = new DomainObject(strProductId);
                StringList strProductConfIds = domProductId.getInfoList(context, "from[" + ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].to.id");
                ...
                MapList lstPCList = DomainObject.findObjects(context, ProductLineConstants.TYPE_PRODUCT_CONFIGURATION, DomainConstants.QUERY_WILDCARD, "", objSelect);
                ...
                tempStrList = getModelContextProductConfigurations(context, strModelId);

                return tempStrList;
            } else {
                StringList objSelect = new StringList(2);
                objSelect.addElement(DomainConstants.SELECT_ID);
                objSelect.addElement("to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.type");
                ...
                for (int i = 0; i < lstPCList.size(); i++) {
                    Map productConfigMap = (Map) lstPCList.get(i);
                    strPCType = (String) productConfigMap.get("to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.type");

                    // if(strPCType!=null && !"".equalsIgnoreCase(strPCType) &&
                    // strPCType.equalsIgnoreCase("null"))
                    if ((strPCType != null) && !(strPCType.equals("")) || "Unassigned".equalsIgnoreCase(strPCType) || "null".equalsIgnoreCase(strPCType)) {
                        if (!mxType.isOfParentType(context, strPCType, ProductLineConstants.TYPE_PRODUCTS)) {
                            String strObjId = (String) productConfigMap.get(DomainConstants.SELECT_ID);
                ...
                if (isUNTInstalled(context, args)) {
                    if (strBuildId != null && strBuildId.length() > 0) {
                        ...
                        String strModelBuildSelectable = "to[" + ProductLineConstants.RELATIONSHIP_MODEL_BUILD + "].from.id";
                        String strProductBuildSelectable = "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.id";
                        selectables.add(strModelBuildSelectable);
                        selectables.add(strProductBuildSelectable);
                        Map list = obj.getInfo(context, selectables);
                        String strBuildModelId = (String) list.get(strModelBuildSelectable);
                        if (strBuildModelId != null && strBuildModelId.length() > 0) {
                            if (strOperation != null && strOperation.equalsIgnoreCase("AsBuilt")) {
                                tempStrList = getModelContextProductConfigurationsForAsBuilt(context, strBuildModelId);
                            } else {
                                tempStrList = getModelContextProductConfigurations(context, strBuildModelId);
                                return tempStrList;
                            }
                        }
                    }
                    tempStrList.addAll(checkForIPUAndGetRelatedProdConfId(context, strBuildId));
                    // Following if condition added for IR-050574
                    if (strOperation != null && strOperation.equalsIgnoreCase("AsBuilt")) {
                        StringList lst = getFirstLevelProdConfList(context, strBuildId);
    ...
    private StringList getFirstLevelProdConfList(Context context, String strBuildId) throws Exception {
        ...
        for (int i = 0; i < listProdIds.size(); i++) {
            ...
            StringList list = tempObj.getInfoList(context, "from[" + ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].to.id");
    ...
    private StringList getModelContextProductConfigurationsForAsBuilt(Context context, String strModelId) throws Exception, FrameworkException {
        StringList tempStrList = new StringList();
        ...
        MapList relatedProducts = domModel.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_PRODUCTS, ProductLineConstants.TYPE_PRODUCTS, objectSelects, relSelects, false, true, (short) 1,
                "", "", 0);
        ...
        for (int i = 0; i < strProductIds.size(); i++) {
            ...
            DomainObject domProductId = new DomainObject((String) strProductIds.get(i));
            StringList strProductConfIdsTemp = domProductId.getInfoList(context, "from[" + ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].to.id");
    ...
    private StringList getModelContextProductConfigurations(Context context, String strModelId) throws Exception, FrameworkException {
        StringList tempStrList = new StringList();
    ...
    /**
     * Method to get only the Product based on the selected Product Configuration Shows all the Product if the Product Configuration is not selected.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the HashMap containing the following arguments paramMap - contains ObjectId, Old Value for product name and new value
    ...
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList filterRelatedProduct(Context context, String[] args) throws Exception {
        ...
        if (ProductLineCommon.isNotNull(strIntendProdId)) {
            ...
            String strProductIds = domBuild.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.id");
            tempStrList.add(strProductIds);
        }

        if (strProductConfigurationId != null && strProductConfigurationId.length() > 0) {
            strProductConfigurationId = strProductConfigurationId.trim();
            DomainObject domProductId = new DomainObject(strProductConfigurationId);

            String strProductConfIds = domProductId.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from.id");

            // get all the Products in the entire Database
            StringList objSelect = new StringList(2);
            objSelect.addElement(DomainConstants.SELECT_ID);
            MapList lstProductList = DomainObject.findObjects(context, ProductLineConstants.TYPE_PRODUCTS, DomainConstants.QUERY_WILDCARD, "", objSelect);
            ...
            for (int i = 0; i < lstProductList.size(); i++) {
                ...
                if (strProductConfIds != null && strProductConfIds.length() > 0 && !strProductConfIds.equals(strId)) {
                    tempStrList.addElement(strId);
                }
            }
        }
        ...
        if (isUNTInstalled(context, args)) {
            if (strBuildId != null && strBuildId.length() > 0) {
                ...
                if (strBuildModelId != null && strBuildModelId.length() > 0) {
                    if (strOperation != null && strOperation.equalsIgnoreCase("AsBuilt"))
                        tempStrList = getModelContextProductsForAsBuilt(context, strBuildModelId);
                    else {
                        tempStrList = getModelContextProducts(context, strBuildModelId);
                        return tempStrList;
                    }
                }
            }

            tempStrList.addAll(checkForIPUAndGetRelatedProdId(context, strBuildId));
            // Following if condition added for IR-050574
            if (strOperation != null && strOperation.equalsIgnoreCase("AsBuilt")) {
    ...
    private StringList getFirstLevelProdList(Context context, String strBuildId) throws Exception {
        StringList lst = new StringList();
        // If condition added for IR-035528
        if (strBuildId != null && strBuildId.length() > 0) {
            DomainObject domBuild = new DomainObject(strBuildId);
            StringList result = domBuild.getInfoList(context, "from[" + ProductLineConstants.RELATIONSHIP_UNITBOM + "].to.id");
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                tempProdId = (String) domUBOMBuild.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.id");
    ...
    private StringList getModelContextProductsForAsBuilt(Context context, String strModelId) throws Exception {
        StringList tempStrList = new StringList();
        ...
        MapList productIds = domModelId.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_PRODUCTS, ProductLineConstants.TYPE_PRODUCTS, objectSels, null, false, true, (short) 1, null, null,
                0);
    ...
    private StringList getModelContextProducts(Context context, String strModelId) throws Exception, FrameworkException {
        StringList tempStrList = new StringList();
        DomainObject domModelId = new DomainObject(strModelId);
        StringList objectSels = new StringList();
        objectSels.addElement(DomainConstants.SELECT_ID);
     ...
     * @throws Exception
     */
    private StringList checkForIPUAndGetRelatedProdId(Context context, String strBuildId) throws Exception {
        ...
        if (strBuildId != null && strBuildId.length() > 0) {
            ...
            selectStmts.addElement("to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.id");
            MapList listIPUFrom = obj.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_INTENDED_PRODUCT_UNIT + "," + ProductLineConstants.RELATIONSHIP_UNITBOM, // relationship
                    // pattern
                    ...
                    null);
            MapList listIPUTo = obj.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_INTENDED_PRODUCT_UNIT + "," + ProductLineConstants.RELATIONSHIP_UNITBOM, // relationship
                    // pattern
                    ProductLineConstants.TYPE_HARDWARE_BUILD, // object pattern
                    selectStmts, // object selects
                    null, // relationship selects
            ...
            if (listIPU != null && listIPU.size() > 0) {
                for (int i = 0; i < listIPU.size(); i++) {
                    ...
                    String tempId = (String) map.get("to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.id");
     ...
     * @throws Exception
     */
    private StringList checkForIPUAndGetRelatedProdConfId(Context context, String strBuildId) throws Exception {
        StringList listProdConfIds = new StringList();
        StringList listProdIds = checkForIPUAndGetRelatedProdId(context, strBuildId);
        for (int i = 0; i < listProdIds.size(); i++) {
            String objid = (String) listProdIds.get(i);
            DomainObject tempObj = new DomainObject(objid);
            StringList list = tempObj.getInfoList(context, "from[" + ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].to.id");
     ...
     * @param args
     *            - Holds the HashMap containing the following arguments paramMap - contains ObjectId, Old Value for product name and new value
     * @return String - returns the textbox if the Form Mode is edit or will display the Product Name
     * @throws Exception
     *             if the operation fails
     * @since ProductLine X+4
     */
    public String getShortHandNotation(Context context, String[] args) throws Exception {
        ...
        String strShortHandNotation = objectModel.getAttributeValue(context, ProductLineConstants.ATTRIBUTE_PREFIX);
     ...
     * @since ProductLine X+4
     */
    public String getBuildUnitNumber(Context context, String[] args) throws Exception {
        ...
        String strBuildUnitNumber = objectModel.getAttributeValue(context, ProductLineConstants.ATTRIBUTE_BUILD_UNIT_NUMBER);
    ...
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList filterProductBuilds(Context context, String[] args) throws Exception {
        StringList tempStrList = new StringList();
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String strObjectId = (String) programMap.get("objectId");
        ...
        try {
            ...
            strCtxtProdId = ctxtBuildObj.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.id");
            ...
            if (ProductLineCommon.isNotNull(strCtxtProdId)) {
                ...
                StringList strCtxtBuildIds = domProduct.getInfoList(context, "from[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].to.id");
            ...
            StringList tmpIPUList = getAllContextBuilds(context, ctxtBuildObj, new StringList());
    ...
    public StringList getAllContextBuilds(Context context, DomainObject ctxtBuildObj, StringList strList) throws Exception {
        StringList tempStrList = new StringList();
        tempStrList.addAll(getParentIPUs(context, ctxtBuildObj));
        StringList tmpIPUList = filterContextAndRelatedBuildsForIPU(context, ctxtBuildObj, new StringList());
        tmpIPUList.addAll(getContextAndOtherProdBuildsToExclude(context, ctxtBuildObj));
        // removeOtherContextProdBuilds(context, tmpIPUList, ctxtBuildObj);
        tempStrList.addAll(tmpIPUList);
        return tmpIPUList;
    }

    private StringList getContextAndOtherProdBuildsToExclude(Context context, DomainObject objBuild) throws Exception {
        ...
        if (objBuild.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "]").equalsIgnoreCase("True")) {

            prodbuilds = objBuild.getInfoList(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.to[" + ProductLineConstants.RELATIONSHIP_PRODUCTS + "].from.from["
                    + ProductLineConstants.RELATIONSHIP_MODEL_BUILD + "].to.id");
            prodbuilds1 = objBuild.getInfoList(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.to[" + ProductLineConstants.RELATIONSHIP_MAIN_PRODUCT + "].from.from["
                    + ProductLineConstants.RELATIONSHIP_MODEL_BUILD + "].to.id");
            if (prodbuilds1 != null && !prodbuilds1.isEmpty()) {
                prodbuilds.addAll(prodbuilds1);
            }
        } else if (objBuild.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_MODEL_BUILD + "]").equalsIgnoreCase("True")) {
            prodbuilds = objBuild.getInfoList(context, "to[" + ProductLineConstants.RELATIONSHIP_MODEL_BUILD + "].from.from[" + ProductLineConstants.RELATIONSHIP_MODEL_BUILD + "].to.id");
        }
        ...
        MapList contextIPUList = DomainObject.findObjects(context, ProductLineConstants.TYPE_HARDWARE_BUILD, DomainConstants.QUERY_WILDCARD,
                "relationship[" + ProductLineConstants.RELATIONSHIP_MODEL_BUILD + "]==True", objSelect);
        for (int i = 0; i < contextIPUList.size(); i++) {
            Map map = (Map) contextIPUList.get(i);
            DomainObject tempObj = new DomainObject((String) map.get(DomainConstants.SELECT_ID));
            tempIPUList = filterContextAndRelatedBuildsForIPU(context, tempObj, new StringList());
    ...
    private boolean contextProdBuildExists(StringList prodbuilds, StringList tempIPUList) {
    ...
    private StringList getFromSideProdBuilds(Context context, DomainObject ctxtBuildObj) throws Exception {
        StringList selectStmts = new StringList(1);
        selectStmts.addElement(DomainConstants.SELECT_ID);
        selectStmts.addElement(DomainConstants.SELECT_NAME);
        StringList prodList = new StringList();
        MapList contextIPUList = ctxtBuildObj.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_INTENDED_PRODUCT_UNIT + "," + ProductLineConstants.RELATIONSHIP_UNITBOM, // relationship
                // pattern
                ProductLineConstants.TYPE_HARDWARE_BUILD, // object pattern
                selectStmts, // object selects
                null, // relationship selects
        ...
        for (int i = 0; i < contextIPUList.size(); i++) {
            ...
            String prodId = obj.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.id");
            if (prodId != null && prodId.length() > 0) {
                prodList.addAll(obj.getInfoList(context, "to[" + ProductLineConstants.RELATIONSHIP_MODEL_BUILD + "].from." + "from[" + ProductLineConstants.RELATIONSHIP_MODEL_BUILD + "].to.id"));
    ...
    /**
     * This method is added to filter out the builds which are having IPU or UBOM relationships with context builds It also filters the context product builds.
     * @param context
     * @param ctxtBuildObj
     * @param orgList
     * @return
     * @throws Exception
     */
    public StringList filterContextAndRelatedBuildsForIPU(Context context, DomainObject ctxtBuildObj, StringList orgList) throws Exception {
        StringList list = new StringList();
        StringList prodbuilds = new StringList();
        StringList tempList = new StringList();
        StringList selectStmts = new StringList(1);
        ...
        MapList listIPU = ctxtBuildObj.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_INTENDED_PRODUCT_UNIT + "," + ProductLineConstants.RELATIONSHIP_UNITBOM, // relationship
                // pattern
                ProductLineConstants.TYPE_HARDWARE_BUILD, // object pattern
                selectStmts, // object selects
                null, // relationship selects
        ...
        for (int i = 0; i < listIPU.size(); i++) {
            Map map = (Map) listIPU.get(i);
            if (((String) map.get(DomainConstants.SELECT_TYPE)).equalsIgnoreCase(ProductLineConstants.TYPE_HARDWARE_BUILD) && !list.contains(DomainConstants.SELECT_ID)) {
    ...
    /**
     * Mathod added as part of fic bor BUG: 370415 -- This will return the Build which is the parent IPU to avoid cyclic dependency.
     * @param context
     * @param ctxtBuildObj
     * @return
     * @throws Exception
     */
    private StringList getParentIPUs(Context context, DomainObject ctxtBuildObj) throws Exception {
        MapList maplist = new MapList();
        StringList selectStmts = new StringList(1);
        selectStmts.addElement(DomainConstants.SELECT_ID);
        String strIPUToRel = "to[" + ProductLineConstants.RELATIONSHIP_INTENDED_PRODUCT_UNIT + "].id";
        selectStmts.addElement(strIPUToRel);
        maplist = ctxtBuildObj.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_INTENDED_PRODUCT_UNIT, // relationship
                // pattern
                ProductLineConstants.TYPE_HARDWARE_BUILD, // object pattern
                selectStmts, // object selects
                null, // relationship selects
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getIntendedProductUnits(Context context, String[] args) throws Exception {
        ...
        String sRelName = PropertyUtil.getSchemaProperty(context, "relationship_IntendedProductUnit");
        ...
        // Get IPUs
        ubomList = domBuild.getRelatedObjects(context, sRelName, sTypeName, selectStmts, selectRelStmts, false, true, (short) level, null, null);
    ...
    public String getBuildProduct(Context context, String[] args) throws Exception {
        ...
        if (strObjectId != null) {
            ...
            strProductName = domBuild.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.name");
            strProductId = domBuild.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.id");
        ...
        if ((strMode != null && !strMode.equals("") && !strMode.equalsIgnoreCase("null") && strMode.equalsIgnoreCase("edit")) || (strContext != null && !strContext.equals(""))) {
            sbBuffer.append("<input type=\"text\" readonly=\"true\" ");
            sbBuffer.append("name=\"");
            sbBuffer.append(XSSUtil.encodeForHTMLAttribute(context, strFieldName));
            ...
            sbBuffer.append(getAsBuiltContextString(context, strOperation, strContextBuildId));
            sbBuffer.append("<input ");
    ...
    // added by P Voggu
    /*
     * This method is used to display the Design Responsibility field in the Build properties page
     */

    public String getDesignResponsibilityForBuild(Context context, String[] args) throws Exception {
        ...
        if (strObjectId != null) {
            DomainObject domBuild = new DomainObject(strObjectId);
            strDesignResponsibilityName = domBuild.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "].from.name");
            strDesignResponsibilityId = domBuild.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "].from.id");
        ...
        if ((strMode != null && !strMode.equals("") && !strMode.equalsIgnoreCase("null") && strMode.equalsIgnoreCase("edit")) || (strContext != null && !strContext.equals(""))) {
            ...
            sbBuffer.append("Display\" id=\"" + strDesignResponsibilityId + "\" value=\"");
    ...
    private String getAsBuiltContextString(Context context, String strOperation, String strContextbuild) {
        if (strOperation == null || strOperation.length() == 0 || strContextbuild == null || strContextbuild.length() == 0 || !strOperation.equalsIgnoreCase("asbuilt")) {
            return "";
        }
        StringBuffer sbBuffer = new StringBuffer();
        sbBuffer.append("<input type=\"hidden\" name=\"");
     ...
     * @return
     */
    private String getModelContextString(Context context, String strModelContext, String strParentOID) {
        if (strModelContext == null || strModelContext.length() == 0 || strParentOID == null || strParentOID.length() == 0) {
            return "";
        }
        StringBuffer sbBuffer = new StringBuffer();
        sbBuffer.append("<input type=\"hidden\" name=\"");
    ...
    /**
     * This method updates the Build Unit Number and Shorthand Notation of Build based on the Product it is connected to It is called as a create trigger when the Product Build relationship
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public void assignBuildUnitNumberAndShorthandNotation(Context context, String[] args) throws Exception {
        try {
            ContextUtil.pushContext(context, PropertyUtil.getSchemaProperty(context, "person_UserAgent"), DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
            ...
            MapList objRelMapList = DomainRelationship.getInfo(context, arrRelId, relSelects);
            Map objRelMap = (Map) objRelMapList.get(0);
            DomainObject objProduct = newInstance(context, (String) objRelMap.get(DomainRelationship.SELECT_FROM_ID));
            DomainObject objBuild = newInstance(context, (String) objRelMap.get(DomainRelationship.SELECT_TO_ID));
            String strIsVersion = objProduct.getAttributeValue(context, ProductLineConstants.ATTRIBUTE_IS_VERSION);
            if (strIsVersion.equalsIgnoreCase("FALSE")) {
                strModelId = objProduct.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCTS + "].from.id");
                ...
                strModelId = objProduct.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_VERSION + "].from.relationship[" + ProductLineConstants.RELATIONSHIP_PRODUCTS + "].from.id");
            }
            if (strModelId == null || strModelId.equals("null") || strModelId.equals("")) {
                return;
            }
            ...
            String strPrefix = objModel.getInfo(context, "attribute[" + ProductLineConstants.ATTRIBUTE_PREFIX + "]");
            if (strPrefix == null || (strPrefix != null && strPrefix.equalsIgnoreCase("null"))) {
                strPrefix = "";
            }
            HashMap attributeMap = new HashMap();
            String strUnitNumber = objBuild.getAttributeValue(context, ProductLineConstants.ATTRIBUTE_BUILD_UNIT_NUMBER);
            String strUpdatedUnitNumber = strUnitNumber;
            // Check if the Unit number exists for the build...if exists then
            // return.
            if (strUnitNumber == null || (strUnitNumber != null && (strUnitNumber.equalsIgnoreCase("") || strUnitNumber.equalsIgnoreCase("0")))) {

                int iUnitNumber = objModel.getLastUnitNumber(context, strModelId);
                ...
                attributeMap.put(ProductLineConstants.ATTRIBUTE_BUILD_UNIT_NUMBER, strUpdatedUnitNumber);
            }
            String strShorthandNotation = strPrefix.concat(strUpdatedUnitNumber);
            attributeMap.put(ProductLineConstants.ATTRIBUTE_PREFIX, strShorthandNotation);
    ...
    /**
     * This method disconnects the Builds from Product Configuration when they are disconnected from parent Products It is called as a delete trigger on the Product Build relationship
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     * @since Product Line X+4
     */
    public void disconnectBuildsFromProductConfigurationOnProductBuildDelete(Context context, String[] args) throws Exception {

        String strBuildId = args[0];
        DomainObject objBuild = newInstance(context, strBuildId);
        String relId = objBuild.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION_BUILD + "].id");
    ...
    /**
     * This method connects the Buildto parent Product when they are connected to Product Configurations It is called as a create trigger on the Product Configuration Build relationship
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     * @since Product Line X+4
     */
    public void connectBuildsToProductOnProductConfigurationBuildsCreate(Context context, String[] args) throws Exception {
        String strProductBuildRelId = args[0];
        String[] arrRelId = new String[1];
        arrRelId[0] = strProductBuildRelId;
        StringList relSelects = new StringList(2);
        ...
        MapList objRelMapList = DomainRelationship.getInfo(context, arrRelId, relSelects);
        Map objRelMap = (Map) objRelMapList.get(0);
        String strBuildId = (String) objRelMap.get(DomainRelationship.SELECT_TO_ID);
        DomainObject objBuild = newInstance(context, (String) objRelMap.get(DomainRelationship.SELECT_TO_ID));
        DomainObject objProductConfiguration = newInstance(context, (String) objRelMap.get(DomainRelationship.SELECT_FROM_ID));
        ...
        MapList objMapList = objProductConfiguration.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION, ProductLineConstants.TYPE_PRODUCTS, true, false, 1, busSelects,
                relSelect, "", "", "", "", null);
        Map objMap = null;
        if (!objMapList.isEmpty()) {
            StringList slProductidList = objBuild.getInfoList(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.id");
            objMap = (Map) objMapList.get(0);
            String strProductId = (String) objMap.get(DomainConstants.SELECT_ID);
            DomainObject objProduct = newInstance(context, strProductId);
            StringList strProductBuildID = objProduct.getInfoList(context, "from[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].to.id");
            if (!strProductBuildID.contains(strBuildId)) {
                DomainRelationship.connect(context, objProduct, ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD, objBuild);
            }
        }
    }

    /**
     * This method checks whether the builds are in Complete or Release state/Products are in Release state and stops the user from deleting the builds
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the builds Id
    ...
    public int checkForBuildDeleteRules(Context context, String[] args) throws Exception {
        String strBuildId = args[0];
        String prodState = "";
        String strProductId = "";
        ...
        if (isAsBuilt) {
            strAsBuiltAlertMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Alert.AsBuiltAlertMessage", language);
        ...
        busSelects.add(DomainConstants.SELECT_ID);
        objPmap = dombuild.getRelatedObject(context, ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD, false, busSelects, null);
        if (objPmap != null) {
        ...
        if (isProdRelease) {
            ...
            strProdAlertMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Alert.ProductDeleteReleaseState", language);
            // new MQLCommand().executeCommand(context, "notice '" +
            // strProdAlertMessage + "'");
        ...
        if (isBuildComplete) {
            strBuildAlertMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Alert.BuildDeleteCompleteState", language);
    ...
    /**
     * This method checks whether the builds are in Complete or Release state/Products are in Release state and stops the user from removing the builds
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public int checkForBuildRemoveRules(Context context, String[] args) throws Exception {
        ...
        if (isProdRelease) {
            String language = context.getSession().getLanguage();
            strProdAlertMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Alert.ProductRemoveReleaseState", language);
            // new MQLCommand().executeCommand(context, "notice '" +
            // strProdAlertMessage + "'");
            MqlUtil.mqlCommand(context, "notice $1", strProdAlertMessage);
            return 1;
        ...
        if (isBuildComplete) {
            String language = context.getSession().getLanguage();
            strBuildAlertMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Alert.BuildRemoveCompleteState", language);
            // new MQLCommand().executeCommand(context, "notice '" +
            // strBuildAlertMessage + "'");
            MqlUtil.mqlCommand(context, "notice $1", strBuildAlertMessage);
            return 1;
     ...
     */
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList getSerializedParts(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        StringList sList = new StringList();
        ...
        try {
            ...
            strBuffer.append("(from[" + ProductLineConstants.RELATIONSHIP_PART_MARKING + "].to.attribute[" + ProductLineConstants.ATTRIBUTE_MARKED_BY + "].value == \"");
            ...
            objSelect.addElement(DomainConstants.SELECT_ID);
            objSelect.addElement(DomainConstants.SELECT_NAME);
            MapList buildsList = DomainObject.findObjects(context, DomainConstants.TYPE_PART, DomainConstants.QUERY_WILDCARD, sWhereExp, objSelect);
     ...
     * @since R209
     */
    public boolean isCFPInstalled(Context context, String[] args) throws Exception {
        return FrameworkUtil.isSuiteRegistered(context, "featureVersionDMCPlanning", false, null, null);
    }
     ...
     * @exclude
     */
    public boolean displayProductField(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        if (parentOID != null && !"".equals(parentOID)) {
            ...
            if (obj.isKindOf(context, ProductLineConstants.TYPE_PRODUCTS) || obj.isKindOf(context, ProductLineConstants.TYPE_PRODUCT_CONFIGURATION))
                return false;
        }
        return true;
    }
     ...
     * @exclude
     */
    public boolean displayProductConfigurationField(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String parentOID = (String) programMap.get("parentOID");
        ...
        if (parentOID != null && !"".equals(parentOID)) {
            DomainObject obj = new DomainObject(parentOID);
            String type = obj.getInfo(context, DomainConstants.SELECT_TYPE);
            if (obj.isKindOf(context, ProductLineConstants.TYPE_PRODUCT_CONFIGURATION))
                return false;
        }
        return true;
    }
     ...
     *             if operation fails
     */
    public StringList isShorthandNotationEditable(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
    ...
    public boolean showNoOfBuildsField(Context context, String args[]) throws Exception {
        ...
        if ("true".equalsIgnoreCase(createMultiple))
            return true;
        return false;
    }
        ...
        try {
            ...
            if (null != objectList) {
                for (int i = 0; i < objectList.size(); i++) {
                    ...
                    objInfo.put(fieldKey, getHTMLForCountAndLabel(count, label, id, mouseOverText,
                            "Lot".equalsIgnoreCase(objInfo.get("type")) ? "UNTLotReferenceDocumentTreeCategory" : "PLCBuildReferenceDocumentTreeCategory", ARG_BASE_URI));
                }
            }
        } catch (Exception ex) {
    ...
    private String getHTMLForCountAndLabel(String count, String label, String id, String mouseOverText, String categoryTreeName, String baseURI) {
        // return
        // "<a target=\"content\" href=\""+baseURI+"common/emxSecurityContextSelection.jsp?DefaultCategory="+categoryTreeName+"&amp;objectId="+id+"\"><span><div class=\"image-container\"
        // style=\"width: 75px;text-decoration:none;text-align: center;font-weight: bold;color: #333333;padding: 6px 8px;\" title=\""+mouseOverText+"\">"+count+"<br>"+label+"</div></span></a>";
    ...
    // Widget-End
    /**
     * This method returns the status of the build i.e., Allocated or Unallocated based on the model build relationship.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     *             if operation fails
     */
    public StringList getBuildStatus(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        i18nNow i18nnow = new i18nNow();
        String language = context.getSession().getLanguage();
        String strAllocated = EnoviaResourceBundle.getProperty(context, "emxProductLineStringResource", context.getLocale(), "emxProductLine.Units.BuildStatusAllocated");
        String strUnallocated = EnoviaResourceBundle.getProperty(context, "emxProductLineStringResource", context.getLocale(), "emxProductLine.Units.BuildStatusUnAllocated");
        ...
        while (i.hasNext()) {
            ...
            strProductName = domObj.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD + "].from.id");
