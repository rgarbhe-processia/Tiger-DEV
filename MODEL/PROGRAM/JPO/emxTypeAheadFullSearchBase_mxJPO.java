...
/**
 * emxTypeAheadFullSearchBase.java Copyright (c) 2006-2015 Dassault Systemes. All Rights Reserved. This program contains proprietary and trade secret information of MatrixOne, Inc. Copyright notice is
...
public class emxTypeAheadFullSearchBase_mxJPO extends emxTypeAhead_mxJPO {
    ...
    public String getTypeSearchResults(Context context, String[] args) throws Exception {
        ...
        // Inclusion and Exclusion list are encoded in adjustTypeField (UIFormCommon.java) if typeField!=null and should be decoded here inorder to separate the types passed in the exclusion or
        // inclusion list using ",".
        ...
        if (typeList.size() < 1) {
            ...
            String displayText = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", new Locale(languageStr), "emxFramework.TypeAheadFullTextSearch.NoResultsFound");
    ...
    /**
     * This method is used to sort maplist based on urlParameter - sortColumnName, sortDirection The default value for sortDirection is ascecnding Method added for - IR-154100
     * @param context
     * @param objects
     * @throws Exception
     */
    ...
    /**
     * This method is used to get "Sort Type" setting present on the column of TypeAhead table and return the type string, which will further be used for selection sorting algorithm. Method added for
     * - IR-154100
     * @param sortColumMap
     * @return
     */
    ...
    public MapList searchObjects(Context context, String[] args) throws Exception {
        String charTyped = (args != null) ? (String) JPO.unpackArgs(args) : "*";
