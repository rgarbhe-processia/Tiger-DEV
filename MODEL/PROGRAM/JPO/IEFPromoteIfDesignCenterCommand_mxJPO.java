...
/**
 ** IEFPromoteIfDesignCenterCommand.java Copyright Dassault Systemes, 1992-2007. All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systemes and its
 ** subsidiaries, Copyright notice is precautionary only and does not evidence any actual or intended publication of such programimport java.util.*;
 **/
...
public class IEFPromoteIfDesignCenterCommand_mxJPO {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        ...
        if (operatedObjectIds.contains(objectId))
            ...
            if (!strContextUser.equals(sOwnerName) && !userRole.contains(vplmProjectLeader)) {
            ...
            if (event.equals("Promote") && !operatedObjectIds.contains(objectId)) {
                ...
                Hashtable JPOResultData = promoteDemoteHelper.executePromote(context, globalConfigObj, localConfigObject, serverGeneralUtil, util, serverResourceBundle, integrationName, objectId,
                        logger);
            ...
            } else if ((event.equals("Demote") && !isFinalized)) {
                ...
                MCADServerException.createException(serverResourceBundle.getString("mcadIntegration.Server.Message.CannotPerformAction"), null);
            }
        } else {
            MCADServerException.createException(serverResourceBundle.getString("mcadIntegration.Server.Message.CannotPerformAction"), null);
        }
    ...
    private void promoteDemoteConnectedObjects(Context context, ArrayList connectedObjectIdList, MCADGlobalConfigObject globalConfigObj, MCADMxUtil util, String event, String currentState)
            throws Exception {
        String MAJOR_BUS_ID = "";
