 ...
 */
public class emxSortFileSummaryTableFileNameColumnBase_mxJPO extends emxSortHTMLAnchorElement_mxJPO {
    ...
    public int compare(Object object1, Object object2) {
         ...
         */
        int diff = str1Empty && str2Empty ? 0 : str1Empty ? -1 : str2Empty ? 1 : compareAnchorDataPart(getFileNameAnchorPart(stringValue1), getFileNameAnchorPart(stringValue2));
    ...
    private String getFileNameAnchorPart(String string) {
        ...
        /**
         * this data will be in the form of <nobr>
         ...
         * <a href= "JavaScript:showModalDialog('emxSuiteDirectory=components', '700', '600', 'false', 'popup', '')">ntuser.dat.LOG</a> </nobr> This method will return
