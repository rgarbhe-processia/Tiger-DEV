...
/*
 * emxMSOIMigrationBase.java program migrates the data into Common Document model i.e. to 10.5 schema.
 *
...
public class emxMSOIMigrationBase_mxJPO {
    ...
    // </Changes>
    /*
     * static int minRange = 0; static int maxRange = 0;
     */
    ...
    static String SELECT_LINE_ITEM_SPLIT_RFQ_STATE = "to[" + DomainObject.RELATIONSHIP_REFERENCE_DOCUMENT + "].from.to[" + DomainObject.RELATIONSHIP_LINE_ITEM_SPLIT + "].from.to["
            + DomainObject.RELATIONSHIP_LINE_ITEM + "].from.current";
    ...
    static String SELECT_ECR_RFQ_QUOTATION_STATE = "to[" + DomainObject.RELATIONSHIP_REFERENCE_DOCUMENT + "].from.to[" + DomainObject.RELATIONSHIP_ECR_REFERENCE + "].from.to["
            + DomainObject.RELATIONSHIP_SUPPLIER_LINE_ITEM + "].from.current";
     ...
     * @grade 0
     */
    public emxMSOIMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            for (i = minRange; i <= maxRange; i++) {
                try {
                    ...
                    logWarning("<<< Time taken for migration of objects in file in milliseconds :" + documentDirectory + "MSOIdocumentobjectids_" + i + ".txt" + ":="
    ...
    private void logWarning(String message, Map map) throws Exception {
        writer.write("!!! WARNING !!! Object TNRV = " + map.get(DomainObject.SELECT_TYPE) + " " + map.get(DomainObject.SELECT_NAME) + " " + map.get(DomainObject.SELECT_REVISION) + " "
                + map.get(DomainObject.SELECT_VAULT) + "\n" + " Id:" + map.get(DomainObject.SELECT_ID) + "\n");
        writer.write("Above Object has Following warning \n" + message + "\n");
        writer.flush();

        warningLog.write("!!! WARNING !!! Object TNRV = " + map.get(DomainObject.SELECT_TYPE) + " " + map.get(DomainObject.SELECT_NAME) + " " + map.get(DomainObject.SELECT_REVISION) + " "
                + map.get(DomainObject.SELECT_VAULT) + "\n" + " Id:" + map.get(DomainObject.SELECT_ID) + "\n");
