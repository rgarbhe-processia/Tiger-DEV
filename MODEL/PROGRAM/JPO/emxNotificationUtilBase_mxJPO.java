...
public class emxNotificationUtilBase_mxJPO extends emxUtil_mxJPO {
    ...
    public emxNotificationUtilBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    /**
     * This method creates a mail notification based on an object id. Only use this method if invoking from beans.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: objectId - a String holding the id of an object to be used for evaluating selects embedded in the subject and message strings
     *            notificationName - a String holding the name of the Notification object payload - a Map containing information to pass on to helper JPO methods
     * @return an int 0 status code
     * @throws Exception
     *             if the operation fails
     * @since AEF 11.0.0.0
    ...
    public static int objectNotificationFromMap(Context context, String[] args) throws Exception {
        ...
        objectNotification(context, (String) map.get("objectId"), (String) map.get("notificationName"), (Map) map.get("payload"));
        return 0;
    }

    /**
     * This method creates a mail notification based on an object id. Only use this method if calling from triggers or tcl.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId - a String holding the id of an object to be used for evaluating selects embedded in the subject and message strings notificationName -
     *            a String holding the name of the Notification object
     * @return an int 0 status code
     * @throws Exception
     *             if the operation fails
     * @since AEF 11.0.0.0
    ...
    public static int objectNotification(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < args.length && UIUtil.isNotNullAndNotEmpty(args[i]); i++) {
            payLoad.put("args_" + i, args[i]);
        }
        objectNotification(context, objectId, notificationName, payLoad);
        return 0;
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            a String holding the id of an object to be used for evaluating selects embedded in the subject and message strings
     * @param notificationName
     *            a String holding the name of the Notification object
     * @param payload
     *            a Map containing information to pass on to helper JPO methods
     * @throws Exception
     *             if the operation fails
     * @since AEF 11.0.0.0
     */

    public static void objectNotification(Context context, String objectId, String notificationName, Map payload) throws Exception {
    ...
    /**
     * This method creates a mail notification based on a relationship id. Only use this method if invoking from beans.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: relId - a String holding the id of a relationship to be used for evaluating selects embedded in the subject and message strings
     *            notificationName - a String holding the name of the Notification object payload - a Map containing information to pass on to helper JPO methods
     * @return an int 0 status code
     * @throws Exception
     *             if the operation fails
    ...
    public static int relationshipNotificationFromMap(Context context, String[] args) throws Exception {
        ...
        relationshipNotification(context, (String) map.get("relId"), (String) map.get("notificationName"), (Map) map.get("payload"));
        return 0;
    }

    /**
     * This method creates a mail notification based on a relationship id. Only use this method if calling from triggers or tcl.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: relId - a String holding the id of a relationship to be used for evaluating selects embedded in the subject and message strings notificationName
     *            - a String holding the name of the Notification object
     * @return an int 0 status code
     * @throws Exception
     *             if the operation fails
    ...
    public static int relationshipNotification(Context context, String[] args) throws Exception {
        if (args == null || args.length < 2) {
            throw (new IllegalArgumentException());
        }
        int index = 0;
     ...
     *            the eMatrix <code>Context</code> object
     * @param relId
     *            a String holding the id of a relationship to be used for evaluating selects embedded in the subject and message strings
     * @param notificationName
     *            a String holding the name of the Notification object
     * @param payload
     *            a Map containing information to pass on to helper JPO methods
    ...
    public static void relationshipNotification(Context context, String relId, String notificationName, Map payload) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param id
     *            a String holding the id of an object or relationship to be used for evaluating selects embedded in the subject and message strings
     * @param idType
     *            a String set to either "object" or "relationship"
     * @param notificationName
     *            a String holding the name of the Notification object
     * @param payload
     *            a Map containing information to pass on to helper JPO methods
    ...
    public static void objectRelationshipNotification(Context context, String id, String idType, String notificationName, Map payload) throws Exception {
        ...
        for (int j = 0; j < notificationWithSelectList.size(); j++) {
            ...
            if (bows.getSelectData((String) _sl.elementAt(0)).compareTo(_stateActive) == 0) {
                ...
                /*
                 * From the Tolist obtained search to get the pipe(|) delimitors so as to list the personList based on their notification type. The convention follwed here is, all the persons in the
                 * tolist upto the 1st pipe are the person to be notified through Email and in between 1st pipe and 2nd pipe are the persons to be notified throug IconMail and persons follwing the 2nd
                 * pipe are to be notified through both(Email and IconMail) the ways
                 */
                ...
                if (finalToEmailList.size() > 0 || finalCcEmailList.size() > 0 || finalBccEmailList.size() > 0) {
                    sendNotification(context, id, idType, notificationName, payload, finalToEmailList, finalCcEmailList, finalBccEmailList, subjectKey, messageKey, messageHTMLKey, finalIdList,
                            basePropFile, urlSuffix, from, replyTo, preprocessJPOMethod, email);
                }
                ...
                if (finalToIconMailList.size() > 0 || finalCcIconMailList.size() > 0 || finalBccIconMailList.size() > 0) {
                    sendNotification(context, id, idType, notificationName, payload, finalToIconMailList, finalCcIconMailList, finalBccIconMailList, subjectKey, messageKey, messageHTMLKey,
                            finalIdList, basePropFile, urlSuffix, from, replyTo, preprocessJPOMethod, iconMail);
                }
    ...
    /**
     * This method creates one or more mail notification based on an object id. The object id passed in will be expanded to get parent id's. The parent ids will be used to create mail notifications.
     * Only use this method if calling from triggers or tcl.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId - id of an object that we want to expand. From this we will check the ids from the expand to be used for evaluating selects embedded in
     *            the subject and message strings notificationName - a String holding the name of the Notification object relationshipPattern - relationship to expand on typePattern - type to expand
     *            to toDirection - expand to direction fromDirection - expand from direction
     * @return an int 0 status code
     * @throws Exception
     *             if the operation fails
     * @since AEF R211
    ...
    public static int objectParentsNotification(Context context, String[] args) throws Exception {
        if (args == null || args.length < 2) {
            throw (new IllegalArgumentException());
        }
        int index = 0;
        ...
        // expand from parent
        MapList mapList = domainObject.getRelatedObjects(context, // context.
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: objectId - a String holding the id of an object to be used for evaluating selects embedded in the subject and message strings, and also to
     *            send with the notification toList - a StringList containing the list of users to notify ccList - a StringList containing the list of users to cc subjectKey - a String that contains
     *            the notification subject key messageKey - a String that contains the notification message key objectIdList - a StringList containing select clauses evaluated to send objects with the
     *            notification basePropFileName - a String holding the property file to search for keys toSelectList - a StringList containing select clauses evaluated to expand the list of users to
     *            notify ccSelectList - a StringList containing select clauses evaluated to expand the list of users to cc filter - a String holding an expression used to determine if the notification
     *            should be sent urlSuffix - a String holding a suffix to be appended to the embedded URL fromAgent - a String holding the from user appearing in the mail messageJPOMethod - a String
     *            holding the JPO name and method name (colon delimited) used to append to the message filterJPOMethod - a String holding the JPO name and method name (colon delimited) used to filter
     * @return an int 0 status code
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.0.0
    ...
    public static int createNotificationFromMap(Context context, String[] args) throws Exception {
        ...
        createNotification(context, (String) map.get("objectId"), (StringList) map.get("toList"), (StringList) map.get("ccList"), (String) map.get("subjectKey"), (String) map.get("messageKey"),
                (StringList) map.get("objectIdList"), (String) map.get("basePropFileName"), (StringList) map.get("toSelectList"), (StringList) map.get("ccSelectList"), (String) map.get("filter"),
                (String) map.get("urlSuffix"), (String) map.get("fromAgent"), (String) map.get("messageJPOMethod"), (String) map.get("filterJPOMethod"));
        return 0;
    }

    /**
     * This method creates a mail notification for the specified users. Only use this method if calling from triggers or tcl, otherwise use the method createNotificationFromMap().
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId - a String holding the id of an object to be used for evaluating selects embedded in the subject and message strings, and also to send
     *            with the notification if no idSelectList given toList - a semicolon separated list of users to notify ccList - a semicolon separated list of users to cc subjectKey - a String that
     *            contains the notification subject key messageKey - a String that contains the notification message key basePropName - a String the property file to search for keys toSelectList - a
     *            semicolon separated list containing select clauses evaluated to expand the list of users to notify ccSelectList - a semicolon separated list containing select clauses evaluated to
     *            expand the list of users to cc filter - a String holding an expression used to determine if the notification should be sent urlSuffix - a String holding a suffix to be appended to
     *            the embedded URL fromAgent - a String holding the from user appearing in the mail idSelectList - a semicolon separated list containing select clauses evaluated to send objects with
     *            the notification messageJPOMethod - a String holding the JPO name and method name (colon delimited) used to append to the message filterJPOMethod - a String holding the JPO name and
     *            method name (colon delimited) used to filter
     * @return an int 0 status code
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.0.0
    ...
    public static int createNotification(Context context, String[] args) throws Exception {
        if (args == null || args.length < 1) {
            throw (new IllegalArgumentException());
        }
        int index = 0;
        ...
        createNotification(context, objectId, toList, ccList, subjectKey, messageKey, idSelectList, basePropName, toSelectList, ccSelectList, filter, urlSuffix, fromAgent, messageJPOMethod,
                filterJPOMethod);
        return 0;
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            a String holding the id of an object to be used for evaluating selects embedded in the subject and message strings, and also to send with the notification if no idSelectList given
     * @param toList
     *            a StringList that contains the list of users to notify
     * @param ccList
     *            a StringList that contains the list of users to cc
     * @param subjectKey
     *            a String that contains the notification subject key
     * @param messageKey
     *            a String that contains the notification message key
     * @param idSelectList
     *            a StringList containing select clauses evaluated to send objects with the notification
     * @param basePropFile
     *            String that is used for the name of property files to search for keys.
     * @param toSelectList
     *            a StringList containing select clauses evaluated to expand the list of users to notify
     * @param ccSelectList
     *            a StringList containing select clauses evaluated to expand the list of users to cc
     * @param filter
     *            a String holding an expression used to determine if the notification should be sent
     * @param urlSuffix
     *            a String holding a suffix to be appended to the embedded URL
     * @param fromAgent
     *            a String holding the from user appearing in the mail
     * @param messageJPOMethod
     *            a String holding the JPO name and method name (colon delimited) used to append to the message
     * @param filterJPOMethod
     *            a String holding the JPO name and method name (colon delimited) used to filter
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.0.0
     */

    public static void createNotification(Context context, String objectId, StringList toList, StringList ccList, String subjectKey, String messageKey, StringList idSelectList, String basePropFile,
            StringList toSelectList, StringList ccSelectList, String filter, String urlSuffix, String fromAgent, String messageJPOMethod, String filterJPOMethod) throws Exception {

        // Evaluate filter to determine if email should be sent
        if (filter != null && !filter.equals("") && objectId != null && !objectId.equals("")) {
        ...
        String from = "";
        if (fromAgent != null && fromAgent.trim().length() > 0 && fromAgent.startsWith("$<person_")) {
            from = substituteValues(context, fromAgent);
        } else {
        ...
        if (filterJPOMethod != null && !"".equals(filterJPOMethod.trim())) {
            ...
            try {
                ...
                System.out.println("exception trying to invoke filter JPO method: " + e.toString());
            }
            if (status != 0) {
                return;
            }
        ...
        sendNotification(context, objectId, finalToList, finalCcList, null, subjectKey, messageKey, finalIdList, basePropFile, urlSuffix, from, messageJPOMethod);
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            String contains id of the object used to evaluate embedded select clauses in the subject and message
     * @param toList
     ...
     *            String that is used for the name of property files to search for keys
     * @param urlSuffix
     *            String that contains additional info to append to embedded URLs
     * @param fromAgent
     *            a String holding the from user appearing in the mail
     * @param messageJPOMethod
     *            - a String holding the JPO name and method name (colon delimited) used to append to the message
    ...
    public static void sendNotification(Context context, String objectId, StringList toList, StringList ccList, StringList bccList, String subjectKey, String messageKey, StringList objectIdList,
            String basePropFile, String urlSuffix, String fromAgent, String messageJPOMethod) throws Exception {
        ...
        while (itr.hasNext()) {
            ...
            subject = getMessage(context, objectId, subjectKey, locale, basePropFile);
            ...
            while (vcItr.hasNext()) {
                locale = vcItr.next();
                message.append(getMessage(context, objectId, messageKey, locale, basePropFile));
                ...
                if (messageJPOMethod != null && !"".equals(messageJPOMethod.trim())) {
                    ...
                    try {
                        ...
                        Class[] types = new Class[] { context.getClass(), StringList.class, Locale.class, String.class, String.class, String.class };
                        Method method = jpo.getMethod(methodName, types);

                        Object[] args = new Object[] { context, objectIdList, locale == null ? getLocale(context) : locale, basePropFile, baseURL, urlSuffix };
     ...
     * @param messageKey
     *            String that contains the notification message key
     * @param messageHTMLKey
     *            a String that contains the notification HTML message key
     * @param objectIdList
     *            StringList that contains the ids of objects to send with the notification
     * @param basePropFile
     *            String that is used for the name of property files to search for keys
     ...
     *            a String holding the from user appearing in the mail
     * @param replyTo
     *            a StringList containing select clauses evaluated to fill out the replyTo user and personal information
     * @param preprocessJPOMethod
     *            a String holding the JPO name and method name (colon delimited) used to append to the message
     * @throws Exception
     *             if the operation fails
     * @since AEF 11.0.0.0
    ...
    protected static void sendNotification(Context context, String id, String idType, String notificationName, Map payload, StringList toList, StringList ccList, StringList bccList, String subjectKey,
            String messageKey, String messageHTMLKey, StringList objectIdList, String basePropFile, String urlSuffix, String fromAgent, StringList replyTo, String preprocessJPOMethod)
            throws Exception {
        // Call the overloaded sendNotification with notification type as Both
        sendNotification(context, id, idType, notificationName, payload, toList, ccList, bccList, subjectKey, messageKey, messageHTMLKey, objectIdList, basePropFile, urlSuffix, fromAgent, replyTo,
                preprocessJPOMethod, both);
    }
     ...
     *            a String holding the JPO name and method name (colon delimited) used to append to the message
     * @param notifyType
     *            Notification Type selected by user (email, iconmail, or both)
     * @throws Exception
     *             if the operation fails
     * @since x+2
     */
        ...
        while (itr.hasNext()) {
            ...
            while (vcItr.hasNext()) {
                ...
                if ((notifyType.equalsIgnoreCase(email))
                        && (fromAgent.equalsIgnoreCase(subscriptionAgent) || (replyTo != null && ((String) replyTo.elementAt(0)).equalsIgnoreCase(subscriptionAgent)))) {
                    bcc.addAll(to);
                    bcc.addAll(cc);
                    to.clear();
                    cc.clear();
                ...
                if (preprocessJPOMethod != null && preprocessJPOMethod.length() > 0) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            System.out.println("Exception trying to invoke method " + methodName + " of JPO " + name + " ERROR: " + e.toString());
                        }
                    } catch (Exception e) {
            ...
            while (itrFreq.hasNext()) {
                ...
                if (toFreq.size() > 0 || ccFreq.size() > 0 || bccFreq.size() > 0) {
                    ...
                    if (frequency.equalsIgnoreCase("immediately")) {
                        sendJavaMail(context, toFreq, ccFreq, bccFreq, subject, messageText, messageHTML, fromAgent, replyTo, objectIdList, notifyType);
                    } else {
                        MapList spools;
                        ...
                        if (spools != null && spools.size() > 0) {
                            spoolJavaMail(context, toFreq, ccFreq, bccFreq, subject, messageText, messageHTML, fromAgent, replyTo, objectIdList, notifyType, notificationName, spools);
                        } else {
                            sendJavaMail(context, toFreq, ccFreq, bccFreq, subject, messageText, messageHTML, fromAgent, replyTo, objectIdList, notifyType);
                        }
                    }
    ...
    private static MapList getSpools(Context context, String notificationName) throws Exception {
        ...
        selects.add("id");
        MapList notifications = DomainObject.findObjects(context, PropertyUtil.getSchemaProperty(context, "type_Notification"), PropertyUtil.getSchemaProperty(context, "vault_eServiceAdministration"),
        ...
        if (notifications.size() > 0) {
            ...
            try {
                ...
                spools = notification.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_NotificationSpool"), // rel type
    ...
    private static MapList getSpool(Context context, String spoolName) throws Exception {
        ...
        try {
            ...
            selects.add("id");
            spool = DomainObject.findObjects(context, PropertyUtil.getSchemaProperty(context, "type_NotificationSpool"), spoolName, "*", "*", "*", "attribute[Enable For Preference]==TRUE", false,
                    selects);
        } catch (Exception e) {
            throw new MatrixException(e);
        } finally {
    ...
    /**
     * This method spools a mail notification to the specified users. Sometime later the spooled messages can be consolidated and sent.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param to
     *            StringList that contains the list of users to notify
     ...
     * @param messageHTML
     *            a String that contains the notification HTML message
     * @param fromAgent
     *            a String holding the from user appearing in the mail
     * @param replyTo
     *            a StringList containing the replyTo user and personal information
     * @param objectIdList
     *            StringList that contains the ids of objects to send with the notification
     * @param notifyType
     *            Notification Type selected by user (email, iconmail, or both)
    ...
    private static void spoolJavaMail(Context context, StringList to, StringList cc, StringList bcc, String subject, String messageText, String messageHTML, String fromAgent, StringList replyTo,
            StringList objectIdList, String notifyType, String notificationName, MapList spools) throws Exception {
        ...
        attrType = new AttributeType(PropertyUtil.getSchemaProperty(context, "attribute_StaticToList"));
        ...
        attrType = new AttributeType(PropertyUtil.getSchemaProperty(context, "attribute_StaticCcList"));
        buf.delete(0, buf.length());
        if (cc != null) {
            int count = 0;
        ...
        attrType = new AttributeType(PropertyUtil.getSchemaProperty(context, "attribute_StaticBccList"));
        buf.delete(0, buf.length());
        if (bcc != null) {
            int count = 0;
        ...
        attrType = new AttributeType(PropertyUtil.getSchemaProperty(context, "attribute_SubjectText"));
        attrObject = new Attribute(attrType, subject);
        attributes.addElement(attrObject);

        attrType = new AttributeType(PropertyUtil.getSchemaProperty(context, "attribute_BodyText"));
        attrObject = new Attribute(attrType, XSSUtil.encodeForHTML(context, messageText));
        attributes.addElement(attrObject);

        attrType = new AttributeType(PropertyUtil.getSchemaProperty(context, "attribute_BodyHTML"));
        attrObject = new Attribute(attrType, messageHTML);
        attributes.addElement(attrObject);

        attrType = new AttributeType(PropertyUtil.getSchemaProperty(context, "attribute_FromAgent"));
        attrObject = new Attribute(attrType, fromAgent);
        attributes.addElement(attrObject);

        attrType = new AttributeType(PropertyUtil.getSchemaProperty(context, "attribute_ReplyTo"));
        buf.delete(0, buf.length());
        if (replyTo != null) {
            int count = 0;
        ...
        attrType = new AttributeType(PropertyUtil.getSchemaProperty(context, "attribute_Attachments"));
        buf.delete(0, buf.length());
        ...
        attrType = new AttributeType(PropertyUtil.getSchemaProperty(context, "attribute_NotificationType"));
        attrObject = new Attribute(attrType, notifyType);
        attributes.addElement(attrObject);

        attrType = new AttributeType(PropertyUtil.getSchemaProperty(context, "attribute_NotificationName"));
        ...
        while (spoolItr.hasNext()) {
            ...
            RelationshipType relType = new RelationshipType(PropertyUtil.getSchemaProperty(context, "relationship_NotificationRequest"));
            ...
            try {
                ContextUtil.pushContext(context);
                isContextPushed = true;
                Relationship rel = spool.addRelatedObject(context, relType, true, // isFrom
                        spoolId);
     ...
     *            StringList that contains the list of users to bcc
     * @param subject
     *            String that contains the subject
     * @param messageText
     *            String that contains the message in plain text
     * @param messageHTML
     *            String that contains the message in HTML format
     * @param fromAgent
     *            a String holding the from user appearing in the mail
     * @param replyTo
     *            a StringList holding the replyTo user and personal info appearing in the mail
     * @throws Exception
     *             if the operation fails
     * @since AEF 11.0.0.0
     */

    public static void sendJavaMail(Context context, StringList toList, StringList ccList, StringList bccList, String subject, String messageText, String messageHTML, String fromAgent,
            StringList replyTo) throws Exception {
        // send notifications through both Email and IconMail
        sendJavaMail(context, toList, ccList, bccList, subject, messageText, messageHTML, fromAgent, replyTo, null, both);
    }
    ...
    public static void sendJavaMail(Context context, StringList toList, StringList ccList, StringList bccList, String subject, String messageText, String messageHTML, String fromAgent,
            StringList replyTo, StringList objectIdList, String notifyType) throws Exception {
    ...
    protected static void sendMail(Context context, StringList toList, StringList ccList, StringList bccList, String subject, String message, StringList objectIdList, String fromAgent)
            throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            a String contains id of the object
     * @param messageKey
     *            the notification message key
     * @param locale
     *            the locale used to determine language
     * @param basePropFileName
     *            used to identify property file.
    ...
    protected static String getMessage(Context context, String objectId, String messageKey, Locale locale, String basePropFileName) throws Exception {
     ...
     *            a String contains id of the object
     * @param messageKey
     *            the notification message key or string
     * @param formatArgs
     *            an array of message place holder values
     * @param locale
     *            the locale used to determine language
     * @param basePropFileName
     *            used to identify property file if key given
     * @return a String containing the message
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.0.0
    ...
    protected static String getMessage(Context context, String objectId, String messageKey, Object[] formatArgs, Locale locale, String basePropFileName) throws Exception {
    ...
    protected static String getMessage(Context context, String id, String idType, String messageKey, Locale locale, String basePropFileName) throws Exception {
    ...
    protected static String getMessage(Context context, String id, String idType, String messageKey, Object[] formatArgs, Locale locale, String basePropFileName) throws Exception {
        ...
        if (basePropFileName == null || basePropFileName.equals("")) {
            ...
            message = MessageUtil.getString(basePropFileName, messageKey, null, locale);
        }
     ...
     *            the eMatrix <code>Context</code> object
     * @param expression
     *            the string containing embedded selectables
     * @return the evaluated result
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.0.0
     */
    protected static String substituteValues(Context context, String expression) throws Exception {
        return (substituteValues(context, expression, null, null));
    }

    /**
     * Replace object selectables embedded in a string with their values based on the given object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param expression
     *            the string containing embedded selectables
     * @param objectId
     *            the id of the object used to evaluate the selectables
     * @param language
     *            the string containing a language for i18n of type and vault
     * @return the evaluated result
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.0.0
    ...
    protected static String substituteValues(Context context, String expression, String objectId, String language) throws Exception {
        return substituteValues(context, expression, objectId, OBJECT, language);
    }

    /**
     * Replace selectables embedded in a string with their values based on the given object or relationship.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param expression
     *            the string containing embedded selectables
    ...
    protected static String substituteValues(Context context, String expression, String id, String idType, String language) throws Exception {
        try {
            ...
            if (language != null) {
                ...
                for (int i = 0; i < selects.size(); i++) {
                    if (((String) selects.get(i)).equalsIgnoreCase("type")) {
                        StringList selectValueList = (StringList) selectMap.get(selects.get(i));
                        String selectValue = (String) selectValueList.firstElement();
                        String selectProp = "emxFramework.Type." + selectValue.replace(' ', '_');
                    ...
                    } else if (((String) selects.get(i)).equalsIgnoreCase("vault")) {
                        StringList selectValueList = (StringList) selectMap.get(selects.get(i));
                        String selectValue = (String) selectValueList.firstElement();
                        String selectProp = "emxFramework.Vault." + selectValue.replace(' ', '_');
                        String selectPropValue = EnoviaResourceBundle.getFrameworkStringResourceProperty(context, selectProp, new Locale(language));
                        selectValueList.setElementAt(selectPropValue, 0);
                        selectMap.put(selects.get(i), selectValueList);
                    } else if (((String) selects.get(i)).equalsIgnoreCase("current")) {
                        DomainObject dom = DomainObject.newInstance(context, id);
                        StringList selectValueList = (StringList) selectMap.get(selects.get(i));
                        String selectValue = (String) selectValueList.firstElement();
                        String selectProp = "emxFramework.State." + dom.getPolicy(context).getName().replace(' ', '_') + "." + selectValue.replace(' ', '_');
                        String selectPropValue = EnoviaResourceBundle.getFrameworkStringResourceProperty(context, selectProp, new Locale(language));
                        selectValueList.setElementAt(selectPropValue, 0);
                        selectMap.put(selects.get(i), selectValueList);
                    }
    ...
    /**
     * Given an expression, replace all of the symbolic references with their real values.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param expression
     *            the expression containing the symbolic references
     * @return the evaluated result
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.0.0
    ...
    protected static String replaceSymbolicTokens(Context context, String expression) throws Exception {
    ...
    /**
     * Lookup a symbolic token and return the real value. If the token can't be found, return the original token.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param symbolicToken
     *            the token to lookup
     ...
     *            the eMatrix <code>Context</code> object
     * @param message
     *            the message containing format information
     * @param formatArgs
     *            array of replacement values for the message
     * @param locale
     *            the locale used to determine language
    ...
    protected static String substituteMessageArgs(Context context, String message, Object[] formatArgs, Locale locale) throws Exception {
    ...
    /**
     * Get information regarding a given business object. The map that is returned contains all StringList entries. This ensures that multiple values are handled. This also means for a single value
     * you need to extract the first element on the StringList.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            the id of the given object
     * @param objectSelects
     *            the eMatrix <code>StringList</code> object that holds the list of object selectables
     * @return Map containing information about the object based on selectables
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.0.0
     */
    protected static Map getInfo(Context context, String objectId, StringList objectSelects) throws Exception {
        return getInfo(context, objectId, OBJECT, objectSelects);
    }

    /**
     * Get information regarding a given business object or relationship. The map that is returned contains all StringList entries. This ensures that multiple values are handled. This also means for a
     * single value you need to extract the first element on the StringList.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param id
     *            a String holding the id of an object or relationship to be used for evaluating selects embedded in the subject and message strings
     ...
     *            a String set to either "object" or "relationship"
     * @param selects
     *            the eMatrix <code>StringList</code> object that holds the list of selectables
    ...
    protected static Map getInfo(Context context, String id, String idType, StringList selects) throws Exception {
        ...
        if (idType.equalsIgnoreCase(OBJECT)) {
            ...
            String[] relIdList = { id };
            RelationshipWithSelectList relWSelList = Relationship.getSelectRelationshipData(context, relIdList, selects);
            RelationshipWithSelectItr relWSelItr = new RelationshipWithSelectItr(relWSelList);
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectIdList
     *            the idList for which the message needs to be returned
     * @param locale
     *            the Locale object
     * @param basePropFile
     *            the name of the property file in which the notification keys are defined
     * @param baseURL
     *            the URL link to the corresponding inbox task
     * @param urlSuffix
     *            the Suffix that needs to be appended with the url
    ...
    public static String getNotificationMessageForInboxTask(Context context, StringList objectIdList, Locale locale, String basePropFile, String baseURL, String urlSuffix) throws Exception {
     ...
     *            a Map containing information to pass on to helper JPO methods
     * @param filter
     *            a String holding the filter expression or "JPO <jponame>:<methodname>"
    ...
    protected static int evaluateFilter(Context context, String id, String idType, String notificationName, Map payload, String filter) throws Exception {
        int status = 0;
        if (filter != null && !filter.equals("")) {
            if (filter.startsWith("JPO")) {
                ...
                if (id != null && !id.equals("")) {
                    ...
                    command.append("$2");
                    String filterResult = MqlUtil.mqlCommand(context, command.toString(), expression, id);
                    if (filterResult.startsWith("FALSE")) {
                        status = 1;
                    }
                }
     ...
     * @param value
     *            a String holding the delimited list of items
    ...
    protected static StringList inputListOrJPOToStringList(Context context, String id, String idType, String notificationName, Map payload, String value) throws Exception {
     ...
     *            a Map containing information to pass on to helper JPO methods
     * @param value
     *            a String holding the given value
    ...
    protected static String inputOrJPOToString(Context context, String id, String idType, String notificationName, Map payload, String value) throws Exception {
     ...
     *            a Map containing information to pass on to helper JPO methods
     * @param urls
     *            a String of urls to append to the results
    ...
    protected static String inputOrJPOTolocalizedString(Context context, String value, Map info, String urls) throws Exception {
        ...
        if (value != null && value.length() > 0) {
            if (value.startsWith("JPO")) {
                ...
                results.append(getMessage(context, (String) info.get("id"), (String) info.get("idType"), value, (Locale) info.get("locale"), (String) info.get("bundleName")));
     ...
     *            a String set to either "object" or "relationship"
     * @param list
     *            a StringList holding the static values
     * @param selects
     *            a StringList holding the dynamic values
     * @param userListMode
     *            a boolean set to true if evaluated selects generate lists of users
    ...
    protected static StringList combineStaticAndDynamicLists(Context context, String id, String idType, StringList list, StringList selects, boolean userListMode) throws Exception {
            ...
            if (selects != null && selects.size() > 0) {
                ...
                while (itr.hasNext()) {
                    ...
                    if (result != null) {
                        ...
                        while (itr2.hasNext()) {
                            if (userListMode) {
                                StringTokenizer tokens = new StringTokenizer((String) itr2.next(), USER_LIST_DELIMITER);
                                while (tokens.hasMoreTokens()) {
                                    finalList.addElement(tokens.nextToken().trim());
                                }
                            } else {
     ...
     *            the eMatrix <code>Context</code> object
     * @param userList
     *            contains the list of the users along with notification type in <person>|<notification type>
     * @return HashMap a containing 'Email', 'IconMail' and 'Both' keys that represent Notification Type and has list of persons as their values
     * @throws Exception
     *             if the operation fails
     * @since X+2
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Contains Long value
     * @return an int 0 for success and non-zero for failure
     * @throws Exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param names
     *            from the list along with notification frequency preference will be added to this map
     * @param frequencies
     *            notification frequency preferences will be added to this map
     * @param list
     *            the list of recipients
     * @since AEF R213
     */

    protected static void getNamesAndFrequencyPreferences(Context context, HashMap<String, String> nameAndFrequency, final StringList names) {
        if (names != null) {
     ...
     * @param list
     *            the list of recipients
     * @param nameAndFrequency
     *            map of key names and value frequency
     * @param frequency
     *            String holds the frequency we are filtering on
     * @return a StringList contains list of recipients expecting a notification in the given time frame
     * @since R213
     */

    protected static StringList getNamesForFrequency(final StringList list, final HashMap<String, String> nameAndFrequency, final String frequency) {
    ...
    /**
     * Called when showing preference choices. Used in AEFEmailNotificationPreference command, "Access Program" and "Access Function" properties.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
