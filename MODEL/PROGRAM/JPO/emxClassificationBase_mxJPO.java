 ...
 * evidence any actual or intended publication of such program static const RCSID [] = "$Id: ${CLASSNAME}.java.rca 1.10 Wed Oct 22 16:02:33 2008 przemek Experimental przemek $";
 */
...

{
    ...
    public emxClassificationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - strPartId The id of the part 1- strparentObj Id The id of the parent object 2 - strPartType The type of the part 3 - strName The name of the
     *            part 4 - strPartRevision The revision of the part 5 - strPartPolicy The policy of the part 6 - strDescription The description of the part
     * @return a Map containing the part object and boolean state whether the part exists or not
     * @throws FrameworkException
     *             if the operation fails
     */
    public static Map createAndConnectPart(Context context, String[] args) throws FrameworkException {
        try {
    ...
    public static Map createAndConnectPart(Context context, String strPartId, String strparentObjId, String strPartType, String strName, String strPartRevision, String strPartPolicy,
            String strDescription) throws FrameworkException {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - parentId is the id of the parent object 1 - childIds is the array of the child objects to be added
     * @return The string result of mql command execution
     * @throws FrameworkException
     *             if the operation fails
     */
    public static String addEndItems(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
     ...
     * @param childIds
     *            is the array of the child objects to be added
     * @return The string result of mql command execution
     * @throws FrameworkException
     *             if the operation fails
     */
    public static String addEndItems(Context context, String parentId, String[] childIds) throws FrameworkException {
        try {
            ...
            String workSpaceVault = PropertyUtil.getSchemaProperty(context, "type_ProjectVault");
    ...
    public MapList getClassificationIds(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            classificationIds = (MapList) domObj.getRelatedObjects(context, LibraryCentralConstants.RELATIONSHIP_CLASSIFIED_ITEM, // relationship pattern
    ...
    /**
     * This method returns Classification path ex. PL1 -> PF1
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     *             if the operation fails
     */
    public Vector getClassificationPath(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            while (objectListItr.hasNext()) {
                ...
                MapList parentClasses = (MapList) domObj.getRelatedObjects(context, LibraryCentralConstants.RELATIONSHIP_SUBCLASS, // relationship pattern
                        LibraryCentralConstants.QUERY_WILDCARD, // type pattern
                        selectStmts, // Object selects
                        null, // relationship selects
                        true, // from
     ...
     *             if the operation fails
     */
    public String renderPathElem(Context context, String strName, String strObjectId, String reportFormat) throws FrameworkException {
        if (reportFormat != null) {
            return strName;
        }
        /*
         * If the Library/Class name contains "&" character, we need to replace it with the code "amp;" because getXML() of BPS code base doesn't support the "&" character. IR-261969
         */
        if (strName.contains("&")) {
        ...
        /*
         * removed the encodeForHTML wrap, as it is messing up when french chars are present in the object name BPS does this again for programHTML fields inside SB code, which causing double encoding
         * IR-261969
         */
        return "<a href=\"javascript:void(0)\" onClick=\"javascript:showModalDialog('../common/emxTree.jsp?objectId=" + XSSUtil.encodeForJavaScript(context, strObjectId) + "','860','520');\" >"
                + XSSUtil.encodeForXML(context, strName) + "</a>";
    }
    ...
    public StringList getClassificationExclusionIds(Context context, String[] args) throws FrameworkException {
    ...
    public String getLibrayDynamicQuery(Context context, String args[]) throws Exception {
        ...
        String dyanmicQuery = "";
        // Changes done by PSA11 start(IR-513436-3DEXPERIENCER2015x).
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments 0 - objectId 1 - rowIds 2 - ClassOID
     * @throws Exception
     *             if the operation fails
     */
    public void updateClassField(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("requestMap");
    ...
    /**
     * This method is necessary because some forms, e.g. emxForm.jsp, submit requestMaps wherein each value is an array of strings, out of which we will always want the first element. Most other forms
     * submit a string value for each param value. This method hides that difference.
     * @param valObj
     *            the string/string array
     * @returns String
     * @throws Exception
     *             if the operation fails
     */
