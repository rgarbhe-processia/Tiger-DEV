 ...
 * evidence any actual or intended publication of such program. static const char RCSID[] = "$Id: ${CLASSNAME}.java.rca 1.37 Tue Oct 28 19:04:45 2008 przemek Experimental przemek $"
 */
...
public class emxMultipleClassificationAttributeGroupBase_mxJPO implements ClassificationConstants {
     ...
     * @param args
     *            holds the following arguments: 0 - name Attribute Group name
     * @return Returns an instance of the Attribute Group, reading the vaules from database.
     * @throws exception
     *             if the operation fails
     */
    public AttributeGroup getInstance(Context context, String[] args) throws Exception {
            ...
            if (attrGrpName != null && !"null".equals(attrGrpName)) {
                ...
                if (result != null) {
                    ...
                    while (sbuf.toString().indexOf("||") > 0) {
                        sbuf.replace(sbuf.toString().indexOf("||"), (sbuf.toString().indexOf("||") + 2), "| |");
                    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments: 0 - name Attribute Group name 1 - description Attribute Group description 0 - attributes to be added to Attribute Group
     * @throws exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param name
     *            Name of the Attribute Group to be created.
     * @param description
     *            Description of the Attribute Group to be created.
     * @param attributes
     *            List of attributes that are to be added to the created Attribute Group.
     * @throws exception
     *             if the operation fails
     */
    public void create(Context context, String name, String description, StringList attributes) throws Exception {
        try {
            ...
            if (!hasLibrarianRole.booleanValue() && !isUserAgent) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param name
     *            Name of the Attribute Group to be deleted.
     * @throws exception
     *             if the operation fails
     */
    public void delete(Context context, String name) throws Exception {
        ...
        try {
            if (name != null && !name.equals("") && !"null".equals(name)) {
                ...
                throw new Exception(FrameworkProperties.getProperty("emxClassificationModule.AttributeGroup.NameIsNull"));
            }
            // Execute the command
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments: 0 - attrGrpName Attribute Group name 1 - cloneName Clone Attribute Group name 2 - cloneDescription Attribute Group description
     * @throws exception
     *             if the operation fails
     */
     ...
     *             if the operation fails
     */
    public void clone(Context context, String name, String cloneName, String cloneDescription) throws Exception {
        MQLCommand command = new MQLCommand();
        String queryCmd = "";
        try {
            if (name != null && !name.equals("") && !"null".equals(name) && cloneName != null && !cloneName.equals("") && !"null".equals(cloneName)) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments: 0 - attrGrpName Attribute Group name 1 - newName Clone new Attribute Group name 2 - newDescription Attribute Group description
     * @throws exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param attrGrpName
     *            Name of the Attribute Group to be modified.
     * @param newName
     *            New name for the Attribute Group to be modified.
     * @param newDescription
     *            New description for Attribute Group to be modified.
     * @throws exception
     *             if the operation fails
     */
    public void modify(Context context, String attrGrpName, String newName, String newDescription) throws Exception {

        String queryCmd = "";
        try {

            // generate modify statement.
            if (attrGrpName != null && !attrGrpName.equals("") && !"null".equals(attrGrpName)) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments: 0 - name Attribute Group name 1 - attributeList AttributeList that are to be added to the Attribute Group
     * @throws exception
     *             if the operation fails
     */
    public void addAttributes(Context context, String[] args) throws Exception {
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            String name = (String) paramMap.get("name");
            StringList attributeList = (StringList) paramMap.get("attributeList");
     ...
     *            the eMatrix <code>Context</code> object
     * @param name
     *            Name of the Attribute Group to which attributes to be added.
     * @param attributeList
     *            List of attributes that are to be added to the Attribute Group.
     * @throws exception
     *             if the operation fails
     */
    public void addAttributes(Context context, String name, StringList attributeList) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments: 0 - name Attribute Group name 1 - attributeList AttributeList that are to be removed to the Attribute Group\
     * @throws exception
     *             if the operation fails
     */
    public void removeAttributes(Context context, String[] args) throws Exception {
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            String name = (String) paramMap.get("name");
            StringList attributeList = (StringList) paramMap.get("attributeList");
     ...
     *            the eMatrix <code>Context</code> object
     * @param name
     *            Name of the Attribute Group to which attributes to be removed.
     * @param attributeList
     *            List of attributes that are to be removed from the Attribute Group.
     * @throws exception
     *             if the operation fails
     */
    public void removeAttributes(Context context, String name, StringList attributeList) throws Exception {
        StringBuffer queryBuffer = new StringBuffer();
        queryBuffer.append("modify interface \"$1\"");
        ...
        if (attributeList != null && attributeList.size() > 0) {
            for (int i = 0; i < attributeList.size(); i++) {
                queryBuffer.append(" remove attribute ");
                queryBuffer.append("$").append(i + 2).append(" ");
                methodArgs[i + 1] = (String) attributeList.get(i);
            }
        }
     ...
     *             if the operation fails
     */
    public String getNumberOfEndItemsWhereUsed(Context context, String[] args) throws Exception {
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            String name = (String) paramMap.get("name");
     ...
     *             if the operation fails
     */
    public String getNumberOfEndItemsWhereUsed(Context context, String attrGrpName) throws Exception {
                ...
                if (interfacesArray != null && interfacesArray.length > batchLimit) {
                    ...
                    for (int index = 0; index < interfacesArray.length; index++) {
                        ...
                        for (int j = index; j < temp; j++) {
                            ...
                            if (interfacesArray[j] != null && interfacesArray[j] != "" && !interfacesArray[j].isEmpty()) {
                                sb.append(interfacesArray[j]);
                                sb.append("|");
                            }
                        }
                        String listOfInterfaces = sb.toString().substring(0, sb.toString().lastIndexOf("|"));
                        mqlResult = MqlUtil.mqlCommand(context, queryItemsCount, "count TRUE", "*", "*", "*", strPersonDefaultVault, "interface matchlist '" + listOfInterfaces + "' '|'");
                    ...
                    // Data is not huge.
                    result = MqlUtil.mqlCommand(context, queryItemsCount, "count TRUE", "*", "*", "*", strPersonDefaultVault, "interface matchlist '" + interfaceList + "' '|'");
                    result = result.trim();
                }
            } catch (Exception ex) {
                throw ex;
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments: 0 - AGName Attribute Group name
     * @return MapList of classification which are using the Attribute Group.
     * @throws exception
     *             if the operation fails
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getClassificationsWhereUsed(Context context, String[] args) throws Exception {
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            ...
            return getClassificationsWhereUsed(context, name);
        } catch (Exception ex) {
            throw ex;
        }
    }
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getClassificationsWhereUsed(Context context, String attrGrpName) throws Exception {
        ...
        if (attrGrpName != null) {
            ...
            try {
                ...
                interfaceList = interfaceList.trim();
                if (!"".equals(interfaceList) && null != interfaceList && !"null".equals(interfaceList)) {
                    ...
                    returnList = DomainObject.findObjects(context, "Classification", null, whereClause.toString(), objectSelects);
                }
            } catch (Exception ex) {
                throw ex;
            }
     ...
     *             if the operation fails
     */
    public static StringList getMatchingAttributeGroupNames(Context context, String nameMatch) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - charSet the charchter set
     * @return MapList with list of Attribute Group details
     * @throws exception
     *             if the operation fails
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getAllAttributeGroups(Context context, String[] args) throws Exception {
     ...
     * @param args
     *            agNames list of attributes
     * @return MapList with the Attribute Group data
     * @throws exception
     *             if the operation fails
     */
    public static MapList getAttributeGroupData(Context context, StringList agNames) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param agNames
     *            Names of the attribute group whose data need to be returned
     * @return Returns a MapList, each map containing with name, description and attributes of the Attribute Group.
     * @throws exception
     *             if the operation fails
     */
    public static MapList getAttributeGroupData(Context context, StringList agNames, String nameMatches) throws Exception {
        MapList returnList = new MapList();
     ...
     *             if the operation fails
     */
    public MapList getAllAttributes(Context context, String[] args) throws Exception {
        MapList list = new MapList();
        AttributeTypeList attList = AttributeType.getAttributeTypes(context, false);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - nameMatches the string used for Attribute Name match 1 - typeFilter the string used for Attribute type match 2 - unused the string for
     *            getting unused or all Attributes
     * @return Returns a MapList with the names of the attributes
     * @throws exception
     *             if the operation fails
     */
    public MapList getAttributesByQuery(Context context, String[] args) throws Exception {
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            ...
            return getAttributesByQuery(context, nameMatches, typeFilter, unused);
        } catch (Exception ex) {
            throw ex;
        }
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param nameMatches
     *            the string used for Attribute Name match
     * @param typeFilter
     *            the string used for Attribute type match
     * @param unused
     *            the string for getting unused or all Attributes
     * @return Returns a MapList with the names of the attributes
     * @throws exception
     *             if the operation fails
     */
    public MapList getAttributesByQuery(Context context, String nameMatches, String typeFilter, boolean unused) throws Exception {
        ...
        if (unused) {
            ...
            String agAttrData = MqlUtil
                    .mqlCommand(context, agAttrCmd, true, DomainConstants.INTERFACE_CLASSIFICATION_ATTRIBUTE_GROUPS, "immediatederivative.attribute.name", "immediatederivative.attribute.owner", ",")
                    .trim();
        ...
        while (matchingAttrRowIter.hasNext()) {
            ...
            if (typeFilter != null && !typeFilter.equals("") && !typeFilter.equals("*") && !typeFilter.toUpperCase().trim().equals(type.toUpperCase().trim())) {
                continue;
            }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - uiType the UI Type 1 - languageStr the language 2 - charSet the charset 3 - objectList the Attribute Group list
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                if (!hyperlink.equals("true")) {
                    ...
                    strI18nAttributeName.append(i18nNow.getAttributeI18NString(att.getName(), strLanguageStr));
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - uiType the UI Type 1 - exportFormat the export format 2 - reportFormat the report format 3 - charSet the charset 4 - objectList the
     *            Attribute Group list
     * @return Vector list of HTML string for each Attribute Group
     * @throws exception
     *             if the operation fails
     */
    public Vector getAttributeGroupCommandName(Context context, String[] args) throws Exception {
        Vector columnValues = new Vector();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap requestValuesMap = (HashMap) programMap.get("paramList");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - uiType the UI Type 1 - exportFormat the export format 3 - charSet the charset 4 - objectList the Attribute Group list
     * @return Vector list of HTML string for each Attribute Group
     * @throws exception
     *             if the operation fails
     */
    public Vector getAttributeGroupNewWindow(Context context, String[] args) throws Exception {
        Vector columnValues = new Vector();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap requestValuesMap = (HashMap) programMap.get("paramList");
            ...
            while (itr.hasNext()) {
                ...
                if (isPrintMode) {
                    ...
                    // IR-482543-3DEXPERIENCER2015x changed below line as treeLabel=" + strEncodedName="
                    href = "emxTree.jsp?treeMenu=type_MCMAttributeGroupTreeMenu&amp;treeLabel=" + strEncodedName + "&amp;objectName=" + strEncodedName + "&amp;AppendParameters=true&amp;AGName="
                            + strEncodedName + "&amp;suiteKey=LibraryCentral";
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - uiType the UI Type 1 - objectList the list of Attribute Groups
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - objectList the list of Attribute Groups
     ...
     *             if the operation fails
     */
    public Vector getAttributeGroupAssignedStatus(Context context, String[] args) throws Exception {
        Vector columnValues = new Vector();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objList = (MapList) programMap.get("objectList");
            ...
            String isAssigned = "";
            String strLanguageStr = ((String) ((HashMap) programMap.get("paramList")).get("languageStr"));
            String strCharSet = ((String) ((HashMap) programMap.get("paramList")).get("charSet"));
            // added for the bug 318209
            /*
             * if(strCharSet == null || strCharSet.trim().equals("")) { strCharSet = "UTF8"; }
             */
            // till here
            Iterator itr = objList.iterator();
            while (itr.hasNext()) {
                ...
                try {
                    ...
                    if (result != null && !"null".equals(result) && !result.equals("")) {
                        result = result.trim();
                    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - uiType the UI Type 1 - languageStr the language
     * @return Vector list of HTML string for each Attribute Display name
     * @throws exception
     *             if the operation fails
     */
    public Vector getAttributeName(Context context, String[] args) throws Exception {
        Vector columnValues = new Vector();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objList = (MapList) programMap.get("objectList");
            ...
            while (itr.hasNext()) {
                ...
                // Changes added by PSA11 start(IR-499922-3DEXPERIENCER2015x)
                ...
                if (!strLanguageStr.contains("fr-FR")) {
                    ...
                    String attributeNameFromPropertiesFile = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", new Locale(strLanguageStr), attributeProperty);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - objectList the list of Attributes
     * @return Vector list of HTML string for each Attribute type
     * @throws exception
     *             if the operation fails
     */
    public Vector getAttributeType(Context context, String[] args) throws Exception {
        Vector columnValues = new Vector();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objList = (MapList) programMap.get("objectList");
     ...
     *             if the operation fails
     */
    public Vector getAttributeDescription(Context context, String[] args) throws Exception {
        Vector columnValues = new Vector();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objList = (MapList) programMap.get("objectList");
     ...
     *             if the operation fails
     */
    public Vector getAttributeDefaultValue(Context context, String[] args) throws Exception {
        Vector columnValues = new Vector();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objList = (MapList) programMap.get("objectList");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - objectName the ObjectName 1 - objectList the list of Attributes
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - objectName the ObjectName
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - nameMatches the name match string 1 - unused the unused string
     * @return MapList with the details of Attributes that match the criteria
     * @throws exception
     *             if the operation fails
     */
    public static MapList getAttributeGroupsByName(Context context, String[] args) throws Exception {
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            String nameMatches = (String) paramMap.get("nameMatches");
            boolean unused = ((Boolean) paramMap.get("unused")).booleanValue();
     ...
     *             if the operation fails
     */
    public static StringList getAttributeGroupsByName(Context context, String nameMatches, boolean unused) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments: 0 - attributePattern string for Attribute Pattern 1 - unused to search for unused attribute only
     * @return MapList with the details of Attributes that match the criteria
     * @throws exception
     *             if the operation fails
     */
    public static MapList getAttributeGroupsByAttribute(Context context, String[] args) throws Exception {
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
     ...
     *             if the operation fails
     */
    public static StringList getAttributeGroupsByAttribute(Context context, String attributePattern, boolean unused) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments 0 - launguagestr
     * @throws Exception
     *             if the operation fails
     */

    public HashMap getAttributeTypes(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments 0 - Attribute Name Matches 1 - Attribute Type 2 - objectId 3 - Unused Attribute
     * @throws Exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments 0 - Attribute Group Name/ Attribute 1 - Attribute Group Name Matches 2 - objectId 3 - Unused Attribute
     * @throws Exception
     *             if the operation fails
     */
    ...
    public HashMap getNameMachesList(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strIncludesAttribute = EnoviaResourceBundle.getProperty(context, "emxLibraryCentralStringResource", new Locale(languagestr),
                    "emxMultipleClassification.AttributeGroupChooser.IncludesAttribute");
            StringList fieldChoices = new StringList();
            StringList fieldDisplayChoices = new StringList();
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments 0 - objectName (Attribute Group Name)
     * @throws Exception
     *             if the operation fails
     */
    public String getAGName(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("requestMap");
     ...
     *             if the operation fails
     */
    public String getAGDescription(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        String attributeGroupName = (String) requestMap.get("objectName");
     ...
     *             if the operation fails
     */
    public String getAGOriginatedDate(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        String attributeGroupName = (String) requestMap.get("objectName");
        AttributeGroup attrGrp = AttributeGroup.getInstance(context, attributeGroupName);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments 0 - New Value (Attribute Group Name) 1 - Description (optional) 2 - Attributes (optional)
     * @throws Exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments 0 - New Value (Attribute Group Name) 1 - old Value (Attribute Group Name) 2 - Description (optional)
     * @throws Exception
     *             if the operation fails
     */
    public void editAttributeGroupName(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap paramMap = (HashMap) programMap.get("paramMap");
            HashMap requestMap = (HashMap) programMap.get("requestMap");
     ...
     *             if the operation fails
     */
    public void editAttributeGroupDescription(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap paramMap = (HashMap) programMap.get("paramMap");
            HashMap requestMap = (HashMap) programMap.get("requestMap");
     ...
     *             if the operation fails
     */
    public void cloneAttributeGroup(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap paramMap = (HashMap) programMap.get("paramMap");
            HashMap requestMap = (HashMap) programMap.get("requestMap");
     ...
     * @param args
     *            , String array containing the names of Attribute group
     ...
     */
    private void invalidateVPLMCatalogueCache(Context context) throws Exception, MatrixException {
