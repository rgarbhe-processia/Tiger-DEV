...
public class emxTriggerBasedIndexingUtilBase_mxJPO {
                ...
                if (field != null) {
                    ...
                    if ("object".equals(idType)) {
                        ...
                        if (!UIUtil.isNullOrEmpty(relatedOID)) {
                            String cmd = "print connection " + relatedOID + " select '" + selectable + "' dump |";
                            String result = MqlUtil.mqlCommand(context, cmd, true);
     ...
     * @param args
     *            holds trigger arguments - args[0] - Business Object Type - args[1] - Business Object Name
     * @return 0 on success
     * @author Chakra
     * @since R209
     * @throws Exception
    ...
    public int updateLastRevisionStatus(Context context, String[] args) throws Exception {
        ...
        try {
            /* Find Last Revision */
            MapList objectList = DomainObject.findObjects(context, type, name, DomainObject.QUERY_WILDCARD, DomainObject.QUERY_WILDCARD, DomainObject.QUERY_WILDCARD, "revision==last", null, false,
                    new StringList(DomainObject.SELECT_ID), (short) 0);
            ...
            if (objectList.size() > 0) {
                ...
                command.append(" ");
                command.append("\"Object Modified\"");
    ...
    public static int indexPerson(Context context, String[] args) throws Exception {
        ...
        MqlUtil.mqlCommand(context, "log bus $1 event bus custom", true, objectId);
