 ...
 */
/**
 * IEFPreferencesPageLayoutTeam jpo This jpo returns a string containing xml for generating Preferences page
 */
...
public class IEFPreferencesPageLayoutTeam_mxJPO {
    ...
    public IEFPreferencesPageLayoutTeam_mxJPO() {
    }

    public IEFPreferencesPageLayoutTeam_mxJPO(Context context, String[] args) throws Exception {
    ...
    /**
     * Entry Point This method returns a string containing xml which is used for generating Preferences page
     */
    public String getPreferencesPageLayout(Context context, String[] args) throws Exception {
        ...
        // Preference - MCADInteg-UseZipInCADFileOperations
        preferencesPageLayout.append("<preference name=\"" + MCADMxUtil.getActualNameForAEFData(context, "attribute_MCADInteg-UseZipInCADFileOperations") + "\">");
        preferencesPageLayout.append("<label>UseZipInCADFileOperations</label>");
        preferencesPageLayout.append("<uitype>" + CHECK_BOX + "</uitype>");
        preferencesPageLayout.append("</preference>");
