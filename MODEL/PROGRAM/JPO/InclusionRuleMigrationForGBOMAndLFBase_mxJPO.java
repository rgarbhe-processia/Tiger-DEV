...
/*
 * ${CLASS:FTRGBOMEffectivityMigrationBase}.java program migrates the data into Common Document model i.e. to 10.5 schema.
 *
...
/**
 * The <code>FTRGBOMEffectivityMigrationBase</code> class contains code to migrate Inclusion Rules to CFF Expression of the Logical Features/Products found in Step 1.
 */
public class InclusionRuleMigrationForGBOMAndLFBase_mxJPO extends emxCommonMigration_mxJPO {
     ...
     */
    public InclusionRuleMigrationForGBOMAndLFBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    /**
     * This method is executed if a specific method is not specified. This method checked for the status property and go ahead with MP migration if find object step is completed.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    public void migrateObjects(Context context, StringList objectIdList) throws Exception {
        try {
            ...
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].attribute["
                    + ConfigurationConstants.ATTRIBUTE_RIGHT_EXPRESSION + "].value");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.physicalid"); // connections to relationship
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.type");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.id");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.type.kindof[" + ConfigurationConstants.RELATIONSHIP_CONFIGURATION_STRUCTURES + "]");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.type.kindof[" + ConfigurationConstants.RELATIONSHIP_COMMON_GROUP + "]");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.attribute[" + ConfigurationConstants.ATTRIBUTE_COMMON_GROUP_NAME + "]");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.from.type.kindof[" + ConfigurationConstants.TYPE_CONFIGURATION_FEATURES + "]");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.from.type");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.from.name");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.from.revision");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.from.id");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.from.physicalid");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.to.type.kindof[" + ConfigurationConstants.TYPE_CONFIGURATION_FEATURES + "]");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.to.type");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.to.name");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.to.revision");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.to.id");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.to.physicalid");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].to.type"); // connections to Object
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].to.name");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].to.revision");
            slRelSelects.add("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                    + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].to.id");
            ...
            while (iterator.hasNext()) {
                try {
                    ...
                    infoMapList = (MapList) domContextBus.getRelatedObjects(context, strRelPattern.toString(), strTypePattern.toString(), slObjSelects, slRelSelects, getTo, getFrom, iLevel,
                            strObjWhere, strRelWhere, limit);
     ...
     *            the eMatrix <code>Context</code> object
     * @param MPMap
     *            Map containing information about all the Manufacturing Plan under Master Manufacturing Plan connected with the Model
     * @throws Exception
     */
            ...
            if (!slconnectedProductModels.isEmpty()) {
                ...
                if (infoMapList.size() != 0) {
                    ...
                    while (itrOut.hasNext()) {
                        ...
                        if (structureInfoMap.containsKey(ConfigurationConstants.SELECT_RELATIONSHIP_TYPE + ".kindof[" + ConfigurationConstants.RELATIONSHIP_VARIES_BY + "]") && "TRUE"
                                .equalsIgnoreCase((String) structureInfoMap.get(ConfigurationConstants.SELECT_RELATIONSHIP_TYPE + ".kindof[" + ConfigurationConstants.RELATIONSHIP_VARIES_BY + "]"))) {
                            slDesignVariantsList.add(structureInfoMap.get(ConfigurationConstants.SELECT_ID));
                        } else if (structureInfoMap.containsKey(ConfigurationConstants.SELECT_RELATIONSHIP_TYPE + ".kindof[" + ConfigurationConstants.RELATIONSHIP_INACTIVE_VARIES_BY + "]")
                                && "TRUE".equalsIgnoreCase(
                                        (String) structureInfoMap.get(ConfigurationConstants.SELECT_RELATIONSHIP_TYPE + ".kindof[" + ConfigurationConstants.RELATIONSHIP_INACTIVE_VARIES_BY + "]"))) {
                            slInactiveDesignVariantsList.add(structureInfoMap.get(ConfigurationConstants.SELECT_ID));
                        } else if (structureInfoMap.containsKey(ConfigurationConstants.SELECT_RELATIONSHIP_TYPE + ".kindof[" + EffectivityFramework.RELATIONSHIP_CONFIGURATION_CONTEXT + "]")
                                && "TRUE".equalsIgnoreCase(
                                        (String) structureInfoMap.get(ConfigurationConstants.SELECT_RELATIONSHIP_TYPE + ".kindof[" + EffectivityFramework.RELATIONSHIP_CONFIGURATION_CONTEXT + "]"))) {
                            slConfigContextsList.add(structureInfoMap.get(ConfigurationConstants.SELECT_ID));
                        } else if (structureInfoMap.containsKey(ConfigurationConstants.SELECT_RELATIONSHIP_TYPE + ".kindof[" + ConfigurationConstants.RELATIONSHIP_LOGICAL_FEATURES + "]")
                                && "TRUE".equalsIgnoreCase(
                                        (String) structureInfoMap.get(ConfigurationConstants.SELECT_RELATIONSHIP_TYPE + ".kindof[" + ConfigurationConstants.RELATIONSHIP_LOGICAL_FEATURES + "]"))) {
                    ...
                    if (part_MapList.size() != 0) {
                        ...
                        while (itrPart.hasNext()) {
                            ...
                            inclusionRuleMigrated = processPartLF(context, IRInfoMap, slDesignVariantsList, slInactiveDesignVariantsList, slConfigContextsList, slconnectedProductModels,
                        ...
                        setActiveInactiveDesignVariant(context, strObjectId, setParentInvolved, new StringList(slDesignVariantsList), new StringList(slInactiveDesignVariantsList));
                    ...
                    /*
                     * slconnectedProductModels.removeAll(slConfigContextsList); mqlLogRequiredInformationWriter("Connecting :"+ strObjectId +" to  Models: "+ slconnectedProductModels +
                     * " using relationship "+ EffectivityFramework.RELATIONSHIP_CONFIGURATION_CONTEXT +" \n"); if(slconnectedProductModels.size()>0){ DomainRelationship.connect(context,
                     * domContextBus, EffectivityFramework.RELATIONSHIP_CONFIGURATION_CONTEXT,true,Arrays.copyOf(slconnectedProductModels.toArray(), slconnectedProductModels.size(), String[].class));
                     * }
                     */
    ...
    private void setActiveInactiveDesignVariant(Context context, String strObjectId, java.util.Set setParentInvolved, StringList slDesignVariantsList, StringList slInactiveDesignVariantsList)
            throws Exception {
        ...
        mqlLogRequiredInformationWriter(
                "Connecting :" + strObjectId + " to  Configuration Feature: " + setParentInvolved + " using relationship " + ConfigurationConstants.RELATIONSHIP_VARIES_BY + " \n");
        if (setParentInvolved.size() > 0) {
            domContextBustoadd.addDesignVariants(context, new StringList(new ArrayList(setParentInvolved)));
        }
    }

    private boolean processPartLF(Context context, Map IRInfoMap, StringList slDesignVariantsList, StringList slInactiveDesignVariantsList, StringList slConfigContextsList,
            StringList slconnectedProductModels, java.util.Set setParentInvolved, boolean isLF) throws Exception {
        ...
        if (ProductLineCommon.isNotNull(IRid)) {
            ...
            // String attributeRightExpression = (String)IRInfoMap.get("tomid["+ ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION
            // +"].from["+ConfigurationConstants.TYPE_INCLUSION_RULE+"].attribute["+ ConfigurationConstants.ATTRIBUTE_RIGHT_EXPRESSION +"].value");
            ...
            if (ProductLineCommon.isNotNull(strReason)) { // These IRs are unsupported case, hence will not be logged as failed case
                ...
                tempObj = IRInfoMap.get("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                        + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.from.id");
                StringList slParentId = ConfigurationUtil.convertObjToStringList(context, tempObj);

                tempObj = IRInfoMap.get("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                        + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].torel.physicalid");
                ...
                if (isLF) {
                    ...
                    setActiveInactiveDesignVariant(context, toSideObjectID, setParentInvolved, slDesignVariantsList, slInactiveDesignVariantsList);
                }

            } //
            /*
             * } else{ //These IR has blank IR and hence will be deleted, no change in Effectivity mqlLogRequiredInformationWriter("Deleting Inclusion Rule object ID: "+ IRid +" \n");
             * DomainObject.deleteObjects(context, new String[]{IRid}); }
             */
        } else {
    ...
    private String isSupportedCase(Context context, Map IRInfoMap) throws Exception {
        ...
        String attributeRightExpression = (String) IRInfoMap.get("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE
                + "].attribute[" + ConfigurationConstants.ATTRIBUTE_RIGHT_EXPRESSION + "].value");
        ...
        tempObj = IRInfoMap.get("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from[" + ConfigurationConstants.TYPE_INCLUSION_RULE + "].from["
                + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].to.type");
