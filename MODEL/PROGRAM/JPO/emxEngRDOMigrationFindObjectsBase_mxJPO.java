...
public class emxEngRDOMigrationFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO {
     ...
     * @grade 0
     */
    public emxEngRDOMigrationFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public void getIds(Context context, int chunkSize) throws Exception {
        ...
        try {
            ...
            String whereClause = "(to[" + DomainConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "]==true) && " + "(program[" + migrationProgramName
            ...
            String whereClause1 = "(to[" + RELATIONSHIP_CHANGE_RESPONSIBILITY + "]==true) && " + "(program[" + migrationProgramName + " -method writeOID ${OBJECTID} \"${TYPE}\"] == true)";
