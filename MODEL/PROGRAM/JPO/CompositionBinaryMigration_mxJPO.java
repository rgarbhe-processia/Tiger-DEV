...
public class CompositionBinaryMigration_mxJPO extends CompositionBinaryMigrationBase_mxJPO {
    /**
     * @param context
     ...
     * @since FTR V6R2012x
     */
    public CompositionBinaryMigration_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
