...
/**
 * IEFCompareStructureComparisonReport.java Copyright Dassault Systemes, 1992-2007. All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systemes and its
...
public class IEFCompareStructureComparisonReport_mxJPO {
    ...
    public Hashtable getStructureComparisionReportData(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String childBusAndRelationshipInfoForStructure1 = serverGeneralUtil.getChildRelsAndIdsForCheckout(context, structure1ID, true, MCADAppletServletProtocol.ASSEMBLY_LIKE, "", "", "",
                    relAttrNames);
            ...
            if (!childBusAndRelationshipInfoForStructure1.equals("")) {
                ...
                while (childDetailsElementsForStructure1.hasMoreElements()) {
                    ...
                    String uniqueKey = new StringBuffer(busType.trim()).append(MCADAppletServletProtocol.IEF_SEPERATOR_ONE).append(busName.trim()).append(MCADAppletServletProtocol.IEF_SEPERATOR_ONE)
                            .append(busRev.trim()).toString();
                    String keyValue = new StringBuffer(description).append(MCADAppletServletProtocol.IEF_SEPERATOR_ONE).append(quantity).append(MCADAppletServletProtocol.IEF_SEPERATOR_ONE)
                    ...
                    if (!structure1UniqueInfoTable.containsKey(uniqueKey)) {
                        ...
                        keyValue = new StringBuffer(description).append(MCADAppletServletProtocol.IEF_SEPERATOR_ONE).append(latestQuantity).append(MCADAppletServletProtocol.IEF_SEPERATOR_ONE)
                                .append(title).toString();
                        structure1UniqueInfoTable.put(uniqueKey, keyValue);
                    }
                }
            ...
            String childBusAndRelationshipInfoForStructure2 = serverGeneralUtil.getChildRelsAndIdsForCheckout(context, structure2ID, true, MCADAppletServletProtocol.ASSEMBLY_LIKE, "", "", "",
                    relAttrNames);
