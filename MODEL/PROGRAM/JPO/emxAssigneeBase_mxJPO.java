...
public class emxAssigneeBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            Holds the Hashmap containing the following arguments: objectId - string containing the object Id relationName - string containing the relationship name
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments objectList - MapList containn the list of busines objetcs paramList - HasMap containg the arguments like reportFormat,ObjectId,
        ...
        for (int i = 0; i < iNoOfObjects; i++) {
            ...
            if (strReportFormat != null && strReportFormat.equals("null") == false && strReportFormat.equals("") == false) {
                ...
                strFullName = "<img src = \"images/iconSmallPerson.gif\"></img><b><A HREF=\"JavaScript:emxTableColumnLinkClick('emxTree.jsp?" + "mode=insert&amp;name="
                        + XSSUtil.encodeForHTMLAttribute(context, strLastName) + XSSUtil.encodeForHTMLAttribute(context, strFirstName) + "&amp;treeMenu=type_PLCPerson&amp;emxSuiteDirectory="
                        ...
                        + XSSUtil.encodeForHTMLAttribute(context, strObjId) + "', 'null', 'null', 'false', 'popup')\" class=\"object\">" + XSSUtil.encodeForHTML(context, strLastName) + ", "
                        + XSSUtil.encodeForHTML(context, strFirstName) + "</A></b>";
            }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            Holds the HashMap containing the following arguments: paramMap - HashMap containing the object id.
     * @return Object - Vector of email ids
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
    ...
    public String getWebSite(Context context, String[] args) throws Exception {
        ...
        strWebSiteAdd = "<B><A HREF=\"" + strWebSite + "\">" + strWebSite + "</A>";
