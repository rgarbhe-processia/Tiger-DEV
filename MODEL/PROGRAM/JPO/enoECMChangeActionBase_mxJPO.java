...
/*
 * * ${CLASS:enoECMChangeActionBase}** Copyright (c) 1993-2015 Dassault Systemes. All Rights Reserved.
 */
...
public class enoECMChangeActionBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public int checkForSrTechnicalAssigneeAndRouteTemplate(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            mapRouteTemplate = getRelatedObjects(context, RELATIONSHIP_OBJECT_ROUTE, TYPE_ROUTE_TEMPLATE, selectStmts, null, false, true, (short) 1, whrClause, null, 0);
    ...
    public HashMap displayRequestedChangeRangeValues(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < strListRequestedChange.size(); i++) {
            ...
            // TIGTK-8679 -28-06-2017 - AniketM - START
            // Hide "None" from Requested change for Change Request
            ...
            // TIGTK-8679 - 28-06-2017 - AniketM - END
        }
    ...
    public MapList getCustomAttributes(Context context, String[] args) throws Exception {
        ...
        StringList interfaceList = FrameworkUtil
                .split(MqlUtil.mqlCommand(context, "print bus $1 select $2 dump $3", strObjectId, "from[" + ChangeConstants.RELATIONSHIP_CHANGE_AFFECTED_ITEM + "].interface", "|"), "|");
            ...
            try {
                ...
                if (attributeTypeList != null) {
                    ...
                    while (keyItr.hasNext()) {
                        ...
                        setColumnSettings(context, mapSettings, (String) attrMap.get(UICache.TYPE), (StringList) attrMap.get(FORMAT_CHOICES), (String) attrMap.get("multiline"));
