 ...
 *
 * FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.7 $" Date : "$Date: Wed Oct 22 16:02:14 2008 $"
 *
 */
...
public class emxDOCUMENTCLASSIFICATIONBase_mxJPO extends emxDocumentCentralCommon_mxJPO {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("must specify method on " + "emxDOCUMENTCLASSIFICATIONBase invocation");
        }
