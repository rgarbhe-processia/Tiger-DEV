...
public class emxCommonUtilBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     *            the eMatrix <code>Context</code> object
     * @param info
     *            contains a Map with the following keys: baseURL - String containing base URL notificationName - String containing the name of the Notification Event bundleName - String containing
     *            the name of the Resource bundle locale - java.util.Locale Object containg locale information messageType - String mentioning the type of the message ,allowed values are "html" or
     *            "text" id - String containing the Object Id of the Object on which Notification Event Triggered
     * @return Document - jdom object holding XML
     * @throws Exception
     *             if the operation fails
     */
    public com.matrixone.jdom.Document getContentAddDeleteMailXML(Context context, Map info) throws Exception {
        ...
        if (messageType.equalsIgnoreCase("html")) {
            ...
            String fromObjectViewLink = MessageUtil.getMessage(context, null, "emxComponents.Object.Event.Html.Mail.ViewLink", fromObjectValues, null, context.getLocale(), bundleName);
            ...
            String fromObjectViewLink = MessageUtil.getMessage(context, null, "emxComponents.Object.Event.Text.Mail.ViewLink", fromObjectValues, null, context.getLocale(), bundleName);
            footerInfoList.add(fromObjectViewLink);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: baseURL - String containing base URL notificationName - String containing the name of the Notification Event bundleName - String containing
     *            the name of the Resource bundle locale - java.util.Locale Object containg locale information id - String containing the Object Id of the Object on which Notification Event Triggered
     * @return String - the text message of the notification
     * @throws Exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the ObjectId, JPO program name and JPO function name :
     * @return boolean - true (if function that is getting called provides access), false(if function that is getting called does not provide access) if function is not there return the default value
     *         true
     * @throws Exception
     *             if the operation fails
     */
