 ...
 **
 ** FileName : "$RCSfile: ${CLASSNAME}.java.rca $ Version : "$Revision: 1.8 $"
 **
...
/**
 * The <code>emxGeneralClass</code> represents anything on the "To Side" of "Subclass" Relationship in LC Schema
...
public class emxGeneralClass_mxJPO extends emxGeneralClassBase_mxJPO {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("must specify method on emxGeneralClass invocation");
        }
