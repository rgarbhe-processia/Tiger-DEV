...
public class emxCommonECRBase_mxJPO extends emxChange_mxJPO {
     ...
     */
    public emxCommonECRBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public Boolean allowSignatureApproval(Context context, String args[]) throws Exception {
        ...
        if (strChangeBoard != null && !EMPTY_STRING.equals(strChangeBoard)) {
            ...
            cmd.open(context);
            String strCommand = "print group \"" + strChangeBoard + "\" select person[" + sCurrentUser + "] dump |";
            cmd.executeCommand(context, strCommand);
            // Modified for Bug No: 339778 0 X+2 Begin
            String sResult = cmd.getResult().trim();
            // Modified for Bug No: 339778 0 X+2 End
            cmd.close(context);
