...
/**
 * The <code>emxUITable</code> class contains methods for UI Table Component.
 * @version AEF 10.0.1.0 - Copyright (c) 2003, MatrixOne, Inc.
 */

public class emxUITable_mxJPO extends emxUITableBase_mxJPO {
    ...
    public emxUITable_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
