...
/**
 * VPLMIntegBOMVPLMSynchronizeBase JPO for publishing and synchronizing VPLM data with Matrix and Matrix data with VPLM.
 */
...
public class VPLMIntegBOMVPLMSynchronizeBase_mxJPO {
     ...
     * <li>"SYNC_AND_TRANSFER" : "give" to give control to other side. Default is "no". Specifying any other value means "no". It is not possible to take control.</li>
     * </ul>
     * @param Context
     *            object for the Enovia MatrixOne session. The context must be connected to a server and VPLM role should be specified in it.
     * @param argument
     *            string array.
    ...
    /**
     * JPO to invoke synchronization using Java code or MQL / TCL script While packing the input string array provide the following data using the mentioned keys: While packing the input string array
     * provide the following data using the mentioned keys:
     * <ul/>
