...
public class IEFStartDesignCreateStructureBase_mxJPO {
    ...
    /**
     * Entry Point This method is to be called for creating the structure for StartDesign functionality.It takes as an input the object ID of the template object which is selected in the UI.Other
     * inputs are the type, name, revision and policy for the design object to be created and a map of the attribute name and values which are to be set on the design object.A flag indicating whether
     * AutoName is selected for naming of object, is also passed as one of the input parameters. Based on the template object ID and other parameters, this object creates the design object (by calling
     * the JPO name of which is got from IEFStartDesignJPO attribute on the template object). If the template object is of assembly type, structure below this template object is traversed and design
     * objects are created for each of the template objects in the structure. These design objects are then connected to build the structure.
     * @param context
     * @param args
     *            Key and value in the packed Hastable "GCO" = Global Config Object "languageName" = locale language name "templateObjID" = Template object ID "type" = Type of the design object to be
     *            created "name" = Name of the design object to be created. If AutoName is selected, it should be a blank string "customRevision" = Revision of the design object to be created "policy"
     *            = Policy for the design object to be created "autoName" = "true" if AutoName is selected; "false" otherwise "autoNameSeries" = selected autoname series if AutoName is selected, blank
     *            string otherwise "isRootObject" = "true" if the selected template object is a component or the topmost assembly; "false" otherwise "attributesMap" = hashmap containing actual
     *            attribute names as key and values as value "source" = Source details (i.e., value that is to be set on Source attribute)
     * @return
     * @throws Exception
     */
    ...
    protected void traverseTemplateStructure(Context context, String parentTemplateObjID, String parentDesignObjID, Hashtable relsAndEnds, Hashtable argumentsTable, boolean isParentObjATemplate)
    ...
    protected String createDesignObject(Context context, Hashtable argTable, String cadType, String templateObjId, String startDesignJPOName, BusinessObject templateObject,
            String oldFileNameWithoutExtension) throws MCADException {
        String designObjID = "";
    ...
    /**
     * This method is used to connect the newly created Object with the selected folder durign Create Object operation
     */
    ...
    /**
     * This method is used to connect newly created Object to the selected object during insert new Object operation operation
     * @param context
     * @param args
     *            : Key and value in the packed Hashtable
     * @return
     * @throws Exception
     */
    public Hashtable insertMethod(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            sBuff.append("<item oid=\"" + majorobjid + "\" relId=\"" + sRes + "\" pid=\"" + sFrmId + "\" >")
                    .append("<column name=\"Type\" edited=\"true\" a=\"" + sMajorobjType + "\">" + sMajorobjType + "</column>").append("</item>");
            sBuff.append("</data>");
            sBuff.append("</mxRoot>");
    ...
    public Hashtable removeMethod(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList mlInfo = doObj.getRelatedObjects(context, sConnectedRelName, "*", busSelects, relSelects, btoDir, // toDir
                    bFromDir, // fromDir
                    (short) 1, null, null, 0);

            DomainObject doObjNewMajor = DomainObject.newInstance(context, sImmedParentMajor);
            // Getting all components connected to the object
            MapList mlInfoOfMajor = doObjNewMajor.getRelatedObjects(context, sConnectedRelName, "*", busSelects, relSelects, btoDir, // toDir
                    bFromDir, // fromDir
                    (short) 1, null, null, 0);
