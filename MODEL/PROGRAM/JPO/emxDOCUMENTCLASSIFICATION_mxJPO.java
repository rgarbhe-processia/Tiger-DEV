 ...
 *
 * FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.8 $" Date : "$Date: Wed Oct 22 16:02:20 2008 $"
 */

import matrix.db.Context;

/**
 * The <code>emxDOCUMENTCLASSIFICATION</code> represents the DOCUMENT CLASSIFICATION type in DC Schema
...
public class emxDOCUMENTCLASSIFICATION_mxJPO extends emxDOCUMENTCLASSIFICATIONBase_mxJPO {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("must specify method on emxDOCUMENTCLASSIFICATION invocation");
        }
