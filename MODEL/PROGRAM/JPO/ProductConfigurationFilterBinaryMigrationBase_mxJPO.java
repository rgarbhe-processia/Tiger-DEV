...
public class ProductConfigurationFilterBinaryMigrationBase_mxJPO extends emxCommonMigrationBase_mxJPO {
    ...
    public ProductConfigurationFilterBinaryMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        ...
        try {
             ...
             * "Product Configuration Filter Binary Migration PreChecks not executed.Please complete PreChecks before migration. \n"); bIsException=true; return -1; }
             */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            accepts a String array holding the arguments context and [Chunk size,Path to save text file]
     * @return void
     * @throws Exception
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            accepts a String array holding the arguments context and PC Ids list
     * @return void
     * @throws Exception
     *             when the operation fails.
     */
    public void migrateObjects(Context context, StringList objectList) throws Exception {
        ...
        for (int count = 0; count < iObjListSize; count++) {
            ...
            try {
                ...
                // Now we are not setting the attribute as blank but modifying the given BOM XML to V6R2014x format
    ...
    /**
     * Writes the command string to the ConvertedObjectIds_xx.csv log file and writes the objectId to the ConvertedObjectIds_xx.txt file.
     * @param command
