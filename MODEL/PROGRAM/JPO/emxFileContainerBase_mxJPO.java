 ...
 * evidence any actual or intended publication of such program. FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.15 $" Date : "$Date: Wed Oct 22
 * 16:02:39 2008 $"
 */
...
/**
 * The <code>${CLASSNAME}</code> class is used as DocumentCentral FileContainer object to hold File Information
 * @exclude
 */
...
public class emxFileContainerBase_mxJPO extends DomainObject {
    ...
    public emxFileContainerBase_mxJPO(Context context, String[] args) throws Exception {
        super(args[0]);
