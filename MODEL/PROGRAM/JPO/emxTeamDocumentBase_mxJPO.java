...
public class emxTeamDocumentBase_mxJPO extends emxCommonDocument_mxJPO {
    ...
    public static void sendNotificationForContentAddOnFolder(Context context, String[] args) throws Exception {
        ...
        MapList wksList = domObj.getRelatedObjects(context, relPattern.getPattern(), typePattern.getPattern(), selStmts, new StringList(), true, false, (short) 0, "", "", 0, includeTypePattern, null,
                null);
