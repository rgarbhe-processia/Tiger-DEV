...
public class emxENCFullSearchBase_mxJPO {
     ...
     * @since MBOM X-3.
     */
    public emxENCFullSearchBase_mxJPO(Context context, String[] args) throws Exception {
        super();
    }
     ...
     * @param args
     *            String array parameter having Part's details
     ...
     * @author Suman Kumar
     */
    public StringList searchNotIsVertionTrue(Context context, String[] args) throws Exception {
        String sWhereExp = "";
        String isVersion = "";
        String objectId = "";
        ...
        if (parentId != null) {
            try {
                ...
                MapList totalresultList = DomainObject.findObjects(context, DomainConstants.TYPE_PART, DomainConstants.QUERY_WILDCARD, DomainConstants.QUERY_WILDCARD, DomainConstants.QUERY_WILDCARD,
                        DomainConstants.QUERY_WILDCARD, sWhereExp, null, true, resultSelects, Short.parseShort(queryLimit), DomainConstants.QUERY_WILDCARD, DomainConstants.EMPTY_STRING // search text
                );
    ...
    public StringList excludeConnectedAlternateOIDs(Context context, String[] args) throws Exception {
        HashMap params = (HashMap) JPO.unpackArgs(args);
        String parentId = (String) params.get("objectId");
        ...
        if (parentId != null) {
            try {
                ...
                totalConnectedList = domConnectId.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ALTERNATE, DomainConstants.TYPE_PART, busSelList, relSelList, false, true, (short) 1, null,
                ...
                MapList substituteConnectedList = domConnectId.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EBOM, DomainConstants.TYPE_PART, new StringList(DomainConstants.SELECT_ID),
                        new StringList(substituteSelect), true, false, (short) 1, null, null, 0);
    ...
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList excludeOIDsForSub(Context context, String[] args) throws Exception {
     ...
     */
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList getEBOMs(Context context, String[] args) throws Exception {
        HashMap params = (HashMap) JPO.unpackArgs(args);
        String parentId = (String) params.get("objectId");
        ...
        if (parentId != null) {
            try {
                ...
                MapList totalConnectedList = (MapList) domConnectId.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EBOM, DomainConstants.TYPE_PART, busSelList, relSelList, false, true,
                        (short) 1, null, null);
                ...
                MapList totalresultList = DomainObject.findObjects(context, DomainConstants.TYPE_PART, DomainConstants.QUERY_WILDCARD, DomainConstants.QUERY_WILDCARD, DomainConstants.QUERY_WILDCARD,
                        DomainConstants.QUERY_WILDCARD, DomainConstants.EMPTY_STRING, null, true, resultSelects, Short.parseShort(queryLimit), DomainConstants.QUERY_WILDCARD,
     ...
     * @author Suman Kumar
     */
    public StringList excludeConnectedSubstituteOIDs(Context context, String[] args) throws Exception {
     ...
     *            Context : User's Context.
     * @param args
     *            String array parameter having Change Details
     * @return The StringList value of excludeOIDPersons.
     * @throws Exception
     *             if searching Person object fails.
     * @since X3
     */

    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList excludeOIDPersons(Context context, String[] args) throws Exception {
        ...
        if (strOrgId != null) {
            DomainObject doOrg = new DomainObject(strOrgId);
            ...
            totalresultList = DomainObject.findObjects(context, sPerson, "*", "*", "*", "*", strWhereClause, null, true, strlPersonSelects, (short) 0);
     ...
     *            Context : User's Context.
     * @param args
     *            String array parameter having Change Object Details
    ...
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList excludeOIDChangeObjs(Context context, String[] args) throws Exception {
        ...
        if (strObjectId != null) {
            ...
            if (strRDOId != null && strRDOId.length() > 0) {
                ...
                MapList totalresultList = DomainObject.findObjects(context, DomainConstants.TYPE_ECO, "*", "*", "*", "*", strWhereClause, null, true, strlChangeObjselects, (short) 0);
            ...
            MapList mapListChangeObjs = doPart.getRelatedObjects(context,
                    // PropertyUtil.getSchemaProperty(context,"relationship_AffectedItem") + "," + PropertyUtil.getSchemaProperty(context,"relationship_NewPartPartRevision") + "," +
                    // PropertyUtil.getSchemaProperty(context,"relationship_NewSpecificationSpecificationRevision") + "," +
                    // PropertyUtil.getSchemaProperty(context,"relationship_RequestSpecificationRevision") + "," + PropertyUtil.getSchemaProperty(context,"relationship_RequestPartRevision") + "," +
                    // PropertyUtil.getSchemaProperty(context,"relationship_RequestPartObsolescence"),
                    PropertyUtil.getSchemaProperty(context, "relationship_AffectedItem"), PropertyUtil.getSchemaProperty(context, "type_Change"), objectSelects, null, true, false, (short) 1, null,
                    null);
    ...
    /**
     * excludeOIDAffectedItems() method returns Person objects that do not belong to the same business unit.
     * @param context
     *            Context : User's Context.
     * @param args
     *            String array parameter having Change Object Details
     * @return The StringList value of excludeOIDAffectedItems.
     * @throws Exception
     *             if searching Person object fails.
     * @since X3
     */
    ...
    /*
     * public StringList excludeOIDAffectedItems(Context context, String[] args) throws Exception {
     * 
     * HashMap params = (HashMap)JPO.unpackArgs(args);
     * 
     * String sRelDesignResponsibility = PropertyUtil.getSchemaProperty(context,"relationship_DesignResponsibility");
     ...
     * String strObjectId = (String) params.get("objectId");
     * 
     * StringList strlExcludeOIDAffectedItems = new StringList();
     * 
     * 
     * if (strObjectId != null)
     * 
     * {
     * 
     * DomainObject doECO = new DomainObject(strObjectId);
     * 
     * String strTypePattern = "*"; String strTempSubTypes = "";
     * 
     * String strRDOId = doECO.getInfo(context, "to[" + sRelDesignResponsibility + "].from.id");
     * 
     * String strField = (String) params.get("field");
     * 
     * StringList strlFields = FrameworkUtil.split(strField, ":");
     * 
     * Iterator itrFields = strlFields.iterator();
     * 
     * while (itrFields.hasNext()) { String strFieldType = (String) itrFields.next();
     * 
     * int intIndex = strFieldType.indexOf("TYPES=");
     * 
     * if (intIndex != -1) { String strSubTypes = strFieldType.substring(intIndex + 6);
     * 
     * StringList strlTypes = FrameworkUtil.split(strSubTypes, ",");
     * 
     * Iterator itrTypes = strlTypes.iterator();
     * 
     * 
     * 
     * while (itrTypes.hasNext()) { String strSubType = (String) itrTypes.next(); strSubType = PropertyUtil.getSchemaProperty(context,strSubType);
     * 
     * if (strTempSubTypes.length() == 0) { strTempSubTypes = strSubType; } else { strTempSubTypes = strTempSubTypes + "," + strSubType; }
     * 
     * }
     * 
     * if (strTempSubTypes.length() > 0) { strTypePattern = strTempSubTypes; }
     * 
     * break; }
     * 
     * 
     ...
     * String strWhereClause = null;
     * 
     * StringList strlAffectedItemselects = new StringList(2); strlAffectedItemselects.add(DomainConstants.SELECT_ID); strlAffectedItemselects.add("to[" + sRelDesignResponsibility + "].from.id");
     * 
     * MapList totalresultList = DomainObject.findObjects(context, strTypePattern, "*", "*", "*", "*", strWhereClause, null, true, strlAffectedItemselects, (short) 0);
     * 
     * Iterator itrAffectedItems = totalresultList.iterator(); String strAffectedItemRDOId = "";
     * 
     * while (itrAffectedItems.hasNext()) { Map mapAffectedItem = (Map) itrAffectedItems.next(); String strAffectedItemId = (String) mapAffectedItem.get(DomainConstants.SELECT_ID); try {
     * strAffectedItemRDOId = (String) mapAffectedItem.get("to[" + sRelDesignResponsibility + "].from.id"); } catch (Exception ex) { strAffectedItemRDOId = (String) ((StringList)
     * mapAffectedItem.get("to[" + sRelDesignResponsibility + "].from.id")).get(0); }
     * 
     * 
     * if (strRDOId != null && strRDOId.length() > 0 && strAffectedItemRDOId != null && strAffectedItemRDOId.length() > 0 && !strRDOId.equals(strAffectedItemRDOId)) {
     * strlExcludeOIDAffectedItems.add(strAffectedItemId); } else { Access access=new Access(); BusinessObject boChange = new BusinessObject(strAffectedItemId); access =
     * boChange.getAccessMask(context); if(!access.hasToConnectAccess()) { strlExcludeOIDAffectedItems.add(strAffectedItemId); } } }
     * 
     * StringList objectSelects = new StringList(1); objectSelects.addElement(DomainConstants.SELECT_ID);
     * 
     * MapList mapListAffectedItems = doECO.getRelatedObjects( context, PropertyUtil.getSchemaProperty(context,"relationship_AffectedItem") + "," +
     * PropertyUtil.getSchemaProperty(context,"relationship_NewPartPartRevision") + "," + PropertyUtil.getSchemaProperty(context,"relationship_NewSpecificationSpecificationRevision") + "," +
     * PropertyUtil.getSchemaProperty(context,"relationship_RequestSpecificationRevision") + "," + PropertyUtil.getSchemaProperty(context,"relationship_RequestPartRevision") + "," +
     * PropertyUtil.getSchemaProperty(context,"relationship_RequestPartObsolescence"), strTypePattern, objectSelects, null, false, true, (short)1, null, null);
     * 
     * Iterator itrRelatedAffectedItems = mapListAffectedItems.iterator();
     * 
     * while (itrRelatedAffectedItems.hasNext()) { Map mapChangeObj = (Map) itrRelatedAffectedItems.next();
     * 
     * String strChangeObjId = (String) mapChangeObj.get(DomainConstants.SELECT_ID);
     * 
     * strlExcludeOIDAffectedItems.add(strChangeObjId); }
     * 
     * } return strlExcludeOIDAffectedItems;
     * 
     * }
     */

    /**
     * Gets all the parent parts for the given part at all levels. This is used by the Full Text search as a selectable.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments objectId - contains the part id.
    ...
    public String getWhereUsedEBOM(Context context, String[] args) throws Exception {
        ...
        if (mxType.isOfParentType(context, strType, DomainConstants.TYPE_PART)) {
            ...
            try {
                ...
                MapList ebomList = FrameworkUtil.toMapList(doPart.getExpansionIterator(context, DomainConstants.RELATIONSHIP_EBOM, "*", objSelects, relSelects, true, false, (short) 0, null, null,
     ...
     * @throws Exception
     *             if searching Organization object fails.
     * @since X3
     */

    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList excludeOIDNonLeadOrganizations(Context context, String[] args) throws Exception {
        ...
        MapList totalresultList = DomainObject.findObjects(context, sOrganization + "," + sProjectSpace, "*", "*", "*", "*", null, null, true, strlNonLeadOrganizationselects, (short) 0);
    ...
    /**
     * Added for the Fix 672436 Returns a StringList of the parent object ids from parent OID which are connected using EBOM Relationship for a given context.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a packed HashMap containing objectId of object
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a packed HashMap containing objectId of context object
     * @return StringList.
     * @since EngineeringCentral X3
     * @throws Exception
     *             if the operation fails.
    ...
    public StringList getEBOMsWithinContext(Context context, String args[]) throws Exception {
        ...
        ebomList = part.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EBOM, // relationship pattern
     ...
     * @param context
     * @param args
     *            Contains all the affectedItems selected to add/move to a Change
    ...
    // 373447
    /**
     * includeOIDLeadOrganizations() method returns OIDs of organization/ProjectSpace Having person with Lead role as "ECR Chairman" and "ECR Coordinator"
     * @param context
     *            Context : User's Context.
     * @param args
     *            String array
    ...
    @com.matrixone.apps.framework.ui.IncludeOIDProgramCallable
    public StringList includeOIDLeadOrganizations(Context context, String[] args) throws Exception {
        ...
        MapList totalresultList = DomainObject.findObjects(context, sOrganization, "*", "*", "*", "*", null, null, true, strlLeadOrganizationselects, (short) 0);
     ...
     *             if searching Parts object fails.
     */
    public StringList includeEBOMOIDs(Context context, String[] args) throws Exception {
        ...
        StringList selectStmts = new StringList(1);
        selectStmts.addElement(DomainConstants.SELECT_ID);
        MapList mapList = partObj.getRelatedObjects(context, relToExpand, // relationship pattern
    ...
    /**
     * excludeAffectedItems() method returns OIDs of Affect Items[Part/Spec/CAD Drawing] which are already connected to context change[ECR/ECO] object
     * @param context
     *            Context : User's Context.
     * @param args
     *            String array
    ...
    public StringList excludeAffectedItems(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            StringList selectStmts = new StringList(1);
            selectStmts.addElement(DomainConstants.SELECT_ID);
            MapList mapList = domObj.getRelatedObjects(context, srelPattern, // java.lang.String relationshipPattern,
     ...
     */
    @com.matrixone.apps.framework.ui.IncludeOIDProgramCallable
    public StringList includeRDE(Context context, String[] args) throws Exception {
     ...
     */
    @com.matrixone.apps.framework.ui.IncludeOIDProgramCallable
    public StringList includeRME(Context context, String[] args) throws Exception {
    ...
    /*
     * This method does the multiLevelRecursionCheck for EBOM and EBOM Pending relationships.* Inputs : args[0]---Selected From Object Id args[1]---Selected To Object Id args[2]---relationship passed
    ...
    public int multiLevelRecursionCheck(Context context, String[] args) throws Exception {
        ...
        if (recursionFlag) {
            // Multitenant
            // String recursionMesssage = UINavigatorUtil.getI18nString("emxEngineeringCentral.Alert.RecursionError", "emxEngineeringCentralStringResource", context.getLocale().toString());
    ...
    public int multiLevelRecursionCheckForSubstitute(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList m1 = prim.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EBOM, // relationship pattern
                    DomainConstants.TYPE_PART, // object pattern
                    selectStmts, // object selects
                    null, // relationship selects
                    false, // to direction
            ...
            if (!recursionFlag) {
                MapList m2 = prim.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EBOM, // relationship pattern
                        DomainConstants.TYPE_PART, // object pattern
                        selectStmts, // object selects
                        null, // relationship selects
                        true, // to direction
            ...
            if (recursionFlag) {
                // Multitenant
                // String msg = i18nNow.getI18nString("emxEngineeringCentral.Alert.RecursionError", "emxEngineeringCentralStringResource",context.getSession().getLanguage());
    ...
    public int multiLevelRecursionCheckForAlternate(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            // Multitenant
            // String msg = i18nNow.getI18nString("emxEngineeringCentral.Alert.RecursionError", "emxEngineeringCentralStringResource",context.getSession().getLanguage().toString());
            String msg = EnoviaResourceBundle.getProperty(context, "emxEngineeringCentralStringResource", context.getLocale(), "emxEngineeringCentral.Alert.RecursionError");
     ...
     * @throws Exception
     */
    public StringList getMfgUsageForSearchTable(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
     ...
     * @throws Exception
     */
    public StringList getBOMLevel(Context context, String[] args) throws Exception {
        StringList slColVal = new StringList();
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList mlObjList = (MapList) programMap.get("objectList");
                ...
                while (itrObjList.hasNext()) {
                    ...
                    if (objectsMapListOne == null)// get Object ids once
                    {
                        ...
                        if (parentPartId != null) {
                            ...
                            objectsMapListOne = pObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EBOM, DomainConstants.TYPE_PART, objectSelects, new StringList(), false, true, (short) 0,
                                    "", null);
                        }
                    }
     ...
     *             if the operation fails.
     */
    public StringList getManufacturingLocationSearchResults(Context context, String[] args) throws FrameworkException {
    ...
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList excludeRelatedItems(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String strChangeId = (String) programMap.get("objectId");
    ...
    /**
     * Returns a StringList of the object ids of Parts which are are used in the context Part's BOM and can be connected as Spare Part for a given context.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a packed HashMap containing objectId of object
    ...
    public String getProjectRoles(Context context, String args[]) throws Exception {
        ...
        if (sPersonId != null && !"".equals(sPersonId)) {
            ...
            orgList = doPerson.getRelatedObjects(context, DomainConstants.RELATIONSHIP_MEMBER, "*", null, relSelectList, true, false, (short) 1, null, // object where clause
                    null);// relationship where clause
            if (!orgList.isEmpty()) {
     ...
     */
    @com.matrixone.apps.framework.ui.IncludeOIDProgramCallable
    public StringList includeCommonParts(Context context, String[] args) throws Exception {
        ...
        StringList relSelects = new StringList();
        MapList commonPartsList = part.getCommonParts(context, selectedObjects, objSelects, relSelects, (short) 1);
     ...
     */
    @com.matrixone.apps.framework.ui.IncludeOIDProgramCallable
    public StringList includeOIDMemberOrganizations(Context context, String[] args) throws Exception {
        ...
        MapList result = dObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_MEMBER, DomainConstants.TYPE_ORGANIZATION, selectStmts, null, true, false, (short) 0, null, null);
     ...
     */
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList excludeECOObjs(Context context, String[] args) throws Exception {
        ...
        if (strObjectId != null) {
            ...
            // String strRDOId = new EngineeringUtil().getAltOwner1Id(context,altowner1);
            ...
            if (strPartOrg != null && strPartOrg.length() > 0) {
                ...
                while (itrChangeObjs.hasNext()) {
                    ...
                    // strECORDOId = new EngineeringUtil().getAltOwner1Id(context, strECOOrg);
            ...
            MapList mapListChangeObjs = doPart.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_AffectedItem"), PropertyUtil.getSchemaProperty(context, "type_Change"),
                    objectSelects, null, true, false, (short) 1, null, null);
     ...
     */
    @com.matrixone.apps.framework.ui.IncludeOIDProgramCallable
    public StringList getDefaultOrg(Context context, String[] args) throws Exception {
        String strDefRDOId = "";
        StringList strlIncludeOIDOrgs = new StringList();
     ...
     *            Context : User's Context.
     * @param strOrg
     *            logged in Default Organization
    ...
    public MapList getUserProjectRoles(Context context, String strOrg) throws Exception {
        ...
        MapList mlProjectRoles = DomainObject.findObjects(context, DomainConstants.TYPE_PERSON, "*", "*", "*", "*", strWhereClause, null, true, objectSelects, (short) 0);
    ...
    public StringList getVPLMProjectLeaders(Context context, String strOrg) throws Exception {
        ...
        String strRolePersonIds = MqlUtil.mqlCommand(context, cmd, "*",
                "assignment.org==\"" + strOrg + "\" && (assignment.parent==\"" + PropertyUtil.getSchemaProperty(context, "role_VPLMProjectLeader") + "\")", "object.id", "|");
     ...
     */
    @com.matrixone.apps.framework.ui.IncludeOIDProgramCallable
    public StringList getRDEDynamicSearch(Context context, String[] args) throws Exception {
     ...
     */
    @com.matrixone.apps.framework.ui.IncludeOIDProgramCallable
    public StringList getRMEDynamicSearch(Context context, String[] args) throws Exception {
    ...
    // ENG Compliance END
    /**
     * Returns a StringList of the Context object id for a given context.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a packed HashMap containing objectId of object
     ...
     */
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList excludeObjectForMassChange(Context context, String[] args) throws Exception {
     ...
     * @param mList
     *            Maplist used to iterate.
     * @param key
     *            the key used to retrieve from the map
     ...
     *            the given map
     * @param key
     *            the given key used to retrieve value form map.
    ...
    public Object getRouteTemplates(Context context, String objWhere) throws Exception {
        ...
        try {
            ...
            if (orgId != null) {
                ...
                templateMapList = templateObj.getRelatedObjects(context, OrgRelPattern.getPattern(), OrgTypePattern.getPattern(), selectStmts, null, false, // modified for bug 352540
                        true, (short) 0, objWhere, null, includeOrgTypePattern, includeOrgRelPattern, null);
            ...
            ExpansionIterator expIter = templateObj.getExpansionIterator(context, DomainConstants.RELATIONSHIP_ROUTE_TEMPLATES, DomainConstants.TYPE_ROUTE_TEMPLATE, selectStmts, new StringList(),
                    false, true, (short) 1, objWhere, null, (short) 0, false, false, (short) 100, false);
    ...
    public ArrayList getBURelatedToPerson(Context context) throws Exception {
        ...
        MapList BUMapList = personObj.getRelatedObjects(context, relPattern.getPattern(), typePattern.getPattern(), selectStmts, null, true, true, (short) 1, objWhere, "", null, null, null);
