...
public class DECemxIntegrationMigrationBase_mxJPO {
     ...
     * @grade 0
     */
    public DECemxIntegrationMigrationBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    private boolean isMcadEcadModel(Context context, String type) throws Exception {
        ...
        while (parentType != null && !parentType.equals("")) {
            if (parentType.equals(TYPE_MCAD_MODEL) || parentType.equals(TYPE_ECAD_MODEL) || parentType.equals(TYPE_MCAD_DRAWING) || parentType.equals(TYPE_MCAD_VERSIONED_DRAWING)
