...
/**
 * IEFListAttachments.java Copyright Dassault Systemes, 1992-2007. All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systemes and its subsidiaries,
 * Copyright notice is precautionary only and does not evidence any actual or intended publication of such program This JPO returns list of all files attached to a BusinessObject $Archive: $
 * $Revision: 1.3$ $Author: ds-kmahajan$ rahulp
 * @since AEF 9.5.2.0
 */
