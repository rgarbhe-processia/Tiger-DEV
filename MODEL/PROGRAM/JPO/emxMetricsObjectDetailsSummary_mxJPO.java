...
/**
 * The <code>emxMetricsObjectDetailsSummary</code> class represents the Object Details Summary functionality for the BM type.
...
public class emxMetricsObjectDetailsSummary_mxJPO extends emxMetricsObjectDetailsSummaryBase_mxJPO {
     ...
     */
    public emxMetricsObjectDetailsSummary_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
