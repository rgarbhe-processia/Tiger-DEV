 ...
 */
public class emxAEFFullSearchUtil_mxJPO extends emxAEFFullSearchUtilBase_mxJPO {
     ...
     * @throws Exception
     */
    public emxAEFFullSearchUtil_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
