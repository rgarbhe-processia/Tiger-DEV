...
public class ManufacturingPlanBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @since DMCPlanning R209
     */
    public ManufacturingPlanBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public MapList getActiveManufacturingPlans(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            StringList slObject = new StringList(ProductLineConstants.SELECT_TYPE);
            ...
            String mpMainDerivedType = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_TYPE;
            String mpMainDerivedTitle = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_ATTRIBUTE_TITLE;
            String mpMainDerivedRevision = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_REVISION;
            String mpMainDerivedId = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_ID;
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getManufacturingPlanBreakdown(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            // Gets the objectids and the relation names from args
            String strObjectid = (String) programMap.get("objectId");
            StringList slObjSelects = new StringList(ProductLineConstants.SELECT_TYPE);
            ...
            slObjSelects.add("to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_ID);
            slObjSelects.add("to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_NAME);
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getParentManufacturingPlan(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments Key- ObjectId which holds contest Object is(product/manufacturing Plan)
     * @return Object - MapList containing the id of Archived Manufacturing Plans objects
     * @throws Exception
     *             if the operation fails
     * @author VZS
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getArchivedManufacturingPlans(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param String
     *            [] - Holds the all the arguments passed by AEF throw structure browser expand. we will use only key= "objectList"
                ...
                if (tempMAp.containsKey("to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.name")) {
                    ...
                    if (exportToExcel) {
                        ...
                        String strTypeIcon = ProductLineCommon.getTypeIconProperty(context,
                                (String) tempMAp.get("to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from." + DomainConstants.SELECT_TYPE));
            ...
            for (Iterator iterator = objectList.iterator(); iterator.hasNext();) {
                ...
                if ((tempMap).containsKey(derivedFromSelectable)) {
                    if (exportToExcel) {
                        ...
                        sbBuffer = sbBuffer.append("<img src=\"images/").append(ProductLineCommon.getTypeIconProperty(context, (String) (tempMap.get(DomainConstants.SELECT_TYPE)))).append("\"")
                                .append("/>").append("<a TITLE=\"\">").append(" ").append(XSSUtil.encodeForXML(context, tempMap.get(derivedFromSelectable).toString())).append("</a>");
        ...
        try {
            ...
            for (int i = 0; i < objectList.size(); i++) {
                ...
                if (exportToExcel) {
                    ...
                    StringBuffer sbBuffer = new StringBuffer(400);
                    sbBuffer = sbBuffer.append("<img src=\"images/").append(ProductLineCommon.getTypeIconProperty(context, type)).append("\"").append("/>").append("<a TITLE=\"\"> ").append(" ")
                            .append(XSSUtil.encodeForXML(context, ((Map) objectList.get(i)).get(DomainConstants.SELECT_NAME).toString())).append("</a>");
            ...
            for (Iterator iterator = objectList.iterator(); iterator.hasNext();) {
                ...
                if (tempMAp.containsKey(titleSelectable)) {
                    ...
                    if (exportToExcel) {
                        ...
                        StringBuffer sbBuffer = new StringBuffer(400);
                        sbBuffer = sbBuffer.append("<img src=\"images/").append(ProductLineCommon.getTypeIconProperty(context, (String) (tempMAp.get(DomainConstants.SELECT_TYPE)))).append("\"")
                                .append("/>").append("<a TITLE=\"\">").append(" ").append(XSSUtil.encodeForXML(context, archivedMPTitle)).append("</a>");
    ...
    public StringList getArchivedState(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strArchState = "";
            String stateArchived = PropertyUtil.getSchemaProperty(context, "policy", ManufacturingPlanConstants.POLICY_ARCHIVED, "state_Archived");
     ...
     * @grade 0
     */
    public String displayContext(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        sb = sb.append(XSSUtil.encodeForXML(context, strContextMap.get(ManufacturingPlanConstants.SELECT_NAME).toString()) + " "
                + XSSUtil.encodeForXML(context, (String) strContextMap.get(ManufacturingPlanConstants.SELECT_REVISION)));
        return sb.toString();
        // Added by KXB for IR-030541 Ends
    }

    /**
     * This will be used in getting the context object icon name revison for property page
     * @param context
     * @param args
     ...
     * @throws Exception
     */
    public String displayContextInPropertyPage(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        String exportFormat = null;
        boolean exportToExcel = false;
        ...
        DomainObject objContext = new DomainObject(strContextId);
        String contextNameSelectable = "to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.name";
        String contextRevisionSelectable = "to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.revision";
        String contextTypeSelectable = "to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.type";
        String contextIDSelectable = "to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.id";
        StringList newList = new StringList();
        ...
        if (strContextMap.containsKey(contextNameSelectable)) {
            if (exportFormat != null && exportFormat.equalsIgnoreCase("CSV")) {
                sb.append(strContextMap.get(contextNameSelectable).toString() + " " + strContextMap.get(contextRevisionSelectable));
            } else {
                String strTemp = "<a TITLE=";
                String strEndHrefTitle = ">";
                String strEndHref = "</a>";
                ...
                sb.append("')\">");
                sb.append(XSSUtil.encodeForHTMLAttribute(context, strContextMap.get(contextNameSelectable).toString()) + " " + strContextMap.get(contextRevisionSelectable));
                sb.append("</A>");
            }
        } else {
            sb.append("");
    ...
    /**
     * This will be used in getting the context object icon name revision for Search page
     * @param context
     * @param args
     *            use args to get objectid from request map.
     * @return
     * @throws Exception
     */
    public StringList displayContextInSearchPage(Context context, String[] args) throws Exception {
        ...
        for (int iCnt = 0; iCnt < objectList.size(); iCnt++) {
            ...
            if (tempMap.containsKey("id")) {
                ...
                objNameRev = (String) strContextMap.get(contextNameSelectable) + " " + (String) strContextMap.get(contextRevisionSelectable);
    ...
    /**
     * This Methods is used to create Manufacturing Plan object with derived from relationship
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
    ...
    public String createManufacturingPlan(Context context, String[] args) throws Exception {
        try {
            // TODO: License Check
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap requestMap = (HashMap) programMap.get("requestMap");
    ...
    /**
     * This Methods is Access Program for Derived From Field in Create Manufacturing Plan web form
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
     ...
     * @grade 0
     */
    public boolean isDerivedFrom(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
    ...
    /**
     * This Methods is Used to display derived from field in Create Manufacturing Plan Web form
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
     ...
     * @grade 0
     */
    public String displayDerivedFrom(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap requestMap = (HashMap) programMap.get("requestMap");
            String strReturn = null;
            String strDerivedFrom = (String) requestMap.get("copyObjectId");
            if (strDerivedFrom != null && !strDerivedFrom.equals("") && !strDerivedFrom.equals("null")) {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList expandManufacturingPlanMatrix(Context context, String[] args) throws Exception {
    ...
    /**
     * This method is used to get all the Manufacturing Plans/Managed Revisions in the Product Context Dynamic Column Behavior to show the Manufacturing Plans/Managed Revisions
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public MapList getManufacturingPlansWithManagedRevisions(Context context, String args[]) throws Exception {
        ...
        if (domObjId.isKindOf(context, ManufacturingPlanConstants.TYPE_MODEL)) {
            ...
            if (selectIds.endsWith(",")) {
                ...
                mpSelected = selectIds.substring(0, j);
        ...
        try {
            ...
            if (objType != null) {
                ...
                mapChildObjsList = domProdObj.getRelatedObjects(context, stbRelSelect.toString(), stbTypeSelect.toString(), selectStmts, relSelects, false, true, (short) 1, stbObjWhere.toString(),
                        null, (short) limit);
            }
    ...
    /**
     * This method is used to get all the Managed Revisions(Technical Features)for display in Managed Revision column(programHTMLOutput)of the View Manufacturing Plan Matrix
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the program Map contents
            ...
            for (int i = 0; i < objectList.size(); i++) {
                ...
                if ((model != null && model)) {
                    ...
                    if (isUndefined) {
                        ...
                        String strNonEncodedPFName = (String) mp.get(DomainObject.SELECT_NAME) + " " + (String) mp.get(DomainObject.SELECT_REVISION);
                        String strEncodedPFName = XSSUtil.encodeForXML(context, (String) mp.get(DomainObject.SELECT_NAME)) + " "
                                + XSSUtil.encodeForXML(context, (String) mp.get(DomainObject.SELECT_REVISION));
                        StringBuffer sb = new StringBuffer();
                        if ((exportFormat != null) && (exportFormat.length() > 0) && ("CSV".equals(exportFormat))) {
    ...
    /**
     * This method is used to get all the Manufacturing Plans for display in Manufacturing Plan column(programHTMLOutput)of the View Manufacturing Plan Matrix
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the program Map contents
    ...
    /**
     * This is method is used to retrieve the "Feature Allocation Type" attribute value of Master Feature of the Technical feature if present.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
        ...
        try {
            ...
            if (lstObjectIdsList.size() != 0) {
                for (int iCnt = 0; iCnt < lstObjectIdsList.size(); iCnt++) {
                    ...
                    if (mxType.isOfParentType(context, strType, ManufacturingPlanConstants.TYPE_LOGICAL_FEATURE) || mxType.isOfParentType(context, strType, ManufacturingPlanConstants.TYPE_PRODUCTS)
                            && (strRootNode == null || (strRootNode.equals("")) || ("null".equalsIgnoreCase(strRootNode)))) {
                        // Changed the code to fix the performance issue - IR-044262V6R2011
                        String strFATAttribute = "to[" + ManufacturingPlanConstants.RELATIONSHIP_LOGICAL_FEATURES + "].tomid[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST
                        ...
                        if (featAllocation instanceof StringList) {
                            ...
                            strFeatureUsageDisplay = EnoviaResourceBundle.getProperty(context, "Configuration", strFeatureUsage + strFATValue, languageStr);
    ...
    /**
     * This is method is used to retrieve the "Name" if object is Manufacturing Plan or else display blank in cell value.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
            ...
            for (int i = 0; i < lstObjectIdsList.size(); i++) {
                ...
                if (mxType.isOfParentType(context, strType, ManufacturingPlanConstants.TYPE_MANUFACTURING_PLAN)) {
                    ...
                    if (exportToExcel) {
                        ...
                        sb = sb.append(XSSUtil.encodeForXML(context, strMPNameValue)).append(strEndTitle).append(strStartImage).append(strImageURL).append(strImageEnd)
                                .append(XSSUtil.encodeForXML(context, strMPNameValue)).append(strEndHref);
    ...
    /**
     * This is method is used to retrieve the current State value if object is Manufacturing Plan or else display blank in cell value.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
        ...
        try {
            ...
            for (int i = 0; i < objectList.size(); i++) {
                ...
                if (mxType.isOfParentType(context, strType, ManufacturingPlanConstants.TYPE_MANUFACTURING_PLAN)) {
                    ...
                    i18strState = i18nNow.getStateI18NString(ManufacturingPlanConstants.POLICY_MANUFACTURING_PLAN, strState, context.getSession().getLanguage());
    ...
    /**
     * This is connection program .It is called on "Apply" in Edit Page In this MP is connected /removed from Technical Feature depending on the Markup.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments * @throws Exception if the operation fails
     * @since R209
     * @author IXH
     */
            ...
            for (int i = 0; i < chgRowsMapList.size(); i++) {
                ...
                if (markUpMode.equalsIgnoreCase("add")) {
                    ...
                    try {
                        // Connect the New MP
                        /*
                         * DomainRelationship .connect(context, new DomainObject(strselObjId), new RelationshipType(ManufacturingPlanConstants.RELATIONSHIP_MANUFACTURING_PLAN_BREAKDOWN), new
                         * DomainObject(strSelObjId));
                         */

                        /*
                         * ManufacturingPlan manufacturingPlan = new ManufacturingPlan(childObjId); Relationship rel = (Relationship) manufacturingPlan.connectManufacturingPlan(context, strselObjId,
                            ...
                            if (strCntxtBrkDownMPId != null && strCntxtBrkDownMPId.equalsIgnoreCase(strselObjId)) {
                                ...
                                if (strContxtProductId != null) {
                                    if (strContxtProductId.equalsIgnoreCase(strRootObjectId)) {
                                        ...
                                        MapList mp = domConnectedMPId.getRelatedObjects(context, relPattern, objPattern, objSelects, relSelects, true, false, (short) 0, whereClause, null, 0);
    ...
    /**
     * This Method is Access Program for "Edit ManufacturingPlan Breakdown" command to display only if Parent(context) is products
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
    ...
    public boolean isContextTypeProducts(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            String strObjectid = (String) programMap.get("objectId");
    ...
    /**
     * This method is called by trigger to delete Manufacturing Plan Master when last revision of Manufacturing Plan is deleted.
     * @param context
     * @param args
     *            []
     * @return
     * @throws Exception
     * @author WPK
     * @since CFP R209 Reusing it in R212_DA
     */

    public int deleteManufacturingPlanMaster(Context context, String args[]) throws Exception {
        int iResult = 0;
        try {
            // get the context object which is deleted from the trigger.
            ...
            String selectMPMObjId = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MANAGED_ROOT + "].from.id";
     ...
     * @grade 0
     */
    public StringList displayContextInMPSummary(Context context, String[] args) throws Exception {
        StringList ctxtList = new StringList();
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objectList = (MapList) programMap.get("objectList");
        ...
        for (int iCnt = 0; iCnt < objectList.size(); iCnt++) {
            ...
            if (tempMap.containsKey("to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.name")) {
                ...
                if (exportToExcel) {
                    ...
                    sb = sb.append("\"\"").append(strEndHrefTitle).append("<img border=\'0\' src=\'../common/images/" + XSSUtil.encodeForHTMLAttribute(context, strTypeIcon) + "\'/>")
    ...
    /**
     * This will be column JPO which will show the derived from column details depending on the policy.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     * @return String list containing HTML code, to render derived from columns data in Table
     * @throws Exception
     */
    public StringList displayDerivedFromInColumn(Context context, String[] args) throws Exception {
        StringList derivedFromList = new StringList();
        try {
            // Unpacking the args
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            ...
            StringList newList = new StringList();
            String derivedFromSelectableName = "from[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].to." + DomainConstants.SELECT_NAME;
            String derivedFromSelectableID = "from[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].to." + DomainConstants.SELECT_ID;
            String derivedFromSelectableType = "from[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].to." + DomainConstants.SELECT_TYPE;
            String derivedFromSelectablePolicy = "from[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].to." + DomainConstants.SELECT_POLICY;
            ...
            for (Iterator iterator = objectList.iterator(); iterator.hasNext();) {
                ...
                if ((tempMap).containsKey(DomainConstants.SELECT_ID)) {
                    String planId = tempMap.get(DomainConstants.SELECT_ID).toString();
                    DomainObject planObjectID = new DomainObject(planId);
                    ContextUtil.pushContext(context, PropertyUtil.getSchemaProperty(context, "person_UserAgent"), DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
                    Map strContextMap = planObjectID.getInfo(context, newList);
                    ContextUtil.popContext(context);
                    ...
                    if (strContextMap.containsKey(derivedFromSelectableID)) {
                        if (exportToExcel) {
                            derivedFromList.add(strContextMap.get(derivedFromSelectableName).toString());
                        } else {
                            // Check if Derived from Plan is in archived state.
                            if (strContextMap.get(derivedFromSelectablePolicy).equals(ManufacturingPlanConstants.POLICY_ARCHIVED)) {
                                StringBuffer sbBuffer = new StringBuffer(400);
                                sbBuffer = sbBuffer.append("<img src=\"images/").append(ProductLineCommon.getTypeIconProperty(context, (String) (strContextMap.get(derivedFromSelectableType))))
                                        .append("\"").append("/>").append("<a TITLE=\"\">").append(" ").append(XSSUtil.encodeForXML(context, strContextMap.get(derivedFromSelectableName).toString()))
                                        .append("</a>");
                                derivedFromList.add(sbBuffer.toString());
                                ...
                                StringBuffer sbBuffer = new StringBuffer(400);
                                sbBuffer = sbBuffer.append("<img src=\"images/").append(ProductLineCommon.getTypeIconProperty(context, (String) (strContextMap.get(derivedFromSelectableType))))
                                        .append("\"").append("/>").append("<a TITLE=\"\">").append("</a>");

                                sbBuffer.append("<A class=\"object\" HREF=\"javascript:showDetailsPopup('../common/emxTree.jsp?objectId=");
                                sbBuffer.append(strContextMap.get(derivedFromSelectableID));
                                sbBuffer.append("')\">");
                                sbBuffer.append(XSSUtil.encodeForXML(context, strContextMap.get(derivedFromSelectableName).toString()));
                                sbBuffer.append("</A>");
            ...
            throw new FrameworkException("displayDerivedFromInMPSummary===" + e.getMessage());
        }
        return derivedFromList;
    }

    /**
     * This will be used in getting the derived from object's icon name for property page
     * @param context
     * @param args
     *            use args to get objectid from request map.
     * @return
     ...
     */
    public String displayDerivedFromPropertyPage(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        String exportFormat = null;
        boolean exportToExcel = false;
        ...
        String strDerivedAbstractId = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_ID;
        String strDerivedAbstractName = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_NAME;
        String strDerivedAbstractType = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_TYPE;
        String strDerivedAbstractTitle = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_ATTRIBUTE_TITLE;
        String strDerivedAbstractRevision = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_REVISION;
        ...
        String mpMainDerivedType = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_TYPE;
        String mpMainDerivedTitle = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_ATTRIBUTE_TITLE;
        String mpMainDerivedRevision = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_REVISION;
        String mpMainDerivedId = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_ID;

        String mpDerivedType = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_TYPE;
        String mpDerivedTitle = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_ATTRIBUTE_TITLE;
        String mpDerivedRevision = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_REVISION;
        String mpDerivedId = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_ID;
        ...
        if ((strContextMap).containsKey(DomainConstants.SELECT_ID)) {
            ...
            if (exportToExcel == true) {
                ...
                sbBuffer.append("<img border=\'0\' src=\"images/").append(ProductLineCommon.getTypeIconProperty(context, (String) (strDerivedFromType))).append("\"").append("/>")
                        .append("<a TITLE=\"\">").append("</a>");
                sbBuffer.append("<A class=\"object\" HREF=\"javascript:showDetailsPopup('../common/emxTree.jsp?objectId=");
    ...
    /**
     * Added for IR-038813V6R2011 This Methods is Access Program for command "Create Manufacturing Plan" and "Create Manufacturing Plan From"
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
     ...
     * @grade 0
     */
    public boolean isMPAssociatedToHigherRev(Context context, String[] args) throws Exception {
        try {
    ...
    /**
     * This method is called by trigger on ChangeName of Model / MasterFeature to change the Name of the associated MPM object Name.
     * @param context
     * @param args
     *            [] args[0] - Object ID of Model/Master Feature args[1] - New Name of Model/Master Feature
    ...
    /**
     * This is a trigger method called on Managed Series relationship used to connect the newly created Manufacturing Plan to the revision chain.
     * @param context
     *            - Matrix Context object
     * @param args
     *            - args[0] - contains the newly created Manufacturing Plan Id args[1] - contains the Manufacturing Plan Master Object Id which is connected to the MF through Managed Series
     *            relationship args[2] - contains the newly created Manufacturing Plan Type
     * @return iResult - 0 - if the operation is success 1 - if the operation fails
     * @throws Exception
     * @author IVU
     * @since CFP R210
     */
    ...
    public int connectToPreviousRevision(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            if (strMPId != null && !strMPId.equals("") && strMPMId != null && !strMPMId.equals("")) {
                ...
                if (mxType.isOfParentType(context, dom.getInfo(context, DomainObject.SELECT_TYPE), ManufacturingPlanConstants.TYPE_MANUFACTURING_PLAN_MASTER)) {
                    ...
                    MapList mManagedMPs = dom.getRelatedObjects(context, strRelName, "*", objSelects, relSelectsList, false, true, (short) 0, strObjWhere, DomainConstants.EMPTY_STRING, (int) 1, null,
                            null, null);
                    String strTempMPId = "";
     ...
     * @param context
     * @param objId
     *            - Object ID of the Newly created Manufacturing Plan
     * @param objParentOID
     *            - The Context Object under which the Manufacturing Plan is created
    ...
    private String getManufacturingPlanRevision(Context context, String objId, String objParentOID) throws FrameworkException {
        String strLatestRev = "";
        try {
            if (objId != null && !objId.equals("") && objParentOID != null && !objParentOID.equals("")) {
                ManufacturingPlan mpBean = new ManufacturingPlan();
                String strMaster = mpBean.getMasterFromContext(context, objParentOID);

                String strMPM = null;
                if (strMaster != null && !strMaster.equals("") && !strMaster.equals("null")) {
            ...
            if (objectList != null && !objectList.isEmpty()) {
                ...
                for (Object mapObj : objectList) {
                    ...
                    if (objectMap != null && !objectMap.isEmpty()) {
                        ...
                        if (objectMapId != null && !objectMapId.isEmpty()) {
                            String strParentId = getParentIdFromObjectMap(context, objectMap, paramMap); // IR-373374-3DEXPERIENCER2016x: Exception given when user clicks on Name link of Manufacturing
                                                                                                         // plan
                ...
                while (objectListItr.hasNext()) {
                    ...
                    if (objectMap != null && !objectMap.isEmpty()) {
                        ...
                        if (strParentId != null && domParentObject.isKindOf(context, ManufacturingPlanConstants.TYPE_MANUFACTURING_PLAN)) {
                            ...
                            Iterator checkStatusItr = sCheckStatusList.iterator();
                            while (checkStatusItr.hasNext()) {
                                sStatusObject = (String) checkStatusItr.next();
                                if (sStatusObject != null && !sStatusObject.equals("")) {
                            ...
                            if (objectMapId != null && !objectMapId.equalsIgnoreCase("") && domManuPlan.isKindOf(context, ManufacturingPlanConstants.TYPE_MANUFACTURING_PLAN) && strParentId != null
                                    && !"".equalsIgnoreCase(strParentId)) {
                                ...
                                if (relatedDesignObjects != null && !relatedDesignObjects.isEmpty()) {
                                    ...
                                    if (unresolvedDesignToImplementObjects != null && !unresolvedDesignToImplementObjects.isEmpty()) {
                                        sBuffer.append("<center><img src=\"../common/images/" + XSSUtil.encodeForHTMLAttribute(context, iconMPBORDesign) + "\" border=\"0\"" + " alt=\""
                                                + XSSUtil.encodeForHTMLAttribute(context, strToolTip) + "\" title=\"" + XSSUtil.encodeForHTMLAttribute(context, strToolTip) + "\"/></center>");
                                    }
    ...
    /**
     * This method should return the structure for the Manufacturing Plan Breakdown edition: Level 1: all Product/Feature revisions connected to the context Manufacturing Plan through Manufacturing
     * Plan Implements Level 2: Manufacturing Plan connected to the context Manufacturing Plan through Manufacturing Plan Breakdown which belongs to the level 1 Product/Feature revision or one of its
     * previous revisions
     * @param context
     * @param args
     * @return
    ...
    public MapList getManufacturingPlanEditBreakdown(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strFATAttribute = "to[" + ManufacturingPlanConstants.RELATIONSHIP_LOGICAL_FEATURES + "].tomid[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST + "].attribute["
            ...
            MapList relatedMPBreakdownObjects = new DomainObject(selObjId).getRelatedObjects(context, relationshipType, objectType, objectSelects, relationshipSelects, false, // to relationship
                    true, // from relationship
                    (short) 1, objectWhereClause.toString(), // objectWhereClause
            ...
            if (objectId != null && !objectId.equalsIgnoreCase("")) {
                ...
                if (domObject.isKindOf(context, ManufacturingPlanConstants.TYPE_MANUFACTURING_PLAN) && isFirst) {
                    MapList relatedImplements = domObject.getRelatedObjects(context, relationshipType, objectType, objectSelects, relationshipSelects, false, // to relationship
                            true, // from relationship
                            (short) 1, DomainConstants.EMPTY_STRING, // objectWhereClause
                    ...
                    for (int i = 0; i < relatedImplements.size(); i++) {
                        ...
                        StringList slRevId = ManufacturingPlanUtil.convertObjToStringList(context, revid);
                        ...
                        if (relatedAvailableManuPlans != null && !relatedAvailableManuPlans.isEmpty()) {
                            ...
                            while (relatedAvailableManuPlansItr.hasNext()) {
                                ...
                                if (relatedAvailableManuPlan != null && !relatedAvailableManuPlan.isEmpty()) {
                                    ...
                                    if (relatedAvailableManuPlanId != null && !relatedAvailableManuPlanId.equalsIgnoreCase("") && relatedMPBreakdownObjects != null
                                            && !relatedMPBreakdownObjects.isEmpty()) {
                                        ...
                                        while (relatedMPBreakdownObjectsItr.hasNext()) {
                                            ...
                                            if (relatedMPBreakdownObject != null && !relatedMPBreakdownObject.isEmpty()) {
                                                ...
                                                if (relatedMPBreakdownObjectId != null && !relatedMPBreakdownObjectId.equalsIgnoreCase("")
                                                        && relatedMPBreakdownObjectId.equalsIgnoreCase(relatedAvailableManuPlanId)) {
                        ...
                        if (!associatedId.equalsIgnoreCase(selectedRevId)) {
                            if (manufacturingIntent != null && !manufacturingIntent.equalsIgnoreCase("")) {
                                if (manufacturingIntent.equalsIgnoreCase("Regular")) {
                                    strToolTip = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.NotCompliant.ToolTip", context.getSession().getLanguage());
                                    sBuffer.append("<center><img src=\"../common/images/" + XSSUtil.encodeForHTMLAttribute(context, iconMPBNotCompliant) + "\" border=\"0\"" + " alt=\""
                                            + XSSUtil.encodeForHTMLAttribute(context, strToolTip) + "\" title=\"" + XSSUtil.encodeForHTMLAttribute(context, strToolTip) + "\" /></center>");
                                } else {
                                    ...
                                    if (index == -1) {
                                        ...
                                        strToolTip = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.Retrofit.ToolTip", context.getSession().getLanguage());
                                        sBuffer.append("<center><img src=\"../common/images/" + XSSUtil.encodeForHTMLAttribute(context, iconMPBCompliantWithRetrofit) + "\" border=\"0\"" + " alt=\""
                                                + XSSUtil.encodeForHTMLAttribute(context, strToolTip) + "\" title=\"" + XSSUtil.encodeForHTMLAttribute(context, strToolTip) + "\" /></center>");
                                    }
                            ...
                            strToolTip = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.Compliant.ToolTip", context.getSession().getLanguage());
                            sBuffer.append("<center><img src=\"../common/images/" + XSSUtil.encodeForHTMLAttribute(context, iconMPBCompliant) + "\" border=\"0\"" + " alt=\""
                                    + XSSUtil.encodeForHTMLAttribute(context, strToolTip) + "\" title=\"" + XSSUtil.encodeForHTMLAttribute(context, strToolTip) + "\" /></center>");
                        } else {
                            sBuffer.append("");
                        }
    ...
    /**
     * This method is used to get all the check column for Manufacturing Plans for display in Check column(programHTMLOutput)of the View Manufacturing Plan Matrix
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the program Map contents
    ...
    @com.matrixone.apps.framework.ui.PostProcessCallable
    public Map refreshManufacturingPlanEditBreakdown(Context context, String[] args) throws Exception {
        ...
        String relationshipType = ManufacturingPlanConstants.RELATIONSHIP_MANUFACTURING_PLAN_BREAKDOWN + "," + ManufacturingPlanConstants.RELATIONSHIP_MANUFACTURING_PLAN_IMPLEMENTS;

        String objectType = ManufacturingPlanConstants.TYPE_MANUFACTURING_PLAN + "," + ManufacturingPlanConstants.TYPE_PRODUCTS;
        ...
        final String SELECT_FEATURE_PARENT_ID = "to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.to[" + ManufacturingPlanConstants.RELATIONSHIP_MANAGED_REVISION
                + "].from.id";
        final String SELECT_FEATURE_PARENT_NAME = "to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.to["
                + ManufacturingPlanConstants.RELATIONSHIP_MANAGED_REVISION + "].from.name";
        final String SELECT_PRODUCT_PARENT_ID = "to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.to[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCTS
                + "].from.id";
        final String SELECT_PRODUCT_PARENT_NAME = "to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.to[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCTS
                + "].from.name";
        ...
        MapList relatedMPBreakdownObjects = domSelObj.getRelatedObjects(context, relationshipType, objectType, objectSelects, relationshipSelects, false, // to
                true, // from relationship
        ...
        if (MPBmap.size() != 0 && MPBmap.size() == 1) {
            Map mpMap = (Map) MPBmap.get(0);
            String connId = (String) mpMap.get(DomainConstants.SELECT_RELATIONSHIP_ID);
            DomainRelationship domrelBD = new DomainRelationship(connId);
            domrelBD.setAttributeValue(context, ManufacturingPlanConstants.ATTRIBUTE_MANUFACTURING_PLAN_PREFERRED, "Yes");
            ...
            for (int i = 0; i < MPImap.size(); i++) {
                ...
                for (int k = 0; k < MPBmap.size(); k++) {
                    ...
                    String pId = (String) MPBproductMap.get("to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.id");
                ...
                if (!flag && newMPBmap.size() != 0) {
                    ...
                    DomainRelationship domrelBD = new DomainRelationship(connId);
                    domrelBD.setAttributeValue(context, ManufacturingPlanConstants.ATTRIBUTE_MANUFACTURING_PLAN_PREFERRED, ManufacturingPlanConstants.RANGE_VALUE_YES);
                }
                newMPBmap.clear();
    ...
    public Map getRangeValuesForPreferred(Context context, String[] args) throws Exception {
        ...
        List attributeDisplayRange = i18nNow.getAttrRangeI18NStringList(ManufacturingPlanConstants.ATTRIBUTE_MANUFACTURING_PLAN_PREFERRED, (StringList) attributeRange,
    ...
    /**
     * This method is used to get the range values for Manufacturing Intent Attribute.
     * @param context
     *            The ematrix context object.
     * @param String
     *            [] The args .
     ...
     * @since CFPR211
     */
    public TreeMap getRangeValuesForManufacturingIntent(Context context, String[] args) throws Exception {
        ...
        List attributeDisplayRange = i18nNow.getAttrRangeI18NStringList(ManufacturingPlanConstants.ATTRIBUTE_MANUFACTURING_INTENT, (StringList) attributeRange, context.getSession().getLanguage());
        for (int i = 0; i < attributeRange.size(); i++) {
            strMPIntent = (String) attributeRange.get(i);
            strMPIntentI18Now = strMPIntent.replace(chBlank, chUnderScore);
            strMPIntentValueKey = "emxFramework.Range.Manufacturing_Intent." + strMPIntentI18Now.toString();
            strMPIntentDisplay = EnoviaResourceBundle.getProperty(context, "Framework", strMPIntentValueKey, strLanguage);
            rangeMap.put(strMPIntentDisplay, (String) attributeRange.get(i));
        }
    ...
    private MapList getAllAssociatedManufacturingPlans(Context context, String objectId) throws Exception {
        ...
        try {
            if (objectId != null && !objectId.equalsIgnoreCase("")) {
                ...
                returnMapList = domMasterObj.getRelatedObjects(context, strRelPattern, strTypePattern, objectSelects, relationshipSelects, false, // to relationship
                        true, // from relationship
                        (short) 2, DomainConstants.EMPTY_STRING, // objectWhereClause
                        DomainConstants.EMPTY_STRING, // relationshipWhereClause
                        0, strTypeIncludePattern, null, null);
            }
        } catch (Exception e) {
            throw new FrameworkException((String) e.getMessage());
        } finally {
            ...
            for (int h = 0; h < objectList.size(); h++) {
                ...
                if (strType != null && mxType.isOfParentType(context, strType, ManufacturingPlanConstants.TYPE_PRODUCTS)) {
                    if (null != strProductStructureMPId && !"null".equals(strProductStructureMPId) && !"".equals(strProductStructureMPId)) {
                        ...
                        final String SELECT_CONTEXT_PRODUCT = "to[" + ManufacturingPlanConstants.RELATIONSHIP_LOGICAL_FEATURES + "].tomid["
                        ...
                        for (int k = 0; k < mlProductsMPs.size(); k++) {
                            ...
                            // StringList strFeatParId = (StringList)dmoProduct.getInfoList(context,
                            // "to["+ManufacturingPlanConstants.RELATIONSHIP_LOGICAL_FEATURES+"].tomid["+ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST+"].from.id");
     ...
     * @throws Exception
     */
    public void disconnectManufacturingPlanOnLFReplace(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList Result = confUtil.getObjectStructure(context, ManufacturingPlanConstants.TYPE_MANUFACTURING_PLAN, ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN,
                    objeSelects, new StringList(), true, true, 0, 0, "", "", (short) 1, "");
            if (Result.size() != 0) {
     ...
     * @throws FrameworkException
     */
    public int disconnectManufacturingPlanOfProduct(Context context, String args[]) throws FrameworkException {
        int iResult = 0;
        // retrieve the RPE variable value for design choice
        String designValue = PropertyUtil.getGlobalRPEValue(context, "designChoice");
        String fromDesignEffectivity = PropertyUtil.getGlobalRPEValue(context, "fromDesignEffectivity");
        ...
        try {
            ...
            /*
             * Retrieve Indent of MP and check if it is Retrofit MP If RetrofitMP then get MPs connected to it through MP Breakdown Step I - For each MP, connected through MP Breakdown, find its
             * Product using Associated MP relationship Step II - Also, find out Relationship ID of the same. Step III - Retrieve Backward derivation Chain of de-selected product from design
             * effectivity if "Backward derivation Chain from Step III" contains "Product from Step I" then add "Relationship ID from Step II" to array, elements of which will be disconnected.
             */
            ...
            mlProductMPs = domobj.getRelatedObjects(context, stbRelSelect.toString(), stbTypeSelect.toString(), selectStmts, relSelects, false, true, (short) 1, EMPTY_STRING, null, 0, null, null,
                    null);
            ...
            for (int i = 0; i < mlProductMPs.size(); i++) {
                ...
                stbRelSelect1.append(ManufacturingPlanConstants.RELATIONSHIP_MANUFACTURING_PLAN_BREAKDOWN);
                // type Pattern
                StringBuffer stbTypeSelect1 = new StringBuffer(50);
                stbTypeSelect1.append(ManufacturingPlanConstants.TYPE_MANUFACTURING_PLAN);
                // Object Selects
                ...
                if (Indent.equalsIgnoreCase(ManufacturingPlanConstants.RANGE_VALUE_RETROFIT)) {
                    if (fromDesignEffectivity.equalsIgnoreCase("True")) {
                        ...
                        mLMPinfo = dmoMP.getRelatedObjects(context, stbRelSelect1.toString(), stbTypeSelect1.toString(), selectStmts1, relSelects1, false, true, (short) 1,
                                DomainConstants.EMPTY_STRING, null, 0, null, null, null);
                        Map mMPInfo1 = null;
                ...
                if (!Indent.equalsIgnoreCase(ManufacturingPlanConstants.RANGE_VALUE_RETROFIT)) {
                    ...
                    StringList slMPBConnections = domObjToDisconnect.getInfoList(context, "from[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].to.to["
                            + ManufacturingPlanConstants.RELATIONSHIP_MANUFACTURING_PLAN_BREAKDOWN + "].id");
                    ...
                    String relPattern = ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "," + ManufacturingPlanConstants.RELATIONSHIP_MANUFACTURING_PLAN_BREAKDOWN;
                    String objPattern = ManufacturingPlanConstants.TYPE_MANUFACTURING_PLAN;
                    String objectWhere = "to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.id==" + strFromID + "||to["
                            + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.id==" + strToID + "";
                    // getting the MPB's Ids
                    MapList result = domobj.getRelatedObjects(context, relPattern, objPattern, slObjSelect, null, false, true, (short) 2, objectWhere, null, 0);

                    for (int j = 0; j < result.size(); j++) {
                        Map resMap = (Map) result.get(j);
                        Object mpBrekdownRelID = resMap.get(sb.toString());
                        sListMPRelIds.addAll(ManufacturingPlanUtil.convertObjToStringList(context, mpBrekdownRelID));
                    }
            ...
            // the mp's
            if (fromDesignEffectivity.equalsIgnoreCase("True")) {
                if (sListMPRelIds.size() != 0 && designValue.equalsIgnoreCase("yes")) {
                    String[] sArrMPRelIds = new String[sListMPRelIds.size()];
                    sArrMPRelIds = (String[]) sListMPRelIds.toArray(sArrMPRelIds);
    ...
    /**
     * This method is called by trigger when user tries to promote Manufacturing Plan from Preliminary to Release state.
     * @param context
     * @param args
     *            []
     * @return
    ...
    public boolean CheckAssociatedPlan(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            // Getting the String to be Displayed in the Error alert.
            String strAlertMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.Alert.PolicyManufacturingPlanStatePreliminaryPromoteCheck", language);
            ...
            MapList returnMapList = domParentObj.getRelatedObjects(context, strRelPattern, strTypePattern, objectSelects, relationshipSelects, false, // to relationship
                    true, // from relationship
                    (short) 1, DomainConstants.EMPTY_STRING, // objectWhereClause
                    DomainConstants.EMPTY_STRING, // relationshipWhereClause
                    0, null, null, null);
            ...
            while (modelIter.hasNext()) {
                ...
                DomainObject domMasterObj = new DomainObject(masterId);
                returnMPList = domMasterObj.getRelatedObjects(context, strRelPattern2, strTypePattern2, objectSelects2, relationshipSelects, false, // to relationship
                        true, // from relationship
                        (short) 2, DomainConstants.EMPTY_STRING, // objectWhereClause
                        DomainConstants.EMPTY_STRING, // relationshipWhereClause
                        0, strTypeIncludePattern, null, null);
                ...
                for (int i = 0; i < returnMPList.size(); i++) {
                    ...
                    String plansId = (String) resMap.get(DomainConstants.SELECT_ID);
                    slMps.add(plansId);
                }
        ...
        try {
            ...
            for (int iXount = 0; iXount < prdsIds.size(); iXount++) {
                ...
                for (int j = 0; j < revids.size(); j++) {
                    ...
                    MapList result = domobj.getRelatedObjects(context, relPattern, objPattern, slObjSelect, null, true, true, (short) 1, "", null, limit);

                    if (result.size() != 0) {
                        for (int i = 0; i < result.size(); i++) {

                            Map resMap = (Map) result.get(i);
                            Object plansId = resMap.get(DomainConstants.SELECT_ID);

                            StringList checkBreakdown = ManufacturingPlanUtil.convertObjToStringList(context, plansId);
                            StringBuffer sb = new StringBuffer();
    ...
    /**
     * private method which will be called on rendendering check icon in case of MPB from Product and MP context
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * Program defined to return Maplist which will hold Manufacturing Plan which are in the Main Derivation Chain, called in as program for the Model->MP Derivation table
     * @param context
     *            Matrix context
     * @param args
     * @return
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getManufacturingPlanDerivationChain(Context context, String[] args) throws FrameworkException {
        MapList mlMPDerivation = new MapList();
        try {
            ...
            mlMPDerivation = DerivationUtil.getDerivationStructure(context, objectID, ManufacturingPlanConstants.TYPE_MANUFACTURING_PLAN, firstLevel, level, limit);
     ...
     * @since CFP R212Derivations
     */
    public List getDerivationType(Context context, String args[]) throws FrameworkException {

        List derivationTypeList = new StringList();

        try {
            String strLanguage = context.getSession().getLanguage();
            String strDerivation = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.MPDerivation.DerivationType.Derivation", strLanguage);
            String strRevision = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.MPDerivation.DerivationType.Revision", strLanguage);

            String mpMainDerivedID = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED + "].from." + ProductLineConstants.SELECT_ID;
            ...
            for (int i = 0; i < lstObjectIdsList.size(); i++) {
                ...
                if (tempMap.containsKey(mpMainDerivedID)) {
                    ...
                    String domCurrentMPID = (String) (tempMap).get(DomainConstants.SELECT_ID);
                    ...
                    if (strDerivationType.equalsIgnoreCase(DerivationUtil.DERIVATION_TYPE_REVISION)) {
                        derivationType = strRevision;
                    } else if (strDerivationType.equalsIgnoreCase(DerivationUtil.DERIVATION_TYPE_DERIVATION)) {
                        derivationType = strDerivation;
                    } else {
                        derivationType = "";
                    }
     ...
     * @since CFP R212Derivations
     */
    public StringList getDerivedFrom(Context context, String[] args) throws FrameworkException {
        StringList derivedFromList = new StringList();
        try {
            String strLanguage = context.getSession().getLanguage();
            String strRoot = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.MPDerivation.DerivationType.Root", strLanguage);
            ...
            for (Iterator iterator = objectList.iterator(); iterator.hasNext();) {
                ...
                if ((tempMap).containsKey(DomainConstants.SELECT_ID)) {
                    ...
                    if (tempMap.containsKey(mpMainDerivedTitle)) {
                        String mpTitle = (String) tempMap.get(mpMainDerivedTitle);
                        String mpRevision = (String) tempMap.get(mpMainDerivedRevision);
                        String mpId = (String) tempMap.get(mpMainDerivedId);
                        String mpType = (String) tempMap.get(mpMainDerivedType);
                        StringBuffer sbBuffer = new StringBuffer(400);
                        if ((exportFormat != null) && (exportFormat.length() > 0) && ("CSV".equals(exportFormat))) {
                            sbBuffer = sbBuffer.append(mpTitle).append(" ").append(mpRevision);
                        } else {
                            ...
                            if (!"HTML".equalsIgnoreCase(exportFormat)) {
                                ...
                                sbBuffer.append(XSSUtil.encodeForHTMLAttribute(context, (String) tempMap.get(mpMainDerivedId)));
                                sbBuffer.append("')\">");
                            }

                            sbBuffer.append(XSSUtil.encodeForXML(context, mpTitle)).append(" ").append(XSSUtil.encodeForXML(context, mpRevision));
                            if (!"HTML".equalsIgnoreCase(exportFormat))
                                sbBuffer.append("</a>");
                        }
                        derivedFromList.add(sbBuffer.toString());
                        ...
                        String domCurrentMPID = (String) (tempMap).get(DomainConstants.SELECT_ID);
                        boolean isRootNode = DerivationUtil.isRootNode(context, domCurrentMPID);
                        if (isRootNode) {
                            derivedFromList.add(strRoot);
                        } else {
                            ManufacturingPlan mpBean = new ManufacturingPlan(domCurrentMPID);
                            Map mpDerivedFrom = mpBean.getManufacturingPlanParent(context);
                            String strFromMPType = (String) mpDerivedFrom.get(DomainObject.SELECT_TYPE);
                            String strFromMPTitle = (String) mpDerivedFrom.get(ManufacturingPlanConstants.SELECT_ATTRIBUTE_TITLE);
                            String strFromMPRevision = (String) mpDerivedFrom.get(DomainObject.SELECT_REVISION);
                            String strFromMPId = (String) mpDerivedFrom.get(DomainObject.SELECT_ID);
                            StringBuffer sbBuffer = new StringBuffer(400);
                            if ((exportFormat != null) && (exportFormat.length() > 0) && ("CSV".equals(exportFormat))) {
                                sbBuffer = sbBuffer.append(strFromMPTitle).append(" ").append(strFromMPRevision);
                            } else {
                                sbBuffer = sbBuffer
                                        ...
                                        .append(XSSUtil.encodeForHTMLAttribute(context, (String) tempMap.get(strFromMPId))).append("')\">").append(XSSUtil.encodeForXML(context, strFromMPTitle))
                                        .append(" ").append(XSSUtil.encodeForXML(context, strFromMPRevision)).append("</a>");
                            }
                            derivedFromList.add(sbBuffer.toString());
                        }
                    }
    ...
    public Map createManufacturingPlanJPO(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            objAttributeMap.put(ManufacturingPlanConstants.ATTRIBUTE_TITLE, strTitle);
            objAttributeMap.put(ManufacturingPlanConstants.ATTRIBUTE_MANUFACTURING_INTENT, strManufacturinPlanIntent);
            ...
            ManufacturingPlan mpBean = new ManufacturingPlan();
            strMPId = mpBean.createManufacturingPlanDerivation(context, strType, strName, strRevision, strPolicy, strVault, strOwner, strDescription, objAttributeMap, strDerivationType,
                    strDerivedFromID);
    ...
    /**
     * To insert Manufacturing Plan object from create component, and insert before the selcted MP
     * @param context
     * @param args
     * @return Map
     * @throws Exception
     ...
     */
    @com.matrixone.apps.framework.ui.CreateProcessCallable
    public Map insertManufacturingPlanJPO(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            try {
                ManufacturingPlan mpBean = new ManufacturingPlan();
                strMPId = mpBean.insertManufacturingPlanDerivation(context, strType, strName, strRevision, strPolicy, strVault, strOwner, strDescription, objAttributeMap, strDerivedFromID,
                        strDerivedToID);
                returnMap.put("id", strMPId);
    ...
    /**
     * This Method is used to get the range HREF for Planned for field For the Main Manufacturing Plan: Model Context: Chooser to select any Product managed under the Model Product Context: Product in
     * which the Manufacturing Plan is being created and the field is locked for editing For the non Main Manufacturing Plan: Product and Model Context: chooser will allow Products from the forward
     * derivation chain of the current Product
     * @since CFP R212Derivations
     */
    public String getPlannedForFieldHref(Context context, String[] args) throws FrameworkException {
        StringBuffer sbBuffer = new StringBuffer();
        ...
        try {
            ...
            String isFromProductContext = (String) requestMap.get("isFromProductContext");
            ...
            slObjSel.add(ManufacturingPlanConstants.SELECT_ATTRIBUTE_MARKETING_NAME);
            slObjSel.add(ManufacturingPlanConstants.SELECT_REVISION);
            Map mapSelContext = objContext.getInfo(context, slObjSel);
            String strMarketinNameContext = XSSUtil.encodeForXML(context, (String) mapSelContext.get(ManufacturingPlanConstants.SELECT_ATTRIBUTE_MARKETING_NAME));
            String strRevisionContext = XSSUtil.encodeForXML(context, (String) mapSelContext.get(DomainConstants.SELECT_REVISION));

            String defaultDestValue = "";
            String defaultDestId = "";
            if (objContext.isKindOf(context, ManufacturingPlanConstants.TYPE_PRODUCTS) && boolRootMP) {
                boolPrdMainMP = true;

                defaultDestValue = strMarketinNameContext + " " + strRevisionContext;
                defaultDestId = contextObjectId;

            } else if (objContext.isKindOf(context, ManufacturingPlanConstants.TYPE_MODEL) && boolRootMP) {
                defaultDestValue = "";
                ...
                if (objectId != null && !objectId.isEmpty()) {
                    ...
                    String contextRevisionSelectable = "to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from.revision";
                    String contextMarketingNameSelectable = "to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from."
                            + ManufacturingPlanConstants.SELECT_ATTRIBUTE_MARKETING_NAME;
                    String contextIDSelectable = "to[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].from." + ManufacturingPlanConstants.SELECT_ID;
                    String strMarketinName = XSSUtil.encodeForXML(context, (String) mapSel.get(contextMarketingNameSelectable));
            ...
            if (!boolPrdMainMP || (boolFromProduct && objectId == null)) {
                ...
                sbBuffer.append("onClick=\"javascript:showPlannedFromSelector('").append(strTypes).append("','").append(includeOIDMethod).append("','").append(contextObjectId).append("')\">");
                sbBuffer.append("</input>");
            }
        } catch (Exception e) {
            throw new FrameworkException(e.getMessage());
     ...
     * @since CFP R212Derivations
     */
    public String getDerivedFromField(Context context, String[] args) throws FrameworkException {
     ...
     * @since CFP R212Derivations
     */
    public String getDerivationTypeField(Context context, String[] args) throws FrameworkException {
        StringBuffer dispField = new StringBuffer();
     ...
     * @since CFP R212Derivations
     */
    public static Boolean showTypeChooser(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            String isFromProductContext = (String) requestMap.get("isFromProductContext");
            boolean boolFromProductContext = Boolean.parseBoolean(isFromProductContext);
            String objectId = (String) requestMap.get("objectID");
     ...
     * @since CFP R212Derivations
     */
    public static Boolean showType(Context context, String[] args) throws FrameworkException {
        boolean showTypeChooser = false;
        try {
            HashMap requestMap = (HashMap) JPO.unpackArgs(args);
            String isRootMP = (String) requestMap.get("isRootMP");
     ...
     * @since CFP R212Derivations
     */
    public String getDerivedToFieldForInsertBefore(Context context, String[] args) throws FrameworkException {
        StringBuffer dispField = new StringBuffer();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap requestMap = (HashMap) programMap.get("requestMap");
     ...
     * @since CFP R212Derivations
     */
    public String getDerivedFromFieldForInsertBefore(Context context, String[] args) throws FrameworkException {
        StringBuffer dispField = new StringBuffer();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap requestMap = (HashMap) programMap.get("requestMap");
     ...
     * @since CFP R212Derivations
     */
    public String getDerivationTypeFieldForInsertBefore(Context context, String[] args) throws FrameworkException {
        StringBuffer dispField = new StringBuffer();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap requestMap = (HashMap) programMap.get("requestMap");
            ...
            String mpAbstractDerivedID = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ProductLineConstants.SELECT_ID;

            String mpMainDerivedID = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_ID;

            String mpDerivedID = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].from." + ProductLineConstants.SELECT_ID;

            Map tempMap = new DomainObject(objectId).getInfo(context, new StringList(mpAbstractDerivedID));
            if (tempMap.containsKey(mpMainDerivedID)) {
                derivationType = strRevision;
     ...
     * @since CFP R212Derivations
     */
    public String getPlannedForFieldForInsertBefore(Context context, String[] args) throws FrameworkException {
        StringBuffer sbBuffer = new StringBuffer();
        ...
        try {
            ...
            String parentMPContextID = (String) requestMap.get("parentMPContextID");
            ...
            sbBuffer.append("");
            sbBuffer.append("size=\"200\" value=\"...\" alt=\"\" enabled=\"true\" ");
            sbBuffer.append("onClick=\"javascript:showChooser('../common/emxFullSearch.jsp?objectId=");
            ...
            sbBuffer.append("&amp;submitURL=../dmcplanning/ManufacturingPlanCreateInsertSearchUtil.jsp?mode=Chooser");
    ...
    public List getDerivationTypeForSearch(Context context, String args[]) throws FrameworkException {
        List derivationTypeList = new StringList();
        try {
            String strLanguage = context.getSession().getLanguage();
            String strDerivation = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.MPDerivation.DerivationType.Derivation", strLanguage);
            ...
            for (int i = 0; i < objectMapList.size(); i++) {
                ...
                String strPRDID = (String) objectMap.get(DomainConstants.SELECT_ID);
                strPRDIDs[i] = strPRDID;
            }

            String mainDerivedToSelectable = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED + "].id";
            String derivedToSelectable = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].id";
            String derivedAbstractToSelectable = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].id";
            MapList mlList = DomainObject.getInfo(context, strPRDIDs, new StringList(derivedAbstractToSelectable));
     ...
     * @return int - Returns true if Manufacturing plan is not in Frozen state else return false
     * @throws Exception
     *             if operation fails
     * @since R214
     */
    public boolean isManufacturingPlanEditable(Context context, String args[]) throws FrameworkException {
    ...
    /**
     * Gets the Manufacturing Plan Breakdown connected to the Manufacturing Plan in order to generate composition binary
     * @param context
     *            The eMatrix <code>Context</code> object
     * @param args
    ...
    public MapList getManufacturingPlanBreakdownComposition(Context context, String[] args) throws Exception {
        ...
        if (domMP.exists(context) && (domMP.hasRelatedObjects(context, ManufacturingPlanConstants.RELATIONSHIP_MANAGED_ROOT, false)
                || domMP.hasRelatedObjects(context, ManufacturingPlanConstants.RELATIONSHIP_MANAGED_REVISION, false))) {
    ...
    /**
     * Updates the composition binary when a Managed Root relationship is created.
     * @param context
     ...
     * @since CFP R212Derivations
     */
    public StringList getDerivedFromForSearch(Context context, String[] args) throws FrameworkException {
        StringList derivedFromList = new StringList();
        try {
            String strLanguage = context.getSession().getLanguage();
            String strRoot = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.MPDerivation.DerivationType.Root", strLanguage);
            ...
            String mpMainDerivedType = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_TYPE;
            String mpMainDerivedMarketing = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_ATTRIBUTE_MARKETING_NAME;
            String mpMainDerivedTitle = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_ATTRIBUTE_TITLE;
            String mpMainDerivedRevision = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_REVISION;
            String mpMainDerivedId = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_ID;

            String mpDerivedType = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_TYPE;
            String mpDerivedMarketing = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_ATTRIBUTE_MARKETING_NAME;
            String mpDerivedTitle = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_ATTRIBUTE_TITLE;

            String mpDerivedRevision = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_REVISION;
            String mpDerivedId = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "].from." + ManufacturingPlanConstants.SELECT_ID;

            String mpAbstractDerivedType = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_TYPE;
            String mpAbstractDerivedMarketing = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_ATTRIBUTE_MARKETING_NAME;
            String mpAbstractDerivedTitle = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_ATTRIBUTE_TITLE;

            String mpAbstractDerivedRevision = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_REVISION;
            String mpAbstractDerivedId = "to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED_ABSTRACT + "].from." + ManufacturingPlanConstants.SELECT_ID;
            ...
            for (Iterator iterator = mlList.iterator(); iterator.hasNext();) {
                ...
                if (tempMap.containsKey(mpMainDerivedId)) {
                    ...
                    String mpTitle = "";
                    if (mxType.isOfParentType(context, mpType, ManufacturingPlanConstants.TYPE_PRODUCTS)) {
                        mpTitle = (String) tempMap.get(mpMainDerivedMarketing);
                    } else if (mxType.isOfParentType(context, mpType, ManufacturingPlanConstants.TYPE_MANUFACTURING_PLAN)) {
                        mpTitle = (String) tempMap.get(mpMainDerivedTitle);
                    }
                    sbBuffer.append(XSSUtil.encodeForHTML(context, mpTitle)).append(" ").append(XSSUtil.encodeForHTML(context, mpRevision));
                    derivedFromList.add(sbBuffer.toString());
                } else if (tempMap.containsKey(mpDerivedId)) {
                    String mpRevision = (String) tempMap.get(mpDerivedRevision);
                    String mpId = (String) tempMap.get(mpDerivedId);
    ...
    /**
     * Method call as a trigger to check if the previous MP of current MP is in Release state.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the parameters passed from the calling method
     ...
     */
    public int checkIfPreviousMPDerivationReleased(Context context, String args[]) throws FrameworkException {
        // return value of the function
        int iReturn = 1;
        try {
            ...
            if (isRootNode) {
                ...
                if (isFrozenParent) {
                    ...
                    String language = context.getSession().getLanguage();
                    String strAlertMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.Alert.MPPromoteFailedStateNotRelease", language);
                    emxContextUtilBase_mxJPO.mqlNotice(context, strAlertMessage);
                    iReturn = 1;
                }
            }
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getEffManufacturingPlanDerivationChain(Context context, String[] args) throws Exception {
        MapList mlMPDerivation = new MapList();
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
    ...
    /**
     * It will be demote trigger called when demoting MP from Release to Preliminary to check if it has any derivation and if it is, is any of it is in Frozen state, if it is in Frozen state, it will
     * not allow to demote it
     * @param context
     * @param args
     * @return
     * @throws FrameworkException
     * @since R212Derivations
     */
    public int checkIfDerivedMPDerivationReleased(Context context, String args[]) throws FrameworkException {
        // return value of the function
        int iReturn = 1;
        try {
            // The feature object id sent by the emxTriggerManager is retrieved here.
            ...
            if (mpList.isEmpty()) {
                ...
                for (int i = 0; i < mpList.size(); i++) {
                    ...
                    if (isFrozenParent) {
                        String language = context.getSession().getLanguage();
                        String strAlertMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.Alert.MPDemoteFailedDerivedRelease", language);
                        emxContextUtilBase_mxJPO.mqlNotice(context, strAlertMessage);
                        iReturn = 1;
                        break;
                    } else {
    ...
    /**
     * This is the check trigger which will check If Context product of Manufacturing Plan is not in release/obselete state, MP will not be released.
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    public int checkIfProductReleased(Context context, String args[]) throws Exception {
        ...
        if (strState != null && (strState.equalsIgnoreCase(ManufacturingPlanConstants.STATE_RELEASE) || strState.equalsIgnoreCase(ManufacturingPlanConstants.STATE_OBSOLETE))) {
            iReturn = 0;
        } else {
            iReturn = 1;
            String language = context.getSession().getLanguage();
            String strAlertMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.Alert.PolicyMPPromoteCheckProductRelease", language);
            throw new FrameworkException(strAlertMessage);
        }
    ...
    public int checkIfUsedInReleasedMPBreakdown(Context context, String args[]) throws Exception {
        ...
        if (strState != null && (strState.contains(ManufacturingPlanConstants.STATE_RELEASE) || strState.contains(ManufacturingPlanConstants.STATE_OBSOLETE))) {
            iReturn = 1;
            String language = context.getSession().getLanguage();
            String strAlertMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.Alert.MPDeleteFailedUsedInReleasedMPB", language);
            throw new FrameworkException(strAlertMessage);
        } else {
            iReturn = 0;
        }
    ...
    private HashMap<String, HashMap<String, StringList>> getMPsThroughMasterModels(Context context, HashMap<String, String> idParentMap) throws Exception {
        ...
        String modelSelectable1 = "from[" + ManufacturingPlanConstants.RELATIONSHIP_LOGICAL_STRUCTURES + "].to." + "to[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCTS + "].from.id";
        String modelSelectable2 = "from[" + ManufacturingPlanConstants.RELATIONSHIP_LOGICAL_STRUCTURES + "].to." + "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_PRODUCT + "].from.id";
        ...
        String mpSelectable = "from[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCTS + "].to." + "from[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].to.id";

        String mpSelectable2 = "from[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_PRODUCT + "].to." + "from[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].to.id";
