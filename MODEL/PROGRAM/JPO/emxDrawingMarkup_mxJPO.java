...
/**
 * The <code>emxDrawingMarkup</code> class contains code for the "Part" business type.
 * @version EC 9.5.JCI.0 - Copyright (c) 2002, MatrixOne, Inc.
 */
public class emxDrawingMarkup_mxJPO extends emxDrawingMarkupBase_mxJPO {
    /**
     * Constructor.
     * @param context
    ...
    public emxDrawingMarkup_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
