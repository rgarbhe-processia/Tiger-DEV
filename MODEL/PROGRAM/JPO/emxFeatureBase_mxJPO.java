 ...
 *
 * static const char RCSID[] = $Id: /java/JPOsrc/base/${CLASSNAME}.java 1.178.2.19.1.1.1.10.1.12 Fri Jan 16 14:21:52 2009 GMT ds-shbehera Experimental${CLASSNAME}.java 1.48 Tue Oct 09 10:24:51 2007
 * GMT ds-rjoge Experimental$
 *
 */
...
/**
 * The <code>emxFeatureBase</code> class holds methods for executing JPO operations related to objects of the type Feature.
...
public class emxFeatureBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public static final String ATTRIBUTE_PARENT_OBJECT_NAME = PropertyUtil.getSchemaProperty("attribute_ParentObjectName");

    public static final String ATTRIBUTE_PARENT_MARKETING_NAME = PropertyUtil.getSchemaProperty("attribute_ParentMarketingName");

    public static final String ATTRIBUTE_CHILD_OBJECT_NAME = PropertyUtil.getSchemaProperty("attribute_ChildObjectName");

    public static final String ATTRIBUTE_CHILD_MARKETING_NAME = PropertyUtil.getSchemaProperty("attribute_ChildMarketingName");
    ...
    public static String SELECT_PART_FAMILY_NAME_FROM_FEATURE = "from[" + ProductLineConstants.RELATIONSHIP_GBOM_FROM + "].to.from[" + ProductLineConstants.RELATIONSHIP_GBOM_TO + "].to.name";

    public static String SELECT_PART_FAMILY_TYPE_FROM_FEATURE = "from[" + ProductLineConstants.RELATIONSHIP_GBOM_FROM + "].to.from[" + ProductLineConstants.RELATIONSHIP_GBOM_TO + "].to.type";
    ...
    public static String SELECT_APPLICABLE_ITEMS_FROM_FEATURE = "to[" + ProductLineConstants.RELATIONSHIP_EC_IMPLEMENTED_ITEM + "].from.from[" + RELATIONSHIP_APPLICABLE_ITEM + "].to."
     ...
     */
    public emxFeatureBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    /**
     * This method is used to update the feature structure or product revision / variant with master features of platform In Product revision Context
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds arguments
     ...
     * @throws Exception
     *             if the operation fails
     * @since Feature Configuration Module X+5 referenced for migration
     */
    public MapList updateListWithMasterFeatures(Context context, String args[]) throws Exception {
        ...
        String strExpandSelect = "from[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO + "].to.from[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_FROM + "]";
        String strObjIdSelect = "from[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO + "].to.id";
        String strObjNameSelect = "from[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO + "].to.name";
        String strObjTypeSelect = "from[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO + "].to.type";
        String strRelSelect = "from[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO + "].id";
        String strObjRevSelect = "from[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO + "].to.revision";
        String strObjAttSelect = "from[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO + "].to.attribute[" + ProductLineConstants.ATTRIBUTE_MARKETING_NAME + "]";
        String strObjAttSFSelect = "from[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO + "].to.attribute[" + ConfigurationConstants.ATTRIBUTE_SUBFEATURECOUNT + "]";
        ...
        selectStmts.addElement("attribute[" + ProductLineConstants.ATTRIBUTE_RULE_TYPE + "]");
        selectStmts.addElement("attribute[" + ProductLineConstants.ATTRIBUTE_FORCE_PART_REUSE + "]");
        selectStmts.addElement("attribute[" + ProductLineConstants.ATTRIBUTE_USAGE + "]");
        selectStmts.addElement("attribute[" + ProductLineConstants.ATTRIBUTE_QUANTITY + "]");
        selectStmts.addElement("to[" + ProductLineConstants.RELATIONSHIP_SELECTED_OPTIONS + "].from." + DomainConstants.SELECT_ID);
        ...
        if ((strProductPlatformId != null && !"".equals(strProductPlatformId)) || (strType.equalsIgnoreCase(ConfigurationConstants.TYPE_MASTER_FEATURE))) {
            if ((strType.equalsIgnoreCase(ConfigurationConstants.TYPE_MASTER_FEATURE)) || (strType.equalsIgnoreCase(ConfigurationConstants.TYPE_PRODUCT_CONFIGURATION))) {
            ...
            sb.append("))");
            StringList lstChildren = ProductLineUtil.getChildrenTypes(context, ProductLineConstants.TYPE_FEATURES);
            ...
            lstChildren = ProductLineUtil.getChildrenTypes(context, ProductLineConstants.TYPE_PRODUCTS);
            for (int i = 0; i < lstChildren.size(); i++) {
                sb.append("|| (");
                sb.append("type== \"");
                sb.append((String) lstChildren.elementAt(i));
            ...
            /*
             * strObjWhere = strObjWhere + "("; strObjWhere = strObjWhere + "to[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST + "].from.id" + "== '" + strContextProdId+"'"; strObjWhere
             * = strObjWhere + ")";
             */
            ...
            /*
             * featureListOfPlatform = objProductPlatform.getRelatedObjects(context, stbRelSelect.toString(), stbTypeSelect.toString(), selectStmts, relSelects, false, true, recurseLevel, strObjWhere,
             * null);
             */

            featureListOfPlatform = objProductPlatform.getRelatedObjects(context, stbRelSelect.toString(), stbTypeSelect.toString(), false, true, recurseLevel, selectStmts, relSelects, strObjWhere,
                    null, null, ConfigurationConstants.TYPE_FEATURE_LIST, null);
        ...
        if ((strProductPlatformId != null && !"".equals(strProductPlatformId)) || (strType.equalsIgnoreCase(ConfigurationConstants.TYPE_MASTER_FEATURE))) {
            while (prodMapItrOfPlatform.hasNext()) {
                ...
                if (((String) prodMapOfPlatform.get("relationship")).equals(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_FROM)) {
                    strLevelKey = (String) prodMapOfPlatform.get("level");
                    strLevelFinal = Integer.toString((Integer.parseInt(strLevelKey) + 1) / 2);
                        ...
                        if (!mapToBeUpdated.contains(prodMapOfPlatform)) {
                            if (!objOfFeatureType.equals(ConfigurationConstants.TYPE_MASTER_FEATURE)) {
                                ...
                                for (int i = 0; i < mapToBeUpdatedNew.size(); i++) {
                                    ...
                                    String strNewLevel = Integer.toString(((Integer.parseInt(strLevelKey) - 2)));
                                    // Modified to fix IR IR-018418 - IVU
                                    // Re calculate the level context is product variant.
                                    if (parentId != null && ConfigurationConstants.TYPE_PRODUCT_VARIANT.equals((new DomainObject(parentId).getInfo(context, DomainObject.SELECT_TYPE)))) {
                                        strNewLevel = Integer.toString((Integer.parseInt(strNewLevel) + 1) / 2);
                                    }
                    ...
                    // Added for bug no:372821
                        ...
                        mapOfPlatform.put("relationship", ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO);
                        mapOfPlatform.put("FeatureListId", (String) prodMapOfPlatform.get(DomainConstants.SELECT_ID));
                        mapOfPlatform.put("FeatureListFromId", (String) prodMapOfPlatform.get(DomainConstants.SELECT_RELATIONSHIP_ID));
                        mapOfPlatform.put("hasChildren", (String) prodMapOfPlatform.get(strExpandSelect));
                        mapOfPlatform.put(DomainConstants.SELECT_RELATIONSHIP_ID, (String) prodMapOfPlatform.get(strRelSelect));
                        mapOfPlatform.put(DomainConstants.SELECT_ID, (String) prodMapOfPlatform.get(strObjIdSelect));
                        mapOfPlatform.put(DomainConstants.SELECT_NAME, (String) prodMapOfPlatform.get(strObjNameSelect));
                        mapOfPlatform.put(DomainConstants.SELECT_TYPE, (String) prodMapOfPlatform.get(strObjTypeSelect));
                        mapOfPlatform.put(DomainConstants.SELECT_REVISION, (String) prodMapOfPlatform.get(strObjRevSelect));
                        mapOfPlatform.put("attribute[" + ProductLineConstants.ATTRIBUTE_MARKETING_NAME + "]", (String) prodMapOfPlatform.get(strObjAttSelect));
                        mapOfPlatform.put("attribute[" + ConfigurationConstants.ATTRIBUTE_SUBFEATURECOUNT + "]", (String) prodMapOfPlatform.get(strObjAttSFSelect));
                        // Added by KXB for IR-014476V6R2010x STARTS
                        mapOfPlatform.put("owningParent", (String) prodMapOfPlatform.get(strParentNameSelect));
                        // Added by KXB for IR-014476V6R2010x ENDS
    ...
    /**
     * This method provide command for Product Revision. Method added for Bug:374276
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * This method set boolean for flag. Method added for Bug:374276
     * @param context
     * @param args
     * @return
     * @throws Exception
            ...
            if (strModelOID != null && !strModelOID.equalsIgnoreCase("")) {
                ...
                if (!(strType.equalsIgnoreCase(ConfigurationConstants.TYPE_MODEL))) {
                    ...
                    if (strRel == null && (strCreateProduct != null || strCreateProduct == null)) {
                        ...
                        MapList relatedObjectsTemp = obj.getRelatedObjects(context, ConfigurationConstants.RELATIONSHIP_PRODUCT_PLATFORM, ConfigurationConstants.TYPE_PRODUCT_PLATFORM,
                                slFeatureListFromId, slFeatureListFromRelID, false, true, (short) 1, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, 0);
    ...
    public String checkPrefForTreeDisplayName(Context context, String[] args) throws Exception {
        ...
        } else if (strTreeNameDisplay.equalsIgnoreCase(ConfigurationConstants.TREE_DISPLAY_OBJECT_NAME_REV)) {
            strTreeName = strName + " " + strRev;
        } else {
            fpdm.utils.Notice_mxJPO.mqlNotice(context, MessageFormat.format(EnoviaResourceBundle.getFrameworkStringResourceProperty(context, "DisplayError", context.getLocale()), strTreeNameDisplay));
        }
        return strTreeName;
    }

    /**
     * This method is used to display the revision column in the Feature Powerview
     * @param context
     *            The ematrix context object
     * @param String
     *            The args
     ...
     * @since V6R2009-1
     */
    public List getRevisionForColumn(Context context, String[] args) throws Exception {
        ...
        for (int j = 0; j < typeRevMapList.size(); j++) {
            ...
            if (strType.equalsIgnoreCase(ConfigurationConstants.TYPE_PRODUCT_VARIANT)) {
                StringBuffer productVariantRevision = new StringBuffer((String) typeRevMap.get(DomainConstants.SELECT_REVISION));
                lstNameRev.add(productVariantRevision.substring(0, 1).toString());
            } else {
                lstNameRev.add((String) typeRevMap.get(DomainConstants.SELECT_REVISION));
            }
     ...
     * @param args
     *            holds arguments
     * @return Object - boolean true if feature name display is set to object name
     * @throws Exception
     *             if operation fails
     * @since Feature Configuration X3
     */
    public Object checkObjectNameDisplayPreference(Context context, String[] args) throws Exception {
        ...
        if (propertyValue == null || propertyValue.equals("") || propertyValue.equalsIgnoreCase("ObjectName")) {
     ...
     * @param args
     *            holds arguments
     * @return Object - boolean true if feature name display is set to marketing name
     * @throws Exception
     *             if operation fails
     * @since ProductCentral X3
     */
    public Object checkMarketingNameDisplayPreference(Context context, String[] args) throws Exception {
    ...
    public MapList getSatisfiedFeatures(Context context, String[] args) throws Exception {
        ...
        sbType.append(ConfigurationConstants.TYPE_CONFIGURATION_FEATURES).append(STR_COMMA).append(ConfigurationConstants.TYPE_LOGICAL_STRUCTURES);
        ...
        // parent feature
        setId(paramMap);
        relBusObjPageList = getRelatedObjects(context, strRelationship, sbType.toString(), objectSelects, relSelects, false, true, sh, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, 0);
     ...
     * @throws Exception
     */
    public Vector getCommonGroups(Context context, String args[]) throws Exception {
    ...
    /**
     * Get the list of all features which satisfies this build and build the Stringlist of IDs,to pass it to the excludeOIDProgram
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for the key "objectId"
    ...
    public StringList getSatisfiedFeaturesList(Context context, String[] args) throws Exception {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getFeatuersSatisfyingRequirement(Context context, String[] args) throws Exception {
        ...
        MapList relBusObjPageList = getRelatedObjects(context, strRelationship, sbType.toString(), objectSelects, relSelects, true, true, sh, DomainConstants.EMPTY_STRING,
                DomainConstants.EMPTY_STRING, 0);
        return (relBusObjPageList);
    }

    /**
     * Get the list of all features which satisfies the Requirement and builds the Stringlist of IDs,to pass it to the excludeOIDProgram
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for the key "objectId"
     ...
     */
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList getFeatuersListSatisfyingRequirement(Context context, String[] args) throws Exception {
        StringList listConnectedFeatures = new StringList();
