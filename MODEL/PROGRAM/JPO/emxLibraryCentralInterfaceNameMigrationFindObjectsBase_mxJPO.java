...
public class emxLibraryCentralInterfaceNameMigrationFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO {
    String LibraryType = "";
    ...
    public emxLibraryCentralInterfaceNameMigrationFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    public void getIds(Context context, int chunkSize) throws Exception {
        ...
        try {
            ...
            MqlUtil.mqlCommand(context, command, LibraryType, name, revision, vaultList, "1", "program[" + migrationProgramName + " -method writeOID ${OBJECTID} \"${TYPE}\"] == true");

            MqlUtil.mqlCommand(context, command, ClassType, name, revision, vaultList, "1", "program[" + migrationProgramName + " -method writeOID ${OBJECTID} \"${TYPE}\"] == true");
        } catch (Exception me) {
            throw me;
        }
