...
public class emxTriggerReportBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public emxTriggerReportBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    /**
     * This method returns the list of triggers defined for Admin Object By iterating each trigger of a selected admin object, it find all the revision objects and finally stores state(if admin type
     * is policy), trigger name and trigger type in MapList.
     * @param context
     *            the eMatrix <code>Context</code> object
    ...
    /**
     * This method will decide whether to show States column or Not. Only for Policy admin object this column should be displayed.
     * @param context
     *            the eMatrix <code>Context</code> object
    ...
    /**
     * This method will decide whether to show the inherited column or not Inherited column should be displayed only when admin type is "TYPE"
     * @param context
     *            the eMatrix <code>Context</code> object
    ...
    /**
     * If the trigger is inherited, value added is "Yes" and if it is not, then value added is "No".
     * @param context
     *            the eMatrix <code>Context</code> object
