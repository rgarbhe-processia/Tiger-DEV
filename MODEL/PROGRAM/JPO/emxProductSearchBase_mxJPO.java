...
public class emxProductSearchBase_mxJPO extends emxSearch_mxJPO {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit Build Type Name State Owner Vault Option
    ...
    public static Object getBuilds(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit Product Type Name Revision condition Revision Description Originator Owner Include Version Flag Vault Option
     * @return a MapList , consisting of the object ids of the selected Objects
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static Object getProducts(Context context, String[] args) throws Exception {
        MapList mapList = null;
        Map programMap = (Map) JPO.unpackArgs(args);
        Map tempMap = null;
        ...
        if (!((strSrcDestRelName == null) || ("".equals(strSrcDestRelName)) || ("null".equalsIgnoreCase(strSrcDestRelName)))) {
            strRelNameActual = PropertyUtil.getSchemaProperty(context, strSrcDestRelName);
        }

        if (((strRelNameActual == null) || ("".equals(strRelNameActual)) || ("null".equalsIgnoreCase(strRelNameActual)))) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit Name Owner Description Vault Option Vault Display
     * @return a MapList , consisting of the object ids of the selected Objects
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static Object getProductLines(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit Name State Owner Vault Option Vault Display
     * @param strType
    ...
    public static Object getCases(Context context, String[] args, String strType) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        short sQueryLimit = (short) (java.lang.Integer.parseInt((String) programMap.get("queryLimit")));
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit Name Description File Name Owner Vault Option Vault Display
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static Object getImages(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit Document Type Name Revision Title Description State Policy Owner Vault Option Vault Display
     * @return MapList , the Object ids matching the search criteria
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
    ...
    public static Object getDocuments(Context context, String[] args) throws Exception {
        ...
        String strAttrIsVersionObject = PropertyUtil.getSchemaProperty(context, SYMBOLIC_attribute_IsVersionObject);
        if (start) {
            sbWhereExp.append(SYMB_OPEN_PARAN);
            start = false;
        } else {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit Part Type Name Revision Condition Revision Vault Option Vault Display
     * @return MapList , the Object ids matching the search criteria
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static Object getParts(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        short sQueryLimit = (short) (java.lang.Integer.parseInt((String) programMap.get("queryLimit")));
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit Name Vault Option Vault Display
     * @return MapList , the Object ids matching the search criteria
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static Object getProjects(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        short sQueryLimit = (short) (java.lang.Integer.parseInt((String) programMap.get("queryLimit")));
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds arguments of the request type
     * @return MapList , the Object ids matching the search criteria
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static Object getTestCases(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit Name ProductLine Vault Option Vault Display
     * @return MapList , the Object ids matching the search criteria
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static Object getModels(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        ...
        if (strOwner == null || strOwner.equals("") || SYMB_NULL.equalsIgnoreCase(strOwner)) {
            strOwner = SYMB_WILD;
        } else {
        ...
        if (strState == null || strState.equals("") || SYMB_NULL.equalsIgnoreCase(strState)) {
            strState = SYMB_WILD;
        } else {
            strState = strState.trim();
        }
        ...
        if (strDesc != null && (!strDesc.equals(SYMB_WILD)) && (!strDesc.equals("")) && !(SYMB_NULL.equalsIgnoreCase(strDesc))) {
            if (start) {
                sbWhereExp.append(SYMB_OPEN_PARAN);
                start = false;
            }
        ...
        if (strState != null && (!strState.equals(SYMB_WILD)) && (!strState.equals("")) && !(SYMB_NULL.equalsIgnoreCase(strState))) {
            if (start) {
                sbWhereExp.append(SYMB_OPEN_PARAN);
                start = false;
            } else {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit User Name First Name Last Name Company Vault Option Vault Display
     * @return MapList , the Object ids matching the search criteria
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static Object getPersons(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit Specification Type Name Revision Title Description State Policy Owner Vault Option Vault Display
     * @return MapList , the Object ids matching the search criteria
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static Object getSpecifications(Context context, String[] args) throws Exception {
        ...
        /*
         * if (strPolicy!=null && (!strPolicy.equals(SYMB_WILD)) && (!strPolicy.equals("")) ) { if (start) { sbWhereExp.append(SYMB_OPEN_PARAN); start = false; } else { sbWhereExp.append(SYMB_AND); }
         * sbWhereExp.append(SYMB_OPEN_PARAN); sbWhereExp.append(DomainConstants.SELECT_POLICY); sbWhereExp.append(SYMB_MATCH); sbWhereExp.append(SYMB_QUOTE); sbWhereExp.append(strPolicy);
         * sbWhereExp.append(SYMB_QUOTE); sbWhereExp.append(SYMB_CLOSE_PARAN); }
         */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit Type Name Vault Option Vault Display
     * @return MapList , the Object ids matching the search criteria
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static Object getCompanies(Context context, String[] args) throws Exception {
        MapList mapList = null;
        try {
            ...
            /*
             * if ( strName!=null && (!strName.equals(SYMB_WILD)) && (!strName.equals("")) ) { sbWhereExp.append(SYMB_OPEN_PARAN); sbWhereExp.append(SYMB_ATTRIBUTE);
             * sbWhereExp.append(SYMB_OPEN_BRACKET); sbWhereExp.append(ProductCentralDomainConstants.ATTRIBUTE_ORGANIZATION_NAME); sbWhereExp.append(SYMB_CLOSE_BRACKET); sbWhereExp.append(SYMB_MATCH);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit Type Name Revision Description Owner State Vault Option Vault Display
     * @return MapList , the Object ids matching the search criteria
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
     */
    public static Object find(Context context, String[] args) throws Exception {
        MapList mapList = null;
        try {
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Object findLike(Context context, String[] args) throws Exception {
        MapList mapList = null;
        try {
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Object getProductStates(Context context, String[] args) throws Exception {
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Object getBuildsStates(Context context, String[] args) throws Exception {
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Object getTestCaseStates(Context context, String[] args) throws Exception {
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Object getDocumentsStates(Context context, String[] args) throws Exception {
     ...
     */
    public static Object getModelStates(Context context, String[] args) throws Exception {
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Object getProductRevisionHTML(Context context, String args[]) throws Exception {
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Object getProductVersionHTML(Context context, String args[]) throws Exception {
    ...
    public static Object getPartsRevisionHTML(Context context, String args[]) throws Exception {
        ...
        sb.append(
                "</td><td><input type=\"text\" name=\"Revision\" value=\"*\" size=\"20\"></td></tr></table></td></tr><tr><td>&nbsp;<input type=\"radio\" name=\"radio\" value=\"latestReleased\"></td><td>");
        sb.append(strLatestReleased);
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Object getDocumentsRevisionHTML(Context context, String args[]) throws Exception {
        StringBuffer sb = new StringBuffer(70);
        String strLocale = context.getSession().getLanguage();
        String strLatestOnly = EnoviaResourceBundle.getProperty(context, SUITE_KEY, PRODUCT_REVISION_LATEST_REVISION_ONLY, strLocale);
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Object getPersonNameHTML(Context context, String args[]) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        ...
        for (int i = 0; i < iNumOfObjects; i++) {
            ...
            resVector.add("<img src=\"../common/images/icons/small/iconSmallPerson.gif\" border=\"0\" alt=\"Person\"></td><td><span class=\"object\">" + strFirstName + ", " + strLastName + "</span>");
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Object getPriorityChoicesHTML(Context context, String args[]) throws Exception {
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static void deleteCommon(Context context, String args[]) throws Exception {
        try {
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static void deleteProduct(Context context, String args[]) throws Exception {
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Object getPolicyDropDownDocs(Context context, String[] args) throws Exception {
    ...
    public static Object getPolicyDropDownSpecs(Context context, String[] args) throws Exception {
     ...
     * @since ProductCentral 10-0-0-0
     */
    protected static String getPolicies(Context context, String strType) throws Exception {
    ...
    /**
     * This method generates the HTML code for type chooser field. The types dispalyed in the chooser depends on the TO side of the realtionship passed in.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing request parameters.
            ...
            if (strMode != null && strMode.equals(Search.ADD_EXISTING)) {
                if (strCommand != null && strCommand.equals(SPECIFICATION_COMMAND)) {
                    ...
                    strTypeChooser.append(
                            "<input type=\"button\" value=\"...\" onclick=\"javascript:getTopWindow().showChooser('../common/emxTypeChooser.jsp?frameName=searchPane&formName=editDataForm&SelectType=single&SelectAbstractTypes=false&InclusionList="
                                    + strTypes
                                    + "&ObserveHidden=true&SuiteKey=eServiceSuiteProductLine&ShowIcons=true&fieldNameActual=Type&fieldNameDisplay=TypeDisplay&objectId=null','400','400')\">");
                }
    ...
    public String getCompanyOrganizationChooserHTML(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if ((strPRCParam1 != null) && (strPRCParam1.equals(MODE_DESIGN_RESPONSIBILITY))) {
                ...
                strTypeChooser.append(
                        "&nbsp;&nbsp;<input type=\"button\" value=\"...\" onclick=\"javascript:getTopWindow().showChooser('../common/emxTypeChooser.jsp?frameName=searchPane&formName=editDataForm&SelectType=single&SelectAbstractTypes=false&InclusionList="
                                + strTypes + "&ObserveHidden=true&SuiteKey=eServiceSuiteProductLine&ShowIcons=true&fieldNameActual=Type&fieldNameDisplay=TypeDisplay&objectId=null','400','400')\">");
            } else {
                String strTypes = "type_Company";
                strTypeChooser.append("<img src=\"images/iconSmallCompany.gif\" border=\"0\" alt=\"Company\"></img><b>" + strCompany);
                strTypeChooser.append("<input type=\"hidden\" name=\"Type\" value=\"" + strCompanyHiddenField + "\">");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            Holds hashmap containing the following arguments Hashmap Containing the objectList Hashmap containg parameters like oject id, tree id, reportFormat
    ...
    public Vector getObjectNameOnMode(Context context, String[] args) throws Exception {
        ...
        if (iNoOfObjects > 0) {
            ...
            if (StrSymbolicName != null && (!StrSymbolicName.equalsIgnoreCase("null")) && (!StrSymbolicName.equalsIgnoreCase(""))) {
                ...
                if (strReportFormat != null && strReportFormat.length() > 0) {
                    ...
                    if (appendTreeName) {
                        ...
                        strFullName = "<a href=\"JavaScript:emxTableColumnLinkClick('emxTree.jsp" + "?name="
                                + XSSUtil.encodeForHTMLAttribute(context, attributeList.getElement(i).getSelectData(strAttrb2)) + "&amp;treeMenu=" // Modified by Enovia MatrixOne for Bug # 304580 Date
                                                                                                                                                   // 05/18/2005
                                + MENU_PLCPRODUCTLINE + "&amp;emxSuiteDirectory=" + XSSUtil.encodeForHTMLAttribute(context, strSuiteDir) + "&amp;parentOID="
                                ...
                                + XSSUtil.encodeForXML(context, attributeList.getElement(i).getSelectData(strAttrb2)) + "</a>";
                        // End of Modify by Enovia MatrixOne for Bug# 296547 on 28 Mar 05
                    } else {
                        strFullName = "<a href=\"JavaScript:emxTableColumnLinkClick('emxTree.jsp?name=" + XSSUtil.encodeForHTMLAttribute(context, attributeList.getElement(i).getSelectData(strAttrb2))
                                + "&amp;emxSuiteDirectory=" // Modified By Enovia MatrixOne for Bug # 304580 Date 05/18/2005
                                + XSSUtil.encodeForHTMLAttribute(context, strSuiteDir) + "&amp;parentOID=" + XSSUtil.encodeForHTMLAttribute(context, strParentObjectId) + "&amp;jsTreeID="
                                + XSSUtil.encodeForHTMLAttribute(context, strJsTreeID) + "&amp;objectId=" + XSSUtil.encodeForHTMLAttribute(context, strObjId)
                                + "', 'null', 'null', 'false', 'content')\" class=\"object\">" + XSSUtil.encodeForXML(context, attributeList.getElement(i).getSelectData(strAttrb2)) + "</a>";
     ...
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the parameters passed from the calling method When this array is unpacked, arguments corresponding to the following String keys are found: queryLimit hdnType txtName
     *            txtDescription txtOwner txtState.
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static MapList searchObjectsGeneric(Context context, String[] args) throws Exception {
        MapList mapList = null;
        try {

            Map programMap = (Map) JPO.unpackArgs(args);
            short sQueryLimit = (short) (java.lang.Integer.parseInt((String) programMap.get(QUERY_LIMIT)));
            ...
            boolean bLatestRevision = false;
            boolean bLatestReleasedRevision = false;
            if (strRadio != null && !strRadio.equals("") && !(SYMB_NULL.equalsIgnoreCase(strRadio))) {
                if (strRadio.equals("input")) {
                    strRevision = (String) programMap.get("Revision");
                    strRevision = strRevision.trim();
                } else if (strRadio.equals("latestReleased")) {
            ...
            if ((strRevision == null) || (strRevision.equals("")) || SYMB_NULL.equalsIgnoreCase(strRevision)) {
                strRevision = SYMB_WILD;
            }
            ...
            if (strVaultOption != null && !strVaultOption.equals("") && !(SYMB_NULL.equalsIgnoreCase(strVaultOption))) {
                ...
                } else if (strVault == null || strVault.equals("") || SYMB_NULL.equalsIgnoreCase(strVault)) {
                    strVault = SYMB_WILD;
                }
            }
            ...
            if ((strFilteredExpression != null) && !(SYMB_NULL.equalsIgnoreCase(strFilteredExpression)) && !strFilteredExpression.equals("")) {
                if (bStart) {
                    sbWhereExp.append(SYMB_OPEN_PARAN);
                    bStart = false;
                } else {
     ...
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            - Holds packed parameters passed from the calling method queryLimit hdnType txtName txtDescription txtOwner txtState.
     * @return - Maplist containing the objects found
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.6
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public List searchPortfolios(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        ...
        MapList mapList = DomainObject.findObjects(context, strType, strName, strRevision, strOwner, strVault, sbWhereExp.toString(), "", true, (StringList) slSelect, sQueryLimit);
        // Begin of Add by Vibhu,Enovia MatrixOne for Bug 311884 on 11/15/2005
        if (bLatestReleasedRevision) {
            mapList = filterForLatestRevisions(context, mapList);
        }
     ...
     */
    public static String generateFilterExpression(Context context, Map programMap) throws Exception {
        ...
        /*
         * Builds an expression which will filter the existing objects in the GBOM of the context Feature/Product from the output maplist
         */
        StringBuffer sbWhereExp = new StringBuffer(100);
        boolean start = true;
        start = false;
        ...
        sbWhereExp.append(SYMB_CLOSE_PARAN);
        /*
         * Builds an expression which will filter the context object (Product/Feature) from the output maplist
         */
        sbWhereExp.append(SYMB_AND);
        sbWhereExp.append(SYMB_OPEN_PARAN);
        sbWhereExp.append(DomainConstants.SELECT_ID);
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static Object getCompaniesForMassRDO(Context context, String[] args) throws Exception {
        MapList mapList = null;
        try {
    ...
    /**
     * The function to get the productline lines the are in persons company contect this filled is been modify to take typeahead functionality in 2012
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param programMap
     *            holds arguments passed
