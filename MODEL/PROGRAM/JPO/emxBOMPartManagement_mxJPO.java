...
/**
 * The <code>emxBOMPartManagement</code> class contains code for the "Part" business type.
 * @version EC 9.5.JCI.0 - Copyright (c) 2002, MatrixOne, Inc.
 */
public class emxBOMPartManagement_mxJPO extends emxBOMPartManagementBase_mxJPO {
    /**
     * Constructor.
     * @param context
    ...
    public emxBOMPartManagement_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
