...
//
// Copyright (c) 2006-2017 Dassault Systemes.
// All Rights Reserved
...
/**
 * @author prasad The <code>FileBase</code> class provides web services related to associated files of an object viewed in 3DLive
...
public class FileBase_mxJPO extends jpo.plmprovider.Mat3DLive_mxJPO {
     ...
     * @param request
     *            input object id, filename, format
     * @return FileResponse
     */
    ...
    /**
     * This function will get FCS url that corresponds to the file/format/object in the request object. This method is for testing purpose only.
     * @param context
     *            the matrix context
     * @param args
     *            the array should contain FileRequest
     * @return FileResponse
     */
     ...
     * @param filename
     *            name of the file for which fcsURl needs to calculated
     * @param fileFormat
     *            format of the file for which fcsURl needs to calculated
     * @return FileResult the FCS url of the file
     * @throws MatrixException
     * @since AEF X+3
     */

    protected FileResult getResult(Context context, String mcsURL, String objectId, String fileName, String fileFormat) throws MatrixException {
     ...
     * @since AEF X+3
     */
    protected String getFCSUrl(Context context, String mcsURL, String oid, String fileName, String format) throws Exception {
    ...
    /**
     * This function will get fcs urls of all required files associated with given as an array of object ids, file name and file format.
     * @param username
     *            the matrix user name
     * @param password
     *            password of the user
     * @param request
     *            input list of FileRequest objects having object id, file format and name
     * @return FileResponse
     * @since
     */
     ...
     * @since
     */
    protected FileResponse getCheckOutURLs(Context context, FileRequest[] request) throws MatrixException {
        FileResponse response = null;
    ...
    /**
     * This method will return RawFileResponse object containing streamed output of zipped file containing mutliple requested files.
     * @param username
     *            the matrix user name
     * @param password
     *            password of the user
     * @param request
     *            FileRequest[] object containing object id, file name and file format
    ...
    protected RawFileResponse getFilesAsZip(Context context, FileRequest[] request) throws MatrixException {
        ...
        try {
            ...
            for (int j = 0; j < iSize; j++) {
                ...
                bo.open(context);
                bo.checkoutFile(context, false, strFormat, strFileName, strWorkspace);
                bo.close(context);
                String strFileToZip = fileWs.getAbsolutePath() + "\\" + strFileName;

                File fileToDelete = new File(strFileToZip);
                // Check whether file exists
                if (fileToDelete.isFile()) {
                    int iFileCount = j + 1;
                    String strtoZipFileName = Integer.toString(iFileCount) + "_" + strFileName;
    ...
    /**
     * This method will return the list of files associated to the object whose id is sent as input This method is for testing purpose only
     * @param context
     *            the matrix context
     * @param args
     *            the array should contain FileRequest
    ...
    protected HashMap getDrawingFileMap(Context context, DomainObject object) throws Exception {
     ...
     *            password of the user
     * @param request
     *            input FileRequest, this contains the objectID, file Name to upload, file format (can be left blank), MCS url
    ...
    public Ticket getUploadTicket(String username, String password, FileRequest request) {
        ...
        try {
            ...
            /*
             * to do add markup name generation logic
             */
            if (markupID == null) {
            ...
            /*
             * to do if markupId is not null: if the filename is different then deleteVersion that corresponds to the existing file
             */
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectID
     *            - objectID for which Markup is needed
    ...
    private String getMarkupID(Context context, String objectID) throws Exception {
        ...
        /*
         * to do change this to add where clause, for just Markup type, not any sub-types
         */
     ...
     *            password of the user
     * @param receipt
     *            , the return from the upload of the file used to finalize the check-in
