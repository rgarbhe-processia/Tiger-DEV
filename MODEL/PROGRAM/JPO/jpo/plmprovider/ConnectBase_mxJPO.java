...
/**
 * @author kcox The <code>${CLASSNAME}</code> class provides web services associated with connecting to the MatrixOne server.
...
public class ConnectBase_mxJPO extends jpo.plmprovider.Mat3DLive_mxJPO {
    ...
    /**
     * Cleans the context cache. This method will be called from timer servlet after specified time interval
     * @param context
     *            the matrix context
     * @param args
     *            the String array
     ...
     * @param password
     *            the user password
     * @return ConnectResponse consists of a) List of security contexts b) default security context c) encrypted key
     * @since BPS R214
     */
    ...
    /**
     * Creates a context with given user name, pass word and security context if user name is null, (i.e context is already created before this call) then it get the context details from password
     * (encrypted key)
     * @param userName
     *            the matrix user name
     * @param password
