...
/**
 * @author mkeirstead The <code>${CLASSNAME}</code> class provides web services associated with meta data.
 * @version AEF 10.7.1.0 - Copyright (c) 2007, MatrixOne, Inc.
 */
public class MetaData_mxJPO extends jpo.plmprovider.MetaDataBase_mxJPO {
    /**
     * Constructor.
     * @since AEF 10.7.1.0
     */
