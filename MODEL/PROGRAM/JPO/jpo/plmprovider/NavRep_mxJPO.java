...
/**
 * @author mkeirstead The <code>${CLASSNAME}</code> class provides web services associated with providing graphical representations of a tree structure.
 * @version AEF 10.7.1.0 - Copyright (c) 2007, MatrixOne, Inc.
 */
public class NavRep_mxJPO extends jpo.plmprovider.NavRepBase_mxJPO {
    /**
     * Constructor.
     * @since AEF 10.7.1.0
     */
    ...
    /**
     * This function will get urls with fake server name but proper associated object ids file name and file format. The same input will be used later in getFilesAsZip web service function.
     * @param username
     *            the matrix user name
     * @param password
     *            password of the user
