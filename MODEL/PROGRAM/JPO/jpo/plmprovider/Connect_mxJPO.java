...
/**
 * @author mkeirstead The <code>${CLASSNAME}</code> class provides web services associated with connecting to the MatrixOne server.
 * @version AEF 10.7.1.0 - Copyright (c) 2007, MatrixOne, Inc.
 */
public class Connect_mxJPO extends jpo.plmprovider.ConnectBase_mxJPO {
    /**
     * Constructor.
     * @since AEF 10.7.1.0
     */
