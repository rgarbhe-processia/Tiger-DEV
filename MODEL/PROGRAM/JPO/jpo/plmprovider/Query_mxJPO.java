...
/**
 * @author mkeirstead The <code>${CLASSNAME}</code> class provides web services associated with database queries.
 * @version AEF 10.7.1.0 - Copyright (c) 2007, MatrixOne, Inc.
 */
public class Query_mxJPO extends jpo.plmprovider.QueryBase_mxJPO {
    /**
     * Constructor.
     * @since AEF 10.7.1.0
     */
    ...
    /**
     * This service performs an expand on CATIA links. All of the required information to do the expand are sent in the QueryRequest, mainly id of the object to expand this web service is called from
     * V5-V6 coexistence engine only, not called from regular 3DLive user actions
     * @param username
    ...
    /**
     * This service performs an expand in reverse direction. All of the required information to do the expand are sent in the Query Request.
     * @param username
     *            the matrix user name
     * @param password
     *            password of the user
    ...
    /**
     * This method exists merely to expose the return type to ServiceGenerator, for proper registration of the Axis serializer.
