...
/**
 * @author prasad The <code>File</code> class provides web services related to associated files of an object viewed in 3DLive
 * @version AEF X+3 - Copyright (c) 2007, MatrixOne, Inc.
 */
public class File_mxJPO extends jpo.plmprovider.FileBase_mxJPO {
    /**
     * Constructor.
     * @since AEF X+3
     */
    ...
    /**
     * This function will get zipped stream of all required files associated with the given array of object ids, file name and file format.
     * @param username
     *            the matrix user name
     * @param password
     *            password of the user
     * @param request
     *            input list of FileRequest objects having object id, file format and file name
