...
public class PartBase_mxJPO extends DomainObject {
    ...
    public MapList getSEP(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            listCorpMEPs = partObj.getRelatedObjects(context, CPCConstants.RELATIONSHIP_SEP, // relationship
     ...
     * @return a MapList of Manufaturer Equivalent Part object ids and relationship ids.
     * @throws Exception
     *             if the operation fails. CPC
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getEnterpriseManufacturerEquivalents(Context context, String[] args) throws Exception {

        ComponentsUtil.checkLicenseReserved(context, CPCConstants.BPS_PRODUCT_TRIGRAM);
        ...
        try {
            ...
            if (partObj.getInfo(context, DomainConstants.SELECT_TYPE).equals(DomainConstants.TYPE_PART)
                ...
                listLocEquivMEPs = partObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_LOCATION_EQUIVALENT + "," + DomainConstants.RELATIONSHIP_MANUFACTURER_EQUIVALENT, // relationship
                        // pattern
                ...
                listCorpMEPs = partObj.getRelatedObjects(context, CPCConstants.RELATIONSHIP_SUPPLIER_EQUIVALENT + "," + DomainConstants.RELATIONSHIP_MANUFACTURER_EQUIVALENT, // relationship
                        // pattern
            ...
            if (objectList != null && objectList.size() > 0) {
                ...
                for (int i = 0; i < objectListSize; i++) {
                    ...
                    if (type.equals(TYPE_MPN)) {
                        String showBlankName = FrameworkProperties.getProperty("emxManufacturerEquivalentPart.EngrPlaceholderMEP.ShowBlankName");
                        if ("false".equalsIgnoreCase(showBlankName)) {
                            displayValue = i18nNow.getI18nString("emxManufacturerEquivalentPart.EngrPlaceholderMEP.DefaultName", "emxManufacturerEquivalentPartStringResource",
            ...
            if (objectList != null && objectList.size() > 0) {
                ...
                while (statusMapListItr.hasNext()) {
                    ...
                    while (statusListItr.hasNext()) {
                        ...
                        allocStatus = i18nNow.getI18nString(allocStatus, "emxFrameworkStringResource", context.getSession().getLanguage());
            ...
            if (objectList != null && objectList.size() > 0) {
                ...
                while (prefMapListItr.hasNext()) {
                    ...
                    while (prefListItr.hasNext()) {
                        ...
                        allocPref = i18nNow.getI18nString(allocPref, "emxFrameworkStringResource", context.getSession().getLanguage());
    ...
    public String showUsageLocationField(Context context, String[] args) throws Exception {
        ...
        String strReset = i18nNow.getI18nString("emxManufacturerEquivalentPart.Common.Reset", "emxManufacturerEquivalentPartStringResource", context.getSession().getLanguage());
        ...
        outPut.append("</input>");
        outPut.append("<a href=\"JavaScript:ResetField('emxCreateForm','UsageLocation','UsageLocationDisplay','" + defaultManufacturer + "','" + defaultManufacturerId + "')\">");
        outPut.append(strReset + "</a>");
        outPut.append("<input type=\"hidden\" name=\"UsageLocation\" value=\"" + defaultManufacturerId + "\"></input>");
        return outPut.toString();
    }
    ...
    public String showManufacturerField(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            returnString.append("</input>");
            returnString.append("<a href=\"JavaScript:ResetField('forms[0]','Manufacturer','ManufacturerDisplay','" + defaultManufacturer + "','" + defaultManufacturerId + "');resetManuLoc();");
            if ("true".equals(isAddExisting)) {
    ...
    public String showVaultField(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strDefault = i18nNowInstance.GetString("emxFrameworkStringResource", strLocale, "emxFramework.Preferences.DefaultVault");
            ...
            radioOption.append(
                    "<input type=\"button\" name=\"VaultChooseButton\" value=\"...\" onclick=\"document.forms[0].vaultOption[3].checked=true;javascript:top.showChooser('../common/emxVaultChooser.jsp?fieldNameActual=vaults&fieldNameDisplay=vaultsDisplay&multiSelect=false&isFromSearchForm=true')\">");
    ...
    /**
     * Creates a Supplier Equivalent Part and connects to the Supplier using Supplied By Relationship
     * @param context
     *            The Matrix Context.
     * @param args
    ...
    public Object getMepPartOrigin(Context context, String[] args) throws Exception {
        ...
        String strManufacturerEquivalent = i18nNow.getI18nString("emxManufacturerEquivalentPart.Part.MfgEquivalent", "emxManufacturerEquivalentPartStringResource", languageStr);
        String strEnterprise = i18nNow.getI18nString("emxManufacturerEquivalentPart.Part.Enterprise", "emxManufacturerEquivalentPartStringResource", languageStr);
    ...
    public Object displayPartRevision(Context context, String[] args) throws Exception {
        ...
        if (isViewMode || !isMep) {
            ...
            String customRevision = FrameworkProperties.getProperty("emxManufacturerEquivalentPart.MEP.allowCustomRevisions");
    ...
    public int updatePartRevision(Context context, String[] args) throws Exception {
        ...
        if (isMep && !"".equals(strRevValue) && !strRev.equals(strRevValue)) {
            ...
            if (mapList == null || mapList.size() == 0) {
                ...
                String strMessage = i18nNow.getI18nString("emxManufacturerEquivalentPart.MEP.Exists", "emxManufacturerEquivalentPartStringResource", languageStr);
    ...
    public String getPolicyClassificationPolicies(Context context, String[] args) throws Exception {
        ...
        if ("edit".equalsIgnoreCase(strMode)) {
            ...
            String isPolicyEdit = FrameworkProperties.getProperty("emxManufacturerEquivalentPart.Policy.EnablePartPolicyEditing");
    ...
    public Vector showLocationPreference(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            StringList attrRanges = FrameworkUtil.getRanges(context, "Location Preference");
            if (objList != null && (listSize = objList.size()) > 0) {
                columnVals = new Vector(listSize);
                for (int i = 0; i < listSize; i++) {
                    map = (Map) objList.get(i);
                    srelId = (String) map.get("id[connection]");
                    String oldLocPref = DomainRelationship.getAttributeValue(context, srelId, "Location Preference");
    ...
    public void updateLocationPreference(Context context, String[] args) throws FrameworkException {
        try {
            ...
            if (requestMap.get("objCount") != null || !"null".equals(requestMap.get("objCount"))) {
                ...
                new DomainRelationship().setAttributeValue(context, relId, attrLocPref, sLocPrefValue);
            }
        } catch (Exception e) {
            throw new FrameworkException(e);
        }
    ...
    public Vector showLocationStatus(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            // String defaultValue = attrType.getDefaultValue(context);
            StringList attrRanges = FrameworkUtil.getRanges(context, "Location Status");
            if (objList != null && (listSize = objList.size()) > 0) {
                columnVals = new Vector(listSize);
                for (int i = 0; i < listSize; i++) {
                    map = (Map) objList.get(i);
                    ...
                    srelId = (String) map.get("id[connection]");
                    String oldLocStat = DomainRelationship.getAttributeValue(context, srelId, "Location Status");
                    if (sMode != null && "true".equals(sMode)) {
                        StringBuffer sbOption = new StringBuffer();
                        int rangeSize = attrRanges.size();
    ...
    public void updateLocationStatus(Context context, String[] args) throws FrameworkException {
        try {
            ...
            HashMap requestMap = (HashMap) arguMap.get("requestMap");
            String relId = (String) paramMap.get("relId");
            String attrLocStat = PropertyUtil.getSchemaProperty(context, "attribute_LocationStatus");
            if (requestMap.get("objCount") != null || !"null".equals(requestMap.get("objCount"))) {
                String sLocStatValue = (String) paramMap.get("New Value");
                new DomainRelationship().setAttributeValue(context, relId, attrLocStat, sLocStatValue);
            }
        } catch (Exception e) {
            throw new FrameworkException(e);
        }
    ...
    public String showTypeSelected(Context context, String[] args) throws Exception {
        ...
        if (type.indexOf("type_") == 0) {
            imageForType = FrameworkProperties.getProperty("emxFramework.smallIcon." + type);
        } else {
            imageForType = FrameworkProperties.getProperty("emxFramework.smallIcon.type_" + type);
        }
    ...
    public String showOwnerField(Context context, String[] args) throws Exception {
        String strClear = i18nNow.getI18nString("emxManufacturerEquivalentPart.Common.Clear", "emxManufacturerEquivalentPartStringResource", context.getSession().getLanguage());
        ...
        StringBuffer outPut = new StringBuffer();
        outPut.append("<script language=\"javascript\" src=\"emxMEPFormValidation.jsp\"></script>");
     ...
     * @throws Exception
     */
    public String showStateField(Context context, String[] args) throws Exception {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getSuppliers(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (selectType.equals(PropertyUtil.getSchemaProperty(context, "type_BusinessUnit"))) {
                ...
                totalresultList = company.getRelatedObjects(context, srelPattern, // java.lang.String relationshipPattern,
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getInProcessSEPs(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (objectId != null)
                sepList = partObj.getRelatedObjects(context, CPCConstants.RELATIONSHIP_SUPPLIER_EQUIVALENT + "," + DomainConstants.RELATIONSHIP_MANUFACTURER_EQUIVALENT, // relationship pattern
                        CPCConstants.TYPE_SEP, // object pattern
                        selectStmts, // object selects
                        selectRelStmts, // relationship selects
                        true, // to direction
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getInProcessECParts(Context context, String[] args) throws Exception {
    ...
    public void addSEPParttoEC(Context context, String ecPartIds[]) throws FrameworkException {
        try {
            ...
            if (partType.equals(DomainConstants.TYPE_PART) && partPolicy.equals(DomainConstants.POLICY_MANUFACTURER_EQUIVALENT)) {
        ...
        try {
            ...
            if (sObjectId != null && !"".equals(sObjectId)) {
                ...
                if (isMEP) {
                     ...
                     */
                    MqlUtil.mqlCommand(context, "modify bus \"" + sObjectId + "\" add interface \"" + sExternalPartData + "\";");
                }
            }
        } catch (Exception e) {
            status = 1;
    ...
    public Vector getPartOrigin(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strManufacturerEquivalent = i18nNow.getI18nString("emxManufacturerEquivalentPart.Part.MfgEquivalent", "emxManufacturerEquivalentPartStringResource", languageStr);
            String strEnterprise = i18nNow.getI18nString("emxManufacturerEquivalentPart.Common.Enterprise", "emxManufacturerEquivalentPartStringResource", languageStr);
    ...
    public String displayRevision(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            outputStr.append("<input type=\"text\" readonly=\"readonly\" name=\"Revision\" value =\"" + revValue + "\" size=\"20\"></input>");

            outputStr.append("<input type=\"hidden\" name=\"rev\" value=\"" + revValue + "\"></input>");
    ...
    public String displayCustomRevision(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            outputStr.append("<input type=\"text\" name=\"CustomRevision\" value =\"" + custRevValue + "\" size=\"20\"></input>");

            outputStr.append("<input type=\"hidden\" name=\"customrev\" value=\"" + custRevValue + "\"></input>");
    ...
    public HashMap getRevisionValue(Context context, HashMap arguMap) throws Exception {
        ...
        try {
            ...
            String attrPlantId = PropertyUtil.getSchemaProperty(context, DomainSymbolicConstants.SYMBOLIC_attribute_PlantID);
            String customRevision = FrameworkProperties.getProperty("emxManufacturerEquivalentPart.MEP.allowCustomRevisions");
            String uniqueIdentifier = FrameworkProperties.getProperty("emxManufacturerEquivalentPart.MEP.UniquenessIdentifier");
            String CageCode = "";
            String CompId = "";
            String plantId = "";
    ...
    public MapList getEnterpriseSupplierEquivalents1(Context context, String[] args) throws Exception {
        ComponentsUtil.checkLicenseReserved(context, CPCConstants.BPS_PRODUCT_TRIGRAM);
        ...
        try {
            ...
            listLocEquivMEPs = partObj.getRelatedObjects(context, CPCConstants.RELATIONSHIP_SUPPLIER_EQUIVALENT, // relationship pattern
                    CPCConstants.TYPE_SEP, // object pattern
                    selectStmts, // object selects
                    selectRelStmts, // relationship selects
                    false, // to direction
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getEnterpriseSupplierAllEquivalents(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) paramMap.get("objectId");
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds a HashMap of the following entries:
     * @return a MapList of Manufaturer Equivalent Part object ids and relationship ids.
     * @throws Exception
     *             if the operation fails.
     */
    public MapList getNonQualifiedSupplierEquivalents(Context context, String[] args) throws Exception {
        ComponentsUtil.checkLicenseReserved(context, CPCConstants.BPS_PRODUCT_TRIGRAM);
    ...
    public MapList getEnterpriseSupplierEquivalents2(Context context, String[] args) throws Exception {
        ComponentsUtil.checkLicenseReserved(context, CPCConstants.BPS_PRODUCT_TRIGRAM);
     ...
     *             if the operation fails.
     */
    public MapList getNonQualifiedManufacturerEquivalents(Context context, String[] args) throws Exception {
        ComponentsUtil.checkLicenseReserved(context, CPCConstants.BPS_PRODUCT_TRIGRAM);
        ...
        try {
            ...
            listLocEquivMEPs = partObj.getRelatedObjects(context, RELATIONSHIP_MANUFACTURER_EQUIVALENT, // relationship pattern
    ...
    // To display
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getEnterpriseManufacturerAllEquivalents(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) paramMap.get("objectId");
    ...
    public MapList getEnterpriseManufacturerEquivalents1(Context context, String[] args) throws Exception {
        ComponentsUtil.checkLicenseReserved(context, CPCConstants.BPS_PRODUCT_TRIGRAM);
    ...
    public MapList getEnterpriseManufacturerEquivalents2(Context context, String[] args) throws Exception {
        ComponentsUtil.checkLicenseReserved(context, CPCConstants.BPS_PRODUCT_TRIGRAM);
    ...
    public MapList getQualificationDetails(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) paramMap.get("objectId");
        String relId = (String) paramMap.get("relId");
     ...
     *             if the operation fails.
     */
    public String showSupplierLocationField(Context context, String[] args) throws Exception {
        ...
        if (relationshipMap != null && relationshipMap.size() > 0) {
            ...
            MapList relListSE = domSupplierID.getRelatedObjects(context, relationOrgLoc, // relationship Pattern
     ...
     *             if the operation fails.
     */
    public String showSupplierField(Context context, String[] args) throws Exception {
    ...
    public String showSupplierField1(Context context, String[] args) throws Exception {
        String result = null;
     ...
     *             if the operation fails.
     */
    public HashMap showSupplierLocationField1(Context context, String[] args) throws Exception {
        String result = null;
        ...
        DebugUtil.debug("showSupplierLocationField1::fieldRangeValues:" + fieldRangeValues + " " + fieldDisplayRangeValues);
     ...
     * @param args
     *            holds a HashMap of the following entries: objectId - a String containing the Enterprise Part id.
     * @return a MapList of Supplier Equivalent Part object ids and relationship ids.
     * @throws Exception
     *             if the operation fails.
     */
    public MapList getBOMSEP(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            // fetching list of related SEPs
            DebugUtil.debug("Trying to retrieve the relation " + CPCConstants.RELATIONSHIP_SEP);
            listCorpMEPs = partObj.getRelatedObjects(context, relToUse, // relationship
                    // pattern
                    typePattern.toString(), // object pattern
                    selectStmts, // object selects
                    selectRelStmts, // relationship selects
    ...
    public void updateQualificationAttributes(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String attrName = PropertyUtil.getSchemaProperty(context, sAttrSymName);
    ...
    public void updateQualificationRelations(Context context, String[] args) throws Exception {
     ...
     *             if the operation fails.
     */
    public StringList showMfrLocations(Context context, String[] args) throws Exception {
     ...
     *             if the operation fails.
     */
    public String showMfr(Context context, String[] args) throws Exception {
     ...
     *             if the operation fails.
     */
    public StringList showSupplierLocations(Context context, String[] args) throws Exception {
        ...
        if (relationshipMap != null && relationshipMap.size() > 0) {
            ...
            relListSE = domSupplierID.getRelatedObjects(context, relationOrgLoc, // relationship Pattern
                    DomainConstants.TYPE_LOCATION, // type Pattern
                    selectStmts, // objectSelects
                    relSelects, // relSelects
                    false, // getTo
    ...
    public MapList getEnterpriseBOMSupplierAllEquivalents(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            listLocEquivMEPs = partObj.getRelatedObjects(context, relToUse, // relationship pattern
    ...
    public MapList getEnterpriseBOMSupplierEquivalents1(Context context, String[] args) throws Exception {
    ...
    public MapList getEnterpriseBOMSupplierEquivalents2(Context context, String[] args) throws Exception {
    ...
    public StringList getAssembliesForPart(Context context, String[] args) throws Exception {
        StringList result = new StringList();
    ...
    public MapList getEnterpriseBOMEquivalents1(Context context, String[] args) throws Exception {
        ComponentsUtil.checkLicenseReserved(context, CPCConstants.BPS_PRODUCT_TRIGRAM);
    ...
    public MapList getEnterpriseBOMEquivalents2(Context context, String[] args) throws Exception {
        ComponentsUtil.checkLicenseReserved(context, CPCConstants.BPS_PRODUCT_TRIGRAM);
    ...
    public static HashMap getQualificationPreferences(Context context, String[] args) throws Exception {
        ...
        fieldDisplayRangeValues.add(EnoviaResourceBundle.getProperty(context, "emxComponentCentralStringResource", new Locale(context.getSession().getLanguage()),
                "emxComponentCentral.Attribute.LocationPreference.Preferred"));
        ...
        fieldDisplayRangeValues.add(EnoviaResourceBundle.getProperty(context, "emxComponentCentralStringResource", new Locale(context.getSession().getLanguage()),
                "emxComponentCentral.Attribute.LocationPreference.NotPreferred"));
    ...
    public MapList getEnterpriseParts(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            StringList selectRelStmts = new StringList(1);
            selectRelStmts.addElement(SELECT_RELATIONSHIP_ID);
            corpEPs = partObj.getRelatedObjects(context, CPCConstants.RELATIONSHIP_SUPPLIER_EQUIVALENT + "," + DomainConstants.RELATIONSHIP_MANUFACTURER_EQUIVALENT, // relationship
                    TYPE_PART, // object pattern
                    selectStmts, // object selects
                    selectRelStmts, // relationship selects
                    true, // to direction
    ...
    public MapList getMultiLevelEBOMsforBQSL(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            relWhere += "|| (tomid[Qualification].from.attribute[Qualification Type ID] == \"BQSL2\")";
            ebomList = partObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EBOM + "," + CPCConstants.RELATIONSHIP_QUALIFICATION, // relationship pattern
                    DomainConstants.TYPE_PART, // object pattern
                    selectStmts, // object selects
                    selectRelStmts, // relationship selects
                    false, // to direction
        ...
        try {
            ...
            for (int i = 0; i < objectList.size(); i++) {
                ...
                if (getTableName(paramMap).equals("CPCBQSLReportSummary")) {
                    ...
                    qualificationId = MqlUtil.mqlCommand(context, getBQSLMQLQuery(), CPCConstants.TYPE_QUALIFICATION, MQL_ALL_TYPE_OR_REV, MQL_ALL_TYPE_OR_REV, MQL_ATTR_QUAL_TYPE_ID,
                            MQL_BQSL_QUAL_TYPE, CPCConstants.PIPE_SEPARATOR);
                    ...
                    qualificationId = MqlUtil.mqlCommand(context, getBQMLMQLQuery(), CPCConstants.TYPE_QUALIFICATION, MQL_ALL_TYPE_OR_REV, MQL_ALL_TYPE_OR_REV, MQL_ATTR_QUAL_TYPE_ID,
                            MQL_BQML_QUAL_TYPE, CPCConstants.PIPE_SEPARATOR);
    ...
    public MapList getMultiLevelEBOMsforBQML(Context context, String[] args) throws Exception {
    ...
    public Vector getSEPart(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < objectList.size(); i++) {
                ...
                MapList sepList = new DomainObject((String) map.get(SELECT_ID)).getRelatedObjects(context, CPCConstants.RELATIONSHIP_SEP, // relationship pattern
                        CPCConstants.TYPE_SEP, // object pattern
    ...
    public Vector getMEPart(Context context, String[] args) throws Exception {
        ...
        try {
            for (int i = 0; i < objectList.size(); i++) {
                Hashtable map = (Hashtable) objectList.get(i);
                MapList mepList = new DomainObject((String) map.get(SELECT_ID)).getRelatedObjects(context, CPCConstants.RELATIONSHIP_MEP, // relationship pattern
    ...
    /*
     * private String getBQSLMQLQuery(){ String bqslMql = "temp query bus '"+"Qualification"+"' '*' ' *' " + "where 'attribute["+"Qualification Type ID"+"] MATCH  BQSL*" + "\" ' select id dump |;";
     * return bqslMql; } private String getBQMLMQLQuery(){ String bqmlMql = "temp query bus '"+"Qualification"+"' '*' ' *' " + "where 'attribute["+"Qualification Type ID"+"] MATCH  BQML*" +
     * "\" ' select id dump |;"; return bqmlMql; }
     */

    // Though both the queries are same, just using different method names as used earlier
    private String getBQSLMQLQuery() {
        String bqslMql = "temp query bus $1 $2 $3 " + "where '$4 MATCH $5 ' " + "select id dump $6;";
        return bqslMql;
    }

    private String getBQMLMQLQuery() {
        String bqmlMql = "temp query bus $1 $2 $3 " + "where '$4 MATCH $5 ' " + "select id dump $6;";
        return bqmlMql;
    }
    ...
    /**
     * excludeAlreadyConnectedGeneralClass - returns the list of Object ids that are already connected to parent Object.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param arguMap
     *            contains packed HashMap with the following entries: objectId
    ...
    public StringList getQualificationLink(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        Map paramList = (HashMap) paramMap.get("paramList");
        String suiteDir = (String) paramList.get("SuiteDirectory");
        String suiteKey = (String) paramList.get("suiteKey");
        ...
        String imgSrc = "<img src='images/" + "iconActionEdit.gif" + "' border='0'/>";
            ...
            if (objectList != null && objectList.size() > 0) {
                ...
                for (int i = 0; i < objectListSize; i++) {
                    ...
                    if (qualificationId == null || qualificationId.equals("")) {
                        ...
                        /*
                         * mqlCmdTxt = "print bus $1 select $2 dump"; selectFieldValue = "to["+relToUse+"].tomid[Qualification].id"; String qualRelId=MqlUtil.mqlCommand(context, mqlCmdTxt, objId,
                         * selectFieldValue);
                         */
                        ...
                        for (int q = 0; q < qualIdList.size(); q++) {
                            ...
                            if (vepType.equals("bommepType"))
                                output.append("<a href=\"JavaScript:emxTableColumnLinkClick('../common/emxTree.jsp" + "?treeMenu=CPCQualificationMenuMEP&amp;emxSuiteDirectory=");
                            else
                                output.append("<a href=\"JavaScript:emxTableColumnLinkClick('../common/emxTree.jsp" + "?treeMenu=CPCQualificationMenu&amp;emxSuiteDirectory=");
    ...
    public HashMap getAssembliesForEditPart(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            DebugUtil.debug("getAssembliesForEditPart::fieldRangeValues:" + fieldRangeValues + " " + fieldDisplayRangeValues);
    ...
    public void clearCascadeQualificationObjects(Context context, String args[]) throws Exception {
        try {
    ...
    public void setEquivalentRelationName(Context context, String args[]) throws Exception {
        try {
    ...
    public String showManufacturerField1(Context context, String[] args) throws Exception {
        String result = null;
    ...
    public String showMEPUsageLocations(Context context, String[] args) throws Exception {
        ...
        if (null != objectId) {
            ...
            if (null != domObj && (domObj.getInfo(context, DomainConstants.SELECT_TYPE).equals(DomainConstants.TYPE_PART)
                ...
                /*
                 * usageLocations = MqlUtil.mqlCommand(context, "print bus "+ objectId + " select to[Allocation Responsibility].from.name dump");
                 */
                ...
                /*
                 * usageLocations = MqlUtil.mqlCommand(context, "print bus "+ objectId + " select from[Qualification].torel[Manufacturer Equivalent].to.to[Allocation Responsibility].from.name dump");
                 */
    ...
    public String showSEPUsageLocations(Context context, String[] args) throws Exception {
        ...
        if (null != objectId) {
            ...
            if (null != domObj && (domObj.getInfo(context, DomainConstants.SELECT_TYPE).equals(DomainConstants.TYPE_PART)
                ...
                /*
                 * usageLocations = MqlUtil.mqlCommand(context, "print bus "+ objectId + " select from[Qualification].torel[Supplier Equivalent].to.to[Allocation Responsibility].from.name dump");
                 */
    ...
    public boolean checkProductLicense(Context context, String args[]) throws FrameworkException {
    ...
    public void qualifySEP(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            boolean isLocationBasedQual = false;
            boolean isBOMQual = false;
            ...
            String mqlQuery = null;
            String locRelationId = null;
            ...
            /*
             * NOTE: (eeq) - V6R2013 release [IR-154386V6R2013] Part of the code here is commented due to implementation issue with Parameterized MQL API module. This code needs to enabled again at
             * later point of time once the issue is addressed.
             */
            ...
            if (isLocationBasedQual) {
                ...
                mqlQuery = "temp query bus Location '" + supplierLocation + "' * where \"" + "to[Organization Location].from.name == '" + supplierName + "'\""
                        + " select to[Organization Location].id dump |";

                /*
                 * whereCondTxt = "\""+"to[Organization Location].from.name == '"+supplierName+"'"+"\""; selectFieldValue = "to[Organization Location].id"; mqlQuery =
                 * "temp query bus $1 $2 $3 where $4 select $5 dump $6";
                 * 
                 * DebugUtil.debug("qualifySEP::mqlQuery-location based==>"+mqlQuery);
                 * 
                 * String txtOutput = MqlUtil.mqlCommand(context, mqlQuery, "Location", "'"+supplierLocation+"'", MQL_ALL_TYPE_OR_REV, whereCondTxt, selectFieldValue, CPCConstants.PIPE_SEPARATOR);
                 */
            ...
            if (isBOMQual) {
                ...
                mqlQuery = "temp query bus Part '" + partName + "' * where \"" + "to[EBOM].from.name == '" + assemblyPartName + "'\"" + " select to[EBOM].id dump |";

                /*
                 * whereCondTxt = "\""+"to[EBOM].from.name == '"+assemblyPartName+"'\""; selectFieldValue = "to[EBOM].id"; mqlQuery = "temp query bus $1 $2 $3 where $4 select $5 dump $6";
                 * 
                 * DebugUtil.debug("qualifySEP::mqlQuery-BOM specific==>"+mqlQuery+", whereCondTxt"+whereCondTxt);
                 * 
                 * String txtOutput = MqlUtil.mqlCommand(context, mqlQuery, "Part", "'"+partName+"'", MQL_ALL_TYPE_OR_REV, whereCondTxt, selectFieldValue, CPCConstants.PIPE_SEPARATOR);
                 */
            ...
            if (qualObjId != null && vequivRelId != null) {
                ...
                /*
                 * mqlCmdStatus = MqlUtil.mqlCommand(context, createQualStmt, CPCConstants.TYPE_QUALIFICATION, qualObjId, vequivRelId);
                 */
            ...
            if (isLocationBasedQual) {
                ...
                mqlCmdStatus = MqlUtil.mqlCommand(context, createQualStmt, true);
                /*
                 * mqlCmdStatus = MqlUtil.mqlCommand(context, createQualStmt, CPCConstants.TYPE_QUALIFICATION, qualObjId, locRelationId);
                 */
            ...
            if (isBOMQual) {
                ...
                mqlCmdStatus = MqlUtil.mqlCommand(context, createQualStmt, true);
                /*
                 * mqlCmdStatus = MqlUtil.mqlCommand(context, createQualStmt, CPCConstants.TYPE_QUALIFICATION, qualObjId, eBOMRelId);
                 */
    ...
    public void qualifyMEP(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (isLocationBasedQual) {
                ...
                mqlQuery = "temp query bus Location '" + manufacturerLocation + "' * where \"" + "to[Organization Location].from.name == '" + manufacturerName + "'\""
                        + " select to[Organization Location].id dump |";

                /*
                 * whereCondTxt = "\""+"to[Organization Location].from.name == '"+manufacturerLocation+"'"+"\""; selectFieldValue = "to[Organization Location].id"; mqlQuery =
                 * "temp query bus $1 $2 $3 where $4 select $5 dump $6";
                 * 
                 * DebugUtil.debug("qualifyMEP::mqlQuery-location based==>"+mqlQuery);
                 * 
                 * String txtOutput = MqlUtil.mqlCommand(context, mqlQuery, "Location", "'"+manufacturerLocation+"'", MQL_ALL_TYPE_OR_REV, whereCondTxt, selectFieldValue, CPCConstants.PIPE_SEPARATOR);
                 */
    ...
    public void clearQualifySign(Context context, String args[]) throws Exception {
        try {
    ...
    public void clearDisqualifySign(Context context, String args[]) throws Exception {
        try {
    ...
    public HashMap getSuppliersByContext(Context context, String[] args) throws Exception {
        ...
        MapList supplierList = (MapList) JPO.invoke(context, "emxCompany", constructor, "getSuppliers", sArgs, MapList.class);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap of the following entries: objectId - a String containing the Part id
     * @return Boolean to activate command or not
     * @throws Exception
     *             if the operation fails
     * @exclude
     */
    public Boolean enableCmdsInManufacturerEquivalentsTab1(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) paramMap.get("objectId");
        ...
        if (partType.equals(DomainConstants.TYPE_PART) && (partPolicy.equals(DomainConstants.POLICY_DEVELOPMENT_PART) || partPolicy.equals(DomainConstants.POLICY_EC_PART)
                || partPolicy.equals(CPCConstants.POLICY_STANDARD_PART) || partPolicy.equals(CPCConstants.POLICY_CONFIGURED_PART))) {
     ...
     * @exclude
     */
    public Boolean enableCmdsInManufacturerEquivalentsTab2(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) paramMap.get("objectId");
        Boolean hasAccess = new Boolean(false);
        ...
        if (partType.equals(CPCConstants.TYPE_SUPPLIER_EQUIVALENT_PART) && partPolicy.equals(CPCConstants.POLICY_SEP)) {
            hasAccess = new Boolean(true);
        }
     ...
     * @exclude
     */
    public Boolean enableCmdsInSupplierEquivalentsTab1(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) paramMap.get("objectId");
        Boolean hasAccess = new Boolean(false);
     ...
     * @exclude
     */
    public Boolean enableCmdsInSupplierEquivalentsTab2(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) paramMap.get("objectId");
        Boolean hasAccess = new Boolean(false);
     ...
     * @exclude
     */
    public Boolean enableCmdsInPartEquivalentsTab1(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) paramMap.get("objectId");
        Boolean hasAccess = new Boolean(false);
     ...
     * @exclude
     */
    public Boolean enableCmdsInPartEquivalentsTab2(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) paramMap.get("objectId");
        Boolean hasAccess = new Boolean(false);
