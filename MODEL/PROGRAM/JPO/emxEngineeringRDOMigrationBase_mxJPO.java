...
public class emxEngineeringRDOMigrationBase_mxJPO extends emxCommonMigration_mxJPO {
     ...
     * @grade 0
     */
    public emxEngineeringRDOMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }

    /**
     * This method does the migration work. This method is used to Organization and Project information. The Organization value will be updated based on the RDO/RCO. If RDO/RCO is blank, then updates
     * with Host Company Name. The Project will be Default
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param objectIdList
    ...
    public void migrateObjects(Context context, StringList objectIdList) throws Exception {
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                // String result = MqlUtil.mqlCommand(context, "modify bus $1 altowner1 $2 altowner2 $3", strObjId, strRDOName, strProject);
