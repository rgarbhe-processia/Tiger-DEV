...
public class emxPackageTransferBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @since EC 10.5.
     */
    public emxPackageTransferBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    /**
     * This method return true if FCS is enabled & property is set to true otherwise return false.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     ...
     * @since EC 10-5.
     */
    public Boolean hasDownloadAndPackageTransfer(Context context, String[] args) throws Exception {
