...
public class emxECRBase_mxJPO extends emxCommonECR_mxJPO {
    /** state "Plan ECO" for the "ECR Standard" policy. */
    public static final String STATE_ECR_PLANECO = PropertyUtil.getSchemaProperty("policy", POLICY_ECR, "state_PlanECO");
     ...
     * @since EC Rossini.
     */
    public emxECRBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    /**
     * Check the number of ECO's connected to the ECR, If more than one ECO connected display warning "Automatic revisioning is not possible, because this ECR is connected to more than 1 ECO". If only
     * one ECO connected, then the trigger will evaluate each affected item connected to the ECR, to check for the following conditions. 1) The Affected item has a revision sequence from which the
     * next revision can be determined. 2) The current user has revise access on that Affected item. If both these check are valid for an affected item, then the trigger will get the next revision,
     * and connect the next revision to the ECO, provided the next revision of affected item not connected to any other ECO.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds no arguments.
    ...
    public void autoRevECRAffectedItems(matrix.db.Context context, String[] args) throws Exception {
        try {
            ...
            MapList objList = getRelatedObjects(context, RELATIONSHIP_ECO_CHANGEREQUESTINPUT, TYPE_ECO, objectSelects, null, true, false, (short) 1, null, null);
            ...
            if (objList == null) {
                emxContextUtil_mxJPO.mqlNotice(context, EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECR.AutoRevECRAffectedItemsErrorNoECO", context.getSession().getLanguage()));
                return;
            } else if (objList.size() != 1) {
                emxContextUtil_mxJPO.mqlNotice(context, EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECR.AutoRevECRAffectedItemsErrorManyECO", context.getSession().getLanguage()));
                return;
            } else {
            ...
            objList = getRelatedObjects(context, ecrRelPattern, "*", objectSelects, relSelects, false, true, (short) 1, null, null);
            ...
            if (sWarning != null) {
                ...
                emxContextUtil_mxJPO.mqlWarning(context,
                        EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECR.AutoRevECRAffectedItemsWarning", context.getSession().getLanguage()) + sWarning);
            }
        } catch (Exception ex) {
            throw (ex);
        }
    ...
    /**
     * Perform the promote action on an ECR policy ECR Standard. Checks the following. - Checks the if any ECOs are connected to the ECR. - If not, cause post processing of promote to happen at JSP
     * level by using MQL notice.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds no arguments.
     ...
     */
    public void autoAssociateECO(Context context, String[] args) throws Exception {
        StringList objectSelects = new StringList(1);
        objectSelects.addElement(DomainObject.SELECT_ID);
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds the following input arguments: 0 - String containing the ECR id.
    ...
    public String getBasicInfo(Context context, String args[]) throws Exception {
        ...
        returnString.append("<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Name", strLanguage) + "</strong>:&nbsp;</td><td>" + attributeMap.get(SELECT_NAME)
                + "</td></tr>");
        returnString.append("<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Type", strLanguage) + "</strong>:&nbsp;</td><td>" + attributeMap.get(SELECT_TYPE)
                + "</td></tr>");
        returnString
                .append("<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.ProductLine", strLanguage) + "</strong>:&nbsp;</td><td>" + ProductLineName + "</td></tr>");
        returnString.append("<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.State", strLanguage) + "</strong>:&nbsp;</td><td>"
        ...
        returnString.append("<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Owner", strLanguage) + "</strong>:&nbsp;</td><td>"
                + com.matrixone.apps.domain.util.PersonUtil.getFullName(context, ((String) attributeMap.get(SELECT_OWNER))) + "</td></tr>");
        returnString.append("<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Originator", strLanguage) + "</strong>:&nbsp;</td><td>"
                + com.matrixone.apps.domain.util.PersonUtil.getFullName(context, ((String) attributeMap.get(SELECT_ORIGINATOR))) + "</td></tr>");
        returnString.append("<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Originated", strLanguage) + "</strong>:&nbsp;</td><td>" + actiondateoriginated
                + "</td></tr>");
        returnString.append(
                "<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Modified", strLanguage) + "</strong>:&nbsp;</td><td>" + actiondateModified + "</td></tr>");
        returnString
                .append("<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Description", strLanguage) + "</strong>:&nbsp;</td><td>" + ecrDesc + "</td></tr>");
        ...
        while (ecrAttrListItr.hasNext()) {
            ...
            if (attrName.equals(ECR.ATTRIBUTE_REASON_FOR_CHANGE) || attrName.equals(ECR.ATTRIBUTE_GENERAL_DESCRIPTION_OF_CHANGE) || attrName.equals(ECO.ATTRIBUTE_REASON_FOR_CANCEL)
            ...
            if ((ECO.ATTRIBUTE_RESPONSIBLE_DESIGN_ENGINEER).equals(attrName) || (ECR.ATTRIBUTE_ECR_EVALUATOR).equals(attrName) || (ECR.ATTRIBUTE_CATEGORY_OF_CHANGE).equals(attrName)) {
            ...
            if (!attrName.equals(ATTRIBUTE_ORIGINATOR)) {
                ...
                if (!attrValue.equals(Unassigned) && ((ECO.ATTRIBUTE_RESPONSIBLE_DESIGN_ENGINEER).equals(attrName) || (ECR.ATTRIBUTE_ECR_EVALUATOR).equals(attrName))) {
        ...
        returnString.append("<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.DesignResponsibility", strLanguage) + "</strong>:&nbsp;</td><td>"
                + sDesignResponsibility + "</td></tr>");
        returnString.append("<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Vault", strLanguage) + "</strong>:&nbsp;</td><td>"
                + attributeMap.get(SELECT_VAULT) + "</td></tr>");
        returnString.append("<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Policy", strLanguage) + "</strong>:&nbsp;</td><td>"
                + attributeMap.get(SELECT_POLICY) + "</td></tr>");
        returnString.append("</table></td>");
        returnString.append("</tr>");
    ...
    public String getApprovals(Context context, String args[]) throws Exception {
        ...
        while (mapItr.hasNext()) {
            ...
            if (hasSigs) {
                ...
                returnString.append("<tr >");
                returnString.append("<td class=\"listCell\" style=\"text-align: \"  valign=\"top\">" + i18nNow.getStateI18NString(sPolicy, sStateName.trim(), strLanguage)
                        + "&nbsp;</td> <td class=\"listCell\" style=\"text-align: \" valign=\"top\">" + sLifeCycle + "&nbsp;</td>");
            ...
            for (int rteCnt = 0; rteCnt < routes.size(); rteCnt++) {
                ...
                for (int k = 0; k < memberList.size(); k++) {
                    ...
                    if (k > 0) {
                        returnString.append("<tr > <td class=\"listCell\" style=\"text-align: \" valign=\"top\">&nbsp</td><td class=\"listCell\" style=\"text-align: \" valign=\"top\">&nbsp</td>"); // last
                                                                                                                                                                                                     // td
                                                                                                                                                                                                     // replaced
                                                                                                                                                                                                     // with
                                                                                                                                                                                                     // style
                    ...
                    returnString.append("<td class=\"listCell\" style=\"text-align: \" valign=\"top\">" + i18nNow.getRangeI18NString("", routeNodeStatus, strLanguage)
                            + "&nbsp;</td> <td class=\"listCell\" style=\"text-align: \" valign=\"top\">" + routeNodeComments + "&nbsp;</td>     </tr>");
                }
            }
        }
    ...
    public String getSupportingDocsDetails(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            SupportDocsList = ecrObj.expandSelect(context, srelPattern, "*", selectStmts, selectRelStmts, false, true, (short) 1, null, null, null, false);
            // Added for Bug-310047 on 10/May/2006
        ...
        while (mapItr.hasNext()) {
            ...
            returnString.append("<tr>");
            returnString.append("<td class=\"listCell\" style=\"text-align: \" valign=\"top\"><img src=\"../common/images/" + imgSpecType + "\" border=\"0\" alt=\"*\">&nbsp;"
                    + specMap.get(DomainConstants.SELECT_NAME) + "&nbsp;</td>");
        ...
        if (SupportDocsList.size() == 0) {
            returnString.append(
                    "<tr><td colspan=\"5\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ReviewECR.NorelatedSupportingDocumentsarefoundforthis", strLanguage) + "</td></tr>");
        }
        returnString.append("</table>");
        String finalStr = returnString.toString();
     ...
     *            the eMatrix <code>Context</code> object.
     * @param resourceID
     *            String holding resourceID.
     * @return Boolean set to the value of the resource.
     * @throws Exception
     *             if the operation fails.
     * @since EC 10.5.
     */
    private static Boolean emxCheckAccess(Context context, String resoureID) throws Exception {
    ...
    public static Boolean emxCheckObsoletePartsAccess(Context context, String[] args) throws Exception {
     ...
     * @since 10.5.
     */
    public static Boolean emxCheckRevisedPartsAccess(Context context, String[] args) throws Exception {
     ...
     * @since 10.5.
     */
    public static Boolean emxCheckRevisedSpecsAccess(Context context, String[] args) throws Exception {
     ...
     * @since 10.5.
     */
    public static Boolean emxCheckSupportingDocsAccess(Context context, String[] args) throws Exception {
    ...
    public static Boolean emxCheckCreateDynamicApprovalECR(Context context, String[] args) throws Exception {
    ...
    public String createHtmlReport(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            summaryReport.append("<tr><td class=\"pageHeader\"><h1>" + ecrObj.getInfo(context, SELECT_NAME) + " : "
                    + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.SummaryReport", strLanguage) + "</h1></td></tr>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td><br></td></tr><tr><td class=\"subhead\"><h2>"
                        + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.Approvals", strLanguage) + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"> <tr><td class=\"subhead\"><h2>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Tasks", strLanguage)
                        + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td><br></td></tr><tr><td class=\"subhead\"><h2>"
                        + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.ECRAffectedItems", strLanguage) + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td><br></td></tr><tr><td class=\"subhead\"><h2>"
                        + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.ECRAffectedSpecs", strLanguage) + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td><br></td></tr><tr><td class=\"subhead\"><h2>"
                        + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECR.Assignees", strLanguage) + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td><br></td></tr><tr><td class=\"subhead\"><h2>"
                        + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECR.RelatedMarkups", strLanguage) + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td><br></td></tr><tr><td class=\"subhead\"><h2>"
                        + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECR.RelatedResolvedItems", strLanguage) + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td><br></td></tr><tr><td class=\"subhead\"><h2>"
                        + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.SupportingDocs", strLanguage) + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td><br></td></tr><tr><td class=\"subhead\"><h2>"
                        + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECR.RelatedECOs", strLanguage) + "</h2></td></tr></table>");
     ...
     *            holds the following input arguments: 0 - String containing the ECR id.
     * @param summaryReport
     *            the String that needs to be rendered into PDF.
     ...
     * @param actiondate
     *            String which holds the date in the supplied format.
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the following Strings, "objectId", "old value", "New OID".
    ...
    public Object updateProductLine(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the following Strings, "objectId", "New Value". requestMap - a HashMap containing the request.
    ...
    public Object changePolicy(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the request values.
    ...
    public MapList getRelatedECOs(Context context, String[] args) throws Exception {
        ...
        MapList relatedECOs = ecrObj.expandSelect(context, srelPattern, "*", selectStmts, selectRelStmts, true, false, (short) 1, null, null, null, false);
        return relatedECOs;
    }
    ...
    public String getRelatedECOsDetails(Context context, String[] args) throws Exception {
        if (args == null || args.length < 1) {
            throw (new IllegalArgumentException());
        }
        ...
        SelectList selectRelStmts = null;
        MapList relatedECOs = ecrObj.expandSelect(context, RELATIONSHIP_ECO_CHANGEREQUESTINPUT, "*", selectStmts, selectRelStmts, true, false, (short) 1, null, null, null, false);
        // Added for Bug-310047 on 10/May/2006
        ...
        if (relatedECOs != null) {
            ...
            while (mapItr.hasNext()) {
                ...
                returnString.append("<tr>");
                returnString.append("<td class=\"listCell\" style=\"text-align: \" valign=\"top\"><img src=\"../common/images/" + imgECOType + "\" border=\"0\" alt=\"*\">&nbsp;"
                        + ecoMap.get(DomainConstants.SELECT_NAME) + "&nbsp;</td>");
     ...
     * @exception Exception
     *                if the operation fails. This is only for Started Route
     * @since EC 10.6
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getECRECOSearchResultActive(Context context, String[] args) throws Exception {
        ...
        if (txtRDO == null || txtRDO.length() == 0 || "null".equals(txtRDO)) {
            ...
            MapList routeList = DomainObject.findObjects(context, TYPE_ROUTE, "*", "*", "*", "*", sWhereCond, null, true, busSelect, (short) 0); // Modified for IR-253617
            ...
            if (uniqueRoutList != null && ((intRouteSize = uniqueRoutList.size()) > 0)) {
                ...
                for (int i = 0; i < intRouteSize; i++) {
                    ...
                    objResultList = domObject.getRelatedObjects(context, RELATIONSHIP_OBJECT_ROUTE, selType, selectListECR, null, true, false, (short) 1, sWhere, "");
            ...
            objResultList = DomainObject.findObjects(context, selType, "*", "*", "*", "*", sWhere, null, true, selectListECR, (short) 0);
     ...
     * @return Vector containing search result.
     * @exception Exception
     *                if the operation fails. This is used for both Started and not Started Routes
     * @since EC 10.6
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getECRECOSearchResultAll(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        com.matrixone.apps.domain.DomainObject domObject = new com.matrixone.apps.domain.DomainObject();
        com.matrixone.apps.common.InboxTask inboxTask = new com.matrixone.apps.common.InboxTask();
        ...
        while (objMapItr.hasNext()) {
            ...
            for (int i = routeList.size() - 1; i >= 0; i--) {
                ...
                MapList relatedTaskInfo = route.getRelatedObjects(context, route.RELATIONSHIP_ROUTE_NODE, // java.lang.String relationshipPattern
     ...
     * @since EC 10.6
     */
    public Vector getLateInboxTaskAction(Context context, String[] args) throws Exception {
     ...
     * @since EC 10.6
     */
    public Vector getLateInboxTaskAssignee(Context context, String[] args) throws Exception {
     ...
     * @since EC 10.6
     */
    public Vector getLateInboxTaskDueDate(Context context, String[] args) throws Exception {
    ...
    public Vector getLateDays(Context context, String[] args) throws Exception {
    ...
    /**
     * All EBOM Markup in the Approved state that are related to the ECR is connected to the ECO by the relationship, Applied Markup
     * @param context
     *            the Matrix Context
     * @param args
     ...
     * @param args
     *            holds Relationship attribute name.
     * @param args
     *            holds FROM/TO.
     * @param args
     *            holds Role value.
     ...
     * @param args
     *            holds Notification Object Name.
     * @return Boolean.
     * @throws Exception
     *             if the operation fails.
     * @since X3.
     ...
     * @throws Exception
     *             if the operation fails Since EC-X3 Created by Preeti
     */
    ...
    /**
     * To set the lead roles for persons. This method connects ECR and Person with Lead Responsibility
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
    ...
    public boolean setLeadRoles(Context context, String[] args) throws Exception {
        ...
        MapList mlPerson = doOrg.getRelatedObjects(context, strRelationshipLeadResponsibility, PropertyUtil.getSchemaProperty(context, "type_Person"), DomainConstants.EMPTY_STRINGLIST, relStringList,
                false, true, (short) 1, "current == " + STATE_PERSON_ACTIVE, " attribute[" + strAttributeProjectRole + "].value smatch '*" + strRoleName + "*'");
        if (mlPerson != null && mlPerson.size() > 0) {
            ...
            MapList mlECRPerson = doECR.getRelatedObjects(context, strRelationshipLeadResponsibility, PropertyUtil.getSchemaProperty(context, "type_Person"), DomainConstants.EMPTY_STRINGLIST,
                    relStringList, false, true, (short) 1, "", " to.id match '" + strPersonId + "'");
    ...
    public String[] getLeadRoles(Context context, String[] args) throws Exception {
        ...
        MapList mlPerson = (MapList) doECR.getRelatedObjects(context, strRelationshipLeadResponsibility, PropertyUtil.getSchemaProperty(context, "type_Person"), DomainConstants.EMPTY_STRINGLIST,
                slRelSel, false, true, (short) 1, "", "to.id==" + sPersonObjId);
    ...
    public String getLeadPerson(Context context, String[] args) throws Exception {
        ...
        MapList mlPersons = doECR.getRelatedObjects(context, strRelationshipLeadResponsibility, PropertyUtil.getSchemaProperty(context, "type_Person"), DomainConstants.EMPTY_STRINGLIST, slRelSel,
                false, true, (short) 1, "", "");
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds the arguments: - ObjectID of the ECR
     * @throws Exception
     *             if the operation fails.
     * @since EngineeringCental X3.
     */
    public String getAffectedOrganizations(Context context, String[] args) throws Exception {
        ...
        String RELATIONSHIP_DESIGN_RESPONSIBILITY = PropertyUtil.getSchemaProperty(context, "relationship_DesignResponsibility");
        DomainObject objDomain = new DomainObject(objectId);
        StringList objectSelects = new StringList(2);
        objectSelects.addElement(DomainConstants.SELECT_ID);
        objectSelects.addElement(DomainConstants.SELECT_NAME);

        MapList mapPart = objDomain.getRelatedObjects(context, RELATIONSHIP_AFFECTED_ITEM, DomainConstants.TYPE_PART, objectSelects, null, false, true, (short) 1, null, null);
    ...
    /**
     * To set the lead roles for persons. This method connects ECR and RCO with Change Responsibility relationship
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
    ...
    public String generateHtmlSummaryReport(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td><br></td></tr><tr><td class=\"subhead\"><h2>"
                        + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.ReferenceDocs", strLanguage) + "</h2></td></tr></table>");
    ...
    public String getECRBasicInfo(Context context, String args[]) throws Exception {
        ...
        while (ecrAttrListItr.hasNext()) {
            attrName = ((AttributeType) ecrAttrListItr.next()).getName();
            // Start IR-010312
            if (attrName.equals(PropertyUtil.getSchemaProperty(context, "attribute_ReviewersComments"))
                    || attrName.equals(PropertyUtil.getSchemaProperty(context, "attribute_GeneralDescriptionofChange"))) {
        ...
        while (ecrAttrListItr.hasNext()) {
            attrName = ((AttributeType) ecrAttrListItr.next()).getName();
            attrValue = (String) attributeMap.get("attribute[" + attrName + "]");
            if ((ECO.ATTRIBUTE_RESPONSIBLE_DESIGN_ENGINEER).equals(attrName) || (ECR.ATTRIBUTE_CATEGORY_OF_CHANGE).equals(attrName)) {
                attrValue = (attrValue.equals(defaultVal)) ? Unassigned : attrValue;
            }

            if (!(attrName.equals(ATTRIBUTE_ORIGINATOR) || attrName.equals(PropertyUtil.getSchemaProperty(context, "attribute_EndDate"))
                    || attrName.equals(PropertyUtil.getSchemaProperty(context, "attribute_isDeviation")) || attrName.equals(PropertyUtil.getSchemaProperty(context, "attribute_StartDate"))
        ...
        String strReviewalRoute = (String) attributeMap.get("from[" + sRelObjectRoute + "].to.name");
        ...
        returnString.append("<tr><td><strong>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Label.ChangeResponsibility", strLanguage) + "</strong>:&nbsp;</td><td>"
                + sDesignResponsibility + "</td></tr>");
        ...
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.Form.Label.ReviewerList")
                + "</strong>:&nbsp;</td><td>" + strReviewalRoute + "</td></tr>");

        // IR-009780V6R2011
        // Multitenant
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.Common.DistributionList")
                + ":</td><td class=\"inputField\">" + strApprovalRoute + "</td></tr>");
    ...
    public String getECRApprovals(Context context, String args[]) throws Exception {
                    ...
                    if (!strListRouteCheck.contains(sRouteId)) {
                        ...
                        if ((rteCnt == 0)) {
                            ...
                            returnString.append("<td valign=\"top\" class=\"listCell\" style=\"text-align: \" >"
                                    + EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), "emxFramework.State.ECR." + sStateName) + "&nbsp;</td>");
                        } else {
                            returnString.append("<td class=\"listCell\" style=\"text-align: \" valign=\"top\">&nbsp;</td>");
                        }
                        if (sRouteId != null && !"null".equals(sRouteId) && !"".equals(sRouteId)) {
                        ...
                        returnString.append("<td class=\"listCell\" style=\"text-align: \" valign=\"top\">" + sRoute + "&nbsp;</td> <td class=\"listCell\" style=\"text-align: \" valign=\"top\">"
                                + routeNodeComments + "&nbsp;</td></tr>");
                    }
                    sPersonName = "";
                    routeNodeStatus = "";
                    routeNodeComments = "";
        ...
        if (!bRouteSize && !bSign) {
            // to fix IR-091260V6R2012
            returnString.append("<tr><td class=\"even\" style=\"text-align: \" colspan=6 align=\"left\" > "
                    + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.SummaryReport.NoSignOrRoutes", strLanguage) + "</td></tr>");
        }
    ...
    public String getECRRoutes(Context context, String[] args) throws Exception, MatrixException {
        try {
            String strLanguage = context.getSession().getLanguage();
            String objectId = args[0];
            Route routeObj = (Route) DomainObject.newInstance(context, TYPE_ROUTE);
    ...
    public String getECRTasks(Context context, String[] args) throws Exception, MatrixException {
        try {
            String strLanguage = context.getSession().getLanguage();
            String objectId = args[0];
            Route routeObj = (Route) DomainObject.newInstance(context, TYPE_ROUTE);
    ...
    public String getECRAffectedPartsDetails(Context context, String[] args) throws Exception {
        if (args == null || args.length < 1) {
            throw (new IllegalArgumentException());
        }
        String strLanguage = context.getSession().getLanguage();
        ...
        try {
            ...
            AffectedPartsList = ecrObj.getRelatedObjects(context, strRelationType, TYPE_PART, selectStmts, selectRelStmts, false, true, (short) 1, null, null);
        ...
        while (mapItr.hasNext()) {
            ...
            returnString.append("<tr>");
            returnString.append("<td width = \"12%\" class=\"listCell\" style=\"text-align: \" valign=\"top\"><img src=\"../common/images/iconSmallPart.gif\" border=\"0\" alt=\"Part\">&nbsp;"
                    + mpParts.get(DomainConstants.SELECT_NAME) + "&nbsp;</td>");
    ...
    public String getECRAffectedSpecsDetails(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            revisedSpecsList = ecrObj.getRelatedObjects(context, strRelationType, objPatrn, selectStmts, selectRelStmts, false, true, (short) 1, null, null);
        ...
        while (mapItr.hasNext()) {
            ...
            // vamsi
            returnString.append("<tr>");
            returnString.append("<td width = \"10%\" class=\"listCell\" style=\"text-align: \" valign=\"top\"><img src=\"../common/images/" + imgSpecType + "\" border=\"0\" alt=\"*\">&nbsp;"
                    + specMap.get(DomainConstants.SELECT_NAME) + "&nbsp;</td>");
    ...
    public String getECRSupportingDocsDetails(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            selectRelStmts.addElement(DomainRelationship.SELECT_ID);
            selectRelStmts.addElement(DomainRelationship.SELECT_NAME);
            SupportDocsList = ecrObj.getRelatedObjects(context, srelPattern, "*", selectStmts, selectRelStmts, false, true, (short) 1, null, null);
    ...
    public String getECRReferenceDocsDetails(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            selectRelStmts.addElement(DomainRelationship.SELECT_ID);
            selectRelStmts.addElement(DomainRelationship.SELECT_NAME);
            ReferenceDocsList = ecrObj.getRelatedObjects(context, srelPattern, "*", selectStmts, selectRelStmts, false, true, (short) 1, null, null);
    ...
    public String getECRsRelatedECODetails(Context context, String[] args) throws Exception {
        if (args == null || args.length < 1) {
            throw (new IllegalArgumentException());
        }
        ...
        SelectList selectRelStmts = null;
        MapList relatedECOs = ecrObj.getRelatedObjects(context, RELATIONSHIP_ECO_CHANGEREQUESTINPUT, "*", selectStmts, selectRelStmts, true, false, (short) 1, null, null);
    ...
    public String getAssigneesOfECR(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        ...
        try {
            ...
            mpListAssignees = ecrObj.getRelatedObjects(context, RELATIONSHIP_ASSIGNED_EC, TYPE_PERSON, selectStmts, selectRelStmts, true, false, (short) 1, EMPTY_STRING, EMPTY_STRING);
    ...
    public String getECRRelatedBOMMarups(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        ...
        try {
            ...
            mpListMarkups = ecrObj.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_ProposedMarkup"), // relationship pattern
    ...
    public String getECRRelatedResolvedItems(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
    ...
    public int renderPDFFileForECR(Context context, String[] args, String summaryReport) throws Exception {
        ...
        String inputFolder = FrameworkProperties.getProperty(context, "emxEngineeringCentral.PDF.InputFolderPath");
        String outputFolder = FrameworkProperties.getProperty(context, "emxEngineeringCentral.PDF.OutputFolderPath");
        ...
        try {
            String fileName = inputFolder + java.io.File.separator + objName + "-Rev" + objRev;
            FileWriter txtFileID = new FileWriter(fileName, false);
            txtFileID.write(summaryReport);
            txtFileID.flush();
            txtFileID.close();

            htmlFileName = inputFolder + java.io.File.separator + objName + "-Rev" + objRev + ".htm";
            ...
            String sleepInterval = FrameworkProperties.getProperty(context, "emxEngineeringCentral.PDF.SleepInterval");
            ...
            //
            String outputFilePath = outputFolder + java.io.File.separator + sFileName;
            ...
            iResult = 1;
            ContextUtil.abortTransaction(context);
            emxContextUtil_mxJPO.mqlError(context, EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.SummaryReport.NoCheckIn.ErrorMessage1", context.getSession().getLanguage()));
        }
        ...
        try {
            if (commitTransaction) {
                ...
                obj.unlock(context);
                obj.checkinFile(context, true, false, null, "generic", sFileName, outputFolder);
            ...
            iResult = 1;
            ContextUtil.abortTransaction(context);
            emxContextUtil_mxJPO.mqlError(context, EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.SummaryReport.NoCheckIn.ErrorMessage2", context.getSession().getLanguage()));
            // throw e;
        } finally {
            ContextUtil.popContext(context);
        }
    ...
    public String displayUserSettingsDefaultVault(Context context, String[] args) throws Exception {
        ...
        sbReturnString.append("emxShowModalDialog(\"../components/emxComponentsSelectSearchVaultsDialogFS.jsp?multiSelect=false&amp;fieldName=Vault&amp;objectType=" + sECR
    ...
    public int assignAffectedItemsToResponsibleDesignEngineer(Context context, String args[]) {
        ...
        try {
            ...
            mlAssignedECRel = getRelatedObjects(context, DomainConstants.RELATIONSHIP_ASSIGNED_EC, DomainConstants.TYPE_PERSON, objectSelects, relSelects, true, false, (short) 1, objectWhereSelects,
                    null);

            String strCreateAssignedECRelId = "";
            if (mlAssignedECRel == null || mlAssignedECRel.size() <= 0) {
                DomainRelationship strDR = DomainRelationship.connect(context, new DomainObject(sRDEID), DomainConstants.RELATIONSHIP_ASSIGNED_EC, new DomainObject(objectId));
            ...
            MapList mlPersons = getRelatedObjects(context, DomainConstants.RELATIONSHIP_ASSIGNED_EC, DomainConstants.TYPE_PERSON, new StringList(DomainConstants.SELECT_ID),
            ...
            while (mlPersonsItr.hasNext()) {
                ...
                if (!("".equals(strAssignedECRelId))) {
                    disconnect(context, strAssignedECRelId);
                }
            }

            MapList mlBusObjAIList = getRelatedObjects(context, RELATIONSHIP_AFFECTED_ITEM, "*", new StringList(DomainConstants.SELECT_ID), new StringList(DomainConstants.SELECT_RELATIONSHIP_ID),
            ...
            while (mlAffectedItemsItr.hasNext()) {
                ...
                StringList slExistingAssignedECRelId = getTomids(context, strAffectedItemRelId);

                // Creating the Assigned Affected Item Rel.
                if (slExistingAssignedECRelId == null || slExistingAssignedECRelId.size() == 0) {
                    connect(context, RELATIONSHIP_ASSIGNEED_AFFECTED_ITEM, strCreateAssignedECRelId, strAffectedItemRelId, false, false);
                }
            }
            iResult = 0;
    ...
    public StringList getRelatedECOOIDs(Context context, String args[]) throws Exception {
        ...
        MapList totalresultList = DomainObject.findObjects(context, typepattern, "*", "*", "*", "*", strWhereClause, null, true, objselectStmts, (short) 0);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a MapList with the following as input arguments or entries: objectId holds the context ECR object Id New Value holds the newly selected Distribution List Object Id
     * @throws Exception
     *             if the operations fails
     * @since Common X3
     */
    public void connectRelatedECDistributionList(Context context, String[] args) throws Exception {
        try {
            ...
            ContextUtil.pushContext(context);
            relationshipIdList = doChange.getRelatedObjects(context, strRelationship, strType, objectSelects, relSelectsList, false, true, (short) 1, DomainConstants.EMPTY_STRING,
                    DomainConstants.EMPTY_STRING);
            ...
            if (strNewId != null && strNewId.length() > 0) {
                ...
                DomainRelationship.connect(context, doChange, strRelationship, new DomainObject(strNewId));
     ...
     * @since EngineeringCentral X+3
     */
    public void assignAffectedItems(Context context, String[] args) throws Exception {
        HashMap hmpProgramMap = (HashMap) JPO.unpackArgs(args);
     ...
     * @since EngineeringCentral X+3
     */
    public void assignMarkups(Context context, String strPartId, String strSourceECR, String strTargetECO) throws Exception {
        try {
            ContextUtil.pushContext(context);
            StringList strlObjSelects = new StringList(1);
            strlObjSelects.add(SELECT_ID);
            ...
            MapList mapListMarkups = doSourceAffectedItem.getRelatedObjects(context, RELATIONSHIP_EBOM_MARKUP, TYPE_PART_MARKUP + "," + TYPE_EBOM_MARKUP, strlObjSelects, strlRelnSelects, false, true,
                    (short) 1, strWhereClause, null);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a MapList with the following as input arguments or entries: objectId holds the context ECR object Id
     * @throws Exception
     *             if the operations fails
     * @since EC - X4
     */
                ...
                if (domObj.isKindOf(context, DomainConstants.TYPE_ECR) || domObj.isKindOf(context, DomainConstants.TYPE_ECO) || domObj.isKindOf(context, DomainConstants.TYPE_PART)) {
                    ...
                    if ("".equals(strModCreate)) {
                        ...
                        if (stz.hasMoreElements()) {
                            ...
                            relationshipIdList = domAffected.getRelatedObjects(context, strRelationshipDesignResponsibility, sType, busSelects, relSelectsList1, true, false, (short) 1, null, null);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds one argument, the symbolic role name
