...
public class emxSpinnerPnOScanOrgAdminRoles_mxJPO extends emxDomainObject_mxJPO {
    ...
    private static void scanOrganizationAdminRole(Context context) throws Exception {
        ...
        MapList mapList = DomainObject.findObjects(context, DomainObject.TYPE_ORGANIZATION, DomainConstants.QUERY_WILDCARD, DomainConstants.QUERY_WILDCARD, DomainConstants.QUERY_WILDCARD,
                DomainConstants.QUERY_WILDCARD, "", true, selectList);
