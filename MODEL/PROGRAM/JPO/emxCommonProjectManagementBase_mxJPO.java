...
/**
 * The <code>emxProjectManagementBase</code> class represents the Project Management JPO functionality for the AEF type.
...
public class emxCommonProjectManagementBase_mxJPO extends com.matrixone.apps.common.ProjectManagement {
    ...
    protected static final String SELECT_PARENT_ID = "to[" + RELATIONSHIP_SUBTASK + "].from.id";
     ...
     * @since AEF 9.5.2.0
     */
    public emxCommonProjectManagementBase_mxJPO(Context context, String[] args) throws Exception {
     ...
     * @since AEF 9.5.2.0
     */
    public emxCommonProjectManagementBase_mxJPO(String id) throws Exception {
        // Call the super constructor
        super(id);
    }

    /**
     * Delete override method for Project Management types Deletes the Project/Task related structure Deletes Assessment, Risk, Finacial Items, Tasks, etc.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - ${OBJECTID}
    ...
    public int triggerDeleteOverride(Context context, String[] args) throws Exception {
        ...
        com.matrixone.apps.common.Task project = (com.matrixone.apps.common.Task) DomainObject.newInstance(context, DomainConstants.TYPE_TASK);
