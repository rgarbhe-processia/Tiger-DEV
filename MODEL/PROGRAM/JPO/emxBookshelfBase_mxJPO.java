 ...
 **
 ** FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.8 $" Date : "$Date: Wed Oct 22 16:02:35 2008 $"
 **
 */
...
/**
 * The <code>emxBookshelfBase</code> represents implementation of anything on the "To Side" of "Has Bookshelves" Relationship in DC Schema
 * @exclude
 */
...
public class emxBookshelfBase_mxJPO extends emxDOCUMENTCLASSIFICATION_mxJPO {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("must specify method on emxBookshelfBase invocation");
        }
