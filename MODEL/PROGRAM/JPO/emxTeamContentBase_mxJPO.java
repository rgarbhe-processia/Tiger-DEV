...
public class emxTeamContentBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - object Id of the folder 1 - object Id of the workspace
     * @return MapList
     * @throws Exception
     *             if the operation fails
     * @deprecated TC 10-7-SP1 use getFolderContentIds Due to performance issue, the method only re turns ids.
     * @since Team 10-0-1-0
     */
    ...
    public MapList getFolderContent(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if ((null == workspaceId) || ("".equals(workspaceId)) || ("#DENIED!".equals(workspaceId)) || ("null".equals(workspaceId))) {
            ...
            if (bIsTypeWorkspaceVault) {
                contentMapList = domainObject.getRelatedObjects(context, DomainObject.RELATIONSHIP_VAULTED_DOCUMENTS, "*", selectTypeStmts, null, false, true, (short) 1, sObjWhere, null, null, null,
                        null);

            } else // Route
            {
                contentMapList = domainObject.getRelatedObjects(context, DomainObject.RELATIONSHIP_OBJECT_ROUTE, "*", selectTypeStmts, null, true, false, (short) 1, sObjWhere, null, null, null, null);
            }
    ...
    public static boolean containsMultipleFiles(Context context, String docOID) throws Exception {
    ...
    /**
     * showCheckbox - This Method will check whether the check box must be enabled or Disabled Called in the CheckBox column
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public Vector showCheckbox(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < objectListSize; i++) {
                ...
                if (strUser.equals(docOwner) || isWorkspaceLead || hasParentRemoveAccess) {
                    accessFlag = true;
                }

                if (boolRouted && DocumentsinMultipleRoutes.equals("false") && !bIsTypeRoute) {
                    enableCheckbox.add("false");
                } else if ((bIsTypeWorkspaceVault && !boolLock) || (boolRouted && !bIsTypeWorkspaceVault && !boolLock)
                        || (bIsTypeWorkspaceVault && boolLock && canRouteCheckoutDocuments.equals("true"))) {
                    if (accessFlag) {
    ...
    /**
     * getLockImage - This method is used to show the Lock image. This method is called from the Column Lock Image.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectList MapList
    ...
    /**
     * getVersion - This method is used to get the Version based on the Type of the Content. For Documents, it shows the Version and For Type like Part, RFQ, etc. it shows ""
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectList MapList
                ...
                if (docType.equals(DomainConstants.TYPE_DOCUMENT)) {
                    ...
                    if (isVersionable) {
                        ...
                        if (!multiFile) {
                            ...
                            sbNextURL.append(
                                    "../common/emxTable.jsp?HelpMarker=emxhelpversions&amp;program=emxCommonFileUI:getFileVersions&amp;table=APPFileVersions&amp;sortColumnName=Version&amp;sortDirection=descending&amp;header=");
    ...
    /**
     * getRevison - This method is used to get the Revision basing on the Type of the Content. For Documents It shows "" and For Type like Part, RFQ etc etc it Shows Revision
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectList MapList
    ...
    /**
     * getContentActions - This method will be called to get the Actions that can be performed on the Content This is called in the Actions Column of the Table
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectList MapList
     ...
     * @since V10 Patch1
     */
    public Vector getContentActions(Context context, String[] args) throws Exception {
            ...
            while (objectListItr.hasNext()) {
                ...
                if (CommonDocument.TYPE_DOCUMENTS.equals(parentType)) {
                    ...
                    if (!isprinterFriendly) {
                        ...
                        // "','575','575')\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconSmallSubscription.png\" alt=\""+sTipSubscription+"\"
                        // title=\""+sTipSubscription+"\"></img></a>";
                    ...
                    if (CommonDocument.canCheckin(context, contentObjectMap) || VCDocument.canVCCheckin(context, contentObjectMap)) {
                        ...
                        if (!isprinterFriendly) {
                            ...
                            if (isAnyFileLockedByContext) {
                                ...
                                if (fileCount <= 1 && !vcDocument) {
                                    ...
                                    if (isContextDocumentOwner || isAnyFileLockedByContext) {
                                        ...
                                        newURL += "<a href=\"javascript:submitWithCSRF(" + strngBuf.toString()
                                                ...
                                                + docLocker + "\" title=\"" + titleText + " : " + docLocker + "\"></img></a>";
                                    }
                                ...
                                if (fileCount <= 1) {
                                    if (isContextDocumentOwner || isAnyFileLockedByContext) {
                                        newURL += "<img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionUnlock.png\" alt=\"" + titleText + " : " + docLocker + "\" title=\""
                                                + docLocker + "\"></img>";
                                    }
                                }
                            }
                    ...
                    if (CommonDocument.canAddFiles(context, contentObjectMap)) {
                        if (!isprinterFriendly) {
                            ...
                            newURL += "<a href=\"javascript:showModalDialog(" + strBuf.toString() + ");\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionAppend.png\" alt=\""
                                    + sTipAddFiles + "\" title=\"" + sTipAddFiles + "\"></img></a>";
    ...
    public static boolean getFolderOption(Context context, String args[]) {
        ...
        try {
            ...
            String wid = "expand bus" + " " + workspaceId + " " + "from rel 'Project Members' select bus id dump | where 'relationship[Project Members].to.relationship[Project Membership].from.name=="
                    + "\"" + contextuser + "\" '";
    ...
    // End of 348885
    /**
     * isVCCommandsEnabled - This method is used to determine if the VC Commands in the Attachments Summray can be enabled or not.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public static boolean hasRouteSelected(Context context, String args[]) throws Exception {
        ...
        MapList mapList = person.getRelatedObjects(context, BaseObject.RELATIONSHIP_PROJECT_MEMBERSHIP, BaseObject.TYPE_PROJECT_MEMBER, false, true, (short) 1, objectSelects, null, objectWhere, null,
                "", "", null);
    ...
    static public Integer getJTAssemblyType(matrix.db.Context context, String objectId) throws Exception, MatrixException {
        ...
        try {
            ...
            Map objectToMap = object.getRelatedObject(context, relDocumentStructure, true, busSelects, null);

            Map objectFromMap = object.getRelatedObject(context, relDocumentStructure, false, busSelects, null);
            if (objectToMap != null) {
    ...
    public static String getWorkspaceId(Context context, String folderId) {
        ...
        try {
            ...
            MapList mapList = domainObject.getRelatedObjects(context, relPattern.getPattern(), typePattern.getPattern(), objSelects, null, true, false, (short) 0, "", "", includeTypePattern, null,
                    null);
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a Map with the following entries: selType - a String containing the type(s) to search for txtName - a String containing a Name pattern to search for txtRev - a String
     *            containing a Revision pattern to search for txtOwner - a String containing an Owner pattern to search for txtWhere - a URL encoded String containing a Matrix where clause.
     *            txtOrginator - a String containing an Originator pattern to search for txtSearch - a String containing a text pattern to Search for. txtFormat - a String containing a format pattern
     *            to Search for. setRadio - a String containing the Collection name to open.
     * @return MapList containing search result.
     * @exception Exception
     *                if the operation fails.
     */
    public MapList getSearchResult(Context context, String[] args) throws Exception {
        ...
        // Start of Pre Migration Code -SC
            ...
            if ((sWhereExp == null) || (sWhereExp.equalsIgnoreCase("null")) || (sWhereExp.length() <= 0)) {
                sWhereExp = " (to[" + DomainObject.RELATIONSHIP_RTS_QUOTATION + "].from.to[" + DomainObject.RELATIONSHIP_COMPANY_RFQ + "]!='#DENIED!') && (!(to["
                        + DomainObject.RELATIONSHIP_RTS_QUOTATION + "].from.to[" + DomainObject.RELATIONSHIP_COMPANY_RFQ + "]))";
            } else {
                sWhereExp += sAnd + " " + "(to[" + DomainObject.RELATIONSHIP_RTS_QUOTATION + "].from.to[" + DomainObject.RELATIONSHIP_COMPANY_RFQ + "]!='#DENIED!') && (!(to["
                        + DomainObject.RELATIONSHIP_RTS_QUOTATION + "].from.to[" + DomainObject.RELATIONSHIP_COMPANY_RFQ + "]))";
            }
        }
    ...
    /**
     * getName- Will get the name/Title (for Folder ) Will be called in the Name Column
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectList MapList
    ...
    /**
     * This function gets the Icon file name for any given type from the emxSystem.properties file
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param type
     *            object type name
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId is in the paramList
     * @return MapList
     * @throws Exception
     *             if the operation fails
     * @since Team 10-7-SP1
    ...
    public MapList getFolderContentIds(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            } else // Workspace Vault (Folder)
            {
                ...
                contentMapList = domainObject.getRelatedObjects(context, relationshipPattern, "*", selectTypeStmts, selectRelStmts, false, true, (short) expandLevel, sObjWhere, null, null, null,
                        null);
    ...
    public Vector getNewWindowIcon(Context context, String[] args) throws Exception {
        try {
            ...
            while (objectListItr.hasNext()) {
                ...
                newURL += "<a href=\"javascript:emxTableColumnLinkClick(" + finalURL.toString()
                        + "', '875', '550', 'false', 'popup', '');\"><img border=\"0\" src=\"images/iconNewWindow.gif\"></img></a>";
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getGeneralSearchResults(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
