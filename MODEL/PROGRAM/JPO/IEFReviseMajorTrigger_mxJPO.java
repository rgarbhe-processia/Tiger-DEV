...
public class IEFReviseMajorTrigger_mxJPO {
    ...
    public int reviseObjectAndCreateRealtionship(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (globalConfigObj.isTypeOfClass(cadTypeVal, MCADAppletServletProtocol.TYPE_INSTANCE_LIKE)) {
                ...
                /*
                 * } else { relsAndEnds = serverGeneralUtil.getPrimaryRelationshipFromInstance(context, oldMinorObject);
                 * 
                 * famObj = serverGeneralUtil.getFamilyObjectForInstance(context, oldMinorObject); connectedFamilyObject = famObj; famObj = util.getMajorObject(context,famObj ); }
                 */
            ...
            copyRelationships(context, globalConfigObj, busName, childBusAndRelDetailsTable, revisedMajorObject, revisedMinorObject, revisedBusRev, relIdBusToConnectData, oldBusObject);
            ...
            if (globalConfigObj.isTypeOfClass(cadTypeVal, MCADAppletServletProtocol.TYPE_INSTANCE_LIKE)) {
                reviseFamily(context, _sObjectID, oldBusObject, revisedMinorObject, famObj, connectedFamilyObject, attrFTRevisionMode, globalConfigObj);
            }
    ...
    private void connectMajorAndMinorObjects(Context context, BusinessObject revisedBusinessObject, String objectId, BusinessObject minorObject) throws MCADException, MatrixException, Exception {
    ...
    // [NDM] QWJ
    private void copyAttributesAndFiles(Context context, BusinessObject oldBusObject, BusinessObject oldMinorObject, BusinessObject revisedBusinessObject, BusinessObject revisedMinorObject,
            String attrVal) throws MatrixException, MCADException {
    ...
    private void reviseFamily(Context context, String _sObjectID, BusinessObject oldBusObject, BusinessObject minorObject, BusinessObject famObj, BusinessObject connectedFamilyObject,
            String attrFTRevisionMode, MCADGlobalConfigObject globalConfigObj) throws MCADException, MatrixException, Exception {
    ...
    // [NDM] QWJ
    private void copyRelationships(Context context, MCADGlobalConfigObject globalConfigObj, String busName, Hashtable childBusAndRelDetailsTable, BusinessObject revisedBusinessObject,
            BusinessObject revisedMinorObject, String busRevision, Hashtable relIdBusToConnectData, BusinessObject oldBusObject) throws MatrixException, MCADException, Exception {
    ...
    // [NDM] QWJ
    private void copyDerivedOutput(Context context, String busName, BusinessObject majorObject, BusinessObject minorObject, String busRevision, BusinessObject oldBusObject,
            MCADGlobalConfigObject globalConfigObj) throws Exception {
    ...
    private void reviseAllInstances(Context context, MCADGlobalConfigObject globalConfigObj, BusinessObject oldBusObject, BusinessObject connectedFamilyObject, String cadTypeVal)
            throws MatrixException, MCADException {
        String familyId = "";
    ...
    private void copyActiveInstanceRelationships(Context context, MCADGlobalConfigObject globalConfigObj, Hashtable childBusAndRelDetailsTable, BusinessObject minorObject)
            throws MatrixException, MCADException, Exception {
        Enumeration childRelationDetails = childBusAndRelDetailsTable.keys();
