...
public class emxRegionBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @grade 0
     */
    public emxRegionBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public Object getRegions(matrix.db.Context context, String[] args) throws Exception {
        ...
        obj.setId(objectId);
        list = obj.getRelatedObjects(context, relName, QUERY_WILDCARD, objectSelects, relSelects, false, true, (short) 1, null, null);
        return list;
    }
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getRegionsBusinessUnits(Context context, String[] args) throws Exception {
        if (args.length == 0) {
            throw new IllegalArgumentException();
        }
        boolean toSide = true;
        ...
        DomainObject obj = DomainObject.newInstance(context);
        obj.setId(objectId);
        list = obj.getRelatedObjects(context, relName, typePattern, objectSelects, relSelects, toSide, fromSide, (short) 1, null, null);
        return list;
    }
     ...
     * @since 10.0.0.0
     */
    public Boolean updateName(Context context, String[] args) throws Exception {
     ...
     * @since 10.0.0.0
     */
    public String getRegionName(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
    ...
    public void createRegionPostProcess(Context context, String[] args) throws Exception {
        try {
            ...
            if (!strOrganizationId.equals(companyId)) {
                strRelName = Region.RELATIONSHIP_SUB_REGION;
    ...
    /**
     * Expand program for select Region If isFrom and relationshipName names are passed and if the context object is already connected to a Region it will be disabled for selection.
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList selectionRegionExpandProgram(Context context, String[] args) throws FrameworkException {
        try {
            ...
            MapList regions = org.getInfo(context, SELECT_TYPE).equals(TYPE_COMPANY) ? new Company(orgId).getRegions(context, null, selectables)
