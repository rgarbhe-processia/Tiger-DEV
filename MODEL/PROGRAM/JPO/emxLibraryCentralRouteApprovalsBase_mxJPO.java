...
public class emxLibraryCentralRouteApprovalsBase_mxJPO {
     ...
     */
    public emxLibraryCentralRouteApprovalsBase_mxJPO(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId - object Id languageStr - language String
     * @throws Exception
     *             if a major failure occurs
     * @since R212
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getRouteApprovals(Context context, String[] args) throws Exception {
    ...
    /**
     * This method sends State of the Object (The state in the object's life cycle where the approval is required)
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectList - should contain object states
     * @throws Exception
     *             if a major failure occurs
     * @since R212
     */
    public Vector getObjectStateForRoute(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectList - should contain Route Name
     * @throws Exception
     *             if a major failure occurs
     * @since R212
     */
    public Vector getRouteName(Context context, String[] args) throws Exception {
        Vector vecResult = new Vector();
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objectList = (MapList) programMap.get("objectList");
        Map stateRouteMap = null;
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectList - should contain Route Signature
     * @throws Exception
     *             if a major failure occurs
     * @since R212
     */
    public Vector getRouteSignature(Context context, String[] args) throws Exception {
        Vector vecResult = new Vector();
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objectList = (MapList) programMap.get("objectList");
        Map stateRouteMap = null;
    ...
    /**
     * This method sends Route Signer (The user whose approval is required before the object can be released).
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectList - should contain Route Signer
     * @throws Exception
     *             if a major failure occurs
     * @since R212
     */
    public Vector getRouteSigner(Context context, String[] args) throws Exception {
        Vector vecResult = new Vector();
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objectList = (MapList) programMap.get("objectList");
        Map stateRouteMap = null;
    ...
    /**
     * This method sends Route Status (Approved or Rejected as specified by the Signer. If blank, the Signer has not yet acted on this approval)
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectList - should contain Route Status
     * @throws Exception
     *             if a major failure occurs
     * @since R212
     */
    ...
    /**
     * This method sends Route Description (Any text entered by the person who approved or rejected the object)
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectList - should contain Route Description
     * @throws Exception
     *             if a major failure occurs
     * @since R212
     */
    public Vector getRouteDescription(Context context, String[] args) throws Exception {
        Vector vecResult = new Vector();
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objectList = (MapList) programMap.get("objectList");
        Map stateRouteMap = null;
