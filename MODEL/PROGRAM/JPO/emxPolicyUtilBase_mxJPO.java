...
public class emxPolicyUtilBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @param args
     *            holds the following input arguments 0 - String which holds the id of the business object
     * @throws Exception
     *             if the operation fails
     * @since EC 10.0.0.0
     */

    public emxPolicyUtilBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - String containing object id whose state to be checked 1 - String containing target state against which the current state of the object is
     *            compared 2 - int containing Comparision operator used for comparison LT, GT, EQ, LE, GE, NE
     * @return an integer: 0 if object state logic satisfies Comparison Operator. 1 if object state logic didn't satisfies Comparison Operator. 2 if a program error is encountered 3 if state in state
     *         argument does not exist in the policy 4 if an invalid comparison operator is passed in
     * @throws Exception
     *             if the operation fails.
     * @since EC 10.0.0.0
     */

    public int checkState(Context context, String[] args) throws Exception {
        try {
            String id = args[0];
