...
/**
 * The <code>emxBusinessUnitBase</code> class contains implementation code for emxBusinessUnitBase. 3 * @version Rossini - Copyright (c) 2002, MatrixOne, Inc.
 */
public class emxBusinessUnitBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @grade 0
     */
    public emxBusinessUnitBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    /**
     * Expand program for select Business Unit If isFrom and relationshipName names are passed and if the context object is already connected to a Business Unit it will be disabled for selection.
     */
