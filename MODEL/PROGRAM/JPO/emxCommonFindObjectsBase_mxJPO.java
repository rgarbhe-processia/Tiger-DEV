...
public class emxCommonFindObjectsBase_mxJPO {
     ...
     * @grade 0
     */
    public emxCommonFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    public void getIds(Context context, int chunkSize) throws Exception {
        ...
        /*
         * try { FrameworkProperties.getProperty(context,"emxComponents.CommonMigration.VaultList"); } catch(Exception e) { //do nothing }
         */
        ...
        String command = "temp query bus '" + type + "' '" + name + "' '" + revision + "'  vault '" + vaultList + "' limit 1 where 'program[" + migrationProgramName
                + " -method writeOID ${OBJECTID} \"${TYPE}\"] == true'";
        if (!isType) {
            command = "query connection relationship '" + type + "' limit 1 where 'program[" + migrationProgramName + " -method writeOID ${OBJECTID} \"${TYPE}\"] == true'";
        }
        String result = "";
