...
public class emxTriggerValidationResultsBase_mxJPO {
    ...
    public emxTriggerValidationResultsBase_mxJPO(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < objSize; i++) {
            ...
            if (strExpFormat != null && ("text".equalsIgnoreCase(strExpFormat) || "csv".equalsIgnoreCase(strExpFormat))) {
                ...
                if ("Pass".equalsIgnoreCase(strResult) && strResult != null) {
                    resStr.append("<table id=error").append(i).append(" width=100% border=0 > <tr> <td align=left> <font forecolor=black >")
                            .append(EnoviaResourceBundle.getFrameworkStringResourceProperty(context, "emxFramework.TriggerValidationReport.Result.Pass", new Locale(languageStr)))
                            .append("<script language=javascript> javascript:changeColor('Pass',").append(i).append(") </script></font> </td> </tr> </table> ");
                }
                if ("Fail".equalsIgnoreCase(strResult) && strResult != null) {
                    resStr.append("<table id=error").append(i).append(" width=100% border=0 > <tr> <td align=left> <font forecolor=black >")
                            .append(EnoviaResourceBundle.getFrameworkStringResourceProperty(context, "emxFramework.TriggerValidationReport.Result.Fail", new Locale(languageStr)))
                            .append("<script language=javascript> javascript:changeColor('Fail',").append(i).append(") </script></font> </td> </tr> </table> ");
                }
                if ("Warning".equalsIgnoreCase(strResult) && strResult != null) {
                    resStr.append("<table id=error").append(i).append(" width=100% border=0 > <tr> <td align=left> <font forecolor=black >")
                            .append(EnoviaResourceBundle.getFrameworkStringResourceProperty(context, "emxFramework.TriggerValidationReport.Result.Warning", new Locale(languageStr)))
                            .append("<script language=javascript> javascript:changeColor('Warning',").append(i).append(") </script></font> </td> </tr> </table> ");
                }
                // XSSOK
