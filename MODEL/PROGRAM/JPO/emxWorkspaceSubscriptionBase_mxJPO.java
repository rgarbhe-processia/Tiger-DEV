...
public class emxWorkspaceSubscriptionBase_mxJPO {
    ...
    public MapList getSubscriptions(Context context, String args[]) throws Exception {
        ...
        while (boItr.next()) {
            ...
            ExpansionIterator expItr = boEvent.getExpansionIterator(context, relPattern.getPattern(), typePattern.getPattern(), typeSelectList, new SelectList(), true, false, (short) 2, null, null,
    ...
    public void userIsAuthenticated(Context context, String objectId) throws Exception {
        ...
        try {
            ...
            throw new MatrixException(loc.GetString("emxTeamCentralStringResource", sLanguage, "emxTeamCentral.Common.PageAccessDenied"));
        }
    ...
    public synchronized BusinessObject getProjectMember(Context context, BusinessObject person) throws Exception {
        ...
        ContextUtil.startTransaction(context, false);
        ExpansionIterator expItr = person.getExpansionIterator(context, relPattern, DomainConstants.TYPE_PROJECT_MEMBER, EMPTY_STRING_LIST, EMPTY_STRING_LIST, false, true, (short) 1, strWhereClause,
    ...
    public BusinessObjectList getAllProjectMemberEvents(Context context, BusinessObject person) throws Exception {
        ...
        if (projectMember != null && !("".equals(projectMember)) && !("null".equals(projectMember))) {
            ...
            ContextUtil.startTransaction(context, false);
            ExpansionIterator expItr = projectMember.getExpansionIterator(context, relPattern.getPattern(), typePattern.getPattern(), typeSelectList, new SelectList(), true, true, (short) 1, null,
                    null, (short) 0, false, false, (short) 100, false);
            try {
    ...
    public BusinessObjectList getAllRoleUserEvents(Context context, String sProjectId) throws MatrixException {
        ...
        ContextUtil.startTransaction(context, false);
        ExpansionIterator expItr = boProject.getExpansionIterator(context, relPattern.getPattern(), typePattern.getPattern(), typeSelectList, new SelectList(), true, true, (short) 0, null, null,
                (short) 0, false, false, (short) 100, false);
    ...
    public Hashtable getAllPersonEvents(Context context) throws MatrixException {
        ...
        ContextUtil.startTransaction(context, false);
        ExpansionIterator expItr = boPerson.getExpansionIterator(context, relPattern.getPattern(), typePattern.getPattern(), selectStmts, selectRelStmts, true, true, (short) 1, null, null, (short) 0,
    ...
    public String getFileName(matrix.db.Context context, String ThreadId) throws MatrixException {
        ...
        ContextUtil.startTransaction(context, false);
        ExpansionIterator expItr = boThread.getExpansionIterator(context, relPattern.getPattern(), typePattern.getPattern(), typeSelectList, new SelectList(), true, true, (short) 1, null, null,
                (short) 0, false, false, (short) 100, false);
    ...
    public String getSubscribableEventsOnFolder(Context context, String[] args) throws Exception {
        ...
        while (it.hasNext()) {
            ...
            sb.append("<input type=\"checkbox\"  value=\"" + XSSUtil.encodeForHTMLAttribute(context, sKeyStr) + "\"  name=chkSubscribeEvent>"
                    + XSSUtil.encodeForHTML(context, (String) projectMap.get(sKeyStr)) + "<br>");
        }
        return sb.toString();
    }
    ...
    public TreeMap getAllObjectEvents(matrix.db.Context context, String objectId) throws MatrixException {
        ...
        ExpansionWithSelect expandWSelectAny = boAny.expandSelect(context, relPattern.getPattern(), typePattern.getPattern(), selectStmts, selectRelStmts, true, true, (short) 1);
        ...
        if (relWSelectAnyItr != null && relWSelectAnyItr.next()) {
            ...
            ExpansionWithSelect expandWSelectPS = boPS.expandSelect(context, relPSPattern.getPattern(), typePSPattern.getPattern(), selectStmts, selectRelStmts, true, true, (short) 1);
            ...
            if (saObjectKey != null) {
                ...
                for (i = 0; i < saObjectKey.length; i++) {
                    ...
                    if (relWSelectAnyItr != null && relWSelectAnyItr.next()) {
                        ...
                        busObj = new BusinessObject(FrameworkUtil.autoName(context, "type_PublishSubscribe", "", "policy_PublishSubscribe", sProjectVault));
                    ...
                    if (!bEventFound) {
                        ...
                        String sEventId = (new BusinessObject(FrameworkUtil.autoName(context, "type_Event", "", "policy_Event", sProjectVault))).getObjectId();
                        boEvent = new BusinessObject(sEventId);
    ...
    static public BusinessObject getConnectedObject(Context context, BusinessObject object, String relPattern, String typePattern, boolean getTo, boolean getFrom) throws MatrixException {
        ...
        RelationshipWithSelectItr relItr = new RelationshipWithSelectItr(ews.getRelationships());
        if (relItr.next()) {
    ...
    public MapList getPushSubscriptionEventsonFolder(Context context, String[] args) throws Exception {
        ...
        /*
         * if ("Discussion".equals(strDiscussion)) { sObjectTypeStr = "Discussion"; }
         */
    ...
    public Vector getRecipientsOnEvents(Context context, String[] args) throws Exception {
        ...
        } else if (sObjectTypeStr.equals(sTypeDocument) || (sObjectTypeStr.equals(domainObject.TYPE_PACKAGE)) || (sObjectTypeStr.equals(domainObject.TYPE_RTS_QUOTATION))
                || (sObjectTypeStr.equals(domainObject.TYPE_REQUEST_TO_SUPPLIER))) {
        ...
        while (it.hasNext()) {
            ...
            while (itr.hasNext()) {
                ...
                MapList subscribedEvent = domainObject.querySelect(context, sTypeEvent, // type pattern
                ...
                if (subscribedEvent.size() != 0) {
                    ...
                    while (i.hasNext()) {
                        ...
                        subscribedPersons = domainObject.expandSelect(context, sRelPushedSubscription, sTypePerson, objectSelects, null, true, true, (short) 1, null, null, null, false);

                    }
                }
                recipientsOnEvents.add("<a href=\"javascript:emxShowModalDialog('emxTeamEditPushSubscriptionDialogFS.jsp?projectId=" + sProjectId + "&flag=pushSubscription&chkSubscribeEvent="
                        + sKeyStr + "&objectId=" + sObjId + "',550, 500);\" >" + subscribedPersons.size() + "</a>");
            }
        }
    ...
    public void deleteSubscriptions(Context context, String args[]) throws Exception {
        ...
        for (int j = 0; j < objId.length; j++) {
            ...
            MapList mapList = workspaceVault.getRelatedObjects(context, relPattern.getPattern(), typePattern.getPattern(), SelectList, // objectSelects,
