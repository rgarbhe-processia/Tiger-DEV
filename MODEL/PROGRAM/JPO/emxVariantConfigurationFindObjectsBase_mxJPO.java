...
public class emxVariantConfigurationFindObjectsBase_mxJPO extends emxCommonFindObjectsBase_mxJPO {
     ...
     * @grade 0
     */
    public emxVariantConfigurationFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    public int findMFnModObjects(Context context, String[] args) throws Exception {
        ...
        String[] sargs = new String[3];
        sargs[0] = "" + chunkSize;
        sargs[1] = ConfigurationConstants.TYPE_MASTER_FEATURE + "," + ConfigurationConstants.TYPE_MODEL;
        sargs[2] = "" + args[1];
        super.mxMain(context, sargs);
