...
public class emxSchemaMapping_mxJPO extends emxSchemaMappingBase_mxJPO {
    ...
    public emxSchemaMapping_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public emxSchemaMapping_mxJPO(Context context, File xmlFile, boolean bReload) throws Exception {
