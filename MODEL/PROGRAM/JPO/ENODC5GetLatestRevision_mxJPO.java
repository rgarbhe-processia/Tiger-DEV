...
public class ENODC5GetLatestRevision_mxJPO extends MCADIntegGetLatestRevisionBase_mxJPO {

    protected String ATTR_CADTYPE;

    public ENODC5GetLatestRevision_mxJPO() {
        super();
    }

    public ENODC5GetLatestRevision_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
