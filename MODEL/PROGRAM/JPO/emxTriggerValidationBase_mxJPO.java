...
public class emxTriggerValidationBase_mxJPO {
    ...
    public emxTriggerValidationBase_mxJPO(Context context, String[] args) throws Exception {
        ...
        while (objectItr.hasNext()) {
            ...
            if (!result.equals("")) {
                ...
                for (int j = 0; j < strTriggerList.size(); j++) {
                    ...
                    mapTemp.addAll(DomainObject.findObjects(context, strTypePattern, strNamePattern, "*", "*", "*", DomainConstants.SELECT_CURRENT + "==Active", false, objectSelect));
                }
