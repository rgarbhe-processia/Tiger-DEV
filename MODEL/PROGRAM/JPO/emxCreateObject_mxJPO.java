...
/*
 * emxCreateObject Copyright (c) 1992-2015 Dassault Systemes.
 *
...
public class emxCreateObject_mxJPO {
    ...
    public emxCreateObject_mxJPO(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - chunksize an int that has the no. of objects to be stored in file. 1 - String that holds the documentDirectory.
     ...
     *            the eMatrix <code>Context</code> object
     * @param chunkSize
     *            int that has the no. of objects to be stored in file.
     * @throws Exception
     *             if the operation fails.
     * @since AEF 9.5.0.0
     */
     ...
     * @param objectIds
     *            ArrayList that contains list of id's
     * @param sequence
     *            int that contains the suffix value of the file.
     * @throws Exception
     *             if the operation fails.
     * @since AEF 9.5.0.0
     */
