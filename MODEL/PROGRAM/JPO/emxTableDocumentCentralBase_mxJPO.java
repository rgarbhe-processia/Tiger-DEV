...
/**
 * The <code>${CLASSNAME}</code> class is used to generate HTML code for the business type column on business type list page for display rule.
 * @exclude
 */
public class emxTableDocumentCentralBase_mxJPO {
     ...
     * @since AEF 9.5.6.0
     */
    public emxTableDocumentCentralBase_mxJPO(Context context, String[] args) throws Exception {
        /*
         * Author : MT Date : 04/07/2003 Notes : History :
         */
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        /*
         * Author : MT Date : 1/30/2003 Notes : History :
         */
     ...
     * @since AEF 9.5.6.0
     */
    public Vector getRevisionLevel(Context context, String[] args) throws Exception {
        /*
         * Author : MT Date : 04/07/2003 Notes : History :
         */
        ...
        if (busTypeList != null) {
            ...
            while (iterator.hasNext()) {
                ...
                if (typeName != null && !typeName.equals("null") && !typeName.equals("")) {
                    ...
                    MxDebug.message(MxDebug.DL_5, "Object details: " + "\n\tobjId:     " + objId + "\n\ttype:      " + typeName + "\n\trevLevel:  " + revLevel);
