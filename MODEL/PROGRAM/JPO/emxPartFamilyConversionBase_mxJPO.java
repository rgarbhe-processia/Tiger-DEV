...
/**
 * The <code>emxPartFamilyConversionBase.java</code> class contains script to migrate 'Part Family Member' relationship to 'Classified Item', 'Part Family' policy to 'Classification' policy Changes
 * "Part Issuer" type objects to "Part Family"
 * @since AEF 10-6
 */
public class emxPartFamilyConversionBase_mxJPO {
    ...
    /**
     * Main entry point. This method is executed if a specific method is not specified.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    /**
     * Migrate 'Part Family Member' relationship to 'Classified Item' For Part Family objects modify policy from 'Part Family' to 'Classification'
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
     ...
     * @since AEF 10-6
     */
    public int migrate(Context context, String[] args) throws Exception {
