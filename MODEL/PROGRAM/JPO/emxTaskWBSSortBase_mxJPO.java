...
public class emxTaskWBSSortBase_mxJPO extends emxCommonBaseComparator_mxJPO {
    ...
    public emxTaskWBSSortBase_mxJPO(Context context, String[] args) throws Exception {
    }
    ...
    /**
     * Compares two maps based on the key values of the MapComparator. Key name values are splitted by '.' delimiter and compared.
     * <p>
     * <dl>
     * <dt><b>Example:</b>
     * <dd><tt>
