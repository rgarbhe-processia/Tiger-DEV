...
public class emxMetricsObjectDetailsSummaryBase_mxJPO {
    ...
    public MapList getAllObjects(Context context, String[] args) throws Exception {
     ...
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param BusinessObjectWithSelectList
     *            holds no arguments
     * @return MapList contains list of Business Object Ids
     * @throws Exception
     *             if the operation fails
     * @since BusinessMetrics 10.6
     */
    protected MapList getObjectIDfromSelect(Context context, BusinessObjectWithSelectList objectList) throws Exception {
        MapList objectIDList = new MapList();
     ...
     * @since BusinessMetrics 10.6
     */
    protected MapList getObjectIDfromSelect(Context context, BusinessObjectList objectList) throws Exception {
        MapList objectIDList = new MapList();
