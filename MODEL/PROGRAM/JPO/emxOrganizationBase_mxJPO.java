...
/**
 * The <code>emxOrganizationBase</code> class contains implementation code for emxOrganizationBase. 3 * @version Rossini - Copyright (c) 2002, MatrixOne, Inc.
 */
public class emxOrganizationBase_mxJPO extends emxDomainObject_mxJPO {

    /** selects an object's RDO. */
    public static final String SELECT_RDO_ID = "to[Design Responsibility].from.id";
     ...
     * @grade 0
     */
    public emxOrganizationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
     ...
     * @grade 0
     */
    public Vector getIfEmployee(Context context, String[] args) throws Exception {
        ...
        String selectable = "type_Department".equals(typeAlias) ? "to[" + Organization.RELATIONSHIP_DEPARTMENT_EMPLOYEE + "].from.id"
                : "type_BusinessUnit".equals(typeAlias) ? "to[" + DomainConstants.RELATIONSHIP_BUSINESS_UNIT_EMPLOYEE + "].from.id" : "to[" + DomainConstants.RELATIONSHIP_EMPLOYEE + "].from.id";
     ...
     * @grade 0
     */
    public Vector getOrganizationalRoles(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList relBusObjPageList = (MapList) programMap.get("objectList");
        HashMap paramMap = (HashMap) programMap.get("paramList");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments as it is getting the params list from the Config UI table
    ...
    public MapList getCollaborationPartners(Context context, String[] args) throws Exception {
     ...
     * @since Common 10-0-0-0
     */
    public Vector getShareTypes(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
     ...
     * @since Common 10-0-0-0
     */
    public Vector getWebsite(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        // getting the MapList of the objects.
        MapList objList = (MapList) programMap.get("objectList");
     ...
     * @since Common 10-0-0-0
     */
    public String hasRDOrole(Context context, String[] args) throws Exception {
        ...
        try {
                ...
                if (roles == null) {
                    ...
                    if (memberMapList == null || memberMapList.size() < 1) {
                        ...
                        for (int i = 0; i < roles.size(); i++) {
                            ...
                            tempCmd = "print role \'" + tempRole + "\' select parent dump |";
                            results = MqlUtil.mqlCommand(context, tempCmd);
            ...
            String command = "set env global emxOrganization " + returnValue;
            String results = MqlUtil.mqlCommand(context, command);
        } catch (FrameworkException Ex) {
            throw Ex;
        }
     ...
     * @since Common 10.5
     */
    public Vector showCheckBoxInCollaborationPartners(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        // getting the MapList of the objects.
        MapList objList = (MapList) programMap.get("objectList");
     ...
     * @since Common 10-0-0-0
     */
    public Vector getWebSiteUsingSelect(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        // getting the MapList of the objects.
        MapList objList = (MapList) programMap.get("objectList");
        ...
        if (objList != null) {
            ...
            busObjwsl = BusinessObject.getSelectBusinessObjectData(context, objIdArray, strList);
            ...
            for (int i = 0; i < objList.size(); i++) {
                ...
                if (!isPrinterFriendly) {
                    ...
                    if ((strTempWebSite.startsWith("http://")) || (strTempWebSite.startsWith("https://"))) {
    ...
    /**
     * This method return true if user have permissions on the command otherwise return false. If the person is a Host Company Representative OR Buyer Admin OR Company Representative of the Selected
     * Company then this method will return true.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     ...
     * @since EC 10-5.
     */
    public Boolean hasAccessForCompanyNodes(Context context, String[] args) throws Exception {
        boolean isHostRep = Company.isHostRep(context, com.matrixone.apps.common.Person.getPerson(context));
        if (isHostRep) {
            return Boolean.valueOf(true);
        }

        String adminRoleList = "role_BuyerAdministrator,role_Buyer";
    ...
    /**
     * This method adds / remove the roles defined in arguments to the person if "Organization Representative" role is connected / disconnect respectively
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds objectId and param values.
     ...
     * @since SC 10-5.
     */
    public void syncRolesOnOrgRepRelationship(Context context, String[] args) throws Exception {
        if (args.length == 0) {
            throw new IllegalArgumentException();
        }
        ...
        while (rolesListItr.hasNext()) {
            ...
            roleName = PropertyUtil.getSchemaProperty(context, role);
            strCommand = "modify role \"" + roleName + "\" " + strAction + " assign person \"" + strPersonName + "\"";
    ...
    public MapList getAllLocations(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            ExpansionIterator expIter = orgObj.getExpansionIterator(context, strRelLocation, strTypeLocation, busSelects, relSelects, false, true, (short) 1, null, null, (short) 0, false, false,
                    (short) 100, false);
    ...
    /**
     * This method displays the location types of the locations associated with the Organization
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds objectId and param values.
    ...
    public MapList getAllFormats(Context context, String[] args) throws Exception {
        ...
        try {
            ContextUtil.startTransaction(context, false);
            ExpansionIterator expIter = orgObj.getExpansionIterator(context, strRelSupportedFileFormats, strTypeFileFormats, busSelects, relSelects, false, true, (short) 1, null, null, (short) 0,
    ...
    public MapList getCollaborationRequests(Context context, String[] args) throws Exception {
        ...
        if (strListOrgRep != null && (size = strListOrgRep.size()) > 0) {
            ...
            MapList requestsFromList = domRepOrg.getRelatedObjects(context, Company.RELATIONSHIP_COLLABORATION_REQUEST, "*", strBusSelects, strRelSelects, true, false, (short) 1, null, null);
            ...
            MapList requestsToList = domRepOrg.getRelatedObjects(context, Company.RELATIONSHIP_COLLABORATION_REQUEST, "*", strBusSelects, strRelSelects, false, true, (short) 1, null, null);
    ...
    public MapList getCapabilites(Context context, String[] args) throws Exception {
        ...
        try {
            ContextUtil.startTransaction(context, false);
            ExpansionIterator expIter = boOrganization.getExpansionIterator(context, sRelCapability, sProcess, selectBusStatms, selectRelStatms, false, true, (short) 1, null, null, (short) 0, false,
     ...
     * @since SC 10-5.
     */
    public boolean hasAccessForBUPeopleCreateNew(Context context, String[] args) throws Exception {
    ...
    public boolean hasAccessForBUAddRemove(Context context, String[] args) throws Exception {
    ...
    public boolean hasAccessForBUDeleteSelected(Context context, String[] args) throws Exception {
    ...
    public boolean hasAccessForLocationRegionAddRemove(Context context, String[] args) throws Exception {
    ...
    /**
     * This method returns access permissions of Command depending on the type of the Person logged in Host Company representative only can modify/edit the Host Company Information. This method
     * restricts the Guest Company representative to modify the Host Company Information.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds objectId and param values.
    ...
    public boolean hasAccessForPeopleAddExisting(Context context, String[] args) throws Exception {
    ...
    public boolean hasAccessForRegionDeleteCreateNew(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            hold the following input arguments: args[0] - Relationship to expand from, mutltiple relationships can be entered as a string delimited with spaces(" "), "~" or ",".(Mandatory).
     *            Example: relationship_Customer,relationship_Supplier. Passing in one of the following will expand on allRelationships. Symbolic name must be used. args[1] -
     *            emxComponents.RelatedObjectExist.Message(Mandatory) Default : emxComponents.RelatedObjectExist.Message
        ...
        try {
            ...
            if (sRelationship != null && !"null".equals(sRelationship) && !"".equals(sRelationship)) {
                ...
                if (sBuffer.length() > 0) {
                    ...
                    MapList mapList = domObj.getRelatedObjects(context, strRelRealName, "*", // object pattern
    ...
    /**
     * Checks whether selected supplier Organization is BU If BU belongs to Host company, update the attribute_SupplierType of rel as internal Otherwise External
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            hold no arguments
    ...
    public void setSupplierType(Context context, String[] args) throws Exception {
        ...
        String typeBusinessUnit = PropertyUtil.getSchemaProperty(context, DomainSymbolicConstants.SYMBOLIC_type_BusinessUnit);
        String relSupplier = PropertyUtil.getSchemaProperty(context, DomainSymbolicConstants.SYMBOLIC_relationship_Supplier);
        ...
        if (dom.isKindOf(context, typeBusinessUnit)) {
            ...
            MapList list = dom.getRelatedObjects(context, RELATIONSHIP_DIVISION, QUERY_WILDCARD, companySelects, EMPTY_STRINGLIST, true, false, (short) 0, EMPTY_STRING, EMPTY_STRING,
    ...
    /**
     * This method returns true if the context user has the Access on Message object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds one argument, object id of Message
    ...
    public boolean hasRDO(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (DomainConstants.TYPE_MESSAGE.equalsIgnoreCase(objectType)) {
                String mqlString = "expand bus \'" + objId + "\' to rel " + RELATIONSHIP_REPLY + " recurse to end select businessobject id dump |";
                parentId = MqlUtil.mqlCommand(context, mqlString);
            ...
            if (RDOid == null || RDOid.equals("")) {
                ...
                if (roles == null) {
                    ...
                    if (memberMapList == null || memberMapList.size() < 1) {
                        // person not member of RDO,
                        return false;
                    } else { // getting role from Association
                        String strPersonName = "";
                        String strRoles = "";
                        String mqlString = "print association '" + PropertyUtil.getSchemaProperty(context, "association_PrivateDiscussion") + "'";
                        String ascString = MqlUtil.mqlCommand(context, mqlString);
    ...
    /**
     * creates the admin user Type with name of the object created and also registers it. the role created, and also registers it.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds one argument, Name of Object Created
    ...
    public int createAdminUserOrganizationForOrganization(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (!"".equals(name)) {
                ...
                String mqlCmd = "add role \"" + name + "\" asanorg";
                ...
                mqlCmd = " add property \"" + symbolicName + "\" on program eServiceSchemaVariableMapping.tcl to role \"" + name + "\" ";
                MqlUtil.mqlCommand(context, mqlCmd);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds two arguments Name - name of the old object .i.e. before modification NewName - name of the Object which is newly created
     * @return 0 if operation is Success.
     * @throws Exception
     *             if the operation fails
     * @since Common X2
    ...
    public int updateAdminUserOrganizationForOrganization(Context context, String[] args) throws Exception {
        ...
        try {
            if (Organization.hasAdminUserRole(context, oldName)) {
                String mqlCmd = "modify role \"" + oldName + "\" name   \"" + newName + "\"";
                MqlUtil.mqlCommand(context, mqlCmd, true);
            }
        } catch (Exception ex) {
            return ERROR;
        }
    ...
    public int setLeadRoles(Context context, String[] args) throws Exception {
        ...
        if (!"".equals(sLeadResponsibility)) {
            ...
            if (checkRole == 1) {
                ...
                mqlCom.executeCommand(context, "print connection bus " + fromDo.getId() + " to " + personDo.getId() + " relationship '" + sLeadResponsibility + "' select id dump");
    ...
    public Vector getPersonSummaryAssignedLeadRoles(Context context, String[] args) throws Exception {
        ...
        MapList leadResPersons = (MapList) obj.getRelatedObjects(context, RELATIONSHIP_LEAD_RESPONSIBILITY, TYPE_PERSON, new StringList(SELECT_ID), new StringList(selAttrProjectRole), false, true,
                (short) 1, EMPTY_STRING, EMPTY_STRING, 0, null, null, null);
        ...
        for (int i = 0; i < relBusObjPageList.size(); i++) {
            ...
            leadRoles = UIUtil.isNullOrEmpty(leadRoles) ? EMPTY_STRING : getI18NRoleListValue(context, strLanguage, FrameworkUtil.split(leadRoles, "~"));
            v.add(leadRoles);
        }
        return v;
    }
    ...
    public Vector getAssignedLeadRoles(Context context, String[] args) throws Exception {
    ...
    public MapList organizationSearchIDs(Context context, String args[]) throws Exception {
        ...
        if (sType != null && sName != null && sDescription != null) {
            ...
            String query = "temp query bus " + sType + " " + sName + " * where 'description smatch " + sDescription + "' select id dump |";
            MQLCommand mqlCmd = new MQLCommand();
            if (mqlCmd.executeCommand(context, query)) {
                // Storing Result.
            ...
            while (stRecords.hasMoreTokens()) {
                ...
                for (int i = 0; stFields.hasMoreTokens(); i++) {
                    ...
                    if (i == 3) {
                        ...
                        MapList mlLeadRoles = doObj.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_LeadResponsibility"),
                                PropertyUtil.getSchemaProperty(context, "type_Person"), objSelects, relSelects, false, true, (short) 1, "", "");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds input arguments. first parameter object Id of matrix object
     * @return void.
     * @throws Exception
     *             if the operation fails.
     * @since X+3
    ...
    public String getAdvancedACCESSRDOAndRMOs(Context context, String args[]) throws Exception {
        ...
        MapList mlRDOs = domPart.getRelatedObjects(context, DomainConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY, "*", busSelects, relSelects, true, false, (short) 1, "", "");
        ...
        if (mxType.isOfParentType(context, strType, DomainConstants.TYPE_PART)) {
            ...
            mlPartMaster = DomainObject.findObjects(context, PropertyUtil.getSchemaProperty(context, "type_PartMaster"), sPartName, strType, "*", "*", "", true, busSelects);
            // End : IR366583V6R2011
            ...
            if (sPartMasterId != null && !"".equals(sPartMasterId) && !"null".equals(sPartMasterId)) {
                ...
                MapList mlRMOs = domPartMaster.getRelatedObjects(context, DomainConstants.RELATIONSHIP_MANUFACTURING_RESPONSIBILITY, "*", busSelects, relSelects, true, false, (short) 1, "", "");
                if (!mlRMOs.isEmpty()) {
    ...
    public StringList getExcludeOIDForResourceManagerSearch(Context context, String args[]) throws Exception {
        try {
            ...
            RelationshipWithSelectList relationshipWithSelectList = Relationship.query(context, strRelPattern, strVaultPattern, strRelExpression, nObjectLimit, slSelectStmts, slOrderBy);
     ...
     *            Matrix Context object
     * @param args
     *            The array of resource manager ids
    ...
    public int assignResourceManagers(Context context, String[] args) throws MatrixException {
        try {
            ...
            MapList mlResourceManagers = dmoBU.getRelatedObjects(context, strRelationshipPattern, // pattern to match relationships
     ...
     * @param args
     *            String array of selectables
     * @returns MapList information about Resource Managers
     * @throws MatrixException
     *             if context is null / the operation fails
     * @since PRG R208
     */
    public MapList getResourceManagers(Context context, String[] args) throws MatrixException {
        ...
        try {
            ...
            MapList mlResourceManagers = getRelatedObjects(context, strRelationshipPattern, // pattern to match relationships
                    strTypePattern, // pattern to match types
                    slBusSelect, // the eMatrix StringList object that holds the list of select statement pertaining to Business Obejcts.
                    slRelSelect, // the eMatrix StringList object that holds the list of select statement pertaining to Relationships.
                    getTo, // get To relationships
    ...
    /**
     * This method assigns selected persons as Resource managers to the Business Units field when selected from edit form mode. It is used for -Field ResourceManager in form type_BusinessUnit -Field
     * ResourceManager in form type_Company
     * @param context
     *            The Matrix Context object
     * @param args
     *            Packed ProgramMap
     * @throws MatrixException
     *             if context is null / objectId parameter is invalid / the operation fails
     * @since PRG R208
     */
    public void updateFieldResourceManagerData(Context context, String[] args) throws MatrixException {
        try {
            ...
            StringList resourceMgrIdList = (resourceMgrIds == null || "".equals(resourceMgrIds) || "null".equals(resourceMgrIds)) ? new StringList()
    ...
    /**
     * Returns comma separated names of the Resource Managers. This method is used for getting value of Resource Manager field on web form. It is used for -Field ResourceManager in form
     * type_BusinessUnit -Field ResourceManager in form type_Company
     * @param context
     *            The Matrix Context object
     * @param args
     *            Packed programMap
     ...
     * @param context
     *            Matrix Context Object
     * @param slResourceManagerIDs
     *            StringList of Person IDs
     * @throws Exception
     * @since PRG R208
     */
    ...
    /**
     * When a Business unit, Department or Organization or any child object of Organization is deleted the Role associated with that object gets deleted, if exists.
     * @param context
     *            The Matrix Context object
     * @param args
     *            comtains the name of role
    ...
    public int deletePandORoleAction(Context context, String[] args) throws Exception {
        try {
            ...
            String strMQL = "list role \"" + strName + "\";";
            if (MqlUtil.mqlCommand(context, strMQL, true).trim().length() > 0) {
                strMQL = "delete role \"" + strName + "\";";
                MqlUtil.mqlCommand(context, strMQL, true);
            }
            ContextUtil.commitTransaction(context);
        } catch (Exception e) {
            ContextUtil.abortTransaction(context);
    ...
    /**
     * Retuns Map having key and values required to show the Contry selection in JSPs Key - Value default - default value for Country attribute valueList - Contry attribute range values optionList -
     * Country attribute option values (I18N strings for range values) manualEntryList - option to show manual entry ("~~~AllowFreeFormEntry~~~")
     * @param context
     * @param language
     * @return
     * @throws Exception
    ...
    /**
     * Method will be invoked by the delete Check trigger on department delete. Method will check for MemberList owned by the Organization and delete the connected Organizations.
     * @param context
     *            The Matrix Context object
     * @param args
     *            args[0] object Id of the deleted Organization
    ...
    public int deleteOwnedMemberListCheck(Context context, String[] args) throws Exception {
        try {
            ...
            MapList list = obj.getRelatedObjects(context, TYPE_MEMBER_LIST, RELATIONSHIP_MEMBER_LIST, objectSelects, null, false, true, (short) 1, null, null, 0);
            if (list.size() > 0) {
    ...
    public Map getCurrencyRangeForStandardCost(Context context, String[] args) throws MatrixException {
        try {
            ...
            String queryOne = "print attribute '" + PropertyUtil.getSchemaProperty(context, "attribute_StandardCost") + "' select Dimension dump";

            String dimensionName = MqlUtil.mqlCommand(context, queryOne);
            String queryTwo = "print Dimension '" + dimensionName + "' select unit.label dump";
            String queryThree = "print Dimension '" + dimensionName + "' select unit.name dump";

            String units = MqlUtil.mqlCommand(context, queryTwo);
            String unitsNames = MqlUtil.mqlCommand(context, queryThree);
    ...
    public boolean isParentCompanyAHostCompany(Context context, String strOrganizationId) throws FrameworkException {
        try {
            ...
            while (!sOrgTypeName.equals(TYPE_COMPANY)) {
                String relType = sOrgTypeName.equals(TYPE_BUSINESS_UNIT) ? RELATIONSHIP_DIVISION : sOrgTypeName.equals(TYPE_DEPARTMENT) ? RELATIONSHIP_COMPANY_DEPARTMENT : null;
                if (relType == null) {
                    foundCompany = false;
                    break;
                }
            ...
            MapList subsidiaries = busOrganization.getRelatedObjects(context, RELATIONSHIP_SUBSIDIARY, TYPE_COMPANY, new StringList(SELECT_ID), null, false, true, (short) 0, null, null, 0);
    ...
    public MapList getFormatstoAdd(Context context, String[] args) throws FrameworkException {
        try {
            ...
            MapList formatObjMapList = DomainObject.findObjects(context, // eMatrix context
            ...
            MapList formatsConnectedList = orgObj.expandSelect(context, RELATIONSHIP_SUPPORTED_FILE_FORMAT, TYPE_FILE_FORMAT, busSelects, relSelects, false, true, (short) 1, null, null, null, null,
                    null, null, false);
    ...
    /**
     * Shows the Company Name as Root object in Select Business Unit, Department, Region, Owning Organization select windows. If objectId is there and it is of type Compnay it shows as Root element If
     * it is not there then it will try to get the compnayId from objectId using ComponentsUtil.getCompanyIdForChildObjectId() method If still company id is null, it will show context users company
     * name as root element If canSelectRootCompany is true it will enable the Root company for selection, if this value is null/false/empty it will be disabled.
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getRootObjectForSelectOrganization(Context context, String[] args) throws FrameworkException {
        try {
            ...
            if (!UIUtil.isNullOrEmpty(objectId)) {
                ...
                companyId = !TYPE_COMPANY.equals(contextObj.getInfo(context, SELECT_TYPE)) ? ComponentsUtil.getCompanyIdForChildObjectId(context, objectId) : objectId;
            }
            companyId = UIUtil.isNullOrEmpty(companyId) ? Person.getPerson(context).getCompanyId(context) : companyId;

            Map companyMap = new HashMap(2);
    ...
    /**
     * Expand program for select Owning Organization Returns Departments, Business Units, and Plants connected to the selected organization
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList selectionOwningOrganizationExpandProgram(Context context, String[] args) throws FrameworkException {
        try {
            ...
            Organization org = new Organization(orgId);
            String orgType = org.getInfo(context, SELECT_TYPE);
            ...
            if (TYPE_COMPANY.equals(orgType) && route.checkIfSubsidiaryOrgMembersEnabled(context) && (Person.getPerson(context).getCompanyId(context)).equals(orgId)) {
                StringList selectStmts = new StringList();
                selectStmts.addElement(SELECT_ID);
                Company companyObj = (Company) newInstance(context, orgId);
                List<Map> mlCompanies = companyObj.getAllSubsidiaries(context, selectStmts, 0);
                organizations.addAll(mlCompanies);
            }
