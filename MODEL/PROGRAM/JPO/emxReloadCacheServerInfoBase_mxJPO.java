...
/**
 * The <code>emxReloadCacheServerInfoBase</code> class contains implementation code for properties to remotely reload cache.
...
public class emxReloadCacheServerInfoBase_mxJPO {
     ...
     * @since AEF 10.5.SP1
     */
    public emxReloadCacheServerInfoBase_mxJPO(Context context, String[] args) throws Exception {
        // super(context, args);
    }
     ...
     * @since AEF 10.5.SP1
     */
    public String[] getAppServerList(Context context, String[] args) throws Exception {
     ...
     * @since AEF 10.5.SP1
     */
    public String[] getRMIServerList(Context context, String[] args) throws Exception {
