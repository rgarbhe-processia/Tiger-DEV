...
public class emxDashboardChangesBase_mxJPO {
    ...
    public String[] getChangesDashboardData(Context context, String[] args) throws Exception {
        ...
        if (mlChanges.size() > 0) {
            ...
            if (mlChanges.size() == 1) {
                sPrefix = EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.String.ThereIs", sLanguage);
            }
            if (mlChanges.size() == 1) {
                sSuffix = EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.String.ChangeMatching", sLanguage);
            }
            ...
            for (int i = 0; i < 3; i++) {
                for (int j = 0; j < 3; j++) {
                    bdDurations[i][j] = new BigDecimal("0");
                }
            }
            ...
            for (int i = 0; i < lWeeksMonths.size(); i++) {
                for (int j = 0; j < 5; j++) {
                    iCountersTimeline[i][j] = 0;
                }
            }
            ...
            for (int i = 0; i < mlChanges.size(); i++) {
                ...
                if (sCurrent.equals("Submit")) {
                    iCountStatus[0]++;
                } else if (sCurrent.equals("Evaluate")) {
                    iCountStatus[0]++;
                } else if (sCurrent.equals("Review")) {
                    iCountStatus[0]++;
                } else if (sCurrent.equals("Approved")) {
                    iCountStatus[1]++;
                } else if (sCurrent.equals("Implement")) {
                    iCountStatus[1]++;
                } else if (sCurrent.equals("Validate")) {
                    iCountStatus[2]++;
                } else if (sCurrent.equals("Formal Approval")) {
                    iCountStatus[2]++;
                } else if (sCurrent.equals("Complete")) {
                    iCountStatus[3]++;
                } else if (sCurrent.equals("Close")) {
                    iCountStatus[4]++;
                }

                // ECO states
                else if (sCurrent.equals("Define Components")) {
                    iCountStatus[0]++;
                } else if (sCurrent.equals("Design Work")) {
                    iCountStatus[1]++;
                } else if (sCurrent.equals("Review")) {
                    iCountStatus[2]++;
                } else if (sCurrent.equals("Released")) {
                    iCountStatus[3]++;
                } else if (sCurrent.equals("Implemented")) {
                    iCountStatus[4]++;
                }

                if (sSeverity.equals("Low")) {
                    iCountSeverity[0]++;
                    iSeverity = 0;
                } else if (sSeverity.equals("Medium")) {
                    iCountSeverity[1]++;
                    iSeverity = 1;
                } else if (sSeverity.equals("High")) {
                    iCountSeverity[2]++;
                    iSeverity = 2;
                }
                ...
                if (!"".equals(sDuration1)) {
                    bdDuration1 = new BigDecimal(sDuration1);
                }
                if (!"".equals(sDuration2)) {
                    bdDuration2 = new BigDecimal(sDuration2);
                }
                if (!"".equals(sDuration3)) {
                    bdDuration3 = new BigDecimal(sDuration3);
                }
                if (!"".equals(sDuration4)) {
                    bdDuration4 = new BigDecimal(sDuration4);
                }
                if (!"".equals(sDuration5)) {
                    bdDuration5 = new BigDecimal(sDuration5);
                }
                if (!"".equals(sDuration6)) {
                    bdDuration6 = new BigDecimal(sDuration6);
                }
                if (!"".equals(sDuration7)) {
                    bdDuration7 = new BigDecimal(sDuration7);
                }
                ...
                for (int j = 0; j < lTimeline.size(); j++) {
                    ...
                    if (!sStart5.equals("")) {
                        ...
                        if (bUseMonths) {
                            iMonthStart = cStart5.get(java.util.Calendar.MONTH) + 1;
                        }
                    ...
                    if (!sStart4.equals("") && (bFound == false)) {
                        ...
                        if (bUseMonths) {
                            iMonthStart = cStart4.get(java.util.Calendar.MONTH) + 1;
                        }
                        if (iYearStart == iYearReference) {
                            if (iMonthStart <= iWeekMonthReference) {
                                bFound = true;
                    ...
                    if (!sStart3.equals("") && (bFound == false)) {
                        ...
                        if (bUseMonths) {
                            iMonthStart = cStart3.get(java.util.Calendar.MONTH) + 1;
                        }
                        if (iYearStart == iYearReference) {
                            if (iMonthStart <= iWeekMonthReference) {
                                bFound = true;
                    ...
                    if (!sStart2.equals("") && (bFound == false)) {
                        ...
                        if (bUseMonths) {
                            iMonthStart = cStart2.get(java.util.Calendar.MONTH) + 1;
                        }
                        if (iYearStart == iYearReference) {
                            if (iMonthStart <= iWeekMonthReference) {
                                bFound = true;
                    ...
                    if (!sStart1.equals("") && (bFound == false)) {
                        ...
                        if (bUseMonths) {
                            iMonthStart = cStart1.get(java.util.Calendar.MONTH) + 1;
                        }
                        if (iYearStart == iYearReference) {
                            if (iMonthStart <= iWeekMonthReference) {
            ...
            sbDataDuration.append("{name : \"").append(sLabelState1).append("\", data : [").append(bdDurations[0][2]).append(",").append(bdDurations[0][1]).append(",").append(bdDurations[0][0])
                    .append("], color: '#").append(sColorState3).append("'},");
            sbDataDuration.append("{name : \"").append(sLabelState2).append("\", data : [").append(bdDurations[1][2]).append(",").append(bdDurations[1][1]).append(",").append(bdDurations[1][0])
                    .append("], color: '#").append(sColorState2).append("'},");
            sbDataDuration.append("{name : \"").append(sLabelState3).append("\", data : [").append(bdDurations[2][2]).append(",").append(bdDurations[2][1]).append(",").append(bdDurations[2][0])
                    .append("], color: '#").append(sColorState1).append("'}");
            ...
            for (int i = 0; i < lTimeline.size(); i++) {
                sbAxisTimeline.append("'").append(lTimeline.get(i)).append("',");
            }
            ...
            if (sbDataTimeline1.length() > 0) {
                sbDataTimeline1.setLength(sbDataTimeline1.length() - 1);
            }
            if (sbDataTimeline2.length() > 0) {
                sbDataTimeline2.setLength(sbDataTimeline2.length() - 1);
            }
            if (sbDataTimeline3.length() > 0) {
                sbDataTimeline3.setLength(sbDataTimeline3.length() - 1);
            }
            if (sbDataTimeline4.length() > 0) {
                sbDataTimeline4.setLength(sbDataTimeline4.length() - 1);
            }
            if (sbDataTimeline5.length() > 0) {
                sbDataTimeline5.setLength(sbDataTimeline5.length() - 1);
            }
        ...
        for (int i = 0; i < mlCategories.size(); i++) {
            ...
            sbDataCategories.append("{ name:\"").append((String) mCategory.get("name")).append("\", color:'#").append(sColors[i % sColors.length]).append("', y:")
                    .append((String) mCategory.get("count")).append("},");
        }

        sbDataStatus.append("{ name:\"").append(sLabelState1).append("\", color:'#").append(sColorState1).append("', y:").append(iCountStatus[0])
                .append(", filter:'Submit,Evaluate,Review,Define Components'},");
        ...
        String sURLPrefix = "onclick='openURLInDetails(\"../common/emxIndentedTable.jsp?changeTypes=" + sChangeTypes + "&filterGlobal=" + sFilterGlobal
                + "&table=APPDashboardEC&program=emxDashboardChanges:getChangesDashboardItems&&freezePane=Name,NewWindow&suiteKey=Framework&filterRange=";
        ...
        sbUpdates.append("<td class='counterCell red'    style='width:25%;'").append(sURLPrefix).append("1&header=").append(sLabelLatestUpdate).append(" : ").append(sLabelToday).append("\")'")
                .append("><span class=\"counterText red\">").append(iCountUpdates[0]).append("</span><br/>").append(sLabelToday).append("</td>");
        sbUpdates.append("<td class='counterCell yellow' style='width:25%;'").append(sURLPrefix).append("2&header=").append(sLabelLatestUpdate).append(" : ").append(sLabelThisWeek).append("\")'")
                .append("><span class=\"counterText yellow\">").append(iCountUpdates[1]).append("</span><br/>").append(sLabelThisWeek).append("</td>");
        sbUpdates.append("<td class='counterCell green'  style='width:25%;'").append(sURLPrefix).append("3&header=").append(sLabelLatestUpdate).append(" : ").append(sLabelThisMonth).append("\")'")
                .append("><span class=\"counterText green\">").append(iCountUpdates[2]).append("</span><br/>").append(sLabelThisMonth).append("</td>");
        sbUpdates.append("<td class='counterCell gray'   style='width:25%;'").append(sURLPrefix).append("4&header=").append(sLabelLatestUpdate).append(" : ").append(sLabelLast30Days).append("\")'")
                .append("><span class=\"counterText gray\">").append(iCountUpdates[3]).append("</span><br/>").append(sLabelLast30Days).append("</td>");
        sbUpdates.append("</tr></table>");

        // Remove trailing commas
        if (sbAxisCategories.length() > 0) {
            sbAxisCategories.setLength(sbAxisCategories.length() - 1);
        }
        if (sbDataCategories.length() > 0) {
            sbDataCategories.setLength(sbDataCategories.length() - 1);
        }
        if (sbAxisTimeline.length() > 0) {
            sbAxisTimeline.setLength(sbAxisTimeline.length() - 1);
        }
    ...
    public MapList retrievChangesPending(Context context, String[] args, StringList busSelects, String sFilterGlobal, String sFilter, String sTypes) throws FrameworkException {
        ...
        if (sFilterGlobal.equals("MineInWork")) {
            sWhere += " && (current != 'Complete') && (owner =='" + context.getUser() + "')";
        } else if (sFilterGlobal.equals("AllInWork")) {
            sWhere += " && (current != 'Complete')";
        } else if (sFilterGlobal.equals("MineAll")) {
            sWhere += " && (owner =='" + context.getUser() + "')";
        }
    ...
    public String[] getUserDashboardData(Context context, String[] args) throws Exception {
        ...
        MapList mlChanges = pUser.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ASSIGNED_EC, DomainConstants.TYPE_ENGINEERING_CHANGE, busSelects, null, false, true, (short) 1,
        ...
        for (int i = 0; i < mlChanges.size(); i++) {
            ...
            if (sSeverity.equals("Medium")) {
                iSeverity = 1;
            } else if (sSeverity.equals("High")) {
                iSeverity = 2;
            }

            if (sCurrent.equals("Evaluate")) {
                iStatus = 1;
            } else if (sCurrent.equals("Review")) {
                iStatus = 2;
            } else if (sCurrent.equals("Approved")) {
        ...
        sbDataChanges.append(" data: [").append(iCounters[0][0]).append(",").append(iCounters[0][1]).append(",").append(iCounters[0][2]).append(",").append(iCounters[0][3]).append(",")
                .append(iCounters[0][4]).append(",").append(iCounters[0][5]).append(",").append(iCounters[0][6]).append("] },");
        ...
        sbDataChanges.append(" data: [").append(iCounters[1][0]).append(",").append(iCounters[1][1]).append(",").append(iCounters[1][2]).append(",").append(iCounters[1][3]).append(",")
                .append(iCounters[1][4]).append(",").append(iCounters[1][5]).append(",").append(iCounters[1][6]).append("] },");
        ...
        sbDataChanges.append(" data: [").append(iCounters[2][0]).append(",").append(iCounters[2][1]).append(",").append(iCounters[2][2]).append(",").append(iCounters[2][3]).append(",")
                .append(iCounters[2][4]).append(",").append(iCounters[2][5]).append(",").append(iCounters[2][6]).append("] }");

        StringBuilder sbCounter = new StringBuilder();
        sbCounter.append(
                "<td onclick='openURLInDetails(\"../common/emxIndentedTable.jsp?table=APPDashboardEC&program=emxDashboardChanges:getChangesAssignedPending&header=emxFramework.String.AssignedChangesPending&freezePane=Name,NewWindow&suiteKey=Framework\")'");
        sbCounter.append(" class='counterCell ");
        if (iCountTotal == 0) {
            sbCounter.append("grayBright");
        } else {
            sbCounter.append("' style='color:#00B2A9;");
        }
        ...
        if (iCountMRU > 0) {
            sbUpdates.append(
                    " onclick='openURLInDetails(\"../common/emxIndentedTable.jsp?table=APPECList&program=emxDashboardChanges:getChangesAssignedPending&mode=MRU&header=emxFramework.String.MRUChanges&freezePane=Name,NewWindow&suiteKey=Framework\")' ");
    ...
    public MapList getChangesAssignedPending(Context context, String[] args) throws Exception {
        ...
        if (sMode.equals("MRU")) {
            ...
            if (sStatus.equals("0")) {
                ...
                sStatus = "Formal Approval";
            } else if (sStatus.equals("7")) {
                sStatus = "Complete";
            } else if (sStatus.equals("8")) {
                sStatus = "Close";
            } else if (sStatus.equals("9")) {
                sStatus = "Reject";
            }
