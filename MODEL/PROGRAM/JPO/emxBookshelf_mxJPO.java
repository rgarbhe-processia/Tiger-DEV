 ...
 **
 ** FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.9 $" Date : "$Date: Wed Oct 22 16:02:11 2008 $"
 **
 */
...
/**
 * The <code>emxBookshelf</code> represents anything on the "To Side" of "Has Bookshelves" Relationship in DC Schema
...
public class emxBookshelf_mxJPO extends emxBookshelfBase_mxJPO {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("must specify method on emxBookshelf invocation");
        }
