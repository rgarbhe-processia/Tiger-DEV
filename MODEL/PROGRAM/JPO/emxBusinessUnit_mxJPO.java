 ...
 */
public class emxBusinessUnit_mxJPO extends emxBusinessUnitBase_mxJPO {
     ...
     * @grade 0
     */
    public emxBusinessUnit_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
