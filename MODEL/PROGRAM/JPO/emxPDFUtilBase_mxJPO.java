 ...
 *
 * FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.11 $" Date : "$Date: Wed Oct 22 15:53:02 2008 $"
 *
 */
...
/**
 * This class is a catch all class for utility methods. It contains what should be static methods, (but they can't be called from the JPO environment) instantiate this class, and you can then call any
 * of the utility functions it contains.
 * @author Devon Jones
...
public class emxPDFUtilBase_mxJPO {
     ...
     * @since AEF 9.5.4.0
     */
    public emxPDFUtilBase_mxJPO(Context context, String[] args) {
        /*
         * Author : DJ Date : 02/04/2003 Notes : History :
         */
    }
     ...
     * @since AEF 9.5.4.0
     */
    public Boolean isBPEnabled(Context context, String[] args) {
        /*
         * Author : DJ Date : 03/21/2003 Notes : History :
         */
        MxDebug.enter();
        ...
        String enabled = getString(context, "eServiceBatchPrintPDF.Batch.BatchPrintAvailable");
     ...
     * @since AEF 9.5.4.0
     */
    public Boolean isRNDEnabled(Context context, String[] args) {
        /*
         * Author : DJ Date : 03/21/2003 Notes : History :
         */
        String enabled = getString(context, "eServiceBatchPrintPDF.PDF.PDFRenderingAvailable");
    ...
    /**
     * Method copied from emxMailUtil class. From version 9.5.4.0 AEF This method is used to send an Icon Mail
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param toList
     *            TO:
     ...
     *            Message Body:
     * @exception Exception
     *                MatrixException - Matrix Icon Mail exceptions
     * @since AEF 9.5.4.0
     */
    protected static void sendMail(Context context, StringList toList, StringList ccList, StringList bccList, String subject, String message) throws Exception {
        /*
         * Author : DJ Date : 02/04/2003 Notes : History :
         */
     ...
     *            Matrix Context
     * @param key
     *            string to get from emxBatchPrintPDF.properties
    ...
    /**
     * Method derived from emxMailUtil class. From version 9.5.4.0 AEF Returns a string from a properties file, localized if the string can be localized
     * @param context
     *            Matrix Context
     * @param key
     ...
     * @grade 0
     */
    protected static String getString(Context context, String key, String propFile) {
        /*
         * Author : DJ Date : 02/04/2003 Notes : History :
         */
