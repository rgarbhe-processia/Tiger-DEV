...
public class emxSearchBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public emxSearchBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
     ...
     * 
     * @param args contains a Map with the following entries: txtName - a String of specified criteria name txtRev - a String of specified criteria revision txtTypeActual - a String of specified
     * criteria type vaultSelction - a String of specified criteria vault QueryLimit - a String of limit on the number of objects found latestRevision - a String containing the latestRevision info of
     * the object
     * 
     ...
     */
    public MapList getIntegrationSearchResult(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: txtName - a String of specified criteria name txtRev - a String of specified criteria revision txtTypeActual - a String of specified
    ...
    public MapList getContextSearchResults(Context context, String[] args) throws Exception {
    ...
    /**
     * getFormatTNR - Will get the type,name,revision & Vaults for the Summary Table Will be called in the mxlink Column.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     * @grade 0
     */
    public MapList getLatestREVSearchResult(Context context, String[] args) throws Exception {
    ...
    /**
     * buildSearchResults - method for building the maplist for the columns
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     * @grade 0
     */
    public MapList buildSearchResults(Context context, String[] args, boolean latest) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
