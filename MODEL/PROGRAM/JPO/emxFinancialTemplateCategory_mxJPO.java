...
/**
 * The <code>emxFinancialTemplateCategory</code> class represents the Financial Benefit Category and Financial Cost Category JPO functionality for the AEF type.
...
public class emxFinancialTemplateCategory_mxJPO extends emxFinancialTemplateCategoryBase_mxJPO {
     ...
     * @grade 0
     */
    public emxFinancialTemplateCategory_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
