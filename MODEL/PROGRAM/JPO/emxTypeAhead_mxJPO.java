...
/**
 * emxTypeAhead.java Copyright (c) 2006-2015 Dassault Systemes. All Rights Reserved. This program contains proprietary and trade secret information of MatrixOne, Inc. Copyright notice is precautionary
...
/**
 * This is the base class for all type ahead jpos that may be called via the type ahead tag libarary. This class provides methods that will build a DOM Document based on display and hidden field
 * values that are appropriate for the field on the form. This Document will then be converted to xml and returned to the type ahead javascript implementation in the web browser.
...
public class emxTypeAhead_mxJPO {
    ...
    /**
     * Set the "all" attribute, that all of the data possible has been returned by this JPO. This will prevent the calling of the JPO for other possible input values.
     * @param allDataSent
     *            true to set the attribute to true
     * @since AEF 10.6.SP2
     */
    ...
    /**
     * Get the DOM Document to write into. If it does not exist then create one and return it to the caller.
