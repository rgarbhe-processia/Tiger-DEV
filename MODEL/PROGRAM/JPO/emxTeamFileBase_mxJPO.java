...
public class emxTeamFileBase_mxJPO extends emxCommonFile_mxJPO {
     ...
     */
    public emxTeamFileBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public String checkinCreate(Context context, String[] args) throws Exception {
        try {
            ...
            if (!DocumentUtil.isDocumentExists(context, parentId, fileName)) {
                documentId = checkinCreate(context, null, null, null, description, fileName, language, parentId, parentRelName);
    ...
    public String mcsCheckinCreate(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (!DocumentUtil.isDocumentExists(context, parentId, fileName)) {
                documentId = mcsCheckinCreate(context, fileList, null, fileName, description, store, append, defaultFormat, unlock, language, parentId, parentRelName);
    ...
    /**
     * This method is executed after the create of document object to notify Subscriptions.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds : String the workspaceId String the folderId String the routeId
     * @param String
     *            the documentId
     * @throws Exception
     *             if the operation fails
