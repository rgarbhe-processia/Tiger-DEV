...
/**
 * The <code>emxDocumentUtilBase</code> class contains utility methods for getting data using configurable table APPDocumentSummary
...
public class emxCommonDocumentUIBase_mxJPO {
     ...
     * @grade 0
     */
    public emxCommonDocumentUIBase_mxJPO(Context context, String[] args) throws Exception {
    }
    ...
    /**
     * gets the list of connected DOCUMENTS to the master Object Used for APPDocumentSummary table
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    /**
     * Get Maplist containing Revisions Info for Id passed In Used for Revision Summary Page in APPDocumentSummary table revision column
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    /**
     * This method is to be called from a UI component Table. The method suppress the revision value for the type type_ProjectVault. The type type_ProjectVault uses a auto generated value and users
     * don't want to see the value in the UI interface. The method takes the objectList from the UI table and parses through the revision values. Objects of type type_ProjectVault have the revision
     * value replaced with a blank value. For all other types, the revision values is returned.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            an array of String arguments for this method
     * @return Vector object that contains a vector of revision values for the column.
     * @throws Exception
     *             if the operation fails
     * @since Common 10.5
     * @grade 0
     */
    public Object getRevisionLevel(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < objectList.size(); i++) {
            ...
            if (!typeName.equals(PropertyUtil.getSchemaProperty(context, "type_ProjectVault"))) {
    ...
    /**
     * getNameOrTitle - Will get the Name/Title for Content Summary Table Will be called in the Name Column
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public Vector getNameOrTitle(Context context, String[] args) throws Exception {
    ...
    /**
     * getLockStatus- This method is used to show the Lock image. This method is called from the Column Lock Image.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectList MapList
    ...
    public Vector getLockStatus(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * boolean getfromMapList = false; if ( objectMap != null && objectMap.containsKey(CommonDocument.SELECT_TYPE) && objectMap.containsKey(CommonDocument.SELECT_MOVE_FILES_TO_VERSION) &&
             * objectMap.containsKey(CommonDocument.SELECT_FILE_NAMES_OF_ACTIVE_VERSION) && objectMap.containsKey(CommonDocument.SELECT_FILE_NAME) &&
             * objectMap.containsKey(CommonDocument.SELECT_ACTIVE_FILE_LOCKED) && objectMap.containsKey(CommonDocument.SELECT_LOCKED) &&
             * objectMap.containsKey(CommonDocument.SELECT_TYPE_OF_IC_DOCUMENT) && objectMap.containsKey(CommonDocument.SELECT_FILE_FORMAT)) { if (bActivateDSFA ){ if (
             * objectMap.containsKey(CommonDocument.SELECT_IS_KIND_OF_VC_DOCUMENT)){ getfromMapList = true; } } else { getfromMapList = true; } }
             * 
             * 
             * if (getfromMapList) { mItr = objectList.iterator(); } else {
             */
    ...
    /**
     * getRouteStatus- This method is used to show the Lock image. This method is called from the Column Lock Image.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectList MapList
     ...
     * @since V10 Patch1
     */
    public Vector getRouteStatus(Context context, String[] args) throws Exception {
    ...
    /**
     * getRevisionStatus- This method is used to show the Lock image. This method is called from the Column Lock Image.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectList MapList
     ...
     * @since V10 Patch1
     */
    public Vector getRevisionStatus(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            baseURLBuf.append(
                    "emxTable.jsp?program=emxCommonDocumentUI:getRevisions&amp;popup=true&amp;table=APPDocumentRevisions&amp;header=emxComponents.Common.RevisionsPageHeading&amp;HelpMarker=emxhelpdocumentfilerevisions&amp;subHeader=emxComponents.Menu.SubHeaderDocuments&amp;suiteKey=Components");
            String revHref = "";
            ...
            Iterator itr = null;
            if (objectMap != null && objectMap.containsKey(CommonDocument.SELECT_TYPE_OF_IC_DOCUMENT) && objectMap.containsKey(CommonDocument.SELECT_REVISION)
    ...
    /**
     * getVersionStatus- This method is used to show the Lock image. This method is called from the Column Lock Image.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectList MapList
    ...
    public Vector getVersionStatus(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            boolean bActivateDSFA = FrameworkUtil.isSuiteRegistered(context, "ActivateDSFA", false, null, null);
            /*
             * boolean getFromMapList = false; if ( objectMap != null && objectMap.containsKey(CommonDocument.SELECT_TYPE) && objectMap.containsKey(CommonDocument.SELECT_ACTIVE_FILE_VERSION)) { if
             * (bActivateDSFA ){ if (objectMap.containsKey(CommonDocument.SELECT_VCFILE_EXISTS) && objectMap.containsKey(CommonDocument.SELECT_VCFOLDER_EXISTS) &&
             * objectMap.containsKey(CommonDocument.SELECT_VCMODULE_EXISTS)) { getFromMapList = true; } } else { getFromMapList = true; } }
             * 
             * if ( getFromMapList) { itr = objectList.iterator(); } else {
             */
            String oidsArray[] = new String[objectList.size()];
            for (int i = 0; i < objectList.size(); i++) {
                try {
            ...
            while (itr.hasNext()) {
                ...
                if ((vcFileType != null && vcFileType.equalsIgnoreCase("true")) || (vcFolderType != null && vcFolderType.equalsIgnoreCase("true"))
     ...
     * @param args
     *            an array of String arguments for this method
     * @return Vector object that contains a vector of html code to construct the Actions Column.
     * @throws Exception
     *             if the operation fails
     * @since Common 10.5
     * @grade 0
     */
    public static Vector getDocumentActions(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (objectMap != null && objectMap.containsKey(CommonDocument.SELECT_TYPE) && objectMap.containsKey(CommonDocument.SELECT_SUSPEND_VERSIONING)
                    && objectMap.containsKey(CommonDocument.SELECT_HAS_CHECKOUT_ACCESS) && objectMap.containsKey(CommonDocument.SELECT_HAS_CHECKIN_ACCESS)
                    && objectMap.containsKey(CommonDocument.SELECT_FILE_NAMES_OF_ACTIVE_VERSION) && objectMap.containsKey(CommonDocument.SELECT_FILE_NAME)
                    && objectMap.containsKey(CommonDocument.SELECT_MOVE_FILES_TO_VERSION) && objectMap.containsKey(CommonDocument.SELECT_IS_KIND_OF_VC_DOCUMENT) && objectMap.containsKey("vcfile")
                    && objectMap.containsKey("vcmodule") && objectMap.containsKey(CommonDocument.SELECT_ACTIVE_FILE_LOCKED) && objectMap.containsKey(CommonDocument.SELECT_ACTIVE_FILE_LOCKER)
                    && objectMap.containsKey(CommonDocument.SELECT_HAS_TOCONNECT_ACCESS) && objectMap.containsKey(CommonDocument.SELECT_ACTIVE_FILE_VERSION_ID)
                    && objectMap.containsKey(CommonDocument.SELECT_OWNER) && objectMap.containsKey(CommonDocument.SELECT_LOCKED) && objectMap.containsKey(CommonDocument.SELECT_LOCKER)) {
                ...
                if (CommonDocument.TYPE_DOCUMENTS.equals(parentType)) {
                    ...
                    if (FrameworkLicenseUtil.isCPFUser(context)) {
                        if (!isprinterFriendly) {
                            ...
                            strBuf.append("', '730', '450')\"><img border='0' src='../common/images/iconSmallSubscription.gif' alt=\"" + sTipSubscriptions + "\" title=\"" + sTipSubscriptions
                                    + "\"></img></a>&#160;");
                        } else {
                    ...
                    if ((CommonDocument.canCheckin(context, contentObjectMap) || VCDocument.canVCCheckin(context, contentObjectMap))) {
                        ...
                        if (!isprinterFriendly) {
                            if (isAnyFileLockedByContext) {
                                if (!vcDocument) {
                                    strBuf.append("<a href=\"javascript:showModalDialog('../components/emxCommonDocumentPreCheckin.jsp?objectId=");
                                    strBuf.append(XSSUtil.encodeForJavaScript(context, documentId));
                                    ...
                                    strBuf.append(
                                            "&amp;showFormat=true&amp;showComments=required&amp;objectAction=update&amp;JPOName=emxTeamDocumentBase&amp;appDir=teamcentral&amp;appProcessPage=emxTeamPostCheckinProcess.jsp&amp;refreshTableContent=true&amp;fromActionsColumn=true',730,450);\">");
                                    ...
                                    if (vcFile) {
                                        ...
                                        strBuf.append(XSSUtil.encodeForJavaScript(context, table)); // Added for Bug #371651 ends
                                        strBuf.append(
                                                "&amp;showFormat=false&amp;showComments=required&amp;objectAction=checkinVCFile&amp;allowFileNameChange=false&amp;noOfFiles=1&amp;JPOName=emxVCDocument&amp;methodName=checkinUpdate&amp;refreshTableContent=true', '730', '450');\">");
                                        strBuf.append("<img border='0' src='../common/images/iconActionCheckIn.gif' alt=\"");
                                        strBuf.append(sTipCheckin);
                                        strBuf.append("\" title=\"");
                                        strBuf.append(sTipCheckin);
                                        ...
                                        strBuf.append(XSSUtil.encodeForJavaScript(context, table)); // Added for Bug #371651 ends
                                        strBuf.append(
                                                "&amp;override=false&amp;showFormat=false&amp;showComments=required&amp;objectAction=checkinVCFile&amp;allowFileNameChange=true&amp;noOfFiles=1&amp;JPOName=emxVCDocument&amp;methodName=checkinUpdate&amp;refreshTableContent=true', '730', '450');\">");
                                        strBuf.append("<img border='0' src='../common/images/iconActionCheckIn.gif' alt=\"");
                                        strBuf.append(sTipCheckin);
                                        strBuf.append("\" title=\"");
                                        strBuf.append(sTipCheckin);
                    ...
                    if (CommonDocument.canAddFiles(context, contentObjectMap)) {
                        if (!isprinterFriendly) {
                            ...
                            strBuf.append(XSSUtil.encodeForJavaScript(context, table)); // Added for Bug #371651 ends
                            strBuf.append(
                                    "&amp;showFormat=true&amp;showDescription=required&amp;objectAction=checkin&amp;showTitle=true&amp;JPOName=emxTeamDocumentBase&amp;appDir=teamcentral&amp;appProcessPage=emxTeamPostCheckinProcess.jsp&amp;refreshTableContent=true&amp;fromActionsColumn=true', '730', '450')\">");
     ...
     * @grade 0
     */
    public static Vector getDocumentRevisionActions(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            while (objectListItr.hasNext()) {
                ...
                String isLatestRevision = (String) contentObjectMap.get("islast");
                ...
                if (CommonDocument.TYPE_DOCUMENTS.equals(parentType)) {
                    ...
                    if (CommonDocument.canDownload(context, contentObjectMap)) {
                        if (!isprinterFriendly) {
                            newURL += "<a href=\"javascript:callCheckout('" + XSSUtil.encodeForJavaScript(context, documentId) + "','download','','','"
                                    + XSSUtil.encodeForJavaScript(context, customSortColumns) + "','" + XSSUtil.encodeForJavaScript(context, uiType) + "','"
                                    + XSSUtil.encodeForJavaScript(context, table) + "');\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionDownload.png\" alt=\"" + sTipDownload
                                    + "\" title=\"" + sTipDownload + "\"></img></a>";
                        ...
                        if (isObjLinked != null && !isObjLinked.equals("")) {
                            if (isObjLinked.equalsIgnoreCase("True")) {
                                // show download icon for Linked Objects
                                newURL += "<a href=\"../servlet/MxCCCS/MxCCCommandsServlet.java?commandName=downloadallfiles&objectId=" + XSSUtil.encodeForURL(context, documentId)
                                        + "\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionDownload.png\" alt=\"" + sTipDownload + "\" title=\"" + sTipDownload
                                        + "\"></img></a>";
                            }
                        }
                    }
                    ...
                    if (!isprinterFriendly) {
                        ...
                        strBuf.append(XSSUtil.encodeForJavaScript(context, documentId));
                        // newURL+="<a href=\"javascript:showModalDialog('" +strBuf.toString()+ "','575','575')\"><img style=\"border:0; padding: 2px;\"
                        // src=\"../common/images/iconSmallSubscription.png\" alt=\""+sTipSubscription+"\" title=\""+sTipSubscription+"\"></img></a>";
                        newURL += "<a href=\"javascript:getTopWindow().showSlideInDialog('" + strBuf.toString()
                                + "')\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconSmallSubscription.png\" alt=\"" + sTipSubscription + "\" title=\"" + sTipSubscription
                                + "\"></img></a>";
                    } else {
                        newURL += "<img style=\"border:0; padding: 2px;\" src=\"../common/images/iconSmallSubscription.png\" alt=\"" + sTipSubscription + "\" ></img>";
                    }

                    if ("true".equalsIgnoreCase(isLatestRevision)) {
                        // Can Checkout
                        if (CommonDocument.canCheckout(context, contentObjectMap, false, ((Boolean) versionMap.get(docType)).booleanValue())) {
                            if (!isprinterFriendly) {
                                newURL += "<a href=\"javascript:callCheckout('" + XSSUtil.encodeForJavaScript(context, documentId) + "','checkout','','','"
                                        + XSSUtil.encodeForJavaScript(context, customSortColumns) + "','" + XSSUtil.encodeForJavaScript(context, customSortDirections) + "', '"
                                        + XSSUtil.encodeForJavaScript(context, uiType) + "', '" + XSSUtil.encodeForJavaScript(context, table)
                                        + "');\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionCheckOut.png\" alt=\"" + sTipCheckout + "\" title=\"" + sTipCheckout
                                        + "\"></img></a>";
                            ...
                            if (!isprinterFriendly) {
                                ...
                                if (isAnyFileLockedByContext) {
                                    if (!vcDocument) {
                                        ...
                                        strBuf.append(XSSUtil.encodeForJavaScript(context, table)); // Added for Bug #371651 ends
                                        strBuf.append(
                                                "&amp;showFormat=true&amp;showComments=required&amp;objectAction=update&amp;JPOName=emxTeamDocumentBase&amp;appDir=teamcentral&amp;appProcessPage=emxTeamPostCheckinProcess.jsp&amp;refreshTableContent=true','730','450'");
                                        newURL += "<a href=\"javascript:showModalDialog(" + strBuf.toString()
                                                + ");\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionCheckIn.png\" alt=\"" + sTipCheckin + "\" title=\"" + sTipCheckin
                                                + "\"></img></a>";
                                    ...
                                    if (fileCount <= 1 && !vcDocument) {
                                        ...
                                        if (isContextDocumentOwner || isAnyFileLockedByContext) {
                                            ...
                                            newURL += "<a href=\"javascript:submitWithCSRF(" + strngBuf.toString()
                                                    + ", findFrame(getTopWindow(),'hiddenFrame'));\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionUnlock.png\" alt=\""
                                                    + docLocker + "\" title=\"" + docLocker + "\"></img></a>";
                                        }

                                    }
                                } else {
                                    if (isAnyFileLockedByContext) {
                                        newURL += "<img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionCheckIn.png\" alt=\"" + sTipCheckin + "\" title=\"" + sTipCheckin
                                                + "\"></img>";
                                    }
                                    if (fileCount <= 1) {
                                        if (isContextDocumentOwner || isAnyFileLockedByContext) {
                                            newURL += "<img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionUnlock.png\" alt=\"" + docLocker + "\" title=\"" + docLocker
                                                    + "\"></img>";
                                        }
                                    }
                                }
                        ...
                        if (CommonDocument.canAddFiles(context, contentObjectMap)) {
                            if (!isprinterFriendly) {
                                ...
                                strBuf.append(XSSUtil.encodeForJavaScript(context, table)); // Added for Bug #371651 ends
                                strBuf.append(
                                        "&amp;showFormat=true&amp;showDescription=required&amp;objectAction=checkin&amp;showTitle=true&amp;JPOName=emxTeamDocumentBase&amp;appDir=teamcentral&amp;appProcessPage=emxTeamPostCheckinProcess.jsp&amp;refreshTableContent=true','730','450'");
                                newURL += "<a href=\"javascript:showModalDialog(" + strBuf.toString()
                                        + ");\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionAppend.png\" alt=\"" + sTipAddFiles + "\" title=\"" + sTipAddFiles
                                        + "\"></img></a>";
    ...
    private static HashMap getViewerURLInfo(Context context, String objectId, String fileName) {
    ...
    public String getUploadFilesUIBlock(matrix.db.Context context, String[] args) throws Exception {
        Locale strLocale = context.getLocale();
        String dropFilesHere = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", strLocale, "emxComponents.CommonDocument.UploadFiles.DropFiles"); // "Drop files here or click
                                                                                                                                                                          // to select"
        ...
        strBuf.append(
                "<div class=\"dropArea\" style=\"position:relative\" onmouseout=\"mouseoutDropArea(this)\" onmouseover=\"mouseoverDropArea(this)\" ondragover=\"filesDragOver(this)\" ondragleave=\"filesDragLeave(this)\" ondrop=\"filesDrop(this, event)\" >");
        strBuf.append("<img id=\"dropAreaIcon\" src=\"images/iconActionAdd.png\"/>");
        strBuf.append(" " + dropFilesHere);
        strBuf.append(
                "<input id=\"hiddenFileInputElement\" type=\"file\" style=\"opacity:0;position:absolute;width:100%;height:100%;left:0px;top:0px\" onchange=\"fileInputChanged(this, event)\" multiple=\"true\"></input>");
        strBuf.append("</div>");
    ...
    /**
     * To create a Document object API called from web UI Appends a random number to the passed name, before creating the Document object
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
