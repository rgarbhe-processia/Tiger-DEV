...
public class emxWorkspaceTemplateBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @since AEF Rossini
     */
    public emxWorkspaceTemplateBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public MapList getMyWorkspaceTemplates(Context context, String[] args) throws FrameworkException {
        try {
            ...
            if (company != null) {
                ...
                templateMapList = company.getRelatedObjects(context, relPattern.getPattern(), typePattern.getPattern(), typeSelects, null, false, true, (short) 1, sWhere, "", null, null, null);
            }
            ...
            templateUserMapList = DomainObject.findObjects(context, typePattern.getPattern(), "*", // namePattern
                    "*", // revPattern
     ...
     * @since AEF Rossini
     */
    public Vector getAvailability(Context context, String[] args) throws FrameworkException {
        try {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getWorkspaceTemplateSubFolders(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            ...
            typeSelects.add(WorkspaceTemplate.SELECT_NAME);

            Pattern typePattern = new Pattern(TYPE_PROJECT_VAULT);
            Pattern relPattern = new Pattern(RELATIONSHIP_SUB_VAULTS);
            relPattern.addPattern(RELATIONSHIP_LINKED_FOLDERS);
            MapList folderList = WorkspaceTemplate.getRelatedObjects(context, relPattern.getPattern(), // String relPattern
                    typePattern.getPattern(), // String typePattern
                    typeSelects, null, false, true, (short) 1, "", "", null, null, null);
            return folderList;
        } catch (Exception ex) {
            throw new FrameworkException(ex);
        }
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getWorkspaceTemplateFolders(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            String parentId = (String) programMap.get("objectId");
     ...
     * @since AEF Rossini
     */
    public Vector getWorkspaceTemplateFoldersSecurity(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objList = (MapList) programMap.get("objectList");
     ...
     * @since AEF Rossini
     */
    public MapList getWorkspaceTemplateMembers(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            String parentId = (String) programMap.get("objectId");
            DomainObject WorkspaceTemplate = DomainObject.newInstance(context, parentId);
            ...
            MapList memberList = WorkspaceTemplate.getRelatedObjects(context, relPattern.getPattern(), // String relPattern
                    typePattern.getPattern(), // String typePattern
                    typeSelects, relSelect, false, true, (short) 1, sWhere, "", null, null, null);
     ...
     * @since AEF Rossini
     */
    public Vector showProjectLeadGif(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objList = (MapList) programMap.get("objectList");
            ...
            if (objList != null) {
                ...
                busObjwsl = DomainRelationship.getInfo(context, relIdArray, strList);
                for (int i = 0; i < objList.size(); i++) {
     ...
     * @since AEF Rossini
     */
    public Vector showCreateRouteGif(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objList = (MapList) programMap.get("objectList");
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getWorkspaceTemplateRev(Context context, String[] args) throws FrameworkException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            String parentId = (String) programMap.get("objectId");
     ...
     * @since AEF Rossini
     */
    public Vector getAvailibility(Context context, String[] args) throws FrameworkException {
        try {
    ...
    public static String displayTemplateData(Context context, String args[]) throws Exception {
        ...
        strTemplateData.append("<input type=checkbox name=\"addFolders\" id=\"addFolders\" value=\"\" checked onclick=\"javascript:templateDataSelected(this)\">"
                + XSSUtil.encodeForHTML(context, strFolderStructure));
    ...
    public String getTemplateDescription(Context context, String[] args) throws Exception {
        ...
        if (strTempId != null) {
            ...
            templateDesc.append("<textarea ").append(rteClass).append(" name=\"TemplateDescription\" rows = \"5\" cols = \"25\" value=\""
                    + XSSUtil.encodeForHTMLAttribute(context, strWorkspaceTempDesc) + "\">" + XSSUtil.encodeForHTML(context, strWorkspaceTempDesc) + "</textarea>");
        } else {
