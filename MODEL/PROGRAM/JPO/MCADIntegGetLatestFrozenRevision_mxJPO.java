...
public class MCADIntegGetLatestFrozenRevision_mxJPO extends MCADIntegGetLatestFrozenRevisionBase_mxJPO {
    /**
     * Constructor.
     * @since Sourcing V6R2008-2
     */
    public MCADIntegGetLatestFrozenRevision_mxJPO() {
        super();
    }
     ...
     * @since Sourcing V6R2008-2
     */
    public MCADIntegGetLatestFrozenRevision_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
