...
/**
 * The <code>emxCommonEngineeringChangeBase</code> class contains methods for executing JPO operations related to objects of the admin type Engineering Change.
 * @author Wipro
...
public class emxCommonEngineeringChangeBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    /**
     * Added by Infosys for EC-search bug, 08 June 2005 A string constant with the value const
     */
    public static final String STR_CONST = "const";

    /** relationship "Business Unit Owns". */
    public static final String RELATIONSHIP_BUSINESS_UNIT_OWNS = PropertyUtil.getSchemaProperty("relationship_BusinessUnitOwns");
    ...
    /**
     * Alias for the range value "Promote Connected Object" of attribute Route Completion Object.
     */
    ...
    /**
     * Alias for the range value "For Obsolescence" of attribute Requested Change.
     */
    ...
    public static final String HIGHER_REVISION_ICON = "<img src=\"../common/images/iconSmallHigherRevision.gif\" border=\"0\" align=\"middle\"/>";
    ...
    public static final String ACTIVE_EC_ICON = "<img src=\"../common/images/iconSmallECRO.gif\" border=\"0\" align=\"middle\">";
     ...
     * @return a <code>MapList</code> object having the list of Active Engineering Change objects owned by or assigned to context user
     * @throws Exception
     *             if the operation fails
     * @since Common 10-6
     */
     ...
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
     * @return a <code>MapList</code> object having the list of Active Engineering Change objects for which context user is assignee
     * @throws Exception
     *             if the operation fails
     * @since Common 10-6
     */
     ...
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
     * @return a <code>MapList</code> object having the list of Inactive Engineering Change objects for which context user is assignee
     * @throws Exception
     *             if the operation fails
     * @since Common 10-6
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param strParentId
     *            the id of the parent context object,if any
     * @param strWhereCondition
     *            the String holds the where expression for query
     * @return Maplist the eMatrix <code>MapList</code> object having queried EngineeringChange objects list
     * @throws Exception
     *             if the operation fails
     * @since Common 10-6
     */
    protected MapList getECList(Context context, String strParentId, String strWhereCondition) throws Exception {
        ...
        if (!(strParentId == null || strParentId.equals(DomainConstants.EMPTY_STRING))) {
            ...
            relBusObjPageList = getRelatedObjects(context, strRelECAffectedItem, // 'Affected Items' relationship
                    strTypeEC, // get type EC objects
                    objectSelects, relSelects, true, false, recurseToLevel, strWhereCondition, DomainConstants.EMPTY_STRING);
        } else {
            // retrieving all Active Engineering Change object List in database
            relBusObjPageList = findObjects(context, strTypeEC, DomainConstants.QUERY_WILDCARD, DomainConstants.QUERY_WILDCARD, DomainConstants.QUERY_WILDCARD, DomainConstants.QUERY_WILDCARD,
                    strWhereCondition, true, objectSelects);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following input arguments or entries: queryLimit limit for displaying search query results hdnType the admin 'type'of the object to search for txtName the
     *            'name' or 'name pattern' to search for txtRevision the 'revision' pattern to search for txtDescription the 'description' pattern to search for txtOwner the 'owner' pattern to search
     *            for txtState. the object 'state' pattern to search for vaultOption the 'vault' search option srcDestRelName the name of the destination relationship to expand for
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static MapList getGeneralSearchResults(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (strType == null || strType.equals("") || "null".equalsIgnoreCase(strType)) {
                strType = DomainConstants.QUERY_WILDCARD;
            }

            String strName = (String) programMap.get("txtName");

            if (strName == null || strName.equals("") || "null".equalsIgnoreCase(strName)) {
                strName = DomainConstants.QUERY_WILDCARD;
            }

            String strRevision = (String) programMap.get("txtRevision");

            if (strRevision == null || strRevision.equals("") || "null".equalsIgnoreCase(strRevision)) {
            ...
            if (strOwner == null || strOwner.equals("") || "null".equalsIgnoreCase(strOwner)) {
            ...
            if (strState == null || strState.equals("") || "null".equalsIgnoreCase(strState)) {
            ...
            if (strVaultOption.equalsIgnoreCase(PersonUtil.SEARCH_DEFAULT_VAULT) || strVaultOption.equalsIgnoreCase(PersonUtil.SEARCH_LOCAL_VAULTS)
            ...
            if (strDesc != null && (!strDesc.equals(DomainConstants.QUERY_WILDCARD)) && (!strDesc.equals("")) && !("null".equalsIgnoreCase(strDesc))) {
                if (bStart) {
            ...
            if (strState != null && (strState.equals(strECStateClose) || strState.equals(strECStateReject) || strState.equals(strECStateComplete) || strState.equals(strIssueStateClosed))) {
                bInactiveECAndIssue = true;
            }

            // set this flag true when state based, non-wildcard search is done for non-satisfied items search
            if (!bSatisfiedItemSearch && (strState != null) && (!strState.equals(DomainConstants.QUERY_WILDCARD)) && (!"".equals(strState)) && (!"null".equalsIgnoreCase(strState))) {
                bStateSearch = true;
            ...
            if ((strFilteredExpression != null) && !("null".equalsIgnoreCase(strFilteredExpression)) && !strFilteredExpression.equals("")) {
                if (bStart) {
                    sbWhereExp.append(SYMB_OPEN_PARAN);
                    bStart = false;
                } else {
            ...
            if (bInactiveECAndIssue) {
                ...
                mapList = DomainObject.findObjects(context, strType, strName, strRevision, strOwner, strVault, sbWhereExp.toString(), "", true, (StringList) slSelect, sQueryLimit);
            }
     ...
     *            the eMatrix <code>Context</code> object
     * @param programMap
     *            a Map with input for constructing where clause filter
     * @return String after constructing the Where clause appropriately
     * @throws Exception
     *             when problems occurred in the AEF
     * @since Common 10-6
     */
    protected static String getFilteredExpression(Context context, Map programMap) throws Exception {
        ...
        if (strMidDestRelNameSymb != null && !strMidDestRelNameSymb.equals("") && !("null".equalsIgnoreCase(strMidDestRelNameSymb))) {
            strMidDestRelName = PropertyUtil.getSchemaProperty(context, strMidDestRelNameSymb);
        }

        String strSrcMidRelName = "";
        if (strSrcMidRelNameSymb != null && !strSrcMidRelNameSymb.equals("") && !("null".equalsIgnoreCase(strSrcMidRelNameSymb))) {
            strSrcMidRelName = PropertyUtil.getSchemaProperty(context, strSrcMidRelNameSymb);
        }

        String strSrcDestRelName = "";
        if (strSrcDestRelNameSymb != null && !strSrcDestRelNameSymb.equals("") && !("null".equalsIgnoreCase(strSrcDestRelNameSymb))) {
        ...
        if ((strCommand != null) && !strCommand.equals("") && !("null".equalsIgnoreCase(strCommand))) {

            if ((strMode.equals(Search.ADD_EXISTING)) && (strObjectId != null) && (!strObjectId.equals("")) && !("null".equalsIgnoreCase(strObjectId))) {
                bStart = false;
                sbWhereExp.append(SYMB_OPEN_PARAN);
        ...
        if (strDQ != null && !strDQ.equals("") && !("null".equalsIgnoreCase(strDQ))) {
            if (!bStart) {
                sbWhereExp.append(SYMB_AND);
                bStart = false;
            }
        ...
        if (strWhereExp != null && !strWhereExp.equals("") && !("null".equalsIgnoreCase(strWhereExp))) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following input arguments or entries: type the admin 'type'of the object to search for Name the 'name' or 'name pattern' to search for Description the
     *            'description' pattern to search for MemberListOwner the 'owner' pattern to search for queryLimit. the search query limit vaultOption the vault search option vaultName the vault
     *            'name' pattern
    ...
    public MapList getMemberLists(matrix.db.Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (strDesc != null && !(strDesc.equalsIgnoreCase("*")) && (!strDesc.equals("")) && !("null".equalsIgnoreCase(strDesc))) {
            ...
            if (sECRECOUI != null && sECRECOUI.equalsIgnoreCase("true") && sChangeResponsibilityId != null && !sChangeResponsibilityId.equals("") && !sChangeResponsibilityId.equals("null")
                    && !sChangeResponsibilityId.equals(" ")) {
                if (whereClause.length() > 0) {
                    whereClause.append(" && ");
                }
                whereClause.append(SYMB_OPEN_PARAN);
            ...
            String strVaults = "";
            if (strVaultOption != null && (strVaultOption.equalsIgnoreCase(PersonUtil.SEARCH_DEFAULT_VAULT) || strVaultOption.equalsIgnoreCase(PersonUtil.SEARCH_LOCAL_VAULTS)
                    || strVaultOption.equalsIgnoreCase(PersonUtil.SEARCH_ALL_VAULTS))) {
            ...
            lists = DomainObject.findObjects(context, // eMatrix context
                    ...
                    null, false, // expand type
                    objectSelects, Short.parseShort(sQueryLimit));
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with Object Id as input argument
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with object id as an input argument
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a MapList with object id as an input argument
     * @param relName
     *            the relationship name for which the Organization name required
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a MapList with the following as input arguments or entries: objectId holds the context Engineering Change object Id New Value holds the newly selected Reported Against
     *            Object Id
     * @throws Exception
    ...
    public void updateReportedAgainstEC(Context context, String[] args) throws Exception {
        try {
            ...
            relationshipIdList = getRelatedObjects(context, strRelationshipReportedAgainstEC, DomainConstants.QUERY_WILDCARD, objectSelects, relSelectsList, false, true, (short) 1,
            ...
            if (!strNewReportedAgainstObjId.equals(strReportedAgainstId)) {
                ...
                DomainRelationship.connect(context, this, strRelationshipReportedAgainstEC, domainObjectToType);
            }
        } catch (Exception ex) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a MapList with the following as input arguments or entries: Name 'name' or 'name pattern' to search for Availability 'availability' to search for queryLimit the search
     *            querylimit Purpose 'Purpose' to earch for vaultOption the search vault Option vaultName the 'name' of vault to search for State the 'state' to search for orgTemplates the 'owning
        ...
        try {
            ...
            if (orgTemplates != null && "true".equalsIgnoreCase(orgTemplates)) {
                ...
                /** End */
                    ...
                    busWhere.append("(to[").append(DomainConstants.RELATIONSHIP_ROUTE_TEMPLATES).append("].from.id == ").append(person.getId()).append(" || to[")
                            .append(DomainObject.RELATIONSHIP_ROUTE_TEMPLATES).append("].from.id == ").append(company.getId()).append(")");
                }
            }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a Maplist with object Id of route template as argument
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a Maplist with object Id of Member List as argument
     * @return StringList containing Scope
     * @throws Exception
     *             if the operation fails.
     * @since Common 10-6
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a MapList with object Id
     * @param relName
     *            contains the relationship name for which the scope is required
     * @return StringList containing Scope
     * @throws Exception
     *             if the operation fails.
     * @since Common 10-6
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: object Id object Id of context Engineering Change. New Value object Id of updated Distribution List Object
     * @throws Exception
     *             if the operations fails
     * @since Common 10-6
     */
    public void updateECDistributionList(Context context, String[] args) throws Exception {
        try {
            ...
            MapList relationshipIdList = new MapList();
            // Calling getRelatedObjects to get the relationship ids
            relationshipIdList = getRelatedObjects(context, strRelationship, DomainConstants.QUERY_WILDCARD, objectSelects, relSelectsList, false, true, (short) 1, DomainConstants.EMPTY_STRING,
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a Map with the following input arguments : mode the mode in which a field need to be displayed name the field name to be displayed PFmode flag to find if in Printer friendly
     *            mode or not objectId context Engineering Change objectId
     * @throws Exception
     *             if the operations fails
    ...
    public String buildReviewApproveFields(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            // 375788
            /*
             * relationshipIdList = getRelatedObjects(context, strRelationship, strType, objectSelects, relSelectsList, false, true, (short)1, objWhere, //375788 DomainConstants.EMPTY_STRING);
             */
            ...
            MapList routeList = getRelatedObjects(context, strRelationship, DomainConstants.TYPE_ROUTE, objectSelects1, null, false, true, (short) 1, DomainConstants.EMPTY_STRING, relWhere1);
            if (routeList.size() > 0) {
                ...
                while (itrTemplates.hasNext()) {
                    ...
                    relationshipIdList = objRoute.getRelatedObjects(context, RELATIONSHIP_INITIATING_ROUTE_TEMPLATE, strType, objectSelects, relSelectsList, false, true, (short) 1,
                            DomainConstants.EMPTY_STRING, "");
                }
            } else {
                relationshipIdList = getRelatedObjects(context, strRelationship, strType, objectSelects, relSelectsList, false, true, (short) 1, objWhere, // 375788
                        DomainConstants.EMPTY_STRING);
            }
            ...
            if (DomainConstants.TYPE_ECO.equals(strChangeType) || TYPE_MECO.equals(strChangeType)) {
                ...
                if (!"true".equalsIgnoreCase(strPDFrender)) {
                    ...
                    // 359889
                    /*
                     * outPut.append("var designResName = document.editDataForm.RDODisplay.value;"); outPut.append(" if (designResName == null || designResName == \"\" || designResName == \" \") {");
                     ...
                     * outPut.append(" return false;"); outPut.append("}"); outPut.append(
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a Map with the following input arguments: objectId objectId of the context Engineering Change New Value objectId of updated Review List value
     * @throws Exception
     *             if the operations fails
     * @since Common 10-6
     */
    public void updateObjectRouteReview(Context context, String[] args) throws Exception {
        try {
            ...
            /*
             * commented the loop for the fix IR-016954 if(strNewToTypeObjId == null || "".equals(strNewToTypeObjId)){ strNewToTypeObjId = (String) paramMap.get("New OID"); }
             */
            ...
            MapList relationshipIdList = new MapList();
            // Calling getRelatedObjects to get the relationship ids
            relationshipIdList = getRelatedObjects(context, strRelationship, strType, objectSelects, relSelectsList, false, true, (short) 1, DomainConstants.EMPTY_STRING,
                    DomainConstants.EMPTY_STRING);
            ...
            if (domainObjectToType != null) {
                ...
                newRelationship = DomainRelationship.connect(context, this, strRelationship, domainObjectToType);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a Map with the following input arguments: objectId objectId of the context Engineering Change New Value objectId of updated Approval List value
     * @throws Exception
     *             if the operations fails
     * @since Common 10-6
     */
    public void updateObjectRouteApproval(Context context, String[] args) throws Exception {
        try {
            ...
            strNewToTypeObjId = (String) paramMap.get("New OID");
            /*
             * commented the loop for the fix IR-016954 if(strNewToTypeObjId == null || "".equals(strNewToTypeObjId)){ strNewToTypeObjId = (String) paramMap.get("New OID"); }fix IR-016954 ends
             */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following as Input arguments: ECReasonForClosure comments for closing the Engineering Change objectId context Engineering change object Id
    ...
    public String closeEngineeringChange(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            mapECAttribClose.put(DomainConstants.ATTRIBUTE_REASON_FOR_CLOSURE, strECReasonForClosure);
            ...
            String strTrigger = MqlUtil.mqlCommand(context, "trigger off", true);
            ...
            try {
                ...
                while (!strCurState.equalsIgnoreCase(strCloseState)) {
                    ...
                    strNextState = (String) ((State) stateList.elementAt(iCurStatePosn + 1)).getName();
                    ...
                    if (signList.isEmpty()) {
                        ...
                        strAutoPromoteChk = MqlUtil.mqlCommand(context, "print policy '" + strCurrentPolicyName + "' select state[" + strCurState + "].autopromote dump", true);
                ...
                strTrigger = MqlUtil.mqlCommand(context, "trigger on", true);
            }
            ...
            bException = true;
            /*
             * The exception ex is thrown back as FrameworkException. This can be modified to handle some specific message from back end and do internationalization.
             */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following as Input arguments: ECReasonForReject comments for closing the Engineering Change objectId context Engineering change object Id
        ...
        try {
            ...
            if (isECHInstalled) {
                ...
                if (!canCancel.booleanValue()) {
                    String strNotice = EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeStringResource", context.getLocale(), "emxEnterpriseChange.Pdcm.CanNotCancelChangeProcess");
            ...
            mapECAttribReject.put(DomainConstants.ATTRIBUTE_REASON_FOR_REJECTION, strECReasonForRejection);
            // setting the atributes for the Object
    ...
    public boolean showCloseToApprovalList(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList relatedApprovalList = contextECObj.getRelatedObjects(context, relPattern.getPattern(), typePattern.getPattern(), false, true, recursionLevel, objectSelects, new StringList(),
                    whereExpn.toString(), DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, null);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing entry for key "RequestValuesMap", having the selected object ids in the UI3 table.
    ...
    /**
     * The method is used to find the total Impact Analysis Effort for an EC to be used by EC Effort Report The total effort is summation of 'Impact Analysis Effort' attribute values of all connected
     * Impact Analysis objects
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id list
    ...
    /**
     * The method is used to find the total Implementation Effort for an EC to be used by EC Effort Report The total effort is summation of 'Implementation Effort' attribute values of all connected
     * Impact Analysis objects
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    /**
     * The method is used to find the total Impact Analysis Validation Effort for an EC to be used by EC Effort Report The total effort is summation of 'Validation Effort' attribute values of all
     * connected Impact Analysis objects
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id list
    ...
    /**
     * The method is used to find the total Effort spent on doing Impact Analysis of an EC to be used by EC Effort Report The total effort is summation of 'Impact Analysis Effort','Validation Effort'
     * and 'Implemetation Effort' attribute values of all connected Impact Analysis objects; it will be displayed in Effort Report page
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id list
    ...
    public Vector getTotalEffort(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < itrSize; i++) {
            ...
            try {
                iTotEffort = Integer.parseInt((String) totalImpactAnalysisEffort.elementAt(i)) + Integer.parseInt((String) totalImplementationEffort.elementAt(i))
    ...
    /**
     * The method is used to fill the Files column in EC Status Report Table with 'Y' or 'N' depending on any files connection exists or not. Returns the column values for 'Files' column depending on
     * the presence of Reference Document fo the EC.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id list
    ...
    /**
     * The method is used to fill the Assigned column in EC Status Report Table with 'Y' /'N' depending on EC has any persons assigned. Returns the column values for 'Assigned' column depending on the
     * presence of Assignees to the Engineering Change object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id list
    ...
    /**
     * The method is used to fill the Impact Analysis column in EC Status Report Table. Returns the column value 'Y'/'N' for 'Impact Analysis' column depending on the presence of Impact Analysis
     * object connection in the Engineering Change object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id list
     * @return a <code>Vector</code> object to return 'Y' or 'N' according to the presence of Impact Analysis for selected Engineering Change object ids.
     * @throws Exception
     *             if the operation fails
     * @since Common 10-6
     */
    ...
    /**
     * The method is used to fill the Test Case column in EC Status Report Table. Returns the column values for 'Test Case' column depending on the number of Test Case objects connected to each
     * Engineering Change object.at any level under it
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id list
    ...
    public Vector getTestCaseColumn(Context context, String[] args) throws Exception {
        ...
        try {
            for (int i = 0; i < oidsArray.length; i++) {// Iterating thro each EC object Id and geting all the related TC. At all levels.
                setId(oidsArray[i]);
                relBusObjPageList = getRelatedObjects(context, relPattern.getPattern(), // 'EC Test Case'and 'Sub Test Case' relationships
                        typePattern.getPattern(), // get type Test Case objects
                        false, true, recurseToLevel, objectSelects, new StringList(), DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING,
                        DomainConstants.EMPTY_STRING, null);
    ...
    /**
     * The method is used to fill the 'Percentage Passed' column in EC Status Report Table. Returns the column values for 'Percentage Passed' column depending on the status of 'Percentage Passed'
     * attribute value of last connected Test Execution
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id list
     * @return a <code>Vector</code> object to return 'Percentage Passed' of latest related Test Execution.for all selected Engineering Change objects
     * @throws Exception
     *             if the operation fails
     * @since Common 10-6
     */
    ...
    /**
     * The method is used to show / hide 'Add Existing'/'Remove' actions links in Engineering Change Affected Items summary page. The links will be enabled till all states upto 'Validate' state
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id
    ...
    /**
     * The method is used to show / hide 'Add Existing'/'Remove' actions links in Engineering Change Implemented Items summary page. The links will be enabled till all states upto 'Implement' state
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id
    ...
    /**
     * This trigger method notifies the Assignee about the EC assignment when a new relationship "Assigned EC" is created between EC and Person object. The notification is sent only if EC is not in
     * Submit state.
     * @param context
     *            The ematrix context of the request
     * @param args
     *            The string array containing following elements: 0 - The object id of Person 1 - The object id of the context EC
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    public void notifyAssignee(Context context, String[] args) throws Exception, FrameworkException {
        ...
        DomainObject domEC = DomainObject.newInstance(context, strECId);
        ...
        Map mapPersonInfo = domPerson.getInfo(context, (StringList) lstObjectSelects);

        // Form the reciepient list to send the message
        List lstAssigneeList = new StringList((String) mapPersonInfo.get(DomainConstants.SELECT_NAME));
        ...
        emxMailUtil_mxJPO.sendNotification(context, strECId, (StringList) lstAssigneeList, null, null, strSubjectKey, subjectKeys, subjectValues, strMessageKey, messageKeys, messageValues,
                (StringList) lstAttachments, null, RESOURCE_BUNDLE_COMPONENTS_STR);
    }

    /*
     * This trigger method sends the notiifcation to the object owners when the new Implemented Item, Affetcted Item or Reported Against Item is added to the Engineeering Change object. The type of
     * the relationship is passed as an argument to this method depending upon which the notification is sent.
     * 
     * @param context The ematrix context of the request.
     * 
     * @param args This string array contains following arguments: 0 - The object id of Engineering Change object. 1 - The object id of Implemented Item, Reported Against Item or Affected Item 2 - The
     * relariohsip name(Reported Against EC or EC Affetcted Item or EC Implemented Item)
     * 
     * @throws Exception
     * 
     * @throws FrameworkException
     ...
     * @since AEF10.6
     */
    public void notifyItemOwners(Context context, String[] args) throws Exception, FrameworkException {
        ...
        BusinessObjectWithSelectList selectedobjectList = DomainObject.getSelectBusinessObjectData(context, objectIds, (StringList) lstObjectSelects);

        String strItemOwner = (selectedobjectList.getElement(1)).getSelectData(DomainConstants.SELECT_OWNER);
        String strECOwner = (selectedobjectList.getElement(0)).getSelectData(DomainConstants.SELECT_OWNER);
        ...
        if (!strItemOwner.equals(strECOwner)) {
            ...
            String strECType = (selectedobjectList.getElement(0)).getSelectData(DomainConstants.SELECT_TYPE);
            String strECName = (selectedobjectList.getElement(0)).getSelectData(DomainConstants.SELECT_NAME);
            String strECRevision = (selectedobjectList.getElement(0)).getSelectData(DomainConstants.SELECT_REVISION);

            String strItemType = (selectedobjectList.getElement(1)).getSelectData(DomainConstants.SELECT_TYPE);
            String strItemName = (selectedobjectList.getElement(1)).getSelectData(DomainConstants.SELECT_NAME);
            String strItemRevision = (selectedobjectList.getElement(1)).getSelectData(DomainConstants.SELECT_REVISION);
            ...
            if (strRelName.equals(DomainConstants.RELATIONSHIP_EC_AFFECTED_ITEM)) {
                strSubjectKey = i18nNow.getI18nString("emxComponents.Message.Subject.EngineeringChangeAffectedItem", RESOURCE_BUNDLE_COMPONENTS_STR, strLanguage);
                ...
                strMessageKey = MessageUtil.getMessage(context, null, "emxComponents.Message.Description.EngineeringChangeAffectedItem", formatArgs, null, context.getLocale(),
                        RESOURCE_BUNDLE_COMPONENTS_STR);
            } else if (strRelName.equals(DomainConstants.RELATIONSHIP_EC_IMPLEMENTED_ITEM)) {
                strSubjectKey = i18nNow.getI18nString("emxComponents.Message.Subject.EngineeringChangeImplementedItem", RESOURCE_BUNDLE_COMPONENTS_STR, strLanguage);
                formatArgs[0] = strItemType;
                formatArgs[1] = strItemName;
                formatArgs[2] = strItemRevision;
                formatArgs[3] = strECType;
                formatArgs[4] = strECName;
                formatArgs[5] = strECRevision;
                strMessageKey = MessageUtil.getMessage(context, null, "emxComponents.Message.Description.EngineeringChangeImplementedItem", formatArgs, null, context.getLocale(),
                        RESOURCE_BUNDLE_COMPONENTS_STR);
            } else if (strRelName.equals(DomainConstants.RELATIONSHIP_REPORTED_AGAINST_EC)) {
                strSubjectKey = i18nNow.getI18nString("emxComponents.Message.Subject.EngineeringChangeReportedAgainstItem", RESOURCE_BUNDLE_COMPONENTS_STR, strLanguage);
                ...
                strMessageKey = MessageUtil.getMessage(context, null, "emxComponents.Message.Description.EngineeringChangeReportedAgainstItem", formatArgs, null, context.getLocale(),
                        RESOURCE_BUNDLE_COMPONENTS_STR);
            }
            String[] subjectKeys = {};
            String[] subjectValues = {};
            ...
            emxMailUtil_mxJPO.sendNotification(context, (StringList) lstOwnerList, null, null, strSubjectKey, subjectKeys, subjectValues, strMessageKey, messageKeys, messageValues,
    ...
    /**
     * This trigger method notifies all the distribution list members connected to EC by "EC Distribution List" relationship when the EC is promoted to the Complete state.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            The string array containing following arguments: 0 - The objectId of the context EC
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    public void notifyDistributionList(Context context, String args[]) throws Exception, FrameworkException {
        // Get the object id of the context Engineering Change object and form
        // the domain object
        String strObjectId = args[0];
        DomainObject domEC = DomainObject.newInstance(context, strObjectId);
        ...
        List lstMemberList = domEC.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EC_DISTRIBUTION_LIST, DomainConstants.QUERY_WILDCARD, (StringList) lstObjectSelects, null, false, true,
                (short) 1, null, null);
        ...
        if (lstMemberList != null && lstMemberList.size() > 0) {
            ...
            Object listMembers = (Object) ((Map) lstMemberList.get(0)).get(sbSelectMember.toString());
            ...
            if (lstListMembers != null && lstListMembers.size() > 0) {
                String strLanguage = context.getSession().getLanguage();
                String strSubjectKey = i18nNow.getI18nString("emxComponents.Message.Subject.EngineeringChangeCompleted", RESOURCE_BUNDLE_COMPONENTS_STR, strLanguage);
                String strMessageKey = i18nNow.getI18nString("emxComponents.Message.Description.EngineeringChangeCompleted", RESOURCE_BUNDLE_COMPONENTS_STR, strLanguage);
                strMessageKey = MessageUtil.substituteValues(context, strMessageKey, strObjectId, strLanguage);
                ...
                emxMailUtil_mxJPO.sendNotification(context, (StringList) lstListMembers, null, null, strSubjectKey, subjectKeys, subjectValues, strMessageKey, messageKeys, messageValues,
                        (StringList) lstAttachments, null);
    ...
    /**
     * This trigger method notifies the owner of the Engineering Change when EC is promoted from Validate State if the promotion is not done by the owner himself.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            The string array containing following arguments 0 - Object Id of the context EC 1 - Owner of the EC
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    public void notifyOwneronValidate(Context context, String[] args) throws Exception, FrameworkException {
        ...
        if (!strContextUser.equals(strECOwner)) {
            String strLanguage = context.getSession().getLanguage();
            String strSubjectKey = i18nNow.getI18nString("emxComponents.Message.Subject.EngineeringChangeFormallyApproved", RESOURCE_BUNDLE_COMPONENTS_STR, strLanguage);
            String strMessageKey = i18nNow.getI18nString("emxComponents.Message.Description.EngineeringChangeFormallyApproved", RESOURCE_BUNDLE_COMPONENTS_STR, strLanguage);
            strMessageKey = MessageUtil.substituteValues(context, strMessageKey, strObjectId, strLanguage);
            ...
            emxMailUtil_mxJPO.sendNotification(context, (StringList) lstOwnerList, null, null, strSubjectKey, subjectKeys, subjectValues, sbMessage.toString(), messageKeys, messageValues,
                    (StringList) lstAttachments, null);
    ...
    /**
     * This trigger method notifies all the assignees connected to the Engineering Change object by Assigned EC relationship when EC is promoted to Approved state. If the promotion is not done by the
     * owner himself then the notification will be sent to owner also.
     * @param context
     *            The ematrix context of the request
     * @param args
     *            string array which contains follwing elements: 0 - The object id of the context EC 2 - The owner of the context EC
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    public void notifyOnApproval(Context context, String[] args) throws Exception, FrameworkException {
        // Get the Object Id and owner of the context Engineering Change object.
        String strObjectId = args[0];
        ...
        // EC" relationship
        List lstAssigneeList = getAssignees(context, strObjectId);
        ...
        // Form the subject and the message body
        String strLanguage = context.getSession().getLanguage();
        String strSubjectKey = i18nNow.getI18nString("emxComponents.Message.Subject.EngineeringChangeApprovedForImplemetation", RESOURCE_BUNDLE_COMPONENTS_STR, strLanguage);
        String strMessageKey = i18nNow.getI18nString("emxComponents.Message.Description.EngineeringChangeApprovedForImplemetation", RESOURCE_BUNDLE_COMPONENTS_STR, strLanguage);
        strMessageKey = MessageUtil.substituteValues(context, strMessageKey, strObjectId, strLanguage);
        String[] subjectKeys = {};
        String[] subjectValues = {};
        String[] messageKeys = {};
        ...
        emxMailUtil_mxJPO.unsetTreeMenuName(context, new String[1]);
        // End of Add for Bug#300683_Reopened by Infosys

        // Send the notification to all the Assignees

        emxMailUtil_mxJPO.sendNotification(context, (StringList) lstAssigneeList, null, null, strSubjectKey, subjectKeys, subjectValues, strMessageKey, messageKeys, messageValues,
                (StringList) lstAttachments, null);

    }

    /**
     * This trigger method notifies the EC owner when EC is promoted to the Complete state.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            The string array containing the following arguments 0 - The object id of the context Engineering Change Object 1 - The owner of the context Engineering Change Object
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    public void notifyOnComplete(Context context, String[] args) throws Exception, FrameworkException {
        // Get the Object Id and owner of the context Engineering Change object.
        String strObjectId = args[0];
        String strOwner = args[1];
        ...
        String strLanguage = context.getSession().getLanguage();
        Locale strLocale = context.getLocale();
        String strSubjectKey = EnoviaResourceBundle.getProperty(context, RESOURCE_BUNDLE_COMPONENTS_STR, strLocale, "emxComponents.Message.Subject.EngineeringChangeCompleted");
        String strMessageKey = EnoviaResourceBundle.getProperty(context, RESOURCE_BUNDLE_COMPONENTS_STR, strLocale, "emxComponents.Message.Description.EngineeringChangeCompleted");
        strMessageKey = MessageUtil.substituteValues(context, strMessageKey, strObjectId, strLanguage);
    ...
    /**
     * This method returns names of all the assignees(Person Objects) connected to the Engineering Change object by "Assigned EC" relationship.
     * @param context
     *            The ematrix context of the request
     * @param strECId
     *            The object id of Engineering Change
     * @return List containig names of all assignees.
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    protected List getAssignees(Context context, String strECId) throws Exception, FrameworkException {
        ...
        // relationship
        List lstObjectSelects = new StringList(DomainConstants.SELECT_NAME);
        List lstAssigneeMapList = (MapList) domEC.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ASSIGNED_EC, DomainConstants.TYPE_PERSON, (StringList) lstObjectSelects, null, true, false,
                (short) 1, null, null);

        // Form the stringlist of all the assignee names
        List lstAssigneeList = new StringList();
        for (int i = 0; i < lstAssigneeMapList.size(); i++) {
            lstAssigneeList.add((String) ((Map) lstAssigneeMapList.get(i)).get(DomainConstants.SELECT_NAME));
        }
    ...
    /**
     * This trigger method creates a Reviewer or Approval Route when EC is promoted to Review/Formal Approval state using the Route Tempalate Connected to Engineering Change object by "Object Route"
     * relationship. If no "Route Template" is connected then default Reviewer or Approval Route is created with no tasks.
     * @param context
     *            The ematrix context of the request
     * @param args
     *            String Array with following arguments: 0 - The Object Id of the context Engineering Change Object. 1 - The next state of the route ontext Engineering Change Object. 2 - The "Route
     *            Base Purpose"(Approve/Review)
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    public void createRoute(Context context, String[] args) throws Exception, FrameworkException {
        ...
        String strRouteTemplateId = getRouteTemplateId(context, strObjectId, strRouteBasePurpose);
        ...
        String strAttrRouteCompletionAction = PropertyUtil.getSchemaProperty(context, "attribute_RouteCompletionAction");
        ...
        // Modified for bug#302310,302308 by Infosys on 21 Apr 05
        mpRouteAttributeMap.put(strAttrRouteCompletionAction, RANGE_PROMOTE_CONNECTED_OBJECT);
        ...
        if (strRouteTemplateId != null && !strRouteTemplateId.equalsIgnoreCase("null") && !strRouteTemplateId.equalsIgnoreCase(DomainConstants.EMPTY_STRING)) {
            routeBean.connectTemplate(context, strRouteTemplateId);
            routeBean.addMembersFromTemplate(context, strRouteTemplateId);
        }
    }

    /**
     * This method returns the object Id of the route template connected to the context Engineeing Change object for which Route Base Purpose is strBasePurpose. The base purpose for the Route Template
     * is decided by retrieiving the attribute "Route Base Purpose" of the relationship "Object Route" between Engineering Change and Route Template.
     * @param context
     *            The ematrix context of the request
     * @param strObjectId
     *            The Object Id of the context Engineering Change object.
     * @param strBasePurpose
     *            The "Route Base Purpose"
     * @return String Object Id of the Route Template mathching the criterion otherwise empty string.
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    protected String getRouteTemplateId(Context context, String strObjectId, String strBasePurpose) throws Exception, FrameworkException {
        ...
        List lstRouteTemplateList = (MapList) domEC.getRelatedObjects(context, DomainConstants.RELATIONSHIP_OBJECT_ROUTE, DomainConstants.TYPE_ROUTE_TEMPLATE, (StringList) lstObjectSelects, null,
                false, true, (short) 1, null, sbWhereExpression.toString());
    ...
    /**
     * When the EC is promoted to "Implemented" State this trigger method automatically revise the "Affected Items" connected to EC by "EC Affected Item" relationship and connect it to EC by "EC
     * Implemented Item" relationship if following two conditions are met: 1.The value of attribute "Requested Change" on the relationship EC Affected Item is "For Revise". 2.The affected item is
     * revisionable and next revision does not exist.
     * @param context
     *            The ematrix context of the request
     * @param args
     *            String Array with following arguments: 0 - The Object Id of the context Engineering Change Object.
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    public void autoReviseAffectedItems(Context context, String[] args) throws Exception, FrameworkException {
        ...
        MapList lstAffectedItemsList = (MapList) domEC.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EC_AFFECTED_ITEM, DomainConstants.QUERY_WILDCARD, (StringList) lstObjectSelects, null,
                false, true, (short) 1, null, sbRelWhereExpression.toString());
        ...
        if (lstAffectedItemsList != null && lstAffectedItemsList.size() > 0) {
            ...
            try {
                ...
                for (int i = 0; i < lstAffectedItemsList.size(); i++) {
                    strAffectedItemId = (String) ((Map) lstAffectedItemsList.get(i)).get(DomainConstants.SELECT_ID);
                    // Begin of Add by Infosys for EC Lifecycle Bug on 18-Mar-05
                    strAffectedItemType = (String) ((Map) lstAffectedItemsList.get(i)).get(DomainConstants.SELECT_TYPE);
                    strAffectedItemName = (String) ((Map) lstAffectedItemsList.get(i)).get(DomainConstants.SELECT_NAME);
                    strAffectedItemRev = (String) ((Map) lstAffectedItemsList.get(i)).get(DomainConstants.SELECT_REVISION);
                    strAffectedItemOwner = (String) ((Map) lstAffectedItemsList.get(i)).get(DomainConstants.SELECT_OWNER);
                    // Added by Infosys for Bug#300664 on 25 Mar 05
                    strRevisionable = (String) ((Map) lstAffectedItemsList.get(i)).get(sbRevSelect.toString());
                    ...
                    ContextUtil.pushContext(context, strAffectedItemOwner, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
                    // End of Add by Infosys for EC Lifecycle Bug on 18-Mar-05

                    DomainObject domItem = DomainObject.newInstance(context, strAffectedItemId);

                    // Modified by Infosys for Bug#300664 on 25 Mar 05
                    if (isLastRevision(context, domItem) && isMajorPolicy(context, domItem) ? strMajorRevisionable.equalsIgnoreCase(STR_TRUE) : strRevisionable.equalsIgnoreCase(STR_TRUE)) {

                        // If we have a Product or one of its sub-types, we have to do things a bit differently.
                        BusinessObject busNewRevision;
                        boolean isPLCInstalled = FrameworkUtil.isSuiteRegistered(context, "appVersionProductLine", false, null, null);
                        if (isPLCInstalled && domItem.isKindOf(context, PropertyUtil.getSchemaProperty(context, "type_Products"))) {
                            ...
                            String strNewRevisionId = (String) JPO.invoke(context, "emxProduct", null, "createProductRevisionForEC", plcArgs, String.class);
                        ...
                        if (isConfigurationInstall) {
                            ...
                            /*
                             * JPO.invoke(context, "emxFeature", arrPacked, "connectRevisedFeatureToMasterFeature", arrPacked, null);
                             */
                        }
                        // END of code modification for IR-011432

                        lstRevisedItemsList.addElement((String) busNewRevision.getObjectId());
                        ...
                        modifyHistory(context, strObjectId, sbHistoryAction.toString(), " ");
                ...
                if (lstRevisedItemsList != null && lstRevisedItemsList.size() > 0) {
                    String strRelationshipImplementedItem = DomainConstants.RELATIONSHIP_EC_IMPLEMENTED_ITEM;
                    domEC.addRelatedObjects(context, new RelationshipType(strRelationshipImplementedItem), true, (String[]) lstRevisedItemsList.toArray(new String[lstRevisedItemsList.size()]));
                }
    ...
    /**
     * For each item of the Affected Item / Implemented Item set, this will method will be executed to get the immediate parent group Logic for Sorting TOPDOWN (Revise), DOWNUP(Release), NONE(Other)
     * @param context
     * @param lstAffectedItemsList
     *            All the object from Affected Item / Implemente Item of selected EC
     * @param strOperation
     *            Either for Revise, Release or None
     * @return Sorted list
     * @throws MatrixException
     * @since R210
     */
    private List accountForHierarchicalChangeSupport(Context context, List lstAffectedItemsList, String strOperation) throws MatrixException {
        ...
        for (int i = lstAffectedItemsList.size() - 1; i >= 0; i--) {
            ...
            if (!(obj instanceof HierarchicalChangeSupport) || ((HierarchicalChangeSupport) obj).getOrderForOperation(strOperation) == HierarchicalChangeSupport.NONE) // NONE - 2
            {
    ...
    /**
     * This common check trigger method checks if there is incomplete route connected to the EC when the EC is manually promoted by owner from Review or Formal Approval state.
     * @param context
     *            The ematrix context of the request
     * @param args
     *            String Array with following arguments: 0 - The Object Id of the context Engineering Change Object. 1 - The policy of the context EC 2 - The current state of the EC 3 - The owner of
     *            the EC
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    public int checkIncompleteRoute(Context context, String[] args) throws Exception, FrameworkException {
        // Get the Object Id of the context Engineering Change object.
        String strECId = args[0];
        ...
        if (strContextUser.equals(strECOwner)) {
            ...
            String strSybState = FrameworkUtil.reverseLookupStateName(context, strECPolicy, strECState);

            // Get the actual name of the state complete for Route
            String strStateComplete = FrameworkUtil.lookupStateName(context, DomainConstants.POLICY_ROUTE, "state_Complete");
            ...
            List lstIncomleteRouteList = (MapList) domEC.getRelatedObjects(context, DomainConstants.RELATIONSHIP_OBJECT_ROUTE, DomainConstants.TYPE_ROUTE, (StringList) lstObjectSelects, null, false,
                    true, (short) 1, sbObjWhereExp.toString(), sbRelWhereExp.toString());
    ...
    /**
     * This trigger method checks for the connected Test Cases to the context Engineering Change object when the EC is promoted from Validate state. If the "Validation Required" flag attribute of the
     * EC is set to Yes and there is no Test Case connected to EC then promotion is blocked and appropriate alert message is shown to the user.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            The string array contains following arguments: 0 - The object id of the context EC
     * @return integer 1 - If the check trigger fails 0 - If the check trigger succeeds
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    public int checkTestCase(Context context, String[] args) throws Exception, FrameworkException {
        // Get the object id of the context Engineering Change Object
        String strObjectId = args[0];
        ...
        if (isValidationRequiredEC(context, strObjectId)) {
            List lstTestCaseSelects = new StringList(DomainObject.SELECT_ID);
            DomainObject domEC = DomainObject.newInstance(context, strObjectId);
            List lstTestCaseList = (MapList) domEC.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EC_TEST_CASE, DomainConstants.QUERY_WILDCARD, (StringList) lstTestCaseSelects, null, false,
    ...
    /**
     * This method checks the attribute "Percentage Passed" of the recent "Test Execution" connected to the Engineeing Change by "EC Test Execution" relationship when EC is promoted from Validate
     * state and the value of the "Validation Flag" attribute of Engineering Change is set to Yes. If the percentage is less than 100% or if there is no "Test Execution" connected to EC then alert
     * message is shown to the user blocking the execution.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            string array containing followig elements: 0 - The object id of contetx EC.
     * @return integer 1 - If the check trigger fails 0 - If the check trigger succeeds
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    public int checkValidationStatus(Context context, String[] args) throws Exception, FrameworkException {
        ...
        if (isValidationRequiredEC(context, strObjectId)) {
            ...
            sbMqlCommand.append("eval expr");
            sbMqlCommand.append(STR_SPACE);
            sbMqlCommand.append(SYMB_QUOTE);
            sbMqlCommand.append("maximum");
            sbMqlCommand.append(STR_SPACE);
            sbMqlCommand.append("originated");
            sbMqlCommand.append(SYMB_QUOTE);
            sbMqlCommand.append(STR_SPACE);
            sbMqlCommand.append("on temp query bus");
            sbMqlCommand.append(STR_SPACE);
            sbMqlCommand.append(SYMB_QUOTE);
            sbMqlCommand.append(DomainConstants.TYPE_TEST_EXECUTION);
            sbMqlCommand.append(SYMB_QUOTE);
            sbMqlCommand.append(STR_SPACE);
            sbMqlCommand.append(DomainConstants.QUERY_WILDCARD);
            sbMqlCommand.append(STR_SPACE);
            sbMqlCommand.append(DomainConstants.QUERY_WILDCARD);
            sbMqlCommand.append(STR_SPACE);
            sbMqlCommand.append("where");
            sbMqlCommand.append(STR_SPACE);
            sbMqlCommand.append(SYMB_TO);
            sbMqlCommand.append(SYMB_OPEN_BRACKET);
            sbMqlCommand.append(DomainConstants.RELATIONSHIP_EC_TEST_EXECUTION);
            sbMqlCommand.append(SYMB_CLOSE_BRACKET);
            sbMqlCommand.append(SYMB_DOT);
            sbMqlCommand.append(SYMB_FROM);
            sbMqlCommand.append(SYMB_DOT);
            sbMqlCommand.append(DomainConstants.SELECT_ID);
            sbMqlCommand.append("==");
            sbMqlCommand.append(strObjectId);

            String strOriginatedDate = MqlUtil.mqlCommand(context, sbMqlCommand.toString());
            ...
            DomainObject domEC = DomainObject.newInstance(context, strObjectId);
            List lstTestCaseList = (MapList) domEC.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EC_TEST_EXECUTION, DomainConstants.QUERY_WILDCARD, (StringList) lstObjectSelects, null,
                    false, true, (short) 1, sbObjWhereExpression.toString(), null);
            ...
            // latest Test Execution
            if (lstTestCaseList != null && lstTestCaseList.size() > 0) {
                String strPassedPercent = (String) ((Map) lstTestCaseList.get(0)).get(sbAttributeSelect.toString());
                String strTestExecutionId = (String) ((Map) lstTestCaseList.get(0)).get(DomainConstants.SELECT_ID);
                if (Float.parseFloat(strPassedPercent) < 100.0) {
                    ...
                    strAlertMessage = MessageUtil.substituteValues(context, strAlertMessage, strTestExecutionId, strLanguage);
                    emxContextUtil_mxJPO.mqlNotice(context, strAlertMessage);
                    return 1;
                }
            } else {
    ...
    /**
     * This method checks the value of the "Validation Required" attribute of EC and returns true if value is "Yes" otherwise returns false.
     * @param context
     *            The ematrix context of the request.
     * @param strECId
     *            The object id of EC.
     * @return boolean true - if value of the atribute "Validation Required" is Yes otherwise returns false.
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    protected boolean isValidationRequiredEC(Context context, String strECId) throws Exception, FrameworkException {
        ...
        DomainObject domEC = DomainObject.newInstance(context, strECId);
        mpObjectInfo = (Map) domEC.getInfo(context, (StringList) lstObjectSelects);

        String strAttribValue = (String) mpObjectInfo.get(sbAttributeSelect.toString());
        // Modified for bug#302310,302308 by Infosys on 21 Apr 05
    ...
    /**
     * This trigger method promotes all the Implemented Items connected to the EC by EC Implemented Item relationship to the Release state when EC is promoted to the Complete state.If Release state
     * doesn'e exists in the lifecycle of the implemented item then no action is taken.
     * @param context
     *            The ematrix context object.
     * @param args
     *            The string array containing following arguments: 0 - The object id of the context EC.
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */

    public void releaseImplementedItems(Context context, String[] args) throws Exception, FrameworkException {
        ...
        List lstImplementedtemsList = (MapList) domEC.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EC_IMPLEMENTED_ITEM, DomainConstants.QUERY_WILDCARD, (StringList) lstObjectSelects, null,
        ...
        try {
            ...
            if (lstImplementedtemsList != null && lstImplementedtemsList.size() > 0) {
                ...
                for (int i = 0; i < lstImplementedtemsList.size(); i++) {
                    domItem.setId((String) ((Map) lstImplementedtemsList.get(i)).get(DomainObject.SELECT_ID));
                    strStateRelease = FrameworkUtil.lookupStateName(context, domItem.getPolicy(context).getName(), "state_Release");

                    // Begin of Add by Infosys for EC Lifecycle Bug on 18-Mar-05
                    strOwner = (String) ((Map) lstImplementedtemsList.get(i)).get(DomainConstants.SELECT_OWNER);
                    strType = (String) ((Map) lstImplementedtemsList.get(i)).get(DomainConstants.SELECT_TYPE);
                    strName = (String) ((Map) lstImplementedtemsList.get(i)).get(DomainConstants.SELECT_NAME);
                    strRev = (String) ((Map) lstImplementedtemsList.get(i)).get(DomainConstants.SELECT_REVISION);
                    ...
                    if (strStateRelease != null && !strStateRelease.equals(DomainConstants.EMPTY_STRING) && !strStateRelease.equalsIgnoreCase("null")) {
                        while (!strStateRelease.equals(domItem.getInfo(context, DomainConstants.SELECT_CURRENT))) {
    ...
    /**
     * This trigger method promotes the affected items connected to the EC by "EC Affected Item" relationship to Release or Obsolete state depending upon the value of the "Requested Change" attribute
     * on relationship.
     * @param context
     *            The ematrix context of the request
     * @param args
     *            The string array containgin the following areguments: 0 - The object id of the context EC
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    public void promoteAffectedItems(Context context, String[] args) throws Exception, FrameworkException {
        // Get the object id of the context EC
        String strObjectId = args[0];
        ...
        List lstAffectedItemsList = (MapList) domEC.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EC_AFFECTED_ITEM, DomainConstants.QUERY_WILDCARD, (StringList) lstObjectSelects,
                (StringList) lstRelSelects, false, true, (short) 1, null, sbRelWhereExpression.toString());
        try {
            // Set the context to the super user
            ContextUtil.pushContext(context, PropertyUtil.getSchemaProperty(context, "person_UserAgent"), DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
            // Start of write transaction
            ...
            if (lstAffectedItemsList != null && lstAffectedItemsList.size() > 0) {
                ...
                for (int i = 0; i < lstAffectedItemsList.size(); i++) {
                    domItem.setId((String) ((Map) lstAffectedItemsList.get(i)).get(DomainConstants.SELECT_ID));
                    strReqChange = (String) ((Map) lstAffectedItemsList.get(i)).get(sbAttribSelect.toString());

                    // Begin of Add by Infosys for EC Lifecycle Bug on 18-Mar-05
                    strOwner = (String) ((Map) lstAffectedItemsList.get(i)).get(DomainConstants.SELECT_OWNER);
                    strType = (String) ((Map) lstAffectedItemsList.get(i)).get(DomainConstants.SELECT_TYPE);
                    strName = (String) ((Map) lstAffectedItemsList.get(i)).get(DomainConstants.SELECT_NAME);
                    strRev = (String) ((Map) lstAffectedItemsList.get(i)).get(DomainConstants.SELECT_REVISION);
                    ...
                    if (strReqChange.equals(RANGE_FOR_RELEASE)) {
                        strState = FrameworkUtil.lookupStateName(context, domItem.getPolicy(context).getName(), "state_Release");
                        if (strState != null && !strState.equals(DomainConstants.EMPTY_STRING) && !strState.equalsIgnoreCase("null")) {
                            while (!strState.equals(domItem.getInfo(context, DomainConstants.SELECT_CURRENT))) {
                                domItem.promote(context);
                            }
                        ...
                        strState = FrameworkUtil.lookupStateName(context, domItem.getPolicy(context).getName(), "state_Obsolete");
                        if (strState != null && !strState.equals(DomainConstants.EMPTY_STRING) && !strState.equalsIgnoreCase("null")) {
                            while (!strState.equals(domItem.getInfo(context, DomainConstants.SELECT_CURRENT))) {
                                domItem.promote(context);
                            }
    ...
    /**
     * Get the list of all Objects which are connected to the context Engineering Change object as Affected Items
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
    ...
    public MapList getAllAffectedItems(Context context, String[] args) throws Exception {
        ...
        relBusObjPageList = getRelatedObjects(context, strRelAffectedItems, DomainConstants.QUERY_WILDCARD, objectSelects, relSelects, false, true, recurseToLevel, DomainConstants.EMPTY_STRING,
                DomainConstants.EMPTY_STRING);
    ...
    /**
     * Get the list of all Objects which are connected to the context Engineering Change object as Implemented Items
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
    ...
    public MapList getAllImplementedItems(Context context, String[] args) throws Exception {
        ...
        this.setId(strParentId);
        relBusObjPageList = getRelatedObjects(context, strRelECImplementedItem, DomainConstants.QUERY_WILDCARD, objectSelects, relSelects, false, true, recurseToLevel, DomainConstants.EMPTY_STRING,
                DomainConstants.EMPTY_STRING);
    ...
    /**
     * Get the list of all Objects connected to the context Engineering Change object as Satisfied Items using 'Resolved To' relationship
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
    ...
    public MapList getAllSatisfiedItems(Context context, String[] args) throws Exception {
        ...
        // retrieving ImplementedItems List from EC Context
        this.setId(strParentId);
        relBusObjPageList = getRelatedObjects(context, strRelResolvedTo, DomainConstants.QUERY_WILDCARD, objectSelects, relSelects, true, false, recurseToLevel, DomainConstants.EMPTY_STRING,
                DomainConstants.EMPTY_STRING);
        return relBusObjPageList;
    }
    ...
    public Vector getCompleteName(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < iNoOfObjects; i++) {
            ...
            if (strReportFormat != null && strReportFormat.equals("null") == false && strReportFormat.equals("") == false) {
                ...
                strFullName = "<img src = \"images/iconSmallPerson.gif\"></img><b><A HREF=\"JavaScript:emxTableColumnLinkClick('emxTree.jsp?mode=insert&amp;name="
                        + XSSUtil.encodeForJavaScript(context, strLastName) + XSSUtil.encodeForJavaScript(context, strFirstName) + "&amp;treeMenu=type_Person&amp;emxSuiteDirectory="// Modified By
                                                                                                                                                                                     // Infosys for Bug
                                                                                                                                                                                     // # 304580 Date
                                                                                                                                                                                     // 05/18/2005
                        /* End of modify : by Infosys for Bug#301835 on 4/13/2005 */
                        + strSuiteDir + "&amp;relId=" + strRelId + "&amp;parentOID=" + strParentObjectId + "&amp;jsTreeID=" + strJsTreeID + "&amp;objectId=" + strObjId
                        + "', 'null', 'null', 'false', 'content')\" class=\"object\">" + strLastName + ", " + strFirstName + "</A></b>";
            }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments objectList - MapList containn the list of busines objetcs paramList - HasMap containg the argument reportFormat
    ...
    /**
     * Gets all the persons with which this Engineering Change object is connected with Assigned EC relationship
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
    ...
    public MapList getEngineeringChangeAssignees(Context context, String[] args) throws Exception {
        ...
        this.setId(strParentId);
        relBusObjPageList = getRelatedObjects(context, strRelAssignedEC, DomainConstants.QUERY_WILDCARD, objectSelects, relSelects, true, false, recurseToLevel, DomainConstants.EMPTY_STRING,
                DomainConstants.EMPTY_STRING);
        return relBusObjPageList;
    }
    ...
    public MapList getEngineeringChangeImpactAnalysis(Context context, String[] args) throws Exception {
        ...
        this.setId(strParentId);
        relBusObjPageList = getRelatedObjects(context, strRelImpactAnalysis, strImpactType, objectSelects, relSelects, false, true, recurseToLevel, DomainConstants.EMPTY_STRING,
                DomainConstants.EMPTY_STRING);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit TypeImpactAnalysis Name State OwnerDiaplay Description Vault Option Vaults
     ...
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
     * @return a <code>MapList</code> object having the list of Engineering Change objects connected through EC Affected Items relationship
     * @throws Exception
     *             if the operation fails
     * @since Common 10-6
     */
     ...
     *            contains a Map with the following input arguments or entries: queryLimit limit for displaying search query results hdnType the admin 'type'of the object to search for txtName the
     *            'name' or 'name pattern' to search for txtRevision the 'revision' pattern to search for txtDescription the 'description' pattern to search for txtOwner the 'owner' pattern to search
     *            for txtState. the object 'state' pattern to search for txtCategoryOfChange the object 'CategoryOfChange' pattern to search for txtSeverity the object 'Severity' pattern to search for
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static MapList getEngineeringChangeSearchResults(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (strCategoryOfChange == null || strCategoryOfChange.equals("") || "null".equalsIgnoreCase(strCategoryOfChange)) {
            ...
            if (strSeverity == null || strSeverity.equals("") || "null".equalsIgnoreCase(strSeverity)) {
            ...
            if (strState != null && (!strState.equals(DomainConstants.QUERY_WILDCARD)) && (!strState.equals("")) && !("null".equalsIgnoreCase(strState))) {
                if (bStart) {
                    sbWhereExp.append(SYMB_OPEN_PARAN);
                    bStart = false;
                } else {
            ...
            if (strSeverity != null && (!strSeverity.equals(SYMB_WILD)) && (!strSeverity.equals("")) && !("null".equalsIgnoreCase(strSeverity))) {
                if (bStart) {
                    sbWhereExp.append(SYMB_OPEN_PARAN);
                    bStart = false;
                } else {
            ...
            if (strCategoryOfChange != null && (!strCategoryOfChange.equals(SYMB_WILD)) && (!strCategoryOfChange.equals("")) && !("null".equalsIgnoreCase(strCategoryOfChange))) {
                if (bStart) {
                    sbWhereExp.append(SYMB_OPEN_PARAN);
                    bStart = false;
                } else {
    ...
    /**
     * The method is used to show / hide 'Create New'/'Add Existing'/'Remove'/'Delete' actions links in Engineering Change ImpactAnalysis summary page. The links will be enabled in states upto
     * 'Review' state
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments queryLimit limit for displaying search query results User Name the user name or name pattern of the Person search for First Name
     *            the first name or name pattern of the Person search for Last Name the last name or name pattern of the Person search for Company the company name or name pattern of the Person search
     *            for Vault Option the vault search option Vault Display the vault display search option
    ...
    /**
     * This method notifies owner and all the distribution list members connected to EC by "EC Distribution List" relationship when the EC is promoted to the Closed Or Rejected.
     * @param context
     *            The ematrix context of the request.
     * @param strObjectId
     *            The string containing object id of Engineering Change Object:
     * @param strState
     *            The string containing promoted state of Engineering Change Object:
     * @throws Exception
     * @throws FrameworkException
     * @since AEF10.6
     */
    public void notifyEngineeringChangePromote(Context context, String strObjectId, String strState) throws Exception, FrameworkException {
        ...
        String strLanguage = context.getSession().getLanguage();
        String strSubjectKey = i18nNow.getI18nString("emxComponents.Message.Subject.EngineeringChange" + strState, RESOURCE_BUNDLE_COMPONENTS_STR, strLanguage);
        String strMessageKey = i18nNow.getI18nString("emxComponents.Message.Description.EngineeringChange" + strState, RESOURCE_BUNDLE_COMPONENTS_STR, strLanguage);
    ...
    public List getHigherRevisionIcon(Context context, String[] args) throws Exception {
        ...
        String strTooltipHigherRevExists = EnoviaResourceBundle.getProperty(context, RESOURCE_BUNDLE_COMPONENTS_STR, context.getLocale(), ICON_TOOLTIP_HIGHER_REVISION_EXISTS);
        ...
        for (iCount = 0; iCount < iNumOfObjects; iCount++) {
            ...
            if (!isLastRevision(context, domObj)) {
                strHigherRevisionIconTag = "<a HREF=\"#\" TITLE=\"" + " " + strTooltipHigherRevExists + "\">" + HIGHER_REVISION_ICON + "</a>";
            } else {
     ...
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the parameters passed from the calling method objectList - Maplist containing Object id Relationship id Maps
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a Map with the following input arguments : mode the mode in which a field need to be displayed objectId context Engineering Change objectId
     * @throws Exception
     *             if the operations fails
     * @return String which contains the HTML code for displaying field
     * @since Common 10-6
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a Map with the following input arguments: objectId objectId of the context Engineering Change New Value new owner id selected
     * @throws Exception
     *             if the operations fails
     * @since Common 10-6
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a Map with the following input arguments : objectId context object Id
     * @throws Exception
     *             if the operations fails
    ...
    /**
     * The method is used to show / hide 'Add Existing'/'Remove' actions links in Engineering Change Assignees summary page. The links will be enabled till all states prior to 'Formal Approval' state
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id
    ...
    public Boolean showAddRemoveAssigneesLink(Context context, String[] args) throws Exception {
        return (showActionsLink(context, args, EC_STATE_VALIDATE));
    }
     ...
     * @param args
     *            - Object Id of Issue
     * @return int - Returns int status code 0 - in case the trigger is successfull
     * @throws Exception
     *             if the operation fails
     * @since Common 10-6
     */
    public int notifyOwner(Context context, String[] args) throws Exception {
        try {
            ...
            toList.add(strOwner);
            lstAttachments.add(strObjectId);
            String strSubject = EnoviaResourceBundle.getProperty(context, RESOURCE_BUNDLE_COMPONENTS_STR, strLocale, "emxComponents.Message.Subject.EngineeringChangeChangeOwner");
            String strMessage = EnoviaResourceBundle.getProperty(context, RESOURCE_BUNDLE_COMPONENTS_STR, strLocale, "emxComponents.Message.Body.EngineeringChangeChangeOwner");
            ...
            if (strOwner.equals(strOriginator)) {
                ...
                strMessage = MessageUtil.substituteValues(context, strMessage, strObjectId, strLanguage);
            }

            // Sending mail to the owner
            emxMailUtil_mxJPO.sendNotification(context, toList, null, null, strSubject, subjectKeys, subjectValues, strMessage, messageKeys, messageValues, lstAttachments, null);
        } catch (Exception ex) {
            ex.printStackTrace(System.out);
            throw new FrameworkException((String) ex.getMessage());
        }
    ...
    public List getActiveECIcon(Context context, String[] args) throws Exception {
        ...
        // Reading the tooltip from property file.
        String strTooltipActiveECIcon = EnoviaResourceBundle.getProperty(context, RESOURCE_BUNDLE_COMPONENTS_STR, context.getLocale(), ICON_TOOLTIP_ACTIVE_EC_EXISTS);
        ...
        for (iCount = 0; iCount < iNumOfObjects; iCount++) {
            ...
            if (strStateList != null && strStateList.size() > 0) {
                ...
                while (stListItr.hasNext()) {
                    ...
                    if (strTmpState == null || strTmpState.equals("") || "null".equals(strTmpState) || "#DENIED!".equals(strTmpState) || strTmpState.equals(strClose) || strTmpState.equals(strReject)
                            || strTmpState.equals(strComplete)) {
                        activeEC = false;
                    } else {
                        activeEC = true;
                        break;
            ...
            if (activeEC) {
                ...
                if (reportFormat != null && !("null".equalsIgnoreCase(reportFormat)) && reportFormat.length() > 0) {
                    ...
                    strActiveECIconTag = "<img src=\"../common/images/" + strIcon + "\" border=\"0\"  align=\"middle\" " + "TITLE=\"" + " " + strTooltipActiveECIcon + "\"" + "/>";
                }
            } else {
                strActiveECIconTag = " ";
            }
    ...
    public String getActiveECIconProperty(Context context, String[] args) throws Exception {
        ...
        MapList relIdList = domObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EC_AFFECTED_ITEM, DomainConstants.TYPE_ENGINEERING_CHANGE, busSelects, relSelects, true, false, (short) 1,
                objWhere.toString(), DomainConstants.EMPTY_STRING);

        // Reading the tooltip from property file.
        String strTooltipActiveECIcon = EnoviaResourceBundle.getProperty(context, RESOURCE_BUNDLE_COMPONENTS_STR, context.getLocale(), ICON_TOOLTIP_ACTIVE_EC_EXISTS);
        String strNo = EnoviaResourceBundle.getProperty(context, RESOURCE_BUNDLE_COMPONENTS_STR, context.getLocale(), "emxComponents.Common.No");
        String strYes = EnoviaResourceBundle.getProperty(context, RESOURCE_BUNDLE_COMPONENTS_STR, context.getLocale(), "emxComponents.Common.Yes");
    ...
    /**
     * This method is used to check whether the context user is owner or Assignee of some Engineering Change object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            [] - String Array.
     * @return String - 0 - If the context user is owner or assignee of some EC 1- Otherwise.
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.6
     */
    public String hasAccess(Context context, String args[]) throws Exception {
        ...
        StringBuffer sbOwnerQuery = new StringBuffer();
        sbOwnerQuery.append("eval expr \"count TRUE\" on temp query bus");
        sbOwnerQuery.append(" \"");
        sbOwnerQuery.append(DomainConstants.TYPE_ENGINEERING_CHANGE);
        sbOwnerQuery.append("\" ");
        sbOwnerQuery.append(DomainConstants.QUERY_WILDCARD);
        sbOwnerQuery.append(" ");
        sbOwnerQuery.append(DomainConstants.QUERY_WILDCARD);
        sbOwnerQuery.append(" ");
        sbOwnerQuery.append("where");
        sbOwnerQuery.append(" '");
        sbOwnerQuery.append("owner==\"");
        sbOwnerQuery.append(strContextUser);
        sbOwnerQuery.append("\"||to[");
        sbOwnerQuery.append(DomainConstants.RELATIONSHIP_ASSIGNED_EC);
        sbOwnerQuery.append("].from.name==\"");
        sbOwnerQuery.append(strContextUser);
        sbOwnerQuery.append("\"'");

        // If the number of owned EC by this user is greater than 0 then return 0
        String strECNumber = MqlUtil.mqlCommand(context, sbOwnerQuery.toString());
        if (Integer.parseInt(strECNumber) > 0) {
            return "0";
        } else {
            return "1";
        }
    ...
    protected void modifyHistory(Context context, String strObjectId, String strAction, String strComment) throws Exception {
        ...
        sbMqlCommand.append(strComment);
        sbMqlCommand.append("\"");

        String strResult = MqlUtil.mqlCommand(context, sbMqlCommand.toString(), true);
    }
     ...
     * @since AEF 10.6
     */
    public static String getDefaultVaults(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            if (!PersonUtil.SEARCH_DEFAULT_VAULT.equals(vaultDefaultSelection) && !PersonUtil.SEARCH_LOCAL_VAULTS.equals(vaultDefaultSelection)
            ...
            radioOption.append(
                    "<input type=\"button\" name=\"VaultChooseButton\" value=\"...\" onclick=\"document.forms[0].vaultOption[2].checked=true;javascript:getTopWindow().showChooser('../common/emxVaultChooser.jsp?fieldNameActual=vaults&fieldNameDisplay=vaultsDisplay&multiSelect=true&isFromSearchForm=true')\">");
    ...
    public String getCompanyOrganizationChooserHTML(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            strTypeChooser.append("<img src=\"images/iconSmallCompany.gif\" border=\"0\" alt=\"Company\"></img><b>" + XSSUtil.encodeForHTML(context, strCompany));
            strTypeChooser.append("<input type=\"hidden\" name=\"Type\" value=\"" + XSSUtil.encodeForHTMLAttribute(context, strCompanyHiddenField) + "\">");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the Hashmap containing following arguments queryLimit Type Name
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static MapList getCompanies(Context context, String[] args) throws Exception {
        MapList mapList = null;
        try {
            ...
            String strAttribOrgName = PropertyUtil.getSchemaProperty(context, Issue.SYMBOLIC_attribute_OrganizationName);

            if (strName != null && (!strName.equals(SYMB_WILD)) && (!strName.equals("")) && !("null".equalsIgnoreCase(strName))) {
                sbWhereExp.append(SYMB_OPEN_PARAN);
                sbWhereExp.append(SYMB_ATTRIBUTE);
                sbWhereExp.append(SYMB_OPEN_BRACKET);
            ...
            mapList = DomainObject.findObjects(context, strType, strName, SYMB_WILD, SYMB_WILD, strVault, sbWhereExp.toString(), "", true, slSelect, sQueryLimit);
        } catch (Exception excp) {
            excp.printStackTrace(System.out);
            throw excp;
        }
    ...
    public static MapList getContextPersons(Context context, String[] args, boolean bECAssign) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        short sQueryLimit = (short) (java.lang.Integer.parseInt((String) programMap.get("queryLimit")));
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static MapList getAffectedItemsGeneralSearchResults(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (bInactiveECAndIssue) {
                ...
                if (strObjectId != null) {
                    ...
                    if (busid != null && busid.length() > 0) {
                        sbWhereExp.append(" && ");
                        sbWhereExp.append("(((to[" + DomainConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "] == True ) && (to[" + DomainConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "].from.id == "
                                + busid + " )) || (to[" + DomainConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "] == False))");
                    }
                }
    ...
    public StringList getDelegateAssigneesExcludePersonList(Context context, String args[]) throws Exception {
        ...
        MapList allPersonMapList = doComp.getRelatedObjects(context, // context
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following input arguments or entries:
    ...
    public StringList excludeConnectedEC(Context context, String args[]) throws Exception {
        ...
        MapList mapConnectedEC = domObject.getRelatedObjects(context, relPattern, typePattern, objSelect, null, true, false, (short) 1, null, null);
    ...
    public StringList includeAssigneeOIDs(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                String cmd = "print role '" + strTempRole + "' select person.object.id dump ,";
                String strRolePersonIds = MqlUtil.mqlCommand(context, cmd);
            ...
            if (FrameworkUtil.isSuiteRegistered(context, "appVersionEngineeringSMB", false, null, null) && context.getRole() != null && !"".equals(context.getRole())) {
     ...
     * @since R214
     */
    protected boolean isLastRevision(Context context, DomainObject object) throws FrameworkException {
     ...
     *            Matrix context
     * @param object
     *            policy of which to check against
