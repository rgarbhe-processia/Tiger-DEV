...
public class IEFDataGenerator_mxJPO {
    ...
    /**
     * Genereates the details of the Menu being accessed Returns a maplist which has the details of the menu or command
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param lang
     *            the language used by the client machine
     * @param menuName
     *            the name of the menu being accessed
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.5
     */
     ...
     * @param lang
     *            the language used by the client machine
     * @param symbolicCommandName
     *            the name of the command being accessed
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.5
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param command
     *            the result of "print command abc"
    ...
    /**
     * Parse name and value from the given string. ex. car value volkswagen
     * @param the
     *            strings containg the name and value
        ...
        try {
            ...
            if (menuMapList != null) {
                ...
                while (menuItr.hasNext()) {
                    ...
                    if ((componentLabel != null) && (componentLabel.endsWith(".Specification") || componentLabel.endsWith(".ReferenceDocument") || componentLabel.endsWith(".ReferenceDocuments")
                            || componentLabel.endsWith(".ClassifiedItems"))) {
                        Map HRefParams = getHRefParams(context, null, componentHRef);
     ...
     * @param quotedString
     *            the string containing the quotes
    ...
    protected String unquote(String quotedString) {
        ...
        if (quotedString != null) {
            ...
            if (strLength > 2 && (quotedString.startsWith("\"") || quotedString.startsWith("\'")) && (quotedString.endsWith("\"") || quotedString.endsWith("\'"))) {
