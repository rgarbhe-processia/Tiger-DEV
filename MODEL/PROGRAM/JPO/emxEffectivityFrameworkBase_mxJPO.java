...
/**
 * @author dmcelhinney The <code>emxEffectivityFrameworkBase</code> class/interface contains...
...
public class emxEffectivityFrameworkBase_mxJPO {
     ...
     * @throws Exception
     */
    public emxEffectivityFrameworkBase_mxJPO(Context context, String[] args) throws Exception {
        super();
    }

    /**
     * Updates the effectivity expression for an object. Called as the update method for the Edit form.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a packed hashmap with the following arguments paramMap HashMap of parameter values- objectId, New Value
     * @return Object - boolean true if the operation is successful
     * @throws Exception
     *             if the operation fails
     * @since CFF R209
     */
    public Object updateObjectExpression(Context context, String[] args) throws Exception {
    ...
    /**
     * Updates the effectivity expression for a relationship. Called as the update method from structure browser edit.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a packed hashmap with the following arguments paramMap HashMap of parameter values - objectId requestMap HashMap of request values - type
     * @throws Exception
     *             if the operation fails
     * @since CFF R209
     */
    public String getItemEffectivityDisplay(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        HashMap requestMap = (HashMap) programMap.get("requestMap");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a packed hashmap with the following arguments paramMap HashMap of parameter values - requestMap HashMap of request values - objectId, mode
     * @throws Exception
     *             if the operation fails
     * @since CFF R209
     */
    public String getItemEffectivityEditDisplay(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        HashMap requestMap = (HashMap) programMap.get("requestMap");
    ...
    /**
     * Updates the object Effectivity Types value. Called as the update method for Item Effectivity field on create/edit form
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a packed hashmap with the following arguments paramMap HashMap of parameter values - objectId requestMap HashMap of request values - effTypes
     * @throws Exception
     *             if the operation fails
     * @since CFF R209
     */
    public void updateObjectEffectivityTypes(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        String objectId = (String) paramMap.get("objectId");
     ...
     * @since CFF R209
     */
    public String getEffectivityExpressionDisplay(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        String objectId = (String) requestMap.get("objectId");
        ...
        String editEffectivityURL = "../effectivity/EffectivityDefinitionDialog.jsp?modetype=edit" + strObjectId + strParentId + "&formName=" + formName + "&fieldNameEffExprDisplay=" + fieldName
                + "&fieldNameEffExprActual=EffectivityExpressionOID&fieldNameEffExprActualListAc=EffectivityExpressionOIDListAc&fieldNameEffExprActualList=EffectivityExpressionOIDList&fieldNameEffTypes=effTypes";
     ...
     * @since CFF R209
     */
    public String getEffectivityExpressionCreate(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        String objectId = (String) requestMap.get("objectId");
        ...
        String createEffectivityURL = "../effectivity/EffectivityDefinitionDialog.jsp?modetype=create&amp;invockedFrom=fromForm&amp;formName=" + formName + "&amp;parentOID=" + objectId
                + "&amp;fieldNameEffExprDisplay=" + fieldName
                + "&amp;fieldNameEffExprActual=EffectivityExpressionOID&amp;fieldNameEffTypes=effTypes&amp;fieldNameEffExprActualListAc=EffectivityExpressionOIDListAc&amp;fieldNameEffExprActualList=EffectivityExpressionOIDList";
    ...
    public MapList getModelMilestoneDictionary(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a packed hashmap with the following arguments objectList MapList of object IDs paramList HashMap of parameter values
     * @throws Exception
     *             if the operation fails
     * @since CFF R209
     */
    public Vector getItemEffectivityExpressionColumn(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
     ...
     * @since CFF R209
     */
    public Vector getStructureEffectivityExpressionColumn(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objectList = (MapList) programMap.get("objectList");
        HashMap params = (HashMap) programMap.get("paramList");
    ...
    /**
     * This method is invocked by the RelationshipEffectivityUsageDeleteCheck trigger to allow the deletion of the rel only if it is being deleted programmatically
     * @param context
     *            the eMatrix <code>Context</code> object
     * @return
     * @throws Exception
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments effectivityExpression: the actual effectivity expression from which the context Ids have to be retrieved effectivityType: the currently chosen
     *            effectivity type in the EffectivityDefinitionDialog
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a packed hashmap with the following arguments paramMap HashMap of parameter values - fieldMap requestMap HashMap of request values - objectId, relId, mode, form fieldMap
     *            HashMap of field values - name
     * @throws Exception
     *             if the operation fails
     * @since CFF R210
     */
    public String getEffectivityFilterDisplay(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        String objectId = (String) requestMap.get("objectId");
        ...
        String effectivityURL = "../effectivity/EffectivityDefinitionDialog.jsp?modetype=filter" + strAmp + "invockedFrom=fromForm" + strAmp + "formName=" + formName + strAmp + strObjectId + strAmp
                + strParentId + strAmp + "fieldNameEffExprDisplay=" + fieldName + strAmp + "fieldNameEffExprActual=" + fieldNameActual + strAmp + "fieldNameEffExprActualListAc=" + fieldNameList
                + strAmp + "fieldNameEffExprActualList=" + fieldNameListAc + strAmp + "fieldNameEffExprOID=" + fieldNameOID;
     ...
     * @since CFF R210
     */
    public Vector getProposedStructureEffectivityColumn(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objectList = (MapList) programMap.get("objectList");
        HashMap params = (HashMap) programMap.get("paramList");
        double timezone = (new Double((String) params.get("timeZone"))).doubleValue();
     ...
     * @since CFF R210
     */
    public Vector getCurrentStructureEffectivityColumn(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objectList = (MapList) programMap.get("objectList");
        HashMap params = (HashMap) programMap.get("paramList");
        double timezone = (new Double((String) params.get("timeZone"))).doubleValue();
    ...
    /**
     * Displays the Effectivity Expression field for a Change - used from the create form context
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a packed hashmap with the following arguments paramMap HashMap of parameter values - fieldMap requestMap HashMap of request values - objectId, mode, form
     ...
     * @since CFF R210
     */
    public String getEffectivityOnChangeCreate(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        String objectId = (String) requestMap.get("objectId");
        ...
        String createEffectivityURL = "../effectivity/EffectivityDefinitionDialog.jsp?modetype=create&amp;invockedFrom=fromForm&amp;formName=" + formName + "&amp;parentOID=" + objectId
                + "&amp;fieldNameEffExprDisplay=" + field + "&amp;fieldNameEffExprActual=" + field + "OID&amp;fieldNameEffTypes=effTypes&amp;fieldNameEffExprActualListAc=" + field
                + "ActualListAc&amp;fieldNameEffExprActualList=" + field + "ActualList";
        String cffParams = cffParams(requestMap, "create");
        createEffectivityURL = createEffectivityURL.concat(cffParams);
        if (mode != null && mode.equalsIgnoreCase("create")) {
            // sb.append(" <script src='../common/scripts/emxUIModal.js'> </script> ");
    ...
    /**
     * Displays the Effectivity Expression field for a Change - used from the Edit/Properties form
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a packed hashmap with the following arguments paramMap HashMap of parameter values - fieldMap requestMap HashMap of request values - objectId, mode, form
     ...
     * @since CFF R210
     */
    public String getEffectivityOnChangeDisplay(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        String objectId = (String) requestMap.get("objectId");
        ...
        String editEffectivityURL = "../effectivity/EffectivityDefinitionDialog.jsp?modetype=edit" + strObjectId + strParentId + "&formName=" + formName + "&fieldNameEffExprDisplay=" + field
                + "&fieldNameEffExprActual=" + field + "OID&fieldNameEffExprActualListAc=" + field + "ActualListAc&fieldNameEffExprActualList=" + field + "ActualList&fieldNameEffTypes=effTypes";
        String cffParams = cffParams(requestMap, "edit");
        editEffectivityURL = editEffectivityURL.concat(cffParams);
        if (mode != null && mode.equalsIgnoreCase("edit")) {
            // sb.append(" <script src='../common/scripts/emxUIModal.js'> </script> ");
    ...
    /**
     * Updates the effectivity expression for a Change object. Called as the update method for the create and edit form of a change type.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a packed hashmap with the following arguments paramMap HashMap of parameter values- objectId, New Value
     ...
     * @since CFF R210
     */
    public Object updateEffectivityOnChange(Context context, String[] args) throws Exception {
    ...
    /**
     * Refreshes the Effectivity Proposed Expression for all operations under the change context due to a changed in the Named Effectivity expression. Called from a modifyAttribute trigger on type
     * Named Effectivity
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     * @since CFF R210
     */
    public Object refreshProposedEffectivity(Context context, String[] args) throws Exception {
    ...
    /**
     * Adds the Named Effectivity Interface to the Named Effectivity Object. This is called as a create trigger on the Named Effectivity type.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a packed hashmap with the following arguments paramMap HashMap of parameter values- objectId, New Value
     ...
     * @since CFF R210
     */
    public Object addNamedEffectivityInterface(Context context, String[] args) throws Exception {
        String neObjId = args[0];
     ...
     *            String specifying the bean directory the the type belongs to
     * @param typeName
     *            String specifying the symbolic name of the type
    ...
    /**
     * Delete the Named Effectivity object when the Change object is deleted. Called as delete action trigger on Named Effectivity relationship
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            String array holding the Named Effectivity objectId
     * @return Object - boolean true if the operation is successful
     * @throws Exception
     *             if the operation fails
     * @since CFF R210
     */
    public Object deleteNamedEffectivity(Context context, String[] args) throws Exception {
    ...
    /**
     * Check if the context object is being used in an effectivity expression. If it is then do not allow the delete of the object. This is a mandatory trigger that needs to be set for all object
     * Types that are being used in an effectivity sequence context.
     * @param context
     *            the eMatrix <code>Context</code> object
    ...
    public static StringList getCellLevelEditAccess(Context context, String args[]) throws Exception {
        ...
        while (objectItr.hasNext()) {
            ...
            if (rootObjectId != null && rootObjectId.equalsIgnoreCase(curObjectID)) {
    ...
    /**
     * Returns a MapList of selected Ids from full search results when using relational effectivity Object View This will expand the selected objects and return a row for each parent/child pair
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a packed hashmap with the following arguments RequestValuesMap HashMap of request values - emxTableRowId
     ...
     * @since CFF R209
     */
    public MapList getSelectorSearchResultsRelationalObjView(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("RequestValuesMap");
        MapList mlSearchResults = new MapList();
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getSelectorSearchResultsRelationalRelView(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("RequestValuesMap");
        MapList mlSearchResults = new MapList();
        ...
        for (int i = 0; i < emxTableRowId.length; i++) {
            ...
            if (strTokens.hasMoreTokens()) {
                ...
                if (strGlobalContextFO != null && !strGlobalContextFO.equals("") && strGlobalContextFO.equalsIgnoreCase("true")) {
     ...
     * @since CFF R209
     */
    public Vector getRelationalColumnName(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objectList = (MapList) programMap.get("objectList");
     ...
     * @throws Exception
     */
    public StringList getConfigurationContexts(Context context, String[] args) throws Exception {
        ...
        if (ECUsageList != null && !ECUsageList.isEmpty()) {
            ...
            while (usageItr.hasNext()) {
                ...
                if (strObjId != null && strObjId.contains(fromObjId)) {
                    ...
                    /*
                     * sbErrorMessage.append("\\n"); sbErrorMessage.append(strType); sbErrorMessage.append(" "); sbErrorMessage.append(strName); sbErrorMessage.append(" ");
    ...
    /**
     * Formats the expression based on settings in the Effectivity Type commands. Returns the display value and storage (actual) value for this expression. Used by the Effectivity Expression Dialog to
     * convert the UI string to a display value and storage value.
     * @return Map containing LIST_VALUE LIST_VALUE_ACTUAL DISPLAY_VALUE and ACTUAL_VALUE keys
     * @throws Exception
     *             if the operation fails
     * @exclude
     */
    public Map formatExpression(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
    ...
    /**
     * returns complete Milestone Tracks connected to configuration context to be displayed in UI - Structure Browser
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId: id of configuration context model and other information from request map
    ...
    /**
     * Returns Milestones' discipline value to be displayed in Milestone Effectivity table, given that this information is already available in milestone object list.
     * @param context
     *            the ENOVIA <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments: objectList: contain a list of milestone objects
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            could hold relId or effectivityDiscipline argument
    ...
    /**
     * Formats the expression based on settings in the Effectivity Type commands.This is specifically used in ECH Applicability Expression Returns the display value and storage (actual) value for this
     * expression. Used by the Effectivity Expression Dialog to convert the UI string to a display value and storage value.
     * @return Map containing LIST_VALUE LIST_VALUE_ACTUAL DISPLAY_VALUE and ACTUAL_VALUE keys
     * @throws Exception
     *             if the operation fails
     * @exclude
     */
    public Map formatExpressionforApplicabilityContext(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList appItemsList = (MapList) programMap.get("AppItemsList");
        String strEffectivityType = (String) programMap.get("EffectivityType");
        EffectivityFramework EFF_app = new EffectivityFramework();
    ...
    /**
     * Gets display expression given a list of applicable items. Currently, it supports of types Products or Manufacturing Plan
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            the argument contains program map, which in turn contains below items: "contextModelId": the context model that applicable items are selected from "applicableItemsList": maplist of
     *            applicable items containg type, name and revision
    ...
    /**
     * Returns true if the attribute has a dependency on effectivity expression usage. This trigger will block the modification of an attribute that is referenced in an effectivity expression.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            String [] with the following arguments 0 = the object id of the object containing the attribute 1 = the relationship id of the relationship containing the attribute (either objectid
     *            or relid, but not both, objectid takes precedence) 2 = symbolic name of a relationship to expand (optional - used with object id only if need to expand the object to determine usage)
     *            3 = boolean true to indicate expand is from the object, false to indicate expand is to the object (optional - used with object id only if need to expand the object to determine
     *            usage)
     * @return int 0 for success and 1 for failure
     * @throws Exception
     *             throws exception if the operation fails
    ...
    /**
     * This method is used to generate the icon and perform action on move right quick action in FO / Milestone panels in Effectivity Dialog
     * @param context
     * @param args
     * @return
        ...
        try {
            ...
            for (int i = 0; i < objectList.size(); i++) {
                ...
                if (selection.equals("true") && !levelId.equalsIgnoreCase("0")) {
                    ...
                    String jsString = "clearAllCheckedItems(); var rowArr = ['" + levelId
                            + "']; emxEditableTable.select(rowArr); window.parent.document.getElementById('insertButtinId').click(); emxEditableTable.unselect(rowArr);";
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getSelectorSearchResults(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("RequestValuesMap");
        String disableRootSelection = (String) programMap.get("disableRootSelection");
        MapList mlSearchResults = new MapList();
