...
/**
 * The <code>emxPartDefinition</code> class contains code for the following types.: CAD Drawing, CAD Model and Drawing Print.
...
public class emxPartDefinition_mxJPO extends emxPartDefinitionBase_mxJPO {
    ...
    public emxPartDefinition_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
