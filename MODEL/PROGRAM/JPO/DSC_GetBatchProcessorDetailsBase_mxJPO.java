...
public class DSC_GetBatchProcessorDetailsBase_mxJPO {
    ...
    public DSC_GetBatchProcessorDetailsBase_mxJPO() {
        ...
        /*
         * To support individual batch processing for each site, please uncomment the below code and populate the siteDetails table accordingly for each site.
         */
        /*
         * Hashtable site1Details = new Hashtable(); site1Details.put(SHADOW_USER_NAME, "<SITE1_USER_NAME>"); site1Details.put(SHADOW_USER_PASSWORD, "<SITE1_USER_PASSWORD>");
         * site1Details.put(QUEUE_NAME, "<SITE1_QUEUE_NAME>");
         * 
         * Hashtable site2Details = new Hashtable(); site2Details.put(SHADOW_USER_NAME, "<SITE2_USER_NAME>"); site2Details.put(SHADOW_USER_PASSWORD, "<SITE2_USER_PASSWORD>");
         * site2Details.put(QUEUE_NAME, "<SITE2_QUEUE_NAME>");
         * 
         * siteNameSiteDetailsTable.put("<SITE1>", site1Details); siteNameSiteDetailsTable.put("<SITE2>", site2Details);
         */

        // Updtae Structure Operation
        Hashtable updateStructureOperationDetails = new Hashtable();
        updateStructureOperationDetails.put(DEFAULT_QUEUE, "UpdateStructureQueue");

        Hashtable site1Details = new Hashtable();
        site1Details.put(SHADOW_USER_NAME, "");
        site1Details.put(SHADOW_USER_PASSWORD, "");
        site1Details.put(QUEUE_NAME, "UpdateStructureQueue");

        siteNameSiteDetailsTable.put("<SITE1>", site1Details);

        updateStructureOperationDetails.put(SITE_DETAILS_TABLE, siteNameSiteDetailsTable);
        batchOperationDetails.put("BackgroundUpdateStructure", updateStructureOperationDetails);
        ...
        /*
         * //Other operation Hashtable otherOperationDetails = new Hashtable(); otherOperationDetails.put(QUEUE_NAME, "OtherQueue"); batchOperationDetails.put("BatchOther", otherOperationDetails);
         */
        // *****************************************************************
    }
