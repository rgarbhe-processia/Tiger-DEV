...
public class emxRouteBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @since AEF Rossini
     */
    public emxRouteBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    public Object getMyRoutes(Context context, String[] args) throws Exception {
        try {
            ...
            routeList = connectedObject.getRelatedObjects(context, relPattern.getPattern(), typePattern.getPattern(), typeSelects, null, false, true, (short) 1, sTypeWhere, null, null, null, null);
            ...
            StringList routeIds = new StringList(routeList.size());
            while (routeListItr.hasNext()) {
                ...
                if (!routeIds.contains(routeId)) {
                    if (loggedInUser.equals(routeOwner)) {
                        tempRouteList.add(routeMap);
                    } else if ((routeOwner != null && routeOwner.equals(loggedInUser)) || (parentRouteOwner != null && parentRouteOwner.equals(loggedInUser))) {
    ...
    public Vector showStatusGif(Context context, String[] args) throws Exception {
        try {
            ...
            for (Iterator itrObjectList = objectList.iterator(); itrObjectList.hasNext();) {
                ...
                mlRouteNodes = dmoRoute.getRelatedObjects(context, DomainObject.RELATIONSHIP_ROUTE_NODE, DomainObject.TYPE_PERSON + "," + DomainObject.TYPE_ROUTE_TASK_USER, slBusSelect, slRelSelect,
                        false, true, nRecurseLevel, strObjWhr, strRelWhr);
     ...
     * @since AEF Rossini
     */
    public Vector getScheduledCompletionDate(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objectList = (MapList) programMap.get("objectList");
     ...
     * @since AEF Rossini
     */
    public Vector getActualCompletionDate(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objectList = (MapList) programMap.get("objectList");
            Vector enableCheckbox = new Vector();
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getAllMyDeskRoutes(Context context, String[] args) throws Exception, MatrixException {
        try {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getMyDeskActiveRoutes(Context context, String[] args) throws Exception, MatrixException {
        try {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getMyDeskInActiveRoutes(Context context, String[] args) throws Exception, MatrixException {
        try {
            StringBuffer sbWhere = new StringBuffer(64);
            sbWhere.append(sbRouteStatus.toString());
            sbWhere.append(strMatchList);
     ...
     * @since AEF Rossini
     */
    public Object getMyDeskRoutes(Context context, String[] args, String WhereExpression) throws Exception {
        try {
            ...
            MapList routeList = person.getRelatedObjects(context, relPattern.getPattern(), DomainObject.TYPE_ROUTE, typeSelects, null, true, false, (short) 1, WhereExpression, "", null, null, null);
     ...
     * @since AEF Rossini
     */
    public Vector showOwner(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objectList = (MapList) programMap.get("objectList");
    ...
    public void grantAccess(matrix.db.Context context, String[] args) throws Exception {
        ...
        /*
         * if(getType(context).equals(TYPE_ROUTE_TEMPLATE)) { return; }
         */
    ...
    /**
     * Update Route Node ID attribute on Route Node relationship when Connected thru Route Node rel.
     * @param context
     *            the eMatrix Context object
     * @param holds
     *            the grantee name
     ...
     * @throws Exception
     *             if the operation fails
     * @Modified: AEF V6R2014 After Team Central Security Context highlight, now we are checking if the member is having 'Add Remove' access then he can perform these operations
     */
    ...
    public static boolean displaySetTaskLinkAccessCheck(Context context, String args[]) throws Exception {
        ...
        } else if (sPassedType.equals(objectGeneral.TYPE_DOCUMENT) || sPassedType.equals(objectGeneral.TYPE_PACKAGE) || sPassedType.equals(objectGeneral.TYPE_RTS_QUOTATION)
                || sPassedType.equals(objectGeneral.TYPE_REQUEST_TO_SUPPLIER)) {
        ...
        try {
            ...
            MapList mapList = person.getRelatedObjects(context, relPatternProject.getPattern(), typePatternWorkspace.getPattern(), objectSelects, null, true, true, (short) 1, objectWhere, "", null,
                    null, null);
     ...
     * @since Common 10.0.1.1
     */
    public Object getRoutes(Context context, String[] args, String sWhere) throws Exception, MatrixException {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            String parentId = (String) programMap.get("objectId");
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getAllRoutes(Context context, String[] args) throws Exception, MatrixException {
        try {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getActiveRoutes(Context context, String[] args) throws Exception, MatrixException {
        try {
            String sWhere = "";
            if (activeFilter != null && !"".equals(activeFilter.trim())) {
                StringTokenizer tokenizer = new StringTokenizer(activeFilter, ",");
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getInActiveRoutes(Context context, String[] args) throws Exception, MatrixException {
        try {
            String sWhere = "";
            if (inActiveFilter != null && !"".equals(inActiveFilter.trim())) {
                StringTokenizer tokenizer = new StringTokenizer(inActiveFilter, ",");
            ...
            while (objectListItr.hasNext()) {
                ...
                if ((restrictScope != null) && (!restrictScope.equals("All")) && (!restrictScope.equals("Organization"))) {
                    ...
                    if (!isPrinterFriendly && hasAccessToScopeObject) {
                        ...
                        if (strExportFormat != null && strExportFormat.equalsIgnoreCase("CSV")) {
                            strBuf.append(scopeObjInfo.get(DomainConstants.SELECT_NAME).toString());
                        } else {
    ...
    /**
     * gets the list of connected connect for the Route Used for APPDocumentSummary table
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getContent(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            String parentId = (String) programMap.get("objectId");
            ...
            MapList documentList = masterObject.getRelatedObjects(context, relPattern, "*", typeSelects, relSelects, true, false, (short) 0, objectWhere, null, null, null, null);
            return documentList;
        } catch (Exception ex) {
            ex.printStackTrace();
            throw ex;
    ...
    /**
     * canUpload - This method is used to determine if the context user can Upload.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            empty
     ...
     * @since Common 10-5
     */
    public boolean canUpload(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) programMap.get("objectId");
        ...
        /*
         * boolean bProgram = FrameworkUtil.isSuiteRegistered(context,"appVersionProgramCentral",false,null,null); If Team or Program is not installed then cannot upload. if ((!bTeam) && (!bProgram))
         */
        ...
        if (((sOwner.equals(context.getUser()) && (isRouteEditable)) || (contextAccess.hasToConnectAccess() && contextAccess.hasFromConnectAccess())) && !loggedInRole.contains(roleOwner)
                && !loggedInRole.contains(roleAdmin))
            showLink = true;
    ...
    /**
     * canAddContent - This method is used to determine if the context user can Add Content to a Route.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            empty
     ...
     * @since Common 10-5
     */
    public boolean canAddContent(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) programMap.get("objectId");
    ...
    /**
     * canEdit - This method is used to determine if the context user can Edit the LifeCycle Blocks of a Route
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            empty
     ...
     * @since Common 10-5
     */
    public boolean canEdit(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) programMap.get("objectId");
    ...
    public boolean canEditLifecycleBlocks(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) programMap.get("objectId");
        ...
        boolean isRouteEditable = true;
        // Do not show links if the Route State is Complete or Archive
        if (sState.equals(Route.STATE_ROUTE_ARCHIVE) || sState.equals(Route.STATE_ROUTE_COMPLETE)) {
            isRouteEditable = false;
        }
    ...
    public Vector showStateBlock(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objectList = (MapList) programMap.get("objectList");
            Map paramList = (Map) programMap.get("paramList");
    ...
    /**
     * canDeleteContent - This method is used to determine if the context user can Delete Content to a Route.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            empty
     ...
     * @since Common 10-5
     */
    public boolean canDeleteContent(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) programMap.get("objectId");
    ...
    /**
     * canRemoveContent - This method is used to determine if the context user can remove Content to a Route.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            empty
    ...
    public boolean canRemoveContent(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) programMap.get("objectId");
    ...
    /**
     * Implements resume process for the route object. Following things will happen on broad level o All the tasks of this route will be found, and each tasks if assigned to any task assignee, it will
     * be unassigned. (The Inbox Task will be disconnected from the Person object with relationship 'Project Task'). So all these tasks will be removed from the 'My Tasks' list of the respective task
     * assignees. o Demote the route to Define state. (The first state of the route). o Set 'Current Route Node' on route object to 1. The Route Status of the route will be made as 'Started' and route
     * is promoted to 'In Process' state. This will start the route.
     * @param context
    ...
    /**
     * Implements promote trigger process for the object. Following things will happen on broad level For the object for which the routes are attached to when promoted to next state the Routes
     * attached to the state is resumed.
     * @param context
     *            The Matrix Context object
     * @param args
     *            The arguments array. args[0] : The object id
     * @return 0 indicating successful operation or 1 indicating unsuccessful operation
     * @throws Exception
     *             of operation fails
     * @since Common V6R2009-1
    ...
    public int triggerAutoResumeRoute(Context context, String[] args) throws Exception {
        ...
        short nRecurseLevel = (short) 1;
        String strBusWhere = "";
        String strRelWhere = "attribute[" + DomainObject.ATTRIBUTE_ROUTE_BASE_STATE + "]==\"" + strSymbolicState + "\" && attribute[" + DomainObject.ATTRIBUTE_ROUTE_BASE_POLICY + "]==\""
                + strSymbolicPolicy + "\"";
    ...
    /**
     * Implements demote trigger process for the object. Following things will happen on broad level For the object for which the routes are attached to when Demoted the Routes attached to the state
     * it is demoted will start from the begining and the routes attached to the state from which it is demoted will stop.
     * @param context
     *            The Matrix Context object
     * @param args
     *            The arguments array. args[0] : The object id
    ...
    public int triggerAutoStopRoute(Context context, String[] args) throws Exception {
        ...
        strRelWhere = "attribute[" + DomainObject.ATTRIBUTE_ROUTE_BASE_STATE + "]== \"" + strSymbolicNextState + "\" && attribute[" + DomainObject.ATTRIBUTE_ROUTE_BASE_POLICY + "]==\""
                + strSymbolicPolicy + "\"";
    ...
    public int startTasksOnCurrentLevel(Context context, String[] args) throws Exception {
        ...
        //
        String[] strMethodArguments = new String[] { strType, strName, strRevision, strCurrentRouteNode, "0" };
        int nReturnCode = emxCommonInitiateRoute_mxJPO.InitiateRoute(context, strMethodArguments);
        return nReturnCode;
    }

    /**
     * Method sets the due dates from due date offset for given level Route Node relationships and Inbox Tasks (if they are activate). (This method assumes that the tasks will be activated (if not
     * already) immediately and hence the current system time is assumed to be the task creation time.)
     * @param context
     *            The Matrix Context object
     * @param args
     *            The arguments. args[0]: Level/Order for the tasks
    ...
    public int setDueDateFromOffsetForGivenLevelTasks(Context context, String[] args) throws Exception {
        ...
        MapList mlRouteNodes = dmoRoute.getRelatedObjects(context, strRelationshipPattern, strTypePattern, slBusSelect, slRelSelect, !GET_TO, GET_FROM, (short) 1, strObjectWhere, strRelWhere);
        ...
        strObjectWhere = "attribute[" + DomainObject.ATTRIBUTE_ROUTE_NODE_ID + "] matchlist \"" + FrameworkUtil.join(slRouteNodeIds, ",") + "\" \",\" && current != const \""
                + POLICY_INBOX_TASK_STATE_COMPLETE + "\"";
        ...
        MapList mlInboxTasks = dmoRoute.getRelatedObjects(context, strRelationshipPattern, strTypePattern, slBusSelect, slRelSelect, GET_TO, !GET_FROM, (short) 1, strObjectWhere, strRelWhere);
    ...
    /**
     * canManageRouteApprovals - This method is used to determine if the context user can Manage Route Approvals.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            empty
    ...
    /**
     * added for the bug 341480 routeDeleteCheck - gets the list of Task Escalation Message objects connected to the context Route
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public int routeDeleteCheck(Context context, String[] args) throws Exception {
        try {
            ...
            MapList list = routeObj.getRelatedObjects(context, typePattern, relPattern, objectSelects, null, false, true, (short) 1, null, null);
    ...
    /**
     * The trigger will check if this is the state based route, then the routed object must be in correct state for route to be started
     * @param context
     *            The Matrix Context object
     * @param args
     *            The arguments, args[0]: Route object id
    ...
    public int validateStateBasedRouteStarting(Context context, String[] args) throws Exception {
        try {
            ...
            MapList mlRoutedObjects = dmoRoute.getRelatedObjects(context, relationshipPattern, typePattern, objectSelects, relationshipSelects, GET_TO, !GET_FROM, recurseToLevel, objectWhere,
                    relationshipWhere);
            ...
            for (Iterator itrRoutedObjects = mlRoutedObjects.iterator(); itrRoutedObjects.hasNext();) {
                ...
                if (strRouteBasePolicy != null && !"".equals(strRouteBasePolicy) && !"null".equals(strRouteBasePolicy) && strRouteBaseState != null && !"".equals(strRouteBaseState)
                        && !"null".equals(strRouteBaseState) && !"Ad Hoc".equals(strRouteBaseState)) {
    ...
    /**
     * Method checks if the routed object is in last state or not. This method is supposed to be used to determine the access for commands for route creation.
     * @param context
     *            The Matrix context object
     * @param args
     *            The packed program map
     * @return true if route object is in last state, false if the route object is not there or route object is there but not in last state.
     * @throws Exception
     *             if operation fails.
     */
    ...
    /**
     * Method checks if user can set task escalation. This method is supposed to be used to determine the access for command.
     * @param context
     *            The Matrix context object
     * @param args
     *            The packed program map
    ...
    /**
     * Method checks if user can start/resume route. This method is supposed to be used to determine the access for command.
     * @param context
     *            The Matrix context object
     * @param args
     *            The packed program map
    ...
    /**
     * added for the Bug 360573 routeDeleteCheck - gets the list of Discussion objects connected to the context Route
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Route Object Id
    ...
    public int routeDiscussionDeleteCheck(Context context, String[] args) throws Exception {
        try {
            StringList objectSelects = new StringList(1);
            objectSelects.addElement(SELECT_ID);
    ...
    /**
     * When the route route is completed system has to revoke the access granted by Route Access Grantor on Route content (for all grantees) Access granted by other than Route Access Grantor will
     * remain same.
     */
        ...
        if (mode.equalsIgnoreCase("create")) {
            if (isSupplierReview) {
                ...
                if (relatedObjectId != null) {
                    ...
                    selects.add(DomainConstants.SELECT_KINDOF_WORKSPACE_VAULT);

                    Map infoMap = boProject.getInfo(context, selects);
                    ...
                    boolean isKindOfWorkspaceVault = Boolean.parseBoolean((String) infoMap.get(DomainConstants.SELECT_KINDOF_WORKSPACE_VAULT));
                    sTypeName = (String) infoMap.get(DomainObject.SELECT_TYPE);
                    String sName = XSSUtil.encodeForHTML(context, boProject.getInfo(context, "name"));
                    if (sTypeName.equals(DomainObject.TYPE_WORKSPACE) || isKindOfWorkspaceVault || // Modified:16-Mar-09:wqy:R207:PRG Bug 370839
                            isProjectSpaceOrConcept) // Modified to handle Sub Type
                    {
                    ...
                    } else if (sTypeName.equals(DomainObject.TYPE_DOCUMENT) || sTypeName.equals(DomainObject.TYPE_PACKAGE) || sTypeName.equals(DomainObject.TYPE_RTS_QUOTATION)
                            || sTypeName.equals(DomainObject.TYPE_REQUEST_TO_SUPPLIER) || sTypeName.equals(DomainObject.TYPE_PART)) {
                        String sId = "";
                        String sName1 = "";
            ...
            if (sTypeName.equals(DomainConstants.TYPE_ROUTE_TEMPLATE) && mode.equalsIgnoreCase("edit")) {
                ...
                if (restrictMembers.equalsIgnoreCase("All") || restrictMembers.equalsIgnoreCase("Organization")) {
                    ...
                    if ("All".equalsIgnoreCase(scopeName))
                        ...
                        scopeName = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(strLanguage), "emxComponents.Common.Organization");
                } else {
    ...
    public HashMap createRouteProcess(Context context, String[] args) throws Exception {
        ...
        String fromInsideProject = "false";
        if (UIUtil.isNotNullAndNotEmpty(objectId)) {
            fromInsideProject = "true";
        }
        ...
        if (isExists) {
            resultMap.put("ErrorMessage", i18nNow.getTypeI18NString(DomainConstants.TYPE_ROUTE, strLanguage) + " " + name + " "
                    + EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(strLanguage), "emxComponents.Common.AlreadyExists"));
        } else {
            ...
            if ((strTypeName != null || !"".equals(strTypeName) || !"null".equals(strTypeName)) && DomainObject.TYPE_DOCUMENT.equals(strTypeName)
                    && com.matrixone.apps.domain.util.mxType.isOfParentType(context, strTypeName, com.matrixone.apps.domain.DomainObject.TYPE_WORKSPACE_VAULT)) {
                selscopeId = objectId;
            }
            ...
            routeDetails.put("fromInsideProject", fromInsideProject);
            routeDetails.put("selscope", restrictMembers);
            ...
            if (WSNotSelected) {
                ...
                if (rtSelected) {
                    ...
                    personSelect = routeTemplateObj.expandSelect(context, DomainObject.RELATIONSHIP_ROUTE_NODE, typePattern.getPattern(), selectPersonStmts, selectPersonRelStmts, false, true,
                            (short) 1);
    ...
    public String routeTemplateLinkOfRoute(Context context, String[] args) throws Exception {
        ...
        if (mode.equalsIgnoreCase("view")) {
            if (strTemplate == null) {
                ...
                sb.append("<a href=\"javascript:showModalDialog('../common/emxTree.jsp?emxSuiteDirectory=components&objectId=" + strTemplateId
                        + "', '800', '575')\"><img src=\"../common/images/iconSmallRoute.gif\" alt=\"\" name=\"route\" id=\"route\" border=\"0\"/></a>&#160;");
    ...
    /**
     * The main method which all filter access method calls. Returns Route Access List Based on the parameters.
     * @param context
     *            the eMatrix Context object
     * @param args
     *            holds the grantee and grantor name
     * @return MapList
     * @throws Exception
     *             if the operation fails
     * @since R211
    ...
    public MapList getRouteAccessSummaryMemberList(Context context, String[] args) throws Exception {
        ...
        MapList memberList = routeBO.getRelatedObjects(context, RELATIONSHIP_ROUTE_NODE, typePattern.getPattern(), selectables, selectPersonRelStmts, false, true, (short) 1, EMPTY_STRING,
                EMPTY_STRING, 0);
            ...
            if (!UIUtil.isNullOrEmpty(dispMemberName) && !members.contains(dispMemberName)) {
                ...
                if (toNodeType.equals(TYPE_ROUTE_TASK_USER) && !UIUtil.isNullOrEmpty(routeTaskUser)) {
                    ...
                    for (int i = 0; i < domainAccessParentSummaryList.size(); i++) {
                        HashMap m = (HashMap) domainAccessParentSummaryList.get(i);
                        if ((sGrantee + "_PRJ").equals(((String) m.get("name")))) {
                            inheritedAccess = (String) m.get("inheritedAccess");
                            break;
                        }
                    }
                    if (UIUtil.isNotNullAndNotEmpty(inheritedAccess)) {
                        StringList slInheritedAccess = FrameworkUtil.split(inheritedAccess, "|");
                        int accessIndex = 0;
                        String sInheritedAccessMask = "";
                        Set<String> hashSet = new LinkedHashSet<String>();
                        for (int i = 0; i < slInheritedAccess.size(); i++) {
                            sInheritedAccessMask = (String) slInheritedAccess.get(i);
                            hashSet.add(sInheritedAccessMask.trim());
                        }
                        slInheritedAccess.clear();
                        slInheritedAccess.addAll(hashSet);
                        inheritedAccess = slInheritedAccess.toString().trim().replaceAll("^\\[|\\]$", "").replaceAll(",", "|");
                    }
                    tempHash.put("InheritedAccess", inheritedAccess);
                ...
                if (UIUtil.isNotNullAndNotEmpty(templateId) && ("Maintain Exact Task List".equals(taskSetting) || "Extend Task List".equals(taskSetting) || "Modify Task List".equals(taskSetting))) {
                    ...
                    MapList PersonList = routeTempObj.getRelatedObjects(context, RELATIONSHIP_ROUTE_NODE, newTypePattern.getPattern(), selectList, null, false, true, (short) 0, EMPTY_STRING,
                            EMPTY_STRING, 0);
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a packed HashMap with the following entries: objectList - a MapList containing the actual maps "dataMap" containing the data. paramList - a HashMap containing the following
     *            parameters. editMode - a String either true or false for deciding the mode. reportFormat - a String to identify the Printer Friendly and Export view.
    ...
    public Vector getRouteAccessSummaryName(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
            ...
            if ("Collab Space".equals(strType)) {
                ...
                if ("Role".equalsIgnoreCase(strType)) {
                    ...
                    if (!isprinterFriendly && strObjType.equalsIgnoreCase(DomainConstants.TYPE_ROUTE)) {
                        ...
                        strBuffName.append("<a href=\"javascript:showModalDialog('../common/emxTree.jsp?emxSuiteDirectory=components&amp;objectId=" + XSSUtil.encodeForJavaScript(context, strId)
                                + "', '800', '575')\"><img src=\"../common/images/iconSmallPerson.gif\" alt=\"\" name=\"person\" id=\"PersonId\" border=\"0\" /></a>&#160;");
                        strBuffName.append("<a href=\"javascript:showModalDialog('../common/emxTree.jsp?emxSuiteDirectory=components&amp;objectId=" + XSSUtil.encodeForJavaScript(context, strId)
                                + "', '800', '575')\">" + XSSUtil.encodeForXML(context, strDisplayName) + "</a>");
                    } else {
     ...
     * @param args
     *            contains a packed HashMap with the following entries: objectList - a MapList containing the actual maps "dataMap" containing the data. paramList - a HashMap containing the following
     *            parameters. languageStr - a String containing the language information.
    ...
    public Vector getRouteAccessSummaryType(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objList = (MapList) programMap.get("objectList");
        HashMap paramList = (HashMap) programMap.get("paramList");
        String languageStr = (String) paramList.get("languageStr");
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a packed HashMap with the following entries: objectList - a MapList containing the actual maps "dataMap" containing the data.
    ...
    public Vector getRouteAccessSummaryOrganization(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objList = (MapList) programMap.get("objectList");
        int objListSize = objList.size();
        Vector columnVals = new Vector(objListSize);
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a packed HashMap with the following entries: charSet - a MapList containing the actual maps "dataMap" containing the data. objectList - a MapList containing the actual maps
     *            "dataMap" containing the data. paramList - a HashMap containing the following parameters. editMode - a String either true or false for deciding the mode. reportFormat - a String to
     *            identify the Printer Friendly and Export view. languageStr - a String containing the language information. accessChoice - a String containing the comma seperated values of the access
     *            rights available.
    ...
    public Vector getRouteAccessSummaryAccess(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objList = (MapList) programMap.get("objectList");
        HashMap paramList = (HashMap) programMap.get("paramList");
        String languageStr = (String) paramList.get("languageStr");
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Vector getRouteAccessSummaryInheritedAccess(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objList = (MapList) programMap.get("objectList");
        HashMap paramList = (HashMap) programMap.get("paramList");
        String languageStr = (String) paramList.get("languageStr");
        String sRouteId = (String) paramList.get("objectId");
        MapList domainAccessParentSummaryList = DomainAccess.getAccessSummaryList(context, sRouteId);
        ...
        for (int k = 0; k < objListSize; k++) {
            Map map = (Map) objList.get(k);
            String type = (String) map.get("Type");
            String access = (String) map.get("InheritedAccess");
            String sPersonId = (String) map.get("PersonId");
            String contextUser = (String) map.get("userName");

            for (int i = 0; i < domainAccessParentSummaryList.size(); i++) {
                HashMap m = (HashMap) domainAccessParentSummaryList.get(i);
                if ((contextUser + "_PRJ").equals(((String) m.get("name")))) {
                    access = (String) m.get("inheritedAccess");
                    break;
                }
            }
            if (UIUtil.isNotNullAndNotEmpty(access)) {
                StringList slInheritedAccess = FrameworkUtil.split(access, "|");
                String sInheritedAccessMask = "";
                Set<String> hashSet = new LinkedHashSet<String>();
                for (int i = 0; i < slInheritedAccess.size(); i++) {
                    sInheritedAccessMask = (String) slInheritedAccess.get(i);
                ...
                slInheritedAccess.clear();
                slInheritedAccess.addAll(hashSet);
                access = slInheritedAccess.toString().trim().replaceAll("^\\[|\\]$", "").replaceAll(",", "|");

                access = emxDomainAccessBase_mxJPO.getAccessDisplayValue(context, access, languageStr);
                StringBuffer strBuff = new StringBuffer();
                strBuff.append(
                        "<a href=\"javascript:emxTableColumnLinkClick('../common/emxIndentedTable.jsp?program=emxRouteBase:getInheritedAccessDetails&amp;table=APPRouteInheritedAccessSummary&amp;massPromoteDemote=false&amp;massUpdate=false&amp;customize=false&amp;multiColumnSort=false&amp;showPageURLIcon=false&amp;showRMB=false&amp;showClipboard=false&amp;objectCompare=false&amp;displayView=details&amp;findMxLink=false&amp;rowGrouping=false&amp;suiteKey=Components&amp;objectId=");
                strBuff.append(XSSUtil.encodeForJavaScript(context, sRouteId));
                strBuff.append("&amp;contextUser=");
                strBuff.append(XSSUtil.encodeForJavaScript(context, contextUser));
                strBuff.append("&amp;header=");
                strBuff.append("emxComponents.RouteAccess.InheritedAccessHeader");
                strBuff.append("', '");
                strBuff.append("700");
                strBuff.append("', '");
                strBuff.append("600");
    ...
    public Vector getRouteAccessSummaryNewWindow(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objList = (MapList) programMap.get("objectList");
        int objListSize = objList.size();
        HashMap paramList = (HashMap) programMap.get("paramList");
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static MapList getInheritedAccessDetails(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String sRouteId = (String) programMap.get("objectId");
        String sPersonName = (String) programMap.get("contextUser");
        String languageStr = (String) programMap.get("languageStr");
        MapList domainAccessParentSummaryList = DomainAccess.getAccessSummaryList(context, sRouteId);
        MapList objAccessList = new MapList();
        for (int i = 0; i < domainAccessParentSummaryList.size(); i++) {
            HashMap accessDetailsMap = (HashMap) domainAccessParentSummaryList.get(i);
            String sGrantee = (String) accessDetailsMap.get("username");
            String inheritedAccess = "";
            String inheritedObjIds = "";
            if (UIUtil.isNotNullAndNotEmpty(sGrantee) && sGrantee.equals(sPersonName)) {
                HashMap objAccessMap = new HashMap();

                inheritedAccess = (String) accessDetailsMap.get("inheritedAccess");
                inheritedObjIds = (String) accessDetailsMap.get("inheritedId");
                if (UIUtil.isNotNullAndNotEmpty(inheritedObjIds)) {
                    StringList slInheritedObjIds = FrameworkUtil.split(inheritedObjIds, "|");
                    StringList slInheritedAccess = FrameworkUtil.split(inheritedAccess, "|");
                    String sInheritedObj = "";
                    String sInheritedAccessMask = "";
                    String sCurrentAccessmask = "";
                    for (int j = 0; j < slInheritedObjIds.size(); j++) {
                        sInheritedObj = (String) slInheritedObjIds.get(j);
                        sInheritedObj = sInheritedObj.trim();
                        sInheritedAccessMask = (String) slInheritedAccess.get(j);
                        sInheritedAccessMask = sInheritedAccessMask.trim();
                        sInheritedAccessMask = emxDomainAccessBase_mxJPO.getAccessDisplayValue(context, sInheritedAccessMask, languageStr);
                        if (objAccessMap.containsKey(sInheritedObj)) {
                            sCurrentAccessmask = (String) objAccessMap.get(sInheritedObj);
                            StringList slCurrentAccess = FrameworkUtil.split(sCurrentAccessmask, "|");
                            if (slCurrentAccess.contains(sInheritedAccessMask)) {
                                continue;
                            }
                            objAccessMap.put(sInheritedObj, sCurrentAccessmask + "|" + sInheritedAccessMask);
                        } else {
                            objAccessMap.put(sInheritedObj, sInheritedAccessMask);
                        }
                    }

                    Iterator accessMapItr = objAccessMap.keySet().iterator();
                    ...
                    HashMap accessInfo = null;
                    String strContentType = "";
                    StringList slContentAccess = new StringList();
                    while (accessMapItr.hasNext()) {
                        String contentObjIdId = (String) accessMapItr.next();
                        DomainObject boContentObj = new DomainObject(contentObjIdId);
                        Map contentObjInfo = boContentObj.getInfo(context, selectables);
                        accessInfo = new HashMap();
                        strContentType = (String) contentObjInfo.get(SELECT_TYPE);
                        strContentType = EnoviaResourceBundle.getAdminI18NString(context, "Type", strContentType, languageStr);
                        accessInfo.put("inheritedObjName", (String) contentObjInfo.get(SELECT_NAME));
                        accessInfo.put("inhertTypeName", strContentType);
                        accessInfo.put("inhertRevName", (String) contentObjInfo.get(SELECT_REVISION));
                        accessInfo.put("inheritedAccess", objAccessMap.get(contentObjIdId));
                        objAccessList.add(accessInfo);
                    }
                }
                break;
            }
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Vector getRouteAccessInheritedFrom(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objList = (MapList) programMap.get("objectList");
        HashMap paramList = (HashMap) programMap.get("paramList");
        String languageStr = (String) paramList.get("languageStr");
        ...
        for (int k = 0; k < objListSize; k++) {
            Map map = (Map) objList.get(k);
            String type = (String) map.get("Type");
            String strObjName = (String) map.get("inheritedObjName");
            columnVals.addElement(strObjName);
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Vector getRouteAccessInheritedType(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objList = (MapList) programMap.get("objectList");
        HashMap paramList = (HashMap) programMap.get("paramList");
        String languageStr = (String) paramList.get("languageStr");
        ...
        for (int k = 0; k < objListSize; k++) {
            Map map = (Map) objList.get(k);
            String strObjType = (String) map.get("inhertTypeName");
            columnVals.addElement(strObjType);
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Vector getRouteAccessInheritedTypeRev(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objList = (MapList) programMap.get("objectList");
        HashMap paramList = (HashMap) programMap.get("paramList");
        String languageStr = (String) paramList.get("languageStr");
        ...
        for (int k = 0; k < objListSize; k++) {
            Map map = (Map) objList.get(k);
            String strObjRevision = (String) map.get("inhertRevName");
            columnVals.addElement(strObjRevision);
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Vector getRouteCollectiveAccess(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objList = (MapList) programMap.get("objectList");
        HashMap paramList = (HashMap) programMap.get("paramList");
        String languageStr = (String) paramList.get("languageStr");
     ...
     * @param args
     *            contains a packed HashMap with the following entries: objectList - a MapList containing the actual maps "dataMap" containing the data. paramList - a HashMap containing the following
     *            parameters. editMode - a String either true or false for deciding the mode.
    ...
    private MapList getPersonsUnderWorkspace(Context context, DomainObject workspace, String routeScopeType, StringList connectedMembers) throws FrameworkException {
        try {
            ...
            if (routeScopeType.equals(DomainObject.TYPE_PROJECT) || routeScopeType.equals(DomainObject.TYPE_PROJECT_VAULT)) {
                ...
                MapList mapList = workspace.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_WorkspaceMember"), DomainConstants.TYPE_PERSON, objectSelects, null, false,
                        true, (short) 1, "", "", 0, null, null, null);
    ...
    private MapList getPersonsUnderProjectSpace(Context context, DomainObject workspace, StringList connectedMembers) throws FrameworkException {
        try {
            ...
            MapList projectMemberList = workspace.getRelatedObjects(context, DomainConstants.RELATIONSHIP_MEMBER, "*", projectMemberSelects, null, false, true, (short) 1, "", "", 0, null, null, null);
    ...
    public MapList getRolesInWorkspace(Context context, String[] args) throws FrameworkException {
        /*
         * try { HashMap programMap = (HashMap)JPO.unpackArgs(args); String objectId = (String) programMap.get("objectId"); String scopeId = (String) programMap.get("scopeId"); List roleMapList = new
         * ArrayList(); boolean hasScopeId = (scopeId == null || scopeId.equals("") || scopeId.equals("null")) ? false : true; DomainObject workspace = hasScopeId ?
         * (DomainObject)DomainObject.newInstance(context, UserTask.getProjectId(context, scopeId)) : getScopeIdFromRouteId(context, objectId); String type = workspace.getInfo(context, SELECT_TYPE);
         * if(type.equals(DomainConstants.TYPE_PROJECT_SPACE) || mxType.isOfParentType(context,type,DomainConstants.TYPE_PROJECT_SPACE)) { roleMapList.addAll(getProjectSpaceGroupsOrRoles(context,
         * workspace.getId(), true)); }else{ DomainObject scopeObject = DomainObject.newInstance(context, scopeId); String scopeObjectType = scopeObject.getInfo(context, DomainConstants.SELECT_TYPE);
         * String sSelPersonName = "to[" + scopeObject.RELATIONSHIP_PROJECT_MEMBERSHIP + "].from.name"; StringList objectSelects = new StringList(1); objectSelects.add(sSelPersonName); MapList
         * personsMapList = workspace.getRelatedObjects(context, scopeObject.RELATIONSHIP_PROJECT_MEMBERS, scopeObject.TYPE_PROJECT_MEMBER, objectSelects, null, false, true, (short)1, "", "", 0, null,
         * null, null); StringList personNamesList = new StringList(); Iterator personsMapListItr = personsMapList.iterator(); while(personsMapListItr.hasNext()){ Map personMap = (Map)
         * personsMapListItr.next(); personNamesList.add((String) personMap.get(sSelPersonName)); } boolean isWorkspaceVault = DomainConstants.TYPE_WORKSPACE_VAULT.equals(scopeObjectType);
         * if(isWorkspaceVault){ AccessList accessList = new AccessList(); String sParentId = scopeObject.getInfo(context,"to[" + scopeObject.RELATIONSHIP_SUBVAULTS + "].from.id"); if(sParentId ==
         * null || sParentId.equals("")) { sParentId = scopeObject.getInfo(context,"to[" + scopeObject.RELATIONSHIP_WORKSPACE_VAULTS+ "].from.id"); } workspace.setId(sParentId); accessList =
         * workspace.getAccessForGrantor(context, AccessUtil.WORKSPACE_ACCESS_GRANTOR); if(accessList != null && accessList.size() > 0){ Iterator accessListItr = accessList.iterator();
         * while(accessListItr.hasNext()){ Access access = (Access) accessListItr.next(); String userName = access.getUser(); if(!personNamesList.contains(userName) && access.hasReadAccess()){
         * roleMapList.add(userName); } } } }else{ StringList granteeList = workspace.getGrantees(context); if((granteeList != null && granteeList.size() > 0)) { Iterator granteeListItr =
         * granteeList.iterator(); while(granteeListItr.hasNext()) { String memberName = (String)granteeListItr.next(); if(!personNamesList.contains(memberName) && !roleMapList.contains(memberName)) {
         * roleMapList.add(memberName); } } } } } return roleMapList.size() > 0 ? new ${CLASS:emxRoleUtil}(context, args).getRoleListForSummaryTable(roleMapList, getExistingRoleOrGroupList(context,
         * objectId)) : new MapList();
         * 
    ...
    public MapList getGroupsInWorkspace(Context context, String[] args) throws FrameworkException {
        /*
         * try { HashMap programMap = (HashMap)JPO.unpackArgs(args); String objectId = (String) programMap.get("objectId"); String scopeId = (String) programMap.get("scopeId"); List groupMapList = new
         * ArrayList(); boolean hasScopeId = (scopeId == null || scopeId.equals("") || scopeId.equals("null")) ? false : true; DomainObject workspace = hasScopeId ?
         * (DomainObject)DomainObject.newInstance(context, UserTask.getProjectId(context, scopeId)) : getScopeIdFromRouteId(context, objectId);
         * 
         * String type = workspace.getInfo(context, SELECT_TYPE); if(type.equals(DomainConstants.TYPE_PROJECT_SPACE) || mxType.isOfParentType(context,type,DomainConstants.TYPE_PROJECT_SPACE)) {
         * groupMapList.addAll(getProjectSpaceGroupsOrRoles(context, workspace.getId(), false)); } return groupMapList.size() > 0 ? new ${CLASS:emxRoleUtil} (context,
         * args).getRoleListForSummaryTable(groupMapList, getExistingRoleOrGroupList(context, objectId)) : new MapList(); } catch (Exception e) { throw new FrameworkException(e); }
         */
        return new MapList();
    }
    ...
    protected List getProjectSpaceGroupsOrRoles(Context context, String projectSpaceId, boolean roles) throws FrameworkException {
        try {
            ...
            String cmd = "print bus " + projectSpaceId + " select " + "to[" + DomainConstants.RELATIONSHIP_PROJECT_ACCESS_LIST + "].from.grantee " + "to["
                    + DomainConstants.RELATIONSHIP_PROJECT_ACCESS_LIST + "].from.grantee.isarole " + "to[" + DomainConstants.RELATIONSHIP_PROJECT_ACCESS_LIST + "].from.grantee.isagroup dump "
                    + DOMAIN_DELIMITER;
            ...
            for (int n = 0; n < numGrantees; n++) {
                if ((roles == true && grantees[n + numGrantees].equalsIgnoreCase("true")) || (roles == false && grantees[n + numGrantees * 2].equalsIgnoreCase("true"))) {
    ...
    public StringList getPersonIDsAddRouteMemberPersonSearch(Context context, String[] args) throws FrameworkException {
        try {
            ...
            buffer.append("print bus ").append(PersonUtil.getUserCompanyId(context)).append(" select from[").append(RELATIONSHIP_EMPLOYEE).append("].to.id dump |");
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a packed HashMap with the following entries: objectId - Object Id of the Route object.
    ...
    public boolean checksToEditRoute(Context context, String[] args) throws Exception {
        ...
        return isRouteEditable(context, objInfo) && ("true".equalsIgnoreCase((String) boObj.getInfo(context, "current.access[modify]")));
     ...
     *            the eMatrix <code>Context</code> object.
     * @param Map
     *            - objInfo containing teh current state of the Route.
    ...
    protected String getDisplayLink(Context context, String objectId) throws Exception {
        ...
        if (!context.getUser().equals((String) routeMap.get(SELECT_OWNER))) {
            ...
            return "Not Started".equals(routeStatus) ? "StartRoute" : "Stopped".equals(routeStatus) ? "ResumeAndRestartRoute" : "Started".equals(routeStatus) ? "StopRoute" : "";
        }
     ...
     *            The Matrix Context object
     * @param strRouteId
     *            The object id of route object
     * @return true if the route is stopped due to rejection of route task false if route is stopped but not due to task rejection
     * @throws Exception
     *             if operation fails or the route is not stopped
     */
    protected boolean isRouteStoppedDueToRejection(Context context, String strRouteId) throws Exception {
        ...
        MapList mlTasks = objRoute.getRelatedObjects(context, strRelPattern, strTypePattern, slBusSelect, slRelSelect, true, false, nRecurseLevel, strBusWhere, strRelWhere, (int) 0);
        ...
        try {
            ...
            if (!isRouteTemplate && canEditRoute && isOwner) {
                ...
                if (!UIUtil.isNullOrEmpty(templateId)) {
                    ...
                    canEditTaskList = !("Maintain Exact Task List".equals(sTaskEditSetting) || "Extend Task List".equals(sTaskEditSetting) || "Modify Task List".equals(sTaskEditSetting));
                }
            }
            // Can't remove tasks from Route Template
            boolean bShowTaskRemove = !isRouteTemplate && canEditTaskList;
            boolean bShowTaskEditAll = isRouteTemplate ? "true".equalsIgnoreCase(hasModifyAccess) : isOwner && canEditRoute;
     ...
     *            the eMatrix Context object
     * @param String
     *            array contains AssigneeIds for Access edit
     * @throws Matrix
        ...
        try {
            ...
            String assignee = routeNodeType.equals(TYPE_PERSON) ? PersonUtil.getFullName(context, (String) mapAssigneeInfo.get(SELECT_NAME))
                    : !UIUtil.isNullOrEmpty(rtu) ? getRoleGroupValue(context, sLanguage, rtu)
                            : EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(sLanguage), "emxComponents.RouteTemplateTaskAssignees.None");
    ...
    public Map getRouteNodeTaskAssigneeRangeValues(Context context, String[] args) throws FrameworkException {
        try {
            ...
            if (UIUtil.isNotNullAndNotEmpty(templateId) && ("Maintain Exact Task List".equals(taskSetting) || ("Extend Task List".equals(taskSetting) && isTemplateTask))) {
                ...
                MapList routeNodeTasks = domObj.getRelatedObjects(context, RELATIONSHIP_ROUTE_NODE, typePattern.getPattern(), selectables, relSelectables, false, true, (short) 1, EMPTY_STRING,
                        EMPTY_STRING, 0);
                ...
                if (STATE_ROUTE_DEFINE.equals(currentState) && !("none".equals((String) fieldValue.get(0)))) {
                    ...
                    rangeDispay.add(0, EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(sLanguage), "emxComponents.RouteTemplateTaskAssignees.None"));
                }
    ...
    protected String getRoleGroupValue(Context context, String sLanguage, String roleGroup) throws FrameworkException {
        try {
            ...
            taskAssignee = isRole ? i18nNow.getRoleI18NString(taskAssignee, sLanguage) : i18nNow.getAdminI18NString("Group", taskAssignee, sLanguage);
    ...
    public HashMap updateRouteNodeTask(Context context, String[] args) throws FrameworkException {
        try {
            ...
            boolean checkDueDate = ("Yes".equals(relValues.get(selAttrAssigneeDueDate)) && !dueDateEmpty && UIUtil.isNullOrEmpty((String) relValues.get(selAttrDueDateOffcet))
                    || context.getUser().equalsIgnoreCase(routeOwner));
            ...
            if (dueDateEmpty && checkDueDate) {
                ...
                resultsMap.put("Message", ComponentsUtil.i18nStringNow("emxComponents.Workflow.AlertDueDate", sLanguage));
                return resultsMap;
            }
            ...
            if (checkDueDate) {
                ...
                String taskScheduledDateNew = eMatrixDateFormat.getFormattedInputDateTime(context, dueDate, dueTime, clientTZOffset, locale);
            ...
            /**
             * newTaskAssignee will be in the following format Person -> person#PERSON_OBJ_ID#PERSON_OBJ_ID Role -> role#RTU_OBJ_ID#Role_SYMB_NAME Group -> group#RTU_OBJ_ID#GROUP_SYMB_NAME None ->
             * none#RTU_OBJ_ID# 0th Element -> Assignee Type 1st Element -> Obj to be connected -> RTU/Person Id 2nd Element -> Role/Group symbolic name Empty for None Person Id for Person
             */
            ...
            if (DomainObject.TYPE_PERSON.equals(mapAssigneeInfo.get("type"))) {
                Route.revokeAccessForOldAssigneeOnReassigningToGroup(context, routeId, ObjType, (String) objInfoMap.get(SELECT_NAME), (String) mapAssigneeInfo.get("name"),
                        (String) mapAssigneeInfo.get("type"), (String) mapAssigneeInfo.get("id"));
            }
    ...
    /**
     * This is dummy update program for Route Node Task edit form. We will be modifying the attributes in the post process JPO.
     * @param context
     * @param args
     * @throws FrameworkException
     */
    ...
    public String getRouteNodeTaskDueDateField(Context context, String[] args) throws Exception {
        ...
        if (UIUtil.isNotNullAndNotEmpty(assigneeSetDueDate) && "Yes".equalsIgnoreCase(assigneeSetDueDate)) {
            ...
            sb.append(dueDateOffset).append(" ").append(EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(languageStr), "emxComponents.common.DaysFrom")).append(" ")
                    .append(i18nNow.getRangeI18NString(DomainObject.ATTRIBUTE_DATE_OFFSET_FROM, dueDateOffsetFrom, languageStr));
        }
        return sb.toString();
    }
    ...
    public Map deleteSelectedRoutes(Context context, String args[]) throws FrameworkException {
        try {
            ...
            String rowIds = requestValuesMap.get("rowIds") != null ? ((String[]) requestValuesMap.get("rowIds"))[0] : null;
            String sMessage = requestValuesMap.get("NotificationMessage") != null ? ((String[]) requestValuesMap.get("NotificationMessage"))[0] : "";
            ...
            for (int i = 0; i < routeIds.length; i++) {
                ...
                boolean isOwner = owner.equals(context.getUser()) ? true : false;
                try {
                    ...
                    if (deleteAccessFlag && isOwner) {
                        route.deleteRoute(context, sMessage, buffer.toString());
                    } else {
                        String message = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), "emxFramework.Alert.CannotDeleteRoute");
    ...
    public Vector getRouteAccessSummaryComments(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objList = (MapList) programMap.get("objectList");
        HashMap paramList = (HashMap) programMap.get("paramList");
        String languageStr = (String) paramList.get("languageStr");
        ...
        for (int k = 0; k < objListSize; k++) {
            ...
            if ("Collab Space".equals(type)) {
                ...
                if ("primary".equalsIgnoreCase(Comments)) {
                    ...
                    Comments = Comments.replaceFirst("Access Granted Through",
                            EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", new Locale(languageStr), "emxFramework.MultipleOwnership.Granted"));
                }
    ...
    public static void setAssigneeDueDate(Context context, String[] args) throws Exception {
        if (args == null || args.length < 3) {
            throw (new IllegalArgumentException());
        }
        String routeId = args[0];
        String inboxTaskId = args[1];
        String sAssigneeDueDateOpt = args[2];
        int routeSequence = Integer.parseInt(args[3]);
        DomainObject route = new DomainObject(routeId);
        DomainObject inboxTask = new DomainObject(inboxTaskId);
        Date date = new Date();
        String strDate = null;
        ...
        {
            DateFormat dateFormat = new SimpleDateFormat(eMatrixDateFormat.getInputDateFormat());
    ...
    public void inheritAccesstoNewContent(matrix.db.Context context, String[] args) throws Exception {
        for (int i = 0; i < args.length; i++) {
            ...
            for (int k = 0; k < routeAccesList.size(); k++) {
                ...
                DomainAccess.createObjectOwnership(context, (String) args[i], null, (String) AccessMap.get(DomainAccess.KEY_ACCESS_PROJECT) + "_PRJ",
                        (String) AccessMap.get(DomainAccess.KEY_ACCESS_GRANTED),
                        DomainAccess.COMMENT_MULTIPLE_OWNERSHIP_GRANTED + " " + (String) RouteInfo.get("from[" + RELATIONSHIP_OBJECT_ROUTE + "].to.name"), false);
            }
        }
    }
            ...
            if ("Route Template".equals(fromType)) {
                ...
                if (UIUtil.isNotNullAndNotEmpty(routeId)) {
                    ...
                    for (int k = 0; k < routeAccesList.size(); k++) {
                        ...
                        try {
                            ContextUtil.pushContext(context);
                            DomainAccess.createObjectOwnership(context, fromId, null, (String) AccessMap.get(DomainAccess.KEY_ACCESS_PROJECT) + "_PRJ",
                                    (String) AccessMap.get(DomainAccess.KEY_ACCESS_GRANTED), (String) AccessMap.get(DomainAccess.KEY_ACCESS_COMMENT), false);
                        } catch (Exception ex) {
                            throw new FrameworkException(ex);
                        } finally {
                            ContextUtil.popContext(context);
                        ...
                        if ((toName + "_PRJ").equals(((String) m.get("name")))) {
                            ...
                            try {
                                ...
                                for (int j = 0; j < coObjMap.length; j++) {
                                    ...
                                    DomainAccess.createObjectOwnership(context, (String) connectedObjects[j], toId, defaultTemplateAccessMasks,
                                            DomainAccess.COMMENT_MULTIPLE_OWNERSHIP_GRANTED + " " + fromName);
                                }
    ...
    public boolean grantAccessOnRouteContentForMembers(Context context, String[] args) throws Exception {
        ...
        String fromId = args[3];
        String fromType = args[4];
        if (!(DomainObject.TYPE_WORKSPACE.equals(fromType) || DomainObject.TYPE_WORKSPACE_VAULT.equals(fromType) || DomainObject.TYPE_PROJECT_SPACE.equals(fromType)
                || DomainObject.TYPE_PROJECT_CONCEPT.equals(fromType))) {
    ...
    public static String getRouteIdFromRouteTemplate(Context context, String strObjectId) throws Exception, FrameworkException {
        ...
        MapList lstRouteTemplateList = domRoute.getRelatedObjects(context, DomainConstants.RELATIONSHIP_INITIATING_ROUTE_TEMPLATE, "*", selectables, null, true, false, (short) 1, EMPTY_STRING,
                EMPTY_STRING, 0);
    ...
    public static String getRouteTemplateId(Context context, String strObjectId) throws Exception {
        ...
        MapList lstRouteTemplateList = domRoute.getRelatedObjects(context, DomainConstants.RELATIONSHIP_INITIATING_ROUTE_TEMPLATE, "*", selectables, null, false, true, (short) 1, EMPTY_STRING,
                EMPTY_STRING, 0);
    ...
    public static Object getRouteCompletionActionsForRouteCreate(Context context, String[] args) throws Exception, FrameworkException {
    ...
    public static Object getRouteCompletionActionsForRouteProperties(Context context, String[] args) throws Exception, FrameworkException {
        ...
        if (objectId != null) {
            ...
            int limit = 100;
            MapList contentList = routeObject.getRelatedObjects(context, relPattern, typePattern, objectSelects, relSelects, true, false, (short) 0, objectWhere, null, limit);
