...
public class emxEngineeringSubstituteMigrationFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO {
     ...
     * @grade 0
     */
    public emxEngineeringSubstituteMigrationFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public void getIds(Context context, int chunkSize) throws Exception {
        ...
        String command = "temp query bus '" + TYPE_SUBSTITUTE + "' '*' '*'  vault '" + vaultList + "' limit 1 where 'program[" + migrationProgramName
