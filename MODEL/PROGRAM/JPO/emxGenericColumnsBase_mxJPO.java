...
public class emxGenericColumnsBase_mxJPO {
    ...
    public Vector columnName(Context context, String[] args) throws Exception {
        ...
        if (sWindowWidth == null) {
            sWindowWidth = aDimensions[0];
        }
        if (sWindowHeight == null) {
            sWindowHeight = aDimensions[1];
        }

        if (null == sDetails) {
            sDetails = "";
        } else {
            sShowDescription = "false";
            aDetails = sDetails.split(",");
        }
        if (null == sShowDescription) {
            sShowDescription = "true";
        }
        if (null == sShowIcon) {
            sShowIcon = "false";
        }
        ...
        if (null == sParentOID) {
            ...
            sParentOID = "&amp;parentOID=" + sParentOID;
        }
        ...
        if (sShowDescription.equalsIgnoreCase("TRUE")) {
        ...
        for (int i = 0; i < mlOIDs.size(); i++) {
            ...
            if (sUIType.equals("Table")) {
                sbResult.append("<a class='object' href=\"javascript:emxTableColumnLinkClick('emxTree.jsp?mode=insert&objectId=").append(sOID).append("&amp;reldId=").append(sRID)
                        .append("','', '', 'false', 'content', '', '").append(sName).append("', 'false', '')\">");
            } else {
                sbResult.append("<a class='object' href=\"javascript:emxTableColumnLinkClick('emxTree.jsp?mode=insert&amp;objectId=").append(sOID).append("&amp;reldId=").append(sRID)
                        .append("','', '', 'false', 'content', '', '").append(sName).append("', 'true')\">");
            }
    ...
    public Vector columnTNR(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < mlOIDs.size(); i++) {
            ...
            sbResult.append("<span style='display:none;'>").append(sName).append("</span>");
            sbResult.append(
                    "<table style='margin:2px 0px 2px 0px;width:100%'><tr onmouseover='this.lastChild.style.visibility=\"visible\";' onmouseout='this.lastChild.style.visibility=\"hidden\";'>");
            sbResult.append("<td style='vertical-align:middle;width:22px;margin-left:5px;'><img style='vertical-align:middle;margin-right:5px;' src='../common/images/").append(sIcon)
                    .append("'/></td>");
            sbResult.append("<td>");
    ...
    public Vector columnFormat(Context context, String[] args) throws Exception {
        ...
        if (!sStyle.equalsIgnoreCase("")) {
            ...
            if (sBold.equalsIgnoreCase("TRUE")) {
                sbStyle.append("font-weight:bold;");
            }
            if (!sColor.equalsIgnoreCase("")) {
                sbStyle.append("color:").append(sColor).append(";");
            }
            if (sNoWrap.equalsIgnoreCase("TRUE")) {
                sbStyle.append("white-space:nowrap;");
            }
            if (sTextAlign.equalsIgnoreCase("right")) {
                sbStyle.append("text-align:right;");
            }
        }
        ...
        for (int i = 0; i < mlOIDs.size(); i++) {
            ...
            if (!sDecimals.equals("") || !sBase.equals("")) {
                ...
                if (sBase.equalsIgnoreCase("K")) {
                    dDiv = 1000.0;
                } else if (sBase.equalsIgnoreCase("M")) {
                    dDiv = 1000000.0;
                } else if (sBase.equalsIgnoreCase("B")) {
                    dDiv = 1000000000.0;
                } else if (sBase.equalsIgnoreCase("T")) {
                    dDiv = 1000000000000.0;
                }
    ...
    private String getSubscriptionLink(Context context, String[] args, String sOID, String sOIDSubscription, String sRowID, String objType) throws Exception {
        ...
        if ((null != sOIDSubscription) && (!sOIDSubscription.equals(""))) {
            ...
            MapList mlSubscriptions = doSubscription.getRelatedObjects(context, DomainConstants.RELATIONSHIP_PUBLISH, DomainConstants.TYPE_EVENT, busSelectsSubscription, null, false, true, (short) 1,
                    "from[" + DomainConstants.RELATIONSHIP_SUBSCRIBED_PERSON + "].to.name == '" + context.getUser() + "'", "", 0);
    ...
    public Vector columnStatus(Context context, String[] args) throws Exception {
        ...
        if (null != sKeyAdvanced) {
            if (sKeyAdvanced.equalsIgnoreCase("TRUE")) {
                sMode = "advanced";
                sWindowHeight = "680";
            }
        } else {
        ...
        if (null == sKeyCompleteState) {
            sKeyCompleteState = "";
        }
        if (null == sKeyInactivateComp) {
            sKeyInactivateComp = "false";
        }
            ...
            if (isExport) {
                ...
                if (!"".equals(sKeyCompleteState)) {
                    if (!sCurrent.equals(sKeyCompleteState) && !sCurrent.equals(stateLast.getName())) {
                        sbComplete.append("<a href='../common/emxColumnStatusAction.jsp?action=setState&amp;objectId=").append(sOID).append("&amp;rowId=").append(sRowID).append("&amp;state=")
                                .append(sKeyCompleteState).append("&amp;label=").append(XSSUtil.encodeForURL(context, sLabelComplete)).append("' target='listHidden'>");
                        sbComplete.append("<img style='vertical-align:middle;width:16px;' src='../common/images/").append(sKeyCompleteIcon).append("' TITLE='")
                                .append(XSSUtil.encodeForXML(context, sLabelComplete)).append("'/>");
                        sbComplete.append("</a>");
                    } else {
                ...
                if (!"".equals(sKeyInactivateState)) {
                    if ((!sCurrent.equals(sKeyInactivateState) && !sCurrent.equals(stateLast.getName()))
                            && (sKeyCompleteState.equals("") || !sKeyCompleteState.equals(sCurrent) || !sKeyInactivateComp.equalsIgnoreCase("false"))) {
                        // if(true) {
                        sbInactivate.append("<a href='../common/emxColumnStatusAction.jsp?action=setState&amp;objectId=").append(sOID).append("&amp;rowId=").append(sRowID).append("&amp;state=")
                                .append(sKeyInactivateState).append("&amp;label=").append(sLabelInactivate).append("' target='listHidden'>");
                        sbInactivate.append("<img style='vertical-align:middle;width:16px;' src='../common/images/").append(sKeyInactivateIcon).append("' TITLE='").append(sLabelInactivate)
                                .append("'/>");
                    ...
                    if ((!sPolicy.equals(sKeyInactivatePolicy)) && (sKeyCompleteState.equals("") || !sKeyCompleteState.equals(sCurrent) || !sKeyInactivateComp.equalsIgnoreCase("false"))) {
                        sbInactivate.append("<a href='../common/emxColumnStatusAction.jsp?action=setPolicy&amp;objectId=").append(sOID).append("&amp;rowId=").append(sRowID).append("&amp;policy=")
                                .append(sKeyInactivatePolicy).append("&amp;label=").append(sLabelInactivate).append("' target='listHidden'>");
                        sbInactivate.append("<img style='vertical-align:middle;width:16px;' src='../common/images/").append(sKeyInactivateIcon).append("' TITLE='").append(sLabelInactivate)
                                .append("'/>");
                        sbInactivate.append("</a>");
                    } else {
                ...
                if (!sKeyLink.equalsIgnoreCase("FALSE")) {
                    ...
                    sbResult.append(
                            "emxTableColumnLinkClick('../common/emxLifecycle.jsp?suiteKey=Framework&amp;toolbar=AEFLifecycleMenuToolBar&amp;header=emxFramework.Lifecycle.LifeCyclePageHeading&amp;export=false&amp;mode=")
                            .append(sMode).append("&amp;objectId=").append(sOID).append("', '', 'height=").append(sWindowHeight).append(",width=").append(sWindowWidth)
                            .append(",top=' + posTop + ',left=' + posLeft + ',toolbar=no,directories=no,status=no,menubar=no;return false;')\">");
                }
                ...
                sbResult.append("</td>");
                sbResult.append(
                        "<td id='lifeCycleSectionId' style='visibility:hidden;vertical-align:middle;'><table><tr><td id='columnPromoteAction' style='vertical-align:middle;v2isibility:hidden;width:20px'>")
                        .append(sbPromote.toString()).append("</td>");
    ...
    public static Vector controlRelatedItems(Context context, String[] args, String sResourceFile, HashMap settings, MapList mlObjects, String sMode, String sTargetFrame, String sLang)
            throws Exception {
        ...
        if (null != sFrom) {
            if (sFrom.equalsIgnoreCase("false")) {
                bFrom = true;
                bTo = false;
            }
        } else {
        ...
        if (sHighlightZeroTooltip == null) {
            sHighlightZeroTooltip = "There are NO related items";
        } else {
        ...
        if (sHighlightNonzeroTooltip == null) {
            sHighlightNonzeroTooltip = "There ARE related items";
        } else {
        ...
        if (sTableStyles == null) {
            if (sTableColumns.equals("Icon,type,name")) {
        ...
        // String sRowHover =
        // " onmouseover='$(this).children().css(\"color\",\"sColorLink\");$(this).children().css(\"text-decoration\",\"underline\");'
        // onmouseout='$(this).children().css(\"color\",\"#333333\");$(this).children().css(\"text-decoration\",\"none\");' ";
        // String sRowHover =
        // " onmouseover='$(this).find(\"*\").css(\"color\",\"#508cb4\");$(this).find(\"*\").css(\"text-decoration\",\"underline\");'
        // onmouseout='$(this).find(\"*\").css(\"color\",\"#333333\");$(this).find(\"*\").css(\"text-decoration\",\"none\");' ";
        ...
        if (!sSortKey.equals("")) {
            ...
            if (sSortType.equals("")) {
                ...
                } else if (sSortKey.equals("modified")) {
                    sSortType = "date";
                } else if (sSortKey.equals("originated")) {
                    sSortType = "date";
                } else {
                    sSortType = "string";
                }
        ...
        for (int i = 0; i < mlObjects.size(); i++) {
            ...
            if ((bEdit && !sEditCount.equals("")) || !sSortKey.equals("")
                    || (!sHighlightZeroIcon.equals("") || !sHighlightNonzeroIcon.equals("") || !sHighlightZeroStyle.equals("") || !sHighlightNonzeroStyle.equals(""))
                    || sShowCounter.equalsIgnoreCase("TRUE") || sShowIcons.equalsIgnoreCase("true") || sShowThumbnails.equalsIgnoreCase("TRUE") || sShowTable.equalsIgnoreCase("TRUE")) {
            ...
            if (sShowDropZone.equalsIgnoreCase("TRUE")) {
                ...
                if (bEdit) {
                    ...
                    if (bAccess) {
                        ...
                        sbResult.append("<form style='h1eight:").append(sDropZoneHeight).append("px;margin-left: 10px; margin-right:5px;width:30px;' id='").append(sFormId)
                                .append("' action='../common/emxFileUpload.jsp?type=").append(sDropZoneType).append("&amp;relationship=").append(sDropZoneRelationship).append("&amp;objectId=")
                        ...
                        sbResult.append("      ondrop=\"FileSelectHandlerColumn(event,  '").append(sOID).append("', '").append(sFormId).append("', '").append(sDivId).append("', 'id[level]=")
                                .append(sLevel).append(".refreshRow', '").append(sLevel).append("', '', '', '', '").append(sDropZoneRelationship).append("', '', '").append(sDirection)
                                .append("', '');\"");
                ...
                if (bEdit) {
                    ...
                    if (!sAddLink.equals("")) {
                        ...
                        if (sAddText.equals("")) {
                            ...
                            sbResult.append("<div style='color:transparent;' onmouseover='this.style.color=\"#508cb4\";' onmouseout='this.style.color=\"transparent\";' title='").append(sAddTooltip)
                                    .append("' ");
                            sbResult.append(sLinkPrefix);
                            // sbResult.append(sAddLink).append("&amp;objectId=").append(sOID).append("&amp;parentOID=").append(sOID).append("&amp;timeStamp=").append(cal.getTimeInMillis());
                            sbResult.append(sAddLink);
                            ...
                            if (!sAddText.equals("")) {
                                sbResult.append("<span style='").append(sStyleLink).append("'>").append(sAddText).append("</span>");
                            }
                            sbResult.append("</div>");
                        }
                    ...
                    if (!sCreateLink.equals("")) {
                        if (sCreateText.equals("")) {
                            ...
                            sbResult.append("<div style='color:transparent;' onmouseover='this.style.color=\"#508cb4\";' onmouseout='this.style.color=\"transparent\";' title='").append(sCreateTooltip)
                                    .append("' ");
                            sbResult.append(sLinkPrefix);
                            ...
                            if (!sCreateText.equals("")) {
                                sbResult.append("<span style='").append(sStyleLink).append("'>").append(sCreateText).append("</span>");
                            }
                            sbResult.append("</div>");
                        }
                    }
            ...
            if (sShowCounter.equalsIgnoreCase("TRUE")) {
                ...
                if (!sCounterLink.equals("")) {
                    ...
                    if (!sCounterStyle.equals("") || !sHighlightZeroStyle.equals("") || !sHighlightNonzeroStyle.equals("")) {
                        ...
                        sbResult.append(" onmouseover='$(this).css(\"color\",\"").append(sColorLink)
                                .append("\");$(this).css(\"text-decoration\",\"underline\");' onmouseout='$(this).css(\"color\",\"#333333\");$(this).css(\"text-decoration\",\"none\");' ");
                    }
            ...
            try {
                invalidPolicyMsg = com.matrixone.apps.domain.util.MessageUtil.getMessage(context, null, "emxComponents.String.ImageSummaryHover", messageValues, null, locale,
                            ...
                            if (null != commandCreate) {
                                ...
                                if (!sSuiteCommand.equals("")) {
                                    ...
                                    if (!sResult.contains("&StringResourceFileId")) {
                                        sResult += "&StringResourceFileId=" + FrameworkProperties.getProperty(context, "eServiceSuite" + sSuiteCommand + ".StringResourceFileId");
                                    }
        ...
        for (int i = 0; i < mlObjects.size(); i++) {
            ...
            if (bShowDropZone) {
                ...
                sbResult.append("<form id='").append(sFormId).append("' action=\"../common/emxFileUpload.jsp?objectId=").append(sOID).append("&amp;relationship=").append(sFileDropRelationship)
                        .append("&amp;type=").append(sFileDropType).append("\"  method='post'  enctype='multipart/form-data'>");
    ...
    public Vector columnDragIcon(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < mlObjects.size(); i++) {
            ...
            sbResult.append(" href='_param=").append(sID).append("_param=").append(sOID).append("_param=").append(sRID).append("_param=").append(sLevel).append("_param=").append(sParentOID)
                    .append("_param=").append(sType).append("_param=").append(sKind).append("_param=' target='listHidden'>");
    ...
    public List columnAssignment(Context context, String[] args) throws Exception {
        ...
        if (null == sExpandTypes) {
            sExpandTypes = "*";
        }
        if (null == sExpandRelationships) {
            sExpandRelationships = "*";
        }
        if (null != sExpandFrom) {
            if (sExpandFrom.equalsIgnoreCase("TRUE")) {
                bExpandTo = false;
                bExpandFrom = true;
            }
        }
        // if(null == sExpandRootType) { sExpandRootType = "Project Space,Company"; }
        if (null == sExpandRootTypes) {
            sExpandRootTypes = "Project Space";
        }
        if (null == sWidth) {
            sWidth = "100";
        }
    ...
    public Vector columnAssignmentAction(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < mlObjects.size(); i++) {
            ...
            if (sTypes.equals("") || sTypes.contains(sType)) {
                ...
                MapList mlAssignees = dObject.getRelatedObjects(context, sRelationship, DomainConstants.TYPE_PERSON, busSelects, relSelects, bTo, bFrom, (short) 1, "id == '" + sOIDPerson + "'", "",
                        0);
                StringBuilder sbResult = new StringBuilder();
                ...
                if (!sCurrent.equals("Complete")) {
                    ...
                    if (bIsAssigned) {
                        ...
                        sbResult.append(" onclick='window.open(\"../common/emxColumnAssignmentProcess.jsp?mode=remove&amp;relationship=").append(sRelationship).append("&amp;objectId=").append(sOID)
                                .append("&amp;rowId=").append(sRowID).append("&amp;relId=").append(sRID).append("&amp;personId=").append(sOIDPerson).append("\", \"listHidden\", \"\", true);'");
                        sbResult.append(" onmouseout='this.style.background=\"#5F747D\";this.style.color=\"#FFF\";this.style.fontWeight=\"normal\"; this.innerHTML=\"").append(sLabelAssigned)
                                .append("\"'");
                        sbResult.append(
                                " onmouseover='this.style.background=\"#cc0000\"; this.style.color=\"#FFF\";this.style.fontWeight=\"normal\"; this.style.cursor=\"pointer\"; this.innerHTML=\"- ")
                                .append(sLabelUnassign).append("\"'");
                        ...
                        sbResult.append("  onclick='window.open(\"../common/emxColumnAssignmentProcess.jsp?mode=add&amp;relationship=").append(sRelationship).append("&amp;from=").append(sFrom)
                                .append("&amp;objectId=").append(sOID).append("&amp;rowId=").append(sRowID).append("&amp;personId=").append(sOIDPerson).append("\", \"listHidden\", \"\", true);'");
                        ...
                        sbResult.append(
                                " onmouseover='this.style.background=\"#009c00\";    this.style.color=\"#FFF\";this.style.fontWeight=\"normal\"; this.style.cursor=\"pointer\"; this.innerHTML=\"+ ")
                                .append(sLabelAssign).append("\"'");
                        sbResult.append("></div>");
                ...
                sResult = "<div " + sStyleUnassigned + ">---</div>";
            }
    ...
    public MapList retrieveMembers(Context context, String[] args, boolean bKeepContextUser, String sTypes, String sRelationships, Boolean bTo, Boolean bFrom, String sExpandRootTypes)
            throws Exception {
        ...
        MapList mlProjectMembers = dObject.getRelatedObjects(context, sSelectableRelationship, sSelectableType, busSelects, relSelects, false, true, (short) 1, "attribute[" + attrLastName + "] != ''",
                "", 0);
            ...
            for (int i = 0; i < mlObjects.size(); i++) {
                ...
                if (sOID.contains(".")) {
                    ...
                    if (!sOID.contains(":")) {
                        ...
                        if (null == sPhone || "".equals(sPhone)) {
                            sPhone = "<i>not available</i>";
                        }
                        if (null != sEMail) {
                            if (!sEMail.equals("")) {
