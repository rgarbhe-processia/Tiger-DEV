...
public class emxMEPAltSubExtention_mxJPO extends emxMEPAltSubExtentionBase_mxJPO {
    ...
    public emxMEPAltSubExtention_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
