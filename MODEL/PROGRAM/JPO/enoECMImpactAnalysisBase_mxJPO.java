...
public class enoECMImpactAnalysisBase_mxJPO extends DomainObject {
    ...
    public MapList getImpactAnalysisForCO(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            mlIAOutput = getRelatedObjects(context, ChangeConstants.RELATIONSHIP_CHANGE_ACTION + "," + relImpactAnalysis, TYPE_IMPACT_ANALYSIS, objectSelects, relSelects, false, true, recurseToLevel,
    ...
    public MapList getImpactAnalysis(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            mlIAOutput = getRelatedObjects(context, strRelImpactAnalysis, DomainConstants.TYPE_IMPACT_ANALYSIS, objectSelects, relSelects, false, true, recurseToLevel, "",
                    DomainConstants.EMPTY_STRING, 0);
        } catch (Exception Ex) {
            Ex.printStackTrace();
            throw Ex;
    ...
    public StringList excludeConnectedIAs(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList mlImpactAnalysis = getRelatedObjects(context, strRelImpactAnalysis, DomainConstants.TYPE_IMPACT_ANALYSIS, objectSelects, relSelects, false, true, (short) 1, "",
                    DomainConstants.EMPTY_STRING, 0);
