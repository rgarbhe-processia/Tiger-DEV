...
public class emxContextUtilBase_mxJPO {
    ...
    public emxContextUtilBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    protected static String getSuperUserName(Context context) throws Exception {
    ...
    public String getSuperUserPassword(Context context, String[] args) throws Exception {
        return emxcommonPushPopShadowAgent_mxJPO.getShadowAgentPassword(context, args);
    }

    /**
     * This method sets the user context with the user name passed and if no user is passed, then the context will be set with the shadow agent user.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - String containing the user name 1 - String containing the user password 2 - String containing the user vault
     * @return int 0, status code
     * @throws Exception
     *             if the operation fails
     * @since AEF 9.5.1.0
    ...
    public int pushContext(Context context, String[] args) throws Exception {
    ...
    public int popContext(Context context, String[] args) throws Exception {
        ...
        if (contextInfo[1] == null || contextInfo[1].equals("")) {
            context.resetContext(getSuperUserName(context), getSuperUserPassword(context, null), contextInfo[2]);
        }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - String containing the user name
     * @return int 0, status code
     * @throws Exception
     *             if the operation fails
     * @since AEF 9.5.1.0
    ...
    public int pushBeanContext(Context context, String[] args) throws Exception {
        if (keepWorkAround) {
    ...
    public int popBeanContext(Context context, String[] args) throws Exception {
        if (keepWorkAround) {
