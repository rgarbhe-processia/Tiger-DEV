...
/*
 * emxCommonMigration.java program migrates the data into Common Document model i.e. to 10.5 schema.
 *
...
public class emxCommonMigration_mxJPO extends emxCommonMigrationBase_mxJPO {
     ...
     * @grade 0
     */
    public emxCommonMigration_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
