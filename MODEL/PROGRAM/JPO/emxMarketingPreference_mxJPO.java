...
/**
 * This JPO class has some methods pertaining to emxMarketing Preference Rule
 * @author 3d PLM.
 * @version ProductCentral BX-3 - Copyright (c) 1993-2015 Dassault Systemes.
 */
public class emxMarketingPreference_mxJPO extends emxMarketingPreferenceBase_mxJPO {
    /**
     * Create a new emxMarketingPreferenceBase object from a given id.
     * @param context
    ...
    public emxMarketingPreference_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
