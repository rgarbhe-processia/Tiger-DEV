 ...
 ** 
 ** This is the base JPO to provide hook for deletion of missing instances in case of overwrite DO NOT CUSTOMIZE this JPO, use IEFDeleteMissingInstancesForOverwrite for customization.
 ** 
 * @since Sourcing R208
 */
...
public class IEFDeleteMissingInstancesForOverwriteBase_mxJPO {
    ...
    public String deleteInstance(Context context, String[] args) throws Exception {
        ...
        /**
         * busObjectInfoList has 0 = fileAbsPath 1 = busId; 2 = format; 3 = storeName; 4 = choppedFileName;
         */
    ...
    /**
     * This method returns a flag which will ultimately decide whether to delete missing instances in object "overwrite" case. This method can be overridden in child JPO to add additional logic at
     * customer end to contol above behavior.
     */
