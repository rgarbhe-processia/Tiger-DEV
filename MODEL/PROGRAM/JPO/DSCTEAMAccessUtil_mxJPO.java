...
/**
 * ${CLASSNAME} Copyright Dassault Systemes, 1992-2011. All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systemes and its subsidiaries, Copyright notice
 * is precautionary only and does not evidence any actual or intended publication of such program This JPO assigns integrations to given person and updates values of attributes in the corresponding
 * local config object for assigned integrations.
 */
