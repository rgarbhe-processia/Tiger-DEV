...
/**
 * The <code>emxBusinessSkillBase</code> class represents the BusinessSkill JPO functionality for the BusinessSkill
...
public class emxBusinessSkillBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public static final String RELATIONSHIP_SUBSKILL = PropertyUtil.getSchemaProperty("relationship_SubSkill");

    public static final String RELATIONSHIP_ORGANIZATIONSKILL = PropertyUtil.getSchemaProperty("relationship_OrganizationSkill");

    public static final String RELATIONSHIP_HASBUSINESSSKILL = PropertyUtil.getSchemaProperty("relationship_hasBusinessSkill");

    public static final String ATTRIBUTE_COMPETENCY = PropertyUtil.getSchemaProperty("attribute_Competency");

    public static final String ATTRIBUTE_EXPERIENCE = PropertyUtil.getSchemaProperty("attribute_Experience");
     ...
     * @grade 0
     */
    public emxBusinessSkillBase_mxJPO(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectId of the BusinessSkill
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectId of the BusinessSkill 1 - name of the BusinessSkill
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: objectId - the context BusinessSkill object
    ...
    public MapList ListBusinessSkillPersons(Context context, String[] args) throws Exception {
        ...
        MapList mapPersons = objSkill.getRelatedObjects(context, RELATIONSHIP_HASBUSINESSSKILL, "*", busSelects, relSelects, true, false, (short) 0, "", "", 0, null, null, null);
     ...
     * @since since R210
     */
    public String getBusinessSkills(Context context, String[] args) throws Exception {
     ...
     * @since since R210
     */
    public static Map getRangeValuesForBusinessSkills(Context context, String args[]) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing Map entries for the key "paramList" and "objectList"
     * @return Object of type Vector
     * @throws Exception
     *             if the operation fails
     * @since Common 10.5.1.2
     */
    public Object retrieveEmployeeDate(Context context, String[] args) throws Exception {
    ...
    public static void DeleteBusinessSkills(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < sDeleteIdList.size(); i++) {
            ...
            sbMqlCommand.append("delete bus ");
            sbMqlCommand.append((String) sDeleteIdList.get(i));
            sbMqlCommand.append(";");
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList ListPersonBusinessSkills(Context context, String[] args) throws Exception {
        // get the id of the BusinessSkill
        ...
        MapList mapSkills = objSkill.getRelatedObjects(context, RELATIONSHIP_HASBUSINESSSKILL, "*", busSelects, relSelects, false, true, (short) 1, "", "", 0, null, null, null);
        String roleResourceManager = PropertyUtil.getSchemaProperty(context, "role_ResourceManager");
        boolean hasEditAccess = PersonUtil.getAssignments(context).contains(roleResourceManager);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectId of Parent skill 1 - objectId of Sub skill
     * @throws Exception
     *             if the operation fails
     * @since Common 10.5.1.2
     */
     ...
     * @param args
     *            Packed arguments sent by UITable Component
    ...
    public MapList getTableExpandChildBusinessSkillData(Context context, String[] args) throws Exception {
        ...
        MapList mlRelatedObjects = getSubSkill(context, strObjectId, strExpandFilter);
     ...
     */
    private MapList getSubSkill(Context context, String strObjectId, String strExpandFilter) throws FrameworkException {
        final String RELATIONSHIP_SUBSKILLS = PropertyUtil.getSchemaProperty(context, "relationship_SubSkill");
        final String SELECT_SUBSKILL_IDS = "from[" + RELATIONSHIP_SUBSKILLS + "].to.id";
        ...
        MapList mlRelatedObjects = dmoObject.getRelatedObjects(context, strRelationshipPattern, // pattern to match relationships
     ...
     *            Matrix Context object
     * @param args
     *            packed arguments sent by UI Table components
    ...
    public Vector getColumnCountData(Context context, String[] args) throws Exception {
        try {
            ...
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext();) {
                ...
                DomainObject dmoObject = DomainObject.newInstance(context, strObjectId);
                if (isRootNode) {
                    MapList mlRelatedObjects = getSubSkill(context, strObjectId, "1");
    ...
    /**
     * getSkillTypePolicy - This Method populates the policy for Business Skill Used in emxBusinessSkill WebForm
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectList - Contains a MapList of Maps which contains object names
     * @return Vector of "Policy" values for the combobox
     * @throws Exception
     *             if the operation fails
     */
    public HashMap getSkillTypePolicy(Context context, String[] args) throws Exception {
        try {
