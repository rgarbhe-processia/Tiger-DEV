...
public class emxAdminCacheBase_mxJPO {
     ...
     * @since AEF 10.Next
     */
    public emxAdminCacheBase_mxJPO(Context context, String[] args) throws Exception {
    }
     ...
     * @since AEF 10.Next
     */
    public static void putUnresolvedReferences(Context context, String sAdminType, String sSymbolicName, ArrayList aUnresolvedReferences) throws Exception {
        // load symbolic names first time
        if (adminCache == null) {
            loadAdminCache(context);
        }
