...
public class emxSchemaDefinitionBase_mxJPO {
    ...
    /**
     * Constructor. Should be used while firing JPO throgh command line
     * @param context
     ...
     * @since AEF 10.Next
     */
    public emxSchemaDefinitionBase_mxJPO(Context context, String[] args) throws Exception {
     ...
     * @since AEF 10.Next
     */
    public emxSchemaDefinitionBase_mxJPO(Context context, File schemaDefFile, emxAppVersionUtil_mxJPO appVersions) throws Exception {
     ...
     * @since AEF 10.Next
     */
    public emxSchemaDefinitionBase_mxJPO() throws Exception {
    }
     ...
     * @since AEF 10.Next
     */
    public TreeMap getCommandList(Context context, emxSchemaDefinition_mxJPO customSDF) throws Exception {
    ...
    /**
     * Replaces environment variables in the command with their values The environment variables are prefixed and suffixed by <ENV> and </ENV> tags.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param sCmd
     ...
     * @since AEF 10.Next
     */
    private static String removeUnresolvedSchemaReferences(Context context, String sAdminSymbolicName, String sName, String sInputCmd) throws Exception {
        // get admin type
     ...
     * @since AEF 10.Next
     */
    private static String removeUnresolvedSchemaReferences(Context context, String sAdminSymbolicName, ArrayList aFieldKeyWords, String sInputCmd) throws Exception {
        String sCmd = sInputCmd;
    ...
    /**
     * Replaces symbolic names in the command with their values The symbolic names are prefixed and suffixed by <SYM> and </SYM> tags.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param sCmd
     *            the command to be processed
     ...
     * @since AEF 10.Next
     */
    public void install(Context context, String sInstallVersion, PrintStream fMQLLog) throws Exception {
     ...
     * @since AEF 10.Next
     */
    public void install(Context context, String sInstallVersion, PrintStream fMQLLog, emxSchemaDefinition_mxJPO customSDF) throws Exception {
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                if (schemaVersion != null && schemaVersion.length() > 0 && appVersionUtil.compareVersion(context, sAdminType, sName, sInstallVersion, schemaVersion) == 1) {
                    if (appVersionUtil.compareVersion(context, sAdminType, sName, sVersion, schemaVersion) >= 2) {
                        continue;
                    }
                ...
                if (sDBName == null || appVersionUtil.compareVersion(context, sAdminType, sName, sVersion, sDBVersion) > 0) {
                    ...
                    if (!aCmds.isEmpty()) {
                        if (sAdminType.equalsIgnoreCase("policy")) {
                            emxAdminCache_mxJPO.refreshStateSymbolicNames(context, sSymbolicName, true);
                        }
                        ...
                        if (sDBName == null) {
                            ...
                            sCmd = "add property \"" + sSymbolicName + "\" " + "on program \"" + SCHEMA_MAPPING_PROGRAM + "\" " + "to " + sAdminType + " \"" + sName + "\"";
                            emxInstallUtil_mxJPO.executeMQLCommand(context, sCmd);
     ...
     * @since AEF 10.Next
     */
    public void install(Context context, String args[]) throws Exception {
     ...
     * @since AEF 10.Next
     */
    public void resolve(Context context, PrintStream fMQLLog, emxSchemaDefinition_mxJPO customSDF) throws Exception {
        // Get all the commands
        TreeMap hCommandList = getCommandList(context, customSDF);
     ...
     * @since AEF 10.Next
     */
    private static ArrayList resolveSchemaReferences(Context context, String sAdminSymbolicName, MxLinkedHashMap aFieldKeyWords, ArrayList aRefAdmins, ArrayList aInputCmd) throws Exception {
