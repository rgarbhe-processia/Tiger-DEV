 ...
 *
 * FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.8 $" Date : "$Date: Wed Oct 22 15:53:02 2008 $"
 *
 */
...
public class emxAbsPDFEnqueueBase_mxJPO {
     ...
     * @param args
     *            Contains a map that has been packed by JPO.packArgs That map Contains: "objectId" - String, Object Id "fileList" - LinkedList, the list of files to print
     * @exception Exception
     *                IllegalArgumentException, if wrong args are passed in
     * @since AEF 9.5.4.0
     */
    ...
    /**
     * Main execution method from a JavaBean This will unpack any args, and then it will invoke the protected enqueue method. That method will build the PDFQueue, PDFDocuments and pass them to the
     * integration
     * @param context
    ...
    /**
     * This method will build the PDFQueue, PDFDocuments and pass them to the integration
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            Object Id
     ...
     * @since AEF 9.5.4.0
     */
    protected emxPDFDocument_mxJPO createPDFDocuments(Context context, String fileName, String objectId) {
        /*
         * Author : DJ Date : 02/04/2003 Notes : History :
         */
