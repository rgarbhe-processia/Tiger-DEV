...
/*
 * ProductsDerivationMigrationBase.java program migrates the Products to Derivation Data Model
 *
...
/**
 * The <code>ProductsDerivationMigrationBase</code> class contains code to migrate Product structure of the Models found in ProductsDerivationMigrationFindObjects.java. This needs to be done for
 * supporting Derivation in 2014x
 */
public class ProductsDerivationMigrationBase_mxJPO extends emxCommonMigration_mxJPO {
     ...
     */
    public ProductsDerivationMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
        warningLog = new FileWriter(documentDirectory + "ProductDerivationMigration.log", true);
    }

    /**
     * This method is executed if a specific method is not specified. This method checked for the status property and go ahead with migration if Prechecks are completed.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
                ...
                try {
                    ...
                    if (mapModel.size() != 0) {
                        ...
                        while (itr.hasNext()) {
                            ...
                            if (ProductLineCommon.isNotNull(strType) && mxType.isOfParentType(context, strType, ProductLineConstants.TYPE_PRODUCTS)) {
