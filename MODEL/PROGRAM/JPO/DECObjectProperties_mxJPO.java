...
public class DECObjectProperties_mxJPO {
    ...
    public String getRevision(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * HashMap selectDataMap = null; if(selectDataMap != null && selectDataMap.size() > 0) { System.out.println("--inside getRev..."); revision = (String)selectDataMap.get("revision"); }else {
             * System.out.println("--inside getRev. ELSE..");
             * 
             * HashMap dataMap = this.getSelectDataForTable(context,objectId,language); System.out.println("--inside getRev. ELSE.."+dataMap); revision = (String)selectDataMap.get("revision"); }
             */
        } catch (Exception e) {
    ...
    public String getPolicy(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * 
             * HashMap params = (HashMap)JPO.unpackArgs(args); System.out.println("--params."+params); HashMap requestMap = (HashMap)params.get("requestMap"); localeLanguage =
             * requestMap.get("languageStr").toString(); HashMap selectDataMap = null; if(selectDataMap != null && selectDataMap.size() > 0) {
             * 
             * policy = (String)selectDataMap.get("policy"); policy = MCADMxUtil.getNLSName(context, "Policy", policy, "", "", localeLanguage); } else {
             * 
             * String objectId = (String) requestMap.get("objectId"); HashMap dataMap = this.getSelectDataForTable(context,objectId,localeLanguage); policy = (String)selectDataMap.get("policy");
             * policy = MCADMxUtil.getNLSName(context, "Policy", policy, "", "" , localeLanguage);
             * 
             * }
             */
    ...
    public String getOwner(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * HashMap params = (HashMap)JPO.unpackArgs(args); System.out.println("--params."+params); HashMap requestMap = (HashMap)params.get("requestMap"); localeLanguage =
             * requestMap.get("languageStr").toString(); HashMap selectDataMap = null; if(selectDataMap != null && selectDataMap.size() > 0) { owner = (String)selectDataMap.get("owner"); owner =
             * MCADMxUtil.getNLSName(context, MCADMxUtil.getActualNameForAEFData(context, "type_Person"), owner, "", "", localeLanguage);
             * 
             * }else { String objectId = (String) requestMap.get("objectId"); HashMap dataMap = this.getSelectDataForTable(context,objectId,localeLanguage); owner = (String)selectDataMap.get("owner");
             * owner = MCADMxUtil.getNLSName(context, MCADMxUtil.getActualNameForAEFData(context, "type_Person"), owner, "", "" , localeLanguage);
             * 
             * }
             */
    ...
    public String getTitle(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * HashMap selectDataMap = null; if(selectDataMap != null && selectDataMap.size() > 0) { title = (String)selectDataMap.get("title"); } else { HashMap params =
             * (HashMap)JPO.unpackArgs(args); System.out.println("--params."+params); HashMap requestMap = (HashMap)params.get("requestMap"); String objectId = (String) requestMap.get("objectId");
             * String language = (String) requestMap.get("languageStr"); HashMap dataMap = this.getSelectDataForTable(context,objectId,language); title = (String)selectDataMap.get("title"); }
             */
        } catch (Exception e) {
        }
        return title;
    ...
    public String getRenamedFrom(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * HashMap selectDataMap = null; if(selectDataMap != null && selectDataMap.size() > 0) { renamedFrom = (String)selectDataMap.get("renamedFrom"); }else { HashMap params =
             * (HashMap)JPO.unpackArgs(args); System.out.println("--params."+params); HashMap requestMap = (HashMap)params.get("requestMap"); String objectId = (String) requestMap.get("objectId");
             * String language = (String) requestMap.get("languageStr"); HashMap dataMap = this.getSelectDataForTable(context,objectId,language); renamedFrom =
             * (String)selectDataMap.get("renamedFrom"); }
             */
        } catch (Exception e) {
        }
        return renamedFrom;
    ...
    public String getLocker(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * HashMap params = (HashMap)JPO.unpackArgs(args); System.out.println("--params."+params); HashMap requestMap = (HashMap)params.get("requestMap"); localeLanguage =
             * requestMap.get("languageStr").toString(); HashMap selectDataMap = null; if(selectDataMap != null && selectDataMap.size() > 0) { locker = (String)selectDataMap.get("locker"); locker =
             * MCADMxUtil.getNLSName(context, MCADMxUtil.getActualNameForAEFData(context, "type_Person"), locker, "", "" , localeLanguage);
             * 
             * 
             * }else { String objectId = (String) requestMap.get("objectId"); HashMap dataMap = this.getSelectDataForTable(context,objectId,localeLanguage); locker =
             * (String)selectDataMap.get("locker"); locker = MCADMxUtil.getNLSName(context, MCADMxUtil.getActualNameForAEFData(context, "type_Person"), locker, "", "", localeLanguage);
             * 
             * 
             * }
             */
    ...
    public String getCurrent(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * HashMap params = (HashMap)JPO.unpackArgs(args); System.out.println("--params."+params); HashMap requestMap = (HashMap)params.get("requestMap"); localeLanguage =
             * requestMap.get("languageStr").toString(); HashMap selectDataMap = null; if(selectDataMap != null && selectDataMap.size() > 0) { policy = (String)selectDataMap.get("policy"); state =
             * (String)selectDataMap.get("state"); state = MCADMxUtil.getNLSName(context, "State", state, "Policy", policy , localeLanguage); } else { String objectId = (String)
             * requestMap.get("objectId"); HashMap dataMap = this.getSelectDataForTable(context,objectId,localeLanguage); policy = (String)dataMap.get("policy"); state = (String)dataMap.get("state");
             * state = MCADMxUtil.getNLSName(context, "State", state, "Policy", policy , localeLanguage); }
             */
        } catch (Exception e) {
        }
    ...
    public String getType(Context context, String[] args) throws Exception {
        ...
        try {
             ...
             * 
             * HashMap params = (HashMap)JPO.unpackArgs(args); System.out.println("--params."+params); HashMap requestMap = (HashMap)params.get("requestMap"); localeLanguage =
             * requestMap.get("languageStr").toString(); HashMap selectDataMap = null; System.out.println("---selectDataMap--"+selectDataMap);
             * 
             * if(selectDataMap != null && selectDataMap.size() > 0) { type = (String)selectDataMap.get("type"); type = MCADMxUtil.getNLSName(context, "Type", type, "", "" , localeLanguage); }else {
             * objectId = (String) requestMap.get("objectId"); HashMap dataMap = this.getSelectDataForTable(context,objectId,localeLanguage); type = (String)selectDataMap.get("type"); type =
             * MCADMxUtil.getNLSName(context, "Type", type, "", "" , localeLanguage); }
             */
        } catch (Exception e) {
        }
        return type;
    ...
    public String getCheckinComment(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * HashMap selectDataMap = null; if(selectDataMap != null && selectDataMap.size() > 0) { checkInComment = (String)selectDataMap.get("checkInComment"); } else { HashMap params =
             * (HashMap)JPO.unpackArgs(args); System.out.println("--params."+params); HashMap requestMap = (HashMap)params.get("requestMap"); String objectId = (String) requestMap.get("objectId");
             * String language = (String) requestMap.get("languageStr"); HashMap dataMap = this.getSelectDataForTable(context,objectId,language);
             * 
    ...
    public String getDescription(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * HashMap selectDataMap = null; if(selectDataMap != null && selectDataMap.size() > 0) { description = (String)selectDataMap.get("description"); } else { HashMap params =
             * (HashMap)JPO.unpackArgs(args); System.out.println("--params."+params); HashMap requestMap = (HashMap)params.get("requestMap"); String objectId = (String) requestMap.get("objectId");
             * String language = (String) requestMap.get("languageStr"); HashMap dataMap = this.getSelectDataForTable(context,objectId,language);
             * 
    ...
    public String getName(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * 
             * HashMap selectDataMap = null; if(selectDataMap != null && selectDataMap.size() > 0) { name = (String)selectDataMap.get("name"); } else { HashMap params = (HashMap)JPO.unpackArgs(args);
             * System.out.println("--params."+params); HashMap requestMap = (HashMap)params.get("requestMap"); String objectId = (String) requestMap.get("objectId"); String language = (String)
             * requestMap.get("languageStr"); HashMap dataMap = this.getSelectDataForTable(context,objectId,language);
             * 
             * name = (String)dataMap.get("name"); }
             */
        } catch (Exception e) {
    ...
    private boolean isMinorType(Context context, String objectId, String language) {
        ...
        try {
             ...
             * 
             * IEFSimpleConfigObject simpleGCO = IEFSimpleConfigObject.getSimpleGCO(context, integrationName); Hashtable typeMapping =
             * simpleGCO.getAttributeAsHashtable(MCADMxUtil.getActualNameForAEFData(context, "attribute_MCADInteg-BusTypeMapping"), "\n", "|");
             * 
             * Vector mxTypes = new Vector();
             * 
             * Enumeration enumTypeMapping = typeMapping.elements() ; while(enumTypeMapping.hasMoreElements()) { String sTypes = (String)enumTypeMapping.nextElement(); StringTokenizer tokenizer = new
             * StringTokenizer(sTypes, ","); while(tokenizer.hasMoreElements()) { String sType = (String) tokenizer.nextElement(); mxTypes.addElement(sType.trim()); } } BusinessObject busObj = new
             * BusinessObject(objectId); busObj.open(context); type = busObj.getTypeName(); busObj.close(context);
             * 
             * if(!mxTypes.contains(type)) isMinor = true;
             */
