...
public class emxWorkflowTaskBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public emxWorkflowTaskBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public void suspend(Context context, String[] args) throws Exception {
        ...
        MapList workflowList = taskObj.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, relSelects, true, false, (short) 0, null, // objectWhere
                null, // relWhere,
                null, null, null);
    ...
    private void updateAssignee(Context context, String taskId, String personName) throws Exception {
        ...
        MapList personList = domObj.getRelatedObjects(context, relPattern.getPattern(), "Person", typeSelects, relSelects, false, true, (short) 0, null, // objectWhere
                null, // relWhere,
                null, null, null);
        ...
        /*
         * Bug - 319310 - Start If relid is null means task is assigned to a role, so do the task assignment via the super user If relid is not null then do the task assignment as task owner as owner
         * has all access.
         */
        if (relId == null) {
    ...
    public void reassign(Context context, String[] args) throws Exception {
        ...
        String[] messageValues = { taskObj.getInfo(context, "type"), taskObj.getInfo(context, "name"), workflowObj.getInfo(context, "type"), workflowObj.getInfo(context, "name"),
    ...
    public String getWorkflowTaskAttributes(Context context, String[] args) throws Exception {
        ...
        _localDateFormat = ((java.text.SimpleDateFormat) java.text.DateFormat.getDateInstance(eMatrixDateFormat.getEMatrixDisplayDateFormat(), Locale.US)).toLocalizedPattern();
        ...
        try {
            ...
            StringList relSelects = new StringList(1);
            relSelects.add(DomainObject.SELECT_RELATIONSHIP_ID);
            MapList workflowList = taskObject.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, relSelects, true, false, (short) 0, null, // objectWhere
                    null, // relWhere,
                    null, null, null);
    ...
    public void updateWorkflowTaskAttributes(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        String objectId = (String) paramMap.get("objectId");
    ...
    private static void performPostCompleteActions(Context context, String taskId) throws Exception {
        ...
        MapList workflowList = dObj.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, relSelects, true, false, (short) 1, null, // objectWhere
                null, // relWhere,
                null, null, null);
     ...
     * @grade 0
     */
    public void notifyOwnerofNewDeliverables(Context context, String[] args) throws Exception {
