...
/**
 * The <code>emxSchemaManifest</code> class contains method for the "Collection" Common Component.
 * @version AEF 10.Next - Copyright (c) 2003, MatrixOne, Inc.
 */

public class emxSchemaManifest_mxJPO extends emxSchemaManifestBase_mxJPO {
    ...
    public emxSchemaManifest_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
