...
public class emxGetMarkupBase_mxJPO {
    ...
    public emxGetMarkupBase_mxJPO(Context context, String[] args) throws Exception {
     ...
     * @since AEF
     */
    public static Vector getMarkupLink(Context context, String[] args) throws Exception {
        ...
        if (relBusObjPageList != null) {
            for (int i = 0; i < relBusObjPageList.size(); i++) {
                ...
                try {
                    ...
                    linkString = "<A HREF='/servlet/" + servlet + "?mid=" + XSSUtil.encodeForURL(context, id) + "' TARGET='_blank'>" + "<IMG SRC='images/iconActionCreateMarkup.gif' BORDER='0' ALT='"
                            + servletAlt + "'>" + XSSUtil.encodeForURL(context, name) + "</A>";
                } catch (Exception e) {
                }
