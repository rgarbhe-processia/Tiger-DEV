 ...
 * 
 * @quickreview T25 DJH 13:08:16 : IR IR-248763V6R2014x : Test Execution command disappear when Test case promoted to Completed state.Modified method showTestExecutionLinksToAssignedQE to show Action
 * menu when Test Case is in Complete State.
 * 
 * @quickreview ZUD DJH 13:11:12 : IR IR-261269V6R2014x : STP: Actual Completion Date is not getting updated for Test case even when user promoted the test case to complete state. Added New Function
 * SetTestCaseCompletionDate.
 * 
...
/**
 * The <code>emxTestExecutionBase</code> JPO class that holds methods for executing JPO operations related to objects of the type Test Execution
...
public class emxTestExecutionBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @param args
     *            holds the packed arguments
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-6
     */

    public emxTestExecutionBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
     ...
     * @return a <code>String</code> object having HTML output for the Slip Days field in Test Execution Properties page
     * @throws Exception
     *             if the operation fails
     ...
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
     * @return a <code>MapList</code> object having the list of all related Test Executions for the context Object.
     * @throws Exception
     *             if the operation fails
     * @since Product Central 10-6
     */
    ...
    public MapList getRelatedTestExecutions(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (strParentObjType.equals(DomainConstants.TYPE_ENGINEERING_CHANGE)) {
                ...
                returnMapList = getRelatedObjects(context, strParentRelName, // Relationship name
                        DomainConstants.TYPE_TEST_EXECUTION, // get type Test Execution
                        objectSelects, relSelects, false, true, // Get the to end of the rel
                        recurseToLevel, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
            } else if (strParentObjType.equals(DomainConstants.TYPE_TEST_CASE)) // added condition for HL Test Execution under Test Case without an EC
            {
                ...
                returnMapList = getRelatedObjects(context, strParentRelName, // Relationship name
                        DomainConstants.TYPE_TEST_EXECUTION, // get type Test Execution
                        objectSelects, relSelects, true, // get To relationships for the Test Case
                        false, recurseToLevel, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
    ...
    /**
     * The method is used to fill the Slip Days column in Test Execution Summary Table . Returns the Slip Days for each Test Execution in its summary page.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    /**
     * The method is used display the WBS number indicating the hierarchical levels of Test Cases connected to the Test Execution object. This information is available as the 'Task WBS' attribute on
     * the relationship between the Test Execution and connected Test Case children. e.g. If a parent Engineering Change object 'EC1' has 2 Test Case siblings TC1, TC2 and TC1 has 2 next level Test
     * Case children 'TC11' and 'TC111', the WBS numbers set for the Test Execution Test Cases relationship are 1, 1.1, 1.1.1 and 2 respectively for 'TC1', 'TC11', 'TC111', 'TC2' objects.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id list
    ...
    /**
     * Access program for showing 'Create New'/'Edit All'/'Delete' Test Execution action links to Parent Object's owner or assigned 'Software Quality Engineer' or 'Quality Manager' or 'Senior Quality
     * Engineer' of the parent object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
    ...
    public boolean showTestExecutionLinksToAssignedQE(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strFormalApproval = FrameworkUtil.lookupStateName(context, strParentObjPolicy, EC_STATE_FORMAL_APPROVAL);
            String strClose = FrameworkUtil.lookupStateName(context, strParentObjPolicy, EC_STATE_CLOSE);
            String strReject = FrameworkUtil.lookupStateName(context, strParentObjPolicy, EC_STATE_REJECT);
            String strComplete = FrameworkUtil.lookupStateName(context, strParentObjPolicy, EC_STATE_COMPLETE);

            // If the current state of the EC object is Close, Reject,Complete or Formal Approval ,
            // the commands will not be shown
            if (strParentObjState.equals(strFormalApproval) || strParentObjState.equals(strClose) || strParentObjState.equals(strReject) || strParentObjState.equals(strComplete)) {
                ...
                if (strContextUser.equals(strParentObjOwner)) {
                    ...
                    parentObjAssigneeMapList = parentDomObj.getRelatedObjects(context, strParentRelName, // Relationship name
                            DomainConstants.TYPE_PERSON, // get type Persom
                            objectSelects, new StringList(), true, // Get the from end of the rel
                            false, recurseToLevel, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
                    ...
                    while (mListItr.hasNext()) {
                        ...
                        if (strContextUser.equals(tmpAssigneeName)) {
                            ...
                            if (tmpAssigneeObj.isAssigned(context, ProductLineConstants.ROLE_QUALITY_MANAGER) || tmpAssigneeObj.isAssigned(context, ProductLineConstants.ROLE_SENIOR_QUALITY_ENGINEER)
    ...
    /**
     * The method is used to display Status gif column in Test Case Summary table of Test Execution. Green indicates and red indicates
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing object id list
    ...
    /**
     * This trigger method notifies all the Person objects connected to the Test Execution by "Assigned Test Execution" relationship when the Test Execution is promoted from the Create state. The
     * notification message contains the <TYPE><NAME><REVISION>of the Test Execution.
     * @param context
     *            The ematrix context of the request
     * @param args
     *            String Array with following arguments: 0 - The Object Id of the context Test Execution.
     * @throws Exception
     * @throws FrameworkException
     * @since ProductCentral 10.6
     */
    public void notifyAssignees(Context context, String[] args) throws Exception, FrameworkException {
        ...
        // the symbolic name
        String strRelAssignedTestExecution = PropertyUtil.getSchemaProperty(context, RELATIONSHIP_ASSIGNED_TESTEXECUTION);

        // Create a new domain object representing the Test Execution
        DomainObject domTest = DomainObject.newInstance(context, strObjectId);
        ...
        List assigneeList = (MapList) domTest.getRelatedObjects(context, strRelAssignedTestExecution, DomainConstants.TYPE_PERSON, slObjectSelects, null, true, false, (short) 1, null, null);

        // Form the stringlist of all the assignee names to send the message
        StringList slAssigneeList = new StringList();
        for (int i = 0; i < assigneeList.size(); i++) {
            slAssigneeList.addElement((String) ((Map) assigneeList.get(i)).get(DomainConstants.SELECT_NAME));
        }
        ...
        emxMailUtilBase_mxJPO.sendNotification(context, slAssigneeList, null, null, strSubjectKey, subjectKeys, subjectValues, strMessageKey, messageKeys, messageValues, slAttachments, null);

    }

    /**
     * This trigger method notifies the Assignee about the Test Execution assignment when a new relationship "Assigned Test Execution" is created between Test Execution and Person object. The
     * notification is sent only if Test Execution is not in Create state.
     * @param context
     *            The ematrix context of the request
     * @param args
    ...
    public void notifyAssignee(Context context, String[] args) throws Exception, FrameworkException {
        ...
        DomainObject domEC = DomainObject.newInstance(context, strObjId);
        ...
        Map mapECInfo = domEC.getInfo(context, (StringList) lstObjectSelects);
        String strStateSubmit = FrameworkUtil.lookupStateName(context, (String) mapECInfo.get(DomainConstants.SELECT_POLICY), "state_Create");

        List lstStateList = (StringList) mapECInfo.get(DomainConstants.SELECT_STATES);
        String strCurrentState = (String) mapECInfo.get(DomainConstants.SELECT_CURRENT);

        if (lstStateList.indexOf(strCurrentState) > lstStateList.indexOf(strStateSubmit)) {
            ...
            String strSubjectKey = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Message.Subject.TestExecutionAssigned", strLanguage);
            String strMessageKey = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Message.Description.TestExecutionAssigned", strLanguage);
            strMessageKey = MessageUtil.substituteValues(context, strMessageKey, strObjId, strLanguage);
            String[] subjectKeys = {};
            String[] subjectValues = {};
            String[] messageKeys = {};
            String[] messageValues = {};
            ...
            emxMailUtilBase_mxJPO.sendNotification(context, (StringList) lstAssigneeList, null, null, strSubjectKey, subjectKeys, subjectValues, strMessageKey, messageKeys, messageValues,
                    (StringList) lstAttachments, null);
        }
    }

    /**
     * This trigger method sets the value of the attribute "Actual Start Date" to the current system date when the Test Execution is promoted to In Progress state.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            The string array containing the following elements: 0 - The object id of the context Test Execution
     * @throws Exception
     * @throws FrameworkException
     */
    public void populateActualStartDate(Context context, String[] args) throws Exception, FrameworkException {

        // Call the setToCurrentDate method passing the object id and attribute
        // name
        setToCurrentDate(context, args[0], DomainConstants.ATTRIBUTE_ACTUAL_START_DATE);
    }

    /**
     * This trigger method sets the value of the attribute "Actual End Date" to the current system date when the Test Execution is promoted to Complete state.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            The string array containing the following elements: 0 - The object id of the context Test Execution
     ...
     * @throws FrameworkException
     */
    public void populateActualEndDate(Context context, String[] args) throws Exception, FrameworkException {

        // Call the setToCurrentDate method passing the object id and attribute
        // name
        setToCurrentDate(context, args[0], DomainConstants.ATTRIBUTE_ACTUAL_END_DATE);
    }

    /**
     * This method sets the attribute of type date to the current system date. It accepts the object id and the actual name of the attribute as arguments.
     * @param context
     *            The ematrix context of the request.
     * @param strObjectId
     *            The object id
     ...
     * @throws FrameworkException
     */
    protected void setToCurrentDate(Context context, String strObjectId, String strAttribName) throws Exception, FrameworkException {
        // Get the current system date
        Calendar cal = Calendar.getInstance();
        cal.add(Calendar.SECOND, -1);
        Date date = cal.getTime();
        SimpleDateFormat mxDateFormat = new SimpleDateFormat(eMatrixDateFormat.getEMatrixDateFormat(), Locale.US);
        String strDate = mxDateFormat.format(date);

        // Set the attribute to the system date
        DomainObject domTest = DomainObject.newInstance(context, strObjectId);
        domTest.setAttributeValue(context, strAttribName, strDate);
    }
    ...
    /**
     * This trigger method sets the value of the attribute "Actual Completion Date" to the current system date when the Test case is promoted to complete state.
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            The string array containing the following elements: 0 - The object id of the context Test Execution
     ...
     * @throws FrameworkException
     */
    public void SetTestCaseCompletionDate(Context context, String[] args) throws Exception, FrameworkException {
        try {
