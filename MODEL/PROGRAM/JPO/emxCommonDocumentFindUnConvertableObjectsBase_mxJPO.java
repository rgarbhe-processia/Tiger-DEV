...
public class emxCommonDocumentFindUnConvertableObjectsBase_mxJPO {
     ...
     * @grade 0
     */
    public emxCommonDocumentFindUnConvertableObjectsBase_mxJPO(Context context, String[] args) throws Exception {
    }
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        ...
        /*
         * JPO.invoke(context, // matrix context "emxCommonDocumentMigration", // program name null, // constructor arguments "scanObjects", // method name args); // method arguments
         */
