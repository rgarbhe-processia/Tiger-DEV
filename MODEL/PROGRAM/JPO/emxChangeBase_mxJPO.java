...
/**
 * The <code>ChangeBase</code> class contains methods for executing JPO operations related to objects of the admin type Change.
 * @author Cambridge
...
public class emxChangeBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    /*********************************
     * ADMIN TYPE SELECTABLES /********************************* /** relationship "Affected Item".
     */
    ...
    /*********************************
     * OPERATOR SYMBOLS /********************************* /** A string constant with the value &&.
     */
    ...
    /*********************************
     * CUSTOM FILTER FIELDS /********************************* /** A string constant with the value "field_choices".
     */
    ...
    /*********************************
     * STRING RESOURCES FIELDS /********************************* /** A string constant with the value "emxComponentsStringResource".
     */
    protected static String RESOURCE_BUNDLE_COMPONENTS_STR = "emxComponentsStringResource";

    /*********************************
     * MAP SELECTABLES /********************************* /** A string constant with the value "objectId".
     */
    ...
    /*********************************
     * REQUEST PARAMETERS /********************************* /** A string constant with the value "selection".
     */
    ...
    /*********************************
     * MQL COMMAND KEYWORDS /********************************* /** A string constant with the value "select".
     */
     ...
     * @since Common X3.
     */
    public int assignNotifyUserByAttribute(Context context, String args[]) throws Exception {
        ...
        int inotify = 0;
        if (strAssignNotify.equalsIgnoreCase("AssignNotify") && strNewOwner != null && !strNewOwner.equals("")) {
        ...
        } else if (strAssignNotify.equalsIgnoreCase("Assign") && strNewOwner != null && !strNewOwner.equals("")) {
            setOwner(context, strNewOwner);
        } else {
            inotify = 1;
        }
     ...
     * @return Boolean determines whether the attribute value is assigned or not.
     * @throws Exception
     *             if the operation fails.
     * @since Common X3.
     */
    public int checkForAttribute(Context context, String args[]) throws Exception {
    ...
    public int checkRelatedObjectState(Context context, String args[]) throws Exception {
        ...
        MapList maplistObjects = getRelatedObjects(context, strRelationshipName, strTypeName, busSelects, // object Select
    ...
    /**
     * Get the list of all Objects which are connected to the context Change object as "Affected Items".
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
     * @return a eMatrix <code>MapList</code> object having the list of Affected Items for this Change object in Edit All Mode.
     * @throws Exception
     *             if the operation fails
     * @since Common X3
     **/
    ...
    public MapList getAffectedItemsForEdit(Context context, String[] args) throws Exception {
        ...
        mlAffectedItemBusObjList = getRelatedObjects(context, RELATIONSHIP_AFFECTED_ITEM, bufType.toString(), objectSelects, relSelects, false, true, (short) 1, null, bufWhereClause.toString());
        ...
        if (action.equalsIgnoreCase("editalldispositioncode")) {
            ...
            while (objectListItr.hasNext()) {
                ...
                if ((sAttRequestedChange.equalsIgnoreCase(EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, "emxFramework.Range.Requested_Change.For_Revise"))
                        || sAttRequestedChange
                                .equalsIgnoreCase(EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, "emxFramework.Range.Requested_Change.For_Obsolescence")))
                        || ((strCurrentState.equalsIgnoreCase(STATE_ECPART_RELEASE) || strCurrentState.equalsIgnoreCase(STATE_CADDRAWING_RELEASE)
                                || strCurrentState.equalsIgnoreCase(STATE_CADMODEL_RELEASE) || strCurrentState.equalsIgnoreCase(STATE_DRAWINGPRINT_RELEASE)
                                || strCurrentState.equalsIgnoreCase(STATE_PARTSPECIFICATION_RELEASE))
                                && !(sAttRequestedChange
                                        .equalsIgnoreCase(EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, "emxFramework.Range.Requested_Change.None"))))) {
        ...
        // For Editable and NonEditable feature of "EditAll" functionality of affected Items.
            ...
            if (strParentType.equalsIgnoreCase(DomainConstants.TYPE_ECR)) {
                ...
                MapList mlFinalMapList = new MapList();
                MapList mlECRObjList = getRelatedObjects(context, DomainConstants.RELATIONSHIP_ECO_CHANGEREQUESTINPUT, TYPE_ECR, objectSelects, null, false, true, (short) 1, null, null);
                Iterator objectListItr = mlAffectedItemBusObjList.iterator();
                while (objectListItr.hasNext()) {
                    Map objMap = (Map) objectListItr.next();
                    String objId1 = (String) objMap.get("id");
                    DomainObject doAIId = new DomainObject(objId1);
                    MapList mlAIECRObjList = doAIId.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_AffectedItem"), TYPE_ECR, objectSelects, null, true, false,
                            (short) 1, null, null);
    ...
    /*
     * This method connects the Context Person object and the context Change Object with the Assigned Affected Item Relationship.
     * 
     * @param context The ematrix context of the request.
     * 
     * @param args This string array contains following arguments: 0 - The object id of Change Object 1 - The object id of Affected Item
     * 
     * @throws Exception
     * 
    ...
    public void createAssignedAffectedItemRel(Context context, String[] args) throws Exception, FrameworkException {
        ...
        try {
            ...
            if (sChangeType.equals(TYPE_MECO) || sChangeType.equals(TYPE_DCR)) {
                ...
                if ((!current.equals(STATE_ECPART_RELEASE)) || (!current.equals(STATE_CADDRAWING_RELEASE)) || (!current.equals(STATE_CADMODEL_RELEASE))
                        || (!current.equals(STATE_DRAWINGPRINT_RELEASE))) {
            ...
            mlAssignedECRel = getRelatedObjects(context, DomainConstants.RELATIONSHIP_ASSIGNED_EC, DomainConstants.TYPE_PERSON,
                    // objectSelects,
                    null, relSelects, true, false, (short) 1, objectWhereSelects, null);
            ...
            if (mlAssignedECRel != null && mlAssignedECRel.size() > 0) {
                ...
                ContextUtil.pushContext(context);
                try {
                    DomainRelationship strDR = DomainRelationship.connect(context, new DomainObject(strBusObjPersonId), DomainConstants.RELATIONSHIP_ASSIGNED_EC, new DomainObject(strChangeObjectId));
            ...
            connect(context, RELATIONSHIP_ASSIGNEED_AFFECTED_ITEM, strAssignedECRelId, strAffectedItemRelId, false, false);
        } catch (Exception ex) {
            ex.printStackTrace();
            throw ex;
        }
    ...
    public Vector getAssigneeOfAI(Context context, String[] args) throws Exception {
        ...
        while (itrML.hasNext()) {
            ...
            if ((sObject.isKindOf(context, DomainConstants.TYPE_PART) || sObject.isKindOf(context, PropertyUtil.getSchemaProperty(context, "type_DOCUMENTS")))
                    && ((!sAffectedItemId.equals("")) && (!sAffectedItemId.equals(null)))) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param relid
     *            relationship id from which reltorel is connected
     ...
     * @since Common X3
     */
    public String getTomidFromrelFromName(Context context, String relid, String relationshipName) throws FrameworkException {
        // IR-037806 - Starts
        String strRes = "";
        if (relid != null && !"".equals(relid)) {
            ...
            try {
                ...
                ContextUtil.pushContext(context);
                strRes = MqlUtil.mqlCommand(context, "print connection " + relid + " select tomid.fromrel[" + relationshipName + "].from.name dump");
    ...
    public MapList getAddRelated(Context context, String[] args) throws Exception {
        MapList aiList = null;
        try {
    ...
    /**
     * Get the list of all Objects which are connected to the context Change object as "Affected Items" and Parts connected with relationship "Part Specification".
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
     * @return a eMatrix <code>MapList</code> object having the list of Affected Items for this Change object.
     * @throws Exception
     *             if the operation fails
     * @since Common X3
     **/
    public MapList getAddRelatedWithRelSelectables(Context context, String[] args) throws Exception {
        ...
        String typepattern = DomainConstants.TYPE_PART + "," + DomainConstants.TYPE_CAD_DRAWING + "," + DomainConstants.TYPE_CAD_MODEL + "," + DomainConstants.TYPE_DRAWINGPRINT + ","
        ...
        mlBusObjPartList = domPartId.getRelatedObjects(context, relapttern, typepattern, selectStmts, selectrelStmts, false, true, (short) 1, whereClause, null);
        ...
        mlBusObjAIList = domchangeObj.getRelatedObjects(context, RELATIONSHIP_AFFECTED_ITEM, typepattern, selectStmts1, selectrelStmts1, false, true, (short) 1, null, null);
    ...
    /**
     * getRequestedChangeFilterOptions(),this method is executed to show the Requested Change Filter options in the Custom Filter Toolbar Menu in Affected Item.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
    ...
    public static HashMap getRequestedChangeFilterOptions(Context context, String[] args) throws Exception {
        ...
        /*
         * if(domobj.isKindOf(context,DomainConstants.TYPE_ECO) && !(strChangeState.equals(STATE_ECO_CREATE)|| strChangeState.equals(STATE_TEAMECO_CREATE)|| //TeamECO Create State
         * strChangeState.equals(STATE_TEAMECO_EVALUATE) //TeamECO Evaluate State ) && index != (indSize - 1)){ index=index+1; }
         * 
         * String sElementValue = (String) fieldChoices.elementAt(index); String sElementDisplayValue = (String) fieldDisplayChoices.elementAt(index);
         */
    ...
    /**
     * getAssigneeFilterOptions(), Method to execute for 'Range Funtion' to populate 'Assignee' Filter Options.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a packed HashMap
     ...
     *             if the operation fails.
     */
    public HashMap getAssigneeFilterOptions(Context context, String args[]) throws Exception {
    ...
    /**
     * This method is used action promote trigger on different states of the policies. checks if the RouteTemplate is attached for context change object or not
     * @param context
     * @param args
     *            0 - String containing object id. 1 - String Approval Or Reviewer RouteTemplate. 2 - String Resource file name 3 - String Resource field key
     * @return int
     * @throws Exception
     *             if the operation fails. * *
     * @since Common X3.
    ...
    public int checkRouteTemplateForState(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String whrClause = "attribute[" + DomainConstants.ATTRIBUTE_ROUTE_BASE_PURPOSE + "] match '" + strApprovalOrReviewerRouteTemplate + "' && current == Active";

            // get route template objects from change object
            mapRouteTemplate = getRelatedObjects(context, DomainConstants.RELATIONSHIP_OBJECT_ROUTE, DomainConstants.TYPE_ROUTE_TEMPLATE, selectStmts, null, false, true, (short) 1, whrClause, null);
    ...
    /**
     * this method checks for Route object(connected to changeobject) and if not present cals the method createRoute which creates route from route template and attaches to change object
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            : 0 - OBJECTID change id 1 - change object policy 2 - change object state (from state ie that is the state on which the route will be started) 3 - the The kind of Route ( Route Base
    ...
    public int createRouteFromRouteTemplate(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            ContextUtil.pushContext(context);
            mpListRoutes = obj.getRelatedObjects(context, RELATIONSHIP_OBJECT_ROUTE, TYPE_ROUTE, objectSelects, null, true, true, (short) 1, null, null);
            ContextUtil.popContext(context);
            ...
            if (mpListRoutes.size() > 0) {
                ...
                String whrClause = "attribute[" + DomainConstants.ATTRIBUTE_ROUTE_BASE_PURPOSE + "] match '" + strApprovalOrReviewerRoute + "'";

                // get list of Templates attached to change object
                listTemplates = obj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_OBJECT_ROUTE, TYPE_ROUTE_TEMPLATE, objectSelects, null, false, true, (short) 1, whrClause, null);
                ...
                if (listTemplates.size() > 0 && (!boolRoutePresent)) {
                    ...
                    while (itrTemplates.hasNext() && (!boolRoutePresent)) {
                        ...
                        String strTemplaeID = (String) mpTemplates.get(SELECT_ID);
                        DomainObject objTemplate = (DomainObject) DomainObject.newInstance(context);
                        objTemplate.setId(strTemplaeID);// Template object
                        // get list of routes connected to Route Template
                        ContextUtil.pushContext(context);
                        listRoutes = objTemplate.getRelatedObjects(context, RELATIONSHIP_INITIATING_ROUTE_TEMPLATE, TYPE_ROUTE, objectSelects, null, true, false, (short) 1, null, null);
                        ContextUtil.popContext(context);
                        if (listRoutes.size() > 0 && (!boolRoutePresent)) {
                            ...
                            while (itrRoute.hasNext() && (!boolRoutePresent)) {
                                ...
                                String strId = (String) mpRoutesOfTemplate.get(SELECT_ID);// route id connected to
                                                                                          // Template
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            : 0 - OBJECTID change id 1 - change object policy 2 - change object state (from state ie that is the state on which the route will be started) 3 - the The kind of Route Template(
     *            Route Base Purpose ) can be Approval,Review,Standard
     * @returns true for sucess and false for trigger failure
     * @throws Exception
     *             if the operation fails
     * @since Common X3
    ...
    public int createRoute(Context context, String[] args) throws Exception {
        ...
        String strState1 = PropertyUtil.getSchemaProperty(context, "policy", strChangeObjectPolicy, args[2]);
        String strApprovalOrReviewerRoute = args[3];
        ...
        objectSelects.add("attribute[" + DomainConstants.ATTRIBUTE_ROUTE_BASE_PURPOSE + "]");
        ...
        try {
            ...
            list = obj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_OBJECT_ROUTE, TYPE_ROUTE_TEMPLATE, objectSelects, relSelects, false, true, (short) 1, whrClause, null);

            Iterator itr = list.iterator();
            while (itr.hasNext()) {

                Map mapTemplate = (Map) itr.next();// Template Map
                templateId = (String) mapTemplate.get(DomainConstants.SELECT_ID);
                sTemplateDesc = (String) mapTemplate.get(DomainConstants.SELECT_DESCRIPTION);
                sState = (String) mapTemplate.get(DomainConstants.SELECT_CURRENT);
                strAutoStopOnRejection = (String) mapTemplate.get(SELECT_ATTRIBUTE_AUTO_STOP_REJECTION); // IR-118894

                if (templateId != null && !"null".equals(templateId) && "Active".equals(sState)) {
                    ...
                    routeObj = (Route) DomainObject.newInstance(context, TYPE_ROUTE);
                    // create ROute object
                    routeObj.setId(sRouteId);
                    // HashMap to carry all the attribute values to be set
                    HashMap attrMap = new HashMap();
                    // rename change object object name
                    String changeObjectName = obj.getInfo(context, DomainConstants.SELECT_NAME);
                    ...
                    attrMap.put(DomainConstants.ATTRIBUTE_ROUTE_BASE_STATE, args[2]);
                    attrMap.put(DomainConstants.ATTRIBUTE_ROUTE_BASE_POLICY, args[1]);
                    ...
                    DomainObject Domobj = (DomainObject) DomainObject.newInstance(context);
                    Domobj.setId(sRouteId);
                    // get all the tasks in the route
                    routeNodeList = Domobj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ROUTE_NODE,
                            // DomainConstants.TYPE_PERSON, // 369474
                            nodeTypePattern, null, relProductSelects, false, true, (short) 1, null, null);
                    Iterator itrRouteNodeList = routeNodeList.iterator();
                    while (itrRouteNodeList.hasNext()) {
                        Map currentMap = (Map) itrRouteNodeList.next();
                        DomainRelationship routeNodeId = new DomainRelationship((String) currentMap.get(DomainConstants.SELECT_RELATIONSHIP_ID));
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - String holding the object id.
     * @returns void.
     * @throws Exception
     *             if the operation fails
     * @since EC 10.5
    ...
    /**
     * Gets all the persons with which this Change object is connected with Assigned EC relationship
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getAssignees(Context context, String[] args) throws Exception {
        // unpacking the Arguments from variable args
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        // getting parent object Id from args
        String strParentId = (String) programMap.get(SELECT_OBJECT_ID);
        ...
        relBusObjPageList = getRelatedObjects(context, strRelAssignedEC, DomainConstants.QUERY_WILDCARD, objectSelects, relSelects, true, false, (short) 1, DomainConstants.EMPTY_STRING,
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Context 1 - A String containg the Object Id 2 - A String Array containg the Rel Ids of Objects Selected 3 - A String Array containg the Obj
     *            Ids of Objects Selected 4 - A String containing the Change Obj Id.
    ...
    public StringList checkAssignedAffectedItemRelExists(Context context, String objectId, String[] arrRelIds, String[] strObjectId) throws Exception {
        ...
        for (int i = 0; i < arrRelationIds.length; i++) {
            // The MQL Command
            strMQLCommand = "print connection " + arrRelationIds[i] + " select frommid.id dump";
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: object Id object Id of context ECR. New Value object Id of updated Distribution List Object
     * @throws Exception
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a MapList with the following as input arguments or entries: objectId holds the context ECR object Id New Value holds the newly selected Reported Against Object Id
     * @throws Exception
     *             if the operations fails
     * @since Common X3
     */
    ...
    /*
     * This method gets the Value of the default RCO connected to the ECR or the value of default connected RDO to the ECO. If no RCO or RDO are connected then return
     * 
     * @param context The ematrix context of the request.
     * 
     * @param args This string array contains following arguments: 0 - The object id of Change Object
     * 
     * @throws Exception
     * 
     * @throws FrameworkException
    ...
    public String getResponsibleOrganization(Context context, String[] args) throws Exception {
        ...
        if (boObjectType.getTypeName().equalsIgnoreCase(DomainConstants.TYPE_ECO)) {
            ...
            strMQLCommand = "print Person " + strContextUser + " select property[" + strPref_DesignResp + "].value ";
            ...
            if (boObjectType.getTypeName().equalsIgnoreCase(DomainConstants.TYPE_ECR)) {
                ...
                Map relBusObjPageList = getRelatedObject(context, RELATIONSHIP_DESIGN_RESPONSIBILITY, // Dummy Value for the time being
                        true, busSelects, relSelects);
     ...
     * @param context The ematrix context of the request.
     * 
     * @param args This string array contains following arguments: 0 - context 1 - A String Array of Object Ids of Assignees to be removed 2 - A String Array of relationship Ids of Assignees with the
     * context object. 3 - A String Array of Change Object Id
     * 
    ...
    public StringList removeAssignee(Context context, String[] args) throws FrameworkException {
     ...
     * @param map
     *            contains selected data using domainobject getInfo method.
     * @param key
     *            contains key for accessing the data from the map
     * @return StringList.
     */
    ...
    /**
     * this method gets the List of Affected Items. Gets the List of Persons to be Notified. The following steps are performed: - The Affected Parts,Specifications Connected to this Pariticular ECO
     * are Disconnected. - The related ECRs are disconnected - The Related Routes Connected to this Particualr ECO are Disconnected
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
    ...
    public void cancelChangeProcess(Context context, String[] args) throws Exception // MethodName
    {
        ...
        DomainObject changeObj = DomainObject.newInstance(context, objectId, DomainConstants.ENGINEERING);
        ...
        try {
            ...
            if (isECHInstalled) {
                ...
                if (!canCancel.booleanValue()) {
                    ...
                    new MQLCommand().executeCommand(context, "notice '" + strNotice + "'");
                    return;
                }
            }
            ...
            JPO.invoke(context, "emxNotificationUtil", null, "objectNotification", argsmail);
            ...
            /*
             * if (policyClassification.equals("StaticApproval")) { //Modified for the IR-030668V6R2011 //relPattern = RELATIONSHIP_NEW_PART_PART_REVISION + "," + RELATIONSHIP_MAKE_OBSOLETE + "," +
             * RELATIONSHIP_NEW_SPECIFICATION_REVISION; relPattern = RELATIONSHIP_REQUEST_PART_REVISION + "," + RELATIONSHIP_REQUEST_SPECIFICATION_REVISION + ","
             * +RELATIONSHIP_REQUEST_PART_OBSOLESCENCE + "," +RELATIONSHIP_NEW_PART_PART_REVISION + "," + RELATIONSHIP_MAKE_OBSOLETE + "," + RELATIONSHIP_NEW_SPECIFICATION_REVISION; //IR-030668V6R2011
             * ends }
             */
            // End
            ...
            while (objItr.hasNext()) {
                ...
                if (deleteAffectedItems) {
                    ...
                    if (!((currentState.equalsIgnoreCase(STATE_ECPART_RELEASE)) || (currentState.equalsIgnoreCase(STATE_PARTSPECIFICATION_RELEASE))
                            || (currentState.equalsIgnoreCase(STATE_CADMODEL_RELEASE)) || (currentState.equalsIgnoreCase(STATE_CADDRAWING_RELEASE))
                        ...
                        DomainRelationship.disconnect(context, (String) objMap.get(DomainConstants.SELECT_RELATIONSHIP_ID));
                    }
                    // End : HF-016433
                } else {
                    DomainRelationship.disconnect(context, (String) objMap.get(DomainConstants.SELECT_RELATIONSHIP_ID));
            ...
            MapList relatedECRs = changeObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ECO_CHANGEREQUESTINPUT, // relationship
                    // pattern
            ...
            routeList = changeObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_OBJECT_ROUTE, // relationship
                    // pattern
            ...
            if (routeList.size() > 0) {
                ...
                while (objItr.hasNext()) {
                    ...
                    if ((DomainConstants.TYPE_ROUTE).equals(strRouteType)) {
                        ...
                        if (!toListRoutes.contains((String) objMap.get(DomainConstants.SELECT_OWNER)))
                            toListRoutes.addElement((String) objMap.get(DomainConstants.SELECT_OWNER));

                        // If this is the only object connected to the route,
                        // terminate the route
                        try {
                            Route route = (Route) DomainObject.newInstance(context, (String) objMap.get(SELECT_ID), ENGINEERING);
                            String routeStatus = (String) route.getAttributeValue(context, DomainConstants.ATTRIBUTE_ROUTE_STATUS);
                            // Stop only if current status is "Started"
                            if (routeStatus.equals("Started"))
                                route.setAttributeValue(context, ATTRIBUTE_ROUTE_STATUS, "Stopped");
            ...
            // Set the reason
            changeObj.setAttributeValue(context, ATTRIBUTE_REASON_FOR_CANCEL, sReason);
    ...
    /**
     * this method gets the List of persons to be notified through Icon Mail. Gets the List of Persons to be Notified. The following steps are performed: - The Related ECRs Owners Connected to this
     * ECO are notified. - The Related Route Owners and Route Assignees are notified - The Related Distribution List connected to this Particular ECO are notified
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds the following input arguments: - The ObjectID of the Change Process
    ...
    public StringList getToListForCancelChangeProcess(Context context, String[] args) throws Exception // Method name shd be replaced
    {
        ...
        MapList mlMemberList = ChangeObject.getRelatedObjects(context, relPattern, // relationship pattern
        ...
        MapList mlreviewerList = ChangeObject.getRelatedObjects(context, relPattern, // relationship pattern
                typePattern, // object pattern
                selectStmts, // object selects
                selectRelStmts, // relationship selects
                false, // to direction
        ...
        MapList mlAssigneeList = ChangeObject.getRelatedObjects(context, relPattern, // relationship pattern
                typePattern, // object pattern
                selectStmts, // object selects
                selectRelStmts, // relationship selects
                true, // to direction
     ...
     * @returns HashMap
     * @throws Exception
     *             if the operation fails Since Common X3.
     **/

    private HashMap getCompanyDefaultValue(Context context, String sObjectId) throws Exception {
    ...
    private HashMap getPersonDefaultDesignResponsibility(Context context) throws Exception {
    ...
    public Object getCompanyDefaultValueHTML(Context context, String[] args) throws Exception {
        ...
        if (sObjectId != null && !sObjectId.equals("") && !sObjectId.equals("null") && !sObjectId.equals(" ")) {
            ...
            if (sType != null && sType.equals(DomainConstants.TYPE_ECO)) {
                InfoMap = oDomObj.getRelatedObjects(context, RELATIONSHIP_DESIGN_RESPONSIBILITY, "*", busSelects, relSelects, true, false, (short) 1, null, null);

            } else if (sType != null && sType.equals(DomainConstants.TYPE_ECR)) {
                InfoMap = oDomObj.getRelatedObjects(context, RELATIONSHIP_CHANGE_RESPONSIBILITY, "*", busSelects, relSelects, true, false, (short) 1, null, null);
        ...
        sbReturnString.append(
                "<input type=\"button\" name=\"btnCompany\" value=\"...\" onclick=\"javascript:showChooser('../components/emxCommonSearch.jsp?formName=editDataForm&frameName=searchPane&searchmode=chooser&suiteKey=Components&searchmenu=APPECSearchAddExistingChooser&searchcommand=SearchECCompanyCommand&fieldNameActual="
                        + sCompany + "&fieldNameDisplay=CompanyDisplay&objectId=");
    ...
    public void disconnectRouteTemplateDistributionList(Context context, String args[]) throws Exception {
        ...
        MapList TemplateListId = domOObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_OBJECT_ROUTE, DomainConstants.TYPE_ROUTE_TEMPLATE, busSelects, relSelects, false, true, (short) 1,
                objWhere, null);
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds - String Array of Change objectId - String Array of New Person Id - String Array of Old Person Id - String Array of Relationship Id Return Object
     * @throws Exception
     *             if the operation fails.
     * @since Common X3.
     */
        ...
        try {
            ...
            for (int k = 0; k < arrRelIds1.length; k++) {
                ...
                while (stzRelId.hasMoreElements()) // For each Rel Id get the corresponding Obj Id
                {
                    ...
                    strMQLCommand = "print connection " + strFinalRelId + " select frommid.id dump";
                    prMQL.executeCommand(context, strMQLCommand);
                    strMQLCommandResult = prMQL.getResult();
                    ...
                    if (!strMQLCommandResult.equals("\n")) {
                        ...
                        try {
                            ...
                            while (stzMQ1CommandResult.hasMoreElements()) {
                                ...
                                strMQLCommand2 = "print connection " + strAssAffItemRelIds + " select torel.id dump";
                                prMQL2.executeCommand(context, strMQLCommand2);
                                strMQLCommandResult2 = prMQL2.getResult();

                                String strAIId = strMQLCommandResult2;
                                // Deleting the existing rel2rel connection.
                                MqlUtil.mqlCommand(context, "delete connection " + strAssAffItemRelIds);
                        ...
                        String strAssigneeNoDelegate = EnoviaResourceBundle.getProperty(context, RESOURCE_BUNDLE_COMPONENTS_STR, context.getLocale(),
                                "emxComponents.Common.Message.strAssigneeNoAffectedItem");
     ...
     * @param context
     * @param args
     *            0 object Id 1 notification object name
     * @return int
     * @throws Exception
     * @since Common X3
     */
    public int notifyRelatedObject(Context context, String[] args) throws Exception {
        ...
        JPO.invoke(context, "emxNotificationUtil", null, "objectNotification", strnotifyargs);
        return 0;
    }
     ...
     *            holds person maps
     * @param sRole
     *            holds role based on which filtering is done
     ...
     *            holds person maps
     * @param slRole
     *            holds list of roles based on which filtering is done
     * @return MapList, the Object ids matching the filter criteria
     * @throws Exception
     *             if the operation fails.
     * @since Common X3.
    ...
    /**
     * Connects the Design Responsibility Organization to the Engineering Object. This method is called for ECO, ECR, Part, Spec objects as update function in their respective Edit pages.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public void connectDesignResponsibility(Context context, String[] args) throws Exception {
        try {
            ...
            if (str.equals("CreateECO") || str.equals("CreateMECO") || str.equals("CreateECR")) {
                ...
                if (strNewToTypeObjId == null || "".equals(strNewToTypeObjId) || "Unassigned".equalsIgnoreCase(strNewToTypeObjId) || "null".equalsIgnoreCase(strNewToTypeObjId)
                        || " ".equals(strNewToTypeObjId)) {
                    strNewToTypeObjId = (String) paramMap.get("New Value");
                }
                ...
                String strMode = strMod[0];
                if ((strMode != null && strMode.equalsIgnoreCase("AssignToECO")) || (strMode != null && strMode.equalsIgnoreCase("MoveToECO"))
                        || (strMode != null && strMode.equalsIgnoreCase("MoveToMECO")) || (strMode != null && strMode.equalsIgnoreCase("AddToECO")))

                {
                    ...
                    if (strNewValue != null && !"null".equals(strNewValue) && strNewValue.length() > 0) {
                        ...
                        try {
                            ...
                            DomainRelationship.connect(context, domainNewValue, strRelationshipDesignResponsibility, domObjectChangeNew);
    ...
    /**
     * DisConnects the ChangeObject with Part If the Part has some Version then Purges the Part.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the following keys, "arrTableRowIds", "arrRelIds"
     * @return void
     * @throws Exception
     *             if operation fails
     * @since Common X3
    ...
    public void removeAffectedItems(Context context, String[] args) throws Exception {
        try {
            String temp = "";
            String partObjectId = "";
            ...
            for (int relcount = 0; relcount < sRelIdsCount; relcount++) {
                ...
                if (isMBOMInstalled) {
                    ...
                    if (mL.size() > 0) {
                        ...
                        for (int j = 0; j < manuRespChgIds.size(); j++) {
                            ...
                            if (connId != null) {
                                fromChange = "print connection " + connId + " select from.id  dump";
                                fromValue = MqlUtil.mqlCommand(context, fromChange);
                ...
                MapList mapListMarkups = new DomainObject(strID).getRelatedObjects(context, RELATIONSHIP_EBOM_MARKUP, "*", new StringList(SELECT_ID), null, false, true, (short) 1, objectWhere, null);
            ...
            /*
             * for(int count=0; count < sRowIdsCount; count++) { temp = arrTableRowIds[count]; objectList = FrameworkUtil.split(temp,"|"); partObjectId = (String)objectList.elementAt(1) ; DomainObject
             * dobj = new DomainObject(partObjectId); attributeValue = dobj.getAttributeValue(context,isVersion) ; StringList busSelects = new StringList(2); busSelects.add(DomainConstants.SELECT_ID);
             * StringList relSelects = new StringList(2); relSelects.add(DomainConstants.SELECT_RELATIONSHIP_ID);
             * 
             * if(attributeValue.equalsIgnoreCase("FALSE")) { MapList mapList = dobj.getRelatedObjects(context,RELATIONSHIP_PART_VERSION,DomainConstants.TYPE_PART
             * ,busSelects,relSelects,false,true,(short)1,null,null); if (mapList.size() > 0) { Iterator itr = mapList.iterator(); while(itr.hasNext()) { Map newMap = (Map)itr.next();
             * sObjectId=(String) newMap.get(DomainConstants.SELECT_ID); DomainObject dobjPartVersion = new DomainObject(sObjectId); dobjPartVersion.deleteObject(context); } } } }
             */
            ...
            MapList totalresultList = dObj1.getRelatedObjects(context, DomainObject.RELATIONSHIP_RAISED_AGAINST_ECR, // relationship pattern
                    DomainConstants.TYPE_ECR, // object pattern
    ...
    /**
     * Creates new Revision for Affected Item If the Affected Item's Requested change value is Revise it will create version object
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the following keys, "arrTableRowIds", "arrRelIds"
    ...
    public void createNewRevisionForAffectedItem(Context context, String[] args) throws Exception

    {
        ...
        for (int i = 0; i < strObjectIds.length; i++) {
            ...
            if (attrValue.equals(attrRequestedChangeValue) && strNewPartId == null) {
                ...
                // added
                String mqlCmd = "print connection " + affectedItemRelId + " select tomid.fromrel[" + DomainConstants.RELATIONSHIP_ASSIGNED_EC + "].from.id dump |";
                MQLCommand mCmd = new MQLCommand();
                mCmd.executeCommand(context, mqlCmd);
                ...
                DomainRelationship doAffectedItemRel = DomainRelationship.connect(context, new DomainObject(strChangeObjectId), RELATIONSHIP_AFFECTED_ITEM, new DomainObject(revPartId));
                try {
                    ContextUtil.pushContext(context);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the following keys, "objectId"
    ...
    public StringList requestedChangeValues(Context context, String[] args) throws Exception {
            ...
            while (objItr.hasNext()) {
                ...
                if ((!sAIRelId.equals("")) && (!sAIRelId.equals(null))) {
                    ...
                    if ((currentChangeStatus.equals(STATE_ECO_CREATE)) || (currentChangeStatus.equals(STATE_ECO_DEFINE_COMPONENTS)) || (currentChangeStatus.equals(STATE_ECO_DESIGN_WORK))
                            || (currentChangeStatus.equals(STATE_ECR_CREATE)) || (currentChangeStatus.equals(STATE_ECR_SUBMIT)) || (currentChangeStatus.equals(STATE_ECR_EVALUATE))
                            || (currentChangeStatus.equals(STATE_ECR_REVIEW))) {
        ...
        if (mode == null || !mode.equals("Edit")) {// if task in view mode show the attribute value
            while (objItr.hasNext()) {
                Map objMap = (Map) objItr.next();
                String reqChangeValue = (String) objMap.get(ATTRIBUTE_REQUESTED_CHANGE);
    ...
    public int updateRequestedChangeValues(Context context, String[] args) throws Exception {
        ...
        if (currentState.equalsIgnoreCase(STATE_ECPART_RELEASE)) {
            ...
            if (domObj.isLastRevision(context) && strNewPartId == null) {
                if (strNewRequestedChangeValue.equalsIgnoreCase(EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, "emxFramework.Range.Requested_Change.For_Update"))
                        || strNewRequestedChangeValue
                                .equalsIgnoreCase(EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, "emxFramework.Range.Requested_Change.For_Revise"))
                        || strNewRequestedChangeValue.equalsIgnoreCase(EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, "emxFramework.Range.Requested_Change.None"))
                        || strNewRequestedChangeValue
                                .equalsIgnoreCase(EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, "emxFramework.Range.Requested_Change.For_Obsolescence"))) {
                ...
                if (strNewRequestedChangeValue
                        .equalsIgnoreCase(EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, "emxFramework.Range.Requested_Change.For_Release"))) {
        ...
        if (!(currentState.equalsIgnoreCase(STATE_ECPART_RELEASE))) {
            ...
            if (strNewRequestedChangeValue.equalsIgnoreCase(EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, "emxFramework.Range.Requested_Change.For_Revise"))
                    || strNewRequestedChangeValue
                            .equalsIgnoreCase(EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, "emxFramework.Range.Requested_Change.For_Obsolescence"))
                    || strNewRequestedChangeValue.equalsIgnoreCase(EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", strLocale, "emxFramework.Range.Requested_Change.None"))) {
                emxContextUtil_mxJPO.mqlNotice(context, strAlertMessage);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the Change Obj Id
     * @return boolean
     * @throws Exception
     *             if operation fails
     * @since Common X3
    ...
    public boolean showDelegateCommand(Context context, String[] args) throws Exception {
        ...
        if ((DomainConstants.POLICY_ECO.equals(strPolicy)) && (DomainConstants.STATE_ECO_REVIEW.equals(strState) || DomainConstants.STATE_ECO_RELEASE.equals(strState)
                || DomainConstants.STATE_ECO_IMPLEMENTED.equals(strState) || DomainConstants.STATE_ECO_CANCELLED.equals(strState))) {
            return false;
        }
        ...
        if (strChangeObjOwner.equals(strLoginPersonName) || strChangeObjOwner.equalsIgnoreCase(strLoginPersonName)) {
            ...
            while (itr.hasNext()) {
                ...
                if (strAssigneeId.equals(strLoginPersonID)) {
                    ...
                    prMQL.open(context);
                    strMQLCommand = "print connection " + strAssECRelId + " select frommid.id dump";
                    prMQL.executeCommand(context, strMQLCommand);
                    strMQLCommandResult = prMQL.getResult();
                    prMQL.close(context);
    ...
    /**
     * This method returns Vector containing true/false values determining is a user has access on a specific Row of a Table.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the objectList, paramList and objectId
     * @return Vector
     * @throws Exception
     *             if operation fails
     * @since Common X3
    ...
    public Vector showCheckBoxInDelegate(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds - String of Change Object's ID Return boolean
     * @throws Exception
     *             if the operation fails.
     * @since Common X3.
     */
     ...
     * @since Common X3
     */
    public String getAffectedItemsFilterClause(Context context) throws Exception {
        String strAssigneeName = "";
        if (!sGlobalAssigneeName.equalsIgnoreCase(SELECT_ALL)) {
            DomainObject dobj = new DomainObject(sGlobalAssigneeName);
            strAssigneeName = dobj.getInfo(context, DomainConstants.SELECT_NAME);
     ...
     * 
     * @param args holds - String of Change Object's ID Return boolean
     * 
    ...
    public String isContextPersonAssignee(Context context, String[] args) {
        ...
        try {
            ...
            // Getting the Assignees of the CHange Object
            AssigneeList = getRelatedObjects(context, strRelAssignedEC, DomainConstants.QUERY_WILDCARD, objectSelects, relSelects, true, false, (short) 1, DomainConstants.EMPTY_STRING,
                    DomainConstants.EMPTY_STRING);
        ...
        try {
            ...
            for (int k = 0; k < arrAffectedItemsRelIds.length; k++) {
                ...
                while (stzRelId.hasMoreElements()) // For each Rel Id get the corresponding Obj Id
                {
                    ...
                    if (((getTomidFromRelationshipFromID(context, strFinalAffectedItemRelId, DomainConstants.RELATIONSHIP_ASSIGNED_EC).equals(strLoginPersonID))
                            || strChangeObjOwner.equals(strLoginPersonName)) && (!strNewAssigneeID[k].equals(strLoginPersonID))) {
                        String whrClause = "id" + "=='" + strNewAssigneeID[k] + "'";

                        MapList mlPersons = domChangeObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ASSIGNED_EC, DomainConstants.TYPE_PERSON, new StringList(DomainConstants.SELECT_ID),
                                new StringList(DomainConstants.SELECT_RELATIONSHIP_ID), true, false, (short) 1, whrClause, "");
                        ...
                        StringList slExistingAssignedECRelId = getTomids(context, strFinalAffectedItemRelId);
                        ...
                        if ("".equals(strAssignedECRelId)) {
                            DomainRelationship strDR = DomainRelationship.connect(context, new DomainObject(strNewAssigneeID[k]), DomainConstants.RELATIONSHIP_ASSIGNED_EC,
                                    new DomainObject(strChangeObjID[0]));
                            strAssignedECRelId = strDR.toString();
                        }

                        // Creating new ReltoRel START
                        connect(context, RELATIONSHIP_ASSIGNEED_AFFECTED_ITEM, strAssignedECRelId, strFinalAffectedItemRelId, false, false);
                    }
                }
            }
            ContextUtil.commitTransaction(context);
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static MapList getReleasedSearchResults(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds - String of Change Object's ID Return String
     * @throws Exception
     *             if the operation fails.
     * @since Common X3.
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the following keys, "mode","ObjectId"
     * @return Boolean
     * @throws Exception
     *             if operation fails
     * @since Common X3
     ...
     *            the eMatrix <code>Context</code> object.
     * @param String
     *            of Change Object's ID
     * @param String
     *            of passed Person's Object ID Return String
     * @throws Exception
     *             if the operation fails.
     * @since Common X3.
     */
    public String getPersonAssigneeRelID(Context context, String strChangeObjID, String strPersonID) {
        ...
        try {
            ...
            this.setId(strChangeObjID);
            // Getting the Assignees of the CHange Object
            AssigneeList = getRelatedObjects(context, strRelAssignedEC, DomainConstants.QUERY_WILDCARD, objectSelects, relSelects, true, false, (short) 1, strObjectWhere,
                    DomainConstants.EMPTY_STRING);
     ...
     *            relationship id from which reltorel is connected
     * @param isfrommid
     *            true to get to/from object from frommid else get from tomid
     * @param getFrom
     *            true to get from object id else it will get to object id
     * @return the StringList of Object Id for further processing
     * @throws FrameworkException
     *             if the operation fails
     * @since Common X3
     */
    public StringList getFromTomidsToFromObjid(Context context, String relid, boolean isfrommid, boolean getFrom) throws FrameworkException {
        ...
        try {
            ...
            if (isfrommid) {
                if (getFrom) {
                    strReult = MqlUtil.mqlCommand(context, "print connection " + relid + " select frommid.from.id dump |");
                    slFromRelId = FrameworkUtil.split(strReult, "|");

                } else {

                    strReult = MqlUtil.mqlCommand(context, "print connection " + relid + " select frommid.to.id dump |");
                    slFromRelId = FrameworkUtil.split(strReult, "|");

                }
            } else {
                if (getFrom) {
                    strReult = MqlUtil.mqlCommand(context, "print connection " + relid + " select tomid.from.id dump |");
                    slFromRelId = FrameworkUtil.split(strReult, "|");

                } else {

                    strReult = MqlUtil.mqlCommand(context, "print connection " + relid + " select tomid.to.id dump |");
                    slFromRelId = FrameworkUtil.split(strReult, "|");
                }
     ...
     * @since Common X3
     */
    public StringList getTomids(Context context, String relid) throws FrameworkException {
        ...
        try {
            ContextUtil.pushContext(context);
            Res = MqlUtil.mqlCommand(context, "print connection " + relid + " select tomid.id dump |");
     ...
     * @since Common X3
     */
    public static void disconnect(Context context, String relationshipId) throws FrameworkException {
        ContextUtil.startTransaction(context, true);
        MqlUtil.mqlCommand(context, "verb on");

        try {
            ContextUtil.pushContext(context);
            String strCommand = "delete connection " + relationshipId;
     ...
     *            the eMatrix <code>Context</code> object
     * @param srelationship
     *            name the object/relationship to connect from
     * @param fromId
     *            the object/relationship to connect from
     * @param toId
     *            the object/relationship to connect to
     * @param isFromObj
     *            true if from side is Object
     * @param isToObj
     *            true if to side is Object
     * @return the connection id for further processing
     * @throws FrameworkException
     *             if the operation fails
     * @since Common X3
     */
    public String connect(Context context, String srelationship, String fromId, String toId, boolean isFromObj, boolean isToObj) throws FrameworkException {
        String sFrom;
        String sTo;
        String Res;
        ...
        try {
            ...
            cmd.append("add connection ");
            cmd.append(srelationship);
            cmd.append(sFrom);
            cmd.append(fromId);
            cmd.append(sTo);
            cmd.append(toId);
            Res = MqlUtil.mqlCommand(context, "add connection \"" + srelationship + "\" " + sFrom + fromId + sTo + toId);
     ...
     * @since Common X3
     */
    public static void disconnect(Context context, String[] relationshipIds, boolean isReltoRel) throws FrameworkException {
     ...
     *            a list of relationship ids to remove
     * @throws FrameworkException
     *             if the operation fails
     * @since Common X3
     */
    public static void disconnect(Context context, String[] relationshipIds) throws FrameworkException {
    ...
    /**
     * getTypeFilterOptions(), Method to execute for populating the 'Type' Filter Options.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a packed HashMap
     ...
     *             if the operation fails.
     */
    public HashMap getTypeFilterOptions(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            // {
            strAffectedItemToTypes = MqlUtil.mqlCommand(context, "print relationship \"" + RELATIONSHIP_AFFECTED_ITEM + "\" select totype dump");
            // }
            /*
             * else { if(doChange.isKindOf(context,DomainConstants.TYPE_ECO)) //checking whether the change obj is ECO or ECR { strAffectedItemToTypes = MqlUtil.mqlCommand(context,
             * "list relationship \"" + DomainConstants.RELATIONSHIP_NEW_SPECIFICATION_REVISION+ "," + DomainConstants.RELATIONSHIP_NEW_PART_PART_REVISION + "," +
             * DomainConstants.RELATIONSHIP_MAKE_OBSOLETE + "\" select totype dump"); } else { strAffectedItemToTypes = MqlUtil.mqlCommand(context, "list relationship \"" +
             * DomainConstants.RELATIONSHIP_REQUEST_PART_REVISION + "," + DomainConstants.RELATIONSHIP_REQUEST_SPECIFICATION_REVISION + "," + DomainConstants.RELATIONSHIP_REQUEST_PART_OBSOLESCENCE +
             * "\" select totype dump"); } }
             */
    ...
    /**
     * getIndirectAffectedItems, Method to retrieve the new revision for a given change and part context
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a packed HashMap
    ...
    public String getIndirectAffectedItems(Context context, String args[]) throws Exception {
        ...
        MapList mapListParts = doECO.getRelatedObjects(context, RELATIONSHIP_AFFECTED_ITEM, strPartType, strlObjectSelects, null, false, true, (short) 1, strObjWhereclause, strRelWhereclause);
    ...
    /**
     * getDirectAffectedItems, Method to retrieve the old revision for a given change and part context
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            contains a packed HashMap
     ...
     * @since Common X3
     */
    public String getTomidFromRelationshipFromID(Context context, String relid, String relationshipName) throws FrameworkException {
        ...
        try {
            ...
            ContextUtil.pushContext(context);
            strRes = MqlUtil.mqlCommand(context, "print connection " + relid + " select tomid.fromrel[" + relationshipName + "].from.id dump");
            ContextUtil.commitTransaction(context);
        } catch (Exception e) {
            // Abort transaction.
            ContextUtil.abortTransaction(context);
     ...
     *            the eMatrix <code>Context</code> object
     * @param strRouteId
     *            route object id which has to be satrted
     * @returns nothing
     * @throws FrameworkException
     *             if the operation fails
     * @since Common X3
    ...
    public void startRoute(Context context, String strRouteId) throws Exception {
        ...
        MapList routeStartOffsetList = doRoute.getRelatedObjects(context, Route.RELATIONSHIP_ROUTE_NODE, // String relPattern
                "*", // String typePattern
        ...
        MapList routeFirstOrderOffsetList = doRoute.getRelatedObjects(context, Route.RELATIONSHIP_ROUTE_NODE, // String relPattern
                "*", // String typePattern
                null, // StringList objectSelects,
                relSelects, // StringList relationshipSelects,
                false, // boolean getTo,
    ...
    /**
     * Set Scheduled Complete Date attribute for all RouteNodes constructed from the maplist The Completion Due Date is got by adding Offset days attribute to current System date-time
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param MapList
     *            Task list for which offset date has to be set
     * @returns nothing
     * @throws FrameworkException
     *             if the operation fails
     * @since Common X3
    ...
    /**
     * Returns a StringList of the object ids for all Affected Items for a given change context.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
    ...
    public Vector getCompleteName(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < iNoOfObjects; i++) {
            ...
            if (strReportFormat != null && strReportFormat.equals("null") == false && strReportFormat.equals("") == false) {
                ...
                strFullName = "<img src = \"images/iconSmallPerson.gif\"/>&#160;<a href=\"JavaScript:emxTableColumnLinkClick('emxTree.jsp?name="
                        + XSSUtil.encodeForURL(context, strLastName + strFirstName) + "&amp;treeMenu=type_Person&amp;emxSuiteDirectory="// Modified By Infosys for Bug # 304580 Date 05/18/2005
                        /* End of modify : by Infosys for Bug#301835 on 4/13/2005 */
                        + XSSUtil.encodeForURL(context, strSuiteDir) + "&amp;relId=" + XSSUtil.encodeForURL(context, strRelId) + "&amp;parentOID=" + XSSUtil.encodeForURL(context, strParentObjectId)
                        + "&amp;jsTreeID=" + XSSUtil.encodeForURL(context, strJsTreeID) + "&amp;objectId=" + XSSUtil.encodeForURL(context, strObjId)
                        + "', 'null', 'null', 'false', 'popup')\" class=\"object\">" + XSSUtil.encodeForHTML(context, strLastName) + ",&#160;" + XSSUtil.encodeForHTML(context, strFirstName) + "</a>";
            }
    ...
    /**
     * Gets the Change object that the given user is an Assignee of. This is used by the Full Text search as a selectable.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap containing the following arguments objectId - contains the person id.
     ...
     * @param selectedRelIds
     *            String array holding all the selected rel ids from the table.
     * @return StringList.
     * @since Common R207
     * @author ZGQ
     * @throws Exception
    ...
    public StringList getIndirectAffectedItemRelIds(Context context, String changeId, String selectedRelIds[]) throws Exception {
        ...
        try {
            ...
            DomainObject changeObj = new DomainObject(strChangeId);
            MapList indirectAIList = changeObj.getRelatedObjects(context, RELATIONSHIP_AFFECTED_ITEM, DomainConstants.QUERY_WILDCARD, null, strlRelSelects, false, true, (short) 1,
                    DomainConstants.EMPTY_STRING, strRelWhereclause);
    ...
    /**
     * getProperIndex(),this method is executed to get the index value for the selected Requested Change Filter option in the Custom Filter Toolbar Menu in Affected Item.
     * @param sElementValue
     *            contains selected Requested Change filter value.
     * @param fieldChoices
     *            contains list of Requested Change filter values available
