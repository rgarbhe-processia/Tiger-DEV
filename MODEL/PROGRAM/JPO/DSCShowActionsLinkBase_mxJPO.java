...
public class DSCShowActionsLinkBase_mxJPO {
    ...
    private String addOpenFromWebLink(Context context, BusinessObjectWithSelect busObjectWithSelect, MCADGlobalConfigObject gco, String integrationName, String objectId, String jpoName,
            String openToolTip) throws Exception {
        String returnVal = "";
        try {
    ...
    private void appendViewerURLToBuffer(Context context, String integrationName, StringList depDocObjectIdList, StringList depDocObjectTypeList, StringList formatsList, StringList filesList,
            HashMap formatViewerMap, String sTipView, StringBuffer htmlBuffer, boolean filesInSameObject) throws Exception {
        MCADGlobalConfigObject gco = (MCADGlobalConfigObject) integrationNameGCOTable.get(integrationName);
    ...
    protected String getViewerURL(Context context, String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < relBusObjPageList.size(); i++) {
                ...
                if (title == null)
                    title = (String) objectSelectMap.get(CommonDocument.SELECT_FILE_NAME);
