 ...
 **
 ** FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : Version : Date : static const RCSID [] = "$Id: ${CLASSNAME}.java.rca 1.8 Wed Oct 22 16:02:36 2008 przemek Experimental przemek $";
 **
 */
...
public class emxPartLibrary_mxJPO extends emxPartLibraryBase_mxJPO {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("must specify method on emxPartLibrary invocation");
        }
