...
public class emxEngineeringSubstituteMigrationBase_mxJPO extends emxCommonMigration_mxJPO {
     ...
     * @grade 0
     */
    public emxEngineeringSubstituteMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }

    /**
     * This method does the migration work. New Part Master objects are created for those that do not have any. All revisions of a Part are connected to a single Part Master with the Part Revision
     * relationship. Only parts with Production or Development policies are migrated.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param objectIdList
    ...
    public void migrateObjects(Context context, StringList objectIdList) throws Exception {
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                MapList mlCompSub = domSubsObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_COMPONENT_SUBSTITUTION, DomainConstants.TYPE_PART, selectlist, relsel, true, false, (short) 1,
                        "", null);
                ...
                mqlLogWriter("Part- " + sParentPartName + " Revision :" + sParentPartRev + " with EC Substitute to Part-  '" + strSubsPartName + "'" + " Revision :" + strSubsPartRev
                        + "for Child Part- " + strChildPartName + " Revision :" + strSubsPartRev);
