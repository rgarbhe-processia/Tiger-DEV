 ...
 * evidence any actual or intended publication of such program. FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.12 $" Date : "$Date: Wed Oct 22
 * 16:02:22 2008 $"
 */
...
/**
 * The <code>${CLASSNAME}</code> is DocumentCentral Application init code Copyright (c) 2002, MatrixOne, Inc.
 * @exclude
 */
...
public class emxApplicationDocumentCentralBase_mxJPO {
    ...
    public emxApplicationDocumentCentralBase_mxJPO(Context context, String[] args) throws Exception {
        super();
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            the Java <code>String<code> array object
     */
     ...
     * @since AEF 9.5.6.0
     */
    public static void initialize(Context context, String[] args) throws FrameworkException {
        /**
         * Author : Brian R. Tibbetts Date : 2003/04/04 Notes : History :
         */
