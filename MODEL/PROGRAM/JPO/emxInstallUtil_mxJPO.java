...
/**
 * The <code>emxInstallUtil</code> class contains method for the "Collection" Common Component.
 * @version AEF 10.Next - Copyright (c) 2003, MatrixOne, Inc.
 */

public class emxInstallUtil_mxJPO extends emxInstallUtilBase_mxJPO {
    ...
    public emxInstallUtil_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
