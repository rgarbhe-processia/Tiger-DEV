...
public class IEFCDMUtil_mxJPO {
    ...
    /**
     * Revise a document object (Major object) Generates XML string representing the Project Space.
     * @param busid
    ...
    /**
     * Delete a document object Based on the parameter passed a major object or version object could be deleted
     * @param busid
     *            String value of the BusID identifying the Project Space object
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * Returns a relationship that a given Document Holder connects an object to the document
     * @param busid
     *            String value of the BusID identifying the Project Space object
     * @throws Exception
     *             if the operation fails
    ...
    public String getRelationshipToBrowse(Context context, String[] args) throws Exception {
        ...
        if (typeName.equals(typeBook)) {
            ...
            if (fromType != null && !"".equals(fromType) && (fromType.equals(typeWorkspace) || fromType.equals(typeWorkspaceVault))) {
    ...
    public String getRelationshipToConnectFromGCO(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (typeName.equals("type_ProjectVault")) {
                ...
                // but if there are sub-folders? then this will not work. This is a bug need to check for
                // a bean which can give me the top most object type
                if (fromType != null && !"".equals(fromType) && (fromType.equals("Workspace"))) {
                    ...
                    if (mappingTokens != null) {
                        if (mappingTokens.hasMoreElements()) {
                            ...
                            if (mappedNavigationValues.indexOf("@") >= 0) {
                                ...
                                if (mappedNavigationValues.startsWith("menu_")
                                        && ((mappedNavigationValues.indexOf(",") == -1) && (mappedNavigationValues.indexOf("@") == -1) && (mappedNavigationValues.indexOf("|") == -1))) {
    ...
    /**
     * Returns the top level vault for the current vault. The current vault is returned if it is the top vault.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param objectSelects
     *            optional list of selectables from this class
    ...
    /**
     * The following method will be called from ief IEF servlet. It is a wrapper over the method "isVersionable()"
     * @param busid
     *            String value of the BusID
     * @throws Exception
     *             if the operation fails
     */
    ...
    /**
     * Check whether versioning is allowed or not for the given object id Return true or false
     * @param busid
     *            String value of the BusID
     * @throws Exception
     *             if the operation fails
