 ...
 * evidence any actual or intended publication of such program This JPO contains the implementation of emxRetentionRecord
 *
 */
...

{
     ...
     */
    public emxRetentionRecordBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    public MapList getRetentionRecords(Context context, String[] args, String Selectedstate) throws Exception {
        ...
        if (stateIndex >= 0)
            ...
            whereState = "current==" + Selectedstate;

        objectList = DomainObject.findObjects(context, typePattern.getPattern(), "*", "*", "*", "*", whereState, false, objectStringList);
    ...
    public MapList getAllRetentionRecords(Context context, String[] args) throws Exception {
        String all = getPropertyKeyValue(context, "emxComponentsStringResource", "emxComponents.Route.Approval");
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getActiveScheduledStateRecords(Context context, String[] args) throws Exception {
        String retentionRecordpolicy = PropertyUtil.getSchemaProperty(context, "policy_RetentionRecord");
    ...
    /*
     * This method checks the route state based on which trigger will fire and record will be promoted
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args holds the following list of arguments: 0 - objectId
     * 
    ...
    /*
     * This method calculates and set the Initiation Date for Retention Record when trigger will fire from Active state to Schedule state
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args holds the following list of arguments: 0 - objectId
    ...
    public void triggerActionPromoteRetentionDate(Context context, String[] args) throws Exception {
        ...
        MapList mlist = dobj1.getRelatedObjects(context, relname, typePattern.getPattern(), typeSelects, relationshipSelects, true, true, (short) 0, null, null);
        if (mlist.isEmpty()) {
    ...
    /*
     * This method calculates Retention Date Date will be caluculated when trigger will fire from Active state to Schedule state
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param attValue
    ...
    /*
     * This method Deletes a document when delete trigger fires Delete trigger will be fire iff Retention feature is in enable state
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args holds the following list of arguments: 0 - objectId
        ...
        if ("TRUE".equalsIgnoreCase(enableFeature)) {
            ...
            while (stringTokenizer.hasMoreTokens()) {
                ...
                if (objectTypeName.equals(objType) || flag == true) {
                    ...
                    MapList objectList = dobj.getRelatedObjects(context, RelPattern.getPattern(), typePattern.getPattern(), typeSelects, null, true, false, (short) 0, null, null);
    ...
    /**
     * This method checks whether child Object Type is Document Type or not If yes return true else return false
     * @param context
     *            the eMatrix <code>Context</code> object
    ...
    /**
     * This method checks whether Record Retention Feature is true or false in properties setting. listed as property emxLibraryCentral.RetentionRecordFeature in the emxLibraryCentral.properties file
     * @param context
     *            The ematrix context of the request.
     * @param args
     *            holds the following list of arguments: 0 - programMap contains the objectId
    ...
    public Boolean retentionFeatureEnabledCheck(Context context, String[] args) throws Exception {
        ...
        if ("TRUE".equalsIgnoreCase(RetentionEnabled)) {
            while (stringTokenizer.hasMoreTokens()) {
                ...
                if (!strPolicy.equals(strPolicyVersion) && (typeName.equals(objType) || flag == true)) {
                    booleanValue = true;
                }
            }
    ...
    public int notifyOriginator(Context context, String[] args) throws Exception {
        try {
            ...
            objectDocList = DomainObject.findObjects(context, typePatternDocument.getPattern(), "*", "*", "*", "*", relDoc, true, objectDocStringList);// End searching Document
            ...
            while (itrForMail.hasNext()) {
                ...
                MapList mlRetentionHoldList = DocObj.getRelatedObjects(context, relRetainedRecord, strRetentionHold, objeselects, null, true, true, (short) 0, currentState, null);// End searching for
                                                                                                                                                                                   // Retention Hold
                ...
                // checking for all Retention Record condition.
                    ...
                    MapList retentionRecordList = DocObj.getRelatedObjects(context, relRetainedRecord, strRetentionRecord, objeselects, relRetentionDateselects, true, true, (short) 0, null, null);// End
                                                                                                                                                                                                    // of
                                                                                                                                                                                                    // search.
                    ...
                    for (int i = 0; i < mapSize; i++) {
                        ...
                        if (sendMailtoOwner) {
                            mail.sendMessage(context, finalKey, ccList, bccList, subject, message, value);
                        } // End of if.
