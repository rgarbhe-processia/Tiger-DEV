...
public class PLCWidgetsBase_mxJPO extends emxPLCCommonBase_mxJPO {
    ...
    /**
     * Gets the number of non-completed tasks for a given phase. The current phase is stored in the project map. The phase is expanded (expand to end) till end to determine the # of tasks.
     * @param context
     *            - the eMatrix <code>Context</code> object
