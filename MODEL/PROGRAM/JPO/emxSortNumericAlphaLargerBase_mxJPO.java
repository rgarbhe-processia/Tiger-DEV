...
/**
 * The <code>emxSortNumericAlphaLargerBase</code> class contains methods for comparision.
 * @version AEF 10.0 - Copyright (c) 2003, MatrixOne, Inc.
 */

public class emxSortNumericAlphaLargerBase_mxJPO extends emxCommonBaseComparator_mxJPO {
    ...
    public emxSortNumericAlphaLargerBase_mxJPO(Context context, String[] args) throws Exception {
    }
    ...
    public emxSortNumericAlphaLargerBase_mxJPO() {
    }
    ...
    public int compare(Object object1, Object object2) {
        ...
        if ((string1 == null || string1.equals(EMPTY_STRING)) && (string2 == null || string2.equals(EMPTY_STRING))) {
            diff = 0;
