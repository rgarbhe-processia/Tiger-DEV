 ...
 **
 ** This JPO is used to generate data for displaying details of instances (based on config) in a custom table. It provides the table column definitions and the actual cell data.
 */
...
public class MCADInstanceRepresentations_mxJPO {
    ...
    /**
     * Constructor wich accepts the Matrix context and an array of String arguments.
     * @param Context
    ...
    /**
     * This method generates the actual cell data for all the cells to be displayed for the instances.
     * @param Context
     *            context for user logged in
     * @param String
     *            array
     * @return Object as ArrayList This method expects following parameters to be packed in string array sBusId : busId of PART type object langStr : language info for resource bundle jsTreeID : Tree
     *         node ID of above object instanceName : instance selected
     */
