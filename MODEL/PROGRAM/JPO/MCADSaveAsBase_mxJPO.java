...
/**
 * MCADSaveAsBase.java Copyright Dassault Systemes, 1992-2007. All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systemes and its subsidiaries, Copyright
 * notice is precautionary only and does not evidence any actual or intended publication of such program
 */
...
public class MCADSaveAsBase_mxJPO extends IEFCommonUIActions_mxJPO {
    ...
    /*
     * protected void putObjectInMajorMinorBusObejctsTable(Context _context, String busObjectID) throws Exception { BusinessObject busObject = new BusinessObject(busObjectID);
     * busObject.open(_context); String sType = busObject.getTypeName(); busObject.close(_context);
     * 
     * if(_globalConfig.isMinorType(sType) && _generalUtil.isBusObjectFinalized(_context, busObject)) { BusinessObject minorObject = new BusinessObject(busObjectID); BusinessObject majorObj =
     * _util.getMajorObject(_context, minorObject); String majorObjectID = majorObj.getObjectId(_context); majorMinorBusObejctsTable.put(busObjectID,majorObjectID); } }
     */
    // [NDM] : L86 Start
    ...
    protected void saveRelatedDocumentForObject(Context _context, String originalBusID, BusinessObject clonedBusObj, Hashtable busIDSaveAsNameTable, Hashtable busIDTargetRevTable,
            String relatedDocumentJPOName, String newInstanceName) throws MCADException {
        try {
                        ...
                        while (assemblyLikeRelList.hasMoreElements()) {
                            ...
                            if (relDirection.equalsIgnoreCase("to")) {
                                ...
                                if (!originalBusID.equals(busId) && !MCADSaveAsUtil.isConnectedWith(rel.getName(), "", processedRelIds)) {
                                    ...
                                    _util.copyAttributesonRelatinship(_context, rel, relationship);
                                    MCADSaveAsUtil.addConnectedObjList(busObj.getObjectId(_context), clonedRelatedDocumentObj.getObjectId(_context), rel.getName(), relationship.getName(),
    ...
    private void buildLowLevelNodeForInstances(Context _context, String familyId, String busID, BusinessObject clonedBusObject, BusinessObject busObject, Hashtable busIDSaveAsNameTable,
        ...
        /*
         * String activeInstanceId = _generalUtil.getActiveInstanceId(_context, busID); BusinessObject instanceClone = (BusinessObject) clonedChildIdCloneObjectMap.get(activeInstanceId);
         * if(instanceClone!=null) { _util.connectBusObjects(_context, familyId, instanceClone.getObjectId(), strActiveInstanceRelationship, true, new Hashtable()); }
         */
    ...
    /**
     * This method is used to connect the EC Part with cad Object during SaveAs operation This method will use the connection JPO used in EBOM Synchronization.
     */
