 ...
 **
 ** FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.8 $" Date : "$Date: Wed Oct 22 16:02:46 2008 $"
 **
 */
...
/**
 * The <code>emxGenericDocument</code> represents anything on the "To Side" of "Has Documents" Relationship in DC Schema
...
public class emxGenericDocument_mxJPO extends emxGenericDocumentBase_mxJPO {
     ...
     */
    /*
     * public ${CLASSNAME} (String id) throws Exception { // Call the super constructor super(id); }
     */
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("must specify method on emxGenericDocument invocation");
        }
