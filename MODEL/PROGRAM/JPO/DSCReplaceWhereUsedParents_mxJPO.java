...
/**
 * DSCReplaceWhereUsedParents.java Copyright Dassault Systemes, 1992-2007. All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systemes and its
...
public class DSCReplaceWhereUsedParents_mxJPO {
    ...
    /**
     * @param objId
     *            The object id for which we check if its locked or finalized.
     * @return The remark string that will appear on the page if it is locked and finalized.
     */
    ...
    /**
     * @param inBus
     *            Input object for which its minors for the revision are found.
            ...
            if (l < relList.size()) {
                ...
                for (l = 0; l < attrList.size(); l++) {
                    ...
                    if (relModificationStatusAttName.equals(relModificationStatusAtt.getName())) {
                        if (relModificationStatusAtt.getValue() != null && "deleted".equalsIgnoreCase(relModificationStatusAtt.getValue())
                                || "new".equalsIgnoreCase(relModificationStatusAtt.getValue())) {
