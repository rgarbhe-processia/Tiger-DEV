...
public class ENODC5GetLatestInWorkRevision_mxJPO extends MCADIntegGetLatestInWorkRevisionBase_mxJPO {

    protected String ATTR_CADTYPE;

    public ENODC5GetLatestInWorkRevision_mxJPO() {
        super();
    }

    public ENODC5GetLatestInWorkRevision_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
