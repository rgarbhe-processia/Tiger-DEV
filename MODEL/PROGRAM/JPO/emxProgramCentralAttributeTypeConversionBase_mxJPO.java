 ...
 **
 ** Copyright (c) 1992-2015 Dassault Systems, Inc. All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systems, Inc. Copyright notice is precautionary only
...
public class emxProgramCentralAttributeTypeConversionBase_mxJPO {
    ...
    public int convertLagTimeAttribute(Context context, String[] args) throws MatrixException {
        try {
            ...
            if ("integer".equals(strAttributeDataType)) {
                ...
                strMQL.append("add attribute \"").append(strNewAttributeName).append("\" ").append("type ").append(strNewDataType).append(" ").append("description \"").append(strDescription)
                        .append("\" ").append("default \"").append(strDefaultValue).append("\"").append(" property application value ENOVIAEngineering ").append(" property version value V6R2009x ")
                        .append(" property \"original name\" value \"" + strNewAttributeName + "\" ").append(" property installer value Framework ")
                ...
                for (StringItr stringItr = new StringItr(slTypes); stringItr.next();) {
                    ...
                    strMQL = new StringBuffer(128);
                    strMQL.append("modify type \"").append(strType).append("\" add attribute \"").append(ATTRIBUTE_TEMPORARY_NAME).append("\"");
                ...
                MapList mlResults = DomainObject.findObjects(context, strTypePattern, strVaultPattern, strBusWhere, slBusSelect);
                ...
                if (slBusObjectIds.size() > 0) {
                    ...
                    BusinessObjectWithSelectList busObjWithSelectList = BusinessObject.getSelectBusinessObjectData(context, strObjectIds, slBusSelect);
                ...
                for (StringItr stringItr = new StringItr(slRelationships); stringItr.next();) {
                    ...
                    strMQL = new StringBuffer(128);
                    strMQL.append("query connection type \"").append(strRelationshipId).append("\" ").append(" where '").append(strRelWhere).append("' select id dump ,");
                ...
                if (slRelationIds.size() > 0) {
                    ...
                    RelationshipWithSelectList relWithSelectList = Relationship.getSelectRelationshipData(context, strRelIds, relationshipSelects);
                    String strRelId = null;
                    String strAttributeValue = null;
                    RelationshipWithSelect relWithSelect = null;
                    for (RelationshipWithSelectItr relWithSelectItr = new RelationshipWithSelectItr(relWithSelectList); relWithSelectItr.next();) {
     ...
     * @param strAdminObjectType
     *            This can be either 'type' or 'relationship'
    ...
    protected void createRegistration(Context context, String strName, String strSymbolicName, String strApplicationName, String strVersion, String strInstaller) throws MatrixException {
    ...
    protected void updateRegistration(Context context, String strName, String strSymbolicName, String strApplicationName, String strVersion, String strInstaller) throws MatrixException {
        String strInstalledDate = new java.util.Date().toString();
