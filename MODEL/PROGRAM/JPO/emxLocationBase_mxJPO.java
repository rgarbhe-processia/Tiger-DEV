...
public class emxLocationBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public emxLocationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    /**
     * Associate the selected locations to use the context calendar Note- will disconnect from other calendar first before connect
     * @param Context
     * @param location
     *            /business unit/task id, any object that can connect to a calendar
     * @throws FrameworkException
     *             if operation fails
     * @since Common 10.5.1.2
     * @grade 0
     */
    public void setCalendar(Context context, String args[]) throws FrameworkException, Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: objectId - the context calendar object
    ...
    public MapList getLocation(Context context, String[] args) throws Exception {
        ...
        com.matrixone.apps.common.WorkCalendar workcalendar = (com.matrixone.apps.common.WorkCalendar) DomainObject.newInstance(context, objectId);
        ...
        objectList = workcalendar.getRelatedObjects(context, RELATIONSHIP_CALENDAR, TYPE_LOCATION, sel, rel, true, false, (short) 0, null, null);
        return objectList;
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: objectId - the context location object
    ...
    /**
     * Gets the locations based the critera passed. getLocationSearchResults(Context context, String[] args) throws Exception
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
    ...
    public MapList getLocationSearchResults(Context context, String[] args) throws Exception {
        ...
        if (companyId.equals("null") || companyId == null || "".equalsIgnoreCase(companyId)) {
            listOfLocations = DomainObject.findObjects(context, DomainConstants.TYPE_LOCATION, sLocName, "*", "*", context.getVault().getName(), sWhereExp, false, objectSelects);
        } else {
    ...
    /**
     * Assigns the Plant ID attribute value as the revision of Location. assignLocationPlantID(Context context, String[] args) throws Exception
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds objectId and param values.
    ...
    /**
     * Checks Plant ID is unique or not among the Locations available in the company. checkPlanIdUniqueness(Context context, String[] args) throws Exception
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds objectId and param values.
    ...
    public int checkPlantIdUniqueness(Context context, String[] args) throws Exception {
        ...
        if (attr_PlantID.equals(attributeName)) {
            ...
            MapList objectList = dom.findObjects(context, TYPE_LOCATION, "*", objWhere, sel);
    ...
    public void createLocationPostProcess(Context context, String[] args) throws Exception {
        ...
        if (boList.size() == 0) {
            ...
            if (sPrimaryContact != null && !"null".equalsIgnoreCase(sPrimaryContact) && !"".equalsIgnoreCase(sPrimaryContact)) {
                ...
                DomainRelationship.connect(context, location, // the object to connect from
        ...
        if (sName != null && !sName.equals(strLocName)) {
            ...
            try {
                ...
                if (boList.size() == 0) {
                    ...
                    location.change(context, strLocType, sName, strLocRev, strLocVault, strLocPolicy);
                } else {
                    bExists = true;
                }
    ...
    public String getLocationTypeData(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            if ("edit".equals(mode)) {
                buffer.append("<input type=\"checkbox\" name=\"").append(sRelAttrBillingAddress).append("\" value=\"").append(sRelAttrBillingAddress).append("\"").append(strBillingAddress)
                        .append("/>").append(i18NsRelAttrBillingAddress);
                buffer.append("<br>");
                buffer.append("<input type=\"checkbox\" name=\"").append(sRelAttrHeadquarters).append("\" value=\"").append(sRelAttrHeadquarters).append("\"").append(strHeadquartersSite).append("/>")
                        .append(i18NsRelAttrHeadquarters);
                buffer.append("<br>");
                buffer.append("<input type=\"checkbox\" name=\"").append(sRelAttrManufacturing).append("\" value=\"").append(sRelAttrManufacturing).append("\"").append(strManufacturingSite)
                        .append("/>").append(i18NsRelAttrManufacturing);
                buffer.append("<br>");
                buffer.append("<input type=\"checkbox\" name=\"").append(sRelAttrShippingAddress).append("\" value=\"").append(sRelAttrShippingAddress).append("\"").append(strShippingAddress)
                        .append("/>").append(i18NsRelAttrShippingAddress);
            } else if ("create".equals(mode)) {
                buffer.append("<input type=\"checkbox\" name=\"").append(sRelAttrBillingAddress).append("\" value=\"").append(sRelAttrBillingAddress).append("\"></input>")
                        .append(i18NsRelAttrBillingAddress);
                buffer.append("<br/>");
                buffer.append("<input type=\"checkbox\" name=\"").append(sRelAttrHeadquarters).append("\" value=\"").append(sRelAttrHeadquarters).append("\"></input>")
                        .append(i18NsRelAttrHeadquarters);
                buffer.append("<br/>");
                buffer.append("<input type=\"checkbox\" name=\"").append(sRelAttrManufacturing).append("\" value=\"").append(sRelAttrManufacturing).append("\"></input>")
                        .append(i18NsRelAttrManufacturing);
                buffer.append("<br/>");
                buffer.append("<input type=\"checkbox\" name=\"").append(sRelAttrShippingAddress).append("\" value=\"").append(sRelAttrShippingAddress).append("\"></input>")
                        .append(i18NsRelAttrShippingAddress);
            } else {
    ...
    public String getOrgData(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            if ("create".equals(mode)) {
                ...
                /**
                 * IR-268385V6R2014x - k3d RCA: Latin characters are not getting encoded properly to be parsed by SAXBuilder in UIFormCommon:addFields() FIX: changing encodeForHTML to encodeForXML as
                ...
                if (DomainConstants.TYPE_BUSINESS_UNIT.equals(parentType)) {
                    buffer.append("<img src=\"../common/images/iconSmallBusinessUnit.gif\" name=\"imgBusinessUnit\" id=\"imgBusinessUnit\" alt=\"*\" />")
                            .append(XSSUtil.encodeForXML(context, sOrgName));
                } else {
