...
public class emxConversionManifestFileBase_mxJPO {
     ...
     * @param xmlFile
     *            holds conversion manifest file name with full path
     * @param bReloadCache
     ...
     * @since AEF 10.Next
     */
    public void loadConversionManifestFile(Context context, File xmlFile) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param conMftFile
     *            holds conversion manifest file handle
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.Next
     */
    public emxConversionManifestFileBase_mxJPO(Context context, File conMftFile) throws Exception {
     ...
     * @since AEF 10.Next
     */
    public boolean isConversionExecuted(Context context, String sConversion) throws Exception {
        String sCmd = "print program \"" + SYSTEM_INFORMATION_PROGRAM + "\" " + "select property[" + sConversion + "].value " + "dump |";
     ...
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param aPreRequisiteAdmins
     *            ArrayList holding all pre requisite admins
     * @returns true if all admins exists else false
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.Next
     */
    public boolean checkPreRequisiteAdmins(Context context, ArrayList aPreRequisiteAdmins) throws Exception {
     ...
     * @since AEF 10.Next
     */
    public ArrayList getPreConversions(Context context, String sVersion) throws Exception {
     ...
     * @since AEF 10.Next
     */
    public ArrayList getPostConversions(Context context, String sVersion) throws Exception {
     ...
     *            version name
     * @param isPreInstall
     *            returns pre install conversion if true else post
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.Next
     */
    public ArrayList getConversions(Context context, String sVersion, boolean isPreInstall) throws Exception {
        // return list
                    ...
                    for (int ii = 0; lConversions != null && ii < lConversions.size(); ii++) {
                        ...
                        if (!isConversionExecuted(context, sName) && checkPreRequisiteAdmins(context, aPreRequisiteAdmins)) {
                            ...
                            if (sProgramType.equals(ATTRIBUTE_CONVERSION_TYPE_TCL)) {
                                ...
                                String sCmd = "compile program \"" + sProgram + "\"; exec program \"" + sProgram + "\" ";
