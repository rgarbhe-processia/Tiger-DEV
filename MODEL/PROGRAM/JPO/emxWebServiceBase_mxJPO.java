...
public class emxWebServiceBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    /**
     * This method gets Deployment Description filenames associated to a Service object. (used by "Range Function" and "Range Program" setting defined in a web form)
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    /**
     * This method gets Deployment Description filename information associated to a Service object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - String containing Service object id.
     * @return MapList holds a list of description file informations. Each item holds: object id, filename, modified date, file size.
     * @throws Exception
     *             if the operation fails
     * @since ServiceManagement V6R2009x
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - MapList containing all description file information.
    ...
    /**
     * This common check trigger method checks if all Deployment Definition objects are in Inactive state.
     * @param context
     *            The ematrix context of the request
     * @param args
     *            String Array with following arguments: 0 - The Object Id of the Deployment Instance Object.
     * @throws Exception
    ...
    public int checkInactivation(Context context, String[] args) throws Exception, FrameworkException {
        ...
        /*
         * 12/17/2008: Active and Inactive are reserved for the other purpose in the future rlease. so no check whether all DepInst objects are at Undeployed state or not List lstDepInstSelects = new
         * StringList(); List lstRelationshipSelects = new StringList(); lstDepInstSelects.add(DomainConstants.SELECT_ID); lstDepInstSelects.add(DomainConstants.SELECT_CURRENT); // get linked
         * Deployment Instances MapList lstDepInstObjects = wsObj.getRelatedObjects(context, RELATIONSHIP_SD, TYPE_DI, (StringList) lstDepInstSelects, (StringList) lstRelationshipSelects, false, true,
         * (short) 1, "", "");
         * 
         * for (int i = 0; i < lstDepInstObjects.size(); i++) { Map depInstMap = (Map) lstDepInstObjects.get(i); String depInstCurrent = (String) depInstMap.get(DomainConstants.SELECT_CURRENT); //
         * check the state of the linked Deployment Instance if (depInstCurrent.equals(STATE_DEPLOYED)) { i18nNow i18nnow = new i18nNow(); String strLanguage = context.getSession().getLanguage();
         * String strAlertMessage = i18nnow.GetString(RESOURCE_BUNDLE_WSManagement_STR, strLanguage, "emxWSManagement.Inactivate.WebService.ErrorMessage1"); ${CLASS:emxContextUtil}.mqlNotice(context,
         * strAlertMessage); return 1; } }
         */
