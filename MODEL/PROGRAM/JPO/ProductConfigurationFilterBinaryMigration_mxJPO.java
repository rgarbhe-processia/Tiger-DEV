...
public class ProductConfigurationFilterBinaryMigration_mxJPO extends ProductConfigurationFilterBinaryMigrationBase_mxJPO {
    /**
     * @param context
     ...
     * @since FTR V6R2012x
     */
    public ProductConfigurationFilterBinaryMigration_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
