 ...
 **
 ** Copyright (c) 2007-2015 Dassault Systemes. All Rights Reserved.
 **
 ** This program contains proprietary and trade secret information of Dassault Systemes. Copyright notice is precautionary only and does not evidence any actual or intended publication of such program.
 **
 */
...
public class emxFeatureConfigurationMigrationBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @since ProductCentral 10.6
     */
    public void migrate(Context context, String[] args) throws Exception {
     ...
     * @since ProductCentral 10.6
     */
    public int migrateImpl(Context context, String[] args) throws Exception {
        try {
    ...
    /**
     * This method sets the Value of the attribute Feature Type on Feature List Object according to the value of the attributes Marketing Feature and Technical Feature of the corresponding Feature
     * object.
     * @param context
     *            - The eMatrix <code>Context</code> object
     * @return void
     ...
     * @grade 0
     */
    public static void migrateFeatureType(Context context) throws Exception {
        ...
        try {
            ...
            List lstFLList = DomainObject.findObjects(context, ProductLineConstants.TYPE_FEATURE_LIST, DomainConstants.QUERY_WILDCARD, sbWhereExpression.toString(), (StringList) lstObjectSelects);
            if (lstFLList != null) {
                ...
                for (int i = 0; i < lstFLList.size(); i++) {
                    try {
                        ...
                        domFL = DomainObject.newInstance(context, (String) flMap.get(DomainConstants.SELECT_ID));
                        if (strSelMF != null && !(strSelMF.equalsIgnoreCase("null")) && !(strSelMF.equals("")) && strSelMF.equalsIgnoreCase("Yes")) {

                            domFL.setAttributeValue(context, "Feature Type", "Marketing");
                        } else if (strSelTF != null && !(strSelTF.equalsIgnoreCase("null")) && !(strSelTF.equals("")) && strSelTF.equalsIgnoreCase("Yes")) {
                            domFL.setAttributeValue(context, "Feature Type", "Technical");
                        } else if (strSelTF != null && !(strSelTF.equalsIgnoreCase("null")) && !(strSelTF.equals("")) && strSelTF.equalsIgnoreCase("No") && strSelMF != null
                                && !(strSelMF.equalsIgnoreCase("null")) && !(strSelMF.equals("")) && strSelMF.equalsIgnoreCase("No")) {
                            domFL.setAttributeValue(context, "Feature Type", "None");
                        } else {
                            domFL.setAttributeValue(context, "Feature Type", "Marketing");
                        }
     ...
     * @grade 0
     */
    public static void migrateBCR(Context context) throws Exception {
        ...
        try {
            ...
            List lstBCRList = DomainObject.findObjects(context, ProductLineConstants.TYPE_BOOLEAN_COMPATIBILITY_RULE, DomainConstants.QUERY_WILDCARD, null, (StringList) lstObjectSelects);
            if (lstBCRList != null) {
                List lstFOID = null;
                String strRuleId = "";
                String strName = "";
                ...
                for (int i = 0; i < lstBCRList.size(); i++) {
                    try {
                        ...
                        /*
                         * list of Maps containing the FeatureList Ids' of all the feature-option pairs in the given expression.
                         */
                        ...
                        for (int j = 0; j < lstFOID.size(); j++) {
                            ...
                            if (strFLId != null && !strFLId.equalsIgnoreCase("null") && !strFLId.equals("")) {
                                if (isAlreadyConnected(context, strRuleId, strFLId, ProductLineConstants.RELATIONSHIP_LEFT_EXPRESSION)) {
                                    boTmp = new BusinessObject(strFLId);
                                    domObj.disconnect(context, rtLE, true, boTmp);
                                }
                            }
                        }
                        ConnectExpression(context, (String) bcrMap.get("attribute[" + ProductLineConstants.ATTRIBUTE_LEFT_EXPRESSION + "]"), rtLE, strRuleId, lstFOID);
                        ...
                        for (int j = 0; j < lstFOID.size(); j++) {
                            String strFLId = (String) lstFOID.get(j);
                            if (strFLId != null && !strFLId.equalsIgnoreCase("null") && !strFLId.equals("")) {
                                if (isAlreadyConnected(context, strRuleId, strFLId, ProductLineConstants.RELATIONSHIP_RIGHT_EXPRESSION)) {
                                    boTmp = new BusinessObject(strFLId);
                                    domObj.disconnect(context, rtRE, true, boTmp);
                                }
                            }
                        }
                        ConnectExpression(context, (String) bcrMap.get("attribute[" + ProductLineConstants.ATTRIBUTE_RIGHT_EXPRESSION + "]"), rtRE, strRuleId, lstFOID);
     ...
     * @param context
     *            - The eMatrix <code>Context</code> object
     * @param lstBCRParentId
     *            - List : list of parent Product/Feature
     * @return void
     * @since ProductCentral 10-6
     * @grade 0
     */
    public static void logInvalidRules(Context context, List lstBCRParentId) throws Exception {
        ...
        if (lstBCRParentId != null) {
            ...
            /*
             * for each Product/feature Connected to rule call the method validateBCRforInvalidFOReference to return the list of invalid Rules
             */
            for (int j = 0; j < lstBCRParentId.size(); j++)// outer for
            {
                ...
                lstInvalidBCR = ConfigurableRulesUtil.validateBCRforInvalidFOReference(context, (String) lstBCRParentId.get(j));
    ...
    public static List getFOPT_OIDs(Context context, String strExpr) throws FrameworkException {
        if (strExpr != null && strExpr.length() > 0) {
            ...
            for (int iTmp = 0; iTmp < lstTNR.size(); iTmp++) {
                ...
                stbWhrCl.append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_FROM).append("].from.").append(DomainConstants.SELECT_NAME).append("\"~=\"");
                stbWhrCl.append((String) mapFOPT.get(ConfigurableRulesUtil.STR_FNAM));
                stbWhrCl.append("\")");

                stbWhrCl.append("&&(\"relationship[");
                stbWhrCl.append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_FROM).append("].from.").append(DomainConstants.SELECT_TYPE).append("\"~=\"");
                stbWhrCl.append((String) mapFOPT.get(ConfigurableRulesUtil.STR_FTYP));
                stbWhrCl.append("\")");

                stbWhrCl.append("&&(\"relationship[");
                stbWhrCl.append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_FROM).append("].from.").append(DomainConstants.SELECT_REVISION).append("\"~=\"");
                stbWhrCl.append((String) mapFOPT.get(ConfigurableRulesUtil.STR_FREV));
                stbWhrCl.append("\")");

                stbWhrCl.append("&&(\"relationship[");
                stbWhrCl.append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_TO).append("].to.").append(DomainConstants.SELECT_TYPE).append("\"~=\"");
                stbWhrCl.append((String) mapFOPT.get(ConfigurableRulesUtil.STR_OTYP));
                stbWhrCl.append("\")");

                stbWhrCl.append("&&(\"relationship[");
                stbWhrCl.append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_TO).append("].to.").append(DomainConstants.SELECT_REVISION).append("\"~=\"");
                stbWhrCl.append((String) mapFOPT.get(ConfigurableRulesUtil.STR_OREV));
                stbWhrCl.append("\")");

                stbWhrCl.append("&&(\"relationship[");
                stbWhrCl.append(ProductLineConstants.RELATIONSHIP_FEATURE_LIST_TO).append("].to.").append(DomainConstants.SELECT_NAME).append("\"~=\"");
                stbWhrCl.append((String) mapFOPT.get(ConfigurableRulesUtil.STR_ONAM));
                stbWhrCl.append("\")");
                lstDBRes = DomainObject.findObjects(context, ProductLineConstants.TYPE_FEATURE_LIST, DomainConstants.QUERY_WILDCARD, stbWhrCl.toString(), lstObjSel);
    ...
    /**
     * This method is called by Create/Edit of Rules ( Boolean Compatibility, Product Compatibility Rules) This method stores the expression tokens in relationship attributes. It calls
     * getParsedExpression to get a space trimmed expression which will be easy to process.
     * @param context
     *            - The eMatrix <code>Context</code> object.
     * @param strExpression
     *            - The expression that user enters in the UI form; Create/Edit dialog.
     * @param relationshipType
     *            - The relationship with which the objects need to be connected. in the current data Model it is either Left Expression/Right Expression.
     * @param strRuleId
     *            - The ObjectId of the context Rule.
     * @param lstobjIds
     *            - The List of Object Ids corresponding to the objects selected while forming the Left/Right Expression.
     * @return - void
     * @throws Exception
     * @since ProductCentral 10-6
     * @grade 0
    ...
    public static void ConnectExpression(Context context, String strExpression, RelationshipType relationshipType, String strRuleId, List lstobjIds) throws Exception {
            ...
            while (i < strExpression.length()) {
                ...
                if (bobjConnect) {
                    ...
                    if (!((String) lstobjIds.get(iobjCounter)).equals("null")) {
                        rel = domTmp.addToObject(context, relationshipType, (String) lstobjIds.get(iobjCounter));
                    ...
                    rel = domTmp.addToObject(context, relationshipType, strRuleId);
    ...
    public static void migrateIR(Context context) throws Exception {
        ...
        List lstProductTypes = ProductLineUtil.getChildrenTypes(context, ProductLineConstants.TYPE_PRODUCTS);
        ...
        try {
            ...
            List lstFLGBOMList = DomainObject.findObjects(context, sbTypePattern.toString(), DomainConstants.QUERY_WILDCARD, "attribute[" + ProductLineConstants.ATTRIBUTE_EXPRESSION + "]!=\"\"",
            ...
            if (lstFLGBOMList != null) {
                ...
                /*
                 * Loop through the list of FL and GBOMs ,fetch the Expression attribute , create Inclusion Rule object and finally connect it to other objects
                 */
                for (int i = 0; i < lstFLGBOMList.size(); i++) {
                    try {
                        ...
                        if (strExp != null && (!(strExp.equalsIgnoreCase("null"))) && (!(strExp.equals("")))) {
                            // Open transaction boundary
                            ContextUtil.startTransaction(context, true);
                            // create a new Inclusion rule object
                            strIncRuleID = PRCCommonInstance.create(context, ProductLineConstants.TYPE_INCLUSION_RULE, DomainConstants.EMPTY_STRING, "-", DomainConstants.EMPTY_STRING,
                                    DomainConstants.EMPTY_STRING, strVault, null, strOwner, (String) fLGBOMMap.get(DomainConstants.SELECT_ID), ProductLineConstants.RELATIONSHIP_LEFT_EXPRESSION,
                                    false);
                            ...
                            // store the expression tokens in relationship attributes
                            ConnectExpression(context, strExp, new RelationshipType(ProductLineConstants.RELATIONSHIP_RIGHT_EXPRESSION), strIncRuleID, lstFOID);
                            ...
                            if (strType != null && !"".equals(strType) && !"null".equalsIgnoreCase(strType)) {
                                if ((ProductLineConstants.TYPE_FEATURE_LIST).equals(strType)) {
                                    if ((strFLParentId != null && !"".equals(strFLParentId) && !"null".equalsIgnoreCase(strFLParentId))
                                            && (strFLParentType != null && !"".equals(strFLParentType) && !"null".equalsIgnoreCase(strFLParentType) && lstProductTypes.contains(strFLParentType))) {
                                        strParentProductId = strFLParentId;
                                        bConnectThroughLR = true;
                                    }
                                } else if ((ProductLineConstants.TYPE_GBOM).equals(strType)) {
                                    if ((strGBOMParentId != null && !"".equals(strGBOMParentId) && !"null".equalsIgnoreCase(strGBOMParentId)) && (strGBOMParentType != null
                                            && !"".equals(strGBOMParentType) && !"null".equalsIgnoreCase(strGBOMParentType) && lstProductTypes.contains(strGBOMParentType))) {
                                        strParentProductId = strGBOMParentId;
                                        bConnectThroughLR = true;
                                    }
                                }
                            }
                            if (strIncRuleID != null && !"".equals(strIncRuleID) && !"null".equalsIgnoreCase(strIncRuleID) && bConnectThroughLR) {
                                domRel.connect(context, strParentProductId, ProductLineConstants.RELATIONSHIP_LOCAL_RULE, strIncRuleID, false);
                            }
                            ContextUtil.commitTransaction(context);
                        } // end if
    ...
    /**
     * This method is called by ConnectExpression method This method parses the input expression and removes the spaces simplifies the format For example ["A" AND "B"] OR NOT "C" will be converted to
     * [X&X]|!X.
     * @param strExpression
    ...
    /**
     * This method is called by migrateBCR method This method removes the dupliacte values from the list
     * @param lstInput
     *            - The Input List
     ...
     * @grade 0
     **/
    public static List removeDupilacate(List lstInput) throws Exception {
    ...
    /**
     * This method is called by migrateBCR method It finds whether two objects are connected through a Particular Relationship or not.
     * @param context
     *            - The eMatrix <code>Context</code> object
     * @param strFromId
     *            - from side Object Id
    ...
    public static boolean isAlreadyConnected(Context context, String strFromId, String strToId, String strRelName) throws Exception {
        ...
        List lstRelatedObj = (MapList) domFL.getRelatedObjects(context, strRelName, DomainConstants.QUERY_WILDCARD, null, new StringList(DomainConstants.SELECT_ID), true, false, (short) 1,
                sbWhereExpression.toString(), DomainConstants.EMPTY_STRING, 0);
    ...
    /**
     * This method sets the Value of the attribute Feature Type on Feature List Object according to the value of the attribute Manufacturing Feature
     * @param context
     *            - The eMatrix <code>Context</code> object
     * @return void
     * @throws Exception
     ...
     * @grade 0
     */
    public static void migrateManufacturingFeature(Context context) throws Exception {
        try {
            ...
            // Get all the Feature List objects in the database
            MapList lstFLList = DomainObject.findObjects(context, ProductLineConstants.TYPE_FEATURE_LIST, DomainConstants.QUERY_WILDCARD, "", objSelect);
            if (lstFLList != null) {
                for (int i = 0; i < lstFLList.size(); i++) {
                    ...
                    if (attMFGFeature != null && "Yes".equalsIgnoreCase(attMFGFeature)) {
                        DomainObject domFL = DomainObject.newInstance(context, (String) flMap.get(DomainConstants.SELECT_ID));

                        domFL.setAttributeValue(context, ProductLineConstants.ATTRIBUTE_FEATURE_TYPE, "Manufacturing");
                    }
                } // end for
            } // end if
        } catch (Exception e) {
    ...
    /**
     * This method returns internalized value for the passed key in ProductCentral string resouce file.
     * @param context
     *            - The eMatrix <code>Context</code> object
     * @param strKey
     *            - Property file entry
    ...
    public static List lstGetTNR(String strExpression) {
        ...
        do {
            iIndexInterTNR = strExpression.indexOf(C_INTER_TNR_SEPERATOR, iIndexInterTNR + 1);
            if (iIndexInterTNR == -1)
                break;
            ...
            iIndexIntraTNR = strExpression.indexOf(STR_INTRA_TNR_SEPERATOR, iIndexInterTNR + 1);

            mapTNR.put(ConfigurableRulesUtil.STR_FTYP, strExpression.substring(iIndexInterTNR + 1, iIndexIntraTNR));

            iIndexIntraTNROld = iIndexIntraTNR;
            iIndexIntraTNR = strExpression.indexOf(STR_INTRA_TNR_SEPERATOR, iIndexIntraTNR + 1);
            mapTNR.put(ConfigurableRulesUtil.STR_FNAM, strExpression.substring(iIndexIntraTNROld + I_TNR_SEPER_LENGTH, iIndexIntraTNR));

            iIndexFOPT = strExpression.indexOf(C_FOPT_SEPERATOR, iIndexInterTNR + 1);

            mapTNR.put(ConfigurableRulesUtil.STR_FREV, strExpression.substring(iIndexIntraTNR + I_TNR_SEPER_LENGTH, iIndexFOPT));

            iIndexIntraTNROld = iIndexIntraTNR;
            iIndexIntraTNR = strExpression.indexOf(STR_INTRA_TNR_SEPERATOR, iIndexIntraTNR + 1);
            mapTNR.put(ConfigurableRulesUtil.STR_OTYP, strExpression.substring(iIndexFOPT + 1, iIndexIntraTNR));

            iIndexIntraTNROld = iIndexIntraTNR;
            iIndexIntraTNR = strExpression.indexOf(STR_INTRA_TNR_SEPERATOR, iIndexIntraTNR + 1);
            mapTNR.put(ConfigurableRulesUtil.STR_ONAM, strExpression.substring(iIndexIntraTNROld + I_TNR_SEPER_LENGTH, iIndexIntraTNR));

            iIndexInterTNR = strExpression.indexOf(C_INTER_TNR_SEPERATOR, iIndexInterTNR + 1);
            mapTNR.put(ConfigurableRulesUtil.STR_OREV, strExpression.substring(iIndexIntraTNR + I_TNR_SEPER_LENGTH, iIndexInterTNR));
            lstTNR.add(mapTNR);
    ...
    /**
     * This method writes to the log file using the Printwriter object and to MQL console using BufferedWriter object.
     * @param bVerbose
     *            - to show output on MQL console
     * @param strLogEnrty
     *            - Message to write
     * @return void
     * @throws Exception
     ...
     * @grade 0
     */
    public static void migrationInfoWriter(boolean bVerbose, String strLogEnrty) throws Exception {
    ...
    /**
     * This method sets the Value of the GBOM From to Feature List Object to the attributes Marketing Feature and Technical Feature of the corresponding Feature object.
     * @param context
     *            - The eMatrix <code>Context</code> object
     * @return void
     * @throws Exception
    ...
    public static void migrationTechnicalFeature(Context context) throws Exception {
        try {
    ...
    /**
     * This method is used to connect all the Features and SubFeatures to the Product using the Product Feature Relationship
     * @param context
     *            - The eMatrix <code>Context</code> object
     * @return void
     * @throws Exception
    ...
    public static void migrationProductFeatureList(Context context) throws Exception {
        try {
            ...
            if (lstProductList != null) {
                ...
                for (int i = 0; i < lstProductList.size(); i++) {
                    ...
                    MapList listFeatures = domProduct.getRelatedObjects(context, strRelPattern, "*", false, true, (int) 0, objSelect, relSelects, DomainConstants.EMPTY_STRING,
                            DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, null);
        ...
        while (itrPC.hasNext()) {
            try {
                ...
                if (topLevelPart == null || topLevelPart.length() <= 0) {
                    ...
                    String objProductId = objProductConfiguration.getInfo(context, "to[" + ProductLineConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].from." + ProductLineConstants.SELECT_ID);
                    ...
                    gbomList = domProductObject.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_GBOM_FROM, ProductLineConstants.TYPE_GBOM, false, true, 1, selectable, null,
                            stbWhereClause.toString(), null, null, null, null);
                    ...
                    if ((strPFType != null && strPFType.length() > 0) && (strPFName != null && strPFName.length() > 0) && (strPFRevision != null && strPFRevision.length() > 0)) {
                        ...
                        MapList mapListEBOMRelatedObject = objProductConfiguration.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EBOM, DomainConstants.TYPE_PART, selectStmts, relSelectsList,
                        ...
                        migrationInfoWriter(bWriteOnMqlConsole,
                                TOP_LEVEL_PART + " : " + objPart.getInfo(context, "type") + " " + objPart.getInfo(context, "name") + " " + objPart.getInfo(context, "revision") + "\n");
                    ...
                    migrationInfoWriter(bWriteOnMqlConsole,
                            TOP_LEVEL_PART + " : " + objTLP.getInfo(context, "type") + " " + objTLP.getInfo(context, "name") + " " + objTLP.getInfo(context, "revision") + "\n");
