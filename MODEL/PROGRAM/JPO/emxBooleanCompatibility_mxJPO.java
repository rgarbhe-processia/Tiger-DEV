 ...
 *
 * static const char RCSID[] = $Id: /ENOVariantConfigurationBase/CNext/Modules/ENOVariantConfigurationBase/JPOsrc/custom/${CLASSNAME}.java 1.3.2.1.1.1 Wed Oct 29 22:27:16 2008 GMT przemek
 * Experimental$
 */
...
/**
 * This JPO class contains method pertaining to Boolean Compatibility Rule type.
 * @author Enovia MatrixOne
 * @version ProductCentral 10.5 - Copyright (c) 2004, MatrixOne, Inc.
 */
public class emxBooleanCompatibility_mxJPO extends emxBooleanCompatibilityBase_mxJPO {

    /**
     * Create a new emxBooleanCompatibility Object from a given id.
     * @param context
    ...
    public emxBooleanCompatibility_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
