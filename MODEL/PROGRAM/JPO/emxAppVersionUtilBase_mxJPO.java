...
public class emxAppVersionUtilBase_mxJPO {
     ...
     */
    @Deprecated
    public emxAppVersionUtilBase_mxJPO(Context context, String sApplicationName, String sAppInfoFile) throws Exception {
        loadAppVersionHistory(context, sApplicationName, sAppInfoFile, true);
    }

    public emxAppVersionUtilBase_mxJPO(Context context, String sApplicationName, String sAppInfoFile, String schemaName) throws Exception {
    ...
    public void loadAppVersionHistory(Context context, String sApplicationName, String sAppInfoFile, boolean bReload) throws Exception {
        if (bReload || aVersions == null) {
            ...
            String sSchemaVersion = emxInstallUtil_mxJPO.executeMQLCommand(context,
                    "print program \"" + SYSTEM_INFORMATION_PROGRAM + "\" select property[appSchema" + schemaName.replace(" ", "") + "].value dump");
