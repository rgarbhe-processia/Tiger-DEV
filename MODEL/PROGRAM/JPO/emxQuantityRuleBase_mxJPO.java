...
public class emxQuantityRuleBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     */
    public emxQuantityRuleBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public MapList getAllQuantityRules(Context context, String[] args) throws Exception {
        ...
        relBusObjPageList = dom.getRelatedObjects(context, strRelationship, strType, objectSelects, RelationSelects, false, true, (short) 0, null, null, 0);
    ...
    public Vector getRuleStatus(Context context, String args[]) throws Exception {
        ...
        while (i.hasNext()) {
            ...
            String strQurey = RELATIONSHIP_NAME + OPEN_BRACE + ConfigurationConstants.RELATIONSHIP_QUANTITY_RULE + CLOSE_BRACE + DOT + STR_ATTRIBUTE + OPEN_BRACE
                    + ConfigurationConstants.ATTRIBUTE_RULE_STATUS + CLOSE_BRACE;

            String i18Value = i18nNow.getRangeI18NString(ConfigurationConstants.ATTRIBUTE_RULE_STATUS, (String) ObjFeature.getInfo(context, strQurey), context.getSession().getLanguage());
    ...
    /**
     * Method call to get the Edit Link for Quantity Rules Summary Page for the feature
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public Vector getEditColumnDisplay(Context context, String[] args) throws Exception {
        ...
        while (i.hasNext()) {
            ...
            if (!isPrinterFriendly) {
                columnVals.addElement("<a href=\"javascript:emxTableColumnLinkClick('../configuration/CreateQuantityRule.jsp?mode=edit%26emxSuiteDirectory=configuration%26relId=" + relId
                        + "%26suiteKey=configuration%26parentOID=" + parentId + "%26objectId=" + id + "%26productID=" + strProductID
                        + "', '780', '770', 'true', 'popup', '')\"><img border=\"0\" src=\"images/iconActionEdit.gif\" alt=\"\"/></a>");
    ...
    /**
     * Wrapper method to display the Right Expression value in Quantity Rule List Page Called from Table Column settings
     * @param context
     * @param args
     * @return
     * @throws Exception
