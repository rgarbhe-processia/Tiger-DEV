 ...
 */
public class emxECOBase_mxJPO extends emxChange_mxJPO {

    /** state "Approved" for the "EC Part" policy. */
    public static final String STATE_ECPART_APPROVED = PropertyUtil.getSchemaProperty("policy", POLICY_EC_PART, "state_Approved");
    ...
    public static final String STATE_ECPART_OBSOLETE = PropertyUtil.getSchemaProperty("policy", POLICY_EC_PART, "state_Obsolete");
    ...
    public static final String STATE_CADDRAWING_APPROVED = PropertyUtil.getSchemaProperty("policy", POLICY_CAD_DRAWING, "state_Approved");
    ...
    public static final String STATE_CADMODEL_APPROVED = PropertyUtil.getSchemaProperty("policy", POLICY_CAD_MODEL, "state_Approved");
    ...
    public static final String STATE_DRAWINGPRINT_APPROVED = PropertyUtil.getSchemaProperty("policy", POLICY_DRAWINGPRINT, "state_Approved");
    ...
    public static final String RESOURCE_BUNDLE_EC_STR = "emxEngineeringCentralStringResource";
     ...
     * @since EC Rossini.
     */
    public emxECOBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds String array as arguments
     * @return Boolean.
     * @throws Exception
     *             if the operation fails.
     */
    ...
    /**
     * Check the current state of the object with the target state, using the comparison operator and returns the result.
     * @return an int value. 0 if object state logic satisfies Comparison Operator. 1 if object state logic didn't satisfies Comparison Operator. 2 if a program error is encountered 3 if state in
     *         state argument does not exist in the policy 4 if an invalid comparison operator is passed in
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param id
     *            String representing the id of the object whose state to be checked.
     * @param targetState
     *            String representing the target state against which the current state of the object is compared.
     * @param comparisonOperator
     *            int representing the operator used for comparison LT, GT, EQ, LE, GE, NE.
     * @since EC 10.0.0.0.
     */
    ...
    /**
     * Check the current state of the object with the target state, using the comparison operator and returns the result. This is a performance enhanced version since we are passing in the list of all
     * states and current states of the object.
     * @return an int value. 0 if object state logic satisfies Comparison Operator. 1 if object state logic didn't satisfies Comparison Operator. 2 if a program error is encountered 3 if state in
     *         state argument does not exist in the policy 4 if an invalid comparison operator is passed in
     * @param context
     *            The eMatrix <code>Context</code> object.
     * @param allStates
     *            A StringList of all the states for this objects policy.
     * @param currentState
     *            String representing the current state of the object.
     * @param targetState
     *            String representing the target state against which the current state of the object is compared.
     * @param comparisonOperator
     *            int representing the operator used for comparison LT, GT, EQ, LE, GE, NE.
     ...
     * @return boolean value true - if all the signature until needed state are satisfied (approved/ignored). false - if any of the signature before needed state is not satisfied (approved/ignored).
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param id
     *            String representing the id of object whose signatures to be checked.
     * @param checkState
     *            String representing the given state upto which signatures are to be checked.
     * @since EC 10.0.0.0.
     */
     ...
     *            the eMatrix <code>Context</code> object.
     * @param id
     *            the id of object whose signatures to be checked.
     * @param stateList
     *            StringList of all states for the objects policy.
     * @param currentState
     *            String representing the current state of the object.
     * @param checkState
     *            the given state upto which signatures are to be checked.
     * @return true - if all the signature until needed state are satisfied (approved/ignored). false - if any of the signature before needed state is not satisfied (approved/ignored).
     * @since EC 10.6.
     */
     ...
     *            the eMatrix <code>Context</code> object.
     * @param policyName
     *            String representing the policy to be checked.
     * @param stateName
     *            String representing the state to be checked.
    ...
    /**
     * When the last changed item associated with the ECO reaches the pre-release state ("Approved"), then the ECO needs to be automatically promoted to the "Review" state.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds no arguments.
    ...
    public void autoPromoteECOToReviewState(matrix.db.Context context, String[] args) throws Exception {
        ...
        try {
            ...
            ecoList = getRelatedObjects(context, relPattern, TYPE_ECO, objectSelects, null, true, false, (short) 1, null, null);
            ...
            while (ecoItr.hasNext()) {
                ...
                ECO.setId(ecoId);
                objList = ECO.getRelatedObjects(context, relPattern, "*", objectSelects, null, false, true, (short) 1, whereStmt, null);
                    ...
                    try {
                        ...
                        if (bSignature) {
                            ...
                            try {
                                ...
                                // ECO.setState(context, STATE_ECOSTANDARD_REVIEW);
            ...
            if (warning != null) {
                emxContextUtil_mxJPO.mqlNotice(context,
                        EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ChangeManagement.AutoCheckChangedItemToCompleteStateWarning", context.getSession().getLanguage()) + warning);
            }
        }
    }

    /**
     * When the affected item being promoted to "Release" state, the ECO associated with it must have reached its "Release" state, otherwise affected item should not be promoted to the "Release"
     * state.
     * @return int value. 0-success if the ECO's attached to the affected item is beyond "Release" state. 1-failure if any of the ECO attached to the affected item is below "Release" state.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds no arguments.
    ...
    public int autoCheckChangedItemToReleaseState(matrix.db.Context context, String[] args) throws Exception {
        ...
        try {
            ...
            whereStmt = whereStmt + " && "
                    + formWhereQueryBelowState(context, ChangeConstants.TYPE_CHANGE_ACTION, PropertyUtil.getSchemaProperty(context, "policy", ChangeConstants.POLICY_CHANGE_ACTION, "state_Complete"),
            ...
            // based on the type use the relationship filter that are applicable alone
            relPattern = relPattern + "," + ChangeConstants.RELATIONSHIP_CHANGE_AFFECTED_ITEM + "," + ChangeConstants.RELATIONSHIP_IMPLEMENTED_ITEM;
            ...
            try {
                objList = FrameworkUtil.toMapList(
                        getExpansionIterator(context, relPattern, typePattern, objectSelects, relSelects, true, false, (short) 1, whereStmt, null, (short) 0, false, false, (short) 0, false),
            ...
            emxContextUtil_mxJPO.mqlNotice(context,
                    EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECO.AutoCheckChangedItemToReleaseStateWarning", context.getSession().getLanguage()) + sUnReleasedList);
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds a HashMap containing the following entries: objectId - a String holding object id.
    ...
    public MapList getECOAffectedItems(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            affectedItems = FrameworkUtil.toMapList(ecoObj.getExpansionIterator(context, relPattern, DomainConstants.QUERY_WILDCARD, selectStmts, selectRelStmts, false, true, (short) 1, null, null,
                    (short) 0, false, false, (short) 0, false), (short) 0, null, null, null, null);
        }
     ...
     *            the eMatrix <code>Context</code> object.
     * @param type
     *            a String which holds type of the object.
     * @param attribute
     *            a String which holds the name of the attribute.
    ...
    public boolean isAttributeOnTypeAndNonHidden(Context context, String type, String attribute) throws Exception {
        return ((FrameworkUtil.isAttributeOnType(context, type, attribute)) && !(FrameworkUtil.isAttributeHidden(context, attribute)));
    }

    /**
     * Checks if the given resource id is set to true or false.
     * @param resourceID
     *            String which holds the property value to check.
     * @return Boolean containing the resource value.
     * @throws Exception
     *             if the operation fails.
     * @since 10.5.
     */
    private Boolean emxCheckAccess(Context context, String resoureID) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds a HashMap containing the following entries: objectId - a String holding the ECO id.
     * @return Boolean determines whether BOM Comparison is accessable.
     * @throws Exception
     *             if the operation fails.
     * @since 10.5.
     */
    public Boolean emxCheckRoutesAccess(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
     ...
     * @since 10.5.
     */
    public Boolean emxCheckApprovalsAccess(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        Boolean emxAccess = Boolean.TRUE;
     ...
     * @since 10.5.
     */
    public Boolean emxCheckRouteInstructionsAccess(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
        Boolean emxAccess = Boolean.TRUE;
     ...
     * @since 10.5.
     */
    public Boolean emxCheckObsoletePartsAccess(Context context, String[] args) throws Exception {
     ...
     * @since 10.5.
     */
    public Boolean emxCheckRevisedPartsAccess(Context context, String[] args) throws Exception {
     ...
     * @since 105.
     */
    public Boolean emxCheckNewPartsAccess(Context context, String[] args) throws Exception {
     ...
     * @since 10.5.
     */
    public Boolean emxCheckRelatedECRsAccess(Context context, String[] args) throws Exception {
     ...
     * @since 10.5.
     */
    public Boolean emxCheckNewSpecsAccess(Context context, String[] args) throws Exception {
     ...
     * @since 10.5.
     */
    public Boolean emxCheckRevisedSpecsAccess(Context context, String[] args) throws Exception {
     ...
     * @since 10.5.
     */
    public Boolean emxCheckBOMComparisonAccess(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds the following input arguments: 0 - String containing object id.
    ...
    public String getApprovals(Context context, String args[]) throws Exception {
        ...
        if (!bRouteSize && !bSign) {
            returnString.append("<tr><td class=\"even\" colspan=\"3\" align=\"center\" > " + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.SummaryReport.NoSignOrRoutes", languageStr)
                    + "</td></tr>");
        }
    ...
    public String getBasicInfo(Context context, String args[]) throws Exception {
        ...
        returnString.append("<tr><td class=\"label\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Name", strLanguage) + ":</td><td class=\"inputField\">"
                + attributeMap.get(SELECT_NAME) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Type", strLanguage) + ":</td><td class=\"inputField\">"
                + attributeMap.get(SELECT_TYPE) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.State", strLanguage) + ":</td><td class=\"inputField\">"
                + i18nNow.getStateI18NString((String) attributeMap.get(SELECT_POLICY), (String) attributeMap.get(SELECT_CURRENT), strLanguage) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Owner", strLanguage) + ":</td><td class=\"inputField\">"
                + com.matrixone.apps.domain.util.PersonUtil.getFullName(context, ((String) attributeMap.get(SELECT_OWNER))) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Originator", strLanguage) + ":</td><td class=\"inputField\">"
                + com.matrixone.apps.domain.util.PersonUtil.getFullName(context, ((String) attributeMap.get(SELECT_ORIGINATOR))) + "</td></tr>");

        returnString.append("<tr><td class=\"label\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Originated", strLanguage) + ":</td><td class=\"inputField\">"
                + (String) attributeMap.get(SELECT_ORIGINATED) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Modified", strLanguage) + ":</td><td class=\"inputField\">"
                + (String) attributeMap.get(SELECT_MODIFIED) + "</td></tr>");

        returnString.append("</table></td>");

        returnString.append("<td><table width=\"100%\" border=\"0\" cellpadding=\"3\" cellspacing=\"0\" >");
        returnString.append("<tr><td class=\"label\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Description", strLanguage) + ":</td><td class=\"inputField\">" + ecoDesc
                + "&nbsp;</td></tr>");
        ...
        while (ecoAttrListItr.hasNext()) {
            ...
            if ((ECO.ATTRIBUTE_RESPONSIBLE_DESIGN_ENGINEER).equals(attrName) || (ECO.ATTRIBUTE_RESPONSIBLE_MANUFACTURING_ENGINEER).equals(attrName)
        ...
        returnString.append("<tr><td class=\"label\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.DesignResponsibility", strLanguage) + ":</td><td class=\"inputField\">"
                + sDesignResponsibility + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Vault", strLanguage) + ":</td><td class=\"inputField\">"
                + attributeMap.get(SELECT_VAULT) + "</td></tr>");
        returnString.append("</table></td>");
        returnString.append("</tr>");
        returnString.append("</table>");
    ...
    public String getStyleInfo(Context context, String args[]) throws Exception {
        ...
        /*
         * ==================================================================== // Spec View Stylesheet // Platform: Windows // by Don Maurer //
         * ====================================================================
         */
        ...
        // htmlString.append(returnString.toString()+"</body></html>");
    ...
    public MapList getRevisedParts(Context context, String[] args) throws Exception {
        String objectId = args[0];
        ...
        try {
            ...
            revisedPartsList = ecoObj.getParts(context, RELATIONSHIP_AFFECTED_ITEM, selectStmts, selectRelStmts, false, bDevelopmentInUse, bCMInUse);
     ...
     * @since 10.5.
     */
    public String getRelatedECRs(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        ...
        try {
            ...
            ecrMapList = FrameworkUtil.toMapList(ecoObj.getExpansionIterator(context, DomainConstants.RELATIONSHIP_ECO_CHANGEREQUESTINPUT, "*", selectStmts, selectRelStmts, false, true, (short) 1,
                    null, null, (short) 0, false, false, (short) 0, false), (short) 0, null, null, null, null);
     ...
     * @since 10.5.
     */
    public String getRoutes(Context context, String[] args) throws Exception, MatrixException {
        try {
            String strLanguage = context.getSession().getLanguage();
            String objectId = args[0];
            Route routeObj = (Route) DomainObject.newInstance(context, TYPE_ROUTE);
     ...
     * @since 10.5.
     */
    public String getBOMComparisonDetails(Context context, String[] args) throws Exception {
     ...
     *            holds the following input arguments: 0 - String containing object id.
     * @param sPart1Id
     *            String first part object id.
     * @param sPart1Id
     *            String second part object id.
    ...
    public String getPartComparisonDetails(Context context, String[] args, String sPart1Id, String sPart2Id) throws Exception {
        ...
        try {
            ...
            ExpansionIterator _objectSelect = ExpandPartObj.getExpansionIterator(context, DomainRelationship.RELATIONSHIP_EBOM, TYPE_PART, selectStmts, selectRelStmts, false, true, (short) 1, null,
                    null, (short) 0, false, false, (short) 1, false);
            ...
            try {
                _objectSelect = ExpandPartObj.getExpansionIterator(context, DomainRelationship.RELATIONSHIP_EBOM, TYPE_PART, selectStmts, selectRelStmts, false, true, (short) 1, null, null, (short) 0,
     ...
     *            the eMatrix <code>Context</code> object.
     * @param info
     *            Hashtable which holds the comparable information for both parts like common, unique parts.
     * @return String containing Comparison information in html format.
     * @throws Exception
     *             if the operation fails.
     * @since 10.5.
    ...
    public String getPartComparisonDetailsHTML(Context context, Hashtable info) throws Exception {
        ...
        if (!comparePrintReport.isEmpty()) {
            ...
            while (eKeys.hasMoreElements()) {
                ...
                if (comparePrintReport.containsKey(sFNHolder)) {
                    ...
                    /* Modified below line. bug 293526 */
                    String sName = "<table cellspacing=\"1\" cellpadding=\"1\"><tr><td><img src=\"../common/images/" + typeIcon3 + "\" border=0 alt=\"*\"></td><td>" + sTok.nextToken()
                            + "</td></tr></table>";
        ...
        if (!unique1PrintReport.isEmpty()) {
            ...
            while (eKeys.hasMoreElements()) {
                ...
                comparisonHTML.append("<td> <table cellspacing=\"1\" cellpadding=\"1\"><tr><td><img src=\"../common/images/" + typeIcon4 + "\" border=\"0\" alt=\"*\"></td><td>" + sName
                        + "</td></tr></table>&nbsp </td>");
        ...
        if (!unique2PrintReport.isEmpty()) {
            ...
            while (eKeys.hasMoreElements()) {
                ...
                comparisonHTML.append("<td> <table cellspacing=\"1\" cellpadding=\"1\"><tr><td><img src=\"../common/images/" + typeIcon5 + "\" border=\"0\" alt=\"*\"></td><td>" + sName
                        + "</td></tr></table>&nbsp </td>");
                comparisonHTML.append("<td> " + sRev + "&nbsp </td>");
                comparisonHTML.append("<td> " + sDescription + "&nbsp </td>");
    ...
    /**
     * Creates the ECO Html summary report. This method has been replicated with createSummaryReport to facilitate PDF report as a Patch.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds the following input arguments: 0 - String containing object id.
    ...
    public String createHtmlReport(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            summaryReport.append("<tr><td class=\"pageHeader\"><h1>" + ecoObj.getInfo(context, SELECT_NAME) + ":&nbsp;"
                    + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.SummaryReport", strLanguage) + "</h1></td>");
            ...
            summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Attributes", strLanguage)
                    + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append(
                        "<table width=\"100%\"><tr><td class=\"subhead\"><h2>" + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.Approvals", strLanguage) + "</h2></td></tr></table>");
                summaryReport.append(getApprovals(context, args));
            }
            // Routes Display
            boolObj = emxCheckAccess(context, "emxEngineeringCentral.ECOSummary.Routes");
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Routes", strLanguage)
                        + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append(
                        "<table width=\"100%\"><tr><td class=\"subhead\"><h2>" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Tasks", strLanguage) + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>" + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.ECOAffectedParts", strLanguage)
                        + "</h2></td></tr></table>");
            ...
            boolObj = emxCheckAccess(context, "emxEngineeringCentral.ECOSummary.AffectedItems");
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>" + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.ECOAffectedSpecs", strLanguage)
                        + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append(
                        "<table width=\"100%\"><tr><td class=\"subhead\"><h2>" + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.ECOAssingees", strLanguage) + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>" + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.ECORelatedECRs", strLanguage)
                        + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>" + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.ECORelatedMarkups", strLanguage)
                        + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>" + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.ReferenceDocuments", strLanguage)
                        + "</h2></td></tr></table>");
            ...
            if (boolObj.booleanValue()) {
                summaryReport.append("<table width=\"100%\"><tr><td><br></td></tr><tr><td class=\"subhead\"><h2>"
                        + EngineeringUtil.i18nStringNow(context, "emxFramework.Command.ResolvedItems", strLanguage) + "</h2></td></tr></table>");
    ...
    public int createSummaryReport(Context context, String args[]) throws Exception {
        ...
        if (pdfGenerated != 0) {
            emxContextUtil_mxJPO.mqlError(context, EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.SummaryReport.NoCheckIn.ErrorMessage", context.getSession().getLanguage()));
            return 1;
        } else {
            return 0;
        }
     ...
     * @param actiondate
     *            holds the date in the supplied format.
    ...
    public String getFormatDate(String actiondate) {
        ...
        String[] monthDesc = new String[] { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" };
        String clientmonth = actiondate.substring(0, actiondate.indexOf('/'));
        int mnth = new Integer(clientmonth).intValue();
        String smonth = monthDesc[mnth - 1] + " ";
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: mode - a String containing the mode.
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds HashMap containing the following entries: objectList - a MapList of object information.
     * @return vector
     * @throws Exception
     *             if the operation fails.
     * @since 10.6
     */
    public Vector displayCheckBoxColumn(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
            ...
            if (reportFormat == null || reportFormat.length() == 0 || "null".equals(reportFormat)) {
                if (relBusObjPageList != null) {
                    ...
                    for (int i = 0; i < objIdArray.length; i++) {
                        partId = com.matrixone.apps.domain.util.MqlUtil.mqlCommand(context, "expand bus $1 to rel $2 type $3 select bus $4 dump $5", objIdArray[i],
                                PropertyUtil.getSchemaProperty(context, "type_EBOMMarkup"), "Part", "id", "|");
                        ...
                        if (!stateArray[i].equals("Applied") && !stateArray[i].equals("Approved")) {
                            ...
                            image = "<a href=\"#\" onClick=window.showModalDialog(\"../engineeringcentral/emxpartEBOMMarkupFS.jsp?sflag=false&mode=ViewEdit&objectId=" + partId + "&markupId="
                                    + objIdArray[i] + "\",\"dialogHeight:500px;dialogWidth:400px;status:no;\");><img src=\"../common/images/iconActionEdit.gif\"  border=\"0\" alt=\"*\"></a>";
    ...
    /**
     * List of EBOM Markups in the Approved/Applied state that are connected to the ECO by the relationship Applied Markup
     * @param context
     *            the Matrix Context
     * @param args
     *            no args needed for this method
    ...
    public MapList getApprovedAndAppliedEBOMMarkups(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            ebomMarkups = doObj.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_AppliedMarkup"),
                    PropertyUtil.getSchemaProperty(context, "type_EBOMMarkup") + "," + PropertyUtil.getSchemaProperty(context, "type_BOMMarkup"), objSelects, relSelects, false, true, level, null,
                    null);
        } catch (Exception e) {
            throw e;
        }
        ...
        if ("true".equals(editTableMode)) {
            ...
            while (objItr.hasNext()) {
                ...
                if (!current.equals(STATE_INBOX_TASK_COMPLETE)) {
                    ...
                    } else {// if task do not have action as Approve do not show anything
                        approvalStatus.add("");
                    }
                } else {// if task is in complete state show only not editable current Approval status
                    approvalStatus.add(currentStatus);
                }
            }
        } else {// if task in view mode show the attribute value
            while (objItr.hasNext()) {
                Map objMap = (Map) objItr.next();
                String objectId = (String) objMap.get((SELECT_ID));
                DomainObject obj = new DomainObject(objectId);
     ...
     * @since 10.7Sp1.
     */
    public MapList getAffectedParts(Context context, String[] args) throws Exception {
        String objectId = args[0];
        MapList revisedPartsList = new MapList();
        ...
        try {
            ...
            String whereclause = "(attribute[" + PropertyUtil.getSchemaProperty(context, "attribute_RequestedChange") + "]==\"" + "" + sCreatedtoDate + "\")";
            revisedPartsList = ecoObj.getRelatedObjects(context, RELATIONSHIP_AFFECTED_ITEM, "*", selectStmts, null, false, true, (short) 1, null, whereclause);
    ...
    public int reviseAffectedItems(Context context, String[] args) throws Exception {
        try {
            ...
            if (!"TRUE".equals(sUnApprovedList)) {
                ...
                while (mapItr.hasNext()) {
                    ...
                    affectedPart = (Part) DomainObject.newInstance(context, DomainConstants.TYPE_PART, DomainConstants.ENGINEERING);// affeted part instance
                    ...
                    if (strNewPartId == null) {
                        if (affectedPart.isLastRevision(context)) {
                            ...
                            ebomMarkupList = affectedPart.getRelatedObjects(context, DomainConstants.RELATIONSHIP_EBOM_MARKUP, "*", selectStmts, selectRelStmts, true, true, (short) 1,
                                    "current == Approved && to[" + strRelAppliedMarkup + "] == False", null);
                            ...
                            if (affectedPart.isKindOf(context, CommonDocument.TYPE_DOCUMENTS) && bSpec) {
                                ...
                                // newRevPart = new DomainObject(affectedPart.reviseObject(context, true));
    ...
    /**
     * This method promotes the connected ECR's with ECO to CompleteState to Complete state.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds the following input arguments. 0 - eco id (objectId of ECO).
     * @throws Exception
     *             if the operation fails since EngineeringCentral X3
     */
    public int promoteAttachedECR(Context context, String[] args) throws Exception {
        // args[] parameters
        ...
        try {
            ...
            StringList selectRelStmts = new StringList(1);
            selectRelStmts.addElement(SELECT_RELATIONSHIP_ID);
            String sPlanEcoState = PropertyUtil.getSchemaProperty(context, "policy", POLICY_ECR, "state_PlanECO");
            String sWhereStmt = "current=='" + sPlanEcoState + "'";
            ecrMapList = ecoObject.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ECO_CHANGEREQUESTINPUT, // relationship
            ...
            while (objItr.hasNext()) {
                ...
                relECOMapList = domobj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ECO_CHANGEREQUESTINPUT, // relationship
                ...
                if (relECOMapList.size() > 1) {
                    ...
                    while (objIterator.hasNext()) {
                        ...
                        if (STATE_ECO_CREATE.equalsIgnoreCase(sEcoState) || STATE_ECO_DEFINE_COMPONENTS.equalsIgnoreCase(sEcoState) || STATE_ECO_DESIGN_WORK.equalsIgnoreCase(sEcoState)
                                || STATE_ECO_REVIEW.equalsIgnoreCase(sEcoState)) {
                            isRelased = false;
                            break;
                        }
                    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a MapList with the following as input arguments or entries: objectId holds the context ECR object Id New Value holds the newly selected Related ECR Object Id
     * @throws Exception
    ...
    public void connectRelatedECR(Context context, String[] args) throws Exception {
        ...
        if ("CreateECO".equals(str)) {
            ...
            if (strMode != null && strMode.equalsIgnoreCase("AssignToECO")) {
                ...
                // Creating DomainObject of Context
                ...
                try {
                    ...
                    // DomainRelationship.connect(context,domObjectChangeNew,RELATIONSHIP_ECO_CHANGE_REQUEST_INPUT,domainChangeContext);
                } catch (Exception ex) {
                }
            }
            if (strMode != null && strMode.equalsIgnoreCase("MoveToECO")) {
                ...
                MapList mapList = domainChangeContext.getRelatedObjects(context, sRelationship, sTypeECR, busSelects, relSelectsList, false, true, (short) 1, null, null);
    ...
    private void connectECRFromNewValue(Context context, HashMap paramMap) throws FrameworkException {
        ...
        if (strNewRelatedObjId != null && !"".equals(strNewRelatedObjId)) {
            try {
                ...
                DomainRelationship.connect(context, new DomainObject(strECObjectId), DomainConstants.RELATIONSHIP_ECO_CHANGEREQUESTINPUT, true,
                        (String[]) FrameworkUtil.split(strNewRelatedObjId, "|").toArray(new String[0]), true);
     ...
     * 
     * @programMap args This string array contains following arguments: 0 - The programMap
     * 
     * @throws Exception
     * 
    ...
    public Vector getAffectedItemsRelatedECRs(Context context, String[] args) throws Exception {
        ...
        objectSelects4
                .addElement("to[" + RELATIONSHIP_AFFECTED_ITEM + "|from.type==" + TYPE_ECR + "].from.to[" + RELATIONSHIP_ECO_CHANGE_REQUEST_INPUT + "|from.id == " + strParentObjectId + "].to.name");
        objectSelects4
                .addElement("to[" + RELATIONSHIP_AFFECTED_ITEM + "|from.type==" + TYPE_ECR + "].from.to[" + RELATIONSHIP_ECO_CHANGE_REQUEST_INPUT + "|from.id == " + strParentObjectId + "].to.id");
        ...
        while (objItr1.hasNext()) {
            ...
            if ((id != null && !("").equals(id) && !("null").equals(id)) && (name != null && !("").equals(name) && !("null").equals(name))) {
                ...
                for (int i = 0; i < strChgId.length; i++) {
                    if (strChgId == null) {
                        ...
                        strFullName = "<A HREF=\"JavaScript:emxTableColumnLinkClick('emxTree.jsp?mode=insert&amp;emxSuiteDirectory=" + XSSUtil.encodeForURL(context, strSuiteDir) + "&amp;parentOID="
                                + XSSUtil.encodeForURL(context, strParentObjectId) + "&amp;jsTreeID=" + XSSUtil.encodeForURL(context, strJsTreeID) + "&amp;objectId="
                                + XSSUtil.encodeForURL(context, strChgId[i]) + "', 'null', 'null', 'false', 'content')\" class=\"object\">" + XSSUtil.encodeForHTML(context, strChgName[i]) + "</A>";
                        strDest += strFullName;
                    }
                }
            }
    ...
    public String generateHtmlSummaryReport(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            if (boolObj.booleanValue()) { // EBOM Comparision - emxEngineeringCentral.ECOSummary.EBOMComparison
                summaryReport.append("<table width=\"100%\" ><tr><td class=\"subhead\"><h2>"
                        + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.CompareBOM.EBOMComparisonReport", strLanguage) + "</h2></td></tr></table>");
    ...
    public String getECOBasicInfo(Context context, String args[]) throws Exception {
        ...
        while (ecoAttrListItr.hasNext()) {
            ...
            if (!(attrName.equals(ATTRIBUTE_ORIGINATOR) || (ECO.ATTRIBUTE_RELEASE_DISTRIBUTION_GROUP).equals(attrName) || (ECO.ATTRIBUTE_PRIORITY).equals(attrName)
                    || attrName.equals(PropertyUtil.getSchemaProperty(context, "attribute_BypassPlants"))) && !attrName.equals(ECO.ATTRIBUTE_REASON_FOR_CANCEL)
                    || (attrName.equals(ECO.ATTRIBUTE_REASON_FOR_CANCEL) && sCurrentState.equals(STATE_ECO_CANCELLED))
            // && sCurrentState.equals(STATE_ECOSTANDARD_CANCELLED))
            ) {
                returnString.append("<tr>");
                returnString.append("<td class=\"label\">" + i18nNow.getAttributeI18NString(attrName, strLanguage) + ":</td>");
        ...
        mapRouteTemplate = getRelatedObjects(context, DomainConstants.RELATIONSHIP_OBJECT_ROUTE, DomainConstants.TYPE_ROUTE_TEMPLATE, selectStmts, null, false, true, (short) 1, null, null);
        ...
        returnString.append("<tr><td class=\"label\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.DesignResponsibility", strLanguage) + ":</td><td class=\"inputField\">"
                + sDesignResponsibility + "</td></tr>");
        // for bug 344498 starts
        returnString.append("<tr><td class=\"label\">" + EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.Common.Policy", strLanguage) + "</strong>:&nbsp;</td><td class=\"inputField\">"
                + sPolicy + "</td></tr>");
        // Multitenant

        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.Form.Label.ReviewerList")
                + "</strong>:&nbsp;</td><td class=\"inputField\">" + strReviewalRoute + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.Form.Label.ApprovalList")
                + "</strong>:&nbsp;</td><td class=\"inputField\">" + strApprovalRoute + "</td></tr>");

        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEngineeringCentralStringResource", context.getLocale(), "emxFramework.Label.DistributionList")
                + "</strong>:&nbsp;</td><td class=\"inputField\">" + strDistributionList + "</td></tr>");
        // for bug 344498 ends
        returnString.append("</table></td>");
        returnString.append("</tr>");
        returnString.append("</table>");
                ...
                for (int rteCnt = 0; rteCnt < routes.size(); rteCnt++) {
                    ...
                    if (!strListRouteCheck.contains(sRouteId)) {
                        ...
                        if ((rteCnt == 0)) {
                            ...
                            returnString.append("<td valign=\"top\" class=\"listCell\" style=\"text-align: \" >"
                                    + EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), "emxFramework.State.ECO." + sStateName) + "&nbsp;</td>");
                        } else {
                            returnString.append("<td>&nbsp;</td>");
                        }
    ...
    public String getECORoutes(Context context, String[] args) throws Exception, MatrixException {
        try {
            String strLanguage = context.getSession().getLanguage();
            String objectId = args[0];
            Route routeObj = (Route) DomainObject.newInstance(context, TYPE_ROUTE);
     ...
     */
    public String getECOTasks(Context context, String[] args) throws Exception, MatrixException {
        try {
            String strLanguage = context.getSession().getLanguage();
            String objectId = args[0];
            Route routeObj = (Route) DomainObject.newInstance(context, TYPE_ROUTE);
    ...
    public String getECOAffectedItemsSummaryDetails(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        ...
        try {
            ...
            mpAffectedPartList = getRelatedObjects(context, strRelationType, // relationship pattern
            ...
            while (objItr.hasNext()) {
                ...
                if (isAttrEDVisible) {
                    ...
                    if (sReqChangeVal != null && !"null".equals(sReqChangeVal) && !"".equals(sReqChangeVal)) {
                        newParts.append("<td>" + EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), "emxFramework.Range.Requested_Change." + sReqChangeVal)
                                + "</td>");
                    } else {
                        newParts.append("<td>&nbsp;</td>");
                    }
     ...
     *            holds the following input arguments: 0 - String containing object id.
     * @param isNewSpec
     *            boolean determines new or revised specs. true-new Specs false-revised specs.
     * @return String Html table format representation of connected specifications.
     * @throws Exception
     *             if the operation fails.
     * @since Enginnering Central X3
     */
    public String getECOSpecifications(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        ...
        try {
            ...
            String objPatrn = TYPE_CAD_MODEL + "," + TYPE_CAD_DRAWING + "," + TYPE_DRAWINGPRINT + "," + PropertyUtil.getSchemaProperty(context, "type_PartSpecification");
            ...
            specList = ecoObj.getRelatedObjects(context, strRelationType, // relationship pattern
     ...
     * @since EngineeringCentral X3
     */
    public String getAssigneesOfECO(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        ...
        try {
            ...
            mpListAssignees = ecoObj.getRelatedObjects(context, RELATIONSHIP_ASSIGNED_EC, TYPE_PERSON, selectStmts, selectRelStmts, true, false, (short) 1, EMPTY_STRING, EMPTY_STRING);
     ...
     * @since Engineering Central X3
     */
    public String getECOsRelatedECRs(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        MapList ecrMapList = new MapList();
        StringBuffer relatedECRs = new StringBuffer(1024);
        try {
            ...
            StringList selectRelStmts = new StringList(1);
            selectRelStmts.addElement(SELECT_RELATIONSHIP_ID);
            ecrMapList = ecoObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ECO_CHANGEREQUESTINPUT, // relationship pattern
                    "*", // object pattern
                    selectStmts, // object selects
                    selectRelStmts, // relationship selects
                    false, // to direction
    ...
    public String getECORelatedBOMMarups(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        ...
        try {
            ...
            StringList selectRelStmts = new StringList(1);
            selectRelStmts.addElement(SELECT_RELATIONSHIP_ID);
            mpListMarkups = ecoObj.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_AppliedMarkup"), // relationship pattern
    ...
    public String getECORelatedReferenceDocuments(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        ...
        try {
            ...
            StringList selectRelStmts = new StringList(1);
            selectRelStmts.addElement(SELECT_RELATIONSHIP_ID);
            mpListReferenceDocs = ecoObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_REFERENCE_DOCUMENT,
    ...
    public int renderPDFFileForECO(Context context, String[] args, String summaryReport) throws Exception {
    ...
    public String getDistributionList(Context context, String[] args) throws Exception {
        ...
        strBuf.append("emxShowModalDialog(\"../common/emxFullSearch.jsp?field=TYPES=type_MemberList:CURRENT=policy_MemberList.state_Active" + EngineeringUtil.getAltOwnerFilterString(context)
    ...
    public String getApprovalList(Context context, String[] args) throws Exception {
        ...
        String strModCreate = (String) requestMap.get("CreateMode");
        StringBuffer strBuf = new StringBuffer();
        if ((strModCreate != null && strModCreate.equalsIgnoreCase("AssignToECO")) || (strModCreate != null && strModCreate.equalsIgnoreCase("MoveToECO"))
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a MapList with the following as input arguments or entries: objectId holds the context ECO object Id
     * @throws Exception
     *             if the operations fails
     * @since EC - X3
     */
            ...
            if (relChange != null) {
                ...
                if (domObj.isKindOf(context, DomainConstants.TYPE_ECR) || domObj.isKindOf(context, DomainConstants.TYPE_ECO) || domObj.isKindOf(context, DomainConstants.TYPE_PART)) {
                    ...
                    if ((strModCreate != null && strModCreate.equalsIgnoreCase("AssignToECO")) || (strModCreate != null && strModCreate.equalsIgnoreCase("MoveToECO"))
                        ...
                        relationshipIdList = domObj.getRelatedObjects(context, strRelationshipReportedAgainstChange, DomainConstants.QUERY_WILDCARD, objectSelects, relSelectsList, false, true,
                    ...
                    if (relationshipIdList.size() > 0) {
                        ...
                        sbReturnString.append(
                                "emxShowModalDialog(\"../components/emxCommonSearch.jsp?formName=emxCreateForm&amp;frameName=formCreateDisplay&amp;searchmode=chooser&amp;suiteKey=Components&amp;searchmenu=APPECSearchAddExistingChooser&amp;searchcommand=APPSearchECReportedAgainstItemsCommand&amp;fieldNameActual=ReportedAgainstOID&amp;fieldNameDisplay=ReportedAgainstDisplay&amp;fieldNameOID=ReportedAgainstOID&amp;suiteKey=Components&amp;objectId=\" + changeResId + \"&amp;ecrEcoUi=true\" ,700,500); ");
                        sbReturnString.append('}');
                        sbReturnString.append(" } ");
            ...
            if (relChange != null) {
                ...
                if (domObj.isKindOf(context, DomainConstants.TYPE_ECR) || domObj.isKindOf(context, DomainConstants.TYPE_ECO) || domObj.isKindOf(context, DomainConstants.TYPE_PART)) {
                    ...
                    if ((strModCreate != null && strModCreate.equalsIgnoreCase("AssignToECO")) || (strModCreate != null && strModCreate.equalsIgnoreCase("MoveToECO"))
                            || (strModCreate != null && strModCreate.equalsIgnoreCase("AddToECO"))) {
                        // Calling getRelatedObjects to get the relationship ids
                        relationshipIdList = domObj.getRelatedObjects(context, strRelationship, DomainConstants.QUERY_WILDCARD, objectSelects, relSelectsList, false, true, (short) 1,
        ...
        try {
            ...
            if (strChangeId != null || !"".equals(strChangeId)) {
                ...
                if (strType.equals(DomainConstants.TYPE_ECR)) {
                    ...
                    sbReturnString.append("</input>");
                    sbReturnString.append(
                            "<input type=\"button\" disabled=\"true\" name=\"btnRelatedECR\" value=\"...\"	 onclick=\"javascript:showChooser('../components/emxCommonSearch.jsp?formName=emxCreateForm&amp;frameName=formCreateDisplay&amp;suiteKey=Components&amp;searchmode=chooser&amp;searchmenu=APPECSearchAddExistingChooser&amp;searchcommand=APPSearchECReportedAgainstItemsCommand&amp;fieldNameActual=RelatedECR&amp;fieldNameDisplay=RelatedECRDisplay");
                    sbReturnString.append(sDisplayValue);
                ...
                if (strType.equals(DomainConstants.TYPE_ECO)) {
                    ...
                    MapList mapList = domObj1.getRelatedObjects(context, sRelationship, sTypeECO, busSelects, relSelectsList, false, true, (short) 1, null, null);
                    if (mapList.size() > 0) {
                        Iterator itr = mapList.iterator();
                        while (itr.hasNext()) {
                            Map newMap = (Map) itr.next();
                        ...
                        sbReturnString.append("&amp;fieldNameOID=RelatedECROID&amp;relId=null&amp;suiteKey=Components','700','500')\">");
                        sbReturnString.append("</input>");
                        // sbReturnString.append("<a href=\"JavaScript:basicClear('DoNotClear')\" disabled=\"true\">Clear</a>");
                        sbReturnString.append("<a href=\"JavaScript:basicClear('DoNotClear')\" disabled=\"true\">");
                        sbReturnString.append(strClear);
                        sbReturnString.append("</a>");
    ...
    /**
     * Added for the Fix 370336 Display the Related ECR field in ECO WebForm.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a MapList with the following as input arguments or entries: objectId holds the context ECO object Id Returns the String Containing all related ECR's
     * @throws Exception
     *             if the operations fails
     * @since EC - X6
     */
            ...
            if (strChangeobjectId != null && strChangeobjectId.length() > 0) {
                ...
                if (domChangeObj.isKindOf(context, DomainConstants.TYPE_ECR) || domChangeObj.isKindOf(context, DomainConstants.TYPE_ECO)) {
                    ...
                    if (strNewValue != null && !"null".equals(strNewValue) && strNewValue.length() > 0) {
                        ...
                        MapList mapListPersons = domChangeObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_ASSIGNED_EC, DomainConstants.TYPE_PERSON,
                                new StringList(DomainConstants.SELECT_ID), null, true, false, (short) 1, strObjWhere, null);

                        if (mapListPersons != null && mapListPersons.size() == 0) {
                            DomainRelationship.connect(context, new DomainObject(PersonUtil.getPersonObjectID(context, strNewValue)), DomainConstants.RELATIONSHIP_ASSIGNED_EC, domChangeObj);
                        }
                    }
                }
            }
    ...
    public Object displayDesignResponsibilityItem(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            // Relationship name
            String strRelationshipDesignResponsibility = PropertyUtil.getSchemaProperty(context, "relationship_DesignResponsibility");
            if ("CreateECO".equals(strModCreate)) {
                ...
                if (strPartDrawingId != null) {
                    ...
                    MapList mapListRDOs = doPart.getRelatedObjects(context, strRelationshipDesignResponsibility, strType, strlObjSelects, strlRelSelects, true, false, (short) 1, null, null);
                ...
                if (domObj.isKindOf(context, DomainConstants.TYPE_ECR) || domObj.isKindOf(context, DomainConstants.TYPE_ECO) || domObj.isKindOf(context, DomainConstants.TYPE_PART)) {
                    ...
                    if (strModCreate != null && strModCreate.equalsIgnoreCase("AssignToECO") || (strModCreate != null && strModCreate.equalsIgnoreCase("MoveToECO"))
                        ...
                        if (null != strMemberIds) {
                            ...
                            if (stz.hasMoreElements()) {
                                ...
                                relationshipIdList = domAffected.getRelatedObjects(context, strRelationshipDesignResponsibility, sType, busSelects, relSelectsList1, true, false, (short) 1, null,
                                        null);
                    ...
                    if (relationshipIdList.size() > 0) {
                        ...
                        sbReturnString.append("</input>");
                        sbReturnString.append(
                                "<input type=\"button\" name=\"btnCompany\" disabled =\"true\" value=\"...\" onclick=\"javascript:showChooser('../common/emxFullSearch.jsp?field=TYPES=type_Organization,type_ProjectSpace:CURRENT=policy_Organization.state_Active&amp;table=ENCAddExistingGeneralSearchResults&amp;selection=single&amp;submitAction=refreshCaller&amp;hideHeader=true&amp;formName=emxCreateForm&amp;fieldNameActual=DesignResponsibilityOID&amp;fieldNameDisplay=DesignResponsibilityDisplay&amp;submitURL=../engineeringcentral/SearchUtil.jsp&amp;mode=Chooser&amp;chooserType=FormChooser&amp;HelpMarker=emxhelpfullsearch");
                        sbReturnString.append("&amp;fieldNameOID=DesignResponsibilityOID&amp;relId=null&amp;suiteKey=EngineeringCentral','850','630')\">");
                        sbReturnString.append("</input>");
                        sbReturnString.append("<a href=\"JavaScript:basicClear('DoNotClear')\" disabled=\"true\">");
                        sbReturnString.append(strClear);
                        ...
                        sbReturnString.append("&amp;fieldNameOID=DesignResponsibilityOID&amp;relId=null&amp;suiteKey=EngineeringCentral','850','630')\">");
                        sbReturnString.append("</input>");
                        if (strModCreate != null && (strModCreate.equalsIgnoreCase("AssignToECO") || strModCreate.equalsIgnoreCase("AddToECO"))) {
                            sbReturnString.append("<a href=\"JavaScript:clearRDO()\">");
                        } else {
     ...
     * @param context
     *            the <code>matrix.db.Context</code> for user logged in
     * @param children
     *            a String with id for an object
     * @param selected
     *            name of the Ad Hoc Route
     * @param parent
     *            locale used
     * @throws Exception
     */
    ...
    public int ecoChangeProcessAction(matrix.db.Context context, String[] args) throws Exception {
        ...
        String SELECT_ATTRIBUTE_REQUESTED_CHANGE = "attribute[" + PropertyUtil.getSchemaProperty(context, "attribute_RequestedChange") + "]";
        ...
        try {
            ...
            MapList mapListAffectedItems = getRelatedObjects(context, strRelPattern, "*", strlObjectSelects, strlRelSelects, false, true, (short) 1, strWhereClause, null);
            // Start:to sort Affected Item List
                        ...
                        if (bolPartSignature) {
                            ...
                            if (strlParentIdList == null || strlParentStateList == null) {
                                ...
                                for (int i = 0; i < strlParentIdList.size() && bolDoPromote; i++) {
                                    ...
                                    MapList mapListECOs = doparent.getRelatedObjects(context, strRelPattern, DomainConstants.TYPE_ECO, strlECOObjectSelects, strlECORelSelects, true, false, (short) 1,
                                            null, strWhere);
            ...
            if (strUnPromotedList != null) {
                emxContextUtil_mxJPO.mqlNotice(context,
                        EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECO.AutoPromoteChangedItemToReleaseStateWarning", context.getSession().getLanguage()) + strUnPromotedList);
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds fieldMap to get policy name.
    ...
    public static Boolean emxCheckCreateDynamicApprovalECO(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains objectid of the ECO in context objectId holds the context ECO object Id
     * @throws Exception
     *             if the operations fails
     * @since EC - X3
     */
    public int ApplyApprovedMarkups(Context context, String[] args) throws Exception {
        ...
        MapList mpApprovedMarkups = doECO.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_AppliedMarkup"), PropertyUtil.getSchemaProperty(context, "type_BOMMarkup"),
                objectSelects, null, false, true, (short) 1, "current == Approved", null);
        ...
        for (int k = 0; k < iSize; k++) {
            ...
            ExpansionIterator _objectSelect = partObj.getExpansionIterator(context, relPattern, typePattern, selectStmts, selectRelStmts, false, true, (short) 1, null, null, (short) 0, false, false,
                    (short) 0, false);

            StringItr strItr = new StringItr(selectStmts);
            StringItr strRelItr = new StringItr(selectRelStmts);
            Part domObj = (Part) DomainObject.newInstance(context, DomainConstants.TYPE_PART, DomainConstants.ENGINEERING);
            ...
            while (checkItr.hasNext()) {
                ...
                try {
                    ...
                    // String sCurrentTypeCheck=bomObjectCheck.getTypeName();
                ...
                if (obsoletePart) {
                    ...
                    if (!fnExists && isMarkupUnique) {
                        ...
                        while (itr.hasNext()) {
                            ...
                            /*
                             * Need to know if it is a replace action for EBOM Substitute. If the action is Replace. then save the EBOM Relationship Id so that an "Add" can be performed.
                             */
                            String rev = "";
                                        ...
                                        while (attrItr.hasNext()) {
                                            ...
                                            if (!HiddenAttribList.contains(sAttrName)) {
                                                ...
                                                if (sAttrName.equals(sFindNoAttr)) {
                                                    ...
                                                    matrix.db.Attribute tempAttributeElement1 = new matrix.db.Attribute(new matrix.db.AttributeType(sAttrName),
                                                            attrElement.getChildText(sAttrChildStrPtr));
                                                    ...
                                                    matrix.db.Attribute tempAttributeElement3 = new matrix.db.Attribute(new matrix.db.AttributeType(sAttrName),
                                                            attrElement.getChildText(sAttrChildStrPtr));
                                                    ...
                                                    matrix.db.Attribute tempAttributeElement4 = new matrix.db.Attribute(new matrix.db.AttributeType(sAttrName),
                                                            attrElement.getChildText(sAttrChildStrPtr));
                                                    ...
                                                    matrix.db.Attribute tempAttributeElement5 = new matrix.db.Attribute(new matrix.db.AttributeType(sAttrName),
                                                            attrElement.getChildText(sAttrChildStrPtr));
                                    ...
                                    if (!(revBomObject.getRevision().equals(""))) {
                                        ...
                                        if (currentState.equals(DomainObject.STATE_PART_RELEASE)) {
                                            MqlUtil.mqlCommand(context, "notice $1",
                                                    " " + objTypeElement.getText() + " " + objNameElement.getText() + " " + objRevElement.getText() + " " + strMessageCheck);
                                            continue;
                                        }
                                    }
     ...
     * @param context The ematrix context of the request.
     * 
     * @param args This string array contains following arguments: 0 - The programMap
     * 
    ...
    public String displayUserSettingsDefaultVault(Context context, String[] args) throws Exception {
        ...
        sbReturnString.append("emxShowModalDialog(\"../components/emxComponentsSelectSearchVaultsDialogFS.jsp?multiSelect=false&amp;fieldName=Vault&amp;objectType=" + sECO
                + "&amp;suiteKey=Components&amp;\",300,350); ");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap hold a HashMap containing the following keys, "objectId"
    ...
    public void createAssignee(Context context, String[] args) throws Exception, FrameworkException {
        ...
        try {
            ...
            if (policy.equals(POLICY_ECO) || policy.equals(POLICY_ECR)) {
                ...
                DomainRelationship.connect(context, new DomainObject(PersonUtil.getPersonObjectID(context, sUser)), DomainConstants.RELATIONSHIP_ASSIGNED_EC, changeObj);
            }
        } catch (Exception ex) {
            throw ex;
        }
            ...
            if (RANGE_FOR_REVISE.equals(strRequestedChange)) {
                ...
                if (strIndirectData != null) {
                    ...
                    strDest = new StringBuffer(100).append("<A HREF=\"JavaScript:emxTableColumnLinkClick('emxTree.jsp?mode=insert&amp;emxSuiteDirectory=")
                            ...
                            .append("', 'null', 'null', 'false', 'content')\" class=\"object\">").append(XSSUtil.encodeForHTML(context, strPartRev)).append("</A>").toString();
                }
            }
    ...
    /**
     * This method returns all the Affected Item objects connected to ECO as Indirect and Requested Change as 'For Release' Data format of the retured map will be if addRevInValue = true then, Key =
     * type|name, value = objectId|rev if addRevInValue = false then, Key = type|name, value = objectId
     * @param context
     *            ematrix context
     * @param changeId
     *            ECOID
     * @param addRevInValue
     *            boolean value, If it is true then revision also will be added to value of map else only objectId will be value of map.
     * @return HashMap
     * @throws Exception
     *             if operation fails.
     */
    public HashMap getIndirectAffectedItemsInMap(Context context, String changeId, boolean addRevInValue) throws Exception {
        ...
        String key;
        String value;
        String strRelWhereclause = "attribute[" + PropertyUtil.getSchemaProperty(context, "attribute_AffectedItemCategory") + "] == 'Indirect' && attribute[" + ATTRIBUTE_REQUESTED_CHANGE + "] == '"
                + RANGE_FOR_RELEASE + "'";

        MapList mapListParts = doECO.getRelatedObjects(context, RELATIONSHIP_AFFECTED_ITEM, DomainConstants.QUERY_WILDCARD, objectSelect, null, false, true, (short) 1, null, strRelWhereclause, null,
                null, null);
    ...
    /**
     * this method checks the Related object state Returns Boolean determines whether the connected objects are in approperiate state.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds objectId.
     ...
     * @return Boolean determines whether the connected objects are in approperiate state.
     * @throws Exception
     *             if the operation fails.
     * @since Engineering Central X3.
     */
    public int checkRelatedObjectState(Context context, String args[]) throws Exception {
        ...
        try {
            ContextUtil.pushContext(context);
            maplistObjects = getRelatedObjects(context, strRelationshipName, strTypeName, busSelects, // object Select
                    relSelects, // rel Select
                    boolFrom, // to
                    boolTo, // from
                    (short) 1, null, // ob where
     ...
     * @since Engineering Central X3
     */
    public String getECORelatedResolvedItems(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        ...
        try {
            ...
            mpListResolvedItems = getRelatedObjects(context, strRelResolvedTo, "*", selectStmts, null, true, false, (short) 1, "", "");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the following keys, "relId","DispositionFieldReturn"
     * @return int
     * @throws Exception
     *             if operation fails
     * @since Common X3
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the following keys, "relId","DispositionInField"
     * @return int
     * @throws Exception
     *             if operation fails
     * @since Common X3
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the following keys, "relId","DispositionInProcess"
     * @return int
     * @throws Exception
     *             if operation fails
     * @since Common X3
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the following keys, "relId","DispositionInStock"
     * @return int
     * @throws Exception
     *             if operation fails
     * @since Common X3
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the following keys, "relId","DispositionOnOrder"
     * @return int
     * @throws Exception
     *             if operation fails
     * @since Common X3
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds a HashMap containing the following entries: paramMap - a HashMap containing the following Strings, "objectId". requestMap - a HashMap containing the request.
    ...
    public Object getCategoryofChange(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        ...
        for (int i = 0; i < slCategoryOfChangeRangeValues.size(); i++) {
            ...
            sbCategoryOfChange.append("<option value=\"" + strCategoryOfChangeOption + "\" " + ((strCategoryOfChangeOption.equals(sCurrentCategoryOfChangeName)) ? sPolicySelected : "") + ">"
                    + i18nNow.getRangeI18NString(ATTRIBUTE_CATEGORY_OF_CHANGE, strCategoryOfChangeOption, languageStr) + "</option>");
        }
    ...
    public StringList getRelatedECRsAlreadyConnected(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList ecrMapList = FrameworkUtil.toMapList(ecoObj.getExpansionIterator(context, DomainConstants.RELATIONSHIP_ECO_CHANGEREQUESTINPUT, "*", selectBusStmts, selectRelStmts, false, true,
                    (short) 1, null, null, (short) 0, false, false, (short) 0, false), (short) 0, null, null, null, null);
     ...
     * @param context
     *            The Matrix Context.
     * @param strTargetECOId
     *            The selected ECO id
     * @param strArrAffectedItems
     *            The selected affected item ids
     * @throws FrameworkException
     *             If the operation fails.
     * @since EngineeringCentral X+3
     */
    public void moveAffectedItems(Context context, String[] args) throws Exception {
        ...
        emxChange_mxJPO Emxchange = new emxChange_mxJPO(context, args);
            ...
            try {
                ...
                if (strlTargetAffectedItems.contains(strSourceAffectedItemId)) {
                    if (strAlreadyConnected.length() > 0) {
                        strAlreadyConnected = strAlreadyConnected + ", " + (String) mapPartDetails.get(SELECT_TYPE) + " " + (String) mapPartDetails.get(SELECT_NAME) + " "
                                + (String) mapPartDetails.get(SELECT_REVISION);
                    } else {
                    ...
                    if (strPartRDO != null && !"".equals(strPartRDO)) {
                        if (!strTargetECORDO.equalsIgnoreCase(strPartRDO)) {
                            if (strRDOMismatchMsg.length() > 0) {
                                strRDOMismatchMsg = strRDOMismatchMsg + ", " + (String) mapPartDetails.get(SELECT_TYPE) + " " + (String) mapPartDetails.get(SELECT_NAME) + " "
                                        + (String) mapPartDetails.get(SELECT_REVISION);
                            } else {
        ...
        if (blnShowRDOMsg) {
            ...
            emxContextUtil_mxJPO.mqlWarning(context,
                    EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECO.AffectedItemsRDOMismatchWarning", context.getSession().getLanguage()) + strRDOMismatchMsg);
        }

        if (blnShowReviseMsg) {
            // display warning to the user on the non-revisable affected items
            emxContextUtil_mxJPO.mqlWarning(context,
                    EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECR.AutoRevECRAffectedItemsWarning", context.getSession().getLanguage()) + strRevisionFailMsg);
        }

        if (blnShowConnectFailMsg) {
            // display warning to the user on the non-revisable affected items
            emxContextUtil_mxJPO.mqlWarning(context,
                    EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECO.ConnectAffectedItemsWarning", context.getSession().getLanguage()) + strConnectFailMsg);
        }

        if (blnAlreadyConnected) {
            // display warning to the user on the non-revisable affected items
            emxContextUtil_mxJPO.mqlWarning(context,
                    EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECO.AlreadyConnectedAffectedItemsWarning", context.getSession().getLanguage()) + strAlreadyConnected);
        }
     ...
     * @since EngineeringCentral X+3
     */
    public String getLatestReleased(Context context, String strAffectedItemId) throws Exception {
        ...
        MapList mapListParts = DomainObject.findObjects(context, (String) mapDetails.get(SELECT_TYPE), (String) mapDetails.get(SELECT_NAME), "*", null, (String) mapDetails.get(SELECT_VAULT),
                strWhereClause, false, strlSelects);
     ...
     * @since EngineeringCentral X+3
     */
    public String getLatestUnreleased(Context context, String strAffectedItemId) throws Exception {
        DomainObject doAffectedItem = new DomainObject(strAffectedItemId);
     ...
     * @param context
     *            The Matrix Context.
     * @param strSourceRelType
     *            name of first relationship
     * @param strTargetRelType
     *            name of second relationship
     * @returns latest unreleased id or null
     * @throws Exception
     *             If the operation fails.
     * @since EngineeringCentral X+3
     */
    public StringList getCommonAttributes(Context context, String strSourceRelType, String strTargetRelType) throws Exception {
     ...
     * @since EngineeringCentral X+3
     */
    public void moveMarkups(Context context, String strPartId, String strSourceECO, String strTargetECO) throws Exception {
        StringList strlObjSelects = new StringList(1);
        strlObjSelects.add(SELECT_ID);
        ...
        MapList mapListMarkups = doSourceECO.getRelatedObjects(context, RELATIONSHIP_APPLIED_MARKUP, TYPE_PART_MARKUP + "," + TYPE_EBOM_MARKUP, strlObjSelects, strlRelnSelects, false, true, (short) 1,
                "to[" + RELATIONSHIP_EBOM_MARKUP + "].from.id == \"" + strPartId + "\"", null);
     ...
     * @since EngineeringCentral X+3
     */
    public void connectAffectedItems(Context context, String[] args) throws Exception {
        HashMap hmpProgramMap = (HashMap) JPO.unpackArgs(args);
        ...
        for (int i = 0; i < intNumAffectedItems; i++) {
            ...
            if (UIUtil.isNotNullAndNotEmpty(strPlanningRequired)) {
                if ("Yes".equals(strPlanningRequired)) {
                    ...
                    slExcludeECOChangeNames = EngineeringUtil.getECOChangeList(doSourceAffectedItem.getInfo(context, EngineeringConstants.SELECT_TO_LEFTBRACE
                            + EngineeringConstants.RELATIONSHIP_MANUFACTURING_RESPONSIBILITY + EngineeringConstants.SELECT_RIGHTBRACE + EngineeringConstants.DOT + "attribute[Doc-In]"));
            ...
            String objRelease = PropertyUtil.getSchemaProperty(context, "policy", objPolicy, "state_Release");
        ...
        if (isSameECO) {
            // display warning to the user on RDO mismatch of affected items
            emxContextUtil_mxJPO.mqlWarning(context, EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.ECO.SameECO", context.getSession().getLanguage()));
        }
    ...
    public String getRelatedECRList(Context context, String[] args) throws Exception {
        ...
        sbReturnString.append(
                "<input type=\"button\" name=\"btnRelatedECR\" value=\"...\"   onclick=\"javascript:showChooser('../engineeringcentral/emxengchgECOSearchECRDialogFS.jsp?form=emxCreateForm&amp;field=RelatedECR&amp;fieldDisp=RelatedECRDisplay&amp;searchcommand=showRelatedECOSearchDialog&amp;createECOMode=true");
        sbReturnString.append("");
    ...
    /**
     * This program checks if the Affected items are in Approve state and returns 0 or 1. Note it only considers policies for those objects which are defined below
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args1
     *            holds objectId.
    ...
    public int checkAffectedItemsState(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            MapList maplistObjects = getRelatedObjects(context, strRelationshipName, "*", busSelects, // object Select
                    relSelects, // rel Select
                    boolFrom, // to
                    boolTo, // from
                    (short) 1, null, // ob where
            ...
            if (maplistObjects != null && (maplistObjects.size() > 0)) {
                ...
                while (itr.hasNext()) {
                    ...
                    if (!"state_Release".equals(strSymbolicState) && hStatePolicy.containsKey(strSymbolicPolicy) && !(hStatePolicy.get(strSymbolicPolicy).equals(strSymbolicState))) {
                        ...
                        strMsg.append("\t \'").append(EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), "emxFramework.Type." + tempType)).append("\' \'")
                                .append(mapObject.get(DomainConstants.SELECT_NAME)).append("\' \'").append(mapObject.get(DomainConstants.SELECT_REVISION)).append("\' \'")
    ...
    public int checkAffectedItemsStateForCA(Context context, String args[]) throws Exception {
        ...
        String strRelationshipNameArr = args[1].trim();
        String strPolicyName = args[2];
        String strStates = args[3];
        boolean boolTo = args[4].equalsIgnoreCase("TO") ? true : false;
        boolean boolFrom = args[4].equalsIgnoreCase("FROM") ? true : false;
        ...
        try {
            ...
            StringTokenizer stkPolicy = new StringTokenizer(strPolicyName, ",");
            StringTokenizer stkState = new StringTokenizer(strStates, ",");
            StringTokenizer stkRelNames = new StringTokenizer(strRelationshipNameArr, ",");
            /* Extracting Policy and States */
            while (stkPolicy.hasMoreElements()) {
                String sPolicy = stkPolicy.nextToken().trim();
                String sState = stkState.nextToken().trim();
                hStatePolicy.put(sPolicy, sState);
            }

            StringList strRelationshipNameList = new StringList();

            while (stkRelNames.hasMoreElements()) {

                strRelationshipNameList.add(PropertyUtil.getSchemaProperty(context, stkRelNames.nextToken().trim()));
            }
            String strRelnWhereClause = null;

            if (ChangeConstants.RELATIONSHIP_CHANGE_AFFECTED_ITEM.equals(strRelationshipNameList.get(0)) || ChangeConstants.RELATIONSHIP_IMPLEMENTED_ITEM.equals(strRelationshipNameList.get(1))) {
                strRelnWhereClause = "attribute[" + attrReqChange + "] == \"" + attrReqChangeValue + "\"";
            }
            ...
            String strRelationshipName = strRelationshipNameList.get(0) + "," + strRelationshipNameList.get(1);
            MapList maplistObjects = getRelatedObjects(context, strRelationshipName, "*", busSelects, // object Select
                    relSelects, // rel Select
                    boolFrom, // to
                    boolTo, // from
    ...
    public String buildReviewApproveFields(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (routeList.size() > 0) {
                ...
                relationshipIdList = getRelatedObjects(context, strRelationship, strType, objectSelects, relSelectsList, false, true, (short) 1, objWhere, DomainConstants.EMPTY_STRING);
            }
            ...
            if (DomainConstants.TYPE_ECO.equals(strChangeType) || TYPE_MECO.equals(strChangeType)) {
                if (!"true".equalsIgnoreCase(strPDFrender)) {
                    ...
                    outPut.append(
                            "javascript:showModalDialog(\"../common/emxFullSearch.jsp?field=TYPES=type_RouteTemplate:ROUTE_BASE_PURPOSE=Approval:CURRENT=policy_RouteTemplate.state_Active:LATESTREVISION=TRUE"
                                    + altOwnerFilter
                    ...
                    outPut.append(
                            "javascript:showModalDialog(\"../common/emxFullSearch.jsp?field=TYPES=type_RouteTemplate:ROUTE_BASE_PURPOSE=Review:CURRENT=policy_RouteTemplate.state_Active:LATESTREVISION=TRUE"
                                    + altOwnerFilter
     ...
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args holds a Map with the following input arguments: objectId objectId of the context Engineering Change New Value objectId of updated Approval List value
     * 
    ...
    public String getChangeFieldForBomGoToProduction(Context context, String[] args) throws Exception {
        ...
        sbHTMLTag.append("<input type=radio name='ecoOptions' value='createNewCO' onclick='javascript:hideSearchOption()' checked='checked'>").append(createNewCO).append("<br>")
                .append("<input type=radio name='ecoOptions' value='createNewCR' onclick='javascript:hideSearchOption()'>").append(createNewCR).append("<br>")
                .append("<input type=radio name='ecoOptions' value='AddExisting' onclick='javascript:showSearchOption()'>").append(AddExisting);
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getECORelatedECRs(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String objectId = (String) programMap.get("objectId");
        MapList ecrMapList = new MapList();
    ...
    public Object displayECRConnectionsWarning(Context context, String[] args) throws Exception {
        String disConnectECRs = EnoviaResourceBundle.getProperty(context, "emxEngineeringCentralStringResource", context.getLocale(),
                "emxEngineeringCentral.CancelECODialog.DisconnectFromAssociatedECRs");
        String doNotDisconnectECRs = EnoviaResourceBundle.getProperty(context, "emxEngineeringCentralStringResource", context.getLocale(),
                "emxEngineeringCentral.CancelECODialog.DoNotDisconnectFromAssociatedECRs");
    ...
    public MapList getAffectedItems(Context context, String[] args) throws Exception {
        ...
        if (TYPE_PART_MARKUP.equals(sENCAffectedItemsTypeFilter) && strParentId.equals(strChangeId)) {
            ...
            mlAffectedItemBusObjList = changeObj.getRelatedObjects(context, relPattern1.getPattern(), // relationship pattern
    ...
    /*
     * Get the list of all Objects which are connected to the context Change object as "Affected Items" and Parts connected with relationship "Part Markups" to Markups (Item and BOM)
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
     * 
     * @return a eMatrix <code>MapList</code> object having the list of Affected Items for this Change object, and Parts connected with relationship "Part Markups" to Markups (Item and BOM)
     * 
     * @throws Exception if the operation fails
     * 
     * @since Common X3
     */
    public MapList getAffectedItemsWithRelSelectables(Context context, String strParentId, String strChangeId, String sENCAffectedItemsTypeFilter, String sENCAffectedItemsAssigneeFilter,
            String sENCAffectedItemsRequestedChangeFilter) throws Exception {
        ...
        {
            mlAffectedItemBusObjList = changeObj.getRelatedObjects(context, relPattern, // relationship pattern
    ...
    /*
     * For a Selected Part, Gets the list of all Parts which can be connected as Affected Items for the Change object
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args[] packed hashMap of request parameters
     * 
     * @return a eMatrix <code>MapList</code> object having the list of Part Id's which could be added as Affected Item
     * 
     * @throws Exception if the operation fails
     * 
     * @since R213
    ...
    public MapList getAddRelatedPartsWithRelSelectables(Context context, String[] args) throws Exception {
        ...
        if (strChangeObjId != null && !"null".equals(strChangeObjId) && strChangeObjId.length() > 0) {
            ...
            if (busid != null && busid.length() > 0) {
                whereClause = "(((to[" + RELATIONSHIP_DESIGN_RESPONSIBILITY + "] == True ) && (to[" + DomainConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "].from.id == " + busid + " )) || (to["
                        + DomainConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "] == False))";
            }
        ...
        mlBusRelatedPartsList = domPartId.getRelatedObjects(context, relapttern, typepattern, selectStmts, selectrelStmts, false, true, (short) nExpandLevel, // Modified for IR-204955
                whereClause, null);
        ...
        mlBusChangeAIList = domchangeObj.getRelatedObjects(context, RELATIONSHIP_AFFECTED_ITEM, typepattern, selectStmts1, selectrelStmts1, false, true, (short) 1, null, null);
    ...
    /*
     * For the Selected Parts, Gets the list of all Specifications which can be connected as Affected Items for the Change object
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args[] packed hashMap of request parameters
     * 
     * @return a eMatrix <code>MapList</code> object having the list of Specification Id's which could be added as Affected Item
     * 
     * @throws Exception if the operation fails
     * 
     * @since R213
    ...
    public MapList getAddRelatedSpecificationsWithRelSelectables(Context context, String[] args) throws Exception {
        ...
        if ("".equals(whereClause))
            whereClause = "((current==" + DomainConstants.STATE_CADDRAWING_PRELIMINARY + " || current==" + DomainConstants.STATE_CADDRAWING_RELEASE + ")" + " || (current=="
                    + DomainConstants.STATE_CADMODEL_PRELIMINARY + " || current==" + DomainConstants.STATE_CADMODEL_RELEASE + ")" + " || (current==" + DomainConstants.STATE_DRAWINGPRINT_PRELIMINARY
                    + " || current==" + DomainConstants.STATE_DRAWINGPRINT_RELEASE + "))";
        else
            whereClause += " &&((current==" + DomainConstants.STATE_CADDRAWING_PRELIMINARY + " || current==" + DomainConstants.STATE_CADDRAWING_RELEASE + ")" + " || (current=="
                    + DomainConstants.STATE_CADMODEL_PRELIMINARY + " || current==" + DomainConstants.STATE_CADMODEL_RELEASE + ")" + " || (current==" + DomainConstants.STATE_DRAWINGPRINT_PRELIMINARY
                    + " || current==" + DomainConstants.STATE_DRAWINGPRINT_RELEASE + "))";
        ...
        while (stPartIds.hasMoreTokens()) {
            ...
            MapList mlBusRelatedSpecsTempList = domPartObj.getRelatedObjects(context, relapttern, typepattern, selectStmts, selectrelStmts, false, true, (short) 1, whereClause, null);
    ...
    public StringList getSpecificationRelatedParts(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < objectList.size(); i++) {
            ...
            MapList relatedPartList = domchangeObj.getRelatedObjects(context, RELATIONSHIP_PART_SPECIFICATION, typepattern, selectStmts1, selectrelStmts1, true, false, (short) 1, null, null);
    ...
    public Map createECO(Context context, String[] args) throws Exception {
        ...
        try {
            ECO eco = (ECO) DomainObject.newInstance(context, DomainConstants.TYPE_ECO, DomainConstants.ENGINEERING);
