...
public class emxProductLineBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     *            string containing the where condition for selection.
     * @param strOwnerCondition
     *            string containing the owner condition for selection.
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectWhere
     *            string containg the where condition
     * @param strObjectId
     *            string containing the object id
     * @return MapList - MapList containing the id of Desktop Requirement objects based on whereCondition .
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.0.0.0
    ...
    protected MapList getRelatedProductLines(Context context, String objectWhere, String strObjectId, String strExpandLevel) throws Exception {
        ...
        // The getRelatedObjects method is invoked to get the list of Sub Product Lines.
        MapList relBusObjPageList = getRelatedObjects(context, strRelationship, strType, objectSelects, relSelects, false, true, recurseLevel, objectWhere, DomainConstants.EMPTY_STRING, 0);
        return relBusObjPageList;
    }

    /*
     * Modified by <Tanmoy Chatterjee> On <26th May 2003> For the following Bug <Description- Sub ProductLine/Models can be added to Product line in Active/Inactive State..> Fixed as Follows: <added
     * the following functions and updated the tool.xls>
     */
    ...
    /**
     * This method gets the object Structure List for the context Product Line object.This method gets invoked by settings in the command which displays the Structure Navigator for Product Line type
     * objects
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public static MapList getStructureList(Context context, String[] args) throws Exception {
        ...
        /*
         * Map tempMap; String strType =""; for(int i=0;i<productlineStructList.size();i++) { tempMap = (Map)productlineStructList.get(i); strType = (String)tempMap.get(DomainConstants.SELECT_TYPE);
         * if(mxType.isOfParentType(context,strType,ProductLineConstants.TYPE_PRODUCT_LINE) ) { tempMap.put("treeMenu","type_PLCProductLine"); }
         * 
         * }
         */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            not used for the method
     * @throws Exception
     *             if the operation fails
     * @return boolean
     * @since R207
     */
    public boolean showRequirementAddedRemovedEvent(Context context, String[] args) throws Exception {// added for bug 368884
     ...
     * @throws Exception
     */
    public static StringList getCompany(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
    ...
    public void updateProductLineProgram(Context context, String[] args) throws Exception {
        ...
        if (strParentID != null && !strParentID.equals("")) {
            ...
            DomainRelationship.connect(context, newObjID, PropertyUtil.getSchemaProperty(context, "relationship_ProductLineProgram"), strParentID, false);
