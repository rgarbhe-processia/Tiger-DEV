...
public class emxAEFActionLinkAccessBase_mxJPO {
    ...
    public emxAEFActionLinkAccessBase_mxJPO(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: SETTINGS - HashMap containing settings details AEFMyDeskSuiteDir - String containing AEFMyDeskSuiteDir name
    ...
    public Boolean hasAccessToActionLink(Context context, String[] args) throws Exception {
    ...
    public static String getRegisteredDirectory(String suiteName) throws FrameworkException {
