...
public class emxWorkspaceBase_mxJPO extends emxWorkspaceConstants_mxJPO {
     ...
     * @since AEF Rossini
     */
    public emxWorkspaceBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
     ...
     *            the eMatrix Context object
     * @param args
     *            is an empty String list - mandatory param for JPO
     * @return void
     * @throws Exception
     *             if the operation fails
     * @since TC V3
     ...
     *            the eMatrix Context object
     * @param args
     *            holds id of Project Member object
     * @return void
     * @throws Exception
     *             if the operation fails
     * @since TC V3
    ...
    public void grantMemberAccess(matrix.db.Context context, String[] args) throws Exception {
        /*
         * try { DomainObject projMember = new DomainObject(args[0]); Map personInfo = projMember.getRelatedObject(context, RELATIONSHIP_PROJECT_MEMBERSHIP, false, new StringList(SELECT_NAME), new
         * StringList());
         * 
         * Access access = new Access(); access.setReadAccess(true); access.setShowAccess(true); access.setCheckoutAccess(true); access.setUser((String)personInfo.get(SELECT_NAME));
         * access.setGrantor(AccessUtil.WORKSPACE_MEMBER_GRANTOR);
         * 
         * BusinessObjectList busList = new BusinessObjectList(); busList.addElement(this);
         * 
         * try { //Push context to Workspace Member grantor to give 'read' access only for Workspace. ContextUtil.pushContext(context, AEF_WORKSPACE_MEMBER_GRANTOR_USERNAME, null, null);
         * matrix.db.BusinessObject.grantAccessRights(context, busList, access); } finally { ContextUtil.popContext(context); } } catch (Exception e) { throw e; }
         */
    }
     ...
     * @since AEF Rossini
     */
    public static MapList getWorkSpaceFolderList(Context context, String[] args) throws Exception {
        ...
        if (objType != null && objType.equals(DomainObject.TYPE_WORKSPACE)) {
            try {
                ...
                result = (MapList) domObj.getRelatedObjects(context, DomainObject.RELATIONSHIP_WORKSPACE_VAULTS, DomainObject.TYPE_PROJECT_VAULT, sSelects, null, false, true, (short) 1, null, null);
            ...
            try {
                result = (MapList) subFolder.getRelatedObjects(context, DomainObject.RELATIONSHIP_SUBVAULTS, DomainObject.TYPE_PROJECT_VAULT, selectTypeStmts, selectRelStmts, false, true, (short) 1,
                        null, null);
            } catch (FrameworkException e) {
                throw new FrameworkException(e);
            }
     ...
     * @since AEF Rossini
     */
    public static boolean displayTreeNodeAccessCheck(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        boolean result = true;
    ...
    public Object getAllMyDeskWorkspace(Context context, String[] args) throws Exception, MatrixException {
        try {
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getActiveMyDeskWorkspace(Context context, String[] args) throws Exception, MatrixException {
        try {
    ...
    public Object getMyDeskWorkspace(Context context, String[] args, String sFtr) throws Exception {
        ...
        if (newSecurityModel != null && "false".equals(newSecurityModel)) {
            ...
            workspaceList = person.getRelatedObjects(context, relPattern.getPattern(), // String relPattern
        ...
        MapList roleWorkspaceList = DomainObject.querySelect(context, DomainConstants.TYPE_PROJECT, // type pattern
            ...
            if (strBuyerDeskId != null && !"".equals(strBuyerDeskId) && !"null".equals(strBuyerDeskId)) {
                ...
                if (isBuyerDeskChanged) {
                    ...
                    if (oldBuyerDesk != null && !"null".equals(oldBuyerDesk)) {
                        ...
                        /*
                         * personSelect = oldBuyerDesk.expandSelect(context,DomainObject.RELATIONSHIP_ASSIGNED_BUYER,DomainObject.TYPE_PERSON, selectStmts,new StringList(),true, false, (short)1);
                         */
                        ContextUtil.startTransaction(context, false);
                        personIter = oldBuyerDesk.getExpansionIterator(context, DomainObject.RELATIONSHIP_ASSIGNED_BUYER, DomainObject.TYPE_PERSON, selectStmts, new StringList(), true, false,
                        ...
                        /*
                         * ExpansionWithSelect expMemberList = workspace.expandSelect(context,strPattern.getPattern(),strTypePattern.getPattern(), selectStmts, new StringList(),true, true, (short)2);
                         * RelationshipWithSelectItr memberItr = new RelationshipWithSelectItr(expMemberList.getRelationships());
                         */

                        ContextUtil.startTransaction(context, false);
                        ExpansionIterator expMemberList = workspace.getExpansionIterator(context, strPattern.getPattern(), strTypePattern.getPattern(), selectStmts, new StringList(), true, true,
                                (short) 2, null, null, (short) 0, false, false, (short) 100, false);
                        try {
                            while (expMemberList.hasNext()) {
                                ...
                                if (relWS.getTypeName().equals(DomainObject.RELATIONSHIP_PROJECT_MEMBERSHIP)) {
                                    /*
                                     * projectMemberAttributesTable = memberItr.obj().getTargetData(); String projectPersonId = (String)projectMemberAttributesTable.get("id");
                                     */
                    ...
                    projectMemberAttributesTable = null;
                    selectStmts = new SelectList(1);
                    selectStmts.addId();

                    /*
                     * personSelect = newBuyerDesk.expandSelect(context,DomainObject.RELATIONSHIP_ASSIGNED_BUYER,DomainObject.TYPE_PERSON, selectStmts,new StringList(),true, false, (short)1);
                     * 
                     * relItr = new RelationshipWithSelectItr(personSelect.getRelationships());
                     */

                    ContextUtil.startTransaction(context, false);
                    personIter = newBuyerDesk.getExpansionIterator(context, DomainObject.RELATIONSHIP_ASSIGNED_BUYER, DomainObject.TYPE_PERSON, selectStmts, new StringList(), true, false, (short) 1,
                            null, null, (short) 0, false, false, (short) 100, false);

                    // while (relItr.next()) {
                    while (personIter.hasNext()) {

                        // projectMemberAttributesTable = relItr.obj().getTargetData();
                        // String projectMemberId = (String)projectMemberAttributesTable.get("id");
                ...
                ContextUtil.startTransaction(context, false);
                personIter = oldBuyerDesk.getExpansionIterator(context, DomainObject.RELATIONSHIP_ASSIGNED_BUYER, DomainObject.TYPE_PERSON, selectStmts, new StringList(), true, false, (short) 1, null,
                        null, (short) 0, false, false, (short) 100, false);

                /*
                 * while (relItr.next()) { projectMemberAttributesTable = relItr.obj().getTargetData(); vectProjectMember.addElement((String)projectMemberAttributesTable.get("id")); }
                 */
                while (personIter.hasNext()) {
                    vectProjectMember.addElement(personIter.next().getTargetSelectData("id"));
                }
                 ...
                 */
                ContextUtil.startTransaction(context, false);
                ExpansionIterator expMemberList = workspace.getExpansionIterator(context, strPattern.getPattern(), strTypePattern.getPattern(), selectStmts, new StringList(), true, true, (short) 2,
                        null, null, (short) 0, false, false, (short) 100, false);

                try {
                    while (expMemberList.hasNext()) {
                        /*
                         * if ( memberItr.obj().getTypeName().equals(DomainObject.RELATIONSHIP_PROJECT_MEMBERSHIP)) { projectMemberAttributesTable = memberItr.obj().getTargetData(); String
                         * projectPersonId = (String)projectMemberAttributesTable.get("id");
                         * 
                         * BusinessObject projectMember = memberItr.obj().getTo(); BusinessObject projectPerson = memberItr.obj().getFrom();
                         */
                        RelationshipWithSelect relWS = expMemberList.next();
                        if (relWS.getTypeName().equals(DomainObject.RELATIONSHIP_PROJECT_MEMBERSHIP)) {
                            String projectPersonId = relWS.getTargetSelectData("id");
    ...
    private boolean canDelete(Context context, BusinessObject projectPerson, BusinessObject boWorkspace) {
        ...
        // ExpansionWithSelect expMemberList = null;
        ExpansionWithSelect boGeneric = null;
        RelationshipWithSelectItr relItr = null;
        RelationshipWithSelectItr relWorkItr = null;
        ExpansionIterator expIter = null;
        ExpansionIterator expWorkIter = null;

        try {
            /*
             * expMemberList = projectPerson.expandSelect(context,relPattern.getPattern(),typePattern.getPattern(), selectStmts, new StringList(),true, true, (short)1); if (
             * expMemberList.getRelationships().size() == 0 ) { return true; } else { relItr = new RelationshipWithSelectItr(expMemberList.getRelationships()); while (relItr.next()) {
             * projectMemberAttributesTable = relItr.obj().getTargetData(); vectProjectMember.addElement( (String)projectMemberAttributesTable.get("id") ); }
             */

            ContextUtil.startTransaction(context, false);
            expIter = projectPerson.getExpansionIterator(context, relPattern.getPattern(), typePattern.getPattern(), selectStmts, new StringList(), true, true, (short) 1, null, null, (short) 0, false,
                    false, (short) 100, false);
            ...
            if (!expIter.hasNext()) {
                ...
                /*
                 * boGeneric = boWorkspace.expandSelect( context, relPattern.getPattern(), typePattern.getPattern(), selectStmts, new StringList(), false, true, (short)0);
                 */
                ContextUtil.startTransaction(context, false);
                expWorkIter = boWorkspace.getExpansionIterator(context, relPattern.getPattern(), typePattern.getPattern(), selectStmts, new StringList(), false, true, (short) 0, null, null, (short) 0,
                        false, false, (short) 100, false);
                ...
                /*
                 * if ( boGeneric.getRelationships().size() == 0 ) { return true; } else {
                 * 
                 * relWorkItr = new RelationshipWithSelectItr(boGeneric.getRelationships()); while (relWorkItr.next()) { if (
                 * relWorkItr.obj().getTypeName().equals(DomainObject.RELATIONSHIP_ROUTE_SCOPE)) { BusinessObject busRoute = relWorkItr.obj().getTo(); busRoute.open(context); if (
                 * vectProjectMember.contains(busRoute.getObjectId().trim()) ) { return false; } busRoute.close(context); } } return true; }
                 */
            }
        } catch (Exception ex) {
        }
    ...
    private BusinessObject getConnectedObject(Context context, BusinessObject object, String relPattern, String typePattern, boolean getTo, boolean getFrom) throws Exception {
        ...
        /*
         * ExpansionWithSelect ews = object.expandSelect(context, relPattern, typePattern, busSelects, new SelectList(), getTo, getFrom, (short) 1);
         * 
         * // If there is a connected object, create it from the id. RelationshipWithSelectItr relItr = new RelationshipWithSelectItr(ews.getRelationships()); if (relItr.next()) { String objectId =
         * (String) relItr.obj().getTargetData().get("id"); connectedObject = new BusinessObject(objectId); }
         */
        ContextUtil.startTransaction(context, false);
        ExpansionIterator expIterator = object.getExpansionIterator(context, relPattern, typePattern, busSelects, new SelectList(), getTo, getFrom, (short) 1, null, null, (short) 0, false, false,
                (short) 100, false);
    ...
    public BusinessObject getProjectMember(matrix.db.Context context, String projectId, BusinessObject person) throws MatrixException {
        ...
        /*
         * ExpansionWithSelect projectSelect = person.expandSelect(context, relPattern, typePattern, EMPTY_STRING_LIST, EMPTY_STRING_LIST,false, true, (short)1,strWhereClause,null);
         * RelationshipWithSelectItr relItr = new RelationshipWithSelectItr(projectSelect.getRelationships()); BusinessObject busProjectMember = null; if (relItr.next()) { busProjectMember =
         * relItr.obj().getTo(); }
         */
        ContextUtil.startTransaction(context, false);
        ExpansionIterator projectItr = person.getExpansionIterator(context, relPattern, typePattern, EMPTY_STRING_LIST, EMPTY_STRING_LIST, false, true, (short) 1, strWhereClause, null, (short) 0,
                false, false, (short) 100, false);
        ...
        ContextUtil.commitTransaction(context);
        /*
         * if (busProjectMember != null ) { personHashtable.put(projectId, busProjectMember); }
         */
    ...
    /**
     * The main method which all filter access method calls. Returns Workspace Access List Based on the parameters.
     * @param context
     *            the eMatrix Context object
     * @param args
     *            holds the grantee and grantor name
    ...
    public Object constructWorkspaceAccessList(Context context, String[] args, boolean bPersonFlag, boolean bBuyerFlag, boolean bRoleFlag) throws Exception {
        ...
        String selCreateRoute = "";
        String selCreateFolder = "";
        String selProjectAccess = "";
        ...
        MapList mapList = Workspace.getRelatedObjects(context, BaseObject.RELATIONSHIP_PROJECT_MEMBERS, BaseObject.TYPE_PROJECT_MEMBER, objectSelects, null, false, true, (short) 1, "", "", null, null,
                null);
    ...
    /**
     * Method to show person name along with its image icon Returns a Vector of person names (HTML) Output
     * @param context
     *            the eMatrix Context object
     * @param args
     *            holds the grantee and grantor name
    ...
    /**
     * Method to show Project Lead Access Image Icon Returns a Vector of person names (HTML) Output
     * @param context
     *            the eMatrix Context object
     * @param args
     *            holds the grantee and grantor name
    ...
    public Vector showProjectLeadIcon(Context context, String[] args) throws Exception {
        ...
        for (Iterator objectListItr = objectList.iterator(); objectListItr.hasNext();) {
            ...
            if ((sProjectLead != null) && (sProjectLead.equalsIgnoreCase("Project Lead"))) {
                projectLeadIcons.add("<img border=\"0\" src=\"../teamcentral/images/iconProjectLead.gif\" alt=\""
                        + EnoviaResourceBundle.getProperty(context, stringResFileId, new Locale(languageStr), "emxTeamCentral.Access.WorkspaceLead") + "\" title=\""
                        + EnoviaResourceBundle.getProperty(context, stringResFileId, new Locale(languageStr), "emxTeamCentral.Access.WorkspaceLead") + "\" />");
            } else {
    ...
    /**
     * Method to show Create Route image icon Returns a Vector of Create Route Images (HTML) Output
     * @param context
     *            the eMatrix Context object
     * @param args
     *            holds the grantee and grantor name
    ...
    public Vector showCreateRouteIcon(Context context, String[] args) throws Exception {
        ...
        for (Iterator objectListItr = objectList.iterator(); objectListItr.hasNext();) {
            ...
            if ((sCreateRoute != null) && (sCreateRoute.equalsIgnoreCase("Yes"))) {
                createRouteIcons.add("<img border=\"0\" src=\"images/iconSmallRoute.gif\" alt=\""
                        + EnoviaResourceBundle.getProperty(context, stringResFileId, new Locale(languageStr), "emxTeamCentral.Access.CreateRoute") + "\" title=\""
                        + EnoviaResourceBundle.getProperty(context, stringResFileId, new Locale(languageStr), "emxTeamCentral.Access.CreateRoute") + "\" />");
            } else {
    ...
    /**
     * Method to show Create Folder Image Icon Returns a Vector of images (HTML) Output
     * @param context
     *            the eMatrix Context object
     * @param args
     *            holds the grantee and grantor name
    ...
    public Vector showCreateFolderIcon(Context context, String[] args) throws Exception {
        ...
        for (Iterator objectListItr = objectList.iterator(); objectListItr.hasNext();) {
            ...
            if ((sCreateFolder != null) && (sCreateFolder.equalsIgnoreCase("Yes"))) {
                createFolderIcons.add("<img border=\"0\" src=\"images/iconSmallFolder.gif\" alt=\""
                        + EnoviaResourceBundle.getProperty(context, stringResFileId, new Locale(languageStr), "emxTeamCentral.CreateFolder.Tooltip") + "\" title=\""
                        + EnoviaResourceBundle.getProperty(context, stringResFileId, new Locale(languageStr), "emxTeamCentral.CreateFolder.Tooltip") + "\" />");
            } else {
    ...
    /**
     * Access Method to Checkbox in Access Summary page Returns a Vector of boolean values
     * @param context
     *            the eMatrix Context object
     * @param args
     *            holds the grantee and grantor name
    ...
    public Vector showAccessCheckBox(Context context, String[] args) throws Exception {
        ...
        String workspaceId = (String) paramMap.get("workspaceId");
        if (workspaceId == null)
            workspaceId = (String) paramMap.get("parentOID");
        if (workspaceId == null)
        ...
        String sSelOrgName = "to[" + BaseObject.RELATIONSHIP_PROJECT_MEMBERSHIP + "].from.to[" + BaseObject.RELATIONSHIP_EMPLOYEE + "].from.name";
        String sSelOrgId = "to[" + BaseObject.RELATIONSHIP_PROJECT_MEMBERSHIP + "].from.to[" + BaseObject.RELATIONSHIP_EMPLOYEE + "].from.id";
        String sSelPersonName = "to[" + BaseObject.RELATIONSHIP_PROJECT_MEMBERSHIP + "].from.name";
        String sSelPersonLastName = "to[" + BaseObject.RELATIONSHIP_PROJECT_MEMBERSHIP + "].from." + PersonObj.SELECT_LAST_NAME + ".value";
        String sSelPersonFirstName = "to[" + BaseObject.RELATIONSHIP_PROJECT_MEMBERSHIP + "].from." + PersonObj.SELECT_FIRST_NAME + ".value";
        String sAssignBuyerDesk = "to[" + BaseObject.RELATIONSHIP_PROJECT_MEMBERSHIP + "].from.from[" + BaseObject.RELATIONSHIP_ASSIGNED_BUYER + "].to.id";
        String sSelProjectMemberId = BaseObject.SELECT_ID;
        ...
        for (Iterator objectListItr = objectList.iterator(); objectListItr.hasNext();) {
            ...
            // Bug 282994
            String sRole = (String) mapAccess.get("type");
            ...
            String PersonType = (String) mapAccess.get(sSelPersonType);
            boolean bRouteOwner = false;
            ...
            String encodeUrl = "emxTeamPeopleDetailsFS.jsp?personId=" + sId + "&objectId=" + sOrgId;
            String target = "";
            String treeUrl = "";
            String sRouteOwner = "";
            ...
            if (sProjectMemberId != null && !sProjectMemberId.equals("")) {
                ...
                MapList taskMapList = PersonObj.getRelatedObjects(context, patternRelationship.getPattern(), BaseObject.TYPE_ROUTE, selectTypeStmts, null, true, false, (short) 1, sTypeWhere, "", null,
                        null, null);
    ...
    /**
     * Method to show the PersonName in SubFolder Access List Returns a Vector of person names along with image icons
     * @param context
     *            the eMatrix Context object
     * @param args
     *            holds the grantee and grantor name
    ...
    /**
     * Method to get Specific Access for SubFolder Returns a Vector of boolean values
     * @param context
     *            the eMatrix Context object
     * @param args
     *            holds the grantee and grantor name
    ...
    public static boolean displaySubFolderAccessTreeNode(Context context, String[] args) throws Exception {
         ...
         * 
         * displayTreeNodeAccessCheck(context,args); HashMap programMap=(HashMap)JPO.unpackArgs(args); String objectId=(String)programMap.get("objectId"); DomainObject BaseObject=new
         * DomainObject(objectId); String parentOID=(String)programMap.get("parentOID"); if(parentOID!=null && !parentOID.equals("")) { DomainObject parentObject=new DomainObject(parentOID); String
         * sTypeName = parentObject.getType(context); if(sTypeName.equals(parentObject.TYPE_WORKSPACE_VAULT)) { return true; } else { return false; } } else { String sParent =
         * (String)BaseObject.getInfo(context,"to[" +DomainObject.RELATIONSHIP_PROJECT_VAULTS+ "].from.type"); if(sParent!= null && !sParent.equals("") && sParent.equals(DomainObject.TYPE_PROJECT)) {
    ...
    private void getAccess(matrix.db.Context context, matrix.db.AccessList baseAccessList, matrix.db.AccessList parentAccessList, String sGrantee, String sTypeName, java.util.HashMap hashMap,
    ...
    private matrix.db.Access getGranteeAccess(matrix.db.Context context, matrix.db.AccessList accessList, String grantee) throws Exception {
    ...
    private String getProjectId(matrix.db.Context context, String folderId) throws MatrixException {
        ...
        MapList mapList = domainObject.getRelatedObjects(context, relPattern.getPattern(), typePattern.getPattern(), objSelects, null, true, false, (short) 0, "", "", includeTypePattern, null, null);
    ...
    public void checkWorkspaceName(Context context, String[] args) throws Exception {
        ...
        ContextUtil.pushContext(context, null, null, null);
        listOfWorkspaces = DomainObject.findObjects(context, DomainConstants.TYPE_WORKSPACE, strName, "*", "*", "*", null, false, null);
        ContextUtil.popContext(context);
     ...
     *            The current context object.
     * @param args
     *            holds the Workspace object Id, request map, param map
    ...
    public String getBuyerDesk(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (workspaceId != null) {
                ...
                MapList mapList = domWorkspace.getRelatedObjects(context, DomainConstants.RELATIONSHIP_WORKSPACE_BUYER_DESK, // relationship
                        // pattern
            ...
            if (strMode.equals("edit")) {
                ...
                output.append("javascript:showChooser('../teamcentral/emxTeamBuyerDeskSummaryFS.jsp?formName=editDataForm&amp;txtCtrl=txtBuyerDesk&amp;txtId=txtBuyerDeskId',575,575)\" />");
    ...
    public Object getWorkspaces(Context context, String[] args, String sFtr) throws Exception {
        ...
        // get all workspaces that the current user is a member since one of his roles is a member
        MapList workspaceList = DomainObject.querySelect(context, DomainConstants.TYPE_PROJECT, // type pattern
                DomainObject.QUERY_WILDCARD, // namePattern
                DomainObject.QUERY_WILDCARD, // revPattern
                DomainObject.QUERY_WILDCARD, // ownerPattern
                DomainObject.QUERY_WILDCARD, // get the Person Company vault
    ...
    public boolean showTMCWorkspaceFolderEditAccess(Context context, String[] args) throws Exception {
        ...
        if (sOwner.equals(sUser) || sProjectLead.equals("Project Lead") || sFolderOwner.equals(sUser)) {
            bIsProjectLead = true;
        }
    ...
    protected MapList getWorkspaceFolders(Context context, String[] args, String accessCheck, String selection) throws Exception {
        ...
        resultsList = (MapList) wsObj.getRelatedObjects(context, DomainObject.RELATIONSHIP_WORKSPACE_VAULTS + "," + DomainObject.RELATIONSHIP_SUBVAULTS, DomainObject.TYPE_PROJECT_VAULT, objectSelects,
    ...
    public Object getDisabledWorkspaces(Context context, String[] args) throws Exception {
        ...
        String queryTypeWhere = "('" + DomainObject.SELECT_CURRENT + "' == 'Active') || ('" + DomainObject.SELECT_CURRENT + "' == 'Prototype')";
        ...
        objectSelects.add("type.kindof[" + DomainConstants.TYPE_PROJECT_CONCEPT + "]");
        ...
        // get all workspaces that the current user is a member since one of his roles is a member
        MapList workspaceList = DomainObject.querySelect(context, typePattern.getPattern(), // type pattern
                DomainObject.QUERY_WILDCARD, // namePattern
                DomainObject.QUERY_WILDCARD, // revPattern
                DomainObject.QUERY_WILDCARD, // ownerPattern
                DomainObject.QUERY_WILDCARD, // get the Person Company vault
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getRouteScopeWorkspaces(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String menuAction = (String) programMap.get("menuAction");
        MapList objectList = new MapList();
        String type = (String) programMap.get("type");
        String routeScopeId = "";
        // getting the route scope from the objectid
        String objectId = (String) programMap.get("objectId");
        if (UIUtil.isNotNullAndNotEmpty(objectId)) {
            ...
            objSelect.add("to[" + DomainConstants.RELATIONSHIP_ROUTE_SCOPE + "].from.id");
            objSelect.add("attribute[" + DomainObject.ATTRIBUTE_RESTRICT_MEMBERS + "]");
            Map map = routeObj.getInfo(context, objSelect);
            restrictMembers = (String) map.get("attribute[" + DomainObject.ATTRIBUTE_RESTRICT_MEMBERS + "]");
            routeScopeId = (String) map.get("to[" + DomainConstants.RELATIONSHIP_ROUTE_SCOPE + "].from.id");
            type = (String) (String) map.get(DomainConstants.SELECT_TYPE);
            if ("All".equals(restrictMembers) || "Organization".equals(restrictMembers)) {
                routeScopeId = "";
            }
        }
        ...
        if (UIUtil.isNotNullAndNotEmpty(routeScopeId)) {
            Map scopeInfo = null;
            DomainObject routeScopeObj = DomainObject.newInstance(context, routeScopeId);
            scopeInfo = routeScopeObj.getInfo(context, objectSelects);
            String owner = (String) scopeInfo.get(DomainObject.SELECT_OWNER);
            String access = (String) scopeInfo.get(accessCheck);
            String objectType = (String) scopeInfo.get(DomainConstants.SELECT_TYPE);
            ;
            String isProjectSpace = (String) scopeInfo.get("type.kindof[" + DomainConstants.TYPE_PROJECT_SPACE + "]");
            if (("true".equalsIgnoreCase(access) || ("true".equalsIgnoreCase(isProjectSpace) && contextUser.equalsIgnoreCase(owner))) && objectType.equals(DomainConstants.TYPE_WORKSPACE_VAULT)) {
                scopeInfo.put("selection", selection);
            }
            objectList.add(scopeInfo);
        } else {
            String queryTypeWhere = "('" + DomainObject.SELECT_CURRENT + "' == 'Active') || ('" + DomainObject.SELECT_CURRENT + "' == 'Prototype')";
            Pattern typePattern = new Pattern(DomainConstants.TYPE_PROJECT);
            typePattern.addPattern(DomainConstants.TYPE_PROJECT_SPACE);
    ...
    public MapList findContentFolderSearch(Context context, String[] args) throws Exception {
        MapList rolesList = new MapList();
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String sProjectId = (String) programMap.get("projectId");
        String sObjectId = (String) programMap.get("objectId");
        // sProjectId = (String)programMap.get("objectId");
        String suiteKey = (String) programMap.get("suiteKey");
        ...
        if (!"".equals(sProjectId)) {
            ...
            sProjectName = boProject.getName();
            ...
            FolderMapList = workspaceObj.getRelatedObjects(context, relPattern.getPattern(), // String relPattern
                    typePattern.getPattern(), // String typePattern
     ...
     *            the eMatrix Context object
     * @param String
     *            array contains person Ids to display in the table
     * @return MapList
     * @throws Exception
     *             if the operation fails
     * @since V6R2011x
    ...
    public Vector showUserLastNameFirstName(Context context, String[] args) throws Exception {
        ...
        for (Iterator objectListItr = objectList.iterator(); objectListItr.hasNext();) {
            ...
            String wrkphoneNumber = (String) mapAccess.get(strworkPhoneNumber);
            String PersonType = (String) mapAccess.get(DomainObject.SELECT_TYPE);
    ...
    public MapList getFolderFindfilesResult(Context context, String[] args) throws Exception {
        ...
        com.matrixone.apps.common.Workspace project = (com.matrixone.apps.common.Workspace) DomainObject.newInstance(context, DomainConstants.TYPE_PROJECT);
        com.matrixone.apps.common.Document document = (com.matrixone.apps.common.Document) DomainObject.newInstance(context, DomainConstants.TYPE_DOCUMENT);
        ...
        if ((Title != null) && !Title.equals(null) && !Title.equals("null") && !Title.equals("*") && !Title.equals("")) {
            if (busWhere != null) {
        ...
        /*
         * // Bug 304444 - Added code to get the correct name of owner StringTokenizer st = new StringTokenizer(Owner, ","); String LastName = st.nextToken().trim();
         * 
         * if(st.hasMoreTokens()){ String FirstName = st.nextToken().trim(); Owner = FirstName +" "+ LastName; }
         */
        // till here
        ...
        // Start of Pre Migration Code -SC
            ...
            if ((busWhere == null) || (busWhere.equalsIgnoreCase("null")) || (busWhere.length() <= 0)) {
                busWhere = "  (to[" + DomainObject.RELATIONSHIP_RTS_QUOTATION + "].from.to[" + DomainObject.RELATIONSHIP_COMPANY_RFQ + "]!='#DENIED!') && (!(to["
                        + DomainObject.RELATIONSHIP_RTS_QUOTATION + "].from.to[" + DomainObject.RELATIONSHIP_COMPANY_RFQ + "]))";
            } else {
                busWhere += sAnd + " " + " (to[" + DomainObject.RELATIONSHIP_RTS_QUOTATION + "].from.to[" + DomainObject.RELATIONSHIP_COMPANY_RFQ + "]!='#DENIED!') && (!(to["
                        + DomainObject.RELATIONSHIP_RTS_QUOTATION + "].from.to[" + DomainObject.RELATIONSHIP_COMPANY_RFQ + "]))";
            }
        }
        ...
        // Else, get all files for each workspaceVault
            ...
            String sContentObjId = "";
            StringList slUniqueContentObjIdList = new StringList();
            while (vaultItr.hasNext()) {
                ...
                while (documentItr.hasNext()) {
                    ...
                    sContentObjId = (String) documentMap.get("id");

                    if (!slUniqueContentObjIdList.contains(sContentObjId)) {
                        queryResultList.add(documentMap);
                        slUniqueContentObjIdList.add(sContentObjId);
                    }
    ...
    static public StringList convertToStringList(String vaultStr, String splitAt) throws MatrixException {
    ...
    static public StringList GetAllVaults(Context context) throws MatrixException {
        ...
        /*
         * Person person = Person.getPerson(context); Company company = person.getCompany(context);
         * 
         * StringList selectList = new StringList(2); selectList.add(company.SELECT_VAULT); selectList.add(company.SELECT_SECONDARY_VAULTS); Map companyMap = company.getInfo(context,selectList);
         * StringList secVaultList = FrameworkUtil.split((String)companyMap.get(company.SELECT_SECONDARY_VAULTS),null); Iterator itr = secVaultList.iterator();
         * 
         * String vaults = (String)companyMap.get(company.SELECT_VAULT); vaultList.add(vaults); while (itr.hasNext() ) { vaultList.add(PropertyUtil.getSchemaProperty((String)itr.next())); }
         */
    ...
    static public StringList GetAllLocalVaults(Context context) throws MatrixException {
        StringList localVaultList = new StringList();
        /*
         * StringList vaultList = GetAllVaults(context); StringItr itr = new StringItr(VaultUtil.getLocalVaults(context)); while (itr.next() ) { String vault = itr.obj(); if(vaultList.contains(vault))
    ...
    static public StringList GetAllRemoteVaults(Context context) throws MatrixException {
    ...
    static MapList getWorkspaceVaults(Context context, DomainObject domainobject, StringList stringlist, int i) throws FrameworkException {
     ...
     * @grade 0
     */
    static public BusinessTypeList getAllSubTypes(Context context, String type, BusinessTypeList busTypeList) throws MatrixException {
        if (busTypeList == null)
    ...
    public String getOrganizationHTMLOutput(Context context, String[] args) throws Exception {
        ...
        BusinessObject myBusinessUnit = getConnectedObject(context, person1, "relationship_BusinessUnitEmployee", "type_BusinessUnit", true, false);
    ...
    public MapList getWorkspaceRoles(Context context, String[] args) throws Exception {
        ...
        if (templateMapList.size() > intQueryLimit) {
            ...
            String strMessage = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", locale, "emxComponents.Warning.ObjectFindLimit") + queryLimit
                    + EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", locale, "emxComponents.Warning.Reached");
    ...
    public MapList getAllWorkspaceMembers(Context context, String[] args) throws Exception {
        ...
        try {
            ContextUtil.startTransaction(context, false);
            ExpansionIterator expIter = domOrgObj.getExpansionIterator(context, relPattern, typePerson, selectStmts, new SelectList(), false, true, (short) 1, null, strRelWhere, (short) 0, false,
                    false, (short) 100, false);
    ...
    public Vector getWorkspaceRoleNames(Context context, String[] args) throws Exception {
        ...
        for (Iterator objectListItr = objectList.iterator(); objectListItr.hasNext();) {
            ...
            rolesList.add("<img src=\"../common/images/iconSmallRole.gif\" name=\"imgRole\" id=\"imgRole\" alt=\"" + XSSUtil.encodeForHTMLAttribute(context, translatedRoleNameString) + "\" />"
                    + XSSUtil.encodeForHTML(context, translatedRoleNameString) + "&nbsp;");
    ...
    public Vector getAllProjectmembers(Context context, String workspaceId) throws Exception {
        ...
        ExpansionWithSelect projectSelect = activeProject.expandSelect(context, relPattern, typePattern, selectStmts, new StringList(0), true, true, (short) 2);
    ...
    public MapList getDisucssionFindfilesResult(Context context, String[] args) throws Exception {
        ...
        String sRelProjectMembership = PropertyUtil.getSchemaProperty(context, "relationship_ProjectMembership");
        String sRelProjectMembers = PropertyUtil.getSchemaProperty(context, "relationship_ProjectMembers");
        ...
        if (sWorkspaceFolder.equals("*")) {
            ...
            while (st.hasMoreTokens()) {
                ...
                domainObject.setId(folderId);
                MapList docMapList = domainObject.expandSelect(context, relPattern.getPattern(), typePattern.getPattern(), objSelects, new StringList(), false, true, expandLevel, null, null, null,
                        includeRelPattern, null, null, false);
            ...
            try {
                ...
                try {
                    ...
                    isQueryExecuted = prMQL.executeCommand(context, prMQLString, "mxdocsearch", sTypeDocument, "*", "*", company1.getAllVaults(context, true), busWhere.trim());
        ...
        while (paginatedMapListItr.hasNext()) {
            ...
            while (vaultIdItr.hasNext()) {
                ...
                if (vaultId != null && !vaultId.equals("#DENIED!")) {
                    ...
                    if (!projectHash.containsKey(vaultId)) {
                        projectMap = getWorkspaceMap(context, vaultId);
                        if (null != projectMap) {
                            ...
                            projectHash.put(vaultId, EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), "emxFramework.Basic.DENIED"));
                        }
                    }

                    if (vault.containsKey(projectName)) {
                        tempVaultName += ";" + (String) vault.get(projectName);
                        vault.put(projectName, tempVaultName);
            ...
            Set keys = vault.keySet();
            Iterator itr = keys.iterator();
            String allVaultName = "";
            while (itr.hasNext()) {
                String key = (String) itr.next();
                String value = (String) vault.get(key);
                if (itr.hasNext()) {
                    allVaultName = allVaultName + "(" + key + ":" + value + ")";
                } else {
                    allVaultName = "(" + key + ":" + value + ")" + allVaultName;
                }
            ...
            try {
                if (workspaceNames != null && workspaceNames.length() != 0) {
                    ...
                    hashTableFinal.put("folder", allVaultName);
    ...
    public HashMap deleteWorkspaceMembers(Context context, String[] args) throws Exception {
        ...
        if (strType != null && strType.equals(DomainObject.TYPE_PROJECT)) {
            ...
            // get all workspaces that the user is a Project-Member
            MapList routeTemplateList = ObjectGeneral.getRelatedObjects(context, DomainObject.RELATIONSHIP_ROUTE_TEMPLATES, // String relPattern
        ...
        if (flagStr) {
            try {
                if (!typeMessage.equals(strType)) {
                    ...
                    for (int i = 0; i < objId.length; i++) {
                        ...
                        if (typeRoute.equals(strType)) {
                            ...
                            if (isRole) {
                                ...
                                MapList tempPersonList = workspace.getRelatedObjects(context, relPattern1.getPattern(), typePattern1.getPattern(), objectSelects, null, true, true, (short) 0, "", "",
                                        new Pattern(DomainObject.TYPE_PERSON), new Pattern(DomainObject.RELATIONSHIP_SUBSCRIBED_PERSON), null);
                            ...
                            if (subscribedItemList.size() > 0 || personList.size() > 0) {
                                for (int j = 0; j < personList.size(); j++) {
                                    ...
                                    MapList objectMapList = workspace.getRelatedObjects(context, relPattern.getPattern(), // relationshipPattern
                    ...
                    MapList messageList = thread.getRelatedObjects(context, DomainConstants.RELATIONSHIP_MESSAGE, DomainConstants.TYPE_MESSAGE, objectSelects, null, false, true, (short) 1, null,
                            null);
    ...
    public StringList getWorkspaceChangeOwnerInclusionIDs(Context context, String[] args) throws FrameworkException {
        try {
            ...
            MapList mapList = ws.getRelatedObjects(context, RELATIONSHIP_WORKSPACE_MEMBER, // String relPattern
    ...
    public void updateWorkspaceAndRelatedProjectMembersOwner(Context context, String[] args) throws MatrixException {
        try {
            ...
            String wsName = workspaceObject.getInfo(context, SELECT_NAME);
            ...
            DomainAccess.createObjectOwnership(context, workspaceId, com.matrixone.apps.domain.util.PersonUtil.getPersonObjectID(context, oldOwner), "Read", DomainAccess.COMMENT_MULTIPLE_OWNERSHIP,
                    true, true);
        } catch (Exception e) {
            throw new FrameworkException(e);
        }
        ...
        try {
            ...
            if (resultList.size() == 2 && "User Projects".equals(resultList.get(1))) {
                ...
                if (personId != null) {
                    ...
                    String select = "print bus " + workspaceId + " select from[" + relationship_WorkspaceMember + "|to.id==" + personId + "].id dump";
                    String relId = MqlUtil.mqlCommand(context, select, true);
                    if (relId == null || "".equals(relId)) {
                        DomainRelationship.connect(context, workspaceId, PropertyUtil.getSchemaProperty(context, "relationship_WorkspaceMember"), personId, true);
                    }
                }
            }
