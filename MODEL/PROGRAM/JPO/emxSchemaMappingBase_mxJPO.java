...
public class emxSchemaMappingBase_mxJPO {
     ...
     * @since AEF 10.Next
     */
    public emxSchemaMappingBase_mxJPO(Context context, String[] args) throws Exception {
     ...
     * @since AEF 10.Next
     */
    public emxSchemaMappingBase_mxJPO(Context context, File xmlFile, boolean bReloadCache) throws Exception {
        // load schema manifest info file
     ...
     *            the eMatrix <code>Context</code> object
     * @param xmlFile
     *            holds schema manifest info file name with full path
     * @param bReloadCache
     ...
     * @since AEF 10.Next
     */
    public void loadSchemaMapping(Context context, String xmlFile, boolean bReloadCache) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param xmlFile
     *            holds schema manifest info file
     * @param bReloadCache
     *            if set to true it will reload the cache
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.Next
     */
    public void loadSchemaMapping(Context context, File xmlFile, boolean bReloadCache) throws Exception {
     ...
     * @since AEF 10.Next
     */
    public TreeMap getOrderedSchemaElements(Context context, emxSchemaMappingBase_mxJPO customMapping) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param iniFileName
     *            of the ini info file
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.Next
     */
    public ArrayList GetPreSchemaHierarchy(Context context, String sSchemaName, emxSchemaMappingBase_mxJPO customMapping) throws Exception {
        // return list
     ...
     * @since AEF 10.Next
     */
    public void createIniInfoFile(Context context, String customDir, String iniFileName) throws Exception {
     ...
     * @since AEF 10.Next
     */
    public void createIniInfoFile(Context context, String iniFileName) throws Exception {
     ...
     * @since AEF 10.Next
     */
    public void createIniInfoFile(Context context, String args[]) throws Exception {
        if (args.length < 1) {
