...
/**
 * The <code>emxProjectAccessList</code> class represents the Project Access List JPO functionality for the AEF type.
...
public class emxCommonProjectAccessList_mxJPO extends emxCommonProjectAccessListBase_mxJPO {
     ...
     * @grade 0
     */
    public emxCommonProjectAccessList_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
