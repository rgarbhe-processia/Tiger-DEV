...
public class MCADIntegGetLatestReleasedRevision_mxJPO extends MCADIntegGetLatestReleasedRevisionBase_mxJPO {
    /**
     * Constructor.
     * @since Sourcing V6R2008-2
     */
    public MCADIntegGetLatestReleasedRevision_mxJPO() {
        super();
    }
     ...
     * @since Sourcing V6R2008-2
     */
    public MCADIntegGetLatestReleasedRevision_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
