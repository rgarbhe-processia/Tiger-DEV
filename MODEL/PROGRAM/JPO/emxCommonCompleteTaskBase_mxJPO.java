...
public class emxCommonCompleteTaskBase_mxJPO {
     ...
     * @grade 0
     */
    public emxCommonCompleteTaskBase_mxJPO(Context context, String[] args) throws Exception {
    }
    ...
    public static int completeTask(Context context, String args[]) throws Exception {
        try {
            ...
            MapList ObjectsList = Route.getRelatedObjects(context, sRelRouteTask, "*", objectSelects, relSelects, true, false, (short) 0, null, null);
            ...
            if (isRouteToBeStopped) {
                if ("Immediate".equals(sAutoStopOnRejection) || isLevelCompleted) {
                    ...
                    Route.setAttributeValue(context, sAttRouteStatus, "Stopped");

                    sendNotification(context, sRouteActionOfTask, ObjectId, sRouteId, sApprovalStatus, sRouteName, sLastName, sFirstName, sPerson, sType, sName, sRev, sRouteType, sRouteRev,
                            sActualCompletionDate, sComments);
            ...
            if (!"Reject".equals(sApprovalStatus)) {
                ...
                for (int i = 0; i < ObjectsList.size(); i++) {
                    ...
                    if (sState.equals(sStateAssigned) || sState.equals(sStateReview)) {
                        if ((sProcessionRule.toLowerCase()).equals("any")) {
                            ...
                            /*
                             * bRouteNodeIdFound = 1; for(int count=0; count< lRouteNodeId.size(); count++) { sRouteNodeId = (String)lRouteNodeId.elementAt(i); sRouteNodeIdAttr = (String)
                             * lRouteNodeIdAttr.elementAt(i); if(sRouteNodeID.equals(sRouteNodeIdAttr)) { bRouteNodeIdFound = 1; break; } } // If Route Node Id not found then // Error out if
                             * (bRouteNodeIdFound == 0) { String sCurrTaskType = ""; String sCurrTaskName = ""; String sCurrTaskRev = ""; arguments = new String[9]; arguments[0] =
                             * "emxFramework.ProgramObject.eServicecommonCompleteTask.InvalidRouteNodeId"; arguments[1] = "3"; arguments[2] = "type"; arguments[3] = sCurrTaskType; arguments[4] =
                             * "name"; arguments[5] = sCurrTaskName; arguments[6] = "rev"; arguments[7] = sCurrTaskRev; arguments[8] = ""; message= mailUtil.getMessage(context,arguments);
                             * MqlUtil.mqlCommand(context,"notice "+message+""); return 1; }
                             */
                ...
                if (bFound == 0 && sRouteStatus.equals("Started")) {
                    ...
                    if (outStr1 == 0) {
                        ...
                        MapList objectList = Route.getRelatedObjects(context, sRelObjectRoute, "*", objectSelects, relSelects, true, false, (short) 0, null, null);
                        ...
                        if (sRouteCompletionAction.equals("Promote Connected Object")) {
                            ...
                            for (int count = 0; count < objectlist.size(); count++) {
                                ...
                                // Modified for Bug No: 293332 and Bug no: 293506
                                MapList ObjectList = dObject.getRelatedObjects(context, sRelObjectRoute, typePattern.getPattern(), // "*",
                                ...
                                if (bPromoteObject == 1) {
                                    ...
                                    // DEC specific use-case, checking for the current state of the Object with the state we fetched before promoting the object.
                            ...
                            if (sObjectsNotSatisfied.equals("") && sRoutesInProcess.equals("")) {
                                ...
                                arguments[2] = "0";
                                // Bug # 335612 - modified below strig resource form emxFramework.ProgramObject.eServicecommonCompleteTask.MessageComplete to
                                // emxFramework.ProgramObject.eServicecommonCompleteTask.MessageCompletePromoteConnectedObject
            ...
            if (e.getMessage().toString().contains("promote business object failed")) {
                ...
                String strDateError = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", strLocale, "emxComponents.Common.PromoteConnectObjectFailed");
    ...
    private static void sendNotification(Context context, String sRouteActionOfTask, String ObjectId, String sRouteId, String sApprovalStatus, String sRouteName, String sLastName, String sFirstName,
            String sPerson, String sType, String sName, String sRev, String sRouteType, String sRouteRev, String sActualCompletionDate, String sComments) throws Exception {
        if ("Approve".equals(sRouteActionOfTask)) {
            if ("Reject".equals(sApprovalStatus)) {
