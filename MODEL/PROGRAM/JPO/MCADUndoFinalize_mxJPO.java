...
public class MCADUndoFinalize_mxJPO extends MCADUndoFinalizeBase_mxJPO {
    /**
     * Constructor.
     * @since Sourcing V6R2008-2
     */
    public MCADUndoFinalize_mxJPO() {
        super();
    }
     ...
     * @since Sourcing V6R2008-2
     */
    public MCADUndoFinalize_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
