...
public class emxReferenceDocumentBase_mxJPO extends emxProductFile_mxJPO {
     ...
     * @grade 0
     */
    public emxReferenceDocumentBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap having the following input arguments: Object ID relationship name
     * @return a MapList containing the list of the objetcs.
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-0-0-0
     */
    public MapList getRelatedDocuments(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Hashmap containing the relationship name.
    ...
    public MapList getWhereUsed(Context context, String[] args) throws Exception {
        ...
        String objectId = (String) documentMap.get("objectId");
        short level = 1;
        String actualRelnName = PropertyUtil.getSchemaProperty(context, relationshipName) + "," + PropertyUtil.getSchemaProperty(context, "relationship_FeaturesSpecification") + ","
                + PropertyUtil.getSchemaProperty(context, "relationship_ProductSpecification") + "," + PropertyUtil.getSchemaProperty(context, "relationship_BuildSpecification") + ","
                + PropertyUtil.getSchemaProperty(context, "relationship_RequirementSpecification");
        MapList relBusObjPageList = new MapList();
        StringList objectSelects = new StringList(DomainConstants.SELECT_ID);
        setId(objectId);
     ...
     * @since ProductCentral 10-0-0-0
     **/
    public MapList getWhereUsedSpecifications(Context context, String[] args) throws Exception {
        HashMap documentMap = (HashMap) JPO.unpackArgs(args);
        String relationshipName = PropertyUtil.getSchemaProperty(context, "relationship_FeaturesSpecification") + PropertyUtil.getSchemaProperty(context, "relationship_ProductSpecification")
                + PropertyUtil.getSchemaProperty(context, "relationship_BuildSpecification") + PropertyUtil.getSchemaProperty(context, "relationship_RequirementSpecification");
        String objectId = (String) documentMap.get("objectId");
        short level = 1;
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HaspMap containing the object id.
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing the parentid and parent relationship name.
    ...
    public String checkin(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String objectId = prodCtrlCommon.create(context, type, name, revision, description, policy, vault, attributeMap, owner, parentId, parentRelName, true);
            ...
            verDocObject.createAndConnect(context, DomainConstants.TYPE_VERSION_DOCUMENT, uniqueName, DomainConstants.RELATIONSHIP_VERSION, this, true);
