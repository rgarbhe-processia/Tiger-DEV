...
public class emxEngineeringECRMigrationFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO {
     ...
     * @grade 0
     */
    public emxEngineeringECRMigrationFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public void getIds(Context context, int chunkSize) throws Exception {
        ...
        String command = "temp query bus '" + TYPE_ECR + "' '" + name + "' '" + revision + "'  vault '" + vaultList + "' limit 1 where '" + whereClause + " && program[" + migrationProgramName
        ...
        try {
            MqlUtil.mqlCommand(context, "temp query bus $1 $2 $3 vault $4 limit $5 where $6", TYPE_ECR, name, revision, vaultList, "1",
