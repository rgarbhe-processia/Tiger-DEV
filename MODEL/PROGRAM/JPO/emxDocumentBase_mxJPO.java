...
public class emxDocumentBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public emxDocumentBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
        ...
        if (routeList.size() != 0) {
            ...
            try {
                while (routeItr.hasNext()) {
                    ...
                    DomainRelationship.connect(context, lastRev, RELATIONSHIP_OBJECT_ROUTE, (new DomainObject((String) map.get(SELECT_ID))));
                }
            } catch (Exception ex) {
                throw ex;
            } finally {
