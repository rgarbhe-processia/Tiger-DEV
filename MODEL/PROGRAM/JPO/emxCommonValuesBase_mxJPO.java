...
public class emxCommonValuesBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public Map getRangeValuesForGlobalCommonGroup(Context context, String[] args) throws Exception {
        ...
        List attributeDisplayRange = i18nNow.getAttrRangeI18NStringList(ConfigurationConstants.ATTRIBUTE_GLOBAL_COMMON_GROUP, (StringList) attributeRange, context.getSession().getLanguage());
    ...
    // //////////////////////////////////////////////////////////////////R212 Code//////////////////////////////////////////////////
    /**
     * This method is used to get Common Group values attached to the Common Values To display the "Common Group" column values in Config Option Table @param context the eMatrix <code>Context</code>
     * object @param args Contains String array containing all the required parameters @return Vector containing the Common Groups @exception Exception if operation fails @category
     */
    public Vector getCommonGroupColumnValues(Context context, String[] args) throws Exception {
        ...
        for (int iCnt = 0; iCnt < iNumOfObjects; iCnt++) {
            ...
            selectable.append("tomid[").append(ConfigurationConstants.RELATIONSHIP_COMMON_VALUES).append("].fromrel.id");
            ...
            if (strCGRelId != null && !"".equals(strCGRelId)) {
                ...
                if (strGlobalCG.equalsIgnoreCase("No")) {
                    ...
                    if (!strCGRelId.contains("|")) {
                        ...
                        selectable2.append("tomid[").append(ConfigurationConstants.RELATIONSHIP_CONTEXT_COMMON_GROUP).append("].from.id");
                        ...
                        while (strTokens.hasMoreTokens()) {
                            ...
                            selectable3.append("tomid[").append(ConfigurationConstants.RELATIONSHIP_CONTEXT_COMMON_GROUP).append("].from.id");
     ...
     *            the eMatrix <code>Context</code> object
     * @param strCGId
     *            Contains the Rel id of the Common Group
    ...
    /*
     * String strMqlCommand = "print connection \""+strCGId+"\" select frommid["+ConfigurationConstants.RELATIONSHIP_COMMON_VALUES+"].to."+DomainConstants.SELECT_ID+"  dump |"; String strCommonValues
     * = executeMqlCommand(context , strMqlCommand ) ; StringTokenizer strTokens = new StringTokenizer(strCommonValues,"|");
     * 
     * while(strTokens.hasMoreTokens()){ vecCommonValues.add((String)strTokens.nextToken()); } return vecCommonValues ; }
     */
        ...
        for (int i = 0; i < objectList.size(); i++) {
            ...
            if (exportToExcel && strName != null) {
                ...
                if (strType != null && !"".equals(strType) && strType.equals("CommonGroup")) {
                    sbBuffer = sbBuffer.append("<img src=\"../common/images/").append(strCommonGroupIcon).append("\" border=\"0\"  align=\"middle\" ").append("TITLE=\"").append(" ").append(i18CG)
                            .append("\"").append("/><B>").append(strName).append("</B>");
                    strName = sbBuffer.toString();

                } else if (strType != null && !"".equals(strType) && (strType.equals("CommonValues") || mxType.isOfParentType(context, strType, ConfigurationConstants.TYPE_LOGICAL_STRUCTURES))) {
                    ...
                    if (strType.equalsIgnoreCase(ConfigurationConstants.TYPE_SOFTWARE_FEATURE)
                    ...
                    if (!strObjId.contains("*") && !strObjId.contains("&")) {
                        ...
                        StringList sLRelSelect = new StringList(ConfigurationConstants.SELECT_TO_TYPE);
                        Hashtable htCGInfo = domRelId.getRelationshipData(context, sLRelSelect);
                        StringList toType = (StringList) htCGInfo.get(ConfigurationConstants.SELECT_TO_TYPE);
                    ...
                    sbBuffer = sbBuffer.append("<img src=\"../common/images/").append(strConfigurableFeatureIcon).append("\" border=\"0\"  align=\"middle\" ").append("TITLE=\"").append(" ")
                            .append(i18Title).append("\"").append("/><B>").append(strName).append("</B>");
                    strName = sbBuffer.toString();
                } else if (strType != null && !"".equals(strType) && mxType.isOfParentType(context, strType, ConfigurationConstants.TYPE_PRODUCTS)) {

                    sbBuffer = sbBuffer.append("<img src=\"../common/images/").append(strProductIcon).append("\" border=\"0\"  align=\"middle\" ").append("TITLE=\"").append(" ").append(i18CGContext)
                            .append("\"").append("/><B>").append(strName).append("</B>");
                    strName = sbBuffer.toString();
                }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            Contains String array containing all the required parameters
    ...
    public Vector getTypeInViewCGListPage(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < objectList.size(); i++) {
            ...
            if (!strObjId.contains("*") && !strObjId.contains("&")) {
                ...
                if (!strType.isEmpty())
                    strI18Type = ConfigurationUtil.geti18FrameworkString(context, strType);
            }
            ...
            if (!strConfRelId.contains("*") && !strConfRelId.contains("&")) {
                ...
                if (strDVName != null && !"".equals(strDVName)) {
                    if (exportToExcel) {
                        ...
                        sbBuffer = sbBuffer.append("<img src=\"../common/images/").append(strConfigurableFeatureIcon).append("\" border=\"0\"  align=\"middle\" ").append("TITLE=\"").append(" ")
                                .append(i18VariantOption).append(" ").append("\"").append("/>").append(strDVName);
    ...
    /**
     * This method is used to Get Common Group Visual Cue , It compares the Common Groups for the selected Design Variant & its immediate sub Technical Feature
     * @param context
     *            - Matrix Context Object
     * @param sLstDVIds
     *            - StringList of Design Variant IDs to be removed from the Context Logical Feature
     * @return bResult - boolean true - if the operation is Successful false - if the operation Fails
     * @throws FrameworkException
     * @since R212
     * @author IXH
     * @category NON API
    ...
    public Vector getCommonGroupVisualCueInViewDV(Context context, String[] args) throws Exception {
        ...
        sbBuffer = sbBuffer.append("<img src=\"../common/images/").append("iconStatusRed.gif").append("\" border=\"0\"  align=\"middle\" ").append("TITLE=\"").append(" ").append(strToolTipNoSubFCG)
                .append("\"").append("/>");

        String strREDVisualCue = sbBuffer.toString();
        sbBuffer.delete(0, sbBuffer.length());

        sbBuffer = sbBuffer.append("<img src=\"../common/images/").append("iconStatusYellow.gif").append("\"  border=\"0\"  align=\"middle\" ").append("TITLE=\"").append(" ")
                .append(strToolTipCommonSubFCG).append("\"").append("/>");
        String strYELLOWVisualCue = sbBuffer.toString();

        sbBuffer.delete(0, sbBuffer.length());
        sbBuffer = sbBuffer.append("<img src=\"../common/images/").append("iconStatusGreen.gif").append("\" border=\"0\"  align=\"middle\" ").append("TITLE=\"").append(" ")
                .append(strToolTipExactSubFCG).append("\"").append("/>");
        ...
        MapList subFeaturesMapList = logicalFeature.getLogicalFeatureStructure(context, sBufTypePattern.toString(), sBufRelPattern.toString(), slObjSelects, new StringList(), false, true, (int) 0,
                (int) 0, DomainObject.EMPTY_STRING, DomainObject.EMPTY_STRING, (short) 0, DomainObject.EMPTY_STRING);
        ...
        if (subFeaturesMapList.size() != 0) {
            for (int iCnt = 0; iCnt < subFeaturesMapList.size(); iCnt++) {
                ...
                if (strSubLogicalFeatureID != null && !"".equals(strSubLogicalFeatureID)) {
                    ...
                    mLDesignVariants = logicalFeat.getDesignVariants(context, typePattern.toString(), relPattern.toString(), objSelects, relSelects, false, true, iLevel, 0, objWhere, relWhere,
        ...
        for (int iCnt = 0; iCnt < objectList.size(); iCnt++) {
            ...
            if (!"".equals(strRelType) && strRelType != null && strRelType.equalsIgnoreCase(ConfigurationConstants.RELATIONSHIP_INACTIVE_VARIES_BY)) {
                ...
                if (!"".equals(strRelType) && strRelType != null && strRelType.equalsIgnoreCase(ConfigurationConstants.RELATIONSHIP_VARIES_BY)) {
                    ...
                    sbMqlCommand.append("print connection \"").append(strRelId).append(" select tomid[").append(ConfigurationConstants.RELATIONSHIP_INACTIVE_VARIES_BY).append(".fromrel[")
                            .append(ConfigurationConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST).append(".from.name dump |");
                    // String strMqlCommand =
                    // "print connection \""+strRelId+"\" select
                    // tomid["+ConfigurationConstants.RELATIONSHIP_INACTIVE_VARIES_BY+"].fromrel["+ConfigurationConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST+"].from.name dump |"
                    // ;
                ...
                if (!isInvalid) {
                    ...
                    if (mapListChildCGsActual.size() == 0) {
                        ...
                        if (iNoOfMatches > 0 && iNoOfPartialMatches == 0) {
                            if (iNoOfMatches == mapListChildCGsActual.size() && parentDVSet.containsAll(childDVSet) && childDVSet.containsAll(parentDVSet))
        ...
        if (objectList.size() != 0) {
            for (int iCnt = 0; iCnt < objectList.size(); iCnt++) {
                ...
                if (strVariesByRelId != null && !"".equals(strVariesByRelId)) {
                    CommonValues cgBean = new CommonValues();
                    strGlobalCommonGroupVal = cgBean.getGlobalCommonGroupAttributeValue(context, strVariesByRelId);

                    if (strGlobalCommonGroupVal != null && !("".equals(strGlobalCommonGroupVal))) {
                        attributeRange.addElement(strGlobalCommonGroupVal);
                        attributeDisplayRange = i18nNow.getAttrRangeI18NStringList(ConfigurationConstants.ATTRIBUTE_GLOBAL_COMMON_GROUP, attributeRange, context.getSession().getLanguage());
    ...
    /**
     * expand program called on expand of CG context, which will render the CG + CG's Options
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    public MapList getCommonGroupListInSB(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        if (strObjId.contains("&") || (strObjId.contains("*"))) {
            if (strObjId.contains("*")) {
                ...
                strRelId = cgBean.getVariesByRelId(context, strParentObjId, strObjId);

                String strGlobalCG = cgBean.getGlobalCommonGroupValue(context, strRelId);
                MapList mlCtxCGs = cgBean.getCommonGroups(context, strParentObjId, strObjId);

                if (strGlobalCG != null && !"".equals(strGlobalCG) && strGlobalCG.equalsIgnoreCase("No")) {
                    for (int iCnt = 0; iCnt < mlCtxCGs.size(); iCnt++) {
                        PdtCGInfo1 = (HashMap) mlCtxCGs.get(iCnt);
                        strCtxId = (String) PdtCGInfo1.get("Context Prod Id");
                        ...
                        if (strCtxId != null && !"".equals(strCtxId) && strCtxId.equals(strPdtId)) {
                            ...
                            map = new HashMap();
                            strCGId = (String) PdtCGInfo1.get("Common Group Id");
                            strCGName = (String) PdtCGInfo1.get("Common Group Name");
                            ...
                            Vector vecParentCVs = getCommonValuesDataForCG(context, strCGId);
                            for (int i = 0; i < vecParentCVs.size(); i++) {
                                strCGId = (String) ((Map) (vecParentCVs.get(i))).get("Common Group Id");
    ...
    /**
     * program which will render CG context, which will be root node in common group list page
     * @param context
     * @param args
     * @return
     * @throws FrameworkException
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public List getCommonGroupContextInCGListPage(Context context, String[] args) throws FrameworkException {
        MapList mapList = new MapList();
        ...
        try {
            ...
            if (strGlobalCG.equalsIgnoreCase("No")) {
                ...
                if (!slContextIds.isEmpty()) {
                    ...
                    MapList cgMapList = DomainObject.getInfo(context, (String[]) slContextIds.toArray(cgIDArray), slSelect);
                    Map mpofCG = null;
