...

{
     ...
     * @grade 0
     */
    public emxModelBasedMigrationFindPUEObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public void getIds(Context context, int chunkSize) throws Exception {
        ...
        try {
            ...
            String whereClause = "((policy == \"" + POLICY_PUE_ECO + "\") && (current != " + implement + ") && (current != " + cancelled + ") && program[" + migrationProgramName
