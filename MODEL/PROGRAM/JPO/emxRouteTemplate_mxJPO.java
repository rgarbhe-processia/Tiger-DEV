 ...
 */
public class emxRouteTemplate_mxJPO extends emxRouteTemplateBase_mxJPO {
     ...
     * @grade 0
     */
    public emxRouteTemplate_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
