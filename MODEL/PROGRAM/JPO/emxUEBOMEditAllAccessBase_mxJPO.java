...
public class emxUEBOMEditAllAccessBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @since x+4.
     */
    public emxUEBOMEditAllAccessBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    /**
     * This method returns true if emxUnresolvedEBOM.DisplayEBOMIndentedTable = true. Used to display the commands related to EBOM Indented Table
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     * @return Boolean.
