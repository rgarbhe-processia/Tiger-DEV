...
public class emxBooleanCompatibilityBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        ...
        if (!context.isConnected()) {
            String sContentLabel = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Error.UnsupportedClient", context.getSession().getLanguage());
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId" 1 - String containing the typeName which is used to find out whether the rule is a
     *            BCR.
     * @return List containing the Right Expressions for all the Rules loaded in the table (Full Name\Marketing Name is displayed based on user preference).
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-6-SP1
     * @grade 0 this could not be deprecated as referenced from migration JPO
     */
     ...
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId" 1 - String containing the typeName which is used to find out whether the rule is a
     *            BCR.
     * @return List containing the Right Expressions for all the Rules loaded in the table (format is Full Name with T::N::R).
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10-6-SP1
     * @grade 0 this could not be deprecated as referenced from migration JPO
     ...
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId" 1 - String containing the typeName which is used to find out whether the rule is a
     *            BCR. 2 - String containing the user preference for Rule Display (Full Name/ Marketing Name)
    ...
    public List getRightExpression(Context context, String[] args, String strRuleDisplay) throws Exception {
        ...
        if (strIsIntermediate != null && !("".equals(strIsIntermediate)) && !("null".equals(strIsIntermediate)) && strIsIntermediate.equals("true")) {
            if (!"null".equals(strRuleType) && !"".equals(strRuleType) && strRuleType != null && strRuleType.equalsIgnoreCase(ConfigurationConstants.TYPE_QUANTITY_RULE)) {
                ...
                lstRightExpression = getExpression(context, args1, strRuleType);
            } else {
                lstRightExpression = getExpression(context, args, ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION, strRuleDisplay);
            }
        } else {
            lstRightExpression = getProductRuleExpression(context, args, ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION, strRuleDisplay);
        }
    ...
    public List getExpressionForRule(Context context, String[] args, String strLeftRightExpr) throws Exception {
        ...
        if ((strRuleDisplayTemp == null) || (strRuleDisplayTemp.equals("null")) || (strRuleDisplayTemp.equals("")) || (strRuleDisplayTemp.equals(RULE_DISPLAY_FULL_NAME))) {
        ...
        try {
            ...
            for (int i = 0; i < expMapList.size(); i++) {
                ...
                if (strObjType.equalsIgnoreCase(ConfigurationConstants.TYPE_FEATURE_LIST)) {
                    ...
                    if (isRuleDisplayFullname) {
                        strExpressionbuffer = strExpressionbuffer.append(DOUBLE_QUOTE).append((String) mapExpression.get("to[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_FROM + "].from.type"))
                                .append(FEATURE_TNR_DELIMITER).append((String) mapExpression.get("attribute[" + ConfigurationConstants.ATTRIBUTE_PARENT_OBJECT_NAME + "]"))
                                .append(FEATURE_TNR_DELIMITER).append((String) mapExpression.get("to[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_FROM + "].from.revision"))
                                .append(C_FOPT_SEPERATOR).append((String) mapExpression.get("from[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO + "].to.type")).append(FEATURE_TNR_DELIMITER)
                                .append((String) mapExpression.get("attribute[" + ConfigurationConstants.ATTRIBUTE_CHILD_OBJECT_NAME + "]")).append(FEATURE_TNR_DELIMITER)
                                .append((String) mapExpression.get("from[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO + "].to.revision")).append(DOUBLE_QUOTE);
                        ...
                        strExpressionbuffer = strExpressionbuffer.append(DOUBLE_QUOTE).append((String) mapExpression.get("attribute[" + ConfigurationConstants.ATTRIBUTE_PARENT_MARKETING_NAME + "]"))
                                .append(C_FOPT_SEPERATOR).append((String) mapExpression.get("attribute[" + ConfigurationConstants.ATTRIBUTE_CHILD_MARKETING_NAME + "]")).append(DOUBLE_QUOTE);
                        map.put("ObjId", strObjId);
                        map.put("Expression", strExpressionbuffer.toString());
                        finalMap.add(map);
                    } else {
                        strExpressionbuffer = strExpressionbuffer.append(DOUBLE_QUOTE).append((String) mapExpression.get("attribute[" + ConfigurationConstants.ATTRIBUTE_PARENT_MARKETING_NAME + "]"))
                                .append(" ").append((String) mapExpression.get("to[" + ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_FROM + "].from.revision")).append(C_FOPT_SEPERATOR)
                                .append((String) mapExpression.get("attribute[" + ConfigurationConstants.ATTRIBUTE_CHILD_MARKETING_NAME + "]")).append(" ")
                    ...
                    if (isRuleDisplayFullname) {
                        strExpressionbuffer = strExpressionbuffer.append(DOUBLE_QUOTE).append((String) mapExpression.get(DomainConstants.SELECT_TYPE)).append(FEATURE_TNR_DELIMITER)
                                .append((String) mapExpression.get(DomainConstants.SELECT_NAME)).append(FEATURE_TNR_DELIMITER).append((String) mapExpression.get(DomainConstants.SELECT_REVISION))
                                .append(DOUBLE_QUOTE);
                        map.put("ObjId", strObjId);
                        map.put("Expression", strExpressionbuffer.toString());
                        finalMap.add(map);
                        ...
                        strExpressionbuffer = strExpressionbuffer.append(DOUBLE_QUOTE).append((String) mapExpression.get("attribute[" + ConfigurationConstants.ATTRIBUTE_MARKETING_NAME + "]"))
                                .append(DOUBLE_QUOTE);
                        map.put("ObjId", strObjId);
                        map.put("Expression", strExpressionbuffer.toString());
                        finalMap.add(map);
                        ...
                        strExpressionbuffer = strExpressionbuffer.append(DOUBLE_QUOTE).append((String) mapExpression.get("attribute[" + ConfigurationConstants.ATTRIBUTE_MARKETING_NAME + "]"))
                                .append(" ").append((String) mapExpression.get(DomainConstants.SELECT_REVISION))
                                // End - Changes for IR Mx376196
                                .append(DOUBLE_QUOTE);
                        map.put("ObjId", strObjId);
                        map.put("Expression", strExpressionbuffer.toString());
                    ...
                    // Bug 367399: Appended Marketing Name attribute Start Changes for IR Mx376196
                        ...
                        strExpressionbuffer = strExpressionbuffer.append(DOUBLE_QUOTE)
                                ...
                                .append((String) mapExpression.get("attribute[" + ConfigurationConstants.ATTRIBUTE_MARKETING_NAME + "]")).append(DOUBLE_QUOTE);
                        map.put("ObjId", strObjId);
                        map.put("Expression", strExpressionbuffer.toString());
                        finalMap.add(map);
                    } else {
            ...
            if (mapCGTokenIds.size() > 0) {
                ...
                for (int i = 0; i < objListCG.size(); i++) {
                    ...
                    strExpressionbuffer.append(DOUBLE_QUOTE).append("CommonGroup").append(FEATURE_TNR_DELIMITER).append(strObjId).append(DOUBLE_QUOTE);
                    map.put("ObjId", strObjId);
            ...
            for (int k = 0; k < strListLeftExpr.size(); k++) {
                ...
                for (int i = 0; i < tempList.size(); i++) {
                    ...
                    if (strTempToken.length() > 0
                            && !(strTempToken.equals(AND) || strTempToken.equals(OR) || strTempToken.equals(NOT) || strTempToken.equals(OPEN_ROUND_BRACE) || strTempToken.equals(CLOSE_ROUND_BRACE))) {
    ...
    /**
     * Method to reframe the Expression for the Product Compatibilty Rule object. This method is called by the methods getLeftExpression and getRightExpression
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
     * @param strRelType
     *            contains the relationship on which getRelated has to be fired (Left/Right Expression)
     * @param strRuleDisplay
     *            contains the user preference for Rule Display (Full Name/ Marketing Name)
     * @return List containing the Expressions for all the Rules loaded in the table.
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.6 this could not be deprecated as referenced from migration JPO
     */
    ...
    public List getProductRuleExpression(Context context, String[] args, String strRelType, String strRuleDisplay) throws Exception {
        ...
        if ((strRuleDisplay == null) || (strRuleDisplay.equals("null")) || (strRuleDisplay.equals("")) || (strRuleDisplay.equals(RULE_DISPLAY_FULL_NAME))) {
            ...
            strBuffer = strBuffer.append(STR_ATTRIBUTE).append(OPEN_BRACE).append(ConfigurationConstants.ATTRIBUTE_MARKETING_NAME).append(CLOSE_BRACE);
            lstObjectSelects.add(strBuffer.toString());
        }

        List lstRelationSelects = new StringList();
        strBuffer.delete(0, strBuffer.length());
        strBuffer = strBuffer.append(STR_ATTRIBUTE).append(OPEN_BRACE).append(ConfigurationConstants.ATTRIBUTE_TOKEN).append(CLOSE_BRACE);
        ...
        try {
            ...
            for (int i = 0; i < iNumOfObjects; i++) {
                ...
                MapList lstTNR = dom.getRelatedObjects(context, strRelType, DomainConstants.QUERY_WILDCARD, (StringList) lstObjectSelects, (StringList) lstRelationSelects, false, true, (short) 1, "",
                        "", 0);
                ...
                for (int j = 0; j < lstTNR.size(); j++) {
                    ...
                    if (((String) mpTNR.get(strBuffer.toString())).trim().equals("")) {
                        if ((strRuleDisplay == null) || (strRuleDisplay.equals("null")) || (strRuleDisplay.equals("")) || (strRuleDisplay.equals(RULE_DISPLAY_FULL_NAME))) {
                            strBuffer.delete(0, strBuffer.length());
                            strBuffer = strBuffer.append(DOUBLE_QUOTE).append((String) mpTNR.get(DomainConstants.SELECT_TYPE)).append(FEATURE_TNR_DELIMITER)
                                    .append((String) mpTNR.get(DomainConstants.SELECT_NAME)).append(FEATURE_TNR_DELIMITER).append((String) mpTNR.get(DomainConstants.SELECT_REVISION))
                                    .append(DOUBLE_QUOTE).append(SPACE);
    ...
    /**
     * Method to reframe the Expression for the Rule object. This method is called by the methods getLeftExpression and getRightExpression
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId" 1 - String containing the typeName which is used to find out whether the rule is a
                        ...
                        if (arrStr[j].indexOf("R") != -1) {
                            ...
                            if (strIsIntermediate != null && strIsIntermediate.equals("true")) {
                                if ((strRuleDisplay == null) || (strRuleDisplay.equals("null")) || (strRuleDisplay.equals("")) || (strRuleDisplay.equals(RULE_DISPLAY_FULL_NAME))) {
                                    if (strType.contains("CommonGroup")) {
                                        strBuffer = strBuffer.append(DOUBLE_QUOTE).append(strType).append(FEATURE_TNR_DELIMITER).append(strObjId).append(DOUBLE_QUOTE);
                            ...
                            if (strIsIntermediate != null && strIsIntermediate.equals("true")) {
                                if ((strRuleDisplay == null) || (strRuleDisplay.equals("null")) || (strRuleDisplay.equals("")) || (strRuleDisplay.equals(RULE_DISPLAY_FULL_NAME))) {
                                    if (strType.equalsIgnoreCase(ConfigurationConstants.TYPE_FEATURE_LIST)) {
                                        ...
                                        MapList mapList = (MapList) domObj.getRelatedObjects(context, strRelationType, DomainConstants.QUERY_WILDCARD, (StringList) lstObjectSel,
                                                (StringList) lstRelationSel, true, true, (short) 1, "", "", 0);
                                        ...
                                        strBuffer = strBuffer.append(DOUBLE_QUOTE).append(strFLFromType).append(FEATURE_TNR_DELIMITER).append(strFLFromName).append(FEATURE_TNR_DELIMITER)
                                                .append(strFLFromRev).append(C_FOPT_SEPERATOR).append(strFLToType).append(FEATURE_TNR_DELIMITER).append(strFLToName).append(FEATURE_TNR_DELIMITER)
                                                .append(strFLToRev).append(DOUBLE_QUOTE);
                                        if (j < arrStr.length - 1) {
                                            strBuffer.append(SPACE);
                                        }
                                    } else if (mxType.isOfParentType(context, strType, ConfigurationConstants.TYPE_FEATURES)) {
                                        strBuffer = strBuffer.append(DOUBLE_QUOTE).append(strType).append(FEATURE_TNR_DELIMITER).append(strName).append(FEATURE_TNR_DELIMITER).append(strRev)
                                                .append(DOUBLE_QUOTE);
                                    ...
                                    strBuffer1.append(STR_ATTRIBUTE).append(OPEN_BRACE).append(ConfigurationConstants.ATTRIBUTE_MARKETING_NAME).append(CLOSE_BRACE);
                                    ...
                                    if (strType.contains(ConfigurationConstants.TYPE_FEATURE_LIST)) {
                                        ...
                                        strBuffer = strBuffer.append(DOUBLE_QUOTE).append(strFLFromMarketingName).append(C_FOPT_SEPERATOR).append(strFLToMarketingName).append(DOUBLE_QUOTE);
                                        if (j < arrStr.length - 1) {
                                            strBuffer.append(SPACE);
                                        }
                                    } else if (mxType.isOfParentType(context, strType, ConfigurationConstants.TYPE_FEATURES)) {
                                        String strFOPTMarketingName = domObj.getInfo(context, strMarketName);
                                        strBuffer = strBuffer.append(DOUBLE_QUOTE).append(strFOPTMarketingName).append(DOUBLE_QUOTE);

                                    } else if (mxType.isOfParentType(context, strType, ConfigurationConstants.TYPE_PRODUCTS)) {
                                        strBuffer = strBuffer.append(DOUBLE_QUOTE).append(strName).append(DOUBLE_QUOTE);
                                    }
                                    ...
                                    if (strType.contains(ConfigurationConstants.TYPE_FEATURE_LIST)) {
                                        ...
                                        String strFOPTMarketingName = domObj.getInfo(context, strMarketName);
                                        strBuffer = strBuffer.append(DOUBLE_QUOTE).append(strFOPTMarketingName).append(" " + strRev).append(DOUBLE_QUOTE);
                                    } else if (mxType.isOfParentType(context, strType, ConfigurationConstants.TYPE_PRODUCTS)) {
                                        strBuffer = strBuffer.append(DOUBLE_QUOTE).append(domObj.getInfo(context, strMarketName)).append(SPACE).append(strRev).append(DOUBLE_QUOTE);
                                    }
                            ...
                            // Hence we can construct the TNR directly.
                                ...
                                // Start changes for IR Mx376196
                                    ...
                                    strMarketingName = domObj.getAttributeValue(context, ConfigurationConstants.ATTRIBUTE_MARKETING_NAME);
                                    strLeftExpression.append(strMarketingName).append(" " + domObj.getInfo(context, ConfigurationConstants.SELECT_REVISION));
    ...
    public List getExpression(Context context, String[] args, String strRuleType) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < iNumOfObjects; i++) {
                ...
                strMQLCommand = "print bus \"" + arrObjId[i] + "\" select from[" + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].toall from["
                        + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].attribute[" + ConfigurationConstants.ATTRIBUTE_SEQUENCE_ORDER + "].value dump |;";
                        ...
                        if (strIsIntermediate != null && strIsIntermediate.equals("true")) {
                            ...
                            if ((strRuleDisplay == null) || (strRuleDisplay.equals("null")) || (strRuleDisplay.equals("")) || (strRuleDisplay.equals(RULE_DISPLAY_FULL_NAME))) {
                                ...
                                if (strType.contains(ConfigurationConstants.TYPE_FEATURE_LIST)) {
                                    ...
                                    MapList mapList = (MapList) dom1.getRelatedObjects(context, strRelationType, DomainConstants.QUERY_WILDCARD, (StringList) lstObjectSel, (StringList) lstRelationSel,
                                            true, true, (short) 1, "", "", 0);
                                    ...
                                    strBuffer = strBuffer.append(DOUBLE_QUOTE).append(strFLFromType).append(FEATURE_TNR_DELIMITER).append(strFLFromName).append(FEATURE_TNR_DELIMITER)
                                            .append(strFLFromRev).append(C_FOPT_SEPERATOR).append(strFLToType).append(FEATURE_TNR_DELIMITER).append(strFLToName).append(FEATURE_TNR_DELIMITER)
                                            .append(strFLToRev).append(DOUBLE_QUOTE).append(SPACE);
                                } else if (mxType.isOfParentType(context, strType, ConfigurationConstants.TYPE_FEATURES)) {
                                    strBuffer = strBuffer.append(DOUBLE_QUOTE).append(strType).append(FEATURE_TNR_DELIMITER).append(strName).append(FEATURE_TNR_DELIMITER).append(strRev)
                                            .append(DOUBLE_QUOTE);
                                    ...
                                    strBuffer = strBuffer.append(DOUBLE_QUOTE).append(strType).append(FEATURE_TNR_DELIMITER).append((String) mpTNR.get(DomainConstants.SELECT_ID)).append(DOUBLE_QUOTE)
                                            .append(SPACE);
                                }
                                ...
                                if (strType.contains(ConfigurationConstants.TYPE_FEATURE_LIST)) {
                                    ...
                                    strBuffer = strBuffer.append(DOUBLE_QUOTE).append(strFLFromMarketingName).append(C_FOPT_SEPERATOR).append(strFLToMarketingName).append(DOUBLE_QUOTE).append(SPACE);
                                } else if (mxType.isOfParentType(context, strType, ConfigurationConstants.TYPE_FEATURES)) {
    ...
    public List getExpression(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < iNumOfObjects; i++) {
                ...
                MapList lstTNR = dom.getRelatedObjects(context, strRelType, DomainConstants.QUERY_WILDCARD, (StringList) lstObjectSelects, (StringList) lstRelationSelects, false, true, (short) 1, "",
                        "", 0);
                strMQLCommand = "print bus \"" + arrObjId[i] + "\" select from[" + strRelType + "].toall from[" + strRelType + "].attribute[" + ConfigurationConstants.ATTRIBUTE_SEQUENCE_ORDER
                        + "].value dump |;";
                strRes = MqlUtil.mqlCommand(context, strMQLCommand);
                StringTokenizer strTokenCGIds = new StringTokenizer(strRes, "|");
                int iTotalNoOfRecords = strTokenCGIds.countTokens();
                ...
                for (int j = 0; j < lstTNR.size(); j++) {
                    ...
                    if (((String) mpTNR.get(strBuffer.toString())).trim().equals("")) {
                        ...
                        if (strIsIntermediate != null && strIsIntermediate.equals("true")) {
                            ...
                            if ((strRuleDisplay == null) || (strRuleDisplay.equals("null")) || (strRuleDisplay.equals("")) || (strRuleDisplay.equals(RULE_DISPLAY_FULL_NAME))) {
                                ...
                                if (mxType.isOfParentType(context, strType, ConfigurationConstants.TYPE_PRODUCTS)
                                    ...
                                    strBuffer = strBuffer.append("B").append(strObjID).append(SPACE);
                                } else if (strType.contains("CommonGroup")) {

                                    strBuffer = strBuffer.append("R").append(strObjID).append(SPACE);
                                }
                                strLeftExpression.append(strBuffer.toString());
                        ...
                        // Hence we can construct the TNR directly.
                            ...
                            strBuffer = strBuffer.append("B").append((String) mpTNR.get(DomainConstants.SELECT_ID)).append(SPACE);
                            strLeftExpression.append(strBuffer.toString());
    ...
    /**
     * Wrapper method to display the Right Expression value in BCR List Page Called from Table Column settings
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * Wrapper method to display the Left Expression value in BCR List Page Called from Table Column settings
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * Wrapper method to display the Right Expression value in PCR List Page Called from Table Column settings
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * Wrapper method to display the Left Expression value in PCR List Page Called from Table Column settings
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * This method is used to return inclusion/exclusion Rule Expression. @param context the eMatrix <code>Context</code> object @param args holds arguments @return List @throws Exception if the
     * operation fails @since R212 @author IXH @category
     */
    public List showInclusionRuleExpression(Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < objectList.size(); i++) {
            ...
            Object slRuleTypeObj = (Object) objectMap.get("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.type");
            slRuleType = ConfigurationUtil.convertObjToStringList(context, slRuleTypeObj);
            int iRuleIndex = -1;
            ...
            if (iRuleIndex != -1) {
                Object slREsObjects = (Object) objectMap.get(ConfigurationConstants.SELECT_ATTRIBUTE_RIGHT_EXPRESSION);
                StringList slREs = new StringList();
                slREs = ConfigurationUtil.convertObjToStringList(context, slREsObjects);
    ...
    public MapList getProductCompatibilityRules(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            // string
            List lstProductChildTypes = ProductLineUtil.getChildrenTypes(context, ConfigurationConstants.TYPE_PRODUCTS);
            ...
            List allObjList = dom.getRelatedObjects(context, strRelationshipType, ConfigurationConstants.TYPE_PRODUCTS, false, true, (short) 0, (StringList) lstobjectSelects, null,
                    DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, sbBuffer.toString(), null);
            ...
            stbBuffer = stbBuffer.append(STR_ATTRIBUTE).append(OPEN_BRACE).append(ConfigurationConstants.ATTRIBUTE_COMPARISION_OPERATOR).append(CLOSE_BRACE);
            ...
            stbBuffer = stbBuffer.append(STR_ATTRIBUTE).append(OPEN_BRACE).append(ConfigurationConstants.ATTRIBUTE_COMPATIBILITY_OPTION).append(CLOSE_BRACE);
            lstObjectSelects.add(stbBuffer.toString());

            StringBuffer stbTemp = new StringBuffer(50);
            stbTemp = stbTemp.append(ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION).append(COMMA).append(ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION);
            ...
            for (int k = 0; k < allObjList.size(); k++) {
                ...
                mapBusIds = domContextBus.getRelatedObjects(context, stbTemp.toString(), ConfigurationConstants.TYPE_PRODUCT_COMPATIBILITY_RULE, (StringList) lstObjectSelects,
                        (StringList) lstRelSelects, true, false, (short) 1, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, (short) 0, DomainObject.CHECK_HIDDEN,
                        DomainObject.PREVENT_DUPLICATES, (short) DomainObject.PAGE_SIZE, null, null, null, DomainObject.EMPTY_STRING, null, DomainObject.FILTER_ITEM);
    ...
    public StringList excludeConnectedBCR(Context context, String[] args) throws Exception {
        ...
        MapList objectList = confUtil.getObjectStructure(context, ConfigurationConstants.TYPE_BOOLEAN_COMPATIBILITY_RULE, ConfigurationConstants.RELATIONSHIP_BOOLEAN_COMPATIBILITY_RULE, objSelects,
                relSelects, false, true, (short) 1, 0, objWhere, relWhere, DomainObject.FILTER_ITEM, filterExpression);
        ...
        if (type.equalsIgnoreCase("Logical Feature")) {
            ...
            MapList objectListForLF = confUtil.findObjects(context, ConfigurationConstants.TYPE_BOOLEAN_COMPATIBILITY_RULE, DomainConstants.QUERY_WILDCARD, objWhere, objSelects);
    ...
    /**
     * Method to get all the BCR objects connected to the product from the data base.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getBooleanCompatibilityRules(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            StringList relationsSelects = new StringList(DomainObject.SELECT_RELATIONSHIP_ID);
            ConfigurationUtil contextObj = new ConfigurationUtil(objectId);
            booleanCompatibilityMapList = contextObj.getObjectStructure(context, ConfigurationConstants.RELATIONSHIP_BOOLEAN_COMPATIBILITY_RULE, ConfigurationConstants.TYPE_BOOLEAN_COMPATIBILITY_RULE,
                    objectSelects, relationsSelects, false, true, 1, 0, DomainObject.EMPTY_STRING, DomainObject.EMPTY_STRING, DomainObject.FILTER_ITEM, DomainObject.EMPTY_STRING);
        } catch (Exception e) {
    ...
    public MapList getValidProductsForPCR(Context context, String[] args) throws Exception {
        ...
        relBusObjPageList = dom.getRelatedObjects(context, strRelName, strTypeName, objectSelects, relSelects, false, true, sLevel, strObjWhere, "", strlimit);
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getAllProductCompatibilityRules(Context context, String[] args) throws Exception {
        Map ProductCompatibilityMap = (HashMap) JPO.unpackArgs(args);
        Map mapTemp = new HashMap();
        ...
        DomainObject dom = newInstance(context, strObjectId);
        /*
         * List allObjList = dom.getRelatedObjects( context, strRelationshipType, DomainConstants.QUERY_WILDCARD, false, true, (short) 0, (StringList)lstobjectSelects, null,
         * DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, sbBuffer.toString(), null);
         */

        List allObjList = dom.getRelatedObjects(context, strRelationshipType, // relationshipPattern
        ...
        for (int k = 0; k < allObjList.size(); k++) {
            ...
            /*
             * mapBusIds = domObject.getRelatedObjects( context, stbTemp.toString(), ConfigurationConstants.TYPE_PRODUCT_COMPATIBILITY_RULE, (StringList)lstObjectSelects,
             * DomainConstants.EMPTY_STRINGLIST, true, false, (short) 1, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
             */

            mapBusIds = domObject.getRelatedObjects(context, stbTemp.toString(), // relationshipPattern
    ...
    /**
     * Method to validate and display the validation result of the Product Compatibility Rules connected to the product.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing one String entry for key "objectId"
    ...
    public List getProductValidationResult(Context context, String[] args) throws Exception {
        ...
        String strReportFormat = (String) ((Map) mapProductCompatibility.get("paramList")).get("reportFormat");
        // End of Add for Bug# 299871
        String strMode = (String) ((Map) mapProductCompatibility.get("paramList")).get("mode");
        String strObjectId = DomainConstants.EMPTY_STRING;
        if ((strMode != null) && !("".equals(strMode)) && !("null".equals(strMode))) {
            if (strMode.equals("ListPage")) {
                strObjectId = (String) ((Map) mapProductCompatibility.get("paramList")).get("emxTableRowId");
            }
        } else {
            strObjectId = (String) ((Map) mapProductCompatibility.get("paramList")).get("objectId");
        }

        // String is initialized to store the value of relationship name
        StringBuffer sbBuffer = new StringBuffer(200);
        /*
         * sbBuffer.append(ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO); sbBuffer.append(COMMA); sbBuffer.append(ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_FROM); String
         * strRelationshipType = sbBuffer.toString(); -- changing for R212 schema
         */
        ...
        // Create a domainobject and get the products in the product structure
        /*
         * DomainObject dom = newInstance(context, strObjectId); List allObjList = dom.getRelatedObjects( context, strRelationshipType, DomainConstants.QUERY_WILDCARD, false, true, (short) 0,
         * (StringList)lstobjectSelects, null, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, sbBuffer.toString(), null);
         */
        int iLevel = 0;
        ...
        List allObjList = confUtil.getObjectStructure(context, sbBuffer.toString(), strRelationshipType, lstobjectSelects, new StringList(ConfigurationConstants.SELECT_RELATIONSHIP_ID), false, true,
                iLevel, limit, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, DomainObject.FILTER_STR_AND_ITEM, filterExpression);
        ...
        sbBuffer.delete(0, sbBuffer.length());
        sbBuffer = sbBuffer.append(STR_ATTRIBUTE).append(OPEN_BRACE).append(ConfigurationConstants.ATTRIBUTE_COMPARISION_OPERATOR).append(CLOSE_BRACE);
        String strCompOperatorkey = sbBuffer.toString();

        sbBuffer.delete(0, sbBuffer.length());
        sbBuffer = sbBuffer.append(STR_ATTRIBUTE).append(OPEN_BRACE).append(ConfigurationConstants.ATTRIBUTE_COMPATIBILITY_OPTION).append(CLOSE_BRACE);
        ...
        for (int i = 0; i < iNumOfObjects; i++) {
            ...
            if (obj instanceof HashMap) {
                arrstrObjId[i] = (String) ((HashMap) lstObjectIdsList.get(i)).get(DomainConstants.SELECT_ID);
                lstCompOperator.add((String) ((HashMap) lstObjectIdsList.get(i)).get(strCompOperatorkey));
                lstCompOption.add((String) ((HashMap) lstObjectIdsList.get(i)).get(strCompOptionkey));
            } else if (obj instanceof Hashtable) {
                arrstrObjId[i] = (String) ((Hashtable) lstObjectIdsList.get(i)).get(DomainConstants.SELECT_ID);
                lstCompOperator.add((String) ((Hashtable) lstObjectIdsList.get(i)).get(strCompOperatorkey));
                lstCompOption.add((String) ((Hashtable) lstObjectIdsList.get(i)).get(strCompOptionkey));
            }

            // get the left expression and right expression object ids
            lstLeftExpIds = ConfigurableRulesUtil.getObjectIdsFromExpression(context, (String) lstLeftExp.get(i));
            lstRightExpIds = ConfigurableRulesUtil.getObjectIdsFromExpression(context, (String) lstRightExp.get(i));

            // processing for requires operator
            if (lstCompOperator.get(i).equals(ConfigurationConstants.RANGE_VALUE_REQUIRES)) {
                ...
                if (containsIds(lstLeftExpIds, allObjList) || lstLeftExpIds.contains(strObjectId)) {
                    ...
                    if (bIsPresent == false) {
                        strMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Rules.Message.Missing", strLanguage);
            ...
            if (lstCompOperator.get(i).equals(ConfigurationConstants.RANGE_VALUE_CODEPENDENT)) {
            ...
            if (lstCompOperator.get(i).equals(ConfigurationConstants.RANGE_VALUE_COMPATIBLE) || lstCompOperator.get(i).equals(ConfigurationConstants.RANGE_VALUE_INCOMPATIBLE)) {
                // Left expression contains context object
                if (containsIds(lstLeftExpIds, allObjList) || lstLeftExpIds.contains(strObjectId)) {
                    boolean bIsLowerRevPresent;
                    // processing for upward option
                    if (lstCompOption.get(i).equals(ConfigurationConstants.RANGE_VALUE_UPWARD)) {
                        bIsPresent = false;
                        ...
                        for (int j = 0; j < lstRightExpIds.size(); j++) {
                            lstRev = getRevisionIndex(context, (String) lstRightExpIds.get(j), allObjList);
                            if (isHigherRevPresentInList(context, (String) lstRightExpIds.get(j), lstRev, lstFailedTNR)) {
                                bIsPresent = true;
                            }
                        }
                        // add the reason for failure
                        if (bIsPresent == true && lstCompOperator.get(i).equals(ConfigurationConstants.RANGE_VALUE_INCOMPATIBLE)) {
                            strMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Rules.Message.HigherRevPresent", strLanguage);
                        ...
                        for (int j = 0; j < lstRightExpIds.size(); j++) {
                            lstRev = getRevisionIndex(context, (String) lstRightExpIds.get(j), allObjList);
                            if (isLowerRevPresentInList(context, (String) lstRightExpIds.get(j), lstRev, lstFailedTNR)) {
                                bIsLowerRevPresent = true;
                            }
                        }
                        // add the reason for failure
                        if (bIsLowerRevPresent == true && lstCompOperator.get(i).equals(ConfigurationConstants.RANGE_VALUE_COMPATIBLE)) {
                            ...
                            for (int m = 0; m < lstFailedTNR.size(); m++) {
                                if (lstRightExpIds.contains((String) lstFailedTNR.get(m))) {
                                    ...
                                    strFailedTNR = FrameworkUtil.findAndReplace(strFailedTNR, strPresent, DomainConstants.EMPTY_STRING);
                                }
                            }
                            if (!strFailedTNR.equals("")) {
                                strMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Rules.Message.LowerRevPresent", strLanguage);
                                lstFinalResult.add(strMessage + removeDuplicate(context, strFailedTNR));
                            }
                        }
                        strFailedTNR = DomainConstants.EMPTY_STRING;
                    ...
                    if (lstCompOption.get(i).equals(ConfigurationConstants.RANGE_VALUE_DOWNWARD)) {
                        bIsPresent = false;
                        bIsLowerRevPresent = false;
                        List lstRev = new StringList();
                        // check whether lower revisions of the products in RE are
                        ...
                        // add the reason for failure
                        if (bIsPresent == true && lstCompOperator.get(i).equals(ConfigurationConstants.RANGE_VALUE_COMPATIBLE)) {
                            // check if any of the failed objects are present in the expression
                            // if so remove it from the failed objects.
                            String strPresent = DomainConstants.EMPTY_STRING;
                            for (int m = 0; m < lstFailedTNR.size(); m++) {
                        ...
                        // add the reason for failure
                        if (bIsLowerRevPresent == true && lstCompOperator.get(i).equals(ConfigurationConstants.RANGE_VALUE_INCOMPATIBLE)) {
                            strMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Rules.Message.LowerRevPresent", strLanguage);
                            lstFinalResult.add(strMessage + removeDuplicate(context, strFailedTNR));
                        }
                        strFailedTNR = DomainConstants.EMPTY_STRING;
                    ...
                    if (lstCompOption.get(i).equals(ConfigurationConstants.RANGE_VALUE_NONE)) {
                        bIsPresent = true;
                        ...
                        for (int j = 0; j < lstRightExpIds.size(); j++) {
                            ...
                            List lstRev = getRevisionIndex(context, (String) lstRightExpIds.get(j), allObjList);
                            ...
                            if (lstRev.size() > 1) {
                                ...
                                for (int k = 0; k < lstRev.size(); k++) {
                                    if ((((String) lstRightExpIds.get(j)).equals(((String) ((Map) lstRev.get(k)).get(DomainConstants.SELECT_ID)))))
                                        lstRev.remove(k);
                                }
                                strMsg = strMsg + processList(context, lstRev);
                            } else if (lstRev.size() == 1) {
                                if (!(((String) lstRightExpIds.get(j)).equals(((String) ((Map) lstRev.get(0)).get(DomainConstants.SELECT_ID))))) {
                                    bIsPresent = false;
                                    if (strRuleDisplay.equals(ConfigurationConstants.RULE_DISPLAY_FULL_NAME)) {
                        ...
                        // add the reason for failure
                        if (bIsPresent == false && lstCompOperator.get(i).equals(ConfigurationConstants.RANGE_VALUE_COMPATIBLE)) {
                            strMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Rules.Message.SpecificCompatible", strLanguage);
                            lstFinalResult.add(strMessage + removeDuplicate(context, strMsg));
                        } else if (bInComp == true && lstCompOperator.get(i).equals(ConfigurationConstants.RANGE_VALUE_INCOMPATIBLE)) {
                            strMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Rules.Message.SpecificIncompatible", strLanguage);
                    ...
                    if (lstCompOption.get(i).equals(ConfigurationConstants.RANGE_VALUE_ALL)) {
                        ...
                        // add the reason for failure
                        if (bIsPresent == false && lstCompOperator.get(i).equals(ConfigurationConstants.RANGE_VALUE_INCOMPATIBLE)) {
                            strMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Rules.Message.AllIncompatible", strLanguage);
                            lstFinalResult.add(strMessage + removeDuplicate(context, strMsg));
                        }
                    }
                }
            ...
            if (lstFinalResult.size() == i) {
                strMessage = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "emxProduct.Rules.Message.Pass", strLanguage);
    ...
    public List getLeftExpression(Context context, String[] args, String strRuleDisplay) throws Exception {
        ...
        List lstLeftExpression = new StringList();
        if (strIsIntermediate != null && !("".equals(strIsIntermediate)) && !("null".equals(strIsIntermediate)) && strIsIntermediate.equals("true")) {
            lstLeftExpression = getExpression(context, args, ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION, strRuleDisplay);
        } else {
            lstLeftExpression = getProductRuleExpression(context, args, ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION, strRuleDisplay);
        }
        return lstLeftExpression;
    }
    ...
    public String processIdforFullName(Context context, String strId) throws Exception {
        ...
        sbTemp = sbTemp.append(STR_NEWLINE).append((String) mapInfo.get(DomainConstants.SELECT_TYPE)).append(FEATURE_TNR_DELIMITER).append((String) mapInfo.get(DomainConstants.SELECT_NAME))
                .append(FEATURE_TNR_DELIMITER).append((String) mapInfo.get(DomainConstants.SELECT_REVISION));
    ...
    public String processIdforMarketingName(Context context, String strId) throws Exception {
        ...
        DomainObject domObj = newInstance(context, strId);
        strMarketingName = domObj.getAttributeValue(context, ConfigurationConstants.ATTRIBUTE_MARKETING_NAME);
        sbTemp = sbTemp.append(STR_NEWLINE).append(strMarketingName);
        return sbTemp.toString();
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param strElement
     *            holds string to be checked for duplicates.
    ...
    private String removeDuplicate(Context context, String strElement) throws Exception {
        ...
        while (strTok.hasMoreTokens()) {
            ...
            if (!lstTemp.contains(strTemp)) {
                lstTemp.add(strTemp);
                stbTemp.append("<BR>").append(strTemp).append("</BR>");
            }
        }
     ...
     * @param lstTobeSeached
     *            holds the Product ids of all the products under the context product
    ...
    public List getRevisionIndex(Context context, String strElement, List lstTobeSeached) throws Exception {
        // initialise maps
        Map mapTemp;
        Map mapInfo;
        ...
        for (int i = 0; i < lstTemp.size(); i++) {
            ...
            for (int j = 0; j < lstTobeSeached.size(); j++) {
                if (((String) ((Map) lstTobeSeached.get(j)).get(DomainConstants.SELECT_ID)).equals((String) mapTemp.get(DomainConstants.SELECT_ID))) {
    ...
    /**
     * Method to check whether a higher revision of the product is present in the given List.
     * @param strElement
     *            holds the Product id
     * @param lstTobeSeached
     *            holds the list of Product ids.
     * @return boolean
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.6
    ...
    public boolean isHigherRevPresentInList(Context context, String strElement, List lstTobeSeached, List lstFailedTNR) throws Exception {
        boolean bPresent = isRevPresentInList(context, strElement, lstTobeSeached, true, lstFailedTNR);
        return bPresent;
    }

    /**
     * Method to check whether a higher or lower revision of the product is present in the given List.
     * @param strElement
     *            holds the Product id
     * @param lstTobeSeached
     *            holds the list of Product ids.
     * @param bHigher
     *            determines whether to look for higher or lower revisions
     * @return boolean
     * @throws Exception
     *             if the operation fails
     * @since ProductCentral 10.6
    ...
    public boolean isRevPresentInList(Context context, String strElement, List lstTobeSeached, boolean bHigher, List lstFailedTNR) throws Exception {
        boolean bPresent = false;
        ...
        for (int i = 0; i < lstTobeSeached.size(); i++) {
            if (strElement.equals((String) ((Map) lstTobeSeached.get(i)).get(DomainConstants.SELECT_ID))) {
        ...
        for (int i = 0; i < lstTobeSeached.size(); i++) {
            ...
            if (bHigher) {
                ...
                if (Integer.parseInt(strPos1) <= Integer.parseInt(strPos2)) {
                    DomainObject domObj = newInstance(context, (String) ((Map) lstTobeSeached.get(i)).get(DomainConstants.SELECT_ID));
                    mapInfo = domObj.getInfo(context, (StringList) lstobjectSelects);
                    sbTemp = sbTemp.append(STR_NEWLINE).append((String) mapInfo.get(DomainConstants.SELECT_TYPE)).append(FEATURE_TNR_DELIMITER)
                            .append((String) mapInfo.get(DomainConstants.SELECT_NAME)).append(FEATURE_TNR_DELIMITER).append((String) mapInfo.get(DomainConstants.SELECT_REVISION));
                    if (iFound == 0) {
    ...
    /**
     * Method to check whether a lower revision of the product is present in the given List.
     * @param strElement
     *            holds the Product id
     * @param lstTobeSeached
     *            holds the list of Product ids.
    ...
    public boolean isLowerRevPresentInList(Context context, String strElement, List lstTobeSeached, List lstFailedTNR) throws Exception {
        boolean bPresent = isRevPresentInList(context, strElement, lstTobeSeached, false, lstFailedTNR);
        return bPresent;
    }

    /**
     * Method to process a List containing object ids so as to return a string in the form of T::N::R.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param lstRev
    ...
    public String processList(Context context, List lstRev) throws Exception {
        ...
        for (int i = 0; i < lstRev.size(); i++) {
            ...
            DomainObject domObj = newInstance(context, strTemp);
            mapInfo = domObj.getInfo(context, (StringList) lstobjectSelects);
            sbTemp = sbTemp.append(STR_NEWLINE).append((String) mapInfo.get(DomainConstants.SELECT_TYPE)).append(FEATURE_TNR_DELIMITER).append((String) mapInfo.get(DomainConstants.SELECT_NAME))
                    .append(FEATURE_TNR_DELIMITER).append((String) mapInfo.get(DomainConstants.SELECT_REVISION));
        }
    ...
    public List getCompatibilityOption(Context context, String[] args) throws Exception {
        ...
        strBuffer = strBuffer.append(STR_ATTRIBUTE).append(OPEN_BRACE).append(ConfigurationConstants.ATTRIBUTE_COMPARISION_OPERATOR).append(CLOSE_BRACE);

        String strCompOperator = strBuffer.toString();

        strBuffer.delete(0, strBuffer.length());

        strBuffer = strBuffer.append(STR_ATTRIBUTE).append(OPEN_BRACE).append(ConfigurationConstants.ATTRIBUTE_COMPATIBILITY_OPTION).append(CLOSE_BRACE);
        ...
        for (int i = 0; i < iNumOfObjects; i++) {
            ...
            if (obj instanceof HashMap) {
                ...
                strCompOper = i18nNow.getRangeI18NString(ConfigurationConstants.ATTRIBUTE_COMPATIBILITY_OPTION, (String) ((HashMap) pcrObjectIdsList.get(i)).get(strCompOption), strLocale);
                strCompOpt = i18nNow.getRangeI18NString(ConfigurationConstants.ATTRIBUTE_COMPARISION_OPERATOR, (String) ((HashMap) pcrObjectIdsList.get(i)).get(strCompOperator), strLocale);
                strBuffer.delete(0, strBuffer.length());
                strBuffer.append(XSSUtil.encodeForHTML(context, strCompOper)).append(SPACE).append(XSSUtil.encodeForHTML(context, strCompOpt));
                lstCmpOption.add(strBuffer.toString());
            } else if (obj instanceof Hashtable) {
                strCompOper = i18nNow.getRangeI18NString(ConfigurationConstants.ATTRIBUTE_COMPATIBILITY_OPTION, (String) ((Hashtable) pcrObjectIdsList.get(i)).get(strCompOption), strLocale);
                strCompOpt = i18nNow.getRangeI18NString(ConfigurationConstants.ATTRIBUTE_COMPARISION_OPERATOR, (String) ((Hashtable) pcrObjectIdsList.get(i)).get(strCompOperator), strLocale);
                strBuffer.delete(0, strBuffer.length());
                strBuffer.append(XSSUtil.encodeForHTML(context, strCompOper)).append(SPACE).append(XSSUtil.encodeForHTML(context, strCompOpt));
                lstCmpOption.add(strBuffer.toString());
    ...
    /**
     * This method is used to return inclusion/exclusion Rule Expression. @param context the eMatrix <code>Context</code> object @param args holds arguments @return List @throws Exception if the
     * operation fails @since R212 HF16 @author @category
     */
