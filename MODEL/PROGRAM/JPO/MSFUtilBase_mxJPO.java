...
public class MSFUtilBase_mxJPO {
    ...
    public String getInstalledProducts(Context context, String[] args) {
        ...
        try {
            ...
            String strOutput = MqlUtil.mqlCommand(context, strCommand, "eServiceSystemInformation.tcl", ",");
    ...
    /**
     * To add specific filter on a projectType admin needs to override this method and write similar code tip: Copy paste this function in MSFUtil JPO, uncomment the sample code and add your required
     * selectable for the required type Added selectable will be suppressed from Synchronization
     */
    public StringList GetExcludedAttributeMappings(String type) {
        StringList attrList = new StringList();

        /*
         * switch(type) { case "CustomProjectSpace1": attrList.addElement("CustomAttribute1"); attrList.addElement("CustomAttribute2"); break;
         * 
         * case "CustomProjectSpace2": attrList.addElement("CustomAttribute3"); attrList.addElement("CustomAttribute4"); break; }
         */
