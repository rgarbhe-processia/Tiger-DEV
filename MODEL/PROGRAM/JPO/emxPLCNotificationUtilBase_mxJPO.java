 ...
 * @version Variant Configuration R207 - Copyright (c) 2008-2015 Dassault Systemes.
 * @since PLC R207
 */
public class emxPLCNotificationUtilBase_mxJPO {
    ...
    /**
     * This trigger method creates a mail notification when a feature or a product is added as an affected item to an engineering change via the EC Affected Item relationship.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId - the Id for the To side object for the EC Affected Item relationship notificationName - PLCEngineeringChangeRaisedEvent toType - the
     *            type for the To side object for the EC Affected Item relationship A notification is generated only if the object is of a child type of Products or Features.
    ...
    /**
     * This trigger method creates a mail notification when a feature or a product is added an issue via the Issue relationship.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId - the Id for the To side object for the Issue relationship notificationName - PLCIssueRaisedEvent toType - the type for the To side
     *            object for the Issue relationship fromType - the type for the From side object for the Issue relationship A notification is generated only if the From side object is of type Issue
     *            and the To side object is of a child type of Products or Features.
     * @return an int 0 status code
     * @throws Exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId - the Id of the product that has a new product version just created notificationName - PLCProductVersionEvent toType - the type for the
     *            To side object for the Product Version relationship A notification is generated only if the To side object is not of type Product Variant.
     * @return an int 0 status code
     * @throws Exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId - the Id of the product that has a new product variant just created notificationName - PLCProductVariantEvent toType - the type for the
     *            To side object for the Product Version relationship A notification is generated only if the To side object is of type Product Variant.
     * @return an int 0 status code
     * @throws Exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId - the Id of the product that is going to revised/derived notificationName - PLCProductDerivationEvent toType - the type for the To side
     *            object for the Main Derived relationship fromType-the type for the From side object for the Main Derived relationship A notification is generated only if the To side and From side
     *            object is type of PRODUCTS.
     * @return an int 0 status code
     * @throws Exception
     *             if the operation fails
     */
    public static int notifyOnPLCProductRevisionEvent(Context context, String[] args) throws Exception {
        ...
        String toType = args[2];
        String fromType = args[3];
        if ((toType == null || toType.trim().length() == 0) && (fromType == null || fromType.trim().length() == 0)) {
            throw (new IllegalArgumentException());
        }

        // Generate the notification if the To side object is not of type
        // Product
        if ((mxType.isOfParentType(context, toType, ProductLineConstants.TYPE_PRODUCTS)) && (mxType.isOfParentType(context, fromType, ProductLineConstants.TYPE_PRODUCTS))) {
            emxNotificationUtil_mxJPO notificationUtil = new emxNotificationUtil_mxJPO(context, args);
            result = notificationUtil.objectNotification(context, args);
        }
     ...
     * @param args
     *            holds the following input arguments: objectId - the Id of the product that is going to revised/derived notificationName - PLCProductDerivationEvent toType - the type for the To side
     *            object for the Derived relationship fromType-the type for the From side object for the Derived relationship A notification is generated only if the To side and From side object is
     *            type of PRODUCTS.
     * @return an int 0 status code
     * @throws Exception
     *             if the operation fails
