...
public class emxEngineeringUtilBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @since EC 10.0.0.0.
     */
    public emxEngineeringUtilBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
     ...
     *            the eMatrix <code>Context</code> object.
     * @param args
     *            holds the following input arguments. 0 - from id (objectId of organization). 1 - to id (objectId of object).
    ...
    public int DesignResponsibilityDisconnectCheck(matrix.db.Context context, String[] args) throws Exception {
        try {
            ...
            // added for bug no 317781
            if (nameList.contains(personName) || personName.equals(PropertyUtil.getSchemaProperty(context, "person_UserAgent")) || PersonUtil.hasAssignment(context, ROLE_SUPPLIER)
                    || PersonUtil.hasAssignment(context, ROLE_SUPPLIER_REPRESENTATIVE) || PersonUtil.hasAssignment(context, ROLE_BUYER) || PersonUtil.hasAssignment(context, ROLE_BUYER_ADMINISTRATOR))
            // till here
            {
                // fix for bug 317972
                ContextUtil.pushContext(context);
                ...
                emxContextUtil_mxJPO.mqlError(context, EngineeringUtil.i18nStringNow(context, "emxEngineeringCentral.RDO.MsgNotRDOMemberToModify", context.getSession().getLanguage()));
                return 1;
            }
        } catch (Exception ex) {
            throw (ex);
    ...
    /**
     * Gets the Organizations connected to Engineering Objects like ECO, ECR, Part, Specification with the relationship Design Responsibility. This is used in the display of properties page of these
     * objects, normally called from Webform.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
     ...
     * @since 10.6.
     */
    public String getRDOs(Context context, String[] args) throws Exception {
            ...
            while (mapItr.hasNext()) {
                ...
                if ("edit".equalsIgnoreCase(strMode)) {
                    ...
                    if (strAccess.equalsIgnoreCase("TRUE")) {
                        ...
                        strBufRDONamesForView.append("<a href=\"javascript:showNonModalDialog(\'" + URLToShow + "\',700,600,false)\">");
    ...
    /**
     * Gets the Organizations connected to Engineering Objects like ECO, ECR, Part, Specification with the relationship Change Responsibility. This is used in the display of properties page of these
     * objects, normally called from Webform.
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param args
    ...
    public String getChangeResponsibility(Context context, String[] args) throws Exception {
        ...
        organizationList = getRelatedObjects(context, RELATIONSHIP_CHANGE_RESPONSIBILITY, "*", ObjectSelectsList, relSelectList, true, true, (short) 1, DomainConstants.EMPTY_STRING,
                DomainConstants.EMPTY_STRING);
        ContextUtil.popContext(context);// Modified for Project Space issue
            ...
            while (mapItr.hasNext()) {
                ...
                if ("edit".equalsIgnoreCase(strMode)) {
                    ...
                    if (strAccess.equalsIgnoreCase("TRUE")) {
                        ...
                        strBufChangeResponsibilityNamesForView.append("<a href=\"javascript:showNonModalDialog(\'" + URLToShow + "\',700,600,false)\">");
    ...
    public static HashMap updateRDOField(Context context, String args[]) throws Exception {
        ...
        if (fieldValues != null) {
            ...
            if (sECOName != null && !"".equals(sECOName)) {
                String result = MqlUtil.mqlCommand(context, "print bus $1 $2 $3 select $4 $5 $6 dump $7", "ECO", sECOName, "-", "id", fromId, fromName, "|");
    ...
    public String getRDEDynamicSearchQuery(Context context, String[] args) throws Exception {
        ...
        String fieldName = fieldValuesMap.containsKey("DesignResponsibilityOID") ? "DesignResponsibilityOID" : "ChangeResponsibilityOID";

        String editFieldName = fieldValuesMap.containsKey("RDOOID") ? "RDOOID" : "ChangeResponsibilityOID";
        ...
        // IR-155395
        String fields = DomainConstants.TYPE_PROJECT_SPACE.equals(objDR.getInfo(context, DomainConstants.SELECT_TYPE)) ? "MEMBER_ID=" + orgId + ":USERROLE=role_SeniorDesignEngineer"
                : "PROJECT_ROLE=role_SeniorDesignEngineer" + orgId;
        // IR-155395
        return fields;
        // 89733
    }
    ...
    public String getRMEDynamicSearchQuery(Context context, String[] args) throws Exception {
        ...
        Map fieldValuesMap = (HashMap) programMap.get("fieldValues");
        String editMode = (String) ((HashMap) programMap.get("requestMap")).get("mode");
        String orgId = "edit".equalsIgnoreCase(editMode) ? (String) fieldValuesMap.get("RDOOID") : (String) fieldValuesMap.get("DesignResponsibilityOID");
        DomainObject objDR = new DomainObject(orgId);
        // 89733
        // return "MEMBER_ID="+orgId+":USERROLE=role_SeniorManufacturingEngineer";
        // IR-155395
        String fields = DomainConstants.TYPE_PROJECT_SPACE.equals(objDR.getInfo(context, DomainConstants.SELECT_TYPE)) ? "MEMBER_ID=" + orgId + ":USERROLE=role_SeniorManufacturingEngineer"
                : "PROJECT_ROLE=role_SeniorManufacturingEngineer" + orgId;
        // IR-155395
        return fields;
        // 89733
    }
    ...
    public String getECOToReleaseSearchQuery(Context context, String[] args) throws Exception {
        ...
        // Modified for RDO Convergence start
        String orgId = "";
        orgId = fieldValuesMap.containsKey("DesignResponsibility") ? (String) fieldValuesMap.get("DesignResponsibility") : (String) fieldValuesMap.get("RDO");
    ...
    public void updateRouteObject(Context context, String[] args) throws Exception {
        ...
        if (newRelationship != null) {
            ...
            newRelationship.setAttributeValue(context, DomainConstants.ATTRIBUTE_ROUTE_BASE_PURPOSE,
    ...
    private StringBuffer getCloneOptions(Context context, DomainObject domPartObj, StringList list, Map keyLabel) throws Exception {
        ...
        sbHTMLOutPut.append("</td>");
        // IR-402417:Add vertical spacing
        sbHTMLOutPut.append("<td style=\"width:30px\"/>");
        sbHTMLOutPut.append("<td>");
        ...
        for (int i = 0, size = list.size(); i < size; i++) {
            ...
            strChecked = (RELATIONSHIP_EBOM.equals(strChkBoxValue) || RELATIONSHIP_REFERENCE_DOCUMENT.equals(strChkBoxValue)) ? " checked=\"true\"" : "";
            ...
            if (null != domPartObj && domPartObj.isKindOf(context, EngineeringConstants.TYPE_MANUFACTURING_PART)) {
                strChecked = (RELATIONSHIP_REFERENCE_DOCUMENT.equals(strChkBoxValue)) ? " checked=\"true\"" : "";
            } else {
                strChecked = (RELATIONSHIP_EBOM.equals(strChkBoxValue) || RELATIONSHIP_REFERENCE_DOCUMENT.equals(strChkBoxValue)) ? " checked=\"true\"" : "";
            }
            // Modified for To Create Multiple part from Part Clone end
            if (null != domPartObj && domPartObj.isKindOf(context, EngineeringConstants.TYPE_MANUFACTURING_PART)
                    && (strChkBoxValue.equals(DomainConstants.RELATIONSHIP_EBOM) || strChkBoxValue.equals(DomainConstants.RELATIONSHIP_COMPONENT_SUBSTITUTION)
            ...
            sbHTMLOutPut.append("<tr>");
            sbHTMLOutPut.append("<td>");
            sbHTMLOutPut.append("<input type=\"checkbox\" name=\"CloneOptions\" value=\"").append(XSSUtil.encodeForHTMLAttribute(context, strChkBoxValue)).append("\" ")
                    .append("onclick=\"javascript:collectSelectedValues(this)\"").append(strChecked).append("/>").append(list.get(i));
            sbHTMLOutPut.append("</td>");
            sbHTMLOutPut.append("</tr>");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the String arrat containing the Param Map
    ...
    public MapList getHostCompanyMemebers(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            while (itr.hasNext()) {
                Map m = (Map) itr.next();
                String result = MqlUtil.mqlCommand(context, "print person $1 select assignment dump", (String) m.get(DomainConstants.SELECT_NAME));
    ...
    public MapList getDynamicColumnforBOMImport(Context context, String[] args) throws Exception {
        ...
        Map columnIndexMap = (Map) requestMap.get("columnIndexMap");
        Map columnMappings = (Map) requestMap.get("columnMappings");
        StringList columns = (StringList) requestMap.get("Columns");
        /*
         * StringList staticList = new StringList(); staticList.add("type"); staticList.add("policy"); staticList.add("revision"); staticList.add("level"); staticList.add("Series");
         */
    ...
    private StringList getDataForThisKey(Context context, MapList list, String key) throws Exception {
        ...
        while (itr.hasNext()) {
            ...
            if (UIUtil.isNullOrEmpty(strTemp)) {
                // to support basics
                strTemp = (String) map.get(key.toLowerCase());
    ...
    public StringList applyStyles(Context context, String args[]) throws Exception {
        ...
        while (itr.hasNext()) {
            ...
            if (map.containsKey("HighlightColumns")) {
                ...
                if (sl != null && sl.contains(columnName.toLowerCase())) {
    ...
    public boolean hideLifecycleRMBCommand(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
    ...
    public String getRDEDynamicSearchQueryForPUEECO(Context context, String[] args) throws Exception {
        ...
        /*
         * Retrieve the Organization and crate a match string based on <Role> . <Organization> . <Project> Note : All Project are considered therefore the *
         */
    ...
    public boolean hideReportsCommand(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
