...
public class emxUtilBase_mxJPO {
    ...
    /**
     * This utility method gets list of property names as an input and returns ArrayList of admin names.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    /**
     * This utility method gets list of property names of policy and states as an input and returns ArrayList of state names.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds an array of Strings
    ...
    /**
     * This utility method gets mql command as an input and returns ArrayList of results after executing mql command.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: i - a String contains command
     * @return an ArrayList object
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * This utility method gets key and base property file name as an input and returns internationalized string.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - a String contains baseFileName value 1 - a String contains a key
     * @return a String
     * @throws Exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: userName - a String of the person name propertyName - a String of the property name
     * @return an int: 0 for success and non-zero for failure
     * @throws Exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains no args, null could be passed
     * @throws Exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains all field values, uiType, and language string
     ...
     * @param context
     * @param args
     *            String array of length 4 args[0] -> adminType args[1] -> adminName args[2] -> propertyName args[3] -> propertyValue e.g. {"person", "Test Everything", "IconMailLanguagePreference",
     *            "en"}
    ...
    public static String getPrimaryImageURL(Context context, String[] args, String sOID, String sFormat, String sMCSURL, String sDefaultImage) throws Exception {
        ...
        busSelects.add("to[Image Holder].from.format[" + sFormat + "].file");
        DomainObject.MULTI_VALUE_LIST.add("to[Image Holder].from.format[" + sFormat + "].file");
        ...
        StringList sFormatFileName = (StringList) mData.get("to[Image Holder].from.format[" + sFormat + "].file");
        boolean fromPrimaryImage = true;
        ...
        if (null != sOIDImageHolder) {
            ...
            if (!sFormat.equals("generic") && sFormatFileName != null && fromPrimaryImage) {
                String primImageName = sFileName.substring(0, sFileName.lastIndexOf("."));
                if (sFormatFileName != null) {
                    for (int i = 0; i < sFormatFileName.size(); i++) {
                        String curImage = (String) sFormatFileName.get(i);
                        if (curImage.contains(primImageName + ".")) {
                            sFileName = primImageName + curImage.substring(curImage.lastIndexOf("."), curImage.length());
                            break;
                        }
                    }
                }
            ...
            try {
                ...
                sResult = "../common/images/brokenimage.png";
            }
        }
    ...
    public Map reloadTypes(Context context, String[] args) throws Exception {
        ...
        String sTypes = MqlUtil.mqlCommand(context, "print type " + sRootType + " select derivative.abstract");
        String sHidden = MqlUtil.mqlCommand(context, "print type " + sRootType + " select derivative.hidden");
