...
/*
 * emxEngineeringECOMigration.java program migrates the data into Common Document model i.e. to 10.5 schema.
 *
...
public class emxEngineeringECOMigration_mxJPO extends emxEngineeringECOMigrationBase_mxJPO {
     ...
     * @grade 0
     */
    public emxEngineeringECOMigration_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
