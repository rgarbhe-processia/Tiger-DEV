...
/**
 * The <code>${CLASSNAME}</code> class extends the Base JPO that is used to generate HTML code for the business type column on business type list page for display rule.
...
public class emxTableDCObjectsStandard_mxJPO extends emxTableDCObjectsStandardBase_mxJPO {
     ...
     * @since AEF 10.0.1.0
     */
    public emxTableDCObjectsStandard_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
