...
public class emxMetricsWebReportsBase_mxJPO {
    ...
    public emxMetricsWebReportsBase_mxJPO(Context context, String[] args) throws Exception {
        // super(context, args);
    }
    ...
    /**
     * This method serves a generic purpose of building a MapList of WebReport Objects and their information based on the user selected filter.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
     * @param webReportList
     *            holds the list of webreport Names after
     * @param reportType
     *            of the webreport filtering
     * @return MapList contains list of WebReports
     * @throws Exception
     *             if the operation fails
     */

    private MapList buildActualMapList(Context context, String[] args, WebReportList webReportList, MapList sharedList, String reportType) throws Exception {
    ...
    public MapList getOwnedWebReports(Context context, String[] args) throws Exception {
        MapList webReportMapList = new MapList();
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getSharedWebReports(Context context, String[] args) throws Exception {
        MapList webReportMapList = new MapList();
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getAllWebReports(Context context, String[] args) throws Exception {
        MapList webReportMapList = new MapList();
        MapList sharedMapList = new MapList();
        WebReport webReport = null;
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: webReportList contains a MapList of Maps which contains object names
    ...
    /**
     * This method gets the WebReport object's Last Executed Time to populate the Last Run Column of the table.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: webReportList contains a MapList of Maps which contains object names
    ...
    public Vector getLastRun(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList webReportList = (MapList) programMap.get(OBJECT_LIST);
        Vector vReport = new Vector(webReportList.size());
     ...
     *            the Ematrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: contains the name of the webreport
    ...
    public Vector getCompletedIn(Context context, String[] args) throws Exception {
        WebReport webReport = null;
        String strDuration = "";
        String reportName = "";
        Vector vReport = null;
    ...
    /**
     * This method gets the WebReport object's Execution Time to populate the Completed-In Column of the table. WebReportList contains a MapList of Maps which contains object names
     * @return String containing the time taken to run a webreport.
     * @throws Exception
     *             if the operation fails
     */

    public static String getCorrectedFormat(String seconds) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: webReportList contains a MapList of Maps which contains objects count.
    ...
    public Vector getWebReportRadioButton(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList webReportList = (MapList) programMap.get(OBJECT_LIST);
        Vector vReport = new Vector(webReportList.size());
        String finalResult = "";
    ...
    public static Boolean refreshAccess(Context context, String[] args) throws Exception {
    ...
    public static Boolean showPieChart(Context context, String[] args) throws Exception {
        // Define a boolean to return
    ...
    public static Boolean showStackBarChart(Context context, String[] args) throws Exception {
        // Define a boolean to return
        Boolean bChartAccess = Boolean.valueOf(false);
        HashMap requestMap = (HashMap) JPO.unpackArgs(args);
    ...
    public static Boolean showTabularFormat(Context context, String[] args) throws Exception {
        // Define a boolean to return
        Boolean bChartAccess = Boolean.valueOf(false);
        HashMap requestMap = (HashMap) JPO.unpackArgs(args);
    ...
    public static Boolean showBarChart(Context context, String[] args) throws Exception {
        // Define a boolean to return
        Boolean bChartAccess = Boolean.valueOf(false);
        HashMap requestMap = (HashMap) JPO.unpackArgs(args);
        ...
        try {
            ...
            if (strSupportedFormats != null) {
                ...
                if (iIndex != -1 && (iIndex == 0 || strSupportedFormats.charAt(iIndex - 1) != 'k')) {
                    bChartAccess = Boolean.valueOf(true);
                }
            }
        } catch (Exception e) {
    ...
    public static Boolean showLineChart(Context context, String[] args) throws Exception {
        // Define a boolean to return
        Boolean bChartAccess = Boolean.valueOf(false);
        HashMap requestMap = (HashMap) JPO.unpackArgs(args);
