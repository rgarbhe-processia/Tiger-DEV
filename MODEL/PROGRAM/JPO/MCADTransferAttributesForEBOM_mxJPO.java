...
public class MCADTransferAttributesForEBOM_mxJPO {
    ...
    private void transferAttrToCADObject(Context _context, String partObjId, String busObjId, boolean isBusOnFromSide, String instanceName, Hashtable atrMappingTable) throws Exception {
        String atrVal = null;
        String fromAtrName;
        String toAtrName = "";
