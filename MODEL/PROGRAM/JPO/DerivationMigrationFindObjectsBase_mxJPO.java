...
/**
 * The <code>DerivationMigrationFindObjectsBase</code> class contains implementation code for list out all the Models in the system. This is the very first step of Migration.
...
public class DerivationMigrationFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO {
     ...
     */
    public DerivationMigrationFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
