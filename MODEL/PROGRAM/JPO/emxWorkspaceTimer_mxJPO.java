 ...
 */
public class emxWorkspaceTimer_mxJPO extends emxWorkspaceTimerBase_mxJPO {
     ...
     * @since AEF Rossini
     */
    public emxWorkspaceTimer_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
