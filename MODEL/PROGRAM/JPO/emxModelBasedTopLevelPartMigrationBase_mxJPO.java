...
public class emxModelBasedTopLevelPartMigrationBase_mxJPO extends emxCommonMigration_mxJPO {
     ...
     * @grade 0
     */
    public emxModelBasedTopLevelPartMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public void migrateObjects(Context context, StringList objectIdList) throws Exception {
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                MqlUtil.mqlCommand(context, "modify connection $1 from $2", AssignedPartRel, ModelObjID);
