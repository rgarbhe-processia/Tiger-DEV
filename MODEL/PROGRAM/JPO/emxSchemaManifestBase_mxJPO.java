...
public class emxSchemaManifestBase_mxJPO {
    ...
    // admin list
    private static final String ADMIN_LIST[] = { "store", "vault", "dimension", "attribute", "type", "relationship", "interface", "format", "person", "group", "role", "association", "expression",
            "policy", "rule", "index", "application", "package", };
     ...
     * @since AEF 10.Next
     */
    public emxSchemaManifestBase_mxJPO(Context context, String[] args) throws Exception {
     ...
     * @since AEF 10.Next
     */
    public void loadSchemaListFile(Context context, File xmlFile) throws Exception {
        // Get content
     ...
     * @since AEF 10.Next
     */
    public ArrayList getSymbolicNames(Context context, String sAdminType, String sCustomDir) throws Exception {
    ...
    public HashMap loadSDFFiles(Context context, String sSDFDir) throws Exception {
    ...
    public void installSchema(Context context, String sCustomManifestDir, String sCustomSDFDir) throws Exception {
        ...
        for (int i = 0; i < aVersions.size(); i++) {
            ...
            for (int ii = 0; ii < ADMIN_LIST.length; ii++) {
                ...
                // present in database
                if (ADMIN_LIST[ii].equals("interface") || ADMIN_LIST[ii].equals("type") || ADMIN_LIST[ii].equals("relationship") || ADMIN_LIST[ii].equals("role") || ADMIN_LIST[ii].equals("group")
                        || ADMIN_LIST[ii].equals("person") || ADMIN_LIST[ii].equals("assignment") || ADMIN_LIST[ii].equals("policy") || ADMIN_LIST[ii].equals("application")) {
    ...
    public void installSchema(Context context, String[] args) throws Exception {
        // get MODE
