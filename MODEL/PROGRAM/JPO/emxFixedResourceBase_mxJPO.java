...
public class emxFixedResourceBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public MapList getAllFixedResources(Context context, String[] args) throws Exception {
        ...
        fixedResourcesMapList = domParentId.getRelatedObjects(context, strRelPattern, strObjPattern, objSelects, relSelects, true, true, sRecurse, "", "", 0);
    ...
    public Vector getMaxValues(Context context, String[] args) throws Exception {
     ...
     * @grade 0
     */
    public Vector getMinValues(Context context, String[] args) throws Exception {
    ...
    public Vector getInitialValues(Context context, String[] args) throws Exception {
    ...
    public Vector getCommentValues(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - HashMap containing Maplist of object ids
     * @param strAttributeName
     *            - Holds the attribute name for which the html needs to be formed
     * @param strAttributeSelect
     *            - Holds the select expression for the attribute
     * @return Object - Vector containing the Textboxes having the maximum valued of the Fixed Resources
     * @throws Exception
     *             if the operation fails
    ...
    public Boolean editDetailsLinkDisplay(Context context, String[] args) throws Exception {
        ...
        if (strType.equals(ProductLineConstants.TYPE_FIXED_RESOURCE)) {
            ...
            Map mapFeatureInfo = getRelatedObject(context, strRelationshipType, false, objectSelects, null);
            DomainObject obj = DomainObject.newInstance(context, (String) mapFeatureInfo.get(DomainConstants.SELECT_ID));

            List lstAssignees = obj.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_ASSIGNED_FEATURE, "*", objectSelects, null, true, false, (short) 1, "", "", 0);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments: 1:Relationship Id. 2:Feature Id.
     ...
     * @grade 0
     */
    public boolean getEditLink(Context context, String[] args) throws Exception {
        boolean hasAccess = editDetailsLinkDisplay(context, args).booleanValue();
    ...
    /*
     * This method is used to update the value of the Resource Usage attribute during the edit all of resource usage.
     * 
    ...
    public void updateResourceUsageUsage(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            DomainRelationship.setAttributeValue(context, strRelId, ProductLineConstants.ATTRIBUTE_RESOURCE_USAGE, strNewVal);
        } catch (Exception e) {
    ...
    /*
     * This method is used to update the value of the Resource Operation attribute during the edit all of resource usage.
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args holds no arguments
    ...
    public void updateResourceUsageOperation(Context context, String[] args) throws Exception {
        ...
        try {
            // Set the context to the super user
            ContextUtil.pushContext(context, PropertyUtil.getSchemaProperty(context, "person_UserAgent"), DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
            DomainRelationship.setAttributeValue(context, strRelId, ProductLineConstants.ATTRIBUTE_RESOURCE_OPERATION, strNewVal);
        } catch (Exception e) {
            throw new FrameworkException(e);
        } finally {
            // Set the context back to the context user
    ...
    public MapList getAllSearchResourceRule(Context context, String[] args) throws Exception {
        ...
        String strRelPattern = ProductLineConstants.RELATIONSHIP_RESOURCE_LIMIT;
        MapList fixedResourcesMapList = new MapList();
        fixedResourcesMapList = domainObject.getRelatedObjects(context, strRelPattern, strObjPattern, objSelects, relSelects, true, true, sRecurse, "", "");
        return fixedResourcesMapList;
    }
    ...
    public MapList getAllFixedResourcesForEditAll(Context context, String[] args) throws Exception {
        ...
        fixedResourcesMapList = domParentId.getRelatedObjects(context, strRelPattern, strObjPattern, objSelects, relSelects, true, true, sRecurse, "", buffer.toString(), 0);
    ...
    public MapList getAllFixedResourcesInUsage(Context context, String[] args) throws Exception {
        ...
        MapList mLConfigFeatureRelId = PL.queryConnection(context, ConfigurationConstants.RELATIONSHIP_RESOURCE_USAGE, RelationshipSelect, sLRelationshipWhere.toString());
    ...
    public Vector getFeatureOptionPairsCoulumnInTable(Context context, String[] args) throws Exception {
    ...
    public StringList excludeConnectedFixedResourceRule(Context context, String[] args) throws Exception {
        ...
        MapList objectList = confUtil.getObjectStructure(context, ConfigurationConstants.TYPE_FIXED_RESOURCE, ConfigurationConstants.RELATIONSHIP_RESOURCE_LIMIT, objSelects, relSelects, false, true,
                (short) 1, 0, objWhere, relWhere, DomainObject.FILTER_ITEM, filterExpression);
