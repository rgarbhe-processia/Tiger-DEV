...
public class emxKeyUtil_mxJPO {
     ...
     * @grade 0
     */
    private static synchronized String generateKey(Context context) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - attribute alias Name string ex:attribute_PrimaryKey
     * @returns nothing
     * @throws Exception
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - fromObjectId String ex:${FROMOBJECTID} 1 - toObjectId String ex:${TOOBJECTID}
     * @returns nothing
     * @throws Exception
     *             if the operation fails
     * @since Common 10.0.0.0
    ...
    /**
     * this method copy the primary key attribute from FromObject to secondary Keys attribute of ToObject
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - fromObjectId String ex:${FROMOBJECTID} 1 - toObjectId String ex:${TOOBJECTID}
    ...
    /**
     * this method copy the primary key attribute of ToObject to secondary Keys attribute of FromObject
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - fromObjectId String ex:${FROMOBJECTID} 1 - toObjectId String ex:${TOOBJECTID}
    ...
    /**
     * this method remove the primary key attribute of FromObject from secondary Keys attribute of ToObject
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - fromObjectId String ex:${FROMOBJECTID} 1 - toObjectId String ex:${TOOBJECTID}
    ...
    /**
     * this method remove the primary key attribute of ToObject from secondary Keys attribute of FromObject
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - fromObjectId String ex:${FROMOBJECTID} 1 - toObjectId String ex:${TOOBJECTID}
    ...
    /**
     * this method set the primary key attribute of creating object from
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - fromObjectId String ex:${FROMOBJECTID} 1 - toObjectId String ex:${TOOBJECTID}
    ...
    /**
     * This method set the primary key of the Company as Admin property of person on connect with employee relationship
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - companyId String 1 - personId String
     * @returns nothing
     * @throws Exception
     *             if the operation fails
     * @since Common 10.0.0.0
