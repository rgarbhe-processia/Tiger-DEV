...
/**
 * IEFReplaceObjectsOption.java Copyright Dassault Systemes, 1992-2007. All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systemes and its subsidiaries,
...
public class IEFReplaceObjectsOption_mxJPO {
    ...
    private String createDesignObject(String designName, BusinessObject templateObject, Relationship relObject, String integrationName, Context context, MCADMxUtil util,
            MCADGlobalConfigObject globalConfigObject) throws Exception {
        String designObjID = "";
