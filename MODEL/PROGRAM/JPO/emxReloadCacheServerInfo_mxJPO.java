...
/**
 * The <code>emxReloadCacheServerInfo</code> class extends the base class that contains code for properties to remotely reload cache.
...
public class emxReloadCacheServerInfo_mxJPO extends emxReloadCacheServerInfoBase_mxJPO {
     ...
     * @since AEF Rossini
     */
    public emxReloadCacheServerInfo_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);

        /*
         * Follwing is the example for configuring remote App server List: APP_SERVER_LIST = new String[] { "http://myserver1:7001/ematrix", "http://myserver2:7001/ematrix" };
         */
        ...
        /*
         * Follwing is the example for configuring RMI Gateway Server List: RMI_SERVER_LIST = new String[] { "//myserver01:1100", "//myserver01:1101" };
         */
