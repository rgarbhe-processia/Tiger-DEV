...
public class emxEnhancedSearchBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public emxEnhancedSearchBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public Object getSearchResults(Context context, String[] args) throws Exception {
        ...
        try {
            // createdBefore
            if (!(createdBefore == null || createdBefore.equalsIgnoreCase(SYMB_NULL) || createdBefore.length() == 0 || createdBefore.equals(SYMB_WILD))) {
            ...
            // createdAfter
            if (!(createdAfter == null || createdAfter.equalsIgnoreCase(SYMB_NULL) || createdAfter.length() == 0 || createdAfter.equals(SYMB_WILD))) {
            ...
            // State
            if (!(state == null || state.equalsIgnoreCase(SYMB_NULL) || state.length() == 0 || state.equals(SYMB_WILD))) {
            ...
            // Policy
            if (!(policy == null || policy.equalsIgnoreCase(SYMB_NULL) || policy.length() == 0 || policy.equals(SYMB_WILD))) {
            ...
            if (type != null && !"".equals(type.trim())) {
                ...
                /* Search Results */
                businessObjectList = DomainObject.findObjects(context, type, // type
                        name, revision, sOwner, strVault, whereClause, "", // save to the .finder later
                        false, resultSelects, Short.parseShort(queryLimit), SYMB_WILD, searchText);
            }
        } catch (Exception ex) {
    ...
    public static Object getPersons(Context context, String[] args) throws Exception {
        ...
        MapList mapList = DomainObject.findObjects(context, strType, strName, SYMB_WILD, SYMB_WILD, strVault, sbWhereExp.toString(), "", true, select, sQueryLimit);
    ...
    protected static MapList getFilteredPersonList(Context context, MapList mapList, String valueRoleToSearch, short sQueryLimit) throws Exception {
    ...
    public static Object getNameDisplay(Context context, String args[]) throws Exception {
    ...
    /*
     * This method displays the name field public static Object getRevDisplay(Context context, String args[]) throws Exception { StringBuffer sb = new StringBuffer(); sb.append("<script>"); sb.append(
     * "function disableRevision(){"); sb.append("if(document.forms[0].latestRevision.checked) {"); sb.append("document.forms[0].txtRev.value = \"*\";"); sb.append(
     * "document.forms[0].txtRev.disabled = true;"); sb.append("} else {"); sb.append("document.forms[0].txtRev.disabled = false;"); sb.append("}"); sb.append("}"); sb.append("</script>"); sb.append(
     * "<input type=\"text\" name=\"txtRev\" value =\"*\" id=\"\" size=\"20\" >"); sb.append(
     * "&nbsp;&nbsp;<input type=\"checkbox\" name=\"latestRevision\" value =\"true\" onclick=\"javascript:disableRevision()\" >"); sb.append("&nbsp;Latest Revision only"); return sb.toString(); }
     */
    /* This method displays the name field (Written by Tejashwini) */
    public static Object getRevDisplay(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            // radioOption.append("<input type=\"button\" name=\"VaultChooseButton\" value=\"...\"
            // onclick=\"document.forms[0].vaultOption[2].checked=true;javascript:top.showChooser('../common/emxVaultChooser.jsp?fieldNameActual=vaults&fieldNameDisplay=vaultsDisplay&multiSelect=true&isFromSearchForm=true')\">");
    ...
    public static Object getAllPencilPolicies(Context context, String args[]) throws Exception {
        return getDropDownPolicies(context, "Pencil");
    }

    /* This method displays the policy of the a type (Written by Tejashwini) */
    public static Object getAllPartPolicies(Context context, String args[]) throws Exception {
        return getDropDownPolicies(context, "Part");
    }

    /* This method returns the policy of the a type (Written by Tejashwini) */
    public static String getDropDownPolicies(Context context, String strType) throws Exception {
    ...
    public static Object getVaults(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            radioOption.append(
                    "<input type=\"button\" name=\"VaultChooseButton\" value=\"...\" onclick=\"javascript:showChooser('../common/emxVaultChooser.jsp?fieldNameActual=vaults&fieldNameDisplay=vaultsDisplay&multiSelect=true&isFromSearchForm=true',500,500)\">");
    ...
    public void addExisting(Context context, String[] args) throws Exception {
        try {
            ...
            for (int a = 0; a < strNewObjIdArr.length; a++) {
                ...
                DomainRelationship.connect(context, fromObjectId, strRelationshipName, toObjectId, false);
            }
            // End transaction
    ...
    public static Object getEmptyTable(Context context, String[] args) throws Exception {
