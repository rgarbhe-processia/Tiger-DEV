    ...
    public MapList getFolderContent(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (bIsTypeWorkspaceVault) {
                contentMapList = domainObject.getRelatedObjects(context, DomainObject.RELATIONSHIP_VAULTED_OBJECTS_REV2, "*", selectTypeStmts, null, false, true, (short) 1, sObjWhere, null, null,
                        null, null);
            }
