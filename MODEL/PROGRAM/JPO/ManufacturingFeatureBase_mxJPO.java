...
public class ManufacturingFeatureBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @since FTR R211
     */
    public ManufacturingFeatureBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public MapList getManufacturingFeatureStructure(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            objSelect.addElement("attribute[" + ConfigurationConstants.ATTRIBUTE_DISPLAY_NAME + "]");
            objSelect.addElement(DomainConstants.SELECT_REVISION);
            objSelect.addElement("attribute[" + ConfigurationConstants.ATTRIBUTE_MARKETING_NAME + "]");
            objSelect.addElement("physicalid");

            mapManufacturingStructure = (MapList) cfBean.getManufacturingFeatureStructure(context, "", null, objSelect, relSelect, false, true, iLevel, limit, strObjWhere, DomainObject.EMPTY_STRING,
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getTopLevelManufacturingFeatures(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            strWhere.append(" || ");
            strWhere.append("to[" + ConfigurationConstants.RELATIONSHIP_MANUFACTURING_FEATURES + "].from.type.kindof[" + ConfigurationConstants.TYPE_MANUFACTURING_FEATURE + "]!=TRUE)");
            ...
            mapTop = DomainObject.findObjects(context, ConfigurationConstants.TYPE_MANUFACTURING_FEATURE, "*", "*", "*", "*", strWhere.toString(), queryName, true,
    ...
    /**
     * This Methods is used to get the top level Logical Features Owned by the user. This is used while launching the Logical Features from My Desk
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getTopLevelOwnedManufacturingFeatures(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            mapTop = DomainObject.findObjects(context, ConfigurationConstants.TYPE_MANUFACTURING_FEATURE, "*", "*", context.getUser(), "*", strWhere.toString(), queryName, true,
                    ConfigurationUtil.getBasicObjectSelects(context), (short) limit);
     ...
     * @return mapManufacturingStructure- MapList Containing the Maps of Manufacturing Features. Each Map will consist of: id= Manufacturing Feature ID, type = Manufacturing Feature or Sub-types of
     *         Manufacturing Features name = name of logical feature revision = revision of Manufacturing Feature name[connection]= name of the relationship id[connection] = relationship id
     * @throws Exception
     * @author A69
     * @since R212
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getCandidateManufacturingFeatures(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (strObjectid.equals(parentOID)) {
                ...
                mapManufacturingStructure = configModel.getCandidateManufacturingFeatures(context, DomainObject.EMPTY_STRING, DomainObject.EMPTY_STRING, slObjSelects, null, false, true, iLevel, 0,
    ...
    public MapList getCommittedManufacturingFeatures(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            Model configModel = new Model(strObjectid);
            mapManufacturingStructure = configModel.getCommittedManufacturingFeatures(context, DomainObject.EMPTY_STRING, DomainObject.EMPTY_STRING, slObjSelects, slRelSelects, false, true, iLevel, 0,
                    DomainObject.EMPTY_STRING, DomainObject.EMPTY_STRING, DomainObject.FILTER_STR_AND_ITEM, filterExpression);
    ...
    public StringList excludeAvailableManufacturingFeature(Context context, String[] args) throws Exception {
        ...
        if (txtType.equalsIgnoreCase(ProductLineConstants.TYPE_MODEL)) {
            strRelPattern += "," + ConfigurationConstants.RELATIONSHIP_CANDIDTAE_MANUFACTURING_FEATURES + "," + ConfigurationConstants.RELATIONSHIP_COMMITTED_MANUFACTURING_FEATURES;
        }
        ...
        relatedFromFeatureList = domContextObj.getRelatedObjects(context, strRelPattern, strObjectPattern, objectSelects, null, false, true, level, strWhereExp, strWhereExp, limit);
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getTempCommittedManufacturingFeatures(Context context, String[] args) throws Exception {
    ...
    public static MapList getStructureList(Context context, String[] args) throws Exception {
        ...
        String strTypePattern = ConfigurationConstants.TYPE_MANUFACTURING_FEATURE + "," + ConfigurationConstants.TYPE_MANUFACTURING_FEATURE + "," + ConfigurationConstants.TYPE_PRODUCTS;
        String strRelPattern = ConfigurationConstants.RELATIONSHIP_MANUFACTURING_FEATURES + "," + ConfigurationConstants.RELATIONSHIP_CANDIDTAE_MANUFACTURING_FEATURES + ","
        ...
        manFeatureStructList = confUtil.getObjectStructure(context, strTypePattern, strRelPattern, objectSelects, null, false, true, (short) 1, 0, "", "", DomainObject.FILTER_STR_AND_ITEM,
    ...
    public List getStatusIcon(Context context, String[] args) throws Exception {
        ...
        while (objectListItr.hasNext()) {
            ...
            if (flag) {
                ...
                stbNameRev = stbNameRev.append("<img src=\"../common/images/").append(XSSUtil.encodeForHTMLAttribute(context, strIcon)).append("\" border=\"0\"  align=\"middle\" ").append("TITLE=\"")
                        .append(" ").append(XSSUtil.encodeForHTMLAttribute(context, strObjState)).append("\"").append("/>");
    ...
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList excludeManufacturingFeature(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
    ...
    /**
     * Method returns the First Sequence revision for the policy Manufacturing Feature. It is called for the create page of Manufacturing Feature
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds parameters passed from the calling method
    ...
    public String getPartFamilyLinkForForm(Context context, String[] args) throws FrameworkException {
        try {
            ...
            StringList tempStringList = new StringList();
            // Replaced DomainConstants.EMPTY_STRINGLIST with tempStringList for stale object issue
            MapList manufacturingFeaturePFList = util.getObjectStructure(context, strTypePattern, strRelPattern, objectSelectables, tempStringList, false, true, 1, 0, DomainConstants.EMPTY_STRING,
     ...
     * @param context
     * @param objectID
     *            -- Manufacturing Feature ID/Product ID
     * @param displayName
     *            - boolean, true for MF and false for Products
    ...
    public static int isUsedInRulesForTypeCheck(Context context, String[] args) throws Exception {
        ...
        String strRelBCRLE = "to[" + ConfigurationConstants.RELATIONSHIP_MANUFACTURING_FEATURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.type.kindof["
                + ConfigurationConstants.TYPE_BOOLEAN_COMPATIBILITY_RULE + "]";
        String strRelBCRRE = "to[" + ConfigurationConstants.RELATIONSHIP_MANUFACTURING_FEATURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].from.type.kindof["
                + ConfigurationConstants.TYPE_BOOLEAN_COMPATIBILITY_RULE + "]";
        String strRelMPRLE = "to[" + ConfigurationConstants.RELATIONSHIP_MANUFACTURING_FEATURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.type.kindof["
                + ConfigurationConstants.TYPE_MARKETING_PREFERENCE + "]";
        String strRelMPRRE = "to[" + ConfigurationConstants.RELATIONSHIP_MANUFACTURING_FEATURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].from.type.kindof["
                + ConfigurationConstants.TYPE_MARKETING_PREFERENCE + "]";
        String strRelQRLE = "to[" + ConfigurationConstants.RELATIONSHIP_MANUFACTURING_FEATURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.type.kindof["
                + ConfigurationConstants.TYPE_QUANTITY_RULE + "]";
        String strRelQRRE = "to[" + ConfigurationConstants.RELATIONSHIP_MANUFACTURING_FEATURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].from.type.kindof["
                + ConfigurationConstants.TYPE_QUANTITY_RULE + "]";
        String strRelIRRE = "to[" + ConfigurationConstants.RELATIONSHIP_MANUFACTURING_FEATURES + "].tomid[" + ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION + "].from.type.kindof["
    ...
    /**
     * Method call as a trigger to check if the Parts associated with the Manufacturing Feature are in Release state.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     ...
     * @author WKU
     */
    public int checkPartsForManufacturingFeaturePromote(Context context, String args[]) throws Exception {
    ...
    /**
     * Method call as a trigger to check if the sub-features associated with the Manufacturing Feature are in. Release state.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Holds the parameters passed from the calling method
     ...
     * @author WKU
     */
    public int checkSubFeaturesForManufacturingFeaturePromote(Context context, String args[]) throws Exception {
        // return value of the function
        int iReturn = 0;
        // The feature object id sent by the emxTriggerManager is retrieved
        // here.
        ...
        MapList relBusObjList = manufacturingFeature.getManufacturingFeatureStructure(context, DomainObject.EMPTY_STRING, DomainObject.EMPTY_STRING, objectSelects, null, false, true, 0, 0,
        ...
        if (iNumberOfObjects > 0) {
            ...
            for (int i = 0; i < iNumberOfObjects; i++) {
                ...
                if (!isFrozen) {
                    String language = context.getSession().getLanguage();
                    String strAlertMessage = EnoviaResourceBundle.getProperty(context, "Configuration", "emxProduct.Alert.ManufacturingFeaturesPromoteFailedStateNotRelease", language);
                    emxContextUtilBase_mxJPO.mqlNotice(context, strAlertMessage);
                    iReturn = 1;
                    break;
                }
    ...
    public int promoteRules(Context context, String args[]) throws Exception {
        ...
        strRelationshipPattern = strRelationshipPattern + ConfigurationConstants.RELATIONSHIP_BOOLEAN_COMPATIBILITY_RULE + strComma + ConfigurationConstants.RELATIONSHIP_PRODUCT_RULEEXTENSION
                + strComma + ConfigurationConstants.RELATIONSHIP_PRODUCT_FIXEDRESOURCE;
    ...
    public int promoteSubFeatures(Context context, String args[]) throws Exception {
        ...
        String objectWhere = "(" + DomainConstants.SELECT_CURRENT + " != \"" + ConfigurationConstants.STATE_RELEASE + "\")";
        // Replaced DomainConstants.EMPTY_STRINGLIST with tempStringList for stale object issue
        MapList relBusObjList = manufacturingFeature.getManufacturingFeatureStructure(context, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, objectSelects, tempStringList, false, true,
                0, 0, objectWhere, DomainConstants.EMPTY_STRING, (short) 1, DomainConstants.EMPTY_STRING);
    ...
    /**
     * It is a trigger method. Fires when a "Manufacturing Feature" promoted from review state to release state. If the promoted LF have previous revision than it will replace with the latest revision
     * in Products/Manufacturing Feature which are not in Release state.
     * @param context
     *            The ematrix context object.
     * @param String
     *            [] The args .
    ...
    public void ManufacturingFeatureFloatOnRelease(Context context, String[] args) throws FrameworkException {
        try {
            ...
            if (boPreviousRevision.exists(context)) {
                ...
                MapList manufacturingFeaturesRelIDListUp = util.getObjectStructure(context, strTypePattern, strRelPattern, tempStringList, tempStringList, true, false, 1, 0, strBusWhereClause,
    ...
    /**
     * It is a check trigger method. Fires when a relationship Manufacturing Features is getting created It is used to check the cyclic condition
     * @param context
     *            The ematrix context object.
     * @param String
     *            [] The args .
    ...
    public int multiLevelRecursionCheck(Context context, String[] args) throws Exception {
        ...
        if (strRemovedLFId == null || strRemovedLFId.equalsIgnoreCase("")) {
            ...
            try {
                ...
                if (recursionCheck) {
                    String language = context.getSession().getLanguage();
                    String strAlertMessage = EnoviaResourceBundle.getProperty(context, "Configuration", "emxConfiguration.Add.CyclicCheck.Error", language);
     ...
     * @param context
     * @param args
     * @return Map containing old created Manufacturing Feature rel id as key and pipe separated old rel physical id, new rel physical id, new rel id as value
     * @throws FrameworkException
     * @exclude
     */
    public Map copyManufacturingFeature(Context context, String[] args) throws FrameworkException {
     ...
     * @author A69
     */
    public void connectManufacturingFeatureOnRevise(Context context, String args[]) throws FrameworkException {
    ...
    /**
     * Trigger will be invoked on Manufacturing Features Delete Action. It will remove the Committed Context relationship and Change the Committed Manufacturing Features relation to Candidate
     * Manufacturing Features relation.
     * @param context
     * @param args
     * @return
     * @throws FrameworkException
    ...
    public static Map refreshTree(Context context, String[] args) throws Exception {
        Map returnMap = new HashMap();
        returnMap.put("Action", "execScript");
        returnMap.put("Message", "{ main:function __main(){refreshTreeForMFAddRemove(xmlResponse)}}");
        return returnMap;
    }
}
