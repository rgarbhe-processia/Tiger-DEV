...
public class emxECSearchMassUpdateBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    /** Simple date format */
    public emxECSearchMassUpdateBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public void updateVault(Context context, String[] args) throws Exception {
        ...
        // Multitenant
        // String strError = UINavigatorUtil.getI18nString("emxEngineeringCentral.TypeAheadError.Message", "emxEngineeringCentralStringResource", context.getLocale().toString());
    ...
    public MapList getPartSearchEditDetails(Context context, String args[]) throws Exception {
        ...
        // Multitenant
        /*
         * strAccessValue = UINavigatorUtil.getI18nString(strAccessValue, "emxEngineeringCentralStringResource", context.getLocale() .toString());
         */
        ...
        // String[] arrObjectIds = new String[slIds.size()];
        String strOId = "";
    ...
    /**
     * This method provides the generic code for update of relationship based columns. The column that is updated could be displaying any object connected to object shown in the Structure browser row.
     * eg. BOM power view can have column showing the Design Responsibility connected to the part in the row in one of the column. This column can be updated using this JPO. This method needs to be
     * used along with 'Update Program Arguments' with value like 'relationship=<symbolic_name_of_relationship>,isFrom=true/false'
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains the 'Update Program Arguments'
     * @returns true/false
     * @throws Exception
     *             if the operation fails
     * @since Common 10.6
                ...
                if (relationshipName.equals(DomainConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY) && strType.equals(DomainConstants.TYPE_SKETCH)) {
                    ...
                    if ("true".equals(strFrom)) {
                        if (DomainConstants.RELATIONSHIP_CLASSIFIED_ITEM.equalsIgnoreCase(relationshipName)) {
                            ...
                            relId = MqlUtil.mqlCommand(context, "print bus $1 select $2 dump", sObjectId,
                                    "to[" + DomainConstants.RELATIONSHIP_CLASSIFIED_ITEM + "|from.type=='" + DomainConstants.TYPE_PART_FAMILY + "'].id");
    ...
    private boolean connectedObject(Context context, String newObjectId, String relationshipName, String sObjectId, String relId, boolean isFrom) throws Exception {
        ...
        if (relationshipName.equals(PropertyUtil.getSchemaProperty(context, "relationship_DesignResponsibility"))) {
            // Modified for IR-048513V6R2012x, IR-118107V6R2012x start
            MapList mlRelObjects = newRelObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY, "*", selectStmts, selectRelStmts, true, false, (short) 1, null, null, 0);
            // Modified for IR-048513V6R2012x, IR-118107V6R2012x end
    ...
    /*
     * Added this is for IR-025583V6R2011 Method to display All the policies in Policy drop down column Arguments should have symbolic relationship name and isFrom connection true/false
     */
    ...
    public void updatePolicy(Context context, String[] args) throws Exception {
