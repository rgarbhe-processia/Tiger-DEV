...
/**
 * The <code>${CLASSNAME}</code> class extends the Base JPO that is used to generate all DR managed business types list for display rule.
...
public class emxPromotePriorRev_mxJPO extends emxPromotePriorRevBase_mxJPO {
     ...
     * @since AEF 10.0.1.0
     */
    public emxPromotePriorRev_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
