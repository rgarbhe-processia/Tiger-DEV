...
public class IEFShowPurgeLink_mxJPO {
    ...
    public IEFShowPurgeLink_mxJPO(Context context, String[] args) throws Exception {
    }
        ...
        for (int i = 0; i < relBusObjPageList.size(); i++) {
            ...
            try {
                ...
                if (integrationName != null && integrationNameGCOTable.containsKey(integrationName)) {
                    ...
                    if (globalConfigObject.isCreateVersionObjectsEnabled() && bPurge) {
                        String purgeToolTip = serverResourceBundle.getString("mcadIntegration.Server.AltText.Purge");
                        String purgeURL = "../integrations/IEFPurge.jsp?header=mcadIntegration.Server.Title.Purge&funcPageName=" + MCADGlobalConfigObject.PAGE_PURGE
                                + "&relName=VersionOf&end=to&objectId=" + objectId + "&integrationName=" + integrationName + "&help=emxhelpdscpurge";
    ...
    private Hashtable executeJPO(Context context, String objectID, String jpoName, String jpoMethod) throws Exception {
        ...
        try {
            ...
            System.out.println("[IEFShowPurgeLink]INVOKING JPO.." + jpoName);
