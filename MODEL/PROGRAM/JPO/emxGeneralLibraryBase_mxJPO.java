...
/*
 * emxGeneralLibraryBase.java Copyright (c) 1992-2015 Dassault Systemes. All Rights Reserved. This program contains proprietary and trade secret information of MatrixOne, Inc. Copyright notice is
...
public class emxGeneralLibraryBase_mxJPO extends emxLibraries_mxJPO {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("must specify method on emxGeneralLibraryBase invocation");
        }
