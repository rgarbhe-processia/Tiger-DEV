...
/**
 * The <code>emxPropertyUtil</code> class contains property utility methods.
 * @version AEF 10.0.1.0 - Copyright (c) 2003, MatrixOne, Inc.
 */

public class emxPropertyUtil_mxJPO extends emxPropertyUtilBase_mxJPO {
    ...
    public emxPropertyUtil_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
