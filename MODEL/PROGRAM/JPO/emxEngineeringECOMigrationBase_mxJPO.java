...
/*
 * emxEngineeringECOMigrationBase.java program migrates Existing EC Substitute Part to New Substitute Data Model(i.e. Create EBOM Substitute rel).
 *
...
public class emxEngineeringECOMigrationBase_mxJPO extends emxCommonMigration_mxJPO {
     ...
     * @grade 0
     */
    public emxEngineeringECOMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public void migrateObjects(Context context, StringList objectIdList) throws Exception {
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                MapList mlNewPartPartRevision = domECO.getRelatedObjects(context, relPattern.getPattern(), "*", selectlist, relselect, false, true, (short) 1, "", null);
