 ...
 **
 ** FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : Anil KJ Version : "$Revision: 1.13 $" Date : "$Date: Wed Oct 22 16:02:44 2008 $"
 **
...
public class emxDocumentCentralSubscriptionBase_mxJPO {
    ...
    public emxDocumentCentralSubscriptionBase_mxJPO(Context context, String[] args) throws Exception {
        // EMPTY CONSTRUCTOR
    }
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("Must specify method on emxDocumentCentralSubscription invocation");
        }
    ...
    /**
     * Get all Event object connected to objectId passed thry Publish Subscribe object and connected to logged in User
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            the Java <code>String[]</code> object holds following input arguments: 0 - HashMap containing one String entry for key "objectId"
    ...
    public TreeMap getAllObjectEvents(matrix.db.Context context, String[] args) throws Exception {
        /*
         * Author : Neaz Faiyaz Date : 02/16/02 Notes : History :
         */
        ...
        MapList result = domainObj.getRelatedObjects(context, relPattern.getPattern(), "*", objSelect, relSelect, false, true, (short) 3, objWhere, null, typePattern, null, null);
        ...
        while (iterator.hasNext()) {
            ...
            treeMap.put(temp.get("attribute[" + sAttType + "]"), temp.get(DomainConstants.SELECT_ID));
        }
    ...
    protected boolean checkForConnectedPerson(Context context, String eventId) throws FrameworkException {
        ...
        MapList mapList = domainObj.getRelatedObjects(context, relPattern.getPattern(), "*", objSelect, relSelect, false, true, (short) 1, null, null);
    ...
    /**
     * Create event object, set the event type attribute and connect it to logged in person and Publish Subscribe object
     * @param context
     *            <code>Context</code> object
     * @param psId
     *            <code>String</code> object
    ...
    /**
     * Return the object id of ps connected to subscribed object, if dosent exists, create it
     * @param context
     *            <code>Context</code> object
     * @param parentId
     *            <code>String</code> object
     ...
     *            <code>Context</code> object
     * @param args
     *            the Java <code>String[]</code> object contains a Map with the following entries: parentId - parentId for Subscription vectorSubEvents - the Java <code>Vector</code> containing al Sub
     *            events
     * @throws FrameworkException
     *             if the operation fails
     * @since AEF 9.5.3.1
    ...
    public void processSubscribeEvents(Context context, String[] args) throws Exception {
        ...
        while (iterator.hasNext()) {
            temp = (Hashtable) iterator.next();
            treeMap.put(temp.get("attribute[" + sAttrEventType + "]"), temp.get(DomainConstants.SELECT_ID));
        }
     ...
     *            <code>Context</code> object
     * @param args
     *            the Java <code>String[]</code> object contains a Map with the following entries: unSubEvents - token separated string of event ids to unsubsribe
     * @throws Exception
     *             if the operation fails
     * @since AEF 9.5.3.1
     */
     ...
     *            <code>Context</code> object
     * @param args
     *            the Java <code>String[]</code> object, holds no arguments
     * @throws Exception
     *             if the operation fails
     * @since AEF 9.5.3.1
     */
    public static MapList getSubscriptionDetailsforContextualUser(Context context, String[] args) throws Exception {
        ...
        MapList eventMapList = (MapList) currentUser.getRelatedObjects(context, sRelSubscribedPerson, "*", eventObjectSelect, new StringList(), true, false, (short) 1, null, null);
        ...
        while (iterator.hasNext()) {
            ...
            MapList dcObjectsMapList = myobj.getRelatedObjects(context, sRelPublish + "," + sRelPublishSubscribe, "*", dcObjectSelects, new StringList(), true, false, (short) 2, null, null, null,
                    psRelPattern, null);
