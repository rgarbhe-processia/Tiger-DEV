...
/**
 * The <code>emxPartFamilyConversion</code> class contains script to migrate 'Part Family Member' relationship to 'Classified Item', 'Part Family' policy to 'Classification' policy
 * @since AEF 10-6
 */
...
public class emxPartFamilyConversion_mxJPO extends emxPartFamilyConversionBase_mxJPO {
    ...
    public emxPartFamilyConversion_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
