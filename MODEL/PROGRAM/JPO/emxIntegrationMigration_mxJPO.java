...
/*
 * emxIntegrationMigration.java program migrates the data into Common Document model i.e. to 10.5 schema.
 *
...
public class emxIntegrationMigration_mxJPO extends emxIntegrationMigrationBase_mxJPO {
     ...
     * @grade 0
     */
    public emxIntegrationMigration_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
