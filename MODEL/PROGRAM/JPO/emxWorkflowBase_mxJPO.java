...
public class emxWorkflowBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @param args
     *            holds the following input arguments: 0 - String that holds the document object id.
     * @throws Exception
     *             if the operation fails
     */

    public emxWorkflowBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    private HashMap create(Context context, String name, String description, String dueDate, String processName, boolean startWorkflow, String promoteObject, String processAutoStart, HashMap content)
            throws Exception {
    ...
    private void delete(Context context, String objectId) throws Exception {
        ...
        MapList tasksList = dObj.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, relSelects, false, true, (short) 0, null, // null, //objectWhere
                null, // relWhere,
                null, null, null);
    ...
    private void sendNotificationsForDeleteAction(Context context, String objectId) throws Exception {
        ...
        MapList mList = dObj.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_WorkflowTask"), PropertyUtil.getSchemaProperty(context, "type_WorkflowTask"), selects,
                new StringList(), false, true, (short) 0, "current == 'Assigned'", null);
        ...
        while (itr.hasNext()) {
            ...
            String messageValues[] = { PropertyUtil.getSchemaProperty(context, "type_WorkflowTask"), (String) map.get(DomainObject.SELECT_NAME),
                    PropertyUtil.getSchemaProperty(context, "type_Workflow"), dObj.getInfo(context, "name") };

            MailUtil.sendNotification(context, toList, // To List
                    null, // Cc List
                    null, // Bcc List
    ...
    private BusinessObject createBusObject(Context context, String type, String name, String revision, String policy, String vault, String owner, String description) throws Exception {
        ...
        if (name == null || name.length() < 1) {
            ...
            busObj = new BusinessObject(FrameworkUtil.autoName(context, aliasType, revision, aliasPolicy, vault, revision, false, false));
        } else {
    ...
    protected ArrayList addWorkflowToProcess(Context context, ArrayList nodes, String objectId) throws Exception {
        ...
        MapList mList = obj.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_WorkflowTask"), PropertyUtil.getSchemaProperty(context, "type_WorkflowTask"), selects,
        ...
        MapList subWFList = obj.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_WorkflowSubProcess"), PropertyUtil.getSchemaProperty(context, "type_Workflow"),
        ...
        /*
         * if(nodes.size() > 0) { command.append(" select "); }
         */
        Iterator itr = nodes.iterator();
     ...
     * @param input
     *            the xml containing the tag and value
     * @param tag
     *            the attribute tag
     ...
     * @param xml
     *            the original xml export from mql
    ...
    public Object getRollupDeliverables(Context context, String[] args) throws Exception {
        try {
            ...
            MapList documentList = workflowObject.getRelatedObjects(context, relPattern.getPattern(), typePattern.getPattern(), typeSelects, relSelects, false, true, (short) 0, null, // objectWhere
                    null, // relWhere,
                    null, includeRelPattern, null);
     ...
     *            holds arguments
     * @param busWhere
     *            holds where condition to get objects
     * @returns Object
     * @throws Exception
     *             if the operation fails
     * @since Common 10.6 SP2
     * @grade 0
     */
    public Object getTasks(Context context, String[] args, String busWhere) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            String workflowId = (String) programMap.get("objectId");
            Pattern relPattern = new Pattern("");
            ...
            StringList relSelects = new StringList(1);
            relSelects.add(CommonDocument.SELECT_RELATIONSHIP_ID);
            MapList tasksList = this.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, relSelects, false, true, (short) 1, busWhere, // null, //objectWhere
                    null, // relWhere,
                    null, null, null);
    ...
    public Object getActiveTasks(Context context, String[] args) throws Exception {
        ...
        /*
         * String stateStarted = PropertyUtil.getSchemaProperty(context, "policy",DomainObject.SYMBOLIC_policy_WorkflowTask,"state_Started"); String stateAssigned =
         * PropertyUtil.getSchemaProperty(context, "policy",DomainObject.SYMBOLIC_policy_WorkflowTask,"state_Assigned"); String stateSuspended = PropertyUtil.getSchemaProperty(context,
         * "policy",DomainObject.SYMBOLIC_policy_WorkflowTask,"state_Suspended");
         */
    ...
    public Object getCompletedTasks(Context context, String[] args) throws Exception {
        ...
        /*
         * String stateOverridden = PropertyUtil.getSchemaProperty(context, "policy",DomainObject.SYMBOLIC_policy_WorkflowTask,"state_Overridden"); String stateCompleted =
         * PropertyUtil.getSchemaProperty(context, "policy",DomainObject.SYMBOLIC_policy_WorkflowTask,"state_Completed");
         */
     ...
     * @grade 0
     */
    public Vector showTaskStatusIcon(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
    ...
    public Object getContent(Context context, String[] args) throws Exception {
        try {
            ...
            MapList contentList = this.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, relSelects, false, true, (short) 1, null, // objectWhere
                    null, // relWhere,
                    null, null, null);
        ...
        try {
            ...
            if (editTableMode != null && editTableMode.equals("false")) {
                ...
                for (Iterator itr = objectList.iterator(); itr.hasNext();) {
                    ...
                    contentList.add(
                            populateCombo(context, objStates, objPolicy, baseState, sNone, dObj.getInfo(context, DomainObject.SELECT_CURRENT), (String) m.get(DomainObject.SELECT_RELATIONSHIP_ID)));
                }
            }
        } catch (Exception ex) {
            throw ex;
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getTaskDeliverableSearchResult(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            ...
            MapList queryResultList = DomainObject.findObjects(context, // eMatrix context
     ...
     * @grade 0
     */
    public Object getResultsCheckboxColumn(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            ...
            MapList deliverableList = workflowTaskObject.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, relSelects, false, true, (short) 1, null, // objectWhere
                    null, // relWhere,
                    null, null, null);
    ...
    /**
     * This method is executed to get all subtypes of given type and adding them to give businesstypelist.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds arguments
     ...
     * @grade 0
     */
    public BusinessTypeList getAllSubTypes(Context context, String type, BusinessTypeList busTypeList) throws MatrixException {
        if (busTypeList == null) {
    ...
    public Object getRollupDeliverableTaskColumn(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objectList = (MapList) programMap.get("objectList");
            String relTaskDeliverable = PropertyUtil.getSchemaProperty(context, "relationship_TaskDeliverable");
            ...
            for (Iterator itr = objectList.iterator(); itr.hasNext();) {
                ...
                try {
                    ...
                    /*
                     * Forming hyperlinks for only Workflow Tasks objects. Other task objects like Task Management will be ignored.
                     */
     ...
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            - args contains a Map with the following entries: paramMap - the Map of the parameters New Value - The new Value of assingee Name
    ...
    public int updateAssignee(Context context, String[] args) throws Exception {
        ...
        /*
         * Reading parameter "New OID" from paramMap is coming as empty so reading New value and forming person object.
         */
        ...
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        updateConnection(context, strObjectId, relWorkflowTaskAssignee, strNewValue, true);
        return 0;
    }
    ...
    protected void updateConnection(Context context, String parentObjectId, String strRelationshipName, String strNewObjectId, boolean bIsFrom) throws Exception {
        ...
        if (!(strNewObjectId.equals("") || strNewObjectId.equals("null") || strNewObjectId == null)) {
            ...
            /*
             * Web form param map is returning selected object id as empty so forming Person bussiness object with type and name
             */
            ...
            this.addRelatedObject(context, new RelationshipType(strRelationshipName), false, strNewObjectId);
        }
    }
    ...
    public Vector showAddContentCheckbox(Context context, String args[]) throws Exception {
        ...
        if (strObjectId != null && !"null".equalsIgnoreCase(strObjectId) && !"".equalsIgnoreCase(strObjectId)) {
            ...
            StringList relSelects = new StringList(1);
            relSelects.add(CommonDocument.SELECT_RELATIONSHIP_ID);
            MapList connectedObjsList = this.getRelatedObjects(context, relPattern.getPattern(), "*", selListObj, relSelects, false, true, (short) 1, null, // objectWhere
                    null, // relWhere,
                    null, null, null);
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getMyworkflows(Context context, String[] args) throws Exception {
        try {
            ...
            if (objectId != null && !"null".equalsIgnoreCase(objectId) && !"".equalsIgnoreCase(objectId)) {
                ...
                workflowList = domainObj.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, null, true, false, (short) 1, null, // objectWhere
                        null // relWhere,
                );
            } else {
                workflowList = DomainObject.findObjects(context, typePattern, QUERY_WILDCARD, // namepattern
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getNotStartedWorkflows(Context context, String[] args) throws Exception {
        try {
            String loggedInUser = com.matrixone.apps.common.Person.getPerson(context).getName(context);
            String typePattern = PropertyUtil.getSchemaProperty(context, "type_Workflow");
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            ...
            if (objectId != null && !"null".equalsIgnoreCase(objectId) && !"".equalsIgnoreCase(objectId)) {
                DomainObject domainObj = DomainObject.newInstance(context, objectId);
                workflowList = domainObj.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, null, true, false, (short) 1, "current==" + stateStopped, // objectWhere
                        null // relWhere,
                );
            } else {
                workflowList = DomainObject.findObjects(context, typePattern, QUERY_WILDCARD, // namepattern
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getPausedWorkflows(Context context, String[] args) throws Exception {
        try {
            String loggedInUser = com.matrixone.apps.common.Person.getPerson(context).getName(context);
            String typePattern = PropertyUtil.getSchemaProperty(context, "type_Workflow");
            ...
            if (objectId != null && !"null".equalsIgnoreCase(objectId) && !"".equalsIgnoreCase(objectId)) {
                DomainObject domainObj = DomainObject.newInstance(context, objectId);
                workflowList = domainObj.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, null, true, false, (short) 1, "current==" + stateSuspended, // objectWhere
                        null // relWhere,
                );
            } else {
                workflowList = DomainObject.findObjects(context, typePattern, QUERY_WILDCARD, // namepattern
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getInprocessWorkflows(Context context, String[] args) throws Exception {
        try {
            String loggedInUser = com.matrixone.apps.common.Person.getPerson(context).getName(context);
            String typePattern = PropertyUtil.getSchemaProperty(context, "type_Workflow");
            ...
            if (objectId != null && !"null".equalsIgnoreCase(objectId) && !"".equalsIgnoreCase(objectId)) {
                DomainObject domainObj = DomainObject.newInstance(context, objectId);
                workflowList = domainObj.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, null, true, false, (short) 1, "current==" + stateStarted, // objectWhere
                        null // relWhere,
                );
            } else {
                workflowList = DomainObject.findObjects(context, typePattern, QUERY_WILDCARD, // namepattern
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getCompletedWorkflowsInLast30Days(Context context, String[] args) throws Exception {
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getCompletedWorkflowsInLast60Days(Context context, String[] args) throws Exception {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public Object getCompletedWorkflowsInLast90Days(Context context, String[] args) throws Exception {
     ...
     * @grade 0
     */
    public Object getCompletedWorkflowsInLastNumOfDays(Context context, String[] args, int days) throws Exception {
        try {
            String loggedInUser = com.matrixone.apps.common.Person.getPerson(context).getName(context);
            String typePattern = PropertyUtil.getSchemaProperty(context, "type_Workflow");
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            ...
            if (objectId != null && !"null".equalsIgnoreCase(objectId) && !"".equalsIgnoreCase(objectId)) {
                DomainObject domainObj = DomainObject.newInstance(context, objectId);
                workflowList = domainObj.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, null, true, false, (short) 1,
     ...
     *             if the operation fails
     */
    public Vector getWorkflowStatus(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            HashMap paramMap = (HashMap) programMap.get("paramList");
     ...
     * 
     * @param args holds the HashMap containing the following arguments queryLimit limit for displaying search query results User Name the user name or name pattern of the Person search for First Name
     * the first name or name pattern of the Person search for Last Name the last name or name pattern of the Person search for Company the company name or name pattern of the Person search for Vault
     * Option the vault search option Vault Display the vault display search option
     * 
    ...
    public String getProcessAttributes(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        ...
        _localDateFormat = ((java.text.SimpleDateFormat) java.text.DateFormat.getDateInstance(eMatrixDateFormat.getEMatrixDisplayDateFormat(), (Locale) _requestMap.get("localeObj")))
                .toLocalizedPattern();
    ...
    public String getFieldViewHTML(String attributeName, String attributeValue) throws Exception {
        ...
        buf.append("<tr>");
        buf.append(_uif.drawFormViewElement(_context, _requestMap, field, _timeZone, "false", true, _maxCol));
        buf.append("</tr>");
    ...
    public String getFieldEditHTML(String attributeName, String attributeValue) throws Exception {
        ...
        buf.append("<tr>");
        String uifOut = _uif.drawFormEditElement(_context, _requestMap, field, inputMap, _timeZone, true, // drawLabel
                _maxCol, -1, // fieldCounter
                isReadOnly);
        buf.append(uifOut);
        buf.append("</tr>");
        return buf.toString();
    ...
    public void updateProcessAttributes(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramMap = (HashMap) programMap.get("paramMap");
        HashMap requestMap = (HashMap) programMap.get("requestMap");
        String objectId = (String) paramMap.get("objectId");
    ...
    public static void acceptTasks(Context context, String objectId) throws Exception {
        ...
        String sStateStarted = PropertyUtil.getSchemaProperty(context, "policy", PropertyUtil.getSchemaProperty(context, "policy_WorkflowTask"), "state_Started");
        String sStateAssigned = PropertyUtil.getSchemaProperty(context, "policy", PropertyUtil.getSchemaProperty(context, "policy_WorkflowTask"), "state_Assigned");
        ...
        MapList tasksList = obj.getRelatedObjects(context, relPattern.getPattern(), PropertyUtil.getSchemaProperty(context, "type_WorkflowTask"), typeSelects, relSelects, false, true, (short) 1, null, // null,
                // //objectWhere
                null, // relWhere,
                null, null, null);
    ...
    public static void acceptTasksForSubProcess(Context context, String objectId) throws Exception {
        ...
        typeSelects.add(DomainObject.SELECT_ID);
        StringList relSelects = new StringList();
        MapList wfList = obj.getRelatedObjects(context, relPattern.getPattern(), PropertyUtil.getSchemaProperty(context, "type_Workflow"), typeSelects, relSelects, true, true, (short) 0, null, // null,
                // //objectWhere
                null, // relWhere,
                null, null, null);
