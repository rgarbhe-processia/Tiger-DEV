...
/*
 * VariantConfigurationDerivationMigrationBase.java program migrates the data into Common Document model i.e. to 10.5 schema.
 *
...
/**
 * The <code>VariantConfigurationMPDerivationMigrationBase</code> class contains code to migrate Manufacturing Plan structure of the Models found in step1. This needs to be done for supporting
 * Branching in 2012x
 */
public class VariantConfigurationGBOMPhaseOneMigrationBase_mxJPO extends emxCommonMigration_mxJPO {
     ...
     */
    public VariantConfigurationGBOMPhaseOneMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        try {
            ...
            /*
             * if(migrationStatus<2) { mqlLogRequiredInformationWriter("Pre-migration Find Object is not complete. Please complete Pre-migration before running Object Migration. \n"); return -1; }
            ...
            /*
             * } else if(migrationStatus == 3){ mqlLogRequiredInformationWriter(
             * "GBOM migration is already in process. Please wait for migration to be completed or abort the transaction and reset the status Property. \n"); return -1; } else if(migrationStatus == 4
                ...
                try {
                    ...
                    if (infoMapList.size() != 0) {
                        ...
                        while (itr.hasNext()) {
                            ...
                            partName = (String) infoMap.get(ConfigurationConstants.SELECT_TYPE) + " " + (String) infoMap.get(ConfigurationConstants.SELECT_NAME) + " "
                            ...
                            if (infoMap.containsKey("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.id")) {
                                mqlLogRequiredInformationWriter("Found Inclusion Rule Id: " + (String) infoMap.get("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.id")
                                        + " Name: " + (String) infoMap.get("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.name") + "\n");
    ...
    private void processGBOMForEffectivity(Context context, String strLogicalFeatureID, Map gbomMap) throws Exception {
        try {
            ...
            String ruleComplexity = (String) gbomMap
                    .get("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.attribute[" + ConfigurationConstants.ATTRIBUTE_RULE_COMPLEXITY + "].value");
            ...
            String attributeRightExpression = (String) gbomMap
                    .get("tomid[" + ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION + "].from.attribute[" + ConfigurationConstants.ATTRIBUTE_RIGHT_EXPRESSION + "].value");
            ...
            if (ruleComplexity.trim().equals("Complex")) {
                ...
                mqlLogRequiredInformationWriter(
                        "Connecting :" + strLogicalFeatureID + " To Global Model: " + GLOBAL_MODEL_ID + " Using Relationship " + EffectivityFramework.RELATIONSHIP_CONFIGURATION_CONTEXT + " \n");
