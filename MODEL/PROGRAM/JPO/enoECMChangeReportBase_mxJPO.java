...
/**
 * The <code>enoECMChangeReportBase</code> class contains methods for executing JPO operations related to Change Reports.
...
public class enoECMChangeReportBase_mxJPO extends emxDomainObject_mxJPO {
        ...
        if ("true".equalsIgnoreCase(strGeneratePDF)) {
            ...
            if (pdfGenerated != 0) {
                emxContextUtil_mxJPO.mqlError(context,
                        EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.SummaryReport.NoCheckIn.ErrorMessage"));
                return 0;
            } else {
                return 0;
            }
    ...
    public String generateCOHtmlSummaryReport(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            summaryReport.append("<tr><td class=\"pageHeader\"><h1>" + ecoObj.getInfo(context, SELECT_NAME) + ":&nbsp;"
                    + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Common.SummaryReportHeader") + "</h1></td>");
            summaryReport.append(
                    "<td class=\"pageSubtitle\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Common.Generated") + " "
                            + dateAndTime + "</td></tr>");
            ...
            summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>"
                    + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Common.Attributes") + "</h2></td></tr></table>");
            ...
            summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>"
                    + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Common.Approvals") + "</h2></td></tr></table>");

            summaryReport.append(getChangeApprovals(context, args));

            summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>"
                    + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Common.Routes") + "</h2></td></tr></table>");
            summaryReport.append(getChangeRoutes(context, args));

            summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>"
                    + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Common.Tasks") + "</h2></td></tr></table>");
            summaryReport.append(getChangeTasks(context, args));

            summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>"
                    + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Command.AffectedItems") + "</h2></td></tr></table>");
            summaryReport.append(getCOAffectedItemsSummaryDetails(context, args));

            summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>"
                    + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Command.CandidateItem") + "</h2></td></tr></table>");
            summaryReport.append(getCOCandidateItemsSummaryDetails(context, args));

            summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>"
                    + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Command.ReferenceDocuments")
                    + "</h2></td></tr></table>");
    ...
    public String getChangeRelatedReferenceDocuments(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        ...
        try {
            ...
            mpListReferenceDocs = ecoObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_REFERENCE_DOCUMENT, "*", // object pattern
            ...
            if (mpListReferenceDocs.size() == 0) {
                referenceDocs.append("<tr><td colspan=\"5\">"
                        + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Change.NoReferenceDocsConnected") + "</td></tr>");
            }
    ...
    public String getCOCandidateItemsSummaryDetails(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        ...
        try {
            ...
            mpAffectedPartList = getRelatedObjects(context, strCandidateItem, // relationship pattern
                    "*", // object pattern
            ...
            if (mpAffectedPartList.size() == 0) {
                newParts.append("<tr><td colspan=\"12\">"
                        + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Change.NoCandidateItemsConnected")
                        + "</td></tr>");
    ...
    public String getCOAffectedItemsSummaryDetails(Context context, String[] args) throws Exception {
        ...
        StringBuffer newParts = new StringBuffer();
        String strLanguage = context.getSession().getLanguage();
        String strChangeAction = PropertyUtil.getSchemaProperty(context, "relationship_ChangeAction");
        String strChangeAffectedItem = PropertyUtil.getSchemaProperty(context, "relationship_ChangeAffectedItem");
        ...
        try {
            ...
            sListSelStmts.addElement(SELECT_CURRENT);
            sListSelStmts.add("current.actual");
            sListSelStmts.add("from[" + strChangeAffectedItem + "].to.name");
            sListSelStmts.add("from[" + strChangeAffectedItem + "].to.type");
            sListSelStmts.add("from[" + strChangeAffectedItem + "].to.revision");
            sListSelStmts.add("from[" + strChangeAffectedItem + "].to.policy");
            sListSelStmts.add("from[" + strChangeAffectedItem + "].to.current");
            sListSelStmts.add("from[" + strChangeAffectedItem + "].attribute[Requested Change].value");

            StringList selectRelStmts = new StringList(1);
            selectRelStmts.addElement(SELECT_RELATIONSHIP_ID);

            mpAffectedPartList = getRelatedObjects(context, strChangeAction, // relationship pattern
                    "*", // object pattern
                    sListSelStmts, // object selects
                    selectRelStmts, // relationship selects
                    false, // to direction
            ...
            StringList slAINames;
            StringList slAITypes;
            StringList slAIRevs;
            StringList slAIStates;
            StringList slAIPolicy;
            StringList slAIReqChanges;
            while (objItr.hasNext()) {
                partMap = (Map) objItr.next();
                ...
                String pMST = FrameworkUtil.findAndReplace((String) partMap.get(SELECT_TYPE), " ", "_");

                slAINames = ChangeUtil.getListValue(partMap, "from[" + strChangeAffectedItem + "].to.name");
                slAITypes = ChangeUtil.getListValue(partMap, "from[" + strChangeAffectedItem + "].to.type");
                slAIRevs = ChangeUtil.getListValue(partMap, "from[" + strChangeAffectedItem + "].to.revision");
                slAIPolicy = ChangeUtil.getListValue(partMap, "from[" + strChangeAffectedItem + "].to.policy");
                slAIStates = ChangeUtil.getListValue(partMap, "from[" + strChangeAffectedItem + "].to.current");
                slAIReqChanges = ChangeUtil.getListValue(partMap, "from[" + strChangeAffectedItem + "].attribute[Requested Change].value");

                int size = slAINames.size();

                for (int i = 0; i < size; i++) {
                    newParts.append("<tr>");
                    newParts.append("<td>" + partMap.get(SELECT_NAME) + "</td>");
                    newParts.append("<td>" + slAINames.get(i) + "</td>");
                    newParts.append("<td>" + EnoviaResourceBundle.getTypeI18NString(context, (String) slAITypes.get(i), strLanguage) + "</td>");
                    newParts.append("<td>" + slAIRevs.get(i) + "</td>");
                    newParts.append("<td>" + EnoviaResourceBundle.getStateI18NString(context, (String) slAIPolicy.get(i), (String) slAIStates.get(i), strLanguage) + "</td>");
                    newParts.append("<td>" + EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(),
                            "emxFramework.Range.Requested_Change." + ((String) slAIReqChanges.get(i)).replaceAll(" ", "_")) + "</td>");
                    newParts.append("</tr>");
                }
            }
            ...
            if (mpAffectedPartList.size() == 0) {
                newParts.append("<tr><td colspan=\"12\">"
                        + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Change.NoAffectedItemsConnected") + "</td></tr>");
            }
        } catch (FrameworkException Ex) {
            throw Ex;
        }
    ...
    public String getChangeTasks(Context context, String[] args) throws Exception, MatrixException {
        try {
            String strLanguage = context.getSession().getLanguage();
            String objectId = args[0];
            ...
            if (taskList.size() == 0) {
                routeInfo.append("<tr><td colspan=\"6\">"
                        + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.TaskSummary.NoTasksFound") + ""
                        + "&nbsp;</td></tr>");
            }
    ...
    public String getChangeRoutes(Context context, String[] args) throws Exception, MatrixException {
        try {
            String strLanguage = context.getSession().getLanguage();
            String objectId = args[0];
            Route routeObj = (Route) DomainObject.newInstance(context, TYPE_ROUTE);
            ...
            if (totalResultList.size() == 0) {
                routeInfo.append("<tr><td colspan=\"6\">"
                        + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Common.NoObjectsFound") + "</td></tr>");
            }
            routeInfo.append("</table>");
            return routeInfo.toString();
        } catch (Exception ex) {
    ...
    public String getChangeApprovals(Context context, String args[]) throws Exception {
                ...
                for (int rteCnt = 0; rteCnt < routes.size(); rteCnt++) {
                    ...
                    if (!strListRouteCheck.contains(sRouteId)) {
                        ...
                        if ((rteCnt == 0)) {
                            ...
                            sStateName = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(),
                                    "emxFramework.State." + sPolicy.replaceAll(" ", "_") + "." + sStateName);
                        ...
                        if (sRouteStatus != null && !sRouteStatus.equals(strRouteStatus)) {
                            for (int k = 0; k < mpListOfTasks.size(); k++) {
                                ...
                                if (k > 0) {
                                    ...
                                    returnString.append("<tr >");
                                    returnString.append("<td valign=\"top\" class=\"listCell\" style=\"text-align: \">&nbsp</td>");
                                    returnString.append("<td> </td>");
                            ...
                            StringList listPersonName = routeObj.getInfoList(context, "from[" + RELATIONSHIP_ROUTE_NODE + "].to.name");
                            for (int i = 0; i < listPersonName.size(); i++) {
                                sPersonName = (String) listPersonName.get(i);
                                if (sPersonName == null || "null".equals(sPersonName) || "".equals(sPersonName)) {
                                    sPersonName = " ";
                                }
                                if (sPersonName != null && sPersonName.trim().length() > 0 && sPersonName.indexOf("auto_") == -1) {
                                ...
                                returnString.append("<td>" + sPersonName + "</td>");
                                returnString.append("<td>&nbsp </td>");
                                returnString.append("<td> &nbsp</td>");
                                returnString.append("</tr>");
                            }
                        }
        ...
        if (bRouteSize == false && bSign == false) {
            returnString.append("<tr><td class=\"even\" colspan=\"3\" align=\"center\" >"
                    + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.SummaryReport.NoSignOrRoutes") + "</td></tr>");
        }
    ...
    public String generateCAHtmlSummaryReport(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            summaryReport.append("<table width=\"100%\"><tr><td class=\"subhead\"><h2>"
                    + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Command.ImplementedItems")
                    + "</h2></td></tr></table>");
    ...
    public String getCAImplementedItems(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        ...
        try {
            ...
            String strRelationType = ChangeConstants.RELATIONSHIP_IMPLEMENTED_ITEM;
            ...
            if (specList.size() == 0) {
                specs.append("<tr><td colspan=\"6\">"
                        + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Change.NoImplementedItemsConnected")
                        + "</td></tr>");
            }
        } catch (FrameworkException Ex) {
            throw Ex;
    ...
    public String getCABasicInfo(Context context, String args[]) throws Exception {
        ...
        String sRelSrTechAssignee = PropertyUtil.getSchemaProperty(context, "relationship_SeniorTechnicalAssignee");
        ...
        objectSelects.add("from[" + sRelSrTechAssignee + "].to.name");
        ...
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Common.Name")
                + ":</td><td class=\"inputField\">" + attributeMap.get(SELECT_NAME) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.Type")
                + ":</td><td class=\"inputField\">" + EnoviaResourceBundle.getTypeI18NString(context, (String) attributeMap.get(SELECT_TYPE), strLanguage) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.State")
                + ":</td><td class=\"inputField\">" + i18nNow.getStateI18NString((String) attributeMap.get(SELECT_POLICY), (String) attributeMap.get(SELECT_CURRENT), strLanguage) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.Owner")
                + ":</td><td class=\"inputField\">" + PersonUtil.getFullName(context, ((String) attributeMap.get(SELECT_OWNER))) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.ORIGINATOR")
                + ":</td><td class=\"inputField\">" + PersonUtil.getFullName(context, ((String) attributeMap.get(SELECT_ORIGINATOR))) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.ORIGINATED")
                + ":</td><td class=\"inputField\">" + (String) attributeMap.get(SELECT_ORIGINATED) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.MODIFIED")
                + ":</td><td class=\"inputField\">" + (String) attributeMap.get(SELECT_MODIFIED) + "</td></tr>");

        returnString.append("</table></td>");
        returnString.append("<td><table width=\"100%\" border=\"0\" cellpadding=\"3\" cellspacing=\"0\" >");
        returnString
                .append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Common.Description")
                        + ":</td><td class=\"inputField\">" + ecoDesc + "&nbsp;</td></tr>");
        ...
        String techSrAssignee = (String) attributeMap.get("from[" + sRelSrTechAssignee + "].to.name");
        ...
        returnString.append(
                "<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.ResponsibleOrganisation")
                        + ":</td><td class=\"inputField\">" + (String) attributeMap.get(SELECT_ORGANIZATION) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.GoverningCO")
                + ":</td><td class=\"inputField\">" + COName + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.GoverningCR")
                + ":</td><td class=\"inputField\">" + CRName + "</td></tr>");
        returnString
                .append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Common.TechAssignee")
                        + ":</td><td class=\"inputField\">" + techAssignee + "</td></tr>");
        returnString.append(
                "<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.SrTechnicalAssignee")
                        + ":</td><td class=\"inputField\">" + techSrAssignee + "</td></tr>");

        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.Policy")
                + "</strong>:&nbsp;</td><td class=\"inputField\">" + sPolicy + "</td></tr>");

        // returnString.append("<tr><td class=\"label\">"+EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource",
        // context.getLocale(),"emxComponents.Form.Label.ApprovalList")+"</strong>:&nbsp;</td><td class=\"inputField\">"+strApprovalRoute+"</td></tr>");
        returnString.append(
                "<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.TechnicalApproversList")
    ...
    public String getCAAffectedItems(Context context, String[] args) throws Exception {
        String strLanguage = context.getSession().getLanguage();
        String objectId = args[0];
        MapList specList = new MapList();
        StringBuffer specs = new StringBuffer();
        ...
        try {
            ...
            String strRelationType = ChangeConstants.RELATIONSHIP_CHANGE_AFFECTED_ITEM;
    ...
    public int renderPDFFileForChange(Context context, String[] args, String summaryReport) throws Exception {
    ...
    public String getCOBasicInfo(Context context, String args[]) throws Exception {
        ...
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.Type")
                + ":</td><td class=\"inputField\">" + EnoviaResourceBundle.getTypeI18NString(context, (String) attributeMap.get(SELECT_TYPE), strLanguage) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.State")
                + ":</td><td class=\"inputField\">" + EnoviaResourceBundle.getStateI18NString(context, (String) attributeMap.get(SELECT_POLICY), (String) attributeMap.get(SELECT_CURRENT), strLanguage)
                + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.Owner")
                + ":</td><td class=\"inputField\">" + com.matrixone.apps.domain.util.PersonUtil.getFullName(context, ((String) attributeMap.get(SELECT_OWNER))) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.ORIGINATOR")
                + ":</td><td class=\"inputField\">" + com.matrixone.apps.domain.util.PersonUtil.getFullName(context, ((String) attributeMap.get(SELECT_ORIGINATOR))) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.ORIGINATED")
                + ":</td><td class=\"inputField\">" + (String) attributeMap.get(SELECT_ORIGINATED) + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.MODIFIED")
                + ":</td><td class=\"inputField\">" + (String) attributeMap.get(SELECT_MODIFIED) + "</td></tr>");
        ...
        String strChange = isKindOf(context, ChangeConstants.TYPE_CHANGE_REQUEST) ? (String) attributeMap.get("from[" + sRelChangeOrder + "].to.name")
                : (String) attributeMap.get("to[" + sRelChangeOrder + "].from.name");
        strChange = UIUtil.isNotNullAndNotEmpty(strChange) ? strChange : "";
        String DisplayChangeLabel = isKindOf(context, ChangeConstants.TYPE_CHANGE_REQUEST)
                ? EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.RelatedCO")
                : EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.RelatedCR");

        returnString.append("<tr><td class=\"label\">" + DisplayChangeLabel + ":</td><td class=\"inputField\">" + strChange + "</td></tr>");
        returnString.append(
                "<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.ChangeCoordinator")
                        + ":</td><td class=\"inputField\">" + strChangeCoordinator + "</td></tr>");
        returnString.append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.Policy")
                + "</strong>:&nbsp;</td><td class=\"inputField\">" + sPolicy + "</td></tr>");

        returnString
                .append("<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.ReviewersList")
                        + "</strong>:&nbsp;</td><td class=\"inputField\">" + strReviewalRoute + "</td></tr>");
        if (!isKindOf(context, ChangeConstants.TYPE_CHANGE_REQUEST))
            returnString.append(
                    "<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.ApprovalList")
                            + "</strong>:&nbsp;</td><td class=\"inputField\">" + strApprovalRoute + "</td></tr>");

        returnString.append(
                "<tr><td class=\"label\">" + EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Label.DistributionList")
    ...
    public Vector showHTMLReportIconforStructureBrowser(Context context, String args[]) throws FrameworkException {
        ...
        try {
            ...
            String strSummaryReport = EnoviaResourceBundle.getProperty(context, SUITE_KEY, "EnterpriseChangeMgt.Label.SummaryReport", context.getSession().getLanguage());
