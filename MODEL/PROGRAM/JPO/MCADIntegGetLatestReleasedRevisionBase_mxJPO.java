...
/*
 ** MCADIntegGetLatestReleasedRevisionBase
 **
...
public class MCADIntegGetLatestReleasedRevisionBase_mxJPO {
    ...
    public MCADIntegGetLatestReleasedRevisionBase_mxJPO() {
    }

    public MCADIntegGetLatestReleasedRevisionBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    public Hashtable getLatestForObjectIds(Context context, String[] args) throws Exception {
        ...
        retTable = util.getObjectIdForParticularView(context, "state_Release", args);
        return retTable;
    }
}
