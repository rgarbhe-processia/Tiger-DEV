...
/*
 ** emxServicecommonInitiateRoute.java
 **
...
public class emxServicecommonInitiateRoute_mxJPO {
    ...
    public emxServicecommonInitiateRoute_mxJPO(Context context, String[] args) throws Exception {
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - String which contains Type of object 1 - String which contains Name of object 2 - String which contains Revision of object 3 - int which
     *            contains RouteSequence value 4 - int which contains ErrorOnNoConnection value
        ...
        try {
            ...
            for (int i = 0; i < sRouteObjectsMaplist.size(); i++) {
                ...
                sBufRouteObjects.append(
                        mapRouteObjects.get(DomainConstants.SELECT_TYPE) + " " + mapRouteObjects.get(DomainConstants.SELECT_NAME) + "" + mapRouteObjects.get(DomainConstants.SELECT_REVISION) + "\n");
            }
            ...
            while (bGreaterSeqNoFound == 1) {
                ...
                for (int i = 0; i < routedNodeObjects.size(); i++) {
                    ...
                    if (routeSequence == sRouteSequenceValue) {
                        ...
                        strTreeMenu = MqlUtil.mqlCommand(context, "get env global MX_TREE_MENU");
                        sTreeMenu[0] = strTreeMenu;
                        if (!strTreeMenu.equals("")) {
                            MqlUtil.mqlCommand(context, "set env global MX_TREE_MENU " + strTreeMenu + "");
                        }
                        // Create a Inbox Task
                        ...
                        strMQL.append(typeTask);
                        strMQL.append("' '' '");
                        strMQL.append(policy);
                        strMQL.append("' 'Null' ");
                        commandInbox.executeCommand(context, strMQL.toString());
                        ...
                        if (!sAbsenceDelegate.equals("") && sAllowDelegation.equals("TRUE")) {
                            ...
                            MapList absenceMap = DomainObject.findObjects(context, sTypePerson, sPersonName, "*", "*", sPersonVault, strWhere.toString(), false, objectSelects1);
                            ...
                            if (absenceMap.size() != 0) {
                                ...
                                strMQL = new StringBuffer(50);
                                strMQL.append("modify connection ");
                                strMQL.append(sRouteNodeId);
                                strMQL.append(" to ");
                                strMQL.append(sDelegatorId);
                                strMQL.append("");
                                updateCommand.executeCommand(context, strMQL.toString());
                                ...
                                /*
                                 * Grant access to the route and route objects to new person based on access to original assignee. Do this by looking up grants from 'Workspace Access Grantor' and
                                 * granting to new user using 'Route Delegation Grantor'.
                                 */
                        ...
                        if ((sRPEType.equals(sInboxTaskType)) && sRouteTaskUser != "") {
                        ...
                        } else if (!(sRPEType.equals(sInboxTaskType)) && sRouteTaskUser != "") {
                            if (sRouteObjects == "") {
                        ...
                        } else if (sRPEType != sInboxTaskType && sRouteTaskUser == "") {
                            if (sRouteObjects == "") {
                                if (sDelegatorId == "") {
