...
public class CFPModelBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    private static final String cellIdSelect = "to[" + ManufacturingPlanConstants.RELATIONSHIP_LOGICAL_FEATURES + "].tomid[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST
            + "].from.id";

    private static final String cellrelIdSelect = "to[" + ManufacturingPlanConstants.RELATIONSHIP_LOGICAL_FEATURES + "].tomid[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST + "].id";

    private static final String cellusageAttribute = "to[" + ManufacturingPlanConstants.RELATIONSHIP_LOGICAL_FEATURES + "].tomid[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST
     ...
     * @author IVU
     */
    public CFPModelBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    /**
     * This method gets the range of values for the displayed Design effectivity Matrix cell values
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds input arguments.
     * @return a StringList containing the range option values to display Design effectivity Matrix cell values combo box.
     * @throws Exception
     *             if the operation fails
     */
    ...
    /*
     * Builds the html for the cell value. this method is used in getRowsForDesignEffectivityMatrix and getCellvalueJPO;
     */
    private void processCellIdrowMap(Context context, Map mapCellIDValues, String cellId, Map rowmap, String strUsage, String url, boolean isFrozen) throws FrameworkException {

        try {
            boolean isCFPLicense = ManufacturingPlanUtil.isCFPUser(context);
            ...
            if (mapCellIDValues.containsKey(cellId)) {
                if (!strUsage.equalsIgnoreCase("")) {
                    String strcellval = ((String) mapCellIDValues.get(cellId)).replaceFirst("</table>", "<tr><td>" + strName + "</td><td>(" + strUsage + ")</td></tr></table>");
                    if (!isFrozen) {
                        ...
                        mapCellIDValues.put(cellId, strcellval.replaceFirst("rowspan=\"" + strrowSpanValue + "\"", "rowspan=\"" + (Integer.parseInt(strrowSpanValue) + 1) + "\""));
                    } else {
                    ...
                    if (isFrozen) {
                        ...
                        if (isCFPLicense) {
                            mapCellIDValues.put(cellId,
                                    "<table><tr><td>" + strName + "</td><td>(" + strUsage + ")</td><td  style=\"vertical-align:middle;text-align:center;\" rowspan=\"1\" >" + " <a href=\"" + url
                                            + "\" >" + "<img src=\"../common/images/iconActionEdit.gif\" border=\"0\" alt=\""
                                            + EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.Heading.EditDesignEffectivity", languageStr) + "\"/></a></td></tr></table>");
                        } else {
                            mapCellIDValues.put(cellId,
                                    "<table><tr><td>" + strName + "</td><td>(" + strUsage + ")</td><td  style=\"vertical-align:middle;text-align:center;\" rowspan=\"1\" >" + "</td></tr></table>");
                        }
                    }
                } else {
                    if (isFrozen) {
                        ...
                        if (isCFPLicense) {
                            mapCellIDValues.put(cellId,
                                    "<table><tr><td  style=\"vertical-align:middle;text-align:center;\" rowspan=\"1\" >" + " <a href=\"" + url + "\" >"
                                            + "<img src=\"../common/images/iconActionEdit.gif\" border=\"0\" alt=\""
                                            + EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.Heading.EditDesignEffectivity", languageStr) + "\"/></a></td></tr></table>");
                        } else {
                            mapCellIDValues.put(cellId,
    ...
    /**
     * Update the Design effectivity Matrix cell values. Design effectivity Matrix cell values
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds input arguments.
    ...
    public String updateFeatureUsageforGrid(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (!"Del".equalsIgnoreCase(strNewValue)) {
                ...
                StringList attributeDisplayRange = i18nNow.getAttrRangeI18NStringList(ManufacturingPlanConstants.ATTRIBUTE_FEATURE_ALLOCATION_TYPE, slObjectList, context.getSession().getLanguage());
    ...
    /*
     * Builds the html for the cell value when Export to excel and printer friendly. this method is used in getRowsForDesignEffectivityMatrix;
     */

    private void processCellIdrowMapForReport(Context context, Map mapCellIDValues, String cellId, Map rowmap, String strUsage, String ReportType) throws FrameworkException {
        try {
            String strName = rowmap.get("attribute[" + ManufacturingPlanConstants.ATTRIBUTE_MARKETING_NAME + "]") + " " + rowmap.get(DomainConstants.SELECT_REVISION);
    ...
    /**
     * This method gets the range of values for the displayed Products Usage feild.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds input arguments.
     * @return a StringList containing the range option values to display Product Feature List Usage combo box.
     * @throws Exception
     *             if the operation fails
            ...
            if (strobjId != null) {
                if (strNewValue != null && !"".equalsIgnoreCase(strNewValue)) {
                    ...
                    if (relMap.containsKey("to[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCTS + "].id")) {
                        domainrelation.setAttributeValue(context, (String) relMap.get("to[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCTS + "].id"),
                                ManufacturingPlanConstants.ATTRIBUTE_FEATURE_ALLOCATION_TYPE, strNewValue);
                    } else {
                        domainrelation.setAttributeValue(context, (String) relMap.get("to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_PRODUCT + "].id"),
                                ManufacturingPlanConstants.ATTRIBUTE_FEATURE_ALLOCATION_TYPE, strNewValue);
                    }
                }
            }
    ...
    public static StringList getMasterCompositionUsage(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            String strUsageSelect = "to[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCTS + "].attribute[" + ManufacturingPlanConstants.ATTRIBUTE_FEATURE_ALLOCATION_TYPE + "]";
            String strUsageSelect2 = "to[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_PRODUCT + "].attribute[" + ManufacturingPlanConstants.ATTRIBUTE_FEATURE_ALLOCATION_TYPE + "]";
            StringList slObjSelects = new StringList(DomainConstants.SELECT_ID);
            slObjSelects.add("to[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCTS + "].attribute[" + ManufacturingPlanConstants.ATTRIBUTE_FEATURE_ALLOCATION_TYPE + "]");
    ...
    /**
     * gets rows for the Design effevtivity grid and pass it on to GridComponent Design effectivity Matrix
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds input arguments.
    ...
    public MapList getRowsForDesignEffectivityMatrix(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            for (int i = 0; i < rowList.size(); i++) {
                ...
                if (iLevelTemp == 1 && ManufacturingPlan.getDerivedMap(context, ManufacturingPlanConstants.TYPE_MODEL).contains(strType)) {
                ...
                } else if (iLevelTemp > 1 && ManufacturingPlan.getDerivedMap(context, ManufacturingPlanConstants.TYPE_MODEL).contains(strType)) {
                    // No models greater than level 1 and their respective products.
                    isModelRemoved = true;
                    continue;
                } else if (iLevelTemp > 1 && strObjectId != null && isModelRemoved && ManufacturingPlan.getDerivedMap(context, ManufacturingPlanConstants.TYPE_PRODUCTS).contains(strType)) {
                    ...
                    if (strObjectId != null && tempMap.get(cellIdSelect) != null) {
                        if (tempMap.get(cellIdSelect) instanceof StringList) {
                            ...
                            for (int j = 0; j < listSelect.size(); j++) {
                                ...
                                if (strReportFormat != null && strReportFormat.length() > 0) {
                                    processCellIdrowMapForReport(context, mapCellIDValues, strobject, tempMap,
                                            (String) usageshortMap.get((String) ((StringList) tempMap.get(cellusageAttribute)).get(j)), strReportFormat);
                                } else {
                                    boolean isFrozen = ManufacturingPlanUtil.isFrozenState(context, strobject);
                                    processCellIdrowMap(context, mapCellIDValues, strobject, tempMap, (String) usageshortMap.get((String) ((StringList) tempMap.get(cellusageAttribute)).get(j)),
                            ...
                            if (strReportFormat != null && strReportFormat.length() > 0) {
                                ...
                                processCellIdrowMap(context, mapCellIDValues, (String) tempMap.get(cellIdSelect), tempMap, (String) usageshortMap.get((String) tempMap.get(cellusageAttribute)),
    ...
    private MapList getModelDerivationStructure(Context context, String strObjectID, String strSelectId) throws Exception {
        ...
        try {
            ...
            if (strSelectId != null && !"".equalsIgnoreCase(strSelectId)) {
                ...
                colList = new DomainObject(strObjectID).getRelatedObjects(context, stbRelName.toString(), ManufacturingPlanConstants.TYPE_PRODUCTS, strListSelectstmts, new StringList(), false, true,
    ...
    private String buildIconforemptyCell(String url, Context context) throws FrameworkException {
        ...
        String cellvalue = "";
        if (isCFPLicense) {
            cellvalue = "<table><tr><td style=\"vertical-align:middle;text-align:center;\" >" + " <a href=\"" + url + "\" >" + "<img src=\"../common/images/iconActionEdit.gif\" border=\"0\" alt=\""
                    + EnoviaResourceBundle.getProperty(context, SUITE_KEY, "DMCPlanning.Heading.EditDesignEffectivity", context.getSession().getLanguage()) + "\"/></a></td></tr></table>";
        } else {
            cellvalue = "<table><tr><td style=\"vertical-align:middle;text-align:center;\" >" + "</td></tr></table>";
        }
        return cellvalue;
    }
    ...
    private String buildURL(Context context, String rowId, String columnId, String strParentID) {
        ...
        String strURL = "JavaScript:showModalDialog(\'../common/emxGridTable.jsp?table=CFPEditEffectivityGridTable" + "&amp;rowJPO=CFPModel:getRowsforEditEffectivityGrid"
                + "&amp;expandLevelFilterMenu=FTRExpandAllLevelFilter" + "&amp;colJPO=CFPModel:getColumnsforEditEffectivityGrid" + "&amp;freezePane=Name,Revision,Usage,State"
                + "&amp;Registered Suite=DMCPlanning" + "&amp;suiteKey=DMCPlanning" + "&amp;header=DMCPlanning.Heading.EditDesignEffectivity" + "&amp;mode=edit"
                ...
                + "&amp;cellRangeJPO=CFPModel:getPFLUsageRange&amp;cellUpdateJPO=CFPModel:updateFeatureUsageforGrid" + "&amp;objectId=" + rowId + "&amp;selectId=" + columnId + "&amp;parentOID="
                + strParentID + "&amp;SuiteDirectory=dmcplanning" + "&amp;cancelProcessJPO=CFPModel:getCellvalueJPO" + "\',\'\',\'\',\'true\',\'Medium\')";

        return strURL;
    }

    /**
     * gets Column for the Design effevtivity grid and pass it on to GridComponent Design effectivity Matrix
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds input arguments.
    ...
    private MapList getModelMasterCompositionStructure(Context context, String strObjectID, String strParentID) throws Exception {
        ...
        try {
            ...
            // Where Clause
            String objectWhere = "(to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "] || to[" + ManufacturingPlanConstants.RELATIONSHIP_PRODUCTS + "].from.to["
                    + ManufacturingPlanConstants.RELATIONSHIP_MODEL_MASTER_FEATURES + "].from.id == " + strParentID + " || " + "to[" + ManufacturingPlanConstants.RELATIONSHIP_MODEL_MASTER_FEATURES
                    + "].from.id == " + strParentID + "" + ")";

            // Get the objects
            relBusObjPageList = new DomainObject(strObjectID).getRelatedObjects(context, stbRelName.toString(), stbTypeName.toString(), objectSelects, relSelects, false, true, (short) 0, objectWhere,
    ...
    /**
     * gets rows for the Design effevtivity grid and pass it on to GridComponent for editing the cell value in the Design effectivity matrix
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds input arguments.
    ...
    public MapList getRowsforEditEffectivityGrid(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            rowList = new DomainObject(ObjectId).getRelatedObjects(context, stbRelName.toString(), ManufacturingPlanConstants.TYPE_PRODUCTS, strListSelectstmts,
                    new StringList(DomainConstants.SELECT_RELATIONSHIP_ID), false, true, (short) 0, "", "", 0);
            ...
            for (int i = 0; i < rowList.size(); i++) {
                ...
                if (tempmap.get(DomainConstants.SELECT_LEVEL) != null) {
                    ...
                    if (tempmap.get(cellIdSelect) != null) {
                        ...
                        StringList attributeDisplayRange = i18nNow.getAttrRangeI18NStringList(ManufacturingPlanConstants.ATTRIBUTE_FEATURE_ALLOCATION_TYPE, slObjectList,
    ...
    /**
     * gets column for the Design effevtivity grid and pass it on to GridComponent for editing the cell value in the Design effectivity matrix
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds input arguments.
    ...
    public HashMap getCellvalueJPO(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            String objectWhere = " (to[" + ManufacturingPlanConstants.RELATIONSHIP_MODEL_MASTER_FEATURES + "] || to[" + ManufacturingPlanConstants.RELATIONSHIP_DERIVED + "] || to["
                    + ManufacturingPlanConstants.RELATIONSHIP_PRODUCTS + "].from.to[" + ManufacturingPlanConstants.RELATIONSHIP_MODEL_MASTER_FEATURES + "].from.id == " + strParentID + ")";
            ...
            stbRelName.append(",");
            stbRelName.append(ManufacturingPlanConstants.RELATIONSHIP_DERIVED);
            MapList rowList = new DomainObject(strObjectID).getRelatedObjects(context, stbRelName.toString(), ManufacturingPlanConstants.TYPE_PRODUCTS, strListSelectstmts,
                    new StringList(DomainConstants.SELECT_RELATIONSHIP_ID), false, true, (short) 0, objectWhere, "", 0);
                    ...
                    if (tempmap.get(cellIdSelect) != null) {
                        if (tempmap.get(cellIdSelect) instanceof StringList) {
                            ...
                            if (cellIndex > -1) {
                                ...
                                processCellIdrowMap(context, mapCellIDValues, strObjectID, tempmap, (String) usageshortMap.get(strCellVal), strUrl, false);
                            }
                        } else {
                            if (strselectId.equalsIgnoreCase((String) tempmap.get(cellIdSelect))) {
                                processCellIdrowMap(context, mapCellIDValues, strObjectID, tempmap, (String) usageshortMap.get((String) tempmap.get(cellusageAttribute)), strUrl, false);
                            } else {
                                String strUsage1 = "";
    ...
    public MapList getManufacturingPlanRevision(Context context, String[] args) throws FrameworkException {
     ...
     * @return MapList - Contains the Products, Features objects
     * @throws Exception
     *             if the operation fails
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getManagedRevisions(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList MapProductlist = domObject.getRelatedObjects(context, strRelPattern.toString(), strTypePattern, slObjSelects, slRelSelects, false, true, (short) iLevel, DomainObject.EMPTY_STRING,
                    DomainObject.EMPTY_STRING, (short) iLimit, DomainObject.CHECK_HIDDEN, DomainObject.PREVENT_DUPLICATES, (short) DomainObject.PAGE_SIZE, null, null, null, DomainObject.EMPTY_STRING,
     ...
     * @param args
     *            - Holds the following arguments 0 - HashMap containing the following arguments
     * @return MapList - Contain the Models
     * @throws Exception
     *             if the operation fails
    ...
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getMasterComposition(Context context, String[] args) throws Exception {
