...
/*
 * emxEngineeringConfiguredPartMigrationBase.java program migrates Existing PUEECO and its appicability attribute to NE object and set the expression
 *
...
public class emxEngineeringConfiguredPartMigrationBase_mxJPO extends emxCommonMigration_mxJPO {
     ...
     * @grade 0
     */
    public emxEngineeringConfiguredPartMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public void migrateObjects(Context context, StringList objectIdList) throws Exception {
        ...
        if (listSize > 0) {
            ...
            MqlUtil.mqlCommand(context, "mod rel $1 to add type $2", strRelEffectivityContext, strTypeProducts);
            ...
            try {
                ...
                for (int i = 0; i < listSize; i++) {
                    ...
                    if (hsetobjectIdList.add(objectId)) {
                        ...
                        listEBOMAndEBOMPendingData = domObj.getRelatedObjects(context, relationship, DomainConstants.QUERY_WILDCARD, null, relSelect, false, true, (short) 1, null, null, null, null,
                                null);
                ...
                MqlUtil.mqlCommand(context, "mod rel $1 to remove type $2", strRelEffectivityContext, strTypeProducts);
            }
        }
    }
    ...
    class ConfiguredPartMigration {
        ...
        public void setPendingAndCurrentOperations() throws Exception {
            if (isNotNullAndNotEmpty(this.applicabilityDetailsTransXML)) {
                this.doc = UnresolvedPart.getXMLDoc(this.applicabilityDetailsTransXML);
         ...
         * 
         * if (this._PENDING_OPERATION_ChangeID_LIST.size() > 1) { Element elePedingOrCurrent = root.getChild("Pending");
         * 
         * if (elePedingOrCurrent != null) { List childern = elePedingOrCurrent.getChildren();
         * 
         * if (childern != null) { Element elementAddCut; Iterator itr = childern.iterator(); String temp; String changeType; String changeName; String changeRev; String applicability; int i = 0;
         * 
         * while (itr.hasNext()) {
         * 
         * if (i == 0) { i = 1; continue; }
         * 
         * elementAddCut = (Element) itr.next(); changeType = elementAddCut.getChild("ECO").getAttributeValue("TYPE"); changeName = elementAddCut.getChild("ECO").getAttributeValue("NAME"); changeRev =
         * elementAddCut.getChild("ECO").getAttributeValue("REVISION"); applicability = elementAddCut.getChild("APPLICABILITY").getText(); temp = changeType + SYMB_COMMA + changeName + SYMB_COMMA +
         * changeRev + SYMB_COMMA + applicability;
         * 
         * 
         * } } } } }
         */
