...
/**
 * The <code>emxProjectManagement</code> class represents the Project Management JPO functionality for the AEF type.
...
public class emxCommonProjectManagement_mxJPO extends emxCommonProjectManagementBase_mxJPO {
     ...
     * @grade 0
     */
    public emxCommonProjectManagement_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
     ...
     * @since 10.0.0.0
     */
    public emxCommonProjectManagement_mxJPO(String id) throws Exception {
