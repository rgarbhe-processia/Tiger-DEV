...
/**
 * The <code>emxQuestion</code> class represents the Question JPO functionality for the AEF type.
...
public class emxQuestion_mxJPO extends emxQuestionBase_mxJPO {
     ...
     * @grade 0
     */
    public emxQuestion_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
