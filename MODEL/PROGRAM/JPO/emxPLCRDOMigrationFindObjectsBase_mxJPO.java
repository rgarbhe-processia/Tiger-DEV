...
public class emxPLCRDOMigrationFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO {
     ...
     * @grade 0
     */
    public emxPLCRDOMigrationFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public void getIds(Context context, int chunkSize) throws Exception {
        ...
        String whereClause = "(to[" + DomainConstants.RELATIONSHIP_DESIGN_RESPONSIBILITY + "]==true) && " + "(program[" + migrationProgramName + " -method writeOID ${OBJECTID} \"${TYPE}\"] == true)";
