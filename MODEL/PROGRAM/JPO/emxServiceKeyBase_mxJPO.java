...
public class emxServiceKeyBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    /**
     * getExpirationDateStatusIcon - gets the status gif to be shown in the column of the Service Key Summary table
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public Vector getExpirationDateStatusIcon(Context context, String[] args) throws Exception {
        try {
            ...
            while (objectListItr.hasNext()) {
                ...
                if (strExpirationDate != null && !strExpirationDate.equals("") && curDate.before(com.matrixone.apps.domain.util.eMatrixDateFormat.getJavaDate(strExpirationDate))) {
    ...
    public MapList getServices(Context context, String[] args) throws Exception {
        ...
        MapList mapServiceList = boKey.expandSelect(context, sRelServiceAccess, sTypeWebService, busSelects, relSelects, false, true, (short) 1, "", "", null, false);
    ...
    public MapList getServiceFolders(Context context, String[] args) throws Exception {
        ...
        MapList mapServiceFolderList = boKey.expandSelect(context, sRelServiceAccess, sTypeServiceFolder, busSelects, relSelects, false, true, (short) 1, "", "", null, false);
     ...
     * @param args
     * @return a <code>HashMap</code> contains Action (CONTINUE or STOP) and Message (error message)
     * @throws Exception
    ...
    protected MapList getGlobalSearchRelObjects(matrix.db.Context context, String objectId, String relName, String typeName, String busWhere, String sQueryLimit, String fieldSep, String recordSep)
        ...
        String strResult = MqlUtil.mqlCommand(context, "expand bus $1 from relationship $2 type $3 select bus id where $4 dump $5 recordsep $6 terse limit $7", objectId, relName, typeName, busWhere,
                fieldSep, recordSep, sQueryLimit);
