...
public class emxTeamAccessBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @since Team 10-5
     */
    public emxTeamAccessBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    protected StringList getInstalledSuites(Context context, String[] args) throws Exception {
        try {
    ...
    /**
     * isSourcingInstalled - This method is used to determine if SourcingCentral is installed.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            empty
     ...
     * @since Team 10-5
     */
    public boolean isSourcingInstalled(Context context, String[] args) throws Exception {
    ...
    /**
     * isEngineeringInstalled - This method is used to determine if EngineeringCentral is installed.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            empty
     ...
     * @since Team 10-5
     */
    public boolean isEngineeringInstalled(Context context, String[] args) throws Exception {
        StringList slInstalledSuites = getInstalledSuites(context, args);
