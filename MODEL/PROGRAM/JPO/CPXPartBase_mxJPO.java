 ...
 **
 ** This program contains proprietary and trade secret information of MatrixOne, Inc. Copyright notice is precautionary only and does not evidence any actual or intended publication of such program.
 **
 **
 */
...
public class CPXPartBase_mxJPO extends DomainObject {
    ...
    public Boolean isComponentAuthor(Context context, String[] args) throws Exception {
    ...
    public Boolean isAnyComponentUser(Context context, String[] args) throws Exception {
        Vector roles = PersonUtil.getUserRoles(context);
        boolean flag = false;
        for (int i = 0; i < roles.size(); i++) {
            String role = (String) roles.get(i);
            if (role.equals(CPCConstants.ROLE_COMPONENTAUTHOR) || role.equals(CPCConstants.ROLE_COMPONENTUSER) || role.equals(CPCConstants.ROLE_COMPONENTQUALENGINEER)) {
                flag = true;
            }
    ...
    public StringList getMEPart(Context context, String[] args) throws Exception {
    ...
    public StringList getManufacturer(Context context, String[] args) throws Exception {
        StringList objlist = new StringList();
        try {
    ...
    public StringList getMEPQualification(Context context, String[] args) throws Exception {
    ...
    public StringList getMEPPreferenceScore(Context context, String[] args) throws Exception {
        StringList qualificationList = new StringList();
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            Map paramList = (HashMap) paramMap.get("paramList");
    ...
    public StringList getMEPQualStatus(Context context, String[] args) throws Exception {
        StringList qualificationList = new StringList();
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            Map paramList = (HashMap) paramMap.get("paramList");
    ...
    public StringList getSEPart(Context context, String[] args) throws Exception {
    ...
    public StringList getSupplier(Context context, String[] args) throws Exception {
        StringList objlist = new StringList();
        try {
    ...
    public StringList getSEPQualification(Context context, String[] args) throws Exception {
        StringList qualificationList = new StringList();
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            Map paramList = (HashMap) paramMap.get("paramList");
    ...
    public StringList getSEPPreferenceScore(Context context, String[] args) throws Exception {
        StringList qualificationList = new StringList();
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            Map paramList = (HashMap) paramMap.get("paramList");
    ...
    public StringList getSEPQualStatus(Context context, String[] args) throws Exception {
        StringList qualificationList = new StringList();
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            Map paramList = (HashMap) paramMap.get("paramList");
    ...
    public StringList getEPInfoHTMLOutput(Context context, String[] args, String id) throws Exception {
    ...
    public MapList getRelatedSEPs(Context context, HashMap paramMap, String objectId) throws Exception {
            ...
            while (itr.hasNext()) {
                ...
                if (key.equals("SEPName") || key.equals("Supplier") || key.equals("SEPPreference")) {
                    ...
                    if (key.equals("SEPName"))
                        ...
                        relName = "to[" + CPCConstants.RELATIONSHIP_SUPPLIER_EQUIVALENT + "].tomid[" + CPCConstants.RELATIONSHIP_QUALIFICATION + "].from." + CPCConstants.SELECT_ATTRIBUTE_PREFERENCE
                                + ".value";
        ...
        MapList listCorpMEPs = partObj.getRelatedObjects(context, CPCConstants.RELATIONSHIP_SUPPLIER_EQUIVALENT, // relationship pattern
    ...
    public StringList getCompanyInfoHTMLOutput(Context context, String[] args, String id) throws Exception {
    ...
    public MapList getRelatedManufacturers(Context context, HashMap paramMap, String objectId) throws Exception {
        ...
        MapList listCorpManus = partObj.getRelatedObjects(context, RELATIONSHIP_MANUFACTURING_RESPONSIBILITY, // relationship pattern
    ...
    public MapList getRelatedSuppliers(Context context, HashMap paramMap, String objectId) throws Exception {
        ...
        MapList listCorpSupps = partObj.getRelatedObjects(context, CPCConstants.RELATIONSHIP_SUPPLIED_BY, // relationship pattern
                TYPE_COMPANY, // object pattern
                selectStmts, // object selects
                selectRelStmts, // relationship selects
                true, // to direction
                                ...
                                if (obj instanceof String) {
                                    ...
                                    while (idListItr.hasNext()) {
                                        ...
                                        if (((useBOMQualification != null && useBOMQualification.equals("true")) && (qualID != null && qualID.equals("BQML2")))
                                                ...
                                                || ((useBOMQualification == null || useBOMQualification.equals("") || useBOMQualification.equals("false"))
                                                        && (qualID != null && qualID.equals("QSL2")))) {
