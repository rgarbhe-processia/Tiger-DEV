...
/**
 * emxTypeAheadOrganizationSearch.java Copyright (c) 2006-2015 Dassault Systemes. All Rights Reserved. This program contains proprietary and trade secret information of MatrixOne, Inc. Copyright
...
public class emxTypeAheadOrganizationSearch_mxJPO extends emxTypeAhead_mxJPO {
    ...
    /**
     * Get the vaults including those from our collaboration partners matching the filter.
     * @param context
     ...
     * @since AEF 10.6.SP2
     */
    public String getResponsibleDesignOrganizations(Context context, String[] args) throws Exception {
        ...
        while (itr.hasNext()) {
            map = (Map) itr.next();
            addValue((String) map.get(DomainConstants.SELECT_NAME), (String) map.get(DomainObject.SELECT_ID));
        }
     ...
     * @since AEF 10.6.SP2
     */
    private MapList search(Context context, String filter) throws Exception {
        ...
        return (DomainObject.findObjects(context, typePattern, "*", "*", "*", vaultPattern, null, null, true, selects, (short) 0));
