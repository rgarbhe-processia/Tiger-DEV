...
public class emxSubscriptionManagerBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @since AEF 10-0-0-0
     */
    public emxSubscriptionManagerBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    /**
     * This method is used to notify occurence of event to all the users subsribing it
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param sObjectId
     *            = object on which event has occured
     * @param sEvent
     *            = name of event
     * @param sURLObject
     *            = object to pass in mail notifications
     * @returns 1 on failure 0 on success
     * @throws Exception
     *             if the operation fails
     * @since AEF 10-0-0-0
     */
    public void publishEvent(Context context, String sEvent, String sURLObject) throws Exception {
    ...
    public void publishEvent(Context context, String sEvent, String sURLObject, String subjectKey, String[] subjectKeyMacros, String[] subjectKeyMacroValues, String messageBodyKey,
            String[] messageBodyMacros, String[] messageBodyMacroValues) throws FrameworkException, Exception {
        ...
        String relPattern = DomainConstants.RELATIONSHIP_PUBLISH_SUBSCRIBE + "," + DomainConstants.RELATIONSHIP_PUBLISH + "," + DomainConstants.RELATIONSHIP_SUBSCRIBED_PERSON + ","
                + DomainConstants.RELATIONSHIP_PUSHED_SUBSCRIPTION;

        // type pattern
        String typePattern = DomainConstants.TYPE_PUBLISH_SUBSCRIBE + "," + DomainConstants.TYPE_EVENT + "," + DomainConstants.TYPE_PERSON;
        ...
        // object where
        String objWhere = "type == \"" + DomainConstants.TYPE_PUBLISH_SUBSCRIBE + "\" || " + "(type == \"" + DomainConstants.TYPE_EVENT + "\" && attribute[" + DomainConstants.ATTRIBUTE_EVENT_TYPE
                + "] == " + mqlEvent + ") || " + "type == \"" + DomainConstants.TYPE_PERSON + "\"";
        ...
        if ("Part_Revised".equals(sEvent.replace(' ', '_'))) {
            ...
            ml = domObj.getRelatedObjects(context, relPattern, typePattern, sl, null, false, true, (short) 3, objWhere, null, includeType, null, null);
        } else {
        ...
        if (lPersons.size() > 0) {
            ...
            emxMailUtil_mxJPO.sendNotification(context, lPersons, null, null, subjectKey, null, null, messageBodyKey, messageBodyMacros, messageBodyMacroValues, lObj, null,
    ...
    /**
     * This is a trigger method used route object or message to user specified by the value of an attribute.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds following arguments. args[0] = name of Event to publish args[1] = object id to be passed in publish message
     * @returns int 1 on failure and 0 on success
     * @throws Exception
     *             if the operation fails
     * @since AEF 10-0-0-0
     */
    public int publishEvent(Context context, String[] args) throws Exception {
    ...
    public MapList getSubscriptionDetailsforContextUser(Context context, String[] args) throws Exception {
        ...
        MapList eventMapList = (MapList) currentUser.getRelatedObjects(context, DomainConstants.RELATIONSHIP_SUBSCRIBED_PERSON + "," + DomainConstants.RELATIONSHIP_PUSHED_SUBSCRIPTION,
                DomainConstants.QUERY_WILDCARD, eventObjectSelect, relSelect, true, false, (short) 1, null, null);
        ...
        while (iterator.hasNext()) {
            ...
            if (!(null == eventId || "null".equals(eventId) || "#DENIED!".equals(eventId) || "".equals(eventId))) {
                ...
                MapList dcObjectsMapList = myobj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_PUBLISH + "," + DomainConstants.RELATIONSHIP_PUBLISH_SUBSCRIBE, DomainConstants.QUERY_WILDCARD,
                        new StringList(DomainConstants.SELECT_ID), new StringList(), true, false, (short) 2, null, null, null, new Pattern(DomainConstants.RELATIONSHIP_PUBLISH_SUBSCRIBE), null);
