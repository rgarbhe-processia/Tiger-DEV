...
public class emxMEPUniquenessMigrationBase_mxJPO // extends ${CLASS:DomainObject}
{
     ...
     * @since EC 9.5.JCI.0.
     */
    public emxMEPUniquenessMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        // super(context, args);
    ...
    public void associateInterface(Context context) throws Exception {
        ...
        MapList mepList = DomainObject.findObjects(context, DomainObject.TYPE_PART, "*", objWhere, objSelects);
    ...
    /**
     * Update location plant id attribute as location rev if location plant attribute is empty. The following steps are performed:
     * @param context
     *            the eMatrix <code>Context</code> object.
     * @param File
     *            Log file to be updated.
     * @throws Exception
     *             if the operation fails.
     * @since EC 10.7.
     */
    public void updatePlantID(Context context) throws Exception {
        ...
        objSelects.add(DomainObject.SELECT_NAME);
        objSelects.add(DomainObject.SELECT_REVISION);
        MapList mepList = DomainObject.findObjects(context, DomainObject.TYPE_LOCATION, "*", objWhere, objSelects);
        ...
        try {
            ...
            while (mepItr.hasNext()) {
                ...
                MapList locList = DomainObject.findObjects(context, DomainObject.TYPE_LOCATION, "*", objWhere, objSelects);
