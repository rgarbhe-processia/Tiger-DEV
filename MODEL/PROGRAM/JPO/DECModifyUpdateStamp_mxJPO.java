...
public class DECModifyUpdateStamp_mxJPO {
    ...
    protected void updateOwnerInfo(Context context, String event, String objectId) throws Exception {
    ...
    public void propagateChangeOwnershipToInstances(Context context, BusinessObject fromBusObject) throws Exception {
        ...
        try {
            ...
            MapList mlConnectedData = boTemp.getRelatedObjects(context, stbRelPattern.toString(), "*", objectSelects, null, false, true, (short) 1, null, null, 0);
