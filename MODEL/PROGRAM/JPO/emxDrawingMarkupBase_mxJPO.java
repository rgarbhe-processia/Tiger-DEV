...
public class emxDrawingMarkupBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    /*
     * public static final String STATE_ECRSTANDARD_PLANECO = PropertyUtil.getSchemaProperty("policy", POLICY_ECR_STANDARD, "state_PlanECO");
     */
     ...
     * @since EC Rossini.
     */
    public emxDrawingMarkupBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            0 - HashMap containing one Map entry for the key "paramMap" This Map contains the arguments passed to the jsp which called this method.
    ...
    public Object isViewMode(Context context, String[] args) throws Exception {
    ...
    public Object isEditMode(Context context, String[] args) throws Exception {
    ...
    public Object updateECR(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        ...
        if (!"".equals(oldECRName)) {
            ...
            ecrList = getRelatedObjects(context, strECRSupportingDocumentRelationship, strECRType + "," + ChangeConstants.TYPE_CHANGE_REQUEST, ObjectSelectsList, RelSelectsList, true, true, (short) 1,
    ...
    public void connectECRSupportingDocumentRel(Context context, String[] args) throws Exception {
        ...
        if ((fromObjectId != null) && !"".equals(fromObjectId)) {
            try {
                ...
                DomainRelationship.connect(context, fromBusObj, RELATIONSHIP_ECR_SUPPORTING_DOCUMENT, toBusObj);
            } catch (Exception e) {
                e.printStackTrace();
                throw e;
            }
    ...
    public Map createDrawingMarkupJPO(Context context, String[] args) throws Exception {
        ...
        markup.create(context, sType, null, sPolicy, sDescription);
