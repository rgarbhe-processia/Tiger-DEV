...
public class emxMultipleClassificationClassificationBase_mxJPO extends emxLibraryCentralCommon_mxJPO implements ClassificationConstants {
    ...
    /**
     * Returns the complete set of interfaces that this Classification implements directly. If allAncestors, then return inherited interfaces as well.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param allAncestors
     *            if true then return inherited interfaces as well
     * @return StringList The list of interface names
     * @throws FrameworkException
     *             if the operation fails
     */
    public StringList getInterfaces(Context context, boolean allAncestors) throws FrameworkException {
     ...
     *            the eMatrix <code>Context</Code> object
     * @param args
     *            holds the following arguments: 0 - allAncestors if false, return interfaces that are associated to direct subclasses of the context object or if true, return interfaces of all
     *            children (multiple level)
     * @return The list of interface names
     * @throws FrameworkException
     *             if the operation fails
     */
    public StringList getInterfaces(Context context, String[] args) throws FrameworkException {
        ...
        return getInterfaces(context, ((Boolean) (map.get("allAncestors"))).booleanValue());
    }
     ...
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param allDerivatives
     *            if false, return interfaces that are associated to direct subclasses of the context object or if true, return interfaces of all children (multiple level)
     * @return StringList The list of interface names
     * @throws FrameworkException
     *             if the operation fails
     */
    public StringList getDerivativeInterfaceList(Context context, boolean allDerivatives) throws FrameworkException {
        try {
            ...
            subClassObjects = getRelatedObjects(context, LibraryCentralConstants.RELATIONSHIP_SUBCLASS, "*", objectSelects, null, false, true, recurseLevel, "", "", null, null, null);
     ...
     *            the eMatrix <code>Context</code> object
     * @param allAncestors
     *            if true then return inherited interfaces as well, else just directly associated interfaces
    ...
    /**
     * Returns the complete set of parent or child interfaces of this Classification. If derivedOrDerivatives is true, then it returns all parent interfaces including the interface connectred to this
     * classification else it returns all child interfaces
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param derivedOrDerivative
     *            If true, returns parent interfaces. If false, returns child interfaces
     * @param flag
     *            when derivedOrDerivative is true and If flag is false, return only directly associated interface or If flag is true, return attribute groups of all ancestorts as well. When
     *            derivedOrDerivative is false and if 'false', return interfaces that are associated to direct subclasses of the context object or if 'true', return interfaces of all children
     *            (multiple level).
     * @return StringList The list of interface names, as a StringList
     * @throws FrameworkException
     *             if the operation fails
    ...
    public StringList getAttributeGroups(Context context, boolean derivedOrDerivatives, boolean flag) throws FrameworkException {
        ...
        try {
            ...
            for (int i = 0; i < myInterfaces.size(); i++) {
                ...
                if (!INTERFACE_CLASSIFICATION_ATTRIBUTE_GROUPS.equals(interfaceName) && ClassificationUtil.isAttributeGroup(context, interfaceName)) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments 0 - grpName Attribute Group name that is to be added.
     * @throws FrameworkException
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param grpName
     *            Attribute Group name that is to be added.
     * @throws FrameworkException
     *             if the operation fails
     */
    public void addAttributeGroup(Context context, String grpName) throws FrameworkException {
        try {
            String[] args = null;
            ...
            Boolean isUserAgent = userName.equals(PropertyUtil.getSchemaProperty(context, "person_UserAgent"));
            if (hasLibrarianRole || isUserAgent) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - grpName Attribute Group name that is to be removed.
     * @throws FrameworkException
     *             if the operation fails
     */
    public void addAttributeGroup(Context context, String[] args) throws FrameworkException {
        if (args == null || args.length < 1) {
            throw (new IllegalArgumentException());
        }
     ...
     *            the eMatrix <code>Context</code> object
     * @param grpName
     *            Attribute Group name that is to be removed.
     * @throws FrameworkException
     *             if the operation fails
     */
    public void removeAttributeGroup(Context context, String grpName) throws FrameworkException {
     ...
     *             if the operation fails
     */
    public void removeAttributeGroup(Context context, String[] args) throws FrameworkException {
        if (args == null || args.length < 1) {
            throw (new IllegalArgumentException());
        }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - grpName Attribute Group names that are to be added.
     * @throws FrameworkException
     *             if the operation fails
     */
    public void addAttributeGroups(Context context, String[] args) throws FrameworkException {
        if (args == null || args.length < 1) {
            throw (new IllegalArgumentException());
        }
     ...
     *            the eMatrix <code>Context</code> object
     * @param grpName
     *            Attribute Group names that are to be added.
     * @throws FrameworkException
     *             if the operation fails
     */
    public void addAttributeGroups(Context context, StringList grpNames) throws FrameworkException {
        try {
            String[] args = null;
            emxObjectAccess_mxJPO objAccess = new emxObjectAccess_mxJPO(context, args);
            Boolean hasLibrarianRole = objAccess.hasLibrarianRole(context, args);
     ...
     *             if the operation fails
     */
    public void removeAttributeGroups(Context context, String[] args) throws FrameworkException {
        if (args == null || args.length < 1) {
            throw (new IllegalArgumentException());
        }
     ...
     *             if the operation fails
     */
    public void removeAttributeGroups(Context context, StringList grpNames) throws FrameworkException {
        try {
            String[] args = null;
            emxObjectAccess_mxJPO objAccess = new emxObjectAccess_mxJPO(context, args);
            Boolean hasLibrarianRole = objAccess.hasLibrarianRole(context, args);
    ...
    /**
     * This method transfers the Classification object under a new parent, or orphans it. It takes care of manipulating the interface tree as well as the BO tree. This method is used for these
     * operations: - Add existing subclass - Remove subclass - Move subclass NOTE: manipulations of the data model MUST be done via this method as referential integrity is only ensured here.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param newParent
     *            New parent for this Classification object. May be null. If null, then this Classifiction becomes orphan.
     * @param carryOverInheritedAttributeGroups
     *            If true, any attribute groups that this classification was previously inheriting from its parent/ancestors, that would NOT be inherited from its new parent, will become directly
     *            associated with this Classification prior to the reparenting taking effect, so as to avoid any loss of attributes on the affected classified items.
    ...
    public HashMap reparent(Context context, String objectId, String oldParent, String newParent, boolean carryOverInheritedAttributeGroups) throws FrameworkException, Exception {
        ...
        try {
            ...
            resultMap = this.getRelatedObject(context, RELATIONSHIP_SUBCLASS, false, busSelects, null);
            if (resultMap.size() != 0) {
                try {
            ...
            if (newParent != null) {
                ...
                if (new DomainObject(newParent).isKindOf(context, LibraryCentralConstants.TYPE_LIBRARIES)) {
                    ...
                    if (!carryOverInheritedAttributeGroups && objOldParent instanceof com.matrixone.apps.classification.Classification) {
                        ...
                        com.matrixone.apps.classification.Classification objectClassification = (com.matrixone.apps.classification.Classification) DomainObject.newInstance(context, objectId,
                                "Classification");
                        objectInterface = objectClassification.getInterfaceName(context);

                        // Get Interface of OldParent
                        com.matrixone.apps.classification.Classification oldParentClassification = (com.matrixone.apps.classification.Classification) DomainObject.newInstance(context, oldParent,
                                "Classification");
                        oldParentInterface = oldParentClassification.getInterfaceName(context);

                    }
                } else {
                    com.matrixone.apps.classification.Classification objNewParentClassification = (com.matrixone.apps.classification.Classification) DomainObject.newInstance(context, newParent,
                            "Classification");
            ...
            // Changes done by PSA11 start(IR-498425-3DEXPERIENCER2015x).
            if (isDisconnected) {
                if (resultMap.size() != 0) {
                    this.connect(context, new RelationshipType(RELATIONSHIP_SUBCLASS), false, new BusinessObject((String) resultMap.get("id")));
                }
            }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - objectId 1 - newParent 2 - oldParent objectId New parent for this Classification object. May be null. If null, then this Classifiction
     *            becomes orphan. 3 - carryOverInheritedAttributeGroups If true, any attribute groups that this classification was previously inheriting from its parent/ancestors, that would NOT be
     *            inherited from its new parent, will become directly associated with this Classification prior to the reparenting taking effect, so as to avoid any loss of attributes on the affected
     *            classified items.
     * @return true for success
     * @throws FrameworkException
     *             if the operation fails
     ...
     *             if the operation fails
     */
    public int getRecursiveEndItemCount(Context context) throws FrameworkException {
     ...
     *             if the operation fails
     */
    public int getRecursiveEndItemCount(Context context, String[] args) throws FrameworkException {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments:
     * @param objectId
    ...
    public StringList getClassifiedItems(Context context, String objectId) throws Exception {
        ...
        try {
            ...
            result = (MapList) doObj.getRelatedObjects(context, com.matrixone.apps.library.LibraryCentralConstants.RELATIONSHIP_CLASSIFIED_ITEM, ClassificationConstants.QUERY_WILDCARD, selectStmts,
    ...
    /**
     * Converts a StringList of attribute group names to a MapList for use in table components.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param items
     ...
     *             if the operation fails
     */
    public static MapList toMapList(Context context, StringList items) throws FrameworkException {
        dbg_break();
        MapList result = new MapList();
        try {
    ...
    /**
     * Utility method to get Attribute Group data for multiple Attribute groups passed as StringList if there is any inherited attribute group, then it will add the parameter 'disableSelection =
     * true', so that the check box for corresponding attribute group will be disabled in the table
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param attrGrpList
     *            Attributes Group List
     * @param inheritedAttrGrpList
     *            inherited Attributes Group List
     * @return MapList the Attribute Group Data
     * @throws FrameworkException
     *             if the operation fails
     */
    public static MapList getAttributeGroupsData(Context context, StringList attrGrpList, StringList inheritedAttrGrpList) throws Exception {
    ...
    /**
     * Returns all attribute groups associated with a Classification, whether inherited or directly associated, in the form of a MapList
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - objectId
     * @return MapList with all the Attribute Group Details
     * @throws FrameworkException
     *             if the operation fails
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static MapList getAllAttributeGroups(Context context, String[] args) throws FrameworkException {
        dbg_break();
        try {
    ...
    /**
     * Returns attribute groups directly associated with a Classification, in the form of a MapList
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param objectId
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static MapList getDirectAttributeGroups(Context context, String[] args) throws FrameworkException {
        dbg_break();
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            String clsId = (String) paramMap.get("objectId");
    ...
    /**
     * Returns only inherited attribute groups associated with a Classification, in the form of a MapList. Impl note: inherited AG's = all AG's - direct AG's
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param objectId
     * @return MapList with Attribute Groups Details
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public static MapList getInheritedAttributeGroups(Context context, String[] args) throws FrameworkException {
        dbg_break();
        try {
            HashMap paramMap = (HashMap) JPO.unpackArgs(args);
            String clsId = (String) paramMap.get("objectId");
    ...
    /**
     * This method is used by getAttributeGroupsInheritedFrom to walk up the inheritance graph, as stored in a HashMap. The structure of the HashMap is map(agName) = StringList(parents of agName).
     * This routine recursively walks up, starting from clsName, looking for an ancestor that is directly derived from agName. That ancestor (which actually could be clsName itself) is returned.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param map
     * @param name
     * @param agName
     * @return String name of the class from which clsName inherited agName, or null if not found
     */
    private static String gagif_recurse(Context context, HashMap map, String clsName, String agName) {
    ...
    /**
     * Given a Classification, and a MapList containing attribute group names, return a Vector of corresponding path-inherited-from.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param clsId
     *            string id of the Classification
     * @param agList
     *            MapList of attribute group names
     * @return MapList containing Id and name fields
     * @throws FrameworkException
     *             if the operation fails
     */
    public static MapList getAttributeGroupInheritedFrom(Context context, String clsId, MapList agList) throws FrameworkException {
        dbg_break();
        try {
            ...
            while (itr.hasNext()) {
                ...
                String inheritedFrom = gagif_recurse(context, derivedMap, myInterfaceName, agName);
            ...
            dump = MqlUtil.mqlCommand(context, cmdQuery, "Classification", "*", "*", "attribute[" + ATTRIBUTE_MXSYS_INTERFACE + "] matchlist '" + inheritedFromCSL + "' ','", "id",
                    "attribute[" + ATTRIBUTE_MXSYS_INTERFACE + "]", ",", "|").trim();
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - objectList Attribute Group List 1 - reportFormat 2 - objectId @ return Vector with the list of Classifications
     * @throws FrameworkException
     *             if the operation fails
     */
    public static Vector getAttributeGroupInheritedFrom(Context context, String[] args) throws FrameworkException {
        dbg_break();
                    ...
                    if (agNameFmObjList.equals(agName)) {
                        if (idOfConnCls.equals(clsid)) {
                            ...
                            if (!isprinterFriendly) {
                                href = "<a href=\"javascript:showModalDialog(" + "'../common/emxTree.jsp?objectId=" + idOfConnCls + "'," + "'860','520');\"" + ">" + nameOfConnCls + "</a>";
                            } else {
                                href = nameOfConnCls;
                            }
                        }
     ...
     *            the eMatrix <code>Context</code> object
     * @param MapList
     *            list of Attribute Groups @ return StringList of Attribute Groups
     * @exclude
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - objectList the list of Attribute Group 1 - objectId
     * @return Vector with true or false for each Attribute Group
     * @throws FrameworkException
     *             if the operation fails
     */
    public static Vector isAttributeGroupInherited(Context context, String[] args) throws FrameworkException {
        dbg_break();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objList = (MapList) programMap.get("objectList");
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - strParentObjectId The id of the classification object
     ...
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param strParentObjectId
     *            The id of the classification object
     * @return The list of attribute names
     * @throws Exception
     *             if the operation fails
     */
    public static Vector findAttributes(Context context, String strParentObjectId) throws Exception {
        ...
        if (strParentType != null && strTypeClassification != null && strTypeClassification.equals(strParentType)) {
            com.matrixone.apps.classification.Classification objClassification = (com.matrixone.apps.classification.Classification) DomainObject.newInstance(context, strParentObjectId,
                    "Classification");
        ...
        for (int i = 0; i < strlistAttributeGroups.size(); i++) {
            ...
            if (strAttributeGroupName != null && !"".equals(strAttributeGroupName)) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - strParentObjectId The id of the classification object 1 - vecCurrentAttributes Vector containing all the attributes of the classified item
     *            unde this classification 2 - strChildId The id of the classified item object
     * @return true if the classified item will lose the attributes otherwise false
     * @throws Exception
     *             if the operation fails
     */
    public static boolean checkIfItLosesAttributeOnRemoval(Context context, String[] args) throws Exception {
     ...
     * @param strParentObjectId
     *            The id of the classification object
     * @param vecCurrentAttributes
     *            Vector containing all the attributes of the classified item unde this classification
     * @param strChildId
     *            The id of the classified item object
     * @return true if the classified item will lose the attributes otherwise false
     * @throws Exception
     *             if the operation fails
     */
    public static boolean checkIfItLosesAttributeOnRemoval(Context context, String strParentObjectId, Vector vecCurrentAttributes, String strChildId, boolean isSearchAllSublevels) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - strChildId The id of the classified item object
     * @return a vector containing all the parent classification object ids
     * @throws FrameworkException
     *             if the operation fails
     */
    public static Vector findAllParentClassifications(Context context, String[] args) throws FrameworkException {
    ...
    public static Vector findAllParentClassifications(Context context, String strChildId) throws FrameworkException {
        ...
        String strResult = MqlUtil.mqlCommand(context, strMQL, true, strChildId, LibraryCentralConstants.RELATIONSHIP_CLASSIFIED_ITEM, "*", "id", "|");
        ...
        while (st1.hasMoreTokens()) {
            ...
            if (strResultLine != null && !"".equals(strResultLine)) {
                ...
                if (strParentObjectId != null && !"".equals(strParentObjectId) && !vecParentObjectIds.contains(strParentObjectId)) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - strParentId The id of the classified item's parent classification object 1- strChildId The id of the classified item object
     * @return a vector containing all the parent classification object ids in current taxonomy
     * @throws Exception
     *             if the operation fails
     */
    public static Vector findAllParentClassificationsInCurrentTaxonomy(Context context, String[] args) throws FrameworkException {
     ...
     *            the eMatrix <code>Context</code> object
     * @param strParentId
     *            The id of the classified item's parent classification object
     * @param strChildId
     *            The id of the classified item object
     * @return a vector containing all the parent classification object ids in current taxonomy
     * @throws Exception
    ...
    public static Vector findAllParentClassificationsInCurrentTaxonomy(Context context, String strParentId, String strChildId) throws FrameworkException {
        ...
        String strResult = MqlUtil.mqlCommand(context, strMQLBuffer.toString(), true, strParentId, strRelSubclass, "id", "from[" + strRelClassifiedItem + "].to.id", strChildId.trim(), "|");
    ...
    /**
     * This method returns true if the object losses any attributes on removal of a given class from the object
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments 0 - objectId 1 - selectedClassIds
     * @return true if the object is going to loose attributes
     * @throws Exception
     *             if the operation fails
     */
    public static boolean checkIfItLosesAttributeOnRemovalOfClassification(Context context, String[] args) throws Exception {
     ...
     * @param args
     *            String array containing the Library Object Id
    ...
    public File exportLibrary(Context context, String args[]) throws FrameworkException {
        ...
        try {
            ...
            MapList subClassesList = (MapList) JPO.invoke(context, "emxLibraryCentralUtilBase", constructor, "getSubclasses", packArgs, MapList.class);
            ...
            if (objectType.equals(TYPE_GENERAL_LIBRARY))
                ...
                if (aliasName == null || "".equals(aliasName)) {
                    ...
                    String message = MessageUtil.getMessage(context, null, "emxLibraryCentral.LoadAllowedTypes.SymbolicNameNotFound",
                            new String[] { i18nNow.getAdminI18NString("type", objectType, locale.getLanguage()) }, null, locale, "emxLibraryCentralStringResource");
            ...
            String fileName = new DomainObject(objectId).getInfo(context, SELECT_NAME);
            Pattern pat = Pattern.compile("\\W");
            Matcher m = pat.matcher(fileName);
            if (m.find()) {
                fileName = "" + Calendar.getInstance().getTimeInMillis();
            }
            fileName += "_" + String.valueOf(date) + String.valueOf(month) + String.valueOf(yr) + ".xml";
     ...
     *            the ENOVIA <code>Context</code> object
     * @param classId
     *            , objectId of Classification Type
        ...
        try {
            ...
            if (typeName.equals(TYPE_GENERAL_CLASS))
                ...
                if (aliasName == null || "".equals(aliasName)) {
                    Locale locale = MessageUtil.getLocale(context);
                    String message = MessageUtil.getMessage(context, null, "emxLibraryCentral.LoadAllowedTypes.SymbolicNameNotFound",
                            new String[] { i18nNow.getAdminI18NString("type", typeName, locale.getLanguage()) }, null, locale, "emxLibraryCentralStringResource");
                    throw new Exception(message);
                }
                aliasName = aliasName.substring(aliasName.indexOf("_") + 1, aliasName.length());
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments: 0 - object id
        ...
        if (args.length > 0) {
            ...
            try {
                ...
                if (!(loggedInUser.equals(result) || loggedInUser.equals(superuserName))) {
                    String errorMsg = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", new Locale(context.getSession().getLanguage()),
                            "emxFramework.Alert.CannotApproveRejectUnassignedTasks");
