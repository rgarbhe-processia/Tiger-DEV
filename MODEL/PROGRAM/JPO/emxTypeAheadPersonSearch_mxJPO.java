...
/**
 * emxTypeAheadPersonSearch.java Copyright (c) 2006-2015 Dassault Systemes. All Rights Reserved. This program contains proprietary and trade secret information of MatrixOne, Inc. Copyright notice is
...
public class emxTypeAheadPersonSearch_mxJPO extends emxTypeAhead_mxJPO {
     ...
     * @param context
     *            the matrix user context
     * @param args
     *            one argument, the filter value
     * @return xml representing the values
     * @since AEF 10.6.SP2
     */
    public String getECREvaluators(Context context, String[] args) throws Exception {
     ...
     * @since AEF 10.6.SP2
     */
    public String getResponsibleDesignEngineers(Context context, String[] args) throws Exception {
        String filter = (args != null) ? (String) JPO.unpackArgs(args) : "*";
     ...
     * @since AEF 10.6.SP2
     */
    private MapList search(Context context, String filter, String role) throws Exception {
        ...
        MapList objects = DomainObject.findObjects(context, typePattern, null, null, null, null, whereClause, null, true, selects, (short) 0);
    ...
    /**
     * Get the Approvers for adding new Inbox Tasks over Lifecycle states. The names of Persons, Roles and Groups will be searched.
     * @param context
     *            the matrix user context
     * @param args
     *            one argument, the filter value
     ...
     */
    public String getApproversIncludePersonsRolesGroups(Context context, String[] args) throws Exception {
        ...
        MapList mlPersons = DomainObject.findObjects(context, DomainObject.TYPE_PERSON, "*", "name ~~ const \"" + strFilter + "\" && current ~~ const \"" + POLICY_PERSON_STATE_ACTIVE + "\"",
        ...
        for (StringItr stringItr = new StringItr(slResult); stringItr.next();) {
            ...
            if (!(strName.startsWith("ctx::") || strName.endsWith("_PRJ"))) {
