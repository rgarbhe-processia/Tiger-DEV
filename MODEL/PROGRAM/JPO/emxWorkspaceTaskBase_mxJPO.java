...
public class emxWorkspaceTaskBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @grade 0
     */
    public emxWorkspaceTaskBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    public Object getWorkspaceTasks(Context context, String args[]) throws Exception {
        try {
            ...
            ExpansionIterator expIter = personObject.getPerson(context).getExpansionIterator(context, personObject.RELATIONSHIP_PROJECT_TASK, personObject.TYPE_INBOX_TASK, selectTypeStmts,
                    new StringList(), true, false, (short) 1, sTypeWhere, null, (short) 0, false, false, (short) 100, false);
     ...
     * @grade 0
     */
    public Vector showAllowDelegation(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objectList = (MapList) programMap.get("objectList");
     ...
     * @grade 0
     */
    public Vector showNeedsOwnerReview(Context context, String[] args) throws Exception {
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            MapList objectList = (MapList) programMap.get("objectList");
