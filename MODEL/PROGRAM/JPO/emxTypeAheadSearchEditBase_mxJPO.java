...
public class emxTypeAheadSearchEditBase_mxJPO extends emxTypeAhead_mxJPO {
     ...
     *            the name filter
     * @param typePattern
     *            the Type Pattern filter
     * @return MapList of Type Pattern objects
     * @since AEF 10.6.SP2
     */
    private MapList search(Context context, String filter, String typePattern) throws Exception {
        filter += "*";
     ...
     * @since AEF 10.6.SP2
     */
    public String getActivePersons(Context context, String[] args) throws Exception {
        String filter = (args != null) ? (String) JPO.unpackArgs(args) : "*";
     ...
     * @since AEF 10.6.SP2
     */
    public String isObject(Context context, String[] args) throws Exception {
        ...
        if (!exists) {
            ...
            MapList mapval = DomainObject.findObjects(context, null, objName, null, null, null, null, false, objectSelects);
