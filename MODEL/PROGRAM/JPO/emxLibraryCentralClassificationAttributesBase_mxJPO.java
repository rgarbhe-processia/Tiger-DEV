...
public class emxLibraryCentralClassificationAttributesBase_mxJPO implements LibraryCentralConstants {
    ...
    public static String strLanguageStr = ""; // sml4 added for group attributes order BUG

    public static HashMap tempMap_Cache = new HashMap(); // sml4 added for group attributes order BUG
     ...
     * @param context
     * @param args
     *            - JPO Packed HashMap containing objectId of the class
     * @return a MapList of AttributesGroups, each map with following key-Value Pairs 1) "name" - String containing AttributeGroup name 2) "attributes" - a MapList of Attributes, each map with
     ...
     *         maxlength of the Attribute 7) "dimension" - name of the dimension 8) "range" - MapList of range Values
     * @throws Exception
     */
    public MapList getClassificationAttributes(Context context, String[] args) throws Exception {
        ...
        if (domObj.isKindOf(context, TYPE_CLASSIFICATION)) {
            ...
            MapList classificationList = domObj.getRelatedObjects(context, "Classified Item", "*", objectSelects, null, true, // boolean getTo,
     ...
     */
    protected static MapList getClassClassificationAttributes(Context context, String objectId) throws Exception, MatrixException {
    ...
    /**
     * This Method removes the classification interface i.e., mxsysInterface on a cloned end item, Note : this method should be triggered only when 'Classified Item' Relationship is not replicated on
     * clone of an end Item //IR-275988V6R2015x
     * @param context
     * @param args
     *            - array of String s args[0] - objectId of the end Item being cloned args[1] - objectId of the clone
     * @throws Exception
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            JPO Packed arguments of a HashMap with following data name - Attribute Group Name Pattern selectables - StringList attribute selectables
     * @returns - a MapList of Attributes Groups, each map with following key-Value Pairs 1) "name" - String containing AttributeGroup name 2) "attributes" - a MapList of Attributes, each map with
     *          following key-Value Pairs 1) "qualifiedName" - String containing qualified name of the Attribute 2) "name" - String containing name of the Attribute 3) "type" - String containing type
     *          of the Attribute 4) "default" - String containing default value of the Attribute 5) "description" - String containing description of the Attribute 6) "maxlength" - String containing
     *          maxlength of the Attribute 7) "dimension" - name of the dimension 8) "range" - StringList of range Values Note: no key-Value pair exists in this map if there is no value for that key
    ...
    public static MapList getAttributeGroupsDetails(Context context, String[] args) throws Exception {
        ...
        String result = MqlUtil.mqlCommand(context, cmd, namePattern, "derived==\"" + LibraryCentralConstants.INTERFACE_CLASSIFICATION_ATTRIBUTE_GROUPS + "\"", ",", "#");
     ...
     *            - MapList containing Maps of attribute Details, Each Map Containing attribute details for keys - "name", "type", "range"
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Packed Arguments containing requestMap which contains objectId of the class
    ...
    public MapList getClassificationAttributesForClassificationEditForm(Context context, String[] args) throws Exception {
        ...
        MapList classificationList = endItemObj.getRelatedObjects(context, "Classified Item", "*", objectSelects, null, true, // boolean getTo,
                false, // boolean getFrom,
                (short) 0, objectWhere.toString(), null, 0);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - Packed Arguments containing objectList(a MapList of objects selected for disply in BOM page)
     ...
     *            the eMatrix <code>Context</code> object
     * @param slObjectIds
     *            StringList of ObjectIds (of end items)
     * @return a HashMap containing following values - allAttributeNames - StringList of all Classification Attribute Names for all objectIds - attributeNamesMap - HashMap having Classification
     *         Attribute Names for each objectId
     * @throws Exception
     */
     ...
     *            - a HashMap containing following values - allAttributeNames - StringList of all Classification Attribute Names for all objectIds - attributeNamesMap - HashMap having Classification
     *            Attribute Names for each objectId
     * @param uniqueObjectIds
     *            - String list of objectIds for which attribute values need to be returned
     * @param isHTMLFormat
     *            - true if return value is of HTML format , othervise false
     * @return HashMap with key = objectId value = a HTML/plaintext string containing Attribute Name = Value pairs separated by | this string contains names which are in attributeNamesMap for this
     *         objectid this string contains a maximum of 256 displayed characters contains 3 dots (...) at the end, if not all attribute Names in attributeNames StringList are included
     */
    protected static HashMap getClassificationAttributeValues(Context context, HashMap classificationAttributesNames, StringList uniqueObjectIds, String reportFormat, double clientTZOffset)
            throws Exception {
     ...
     *            - StringList of Attribute Names
     * @param attributeValues
     *            - HashMap containing "Attribute Name" - "Attribute Value" as key-value pairs
     * @return String - a HTML string containing Attribute Name = Value pairs separated by | this string contains names from StringList attributeNames only this string contains a maximum of 256
     *         displayed characters contains 3 dots (...) at the end, if not all attribute Names in attributeNames StringList are included
     */
    protected static String mergeAttributeNameValues(Context context, StringList attributeNames, HashMap attributeValues, String reportFormat, double clientTZOffset) throws Exception {
        ...
        while (itr.hasNext()) {
            ...
            // Changes added by PSA11 start(IR-531932-3DEXPERIENCER2015x).
            if (!attributeType.equals("timestamp")) {
            ...
            /*
             * if(reportFormat == null || reportFormat.equals("HTML")){ attributeActualValue = XSSUtil.encodeForHTML(context, attributeValue); }
             */
     ...
     * @param context
     * @param args
     *            - String array containing object id of the Classified Item
     * @return
     * @throws Exception
     */
    public String getClassification(Context context, String[] args) throws Exception {
        ...
        StringList objectSelects = new StringList();
        objectSelects.add("id");
        MapList classificationList = domObj.getRelatedObjects(context, "Classified Item,Subclass", "*", objectSelects, null, true, // boolean getTo,
                false, // boolean getFrom,
                (short) 0, null, null, 0);
     ...
     * @param context
     * @param args
     *            JPO packed args of a HashMap containing an attributeGroup as below 1) "name" - String containing AttributeGroup name (Optional , autonName is used if omitted) 2) "description" -
     *            String Containing Attribute Group Description (Optional) 3) "attributes" - a MapList of Attributes (Optional), each map with following key-Value Pair 1) "qualifiedName" - String
     *            containing qualified name of the Attribute 2) "name" - String containing name of the Attribute 3) "type" - String containing type of the Attribute 4) "default" - String containing
     *            default value of the Attribute 5) "description" - String containing description of the Attribute 6) "maxlength" - String containing maxlength of the Attribute 7) "dimension" - name
     *            of the dimension 8) "range" - MapList of range Values
     * @throws Exception
     */
     ...
     * @param context
     * @param args
     *            JPO packed args of a HashMap containing an attributeGroup as below 1) "name" - String containing AttributeGroup name 2) "attributes" - a MapList of Attributes, each map with
     *            following key-Value Pairs 1) "qualifiedName" - String containing qualified name of the Attribute 2) "name" - String containing name of the Attribute 3) "type" - String containing
     *            type of the Attribute 4) "default" - String containing default value of the Attribute 5) "description" - String containing description of the Attribute 6) "maxlength" - String
     *            containing maxlength of the Attribute 7) "dimension" - name of the dimension 8) "range" - MapList of range Values
     * @throws Exception
     */
     ...
     * @param context
     * @param args
     *            JPO packed args of a HashMap containing an attributeGroup as below 1) "name" - String containing AttributeGroup name 2) "attributes" - a StringList of Attribute Names
     * @throws Exception
     */
    ...
    /**
     * This method returns the Attribute Group Name for a Given class Attribute group name will be of form "Attribute Group (Class_Type Class_Name)[(repeating number)]" ie attribute group name will be
     * in the format "Attribute Group (Class_Type Class_Name)" "Attribute Group (Class_Type Class_Name)(1)" "Attribute Group (Class_Type Class_Name)(2)" .. so on
     * @param context
     * @param classId
    ...
    protected String generateAGName(Context context) throws Exception {
        ...
        MapList agObjectGenerators = DomainObject.findObjects(context, PropertyUtil.getSchemaProperty(context, "policy_eServiceObjectGenerator"), "Attribute Group", // name pattern e.g. value Test
                // Everything,dmc author
                "*", "*", PropertyUtil.getSchemaProperty(context, "vault_eServiceAdministration"), null, false, objectSelects);
     ...
     * @param context
     * @param args
     *            JPO Packed args of a HashMap containing data as follows name - Name of the Attribute , can not be empty or null type - type of the attribute being created , allowed values are
     *            "date","integer","string","real","boolean" default - default value for the attribute description - description for the attribute maxlength - maximum length of the attribute values ,
     *            valid only for type = "string" dimension - name of the Dimension Object , valid only for type = "integer" or type = "real" ownerType - type of the owner object to create local
     *            attributes , allowed values are "Type", "Relationship", "interface" ownerName - name of the owner object , ie either a Type , a Relationship or an Interface Object name range -
     *            MapList containing the range of values, where each Map represents a Range Value along with Operator as defined below operator - range value operator , allowed values are "=", "!=",
     *            "<", ">", "<=", ">=", "smatch", "!smatch", "match", "!match" value - value of the range Item
     * @return
     * @throws Exception
     */
    ...
    /*
     * This method returns the String of comma-separated attributes that are to be shown in the the web form of emxFullSearch.jsp. This comma-separated string is sent as the request parameter to
     * emxFullSearch.jsp with the key as formInclusionList. Called from emxMultipleClassificationEndItemsSearch.jsp.
     */
    public String getFormInclusionList(Context context, String[] args) throws FrameworkException, Exception {
        ...
        ArrayList<String> customizedListOfAttributes = null;
        try {
        ...
        if (attributeListFromAncestors == null) {
            ...
            if (customizedListOfAttributes != null) {
                for (int k = 0; k < customizedListOfAttributes.size(); k++) {
                    if (attributeList.toString().contains(customizedListOfAttributes.get(k))) {
                        continue;
                    }
                    attributeList.append(customizedListOfAttributes.get(k) + ",");
                }
            }
    ...
    /*
     * Returns the ArrayList of attributes connected to the class and its Parent classes. Input parameter is the Object Id of the class against which the list of attributes is to be obtained.
     */
    ...
    /*
     * User will customize list according to his usage. And will return the customized arrayList containing comma - separated list of attributes.
     */
