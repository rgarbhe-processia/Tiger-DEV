...
public class emxCommonRDOMigrationBase_mxJPO extends emxCommonMigrationBase_mxJPO {
     ...
     * @throws Exception
     */
    public emxCommonRDOMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    ...
    public void transitionProjectOrg(Context context, String[] args) throws Exception {
        ...
        String cmd = "transition project_org policy " + policy + " project '" + project + "' organization '" + organization + "'";
        // MqlUtil.mqlCommand(context, cmd, true, "project_org", policy, project, organization);
