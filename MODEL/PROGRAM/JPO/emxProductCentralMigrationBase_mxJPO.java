...
public class emxProductCentralMigrationBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     *            holds no arguments
     * @throws Exception
     *             when unable to find object id in the AEF
     * @since AEF10.6
     */
    ...
    public emxProductCentralMigrationBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
        ...
        try {
            ...
            for (int i = 0; i < iProductCount; i++) {
                ...
                MapList objBuildAndPCList = objProduct.getRelatedObjects(context,
                        ...
                        ProductLineConstants.TYPE_PRODUCT_CONFIGURATION + "," + ProductLineConstants.TYPE_BUILDS, true, true, 2, selectStmts, null, "", "", "", "", null);
    ...
    private static void migrationInfoWriter(boolean bVerbose, String strLogEnrty) throws Exception {
    ...
    private int migrateBuildsAndModels(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < iModelCount; i++) {
                ...
                MapList objProductList = objModel.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_PRODUCTS, ProductLineConstants.TYPE_PRODUCTS, true, true, 1, selectStmts, null, "", "",
                        "", "", null);
                ...
                if (!objProductList.isEmpty()) {
                    ...
                    for (int j = 0; j < iProductCount; j++) {
                        ...
                        MapList objProductBuildList = domObj.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_PRODUCT_BUILD, ProductLineConstants.TYPE_BUILDS, true, true, 1, selectStmts,
                                null, "", "", "", "", null);
                                ...
                                if (connectedPCId != null && !connectedPCId.equals("null") && !connectedPCId.equals("")) {
                                    if (pcIdList.contains(connectedPCId)) {
                                        ...
                                        migrationInfoWriter(bWriteOnMqlConsole,
                                                strBuildType + " " + strBuildName + " " + strBuildRev + " " + getString(context, "emxProductLine.Migration.BuildAmbiguous"));
                                    }
                                }
                                if (connectedPCId == null || connectedPCId.equals("null") || connectedPCId.equals("")) {
                                    objModelBuildMapList.add(objBuildMap);
