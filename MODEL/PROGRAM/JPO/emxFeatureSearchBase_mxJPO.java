...
public class emxFeatureSearchBase_mxJPO extends emxProductSearch_mxJPO {
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Object getProductConfigurationStates(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the HashMap with following arguments: queryLimit Name Revision Description State OwnerDisplay OriginatorDisplay vaultOption
    ...
    public static Object getProductConfigurations(Context context, String[] args) throws Exception {
        ...
        if (productId != null && (!productId.equals(SYMB_WILD)) && (!productId.equals(""))) {
            ...
            mapList = dObj.getRelatedObjects(context, ConfigurationConstants.RELATIONSHIP_PRODUCT_CONFIGURATION, ConfigurationConstants.TYPE_PRODUCT_CONFIGURATION, select, null, true, true, (short) 1,
                    // Modified by Vibhu,Enovia MatrixOne for Bug 311780 on 11/10/2005
                    sbWhereForProduct.toString(), null, null, null, null);
        } else {
            if (forAddExisting != null && "true".equalsIgnoreCase(forAddExisting)) {
                ...
                MapList mapList2 = domParentObj.getRelatedObjects(context, "*", ConfigurationConstants.TYPE_PRODUCT_CONFIGURATION, select, null, true, true, (short) 1, null, null, null, null, null);
     ...
     */
    public static MapList getGBOMForReplace(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            /*
             * Get the value of the radio concerned with the revision and set the value appropriately.
             */
            // If Null then set it to *
            String strRadio = (String) programMap.get("radio");
            String strRevision = null;
            ...
            /*
             * Depending on the values of the fields acquired above; build the where expression for the Query
             */
     ...
     * @since ProductCentral 10-0-0-0
     */
    public static Vector getConfigurationCount(Context context, String[] args) throws Exception {
    ...
    public StringList excludeConnected(Context context, String[] args) throws Exception {
        ...
        MapList childObjects = domObjFeature.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, strRelationship), toType == null ? fromType : toType,
                new StringList(DomainConstants.SELECT_ID), null, bisTo, bisFrom, (short) 1, DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING, 0);
    ...
    /**
     * To obtain the list of Object IDs to be excluded from the search for "Derived From" while creating the PC for tech feature
     * @param context
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            - holds the HashMap containing the following arguments
    ...
    public StringList excludeDerivedConfigurations(Context context, String[] args) throws Exception {
        ...
        String relPattern = ConfigurationConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "," + ConfigurationConstants.RELATIONSHIP_FEATURE_PRODUCT_CONFIGURATION;

        String typePattern = ConfigurationConstants.TYPE_PRODUCT_CONFIGURATION + "," + ProductLineConstants.TYPE_PRODUCTS;

        StringList objSel = new StringList();

        objSel.add(DomainConstants.SELECT_ID);
        objSel.add("relationship[" + ConfigurationConstants.RELATIONSHIP_PRODUCT_CONFIGURATION + "].to.to" + "[" + ConfigurationConstants.RELATIONSHIP_FEATURE_PRODUCT_CONFIGURATION + "].from.id");

        MapList lstPC = new DomainObject(strBasedOnId).getRelatedObjects(context, relPattern, typePattern, objSel, null, true, true, (short) 1, DomainConstants.EMPTY_STRING,
