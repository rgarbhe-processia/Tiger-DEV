...
public class IEFTMCUtilBase_mxJPO {
     ...
     * @since AEF 10.5
     */
    public IEFTMCUtilBase_mxJPO(Context context, String[] args) throws Exception {
        // Call the super constructor
        super();
    }

    /**
     * Get Workspaces of a the current user NOTE : This function is an extract of the emxTeamMyWorkSpaceSummary.jsp the code to get the id list is reused in the JPO Returns a maplist of the current
     * users project ids
     * @param context
     *            the eMatrix <code>Context</code> object
     * @throws Exception
    ...
    public static MapList getCurrentUserWorkspaces(Context context, String[] args) throws MatrixException {
        ...
        try {
            ...
            MapList roleWorkspaceList = DomainObject.findObjects(context, DomainConstants.TYPE_PROJECT, // type pattern
    ...
    /**
     * Get the folders of a Project Returns a maplist of folders
     * @param context
     *            the eMatrix <code>Context</code> object
     * @throws Exception
     *             if the operation fails
    ...
    public static MapList getWorkspaceFolders(Context context, String[] args) throws MatrixException {
        ...
        try {
            ...
            folderList = workspace.getRelatedObjects(context, DomainObject.RELATIONSHIP_WORKSPACE_VAULTS, DomainObject.TYPE_WORKSPACE_VAULT, objectSelects, null, false, true, (short) 1, null, null);
        } catch (Exception ex) {
