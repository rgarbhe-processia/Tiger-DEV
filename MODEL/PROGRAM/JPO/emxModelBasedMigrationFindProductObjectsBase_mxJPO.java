...
public class emxModelBasedMigrationFindProductObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO {
     ...
     * @grade 0
     */
    public emxModelBasedMigrationFindProductObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public void getIds(Context context, int chunkSize) throws Exception {
        ...
        try {
            ...
            String whereClause = "(policy == \"" + strPolicyProduct + "\") && (revision == last) && (from[" + RELATIONSHIP_ASSIGNED_PART + "] == True) && program[" + migrationProgramName
