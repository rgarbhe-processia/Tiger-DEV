...
/**
 * emxCommonPartFamilyBase.java Copyright (c) 1992-2015 Dassault Systemes. All Rights Reserved. This program contains proprietary and trade secret information of MatrixOne, Inc. Copyright notice is
...
/**
 * The <code>emxCommonPartFamilyBase</code> class contains utility methods for getting Part related data to feed configurable tables for PartFamily tree categories
 * @since Common 10.6
 * @grade 0
 */
public class emxCommonPartFamilyBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @grade 0
     */
    public emxCommonPartFamilyBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    /**
     * returns the MapList of Parts directly connected to a Part Family It is called in the Href of Parts command of the Part Family menu.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public static MapList getParts(Context context, String[] args) throws FrameworkException {
        ...
        try {
            ...
            partList = (MapList) partFamilyObj.getRelatedObjects(context, RELATIONSHIP_CLASSIFIED_ITEM, "*", selectStmts, new StringList(), false, true, (short) 1, null, null);
        } catch (Exception exp) {
    ...
    /**
     * Update the 'Classification Class' and its parent objects' count as a result of a classified item being revised or cloned.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
