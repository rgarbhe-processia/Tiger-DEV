        ...
        try {
            ...
            for (i = minRange; i <= maxRange; i++) {
                try {
                    ...
                    mqlLogRequiredInformationWriter("<<< Time taken for Validation of objects & write ConvertedOid.txt for file in milliseconds :" + documentDirectory + "objectids_" + i + ".txt"
            ...
            if (objectsList != null && !objectsList.isEmpty()) {
                ...
                while (objectsListItr.hasNext()) {
                    ...
                    if (objectId != null && !objectId.isEmpty()) {
                        ...
                        MapList mapListModel = (MapList) objModel.getRelatedObjects(context, strRelPattern.toString(), strTypePattern.toString(), slObjSelects, slRelSelects, getTo, getFrom, iLevel,
