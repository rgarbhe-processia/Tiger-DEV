 ...
 *
 * FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : "$Author: przemek $" Version : "$Revision: 1.13 $" Date : "$Date: Wed Oct 22 15:53:03 2008 $"
 *
 */
...
/**
 * This class encapsulates all the document/file information necessary for the printing/rendering of a file from the matrix STORE.
 * @author Devon Jones
...
public class emxPDFDocumentBase_mxJPO {
     ...
     *            Object ID
     * @param fileName
     *            Name of file to this PDF Document represents
     * @since AEF 9.5.4.0
     */
     ...
     * @exception Exception
     *                Exception on checkout failure,
     * @since AEF 9.5.4.0
     */
    public void checkOutFile(String directory) throws Exception {
        /*
         * Author : DJ Date : 02/04/2003 Notes : History :
         */
