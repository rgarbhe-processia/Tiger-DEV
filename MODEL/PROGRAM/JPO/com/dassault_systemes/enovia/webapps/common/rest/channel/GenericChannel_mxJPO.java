...
public class GenericChannel_mxJPO implements ChannelService {
    ...
    public List<RowSet> query(Context context, String[] args) throws Exception {
    ...
    @Override
    public List<RowSet> query(Context context, String baseURL, String itemHref, String typePattern, String where, List<Selectable> selects, List<ProgramSelectable> programSelects,
            ImageSelectable imageSelect, String overrideSortId, String overrideSortDirection) throws Exception {
    ...
    private String getImageURL(Context context, String baseURL, String imageHolderId, String format, String file) throws Exception {
        ...
        BusinessObjectProxy bproxy = new BusinessObjectProxy(imageHolderId, boFormat.getName(), boFile.getName(), false, false);
        bops.add(bproxy);
        // LKD - hack
        ...
        for (int i = 0; i < ml.size(); i++) {
            ...
            for (Iterator<String> itr = map.keySet().iterator(); itr.hasNext();) {
                ...
                if (index != -1) {
                    ...
                    try {
                        value = UINavigatorUtil.getAttrRangeI18NString(attributeName, (String) map.get(selectable), context.getSession().getLanguage());
