...
public class emxRuleExtensionBase_mxJPO {
     ...
     */
    public emxRuleExtensionBase_mxJPO(Context context, String[] args) throws Exception {
    }
    ...
    public MapList getAllRuleExtensions(Context context, String[] args) throws Exception {
        ...
        ruleExtensionMapList = contextObject.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_RULE_EXTENSION, ProductLineConstants.TYPE_RULE_EXTENSION, objectSelects, relationSelects,
    ...
    public MapList getAllRuleExtensionsSearch(Context context, String[] args) throws Exception {
        ...
        ruleExtensionList = domainObject.getRelatedObjects(context, strRelPattern, strObjPattern, objSelects, relSelects, true, true, sRecurse, "", "", 0);
    ...
    public StringList excludeConnectedRuleExtension(Context context, String[] args) throws Exception {
        ...
        MapList objectList = confUtil.getObjectStructure(context, ConfigurationConstants.TYPE_RULE_EXTENSION, ConfigurationConstants.RELATIONSHIP_RULE_EXTENSION, objSelects, relSelects, false, true,
        ...
        for (int i = 0; i < objectList.size(); i++) {
            ...
            if (mapREObj.containsKey(DomainObject.SELECT_ID)) {
                String REIDToExclude = (String) mapREObj.get(DomainObject.SELECT_ID);
