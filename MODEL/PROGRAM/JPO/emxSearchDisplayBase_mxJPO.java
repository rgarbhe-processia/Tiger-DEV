 ...
 * publication of such program. static const RCSID [] = "$Id: ${CLASSNAME}.java.rca 1.8 Wed Oct 22 16:02:45 2008 przemek Experimental przemek $";
 */
...
public class emxSearchDisplayBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @since AEF Rossini
     */
    public emxSearchDisplayBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public static String getEndItemsCount(Context context, String[] args) throws Exception {
        try {
            ...
            return MqlUtil.mqlCommand(context, strMQL, "count(true)", objectId, DomainConstants.RELATIONSHIP_CLASSIFIED_ITEM, strLimit);
