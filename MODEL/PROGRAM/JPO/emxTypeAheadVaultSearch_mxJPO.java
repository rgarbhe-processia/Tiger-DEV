...
/**
 * emxTypeAheadVaultSearch.java Copyright (c) 2006-2015 Dassault Systemes. All Rights Reserved. This program contains proprietary and trade secret information of MatrixOne, Inc. Copyright notice is
...
public class emxTypeAheadVaultSearch_mxJPO extends emxTypeAhead_mxJPO {
     ...
     * @since AEF 10.6.SP2
     */
    public String getVaultsIncludeCollaborationPartners(Context context, String[] args) throws Exception {
        ...
        while (itr.hasNext()) {
            map = (Map) itr.next();
            addValue((String) map.get("display"), (String) map.get(DomainConstants.SELECT_NAME));
        }
    ...
    /**
     * Translate the vault names given the language passed with the constructor.
     * @param vaults
     *            the list of vault maps
     * @return the same list with translated value in the map
     * @since AEF 10.6.SP2
     */
    private MapList translate(MapList vaults) throws Exception {
