...
public class emxDashboardDocumentsBase_mxJPO {
    ...
    public MapList getDocumentWhereUsed(Context context, String[] args) throws Exception {
        ...
        StringList slBusSelects = new StringList(new String[] { DomainConstants.SELECT_TYPE, DomainConstants.SELECT_ID, DomainConstants.SELECT_NAME,
                "type.kindof[" + DomainConstants.TYPE_PROJECT_SPACE + "]", "to[" + DomainConstants.RELATIONSHIP_PROJECT_VAULTS + "]", "to[" + DomainConstants.RELATIONSHIP_SUB_VAULTS + "]" });
        StringList slRelSelects = new StringList(new String[] { DomainConstants.SELECT_ORIGINATED, "type[connection]" });
        String relationshipPattern = DomainConstants.RELATIONSHIP_PROJECT_VAULTS + "," + DomainConstants.RELATIONSHIP_SUB_VAULTS + "," + DomainConstants.RELATIONSHIP_VAULTED_DOCUMENTS + ","
        ...
        for (int i = 0; i < mlTemp.size(); i++) {
            ...
            if (sIsProject.equalsIgnoreCase("TRUE") || sType.equals("Workspace")) {
                ...
                sbPath.insert(0, "<a title='" + sName + "' href='#' onClick=\"emxTableColumnLinkClick('../common/emxTree.jsp?emxSuiteDirectory=programcentral&amp;suiteKey=ProgramCentral&amp;objectId="
                        + sId + "', 'popup', '" + aDimensions[0] + "', '" + aDimensions[1] + "', '')\">");
        ...
        for (int i = 0; i < mlWBS.size(); i++) {
            ...
            if (sLevel.equals("1")) {
                ...
                // sbWBSStructure.append("<a title='").append(sName).append("'
                // href='emxTree.jsp?mode=insert&amp;emxSuiteDirectory=programcentral&amp;suiteKey=ProgramCentral&amp;objectId=").append(sId).append("'>");
                sbWBSStructure.insert(0,
                        "<a title='" + sName
                                + "' href='#' onClick=\"emxTableColumnLinkClick('../common/emxTree.jsp?mode=insert&amp;emxSuiteDirectory=programcentral&amp;suiteKey=ProgramCentral&amp;objectId=" + sId
                                + "', 'popup', '" + aDimensions[0] + "', '" + aDimensions[1] + "', '')\">");
        ...
        // Reference Document
        MapList mlReferences = dObject.getRelatedObjects(context, DomainConstants.RELATIONSHIP_REFERENCE_DOCUMENT, "*", new StringList(new String[] { "id" }), slRelSelects, true, false, (short) 1, "",
                "", 0);
        ...
        // Part Specification
        MapList mlParts = dObject.getRelatedObjects(context, DomainConstants.RELATIONSHIP_PART_SPECIFICATION, "*", new StringList(new String[] { "id" }), slRelSelects, true, false, (short) 1, "", "",
                0);
        ...
        // Meeting Attachment
        MapList mlMeetings = dObject.getRelatedObjects(context, DomainConstants.RELATIONSHIP_MEETING_ATTACHMENTS, DomainConstants.TYPE_MEETING, new StringList(new String[] { "id" }), slRelSelects,
    ...
    public WorkspaceVault cloneWorkspaceVault(Context context, String sOIDParent, String sOIDSource, String sCopyFiles) throws FrameworkException, MatrixException, Exception {
        ...
        MapList mlSubfolders = vaultSource.getRelatedObjects(context, DomainConstants.RELATIONSHIP_SUB_VAULTS, DomainConstants.TYPE_WORKSPACE_VAULT, busSelects, null, false, true, (short) 1, "", "",
                0);
    ...
    public String[] getUserDashboardData(Context context, String[] args) throws Exception {
        ...
        sbInfo1.append("<b>").append(iCounters[0]).append("</b>").append(sInfoPrefix).append("getDocuments&mode=NewWeek&header=emxFramework.String.DocumentsCreatedThisWeek\")'>")
                .append(EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.String.NEWThisWeek", sLanguage)).append("</a>");
        sbInfo2.append("<b>").append(iCounters[1]).append("</b>").append(sInfoPrefix).append("getDocuments&mode=NewMonth&header=emxFramework.String.DocumentsCreatedThisMonth\")'>")
                .append(EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.String.NEWThisMonth", sLanguage)).append("</a>");
        sbInfo3.append("<b>").append(iCounters[2]).append("</b>").append(sInfoPrefix).append("getDocuments&mode=ModWeek&header=emxFramework.String.DocumentsModifiedThisWeek\")'>")
                .append(EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.String.MODThisWeek", sLanguage)).append("</a>");
        sbInfo4.append("<b>").append(iCounters[3]).append("</b>").append(sInfoPrefix).append("getDocuments&mode=ModMonth&header=emxFramework.String.DocumentsModifiedThisMonth\")'>")
                .append(EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.String.MODThisMonth", sLanguage)).append("</a>");
        ...
        // Dashboard Counters
        MapList mlDocumentsLocked = DomainObject.findObjects(context, "DOCUMENTS", context.getVault().getName(), "(revision == last) && locker == \"" + context.getUser() + "\"", busSelects);
        ...
        sbCounter.append(
                "<td onclick='openURLInDetails(\"../common/emxIndentedTable.jsp?table=APPDashboardUserDocuments&program=emxDashboardDocuments:getDocuments&mode=Locked&header=emxFramework.String.LockedDocuments&freezePane=RouteStatus,Name,Title,Actions,NewWindow&suiteKey=Framework\")'");
        ...
        if (iCountMRU > 0) {
            sbUpdates.append(
                    " onclick='openURLInDetails(\"../common/emxIndentedTable.jsp?table=APPDashboardUserDocuments&program=emxDashboardDocuments:getDocuments&mode=MRU&header=emxFramework.String.MRUDocuments&freezePane=RouteStatus,Name,Title,Actions,NewWindow&suiteKey=Framework\")' ");
        ...
        aResults[0] = EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.String.DocumentUpdates", sLanguage);
        aResults[1] = sbInfo1.toString();
        aResults[2] = sbInfo2.toString();
        aResults[3] = sbInfo3.toString();
        aResults[4] = sbInfo4.toString();
        aResults[5] = sbNEW.toString();
        aResults[6] = sbMOD.toString();
        aResults[7] = sbCounter.toString();
        aResults[8] = sbUpdates.toString();
    ...
    public MapList getDocuments(Context context, String[] args) throws Exception {
        ...
        if (sMode.equals("New")) {
            ...
            MapList mlLockedItems = DomainObject.findObjects(context, strType, context.getVault().getName(), sblWhere.toString(), busSelects);
