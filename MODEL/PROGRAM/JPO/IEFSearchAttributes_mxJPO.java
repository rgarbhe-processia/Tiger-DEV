...
/**
 * IEFSearchAttributes.java Copyright Dassault Systemes, 1992-2007. All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systemes and its subsidiaries,
...
public class IEFSearchAttributes_mxJPO {
    ...
    /**
     * List returned by this method is used to render a table displaying attributes corresponding to the query entered in the attribute-search dialog. It returns a CustomMapList containing hashmap
     * objects. Each hashmap descrbes a row in the table.
     * @param Context
     *            context for user logged in
     * @param String
     *            array This method expects following parameters to be packed in string array sBasic=<basic_value> sAttribute=<attribute_value>
    ...
    public Object getTableData(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if ((sListAttribute != null) && (sListAttribute.size() != 0)) {
                int count = 0;
                count = filterList(sListAttribute, iFilterCount, attributeList, "images/iconSmallAttributeGroup.gif", "Attribute");
    ...
    private int filterList(StringList currentList, int iLimit, CustomMapList attributeList, String sImageSrc, String expressionType) {
        int count = 0;
        ...
        if (currentList != null && currentList.size() > 0) {
            for (int i = 0; ((i < currentList.size()) && (attributeList.size() < iLimit)); i++) {
                String sValue = "";
    ...
    private int getAttributeList(HashMap paramMap, Context context) {
        ...
        try {
            ...
            if (bAttribute) {
                ...
                String sAttrib = "";
                System.out.println("In getAttributeList4");
