 ...
 **
 ** FileName : emxDocumentSheetBase.java Author : "$Author: przemek $" Version : "$Revision: 1.12 $" Date : "$Date: Wed Oct 22 16:02:23 2008 $"
 */
...
public class emxDocumentSheetBase_mxJPO extends emxDocumentCentralRoot_mxJPO implements DocumentCentralConstants {
    /**
     * Constructor.
     * @param context
     ...
     * @since AEF 9.5.0.0
     */
    public emxDocumentSheetBase_mxJPO(Context context, String[] args) throws Exception {
        super(args[0]);
    ...
    public emxDocumentSheetBase_mxJPO(String id) throws Exception {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("Must specify method on emxDocumentSheetBase invocation");
        }
        return 0;
    }
