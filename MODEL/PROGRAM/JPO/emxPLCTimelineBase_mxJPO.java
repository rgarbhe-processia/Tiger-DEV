...
/*
 * emxPLCTimelineBase Copyright (c) 1992-2015 Dassault Systemes. All Rights Reserved. This program contains proprietary and trade secret information of MatrixOne, Inc. Copyright notice is
...
/**
 * This JPO <code>emxPLCTimelineBase</code> contains method pertaining to the product central timeline functionality.
...
public class emxPLCTimelineBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     */
    static protected final String SELECT_ATTRIBUTE_TASK_ESTIMATED_START_DATE = "attribute[" + DomainObject.ATTRIBUTE_TASK_ESTIMATED_START_DATE + "]";

    /**
     * Select expression for Attribute Task Estimated Finish Date.
     */
    static protected final String SELECT_ATTRIBUTE_TASK_ESTIMATED_FINISH_DATE = "attribute[" + DomainObject.ATTRIBUTE_TASK_ESTIMATED_FINISH_DATE + "]";

    /**
     * Select expression for Attribute Task Actual Start Date.
     */
    static protected final String SELECT_ATTRIBUTE_TASK_ACTUAL_START_DATE = "attribute[" + DomainObject.ATTRIBUTE_TASK_ACTUAL_START_DATE + "]";

    /**
     * Select expression for Attribute Task Actual Finish Date.
     */
    static protected final String SELECT_ATTRIBUTE_TASK_ACTUAL_FINISH_DATE = "attribute[" + DomainObject.ATTRIBUTE_TASK_ACTUAL_FINISH_DATE + "]";
    ...
    static protected final String SELECT_PRIMARY_IMAGE = "from[" + ProductLineConstants.RELATIONSHIP_PRIMARY_IMAGE + "].to." + DomainConstants.SELECT_ID;
    ...
    /**
     * This method is used to get the substring of the property file key after the last dot(.). This will give the symbolic name of the type for which the property file entry has been added.
     * @param strKey
     *            The property file key.
     * @return String containing the symbolic name of the type.
     * @since ProductCentral10.6
     */
    static protected String getLastReferenceKey(String strKey) {
        return strKey.substring(strKey.lastIndexOf('.') + 1, strKey.length());
    }

    /**
     * This method is used to set the select expression for the display name of the particular object type in the configuration Map.
     * @param mapConfig
     *            The roadmap configuration Map.
     * @param strObjectType
     *            The object type.
     ...
     * @since ProductCentral10.6
     */
    static protected void setConfigDisplayName(Map mapConfig, String strObjectType, String strDisplayName) {
        ...
        if (mapTypeConfig == null) {
            ...
            mapConfig.put(strObjectType, mapTypeConfig);
        }

        // Put the display name.
        mapTypeConfig.put(UITimeline.SELECT_DISPLAY_NAME, strDisplayName);
    }

    /**
     * This method is used to get the select expression for the display name of the partcular object type from the roadmap configuration map.
     * @param mapConfig
     *            The roadmap configuration map.
     * @param strObjectType
     *            The object type.
     ...
     * @since ProductCentral10.6
     */
    static protected String getConfigDisplayName(Map mapConfig, String strObjectType) {
    ...
    /**
     * This method is used to add the select expressions for the object details and detail labels to the type configuration map.
     * @param mapConfig
     *            The roadmap configuration map.
     * @param strObjectType
     *            The object type.
     * @param lstSelectsList
     *            The detail select list.
     * @param lstDisplayNameList
     *            The display name select list.
     * @since ProductCentral10.6
     */
    static protected void addConfigDetails(Map mapConfig, String strObjectType, StringList lstSelectsList, StringList lstDisplayNameList) {
        ...
        if (mapDetails == null) {
            ...
            mapTypeConfig.put(UITimeline.SELECT_DETAILS, mapDetails);
        }

        // Add the selects to the map.
        mapDetails.put(SELECT_DETAIL_SELECTS, lstSelectsList);
        mapDetails.put(SELECT_DETAIL_DISPLAY_NAMES, lstDisplayNameList);
    }

    /**
     * This method is used to get the list of details for particular object type from the roadmap configuration map.
     * @param mapConfig
     *            The roadmap configuration map.
     * @param strObjectType
     *            The object type.
     ...
     * @since ProductCentral10.6
     */
    static protected StringList getConfigDetailSelects(Map mapConfig, String strObjectType) {
        if (strObjectType == null) {
            return null;
        } else {
            Map mapTypeConfig = (Map) mapConfig.get(strObjectType);

            return (StringList) ((Map) mapTypeConfig.get(UITimeline.SELECT_DETAILS)).get(SELECT_DETAIL_SELECTS);
        }
    }

    /**
     * This method is used to get the list of detail labels for particular object type from the roadmap configuration map.
     * @param mapConfig
     *            The roadmap configuration map.
     * @param strObjectType
     *            The object type.
     ...
     * @since ProductCentral10.6
     */
    static protected StringList getConfigDetailDisplayNames(Map mapConfig, String strObjectType) {
        if (strObjectType == null) {
            return null;
        } else {
            Map mapTypeConfig = (Map) mapConfig.get(strObjectType);

            return (StringList) ((Map) mapTypeConfig.get(UITimeline.SELECT_DETAILS)).get(SELECT_DETAIL_DISPLAY_NAMES);
        }
    }

    /**
     * This method is used to get the default image url for the roadmap object from the roadmap configuration map.
     * @param mapRoadmapConfig
     *            The roadmap configuration map.
     * @return The string containig the url of the default roadmap image.
     * @since ProductCentral10.6
     */
    static protected String getDefaultImageURL(Map mapRoadmapConfig) {
        return (String) mapRoadmapConfig.get(ROADMAP_OBJECT_IMAGE_DEFAULT);
    }

    /**
     * This method is used to read the roadmap configuation settings defined in the aplication property file and put it into Map.
     * @param context
     *            The ematrix context object.
     * @param strSuiteKey
     *            The application suite key.
     * @return The roadmap configuration map for passed suitekey.
     * @throws Exception
     * @since ProductCentral10.6
     */
    static protected Map loadSuiteRoadmapMap(Context context) throws Exception {
        PropertyResourceBundle bundle = (PropertyResourceBundle) PropertyResourceBundle.getBundle("emxProductLine");
        ...
        roadmapConfig.put(SELECT_OBJECT_CONFIG, objectConfig);

        // Add the configuration settings defined for milestone object types.
        roadmapConfig.put(SELECT_MILESTONE_CONFIG, milestoneConfig);

        // Add the configuration settings defined miletone icons.
        roadmapConfig.put(SELECT_MILESTONE_ICON_MAP, milestoneIconMap);

        // Add the settings for the default image url.
        roadmapConfig.put(ROADMAP_OBJECT_IMAGE_DEFAULT, EnoviaResourceBundle.getProperty(context, ROADMAP_OBJECT_IMAGE_DEFAULT));
        ...
        roadmapConfig.put(SELECT_MILESTONE_RELATIONSHIP, strPropertyValue);
        ...
        if (strPropertyValue != null && strPropertyValue.indexOf("attribute_") != -1) {
            strPropertyValue = PropertyUtil.getSchemaProperty(context, strPropertyValue);
        }
        if (strPropertyValue == null)
            strPropertyValue = PropertyUtil.getSchemaProperty(context, "attribute_MilestoneType");
        roadmapConfig.put(ROADMAP_MILESTONE_TYPE, strPropertyValue);
        ...
        roadmapConfig.put(ROADMAP_MILESTONE_DATE, strPropertyValue);
        ...
        roadmapConfig.put(ROADMAP_MILESTONE_DATE_START, strPropertyValue);
        strPropertyValue = EnoviaResourceBundle.getProperty(context, ROADMAP_MILESTONE_DATE_END);
        if (strPropertyValue == null)
            strPropertyValue = "End";
        roadmapConfig.put(ROADMAP_MILESTONE_DATE_END, strPropertyValue);
        ...
        while (enumKeys.hasMoreElements()) {
            ...
            if (strKey.indexOf(ROADMAP_OBJECT_TITLE) != -1) {
                ...
                if (strValue != null && strValue.indexOf("$<") >= 0)
                    strValue = MessageUtil.substituteValues(context, strValue);
                setConfigDisplayName(objectConfig, strRealName, strValue);
            }
            // Add the configuration settings for the roadmap object details
            else if (strKey.indexOf(ROADMAP_OBJECT_DETAILS) != -1) {
                String strSymName = getLastReferenceKey(strKey);
                String strRealName = PropertyUtil.getSchemaProperty(context, strSymName);
                StringList lstDetailsList = FrameworkUtil.split(EnoviaResourceBundle.getProperty(context, strKey), ",");
                ...
                for (int i = 0; i < lstDetailsList.size(); i++) {
                    ...
                    if (strValue.indexOf("$<") >= 0) {
                        strValue = MessageUtil.substituteValues(context, strValue);
                        lstDetailsList.set(i, strValue);
                    }
                }

                StringList lstDisplayDetailsList = FrameworkUtil.split(EnoviaResourceBundle.getProperty(context, ROADMAP_OBJECT_DETAIL_LABELS + '.' + strSymName), ",");
                ...
                addConfigDetails(objectConfig, strRealName, lstDetailsList, lstDisplayDetailsList);
            }
            // Add the configuration settings for the milestone object details
                ...
                StringList lstDisplayDetailsList = FrameworkUtil.split(EnoviaResourceBundle.getProperty(context, ROADMAP_MILESTONE_DETAIL_LABELS + '.' + strSymName), ",");
                if (lstDetailsList.size() != lstDisplayDetailsList.size()) {
                    String strLanguage = context.getSession().getLanguage();
                    String strErrorMessage = EnoviaResourceBundle.getProperty(context, "ProductLine", "emxProduct.Error.NoDisplayLabels", strLanguage);
                    throw new Exception(strErrorMessage);
                }
                addConfigDetails(milestoneConfig, strRealName, lstDetailsList, lstDisplayDetailsList);
            }
            // Add the configuration settings for the milestone icons
                ...
                milestoneIconMap.put(getLastReferenceKey(strKey), EnoviaResourceBundle.getProperty(context, strKey));
                // Bug fix 335672 end
            }
        }
     ...
     * @since ProductCentral10.6
     */
    static protected Map getSuiteMap(Context context, String strSuiteKey) throws Exception {
        ...
        if (mapSuiteConfig == null) {
            ...
            suiteRoadmapConfigs.put(strSuiteKey, mapSuiteConfig);
        }
    ...
    /**
     * This method is used to get the defined type in configuration settingfor a particular type.
     * @param context
     *            The ematrix context of the request.
     * @param definedTypes
     *            The defined types set.
     * @param strTypeName
     *            The passed type name.
     * @return String containing the defined type.
     * @throws Exception
     * @since ProductCentral10.6
     */
    static protected String getDefinedType(Context context, Set definedTypes, String strTypeName) throws Exception {
     ...
     * @param context
     *            The ematrix context object.
     * @param mapObjectConfig
     *            The configuration map.
     * @param strObjectId
     *            The object id.
     * @param strDefinedType
     *            The definbed type.
     * @param strDisplayName
     *            The display name.
     ...
     * @since ProductCentral10.6
     */
    static protected Map getRoadmapObjectInfo(Context context, Map mapObjectConfig, String strObjectId, String strDefinedType, String strDisplayName, double ClientOffset, Locale localeObj)
            throws Exception {
        HashMap mapReturnMap = new HashMap();

        // Get the object selects for this object from the configuration map
        StringList lstObjectSelects = getConfigDetailSelects(mapObjectConfig, strDefinedType);

        // Get the display labels for this object from the configuration map
        StringList lstObjectDisplayNames = getConfigDetailDisplayNames(mapObjectConfig, strDefinedType);
        ...
        mapReturnMap.put(DomainObject.SELECT_ID, strObjectId);

        if (strDisplayName == null)
            strDisplaySelect = getConfigDisplayName(mapObjectConfig, strDefinedType);
        ...
        lstObjectSelects.addElement(SELECT_ATTRIBUTE_TASK_ESTIMATED_FINISH_DATE);
        ...
        Map objDetails = dObj.getInfo(context, lstObjectSelects);

        if (lstObjectDisplayNames.size() != 0) {
            lstDetails = new MapList(lstObjectDisplayNames.size());

            for (int selectIndex = 0; selectIndex < lstObjectDisplayNames.size(); selectIndex++) {
                HashMap mapTemp = new HashMap(2);
                strDetailName = (String) lstObjectDisplayNames.elementAt(selectIndex);

                if (strDetailName.equals("startDate")) {
                    strDetailValue = (String) objDetails.get(lstObjectSelects.elementAt(lstObjectDisplayNames.size() + 1));
                    if (strDetailValue.length() == 0) {
                        strDetailValue = (String) objDetails.get(lstObjectSelects.elementAt(lstObjectDisplayNames.size()));
                        // Added by Vibhu,Enovia MatrixOne for bug 303031 on 2nd May,05
                        strDetailValue = getDisplayDate(context, strDetailValue, ClientOffset, localeObj);
                        mapTemp.put(UITimeline.SELECT_VALUE, strDetailValue);
                        // Modified by Vibhu,Enovia MatrixOne for bug 303031 on 2nd May,05
                        mapTemp.put(UITimeline.SELECT_DISPLAY_NAME, ROADMAP_ESTIMATED_START_DATE);
                    } else {
                        // Added by Vibhu,Enovia MatrixOne for bug 303031 on 2nd May,05
                        strDetailValue = getDisplayDate(context, strDetailValue, ClientOffset, localeObj);
                        mapTemp.put(UITimeline.SELECT_VALUE, strDetailValue);
                        // Modified by Vibhu,Enovia MatrixOne for bug 303031 on 2nd May,05
                        mapTemp.put(UITimeline.SELECT_DISPLAY_NAME, ROADMAP_ACTUAL_START_DATE);
                    }

                    lstDetails.add(mapTemp);
                } else if (strDetailName.equals("finishDate")) {
                    strDetailValue = (String) objDetails.get(lstObjectSelects.elementAt(lstObjectDisplayNames.size() + 3));

                    if (strDetailValue.length() == 0) {
                        strDetailValue = (String) objDetails.get(lstObjectSelects.elementAt(lstObjectDisplayNames.size() + 2));
                        // Added by Vibhu,Enovia MatrixOne for bug 303031 on 2nd May,05
                        strDetailValue = getDisplayDate(context, strDetailValue, ClientOffset, localeObj);
                        mapTemp.put(UITimeline.SELECT_VALUE, strDetailValue);
                        // Modified by Vibhu,Enovia MatrixOne for bug 303031 on 2nd May,05
                        mapTemp.put(UITimeline.SELECT_DISPLAY_NAME, ROADMAP_ESTIMATED_FINISH_DATE);
                    } else {
                        // Added by Vibhu,Enovia MatrixOne for bug 303031 on 2nd May,05
                        strDetailValue = getDisplayDate(context, strDetailValue, ClientOffset, localeObj);
                        mapTemp.put(UITimeline.SELECT_VALUE, strDetailValue);
                        // Modified by Vibhu,Enovia MatrixOne for bug 303031 on 2nd May,05
                        mapTemp.put(UITimeline.SELECT_DISPLAY_NAME, ROADMAP_ACTUAL_FINISH_DATE);
                    }

                    lstDetails.add(mapTemp);
                } else {
                    mapTemp.put(UITimeline.SELECT_DISPLAY_NAME, lstObjectDisplayNames.elementAt(selectIndex));
                    mapTemp.put(UITimeline.SELECT_VALUE, objDetails.get(lstObjectSelects.elementAt(selectIndex)));
                    lstDetails.add(mapTemp);
                }
            }
        }

        mapReturnMap.put(UITimeline.SELECT_DETAILS, lstDetails);

        mapReturnMap.put(UITimeline.SELECT_ESTIMATED_START_DATE, objDetails.get(SELECT_ATTRIBUTE_TASK_ESTIMATED_START_DATE));
        mapReturnMap.put(UITimeline.SELECT_ACTUAL_START_DATE, objDetails.get(SELECT_ATTRIBUTE_TASK_ACTUAL_START_DATE));
        mapReturnMap.put(UITimeline.SELECT_ESTIMATED_FINISH_DATE, objDetails.get(SELECT_ATTRIBUTE_TASK_ESTIMATED_FINISH_DATE));

        mapReturnMap.put(UITimeline.SELECT_ACTUAL_FINISH_DATE, objDetails.get(SELECT_ATTRIBUTE_TASK_ACTUAL_FINISH_DATE));
        ...
        mapReturnMap.put(DomainConstants.SELECT_NAME, sbNameRev.toString());

        mapReturnMap.put(UITimeline.SELECT_IMAGE_OBJECT, objDetails.get(SELECT_PRIMARY_IMAGE));

        if (strDisplaySelect != null)
            strDisplayName = (String) objDetails.get(strDisplaySelect);
        /* End of Modify:Raman,Enovia MatrixOne for Bug#302847 on 4/21/2005 */
        mapReturnMap.put(UITimeline.SELECT_DISPLAY_NAME, strDisplayName);
     ...
     * @since ProductCentral10.6
     */
    public String getCurrentMilestone(MapList lstMilestones) {
        String strMilestoneName = null;

        if (lstMilestones.size() != 0) {
            Map mapMilestone = (Map) lstMilestones.get(0);
            strMilestoneName = (String) mapMilestone.get(UITimeline.SELECT_DISPLAY_NAME);
            String strValue = null;

            for (int i = 1; i < lstMilestones.size(); i++) {
                mapMilestone = (Map) lstMilestones.get(i);
                strValue = (String) mapMilestone.get(UITimeline.SELECT_ACTUAL_START_DATE);
     ...
     *            The object data map.
     * @param strRelName
     *            The relatioship name.
     * @param lstRelAttribList
     *            The rel attributes list.
     * @param strParentId
     *            The id of the parent.
     * @throws Exception
     * @since ProductCentral10.6
     */
    protected void addFilterData(Context context, Map mapObjectData, String strRelName, StringList lstRelAttribList, String strParentId) throws Exception {
        StringList lstSelects = new StringList(lstRelAttribList.size());

        String strAttName = null;
        for (int i = 0; i < lstRelAttribList.size(); i++) {
            strAttName = PropertyUtil.getSchemaProperty(context, (String) lstRelAttribList.elementAt(i));
            // Modified By:Raman,Enovia MatrixOne for Bug#303232 on 5/26/2005
            lstSelects.addElement("attribute[" + strAttName + "].value");
        }
        DomainObject dObj = new DomainObject((String) mapObjectData.get(DomainObject.SELECT_ID));
        ...
        List lstTmp = (MapList) dObj.getRelatedObjects(context, strRelName, "*", new StringList(DomainConstants.SELECT_ID), lstSelects, true, false, (short) 1, sbObjWhereExp.toString(), null);
        ...
        for (int i = 0; i < lstRelAttribList.size(); i++) {
            ...
            mapNewData.put(strAttName, mapTmp.get("attribute[" + strAttName + "].value"));
        }
        mapObjectData.put(UITimeline.SELECT_FILTER_DATA, mapNewData);
    }

    /**
     * This method is used to get the roadmap stucture for the selected roadmap objects in the list page.
     * @param context
     *            The ematrix context object.
     * @param args
     *            The packed arguments containing following arguments: objectIds: The selected roadmap object ids.
     * @return The roadmap structure.
     * @throws Exception
     * @since ProductCentral10.6
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getRoadmap(Context context, String[] args) throws Exception {
        try {
            ...
            String strAttributeFilterList = (String) paramMap.get("attributeFilterList");
            // Added by Vibhu,Enovia MatrixOne for Bug 303031 on 2nd may,05
            ...
            if (strAttributeFilterList != null)
                attributeFilterList = FrameworkUtil.split(strAttributeFilterList, UITimeline.FILTER_ATTRIBUTE_DELIMITER);
            Map roadmapConfig = getSuiteMap(context, strSuiteKey);
            MapList objectTypeMapList = DomainObject.getInfo(context, objectIds, SELECTLIST_TYPE);
            Map objectConfig = (Map) roadmapConfig.get(SELECT_OBJECT_CONFIG);
            Map milestoneConfig = (Map) roadmapConfig.get(SELECT_MILESTONE_CONFIG);
            Map milestoneIconMap = (Map) roadmapConfig.get(SELECT_MILESTONE_ICON_MAP);
            String milestoneRelationship = (String) roadmapConfig.get(SELECT_MILESTONE_RELATIONSHIP);
            String milestoneTypeSelect = "attribute[" + (String) roadmapConfig.get(ROADMAP_MILESTONE_TYPE) + "]";
            String milestoneDateSelect = "attribute[" + (String) roadmapConfig.get(ROADMAP_MILESTONE_DATE) + "]";
            ...
            for (int objectIndex = 0; objectIndex < objectTypeMapList.size(); objectIndex++) {
                ...
                strObjectType = (String) objectTypeMap.get(DomainObject.SELECT_TYPE);
                definedType = getDefinedType(context, definedObjectTypes, strObjectType);

                objectTypeMap = getRoadmapObjectInfo(context, objectConfig, (String) objectTypeMap.get(DomainObject.SELECT_ID), definedType, null, ClientOffset, localeObj);

                dObj = new DomainObject((String) objectTypeMap.get(DomainObject.SELECT_ID));

                objectTypeMap.put(UITimeline.SELECT_IMAGE_URL, getDefaultImageURL(roadmapConfig));

                MapList relatedObjects = dObj.getRelatedObjects(context, milestoneRelationship, "*", SELECTLIST_TYPE, milestoneRelSelect, false, true, (short) 1, null, null);
                ...
                for (int milestoneIndex = 0; milestoneIndex < relatedObjects.size(); milestoneIndex++) {
                    milestoneTypeMap = (Map) relatedObjects.get(milestoneIndex);
                    strObjectType = (String) milestoneTypeMap.get(DomainObject.SELECT_TYPE);
                    definedType = getDefinedType(context, definedMilestoneTypes, strObjectType);
                    milestoneDisplayType = (String) milestoneTypeMap.get(milestoneTypeSelect);
                    milestoneDate = (String) milestoneTypeMap.get(milestoneDateSelect);

                    milestoneDisName = i18nNow.getRangeI18NString((String) roadmapConfig.get(ROADMAP_MILESTONE_TYPE), milestoneDisplayType, (String) context.getSession().getLanguage());

                    milestoneTypeMap = getRoadmapObjectInfo(context, milestoneConfig, (String) milestoneTypeMap.get(DomainObject.SELECT_ID), definedType, milestoneDisName, ClientOffset, localeObj);
                    milestoneTypeMap.put(UITimeline.SELECT_IMAGE_URL, milestoneIconMap.get(milestoneDisplayType.replace(' ', '_')));
                    milestoneTypeMap.put(ROADMAP_MILESTONE_TYPE, roadmapConfig.get(ROADMAP_MILESTONE_TYPE));

                    if (attributeFilterList != null)
                        // Modified By:Raman,Enovia MatrixOne for Bug#303232 on 5/26/2005
                        addFilterData(context, milestoneTypeMap, milestoneRelationship, attributeFilterList, (String) objectTypeMap.get(DomainObject.SELECT_ID));
                    /* Begin of Modify:Raman,Enovia MatrixOne for Bug#303027 on 4/21/2005 */
                    if (milestoneDate.equals((String) roadmapConfig.get(ROADMAP_MILESTONE_DATE_START))) {
                        if (((String) milestoneTypeMap.get(UITimeline.SELECT_ACTUAL_START_DATE) != null) && (!"".equals((String) milestoneTypeMap.get(UITimeline.SELECT_ACTUAL_START_DATE))
                                && (!"null".equalsIgnoreCase((String) milestoneTypeMap.get(UITimeline.SELECT_ACTUAL_START_DATE))))) {
                            milestoneTypeMap.put(UITimeline.SELECT_MILESTONE_DATE, (String) milestoneTypeMap.get(UITimeline.SELECT_ACTUAL_START_DATE));
                        } else {
                            milestoneTypeMap.put(UITimeline.SELECT_MILESTONE_DATE, (String) milestoneTypeMap.get(UITimeline.SELECT_ESTIMATED_START_DATE));
                        }
                    } else if (milestoneDate.equals((String) roadmapConfig.get(ROADMAP_MILESTONE_DATE_END))) {
                        if (((String) milestoneTypeMap.get(UITimeline.SELECT_ACTUAL_FINISH_DATE) != null) && (!"".equals((String) milestoneTypeMap.get(UITimeline.SELECT_ACTUAL_FINISH_DATE))
                                && (!"null".equalsIgnoreCase((String) milestoneTypeMap.get(UITimeline.SELECT_ACTUAL_FINISH_DATE))))) {
                            milestoneTypeMap.put(UITimeline.SELECT_MILESTONE_DATE, (String) milestoneTypeMap.get(UITimeline.SELECT_ACTUAL_FINISH_DATE));
                        } else {
                            milestoneTypeMap.put(UITimeline.SELECT_MILESTONE_DATE, (String) milestoneTypeMap.get(UITimeline.SELECT_ESTIMATED_FINISH_DATE));
                        }
                    }
                ...
                if (milestoneList != null) {
                    ...
                    milestoneList.sort(UITimeline.SELECT_MILESTONE_DATE, "ascending", "date");
                    objectTypeMap.put(UITimeline.SELECT_MILESTONES, milestoneList);
                    objectTypeMap.put(UITimeline.SELECT_CURRENT_MILESTONE, getCurrentMilestone(milestoneList));
    ...
    /**
     * This method is used to return the Formatted date corrosponding to user objects in the list page.
     * @param context
     *            The ematrix context object.
     * @param String
    ...
    // Begin of add by Enovia MatrixOne for Bug 303522 on 3rd May,05
    /**
     * This column JPO method is invoked while displaying the Tasks list page under products and is used to display the slip days icon.
     * @param context
     *            The ematrix context of the request
     * @param args
    ...
    public Vector getSlipDaysIcon(Context context, String[] args) throws Exception, FrameworkException {
        ...
        // the property file
        String strLanguage = context.getSession().getLanguage();
        String strLegendOnTime = EnoviaResourceBundle.getProperty(context, "ProductLine", "emxProduct.ProjectStatus.OnTime", strLanguage);
        String strLegendLate = EnoviaResourceBundle.getProperty(context, "ProductLine", "emxProduct.ProjectStatus.Late", strLanguage);
        String strLegendBehind = EnoviaResourceBundle.getProperty(context, "ProductLine", "emxProduct.ProjectStatus.BehindSchedule", strLanguage);
        ...
        for (int i = 0; i < lstProjectList.size(); i++) {
            ...
            strEstEndDate = (String) mapProject.get(SELECT_ATTRIBUTE_TASK_ESTIMATED_FINISH_DATE);
            ...
            if (dtSysDate.after(dtFinishDate)) {
                lDaysRemain = DateUtil.computeDuration(dtFinishDate, dtSysDate);
            }
            ...
            if (strState.equals(strStateComplete)) {
                ...
                sbHtmlTag.append("\">");
            } else if (dtSysDate.after(dtFinishDate) && lDaysRemain <= iThreshold) {
