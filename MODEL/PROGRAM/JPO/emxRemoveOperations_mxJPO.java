 ...
 *
 * FileName : "$RCSfile: ${CLASSNAME}.rca $" Author : Anil KJ Version : "$Revision: 1.9 $" Date : "$Date: Wed Oct 22 16:02:09 2008 $"
 *
...
/**
 * The <code>${CLASSNAME}</code> class extends the Base JPO that is used to Remove Operations
...
public class emxRemoveOperations_mxJPO extends emxRemoveOperationsBase_mxJPO {
    ...
    public emxRemoveOperations_mxJPO(Context context, String[] args) throws Exception {
        super(args[0]);
    }
    ...
    public emxRemoveOperations_mxJPO(String id) throws Exception {
        super(id);
    }
