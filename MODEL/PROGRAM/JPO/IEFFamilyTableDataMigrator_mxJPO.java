...
public class IEFFamilyTableDataMigrator_mxJPO {
    ...
    public IEFFamilyTableDataMigrator_mxJPO(Context context, String[] args) throws Exception {
    ...
    private void processResultsForRelationship(Context context, String parentInstanceName, StringList childRelidList, StringList childidList, StringList childIsPrimaryList, StringList familyIdList,
            StringList parentIsPrimaryList, StringList familyCADTypeList) throws Exception {
    ...
    private void processChildInstance(Context context, String childInstanceId, String childInstanceRelId, String childIsPrimary, String parentInstanceName, StringList familyIdList,
            StringList parentIsPrimaryList, StringList familyCADTypeList) throws Exception {
