...
/**
 * DECBaselineDetails.java Copyright Dassault Systemes, 1992-2007. All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systemes and its subsidiaries,
 * Copyright notice is precautionary only and does not evidence any actual or intended publication of such program This JPO gets all revisions for a BusinessObject Project. Infocentral Migration to UI
 * level 3 $Archive: $ $Revision: 1.2$ $Author:
 * @since AEF 9.5.2.0
 */
