...
/**
 * The <code>${CLASS:RelationshipBinaryUpgradeMigrationBase}</code> class contains the utilities necessary to migrate the stored binary data for Effectiviy expression to new format. It must be run on
 * all CFF data created prior to V6R2013x.
 */
public class RelationshipBinaryUpgradeMigrationBase_mxJPO extends emxCommonMigration_mxJPO {
     ...
     */
    public RelationshipBinaryUpgradeMigrationBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    public void migrateObjects(Context context, StringList objectIdList) throws Exception {
        ...
        /*
         * Below code can be uncommented after Migration Prechecks implementation if(migrationStatus < 2) { mqlLogRequiredInformationWriter(
         * "Migration pre-check is not complete.Please complete migration pre-checks before running Relationship Binary Upgrade migration. \n"); bIsException=true; return; }
         */
        try {
    ...
    public int getAdminMigrationStatus(Context context) throws Exception {
        ...
        String result = MqlUtil.mqlCommand(context, "print program $1 select $2 dump", "eServiceSystemInformation.tcl", "property[RelationshipBinaryUpgradeMigration].value");
    ...
    public void setAdminMigrationStatus(Context context, String strStatus) throws Exception {
        MqlUtil.mqlCommand(context, "modify program $1 property $2 value $3", "eServiceSystemInformation.tcl", "RelationshipBinaryUpgradeMigration", strStatus);
    }
