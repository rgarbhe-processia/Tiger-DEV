...
/**
 * The <code>emxProjectTemplate</code> class represents the Project Template JPO functionality for the AEF type.
...
public class emxProjectTemplate_mxJPO extends emxProjectTemplateBase_mxJPO {
     ...
     * @grade 0
     */
    public emxProjectTemplate_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
