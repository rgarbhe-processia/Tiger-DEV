...
/**
 * @author ixk The <code>${CLASSNAME}</code> class/interface contains ...
...
public class emxAEFUtilBase_mxJPO {
     ...
     * @throws Exception
     */
    public static boolean accessEditActions(Context context, String[] args) throws Exception {
     ...
     * @throws Exception
     */
    public static boolean accessEditAdd(Context context, String[] args) throws Exception {
        boolean access = true;
        HashMap requestMap = (HashMap) JPO.unpackArgs(args);
     ...
     * @throws Exception
     */
    public static boolean accessEditRemove(Context context, String[] args) throws Exception {
        boolean access = true;
        HashMap requestMap = (HashMap) JPO.unpackArgs(args);
        String newRow = (String) requestMap.get("insertNewRow");
        String applyURL = (String) requestMap.get("applyURL");
        ...
        String uiType = (String) requestMap.get("uiType");
        return ("structureBrowser".equalsIgnoreCase(uiType)
                && ((newRow != null && "true".equalsIgnoreCase(newRow)) || lookupJPO != null && !"".equals(lookupJPO) || (applyURL != null && !"".equals(applyURL))));
    }
     ...
     * @throws Exception
     */
    public static boolean accessEditSeparator(Context context, String[] args) throws Exception {
        boolean access = true;
        HashMap requestMap = (HashMap) JPO.unpackArgs(args);
        String newRow = (String) requestMap.get("insertNewRow");
        String applyURL = (String) requestMap.get("applyURL");
     ...
     * @throws Exception
     */
    public static boolean accessEditExisting(Context context, String[] args) throws Exception {
        boolean access = true;
        HashMap requestMap = (HashMap) JPO.unpackArgs(args);
    ...
    public String deleteObject(Context context, String objectId) throws Exception {
        ...
        try {
            ...
            /*
             * if(error.lastIndexOf(":") != -1) { int lastIndex = error.lastIndexOf(":"); error = error.substring(lastIndex+1); } if(error.indexOf("to") != -1) { int lastIndex = error.indexOf("to");
     ...
     * @throws Exception
     */
    public static boolean getFullSearchAccess(Context context, String[] args) throws Exception {
        HashMap requestMap = (HashMap) JPO.unpackArgs(args);
    ...
    public static String getWelcomeMessage(Context context, String[] args) throws Exception {
        ...
        String res = MqlUtil.mqlCommand(context, "temp query bus $1 $2 $3 limit 1 select $4 $5 $6 dump $7", typePerson, personName, "-", "id",
                "attribute[" + DomainConstants.ATTRIBUTE_FIRST_NAME + "]", "attribute[" + DomainConstants.ATTRIBUTE_LAST_NAME + "]", "|");
    ...
    public HashMap getFullTextFilterColumns(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (UIUtil.isNotNullAndNotEmpty(ftsFilters)) {
                ...
                while (filterKeyIter.hasNext()) {
                    ...
                    if (!PARAM_TYPES.equals(fieldName) && !strKey.equals(fieldName) && jsonValues.length() > 0) {
                        ...
                        if (EQUALS.equalsIgnoreCase(operator) && containsLibrary && dynFields.contains(fieldName)) {
                            if ((addExactMatch && jsonValues.length() == 0) || (!addExactMatch && jsonValues.length() <= 1)) {
                    ...
                    while (fieldItr.hasNext()) {
                        ...
                        if (field != null && field.selectable != null) {
                            ...
                            if (!UISearchUtil.IsColumnExists("BusinessObject", field.selectable, expressionList) && !UISearchUtil.IsColumnExists("RelationShip", field.selectable, expressionList)
                                    && !UISearchUtil.IsColumnExists("BusinessObject", field.selectable + ".value", expressionList)
                                    && !UISearchUtil.IsColumnExists("RelationShip", field.selectable + ".value", expressionList)) {
                ...
                /*
                 * if(dynColumns.size() > 0) { insertColumns(tablecolumns,dynColumns,requestMap,controlMap,dynColPos); }
                 */
            }
