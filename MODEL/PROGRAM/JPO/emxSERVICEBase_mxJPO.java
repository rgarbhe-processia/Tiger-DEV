...
public class emxSERVICEBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public MapList getServiceSearchResult(Context context, String[] args) throws Exception {
        ...
        if (objectId != null && !objectId.equals("null")) {
            ...
            // Sub Service Folders
            aggregatedServicesConnectedList = boServiceFolder.expandSelect(context, relType, TYPE_SERVICE, busSelects, relSelects, true, true, (short) 1, null, null, null, null, null, null, false);
