 ...
 */
public class emxWorkflowTask_mxJPO extends emxWorkflowTaskBase_mxJPO {
     ...
     * @grade 0
     */
    public emxWorkflowTask_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
