...
public class emxPLCPartBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments 0 - id of the business object 1 - side side of expand (from/to) 2 - relationship name
    ...
    protected MapList expandForParts(Context context, String args[], String strWhereCondition) throws Exception {
        ...
        // making the querry
        mapBusIds = getRelatedObjects(context, strRelPattern, strObjPattern, objSelects, relSelects, true, true, sRecurse, strWhereCondition, DomainConstants.EMPTY_STRING);
    ...
    /*
     * Modified by <Tanmoy Chatterjee> On <22nd May 2003> For the following Bug <Even when a feature is in preliminary state parts can be added to it.> Fixed as Follows: <added the following functions
     * and updated the tool.xls>
     */
    ...
    public Vector getEBOMEditIcon(Context context, String[] args) throws Exception {
        ...
        while (objectListItr.hasNext()) {
            String strURL = "../common/emxForm.jsp?form=PLCEBOMDetails&mode=Edit&formHeader=emxProduct.Heading.EditPartAttributes&HelpMarker=emxhelpproducteditallparts&emxSuiteDirectory="
                    + emxSuiteDirectory + "&parentOID=" + parentOID + "&jsTreeID=" + jsTreeID + "&suiteKey=" + suiteKey;
            ...
            mapListBusIds = domPartObj.getRelatedObjects(context, "*", ProductLineConstants.TYPE_GBOM, objSelects, null, true, true, (short) 1, strWhereCondition, DomainConstants.EMPTY_STRING);
            ...
            statusGif = "<a href=\"javascript:emxTableColumnLinkClick(\'" + strURL
                    + "\',\'570\',\'520\',\'true\',\'popup\',\'\')\"><img src=\"images/iconActionEdit.gif\" border=0 alt=\"Edit\"></a>&nbsp;";
    ...
    public Boolean updateReferenceDesignator(Context context, String[] args) throws Exception {
        ...
        mlRelObj = domObj.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_GBOM_TO, ProductLineConstants.TYPE_GBOM, slTempId, slTempRel, true, false, (short) 1,
        ...
        mlRelGBOMFromObj = domObjGBOM.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_GBOM_FROM, DomainConstants.QUERY_WILDCARD, slGBOMFromId, slGBOMFromRelID, true, false, (short) 1,
                DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
    ...
    public List getFindNumber(Context context, String[] args) throws Exception {
        ...
        for (int j = 0; j < lstObjectIdsList.size(); j++) {
            ...
            if (!strRelType.equals(ProductLineConstants.RELATIONSHIP_GBOM_TO)) {
                ...
                mlRelGBOMFromObj = domObjGBOM.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_GBOM_FROM, DomainConstants.QUERY_WILDCARD, slGBOMFromId, slGBOMFromRelID, true, false,
                ...
                sb = sb.append("\"" + strFindNumber + "\"").append(strEndHrefTitle).append(strFindNumber).append(strEndHref);
    ...
    public List getComponentLocation(Context context, String[] args) throws Exception {
        ...
        for (int j = 0; j < lstObjectIdsList.size(); j++) {
            ...
            if (!strRelType.equals(ProductLineConstants.RELATIONSHIP_GBOM_TO)) {
                ...
                sb = sb.append("\"" + strComponentLocation + "\"").append(strEndHrefTitle).append(strComponentLocation).append(strEndHref);
    ...
    public List getReferenceDesignator(Context context, String[] args) throws Exception {
        ...
        for (int j = 0; j < lstObjectIdsList.size(); j++) {
            ...
            if (!strRelType.equals(ProductLineConstants.RELATIONSHIP_GBOM_TO)) {
                ...
                sb = sb.append("\"" + strReferenceDesignator + "\"").append(strEndHrefTitle).append(strReferenceDesignator).append(strEndHref);
    ...
    public TreeMap getRangeValuesForUsage(Context context, String[] args) throws Exception {
        ...
        List attributeDisplayRange = i18nNow.getAttrRangeI18NStringList(ProductLineConstants.ATTRIBUTE_USAGE, (StringList) attributeRange, context.getSession().getLanguage());
    ...
    public List getUsage(Context context, String[] args) throws Exception {
        ...
        while (ik.hasNext()) {
            ...
            if (strRelType.equals(ProductLineConstants.RELATIONSHIP_GBOM_TO)) {
                ...
                sb = sb.append("\"" + strUsageDisplay + "\"").append(strEndHrefTitle).append(strUsageDisplay).append(strEndHref);
    ...
    public StringList getUsageForGBOM(Context context, String[] args) throws Exception {
        ...
        strUsageValue = EnoviaResourceBundle.getProperty(context, "Framework", "emxFramework.Range.Usage." + strUsageValue, language);
