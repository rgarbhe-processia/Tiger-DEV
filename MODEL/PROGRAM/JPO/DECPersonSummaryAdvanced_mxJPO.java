...
public class DECPersonSummaryAdvanced_mxJPO {
    public Object getWorkspaceAssociations(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String SELECT_ATTR_PROJECT_ACCESS = "from[" + relProjectMembershipActualName + "].to.to[" + relProjectMembersActualName + "].to."
                    + DomainObject.getAttributeSelect(DomainObject.ATTRIBUTE_PROJECT_ACCESS);
