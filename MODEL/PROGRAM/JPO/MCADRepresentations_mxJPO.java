 ...
 * CustomMapList which stores each row of table as Map objects. The Table data returned is the list of Representations supported by the input business object. Value of "ProE Simplified Reps" attribute
 * on business object is the representations supported.
 */
...
public class MCADRepresentations_mxJPO {
     ...
     * @param Context
     *            context - context for user logged in
     * @param String
     *            array
     */
     ...
     *            context - context for user logged in
     * @param String
     *            gcoString - global confg object in string format
     * @param String
     *            sLanguage - language specified for resource bundle
     */
    ...
    /**
     * This method returns Representations table data using a CustomMapList. Each row data of table is stored in Map object which in turn is stored in CustomMaplist. Data Picking logic - Value of
     * "ProE Simplified Reps" attribute on business object (sBusId) is the Representations in the format Representation1,Representation2 etc is parsed and shown in table form.
     * @param Context
     *            context for user logged in
     * @param String
     ...
     *            above object gcoString : GCO object string instanceName : instance selected
