 ...
 **
 ** All Rights Reserved. This program contains proprietary and trade secret information of Dassault Systemes and its subsidiaries, Copyright notice is precautionary only and does not evidence any
                                            ...
                                            while (relAllChildListItr.next()) {
                                                ...
                                                if (!relChildId.equals(returnRelID)) {
                                                    if (returnAllChildRel.getTypeName().equals(cadSubcomponentRelationship)) {
                                                        ...
                                                        String attrValue = _util.getRelationshipAttributeValue(context, returnAllChildRel,
                                                                MCADMxUtil.getActualNameForAEFData(context, "attribute_RelationshipModificationStatusinMatrix"));
