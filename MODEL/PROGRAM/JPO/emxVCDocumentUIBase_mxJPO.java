 ...
 ** emxVCDocumentUIBase
 **
 ** $RCSfile: emxVCDocumentUIBase_mxJP0.java $
 **
 ** $Revision: 3.1 $ $Date: Oct 30 2013 $
 **
...
public class emxVCDocumentUIBase_mxJPO {
    ...
    static final String SELECT_PROJECT_TYPE_FROM_TASK = "to[" + DomainConstants.RELATIONSHIP_PROJECT_ACCESS_KEY + "].from.from[" + DomainConstants.RELATIONSHIP_PROJECT_ACCESS_LIST + "].to.type";
    ...
    /**
     * returns true if object created doesn't have a DSFAImport tag. else returns false.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @return boolean
     * @throws Exception
    ...
    */
    ...
    /**
     * This method is used to get the list of files and their versions in master (i.e. document holder) object
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public MapList getVCFileVersions(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (ex.toString().indexOf("java.lang.StringIndexOutOfBoundsException") != -1) {
                ...
                String strError = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(strLanguage), "emxComponents.VCDocument.InvalidConnection");
    ...
    /**
     * getVersion - get Versions strings for File versions Summary Table Method is called to populate the Version Column.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    /**
     * getOwner - Will get the Owner for File versions Summary Table Will be called in the Owner Column.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            an array of String arguments for this method
    ...
    /**
     * getCheckinDate - Will get the CheckIn Date for File versions Summary Table Will be called in the CheckIn Date Column.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            an array of String arguments for this method
    ...
    /*
     * getComments - Will get the Comments for File versions Summary Table Will be called in the Comments Column.
     * 
    ...
    /*
     * getFormat - Will get the format for File versions Summary Table Will be called in the Format Column.
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args an array of String arguments for this method
    ...
    /*
     * getTags - extract the Module or file tags from the maps Called to populate the table column.
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     ...
     * @since Common 10-7
     * 
     * @grade 0 Updated per IR-186375V6R2014 on 2013-01-21
     */
    ...
    public Object getVCFolderConfigActions(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String type = _empty;
            String sTipDownload = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(languageStr), "emxComponents.DocumentSummary.ToolTipDownload");
            ...
            for (int i = 0; i < objectList.size(); i++) {
                ...
                if (canViewAndDownload) {
                    if (!isprinterFriendly) {
                        if (type.equals("file")) {
                            downloadURL = "javascript:.callCheckout('" + XSSUtil.encodeForJavaScript(context, objectId) + "','download', '" + folderPath + "', '"
                            ...
                            fileActionsStrBuff.append("<img border='0' src='../common/images/iconActionDownload.gif' alt=\"" + sTipDownload + "\" title=\"" + sTipDownload + "\"></a>&nbsp;");
                        }
                    } else {
                        if (type.equals("file")) {
                            fileActionsStrBuff.append("<img border='0' src='../common/images/iconActionView.gif' alt=\"" + i18nViewerTip + "\" title=\"" + i18nViewerTip + "\"></a>&nbsp;");
                            fileActionsStrBuff.append("<img border='0' src='../common/images/iconActionDownload.gif' alt=\"" + sTipDownload + "\" title=\"" + sTipDownload + "\"></a>&nbsp;");
                        }
                    }
                }
        ...
        if (level == null && "searchVCDocuments".equalsIgnoreCase(fromPage)) {
            ...
            for (int i = 0; i < objectList.size(); i++) {
                ...
                if (vcfile.equalsIgnoreCase("TRUE")) {
                    ...
                    sBuff.append("<img src=\"images/iconSmallFolder.gif\" valign=\"bottom\" border=\"0\" />");
                }
    ...
    /**
     * This method is used to extract version strings from the maps Called to populate the table column.
     * @param context
     *            - the eMatrix <code>Context</code> object
     * @param args
     *            - packed argument maps
     * @return Object (Vector)
     * @throws Exception
     *             if the operation fails
     * @since Common 10-7
                    ...
                    if (canViewAndDownload) {
                        if (!isprinterFriendly) {
                            if (type.equals("file") && showFileVersions) {
                                ...
                                viewerURL = getVCFolderViewerURL(context, objectId, fileFormat, folderPath, versionId);
                                fileActionsStrBuff.append(viewerURL);
                                fileActionsStrBuff.append("<a href=\"" + downloadURL + "\">");
     ...
     * @grade 0
     */
    public static String getVCFolderViewerURL(Context context, String objectId, String format, String fileName, String versionid) throws Exception {
        try {
            ...
            if (formatDetailsMap == null) {
                viewerURL = "javascript:callCheckout('" + XSSUtil.encodeForJavaScript(context, objectId) + "','view', '" + XSSUtil.encodeForJavaScript(context, fileName) + "', '"
                ...
                while (itr.hasNext()) {
                    ...
                    if (viewer == null || "".equals(viewer) || "null".equals(viewer) || viewerURL.equals(viewer)) {
                        ...
                        if (viewerTip.equalsIgnoreCase("Default")) {
                            ...
                            viewerURL = "javascript:callViewer('" + XSSUtil.encodeForJavaScript(context, objectId) + "','view', '" + XSSUtil.encodeForJavaScript(context, fileName) + "', '"
                                    + XSSUtil.encodeForJavaScript(context, format) + "', '" + viewerURL + "', null, '" + XSSUtil.encodeForJavaScript(context, versionid) + "');";
                            fileViewerURL.append("<a href=\"" + viewerURL + "\">");
                            fileViewerURL.append("<img src=\"../common/images/iconActionView.gif\" border=\"0\" alt=\"");
                            fileViewerURL.append(i18nViewerTip);
                            fileViewerURL.append("\" title=\"");
    ...
    public static Vector getVCFileVersionActions(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < objectList.size(); i++) {
                ...
                if (canViewAndDownload) {
                    if (!isprinterFriendly) {
                        downloadURL = "javascript:callCheckout('" + objectId + "','download', '" + fileName + "', '" + fileFormat + "', null, null, null, null, null, '" + versionid + "');";
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectList - maplist of DS file information paramList - map ofreport information
    ...
    public static Vector getVCFileActions(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String sTipCheckout = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(languageStr), "emxComponents.DocumentSummary.ToolTipCheckout");

            String sTipUpdate = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(languageStr), "emxComponents.DocumentSummary.ToolTipUpdate");
            ...
            for (int i = 0; i < objectList.size(); i++) {
                ...
                if (canViewAndDownload) {
                    if (!isprinterFriendly) {
                        ...
                        downloadURL = "javascript:callCheckout('" + objectId + "','checkout', '" + fileName + "', '" + fileFormat + "', null, null, null, null, null, '" + versionid + "');";

                        fileActionsStrBuff.append("<a href=\"" + downloadURL + "\">");
                        fileActionsStrBuff
                                .append("<img style='border:0; padding: 2px;' src='../common/images/iconActionCheckOut.gif' alt=\"" + sTipCheckout + "\" title=\"" + sTipCheckout + "\"></a>&nbsp;");

                        fileActionsStrBuff.append("<a href=\"javascript:showModalDialog('../components/emxCommonDocumentPreCheckin.jsp?objectId=" + objectId
                                + "&showFormat=readonly&showComments=required&objectAction=checkinVCFile&allowFileNameChange=false&noOfFiles=1&JPOName=emxVCDocument&methodName=checkinUpdate','730','450');\">");
                        fileActionsStrBuff
                                .append("<img style='border:0; padding: 2px;' src='../common/images/iconActionCheckIn.gif' alt=\"" + sTipUpdate + "\" title=\"" + sTipUpdate + "\"></a>&nbsp");
                        ...
                        fileActionsStrBuff
                                .append("<img style='border:0; padding: 2px;' src='../common/images/iconActionCheckIn.gif' alt=\"" + sTipUpdate + "\" title=\"" + sTipUpdate + "\"></a>&nbsp;");
                    }
                }
     ...
     * @grade 0
     */
    public static String getViewerURL(Context context, String objectId, String format, String fileName, String versionid) throws Exception {
    ...
    public boolean isProjectSpaceTask(Context context, String[] args) throws Exception {
        ...
        if (hasDSServer) {
            ...
            if (objectId != null && !objectId.equals("") && !objectId.equals("null")) {
                ...
                if (objectType != null && !objectType.equals("") && !objectType.equals("null") && parentObjectType != null && !parentObjectType.equals("") && !parentObjectType.equals("null")
                        && objectType.equals(DomainConstants.TYPE_TASK)
                        && (parentObjectType.equals(DomainConstants.TYPE_PROJECT_SPACE) || parentObjectType.equals(DomainConstants.TYPE_PROJECT_TEMPLATE))) {
    ...
    /*
     * getVCModuleContentsName - Will get the Names for Module Summary Table Will be called in the Name Column.
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args an array of String arguments for this method
    ...
    /*
     * getVCModuleVersions - Will get the Versions for Module Summary Table Will be called in the Versions Column.
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args an array of String arguments for this method
    ...
    /*
     * getVCModuleComments - Will get the Comments for Module Summary Table Will be called in the Comments Column.
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args an array of String arguments for this method
    ...
    /*
     * getVCModuleTags - Will get the Tags for Module Summary Table Will be called in the Tags Column.
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args an array of String arguments for this method
    ...
    /*
     * getVCModuleHrefs - Will get the Module Href's for Module Summary Table Will be called in the Other Column.
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args an array of String arguments for this method
    ...
    /*
     * getVCModuleContentActions - Will get the Module Actions for Module Summary Table Will be called in the Actions Column.
     * 
     * @param context the eMatrix <code>Context</code> object
     * 
     * @param args an array of String arguments for this method
    ...
    /**
     * This method is used to get the Module Versions based on static OR dynamic choice of selectors
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - objectList MapList
    ...
    public Object getVCModuleHrefsNavigate(Context context, String[] args) throws Exception {
        try {
            ...
            if (hrefType.equals("dynamic")) {
                ...
                if (version == null) {
                    String strLanguage = context.getSession().getLanguage();
                    String strError = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(strLanguage), "emxComponents.VCDocument.UnresolvedDynamicSelector");
            ...
            if (canDownload) {
                ...
                downloadURL = "javascript:callCheckout('" + objectId + "','download', '" + path + "', '" + "generic" + "', null, null, null, null, null, '" + version + "');";
    ...
    /**
     * This method acts as a global method and calls getVCFolderContents OR getVCModuleContents for further expansion, based on the storePath defined and current object being expanded.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    MapList doGetVCAllContents(Context context, String[] args) throws Exception {
        ...
        jpoTrace("initialRequest=" + initialRequest + " expandLevel=" + expandLevel + " _addExpandMultiLevelFlag=" + _addExpandMultiLevelFlag + "\n \t\t\t\t  fromPage=" + fromPage + " objectId="
                + objectId);
                    ...
                    if (fileOrFolder.equalsIgnoreCase("folder")) {
                        ...
                        if (folderPath.equals("Modules")) {
                            if (objectIdModule == null) {
                                ...
                                sb.append("print bus ");
                                sb.append(TYPE_mxsysDSFAHolder);
                                sb.append(_space).append(storeName);
                                sb.append(" Modules select id dump");
                                objectIdModule = MqlUtil.mqlCommand(context, sb.toString());
                            }
    ...
    MapList doGetVCModuleContents(Context context, String[] args) throws Exception {
        ...
        jpoTrace("fromPage=" + fromPage + " storePath=" + storePath + " path=" + path + " objectId=" + objectId);
        ...
        if (initialRequest) {
            if (fromPage.equals("VCModuleContents")) {
                ...
                sb.append(" valign='bottom' border='0' />");
        ...
        if (!initialRequest) {
            ...
            if (type.equalsIgnoreCase("branch")) {
                ...
                for (int idx = 0; idx < versionList.size(); idx++) {
                    ...
                    if ("TRUE".equalsIgnoreCase(checkoutAccess)) {
                        ...
                        String downloadURL = "javascript:callCheckout('" + objectId + "', 'download', '" + path + "', 'generic'" + ", null, null, null, null, null, '" + version + "');";
            ...
            if (type.equalsIgnoreCase("version")) {
                ...
                for (int idx = 0; idx < hrefList.size(); idx++) {
                    ...
                    sb.append("<a href=\"javascript:showModalDialog('../components/emxCommonDocumentVCHrefNavigateProcess.jsp?type=static&amp;hrefPath=" + hrefname
                            + "&amp;fromPage=HrefNavigate&amp;name=" + hrefInfo.getName() + "&amp;version=" + version + "&amp;tags=" + tags + "&amp;storePath=" + storePath
                            + "&amp;table=APPVCHrefContentsSummary&amp;program=emxVCDocumentUI:getVCModuleHrefsNavigate&amp;expandProgram=emxVCDocumentUI:getVCModuleContents&amp;selection=single&amp;toolbar=APPVCFolderContentActions&amp;emxExpandFilter=3','730','450');\">");
                    sb.append("<img border='0' src='../common/images/iconSmallDSStaticHref.gif' />");
                    sb.append("</a>&#160;");

                    sb.append("<a href=\"javascript:showModalDialog('../components/emxCommonDocumentVCHrefNavigateProcess.jsp?type=dynamic&amp;hrefPath=" + hrefname
                            + "&amp;fromPage=HrefNavigate&amp;name=" + hrefInfo.getName() + "&amp;tags=" + tags + "&amp;storePath=" + storePath
                            + "&amp;table=APPVCHrefContentsSummary&amp;program=emxVCDocumentUI:getVCModuleHrefsNavigate&amp;expandProgram=emxVCDocumentUI:getVCModuleContents&amp;selection=single&amp;toolbar=APPVCFolderContentActions&amp;emxExpandFilter=3','730','450');\">");
    ...
    MapList doGetVCFolderContents(Context context, String[] args) throws Exception {
        ...
        if (!initialRequest) {
            ...
            if (fileOrFolder.equalsIgnoreCase("file") && matchesOneOf(fromPage, "FolderContents")) {
                ...
                objectId = strtk.nextToken();
            } else if (fileOrFolder.equalsIgnoreCase("file") && matchesOneOf(fromPage, "FileVersions", "FolderContentBranches", "FileBranchSummary", "searchVCDocuments")) {
                vcName = strtk.nextToken();
                objectId = strtk.nextToken();
                versionId = strtk.nextToken();
            } else {
            ...
            if (fromPage.equals("FolderContents")) {
                if (fileOrFolder.equals("file")) {
                    ...
                    if (configName != null && !configName.isEmpty()) {
                        folderPath = FrameworkUtil.decodeURL((String) programMap.get("folderPath"), com.matrixone.servlet.Framework.getEncoding());
                    }
        ...
        if (folderList != null) {
            for (int i = 0; i < folderList.size(); i++) {
                ...
                if (!ReservedDesignSyncFile(folderName)) {
                    ...
                    if (associatedList != null && associatedList.size() > 0 && associatedList.get(0).toString() != "[]" && !folderPathName.equals("Modules")) {
     ...
     *            - Matrix Context
     * @param programMap
     *            - the arg map received by the caller
     ...
     * @param level
     *            - the level of the object in the Structure Browser
     * @param expandLevel
     *            - the level to expand to (max-depth)
     * @param programMap
     *            - the arg map used for calling other methods
     * @param retList
     *            - the resulting MapList used to accumulate the hierarchy
     * @param moduleType
     *            - whether the given object is some kind of the DS Module
     * @return - nothing
     */
    void expandVCObject(Context context, short level, short expandLevel, Map programMap, MapList retList, boolean moduleType) throws Exception {
        // this should never happen
    ...
    static boolean getInitialRequest(Map programMap) {
        ...
        boolean initialRequest = ((level == null || level.equals("0")) && !objectId.contains("$"));
     ...
     * @param expandLevel
     *            - argument passed from the Structure Browser
    ...
    /**
     * getLeafName - given the UNIX path return the leaf-name also remove the trailing slash, if any
     * @param path
     *            - relative or absolute UNIX path
     ...
     * @param path
     *            - the containing UNIX path
     * @param subpath
     *            - a sub-path of the first argument
     * @return - the relative UNIX path - the result of subtraction Ex: /home/users/dsws/modules/chip, /home/users/dsws => modules/chip Either argument can be absolute or relative path.
     */
     ...
     * @param values
     *            - var string args to compare against
    ...
    /**
     * ReservedDesignSyncFile - checks whether the given name is one of the special DesignSync files or folders that must not be captured
     * @param fname
     *            - name of the DS file or folder
     * @return - boolean indicating whether the given name is on the list
     */
    static boolean ReservedDesignSyncFile(String fname) {
        String[] reserved = { "sync_server_trace.log", "sync_project.txt", "Partitions", "Backup.sync", "Import.sync", "Export.sync" };
     ...
     * @param values
     *            - var string args to join together
     ...
     * @param mapList
     *            - MapList returned to the Structure Browser
