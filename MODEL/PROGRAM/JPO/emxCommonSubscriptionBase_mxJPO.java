...
public class emxCommonSubscriptionBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @grade 0
     */
    public emxCommonSubscriptionBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
     ...
     * @since VCP 10.6
     */
    public void classifiedItemContentAddRemove(matrix.db.Context context, String[] args) throws Exception {
        try {
     ...
     * @param args
     *            containing RequestValuesMap,objectId
     ...
     *            the ENOVIA <code>Context</code> object
     * @param args
     *            containing objectId and parentId
    ...
    public MapList getSubscribers(Context context, String args[]) throws Exception {
        ...
        try {
            ...
            if (domObject.exists(context)) {
                ...
                resultList = domObject.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, DomainSymbolicConstants.SYMBOLIC_relationship_ListMember), strPersonType,
                        new StringList(DomainConstants.SELECT_ID), null, false, true, (short) 0, null, null, 0);
     ...
     *            the ENOVIA <code>Context</code> object
     * @param args
     *            holds programMap with enablePush attribute value
