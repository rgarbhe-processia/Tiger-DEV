...
public class emxPLCImageMigrationBase_mxJPO extends emxImageManager_mxJPO {
    ...
    protected void migrateImageObjects(Context context, String[] args) throws Exception {
        try {
            ...
            String strImageFormat = PropertyUtil.getSchemaProperty(context, DomainSymbolicConstants.SYMBOLIC_format_generic);
            ...
            stbRelSelect = stbRelSelect.append(ProductLineConstants.RELATIONSHIP_IMAGES).append(SYMB_COMMA).append(ProductLineConstants.RELATIONSHIP_PRIMARY_IMAGE);
            ...
            for (int i = 0; i < mapList.size(); i++) {
                ...
                try {
                    ...
                    mapObjectList = domImage.getRelatedObjects(context, stbRelSelect.toString(), DomainConstants.QUERY_WILDCARD, objSelect, relSelect, true, false, (short) 1,
    ...
    protected void connectPrimaryImageToObjects(Context context, String[] args) throws Exception {
        try {
            ...
            stbTypeSelect = stbTypeSelect.append(ProductLineConstants.TYPE_PRODUCT_LINE).append(SYMB_COMMA).append(ProductLineConstants.TYPE_MODEL).append(SYMB_COMMA)
                    .append(ProductLineConstants.TYPE_FEATURES).append(SYMB_COMMA).append(ProductLineConstants.TYPE_PRODUCTS);
            ...
            mapList = DomainObject.findObjects(context, stbTypeSelect.toString(), DomainConstants.QUERY_WILDCARD, strWhereExp, objSelect);
            ...
            for (int i = 0; i < mapList.size(); i++) {
                ...
                mlImageIds = domainObject.getRelatedObjects(context, ProductLineConstants.RELATIONSHIP_IMAGES, ProductLineConstants.TYPE_IMAGE, objSelect, null, false, true, (short) 1,
                        DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
                ...
                image.setImageAsPrimary(context, strObjectId, ProductLineConstants.TYPE_IMAGE, ProductLineConstants.RELATIONSHIP_PRIMARY_IMAGE, strImageId);
     ...
     * @grade 0
     */
    protected void migrationInfoWriter(String strLogEnrty) throws Exception {
     ...
     * @grade 0
     */
    protected void migrationErrWriter(String strLogEnrty) throws Exception {
        if (strLogEnrty != null && strLogEnrty.length() > 0) {
