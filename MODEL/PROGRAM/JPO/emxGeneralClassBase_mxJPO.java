...
/**
 * The <code>emxGeneralClassBase</code> represents implementation of the "To Side" of "SubClass" Relationship in LC Schema
 */
...
public class emxGeneralClassBase_mxJPO extends emxClassification_mxJPO {
     ...
     * @param args
     *            holds the following list of arguments: 0 - String entry for "objectId"
     * @throws Exception
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("must specify method on emxGeneralClassBase invocation");
        }
    ...
    /**
     * Updates the 'Classification Class' and its parent objects' count as a result of a classified item being revised.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following list of arguments: 0 - FROMOBJECTID 1 - TOOBJECTID 2 - PARENTEVENT 3 - NEWRELID
