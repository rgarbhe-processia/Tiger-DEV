...
/**
 * The <code>CompositionBinaryMigrationFindObjects</code> class contains implementation code for list out all the Products, Builds and Manufacturing Plan. This is the very first step of Migration.
...
public class CompositionBinaryMigrationFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO {
     ...
     * @since FTR V6R2012x
     */
    public CompositionBinaryMigrationFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
        mqlCommand = MqlUtil.getMQL(context);
    }

    /**
     * This method is executed if a specific method is not specified. This is the actual method to get all the all ids of objects that need composition binary generated and save the ids to a list of
     * filesname objectids_xx.txt
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
