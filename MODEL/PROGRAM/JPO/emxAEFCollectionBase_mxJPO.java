...
public class emxAEFCollectionBase_mxJPO {
    ...
    public emxAEFCollectionBase_mxJPO(Context context, String[] args) throws Exception {
        // super(context, args);
    }
    ...
    public MapList getCollections(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: treeLabel contains a String of the treeLabel name.
    ...
    public MapList getObjects(Context context, String[] args) throws Exception {
        ...
        /*
         * if(strSetname != null && strSetname.indexOf("%") > -1){ strSetname = FrameworkUtil.decodeURL(strSetname,sCharSet); } // To get System Generated Collection Label String
         * strSystemGeneratedCollectionLabel = UINavigatorUtil.getI18nString("emxFramework.ClipBoardCollection.NameLabel", "emxFrameworkStringResource", strLang);
         * if(strSetname.equals(strSystemGeneratedCollectionLabel)) { //Modified for Bug 342586 strSetname = FrameworkProperties.getProperty(context, "emxFramework.ClipBoardCollection.Name"); }
         */
        ...
        try {
            totalresultList = SetUtil.getMembers(context, strSetname, resultSelects);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: objectList contains a MapList of Maps which contains object names
    ...
    public Vector getDescription(Context context, String[] args) throws Exception {
        ...
        try {
            for (int i = 0; i < relBusObjPageList.size(); i++) {
                ...
                String strSystemGenCollection = EnoviaResourceBundle.getProperty(context, "emxFramework.ClipBoardCollection.Name");
                if (strName.equalsIgnoreCase(strSystemGenCollection)) {
                    strDescProperty = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", new Locale((String) ((HashMap) programMap.get("paramList")).get("languageStr")),
                            "emxFramework.ClipBoardCollection.Description");
                }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: objectList contains a MapList of Maps which contains objects count.
    ...
    public Vector getCount(Context context, String[] args) throws Exception {
     ...
     *             if the operation fails
     */
    public Vector getCollectionsName(Context context, String[] args) throws Exception {
     ...
     * @param pattern
     *            the name patterns (can be comma separated)
     * @param collection
    ...
    public MapList getCollectionsForWidgets(Context context, String[] args) throws Exception {
        HashMap paramMap = (HashMap) JPO.unpackArgs(args);
     ...
     * @since V6R2014x
     */
    private MapList getCollectionList(Context context, String strLang, boolean isSearch, ArrayList patternList) throws Exception {
