...
/**
 * The <code>emxFormatUtil</code> class contains property utility methods.
 * @version AEF 10.0.1.0 - Copyright (c) 2003, MatrixOne, Inc.
 */

public class emxFormatUtil_mxJPO extends emxFormatUtilBase_mxJPO {
    ...
    public emxFormatUtil_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
