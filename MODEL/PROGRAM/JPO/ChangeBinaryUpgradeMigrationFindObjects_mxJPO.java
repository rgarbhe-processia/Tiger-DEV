...
public class ChangeBinaryUpgradeMigrationFindObjects_mxJPO extends ChangeBinaryUpgradeMigrationFindObjectsBase_mxJPO {
    /**
     * @param context
     ...
     * @since CFF V6R2013x
     */
    public ChangeBinaryUpgradeMigrationFindObjects_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
