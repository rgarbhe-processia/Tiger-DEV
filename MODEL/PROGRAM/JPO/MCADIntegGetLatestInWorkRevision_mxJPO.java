...
/*
 ** MCADIntegGetLatestInWorkRevision
 **
...
public class MCADIntegGetLatestInWorkRevision_mxJPO extends MCADIntegGetLatestInWorkRevisionBase_mxJPO {
    /**
     * Constructor.
     * @since Sourcing V6R2008-2
     */
    public MCADIntegGetLatestInWorkRevision_mxJPO() {
        super();
    }
     ...
     * @since Sourcing V6R2008-2
     */
    public MCADIntegGetLatestInWorkRevision_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
