 ...
 **
 ** FileName : "$RCSfile: ${CLASSNAME}.java.rca $" Author : MadhavHG Version : "$Revision: 1.9 $" Date : "$Date: Wed Oct 22 16:02:38 2008 $"
 **
...
public class emxDocumentCentralSubscription_mxJPO extends emxDocumentCentralSubscriptionBase_mxJPO {
    ...
    public emxDocumentCentralSubscription_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
