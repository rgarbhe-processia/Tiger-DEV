...
public class emxMailUtilBase_mxJPO {
    ...
    public emxMailUtilBase_mxJPO(Context context, String[] args) throws Exception {
        /*
    ...
    public static int getStreamBaseURL(Context context, String[] args) throws Exception {
    ...
    public static int sendNotification(Context context, String[] args) throws Exception {
        ...
        if (map.get("basePropFileName") != null) {
            ...
            sendNotification(context, (StringList) map.get("toList"), (StringList) map.get("ccList"), (StringList) map.get("bccList"), (String) map.get("subjectKey"),
                    ...
                    (StringList) map.get("objectIdList"), (String) map.get("companyName"), (String) map.get("basePropFileName"));
        } else {
            sendNotification(context, (StringList) map.get("toList"), (StringList) map.get("ccList"), (StringList) map.get("bccList"), (String) map.get("subjectKey"),
                    (String[]) map.get("subjectKeys"), (String[]) map.get("subjectValues"), (String) map.get("messageKey"), (String[]) map.get("messageKeys"), (String[]) map.get("messageValues"),
                    (StringList) map.get("objectIdList"), (String) map.get("companyName"));
        }
        return 0;
    }
    ...
    public static int sendNotificationToUser(Context context, String[] args) throws Exception {
        ...
        sendNotification(context, toList, null, null, subjectKey, subjectKeys, subjectValues, messageKey, messageKeys, messageValues, objectIdList, companyName, basePropName);
        return 0;
    }
    ...
    public static void sendNotification(Context context, StringList toList, StringList ccList, StringList bccList, String subjectKey, String[] subjectKeys, String[] subjectValues, String messageKey,
            String[] messageKeys, String[] messageValues, StringList objectIdList, String companyName) throws Exception {
        sendNotification(context, toList, ccList, bccList, subjectKey, subjectKeys, subjectValues, messageKey, messageKeys, messageValues, objectIdList, companyName,
    ...
    public static void sendNotification(Context context, StringList toList, StringList ccList, StringList bccList, String subjectKey, String[] subjectKeys, String[] subjectValues, String messageKey,
            String[] messageKeys, String[] messageValues, StringList objectIdList, String companyName, String basePropFile) throws Exception {
        sendNotification(context, null, toList, ccList, bccList, subjectKey, subjectKeys, subjectValues, messageKey, messageKeys, messageValues, objectIdList, companyName, basePropFile);
    }
        ...
        while (itr.hasNext()) {
            ...
            if (userPrefLocale == null && _locales != null) {
                ...
                for (int i = 0; i < _locales.size(); i++) {
                    ...
                    messageBuffer.append(MessageUtil.getMessage(context, objectId, messageKey, messageKeys, messageValues, companyName, (Locale) _locales.elementAt(i), basePropFile));
                ...
                while (i.hasNext()) {
                    ...
                    if ((sTempObjId != null) && (!sTempObjId.equals(""))) {
                        try {
                            ...
                            System.out.println("exception in box sendNotification " + ex);
                        }
                    }
                    // Add the url to the end of the message.
    ...
    protected static void getNamesAndLanguagePreferences(Context context, HashMap names, HashMap languages, StringList list) {
    ...
    protected static StringList getNamesForLanguage(StringList list, HashMap namesAndLanguages, String language) {
