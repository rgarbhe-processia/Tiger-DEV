...
/**
 * The <code>emxPartFamily</code> represents anything on the "To Side" of "Subclass" Relationship in LC Schema
...
public class emxLibraryCentralPartFamily_mxJPO extends emxLibraryCentralPartFamilyBase_mxJPO {
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("must specify method on emxLibraryCentralPartFamily invocation");
        }
