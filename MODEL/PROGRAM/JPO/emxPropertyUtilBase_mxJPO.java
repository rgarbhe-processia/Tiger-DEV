...
public class emxPropertyUtilBase_mxJPO {
    ...
    public emxPropertyUtilBase_mxJPO(Context context, String[] args) throws Exception {

    }

    /**
     * This method loads the Admin Property values The properties must be on an admin object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    public static void cacheSymbolicNames(Context context, String[] args) throws Exception {
        try {
