...
/**
 * The <code>emxChange</code> JPO class is Wrapper JPO for emxChangeBase JPO which holds methods for executing JPO operations related to objects of the type Change.
 * @author Cambridge
...
public class emxChange_mxJPO extends emxChangeBase_mxJPO {
    ...
    public emxChange_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
