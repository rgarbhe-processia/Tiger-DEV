...
public class emxReadObject_mxJPO {
    ...
    public emxReadObject_mxJPO(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - String contains the directory of the document 1 - int contains the minimum no of files 2 - int contains the maximum no of files
     ...
     * @param i
     *            integer specifying the suffix of filename to identify the file.
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectIdList
     *            ArrayList object containing the list of document objectIds.
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.1.0
     */
    ...
    public void identifyModel(Context context, ArrayList objectIdList) throws Exception {
        ...
        for (int i = 0; i < objectIdList.size(); i++) {
            ...
            if (doType.equals(DomainConstants.TYPE_DOCUMENT)) {
                ...
                if (!(objectId.equals(doLatest.getId(context))))
                    continue;
            }
     ...
     *            the eMatrix <code>Context</code> object
     * @param list
     *            MapList contains list of document objects connected to Current Object
     * @param masterObj
     *            DomainObject represents Current Object from ArrayList loaded from file
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.1.0
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param hasFile
     *            String has value (True/False) whether current object has file
     * @param toId
     *            String has document object Id to which file has to be moved
     * @param fromId
     *            String has document object Id from which file has to be moved
     * @param format
     *            String has format of the file to be moved
     * @param fileName
     *            String has name of the file to be moved
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.1.0
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param masterObj
     *            current object from the ArrayList loaded from file
     * @throws Exception
     *             if the operation fails
     * @since AEF 10.0.1.0
     */
    ...
    /**
     * This method clones masterobject based on the no of files in master object and connects the master to clone using Active and Latest Version relationship and also updates the Title and is Version
     * Object attribute in cloned object.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param masterObj
     *            DomainObject represents Current Object from ArrayList loaded from file
