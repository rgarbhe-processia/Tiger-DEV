...
public class IEFShowRenameLink_mxJPO {
    ...
    public IEFShowRenameLink_mxJPO(Context context, String[] args) throws Exception {
    }
        ...
        for (int i = 0; i < relBusObjPageList.size(); i++) {
            ...
            try {
                ...
                if (integrationName != null && integrationNameGCOTable.containsKey(integrationName)) {
                    ...
                    String renameURL = "../integrations/MCADGenericFS.jsp?pageDetails=Rename|MCADRename.jsp|" + integrationName + "|true|" + objectId + "&help=emxhelpdscrename";
                    String renameHref = "javascript:parent.emxShowModalDialog('" + renameURL + "', 400, 400, false)";
