...
public class emxTeamStructureTreeBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @since AEF Rossini
     */
    public emxTeamStructureTreeBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public static MapList getWorkSpaceFolderList(Context context, String[] args) throws Exception {
        ...
        if (objType != null && objType.equals(DomainObject.TYPE_WORKSPACE)) {
            try {
                ...
                result = (MapList) domObj.getRelatedObjects(context, DomainObject.RELATIONSHIP_WORKSPACE_VAULTS + "," + RELATIONSHIP_LINKED_FOLDERS, DomainObject.TYPE_PROJECT_VAULT, sSelects,
                        selectRelStmts, false, true, (short) 1, null, null);
            ...
            try {
                result = (MapList) subFolder.getRelatedObjects(context, DomainObject.RELATIONSHIP_SUBVAULTS + "," + RELATIONSHIP_LINKED_FOLDERS, DomainObject.TYPE_PROJECT_VAULT, selectTypeStmts,
                        selectRelStmts, false, true, (short) 1, null, null);
            } catch (FrameworkException e) {
                throw new FrameworkException(e);
            }
        ...
        /*
         * Added to display the proper menu for workspace vault in advance search In general advance search will look for type_MENUNAME. But in our case it will be TMCtype_MENUNAME For that we need to
         * pass treeMenu with the required menu to be displayed.
         */
