...
public class ManufacturingPlanSearchBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    /**
     * To obtain the list of Manufacturing Plans to be excluded in the Search Results and show the Manufacturing Plans related to selected Revision * @param context- the eMatrix <code>Context</code>
     * object
     * @param args
    ...
    /**
     * This Methods is Used to get all the plans to be displayed in search page during Create Manufacturing Plan Derived From
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public StringList getMPofAllRevisions(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList revisionsList = domContxtId.getRevisionsInfo(context, busSelects, new StringList(0));
    ...
    /**
     * This method is used to get the List of Master Features connected the Model and exclude them in the Search Results While performing the Add Existing Master Feature under Model Contest
     * @param context
     *            : The eMatrix <code>Context</code> object
     * @param args
     *            : Holds the HashMap containing the following arguments
     * @return StringList : Consisting of the object ids that need to be excluded, the Master Features connected to context Model with Model Master Features relationship
     * @throws Exception
    ...
    /**
     * This method is used to obtain the list of product revisions that needs to be excluded in search page while performing add existing operations
     * @param context
     *            : The eMatrix <code>Context</code> object
     * @param args
     *            : Holds the HashMap containing the following arguments
     * @return StringList : Consisting of the object ids that need to be excluded, the Master Features Revisions connected to context Master Feature with Managed Revision relationship
     * @throws Exception
     *             : Throws Exception if the operation fails
     * @since CFP R209
     * @author IVU
    ...
    public StringList getMPofCurrentRevision(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            currentRevision.put("ProductTNR", domContxtId.getInfo(context, DomainConstants.SELECT_TYPE) + "::" + domContxtId.getInfo(context, DomainConstants.SELECT_NAME) + "::"
                    + domContxtId.getInfo(context, DomainConstants.SELECT_REVISION));
    ...
    /**
     * Include Program to get all Products connected with Model, for Planned For field chooser in case of Root MP Creation in Model Context, we get all Product which are assocaited with model
     * @param context
     * @param args
     * @return
    ...
    /**
     * include Program to get all Products which are connected in forward derivation chain with Product, for Planned For field chooser in case of Non Root MP Creation in Product Context,
     * @param context
     * @param args
     * @return
     * @throws FrameworkException
     ...
     */
    @com.matrixone.apps.framework.ui.IncludeOIDProgramCallable
    public StringList getForwardChainofContext(Context context, String[] args) throws FrameworkException {
        StringList slIncludeIds = new StringList();
        ...
        try {
            ...
            relBusObjPageList = dom.getRelatedObjects(context, strRelName, strTypeName, objectSelects, relSelects, false, true, sLevel, "", "", 0);
            Hashtable hmPlans = null;
    ...
    /**
     * Include Program to get backward derivations of the selected Manufacturing Plan, until the Planned For product of the Derived From Manufacturing Plan, used in Insert Before case to get valid
     * Product between Derived To and Derived From MP
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    /**
     * Include program , used to get valid Manufacturing Plan,from which Manufacturing Plan will be derived from, this is case product context and no MP is selected for derived from. This gets all
     * Manufacturing Plans from which a new Derivation can be created. ----------------------------------------- Used for Create Derivation Only
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    public StringList getManufacturingPlansForDerivationCreate(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strMPIDSelectable = "from[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].to.id";
    ...
    /**
     * Include program , used to get valid Manufacturing Plan,from which Manufacturing Plan will be derived from, this is case product context and no MP is selected for derived from. This gets all
     * Manufacturing Plans from which a new Revision can be created. ----------------------------------------- Used for Create Revision Only
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    public StringList getManufacturingPlansForRevisionCreate(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            String strMainDerivedSelectable = "from[" + ManufacturingPlanConstants.RELATIONSHIP_ASSOCIATED_MANUFACTURING_PLAN + "].to.from[" + ManufacturingPlanConstants.RELATIONSHIP_MAIN_DERIVED
                    + "]";
