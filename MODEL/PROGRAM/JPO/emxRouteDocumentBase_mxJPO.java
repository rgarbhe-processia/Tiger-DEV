...
public class emxRouteDocumentBase_mxJPO extends emxVCDocument_mxJPO {
     ...
     * @grade 0
     */
    public emxRouteDocumentBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    /**
     * This method is executed before create of document object to check the parent id is RFQ Template and that is active then to revise RFQ Tempalte and return new Template Id.
     * @param context
     *            the eMatrix <code>Context</code> object
    ...
    /**
     * This method is executed after create of document object to check if it should be connected to a folder.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param uploadParamsMap
     *            HashMap
    ...
    public void postCheckin(Context context, HashMap uploadParamsMap, StringList objectIds) throws Exception {
        ...
        if ((routeContent != null) && (!"".equals(routeContent)) && (!"null".equals(routeContent))) {
            ...
            subscriptionMgr.publishEvent(context, route.EVENT_CONTENT_ADDED, objectId);
    ...
    /**
     * This method is executed after deletion of Object Route relationship to send the subscription notifications.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds no arguments
    ...
    public void deleteAction(Context context, String[] args) throws Exception {
        ...
        if ((object.getType(context)).equals(DomainConstants.TYPE_ROUTE)) {
            Route route = (Route) DomainObject.newInstance(context, routeId);
            SubscriptionManager subscriptionMgr = new SubscriptionManager(route);
            subscriptionMgr.publishEvent(context, route.EVENT_CONTENT_REMOVED, objectId);
        }
    }
}
