...
public class IEFObjectsLockedBy_mxJPO {
    ...
    public Object getListDetails(Context context, String[] args, MCADGlobalConfigObject gco) throws Exception {
        ...
        try {
            ...
            businessObjectList = DomainObject.findObjects(context, type, name, revision, owner, vault, whereClause, "", expandFlag, resultSelects, Short.parseShort(queryLimit), null, searchText);
