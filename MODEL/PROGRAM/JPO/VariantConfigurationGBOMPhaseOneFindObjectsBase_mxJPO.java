...
/**
 * The <code>VariantConfigurationDerivationFindObjectsBase</code> class contains implementation code for list out all the Models in the system. This is the very first step of Migration.
...
public class VariantConfigurationGBOMPhaseOneFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO {
     ...
     * @since FTR V6R2012x
     */
    public VariantConfigurationGBOMPhaseOneFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    /**
     * Sets the migration status as a property setting. Status could be :- PreMigrationFindObjectInProgress PreMigrationFindObjectCompleted ManufacturingPlanMigrationInProgress
     * ManufacturingPlanMigrationCompleted ProductMigrationInProgress ProductMigrationCompleted
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param strStatus
