...
/**
 * The <code>IEFCDMSupport</code> class represents the JPO for obtaining additional support if the CDM is installed
...
public class IEFCDMSupport_mxJPO {
    ...
    public DomainObject iefCreateAndConnect(Context context, String designObjType, String designObjName, String designObjRevision, String designObjPolicy, String s1, String vaultName, String s2,
            String s3, DomainObject docHolder, String relationship, String s4, Map attrNameValMap, DomainObject domainObj, String lang) {
        DomainObject obj = null;
        try {
            obj = ((CommonDocument) domainObj).createAndConnect(context, designObjType, designObjName, designObjRevision, designObjPolicy, "", vaultName, s2, null, docHolder, relationship, null,
                    (Map) attrNameValMap);
