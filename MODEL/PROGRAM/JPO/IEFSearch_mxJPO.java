...
/**
 * The <code>IEFSearch</code> class represents the JPO for obtaining the search data for MS Office integration
...
public class IEFSearch_mxJPO {
    ...
    /**
     * Get the query criteria Generates XML string representing the query criteria. 'query name' String value
     * @throws Exception
     *             if the operation fails
     */
    ...
    /**
     * Update existing query 'query name' String value
     * @param query
     *            criteria
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * Save as new query 'query name' String value
     * @param query
     *            criteria
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * saveDotFinderAs 'query name' String value
     * @param query
     *            criteria
     * @throws Exception
     *             if the operation fails
    ...
    /**
     * Check whether the query exists in Matrix 'query name' String value return boolean
     */
    ...
    /**
     * Delete the saved query 'query name' String value
     * @throws Exception
     *             if the operation fails
     */
    public String deleteQuery(Context context, String[] args) throws MatrixException {
        ...
        try {
            ...
            if (txtQueryName != null && txtQueryName.length() != 0) {
                ...
                xmlOutput = i18nNow.getI18nString("mcadIntegration.Server.Message.UnableToDeleteQuery", "iefStringResource", lang) + " "
                        + i18nNow.getI18nString("mcadIntegration.Server.Message.UnableToDeleteQuery", "iefStringResource", lang);
                throw new MatrixException(xmlOutput);
            }
        } catch (Exception ex) {
            ContextUtil.abortTransaction(context);
     ...
     */
    public String getAdvanceSearchWhereExpression(Context context, String sTypeName, HashMap hashmap, String dateCreatedAfter, String dateCreatedBefore, String latestRevOnly, String strTitle,
            String lang) throws FrameworkException {
        String returnString = "";
        ...
        try {
            ...
            for (int i = 0; i < stringlist.size(); i++) {
                try {
                    ...
                    if (!sString5.equals("") && !sString5.equals("*")) {
                        if (pattern1.match(sType) || pattern1.match(sName) || pattern1.match(sRevision) || pattern1.match(sOwner) || pattern1.match(sVault) || pattern1.match(sDescription)
                                || pattern1.match(sCurrent) || pattern1.match(sModified) || pattern1.match(sOriginated) || pattern1.match(sGrantor) || pattern1.match(sGrantee)
                                || pattern1.match(sPolicy) || sString6.equals("State")) {
                        ...
                        if (pattern3.match(sIncludes)) {
                            ...
                            if (pattern1.match(sDescription) || pattern1.match(sCurrent) || pattern1.match(sModified) || pattern1.match(sOriginated) || pattern1.match(sGrantor)
                                    || pattern1.match(sGrantee) || pattern1.match(sPolicy)) {
                                stringbuffer1.append(sString6);
                            } else {
                                stringbuffer1.append(sAttribute);
                                stringbuffer1.append(sOpenSquareBracket);
            ...
            if (!"".equals(stringbuffer.toString())) {
                if (strTitle != null && !("*".equals(strTitle)) && strTitle.length() != 0) {
                    stringbuffer.append(sAndOrField + sOpenParenthesize + sBackSlash + "attribute" + sOpenSquareBracket + MCADMxUtil.getActualNameForAEFData(context, "attribute_Title")
                            + sCloseSquareBracket + sBackSlash + sTildaEqualConst + sBackSlash + strTitle + sBackSlash + sCloseParenthesize);
                }
            } else {
                if (strTitle != null && !("*".equals(strTitle)) && strTitle.length() != 0) {
                    stringbuffer.append(sOpenParenthesize + sBackSlash + "attribute" + sOpenSquareBracket + MCADMxUtil.getActualNameForAEFData(context, "attribute_Title") + sCloseSquareBracket
            ...
            if (!"".equals(stringbuffer.toString())) {
                if (isDocumentsType && iefAppendIsVersionObject(context)) {
                    ...
                    stringbuffer.append(sCloseParenthesize);
                    stringbuffer.append(sAnd + sOpenParenthesize + sBackSlash + "attribute" + sOpenSquareBracket + MCADMxUtil.getActualNameForAEFData(context, "attribute_IsVersionObject")
                            + sCloseSquareBracket + sBackSlash + sEqualEqualConst + sBackSlash + "False" + sBackSlash + sCloseParenthesize);
                }
            } else {
                if (isDocumentsType && iefAppendIsVersionObject(context)) {
                    stringbuffer.append(sOpenParenthesize + sBackSlash + "attribute" + sOpenSquareBracket + MCADMxUtil.getActualNameForAEFData(context, "attribute_IsVersionObject")
                            + sCloseSquareBracket + sBackSlash + sEqualEqualConst + sBackSlash + "False" + sBackSlash + sCloseParenthesize);
                }
            }
                                            ...
                                            try {
                                                ...
                                                while (attributeNodes.hasMoreElements()) {
                                                    ...
                                                    if (nodeName.equals("attribute")) {
                                                        ...
                                                        if (sEnteredvalue == null)
                                                            sEnteredvalue = "";
                                                        if (sSelselectedvalue == null)
                                                            sSelselectedvalue = "";
                                                        if (sSeloperatorvalue == null)
                                                            sSeloperatorvalue = "";
        ...
        if (args != null && args.length != 0) {
            ...
            if (isQueryNameAvailable) {
                ...
                if (txtQueryName != null)
                    txtQueryName = txtQueryName.trim();
            } else
            ...
            if (txtRev != null)
                txtRev = txtRev.trim();
            if (latestRevOnly != null)
                latestRevOnly = latestRevOnly.trim();
            if (txtVault != null)
                txtVault = txtVault.trim();
            if (txtOwner != null)
                txtOwner = txtOwner.trim();
            if (txtTitle != null)
            ...
            if (sAndOrOption != null)
                sAndOrOption = sAndOrOption.trim();
            if (sQueryLimit != null)
                sQueryLimit = sQueryLimit.trim();
            if (strDefdateformat != null)
                strDefdateformat = strDefdateformat.trim();
            if (strShowTime != null)
                strShowTime = strShowTime.trim();
    ...
    /**
     * Update existing query criteria 'query name' String value
     * @param query
     *            criteria
     * @throws Exception
     *             if the operation fails
    ...
    public String getAllTypes(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (_util != null) {
                rootTypeList = _util.isCDMInstalled(context) ? MCADMxUtil.getActualNameForAEFData(context, rootType) : "Office Document";
            } else {
                    ...
                    while (attributeListItr.next()) {
                        ...
                        if (!isHidden(context, "attribute", attributeName)) {
                            if (!notAllowedAttributes.contains(attributeName)) {
                                ...
                                // IR-542275-3DEXPERIENCER2015x : Custom attributes of type string, date etc are not displayed in the document attributes,if custom binary attribute is added to type
                                // Document
    ...
    private String getSearchVaults(Context context, boolean flag, String s) throws FrameworkException {
        String s1 = "";
        ...
        try {
            ...
            } else if ("DEFAULT_VAULT".equals(s))
                s1 = context.getVault().getName();
            else if (s != null && !"".equals(s) && !"null".equals(s))
                s1 = s;
            return s1;
    ...
    private String encodeURL(String s, String s1) {
        ...
        if (s != null) {
            ...
            for (int l = 0; l < i; l++) {
                char c1 = s.charAt(l);
                if ((c1 < 'a' || c1 > 'z') && (c1 < 'A' || c1 > 'Z') && (c1 < '0' || c1 > '9') && c1 != '/' && c1 != '?' && c1 != '&' && c1 != '=' && c1 != ':' && c1 != '.' && c1 != ';' && c1 != '@'
                        && c1 != '$' && c1 != ',' && c1 != '+' && c1 != '-' && c1 != '_' && c1 != '*') {
    ...
    private String decodeURL(String s, String s1) throws FrameworkException {
        int i = 0;
