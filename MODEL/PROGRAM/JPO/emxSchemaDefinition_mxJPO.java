...
public class emxSchemaDefinition_mxJPO extends emxSchemaDefinitionBase_mxJPO {
    ...
    public emxSchemaDefinition_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public emxSchemaDefinition_mxJPO() throws Exception {
        super();
    }
     ...
     * @since AEF 10.Next
     */
    public emxSchemaDefinition_mxJPO(Context context, File schemaDefFile, emxAppVersionUtil_mxJPO appVersions) throws Exception {
