...
public class emxTBEPartMigrationFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO {
     ...
     * @grade 0
     */
    public emxTBEPartMigrationFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
    ...
    public void getIds(Context context, int chunkSize) throws Exception {
        ...
        try {
            MqlUtil.mqlCommand(context, "temp query $1 $2 $3 vault $4 limit $5 where $6", type, name, revision, vaultList, "1",
