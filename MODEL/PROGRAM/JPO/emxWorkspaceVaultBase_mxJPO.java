...
/**
 * emxWorkspaceVault.java Copyright (c) 1992-2015 Dassault Systemes. All Rights Reserved. This program contains proprietary and trade secret information of MatrixOne,Inc. Copyright notice is
 ...
 * @exclude
 */
public class emxWorkspaceVaultBase_mxJPO extends DomainObject implements DocumentCentralConstants {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments: 0 - objectId the object Id 1 - paramList the map contains parameters for Cloning
     * @return String objectId of the clone Workspace vault
     * @throws Exception
     *             if the operation fails
     */
    public static String cloneObject(Context context, String[] args) throws Exception {
        ...
        String objectId = cloneObject(context, (String) map.get("objectId"), (Map) map.get("paramList"));
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments: 0 - objectId the object Id 1 - paramList the map contains parameters for creating
     * @return String objectId of the new Workspace vault
     * @throws Exception
     *             if the operation fails
     */
    public static String createObject(Context context, String[] args) throws Exception {
        if ((args == null) || (args.length < 1)) {
            throw (new IllegalArgumentException());
        }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments: 0 - objectId the object Id 1 - paramList the map with the attribute values for the revisied Work Space Object 1 - paramList the map contains parameters
     *            for revising
     * @throws Exception
     *             if the operation fails
     */
    public static String reviseObject(Context context, String[] args) throws Exception {
        if ((args == null) || (args.length < 1)) {
            throw (new IllegalArgumentException());
        }

        Map map = (Map) JPO.unpackArgs(args);
        String objectId = reviseObject(context, (String) map.get("objectId"), (Map) map.get("paramList"));
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            Id of object to be cloned
     * @param map
     *            contains parameters for Cloning
     * @return String objectId of the clone Workspace vault
     * @throws Exception
     *             if the operation fails
     * @exclude
     */
    protected static String cloneObject(Context context, String objectId, Map map) throws Exception {
        ...
        attributeList.put(PropertyUtil.getSchemaProperty(context, "attribute_GlobalRead"), globalRead);
        ...
        try {
            ...
            newBo = new DomainObject(domainObject.clone(context, name, domainObject.getRevision(), domainObject.getVault()));

            newBo.change(context, type, name, domainObject.getRevision(), domainObject.getVault(), domainObject.getPolicy().toString());
            ...
            if (folderIds != null && folderIds.length() > 0) {
                ...
                DomainRelationship.connect(context, newBo, PropertyUtil.getSchemaProperty(context, "relationship_SubVaults"), true, // from dir?
     ...
     *            the eMatrix <code>Context</code> object
     * @param map
     *            contains parameters for Creating
     * @return String objectId of the new Workspace Vault
     * @throws Exception
     *             if the operation fails
     * @exclude
     */
    protected static String createObject(Context context, Map map) throws Exception {
        ...
        String[] contentIds = (String[]) map.get("attribute_ContentIds");
        String[] grantees = (String[]) map.get("attribute_AccessId");
        String[] accessType = (String[]) map.get("attribute_Access");
        ...
        try {
            ...
            newBo = new BusinessObject(type, name, domObject.getUniqueName(), context.getVault().toString());
            ...
            if ((globalRead != null) && (globalRead.length() > 0)) {
                if (globalRead.equalsIgnoreCase("true")) {
                    accessMap.put(PropertyUtil.getSchemaProperty(context, "role_Employee"), AccessUtil.READ);

                }

                String symbolicAttrName = PropertyUtil.getSchemaProperty(context, "attribute_GlobalRead");

                if ((symbolicAttrName != null) && (symbolicAttrName.length() > 0)) {
                    attribList.addElement(new Attribute(new AttributeType(symbolicAttrName), globalRead));
                }
            }
            ...
            if ((folderIds != null) && (folderIds.length() > 0)) {
                ...
                DomainRelationship.connect(context, domObject, PropertyUtil.getSchemaProperty(context, "relationship_SubVaults"),
                        // rel type
                        false, // to dir?
                ...
                //
                for (int i = 0; i < folderIdsArray.length; i++) {
                    sendEventIconMail(context, EventConstants.EVENT_CONTENT_ADDED, folderIdsArray[i], newBoId);
                }
            }
            ...
            // grant access
            //
            if ((grantees != null) && (accessType != null) && (grantees.length == accessType.length)) {
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            Id of object to be revised
     * @param map
     *            contains parameters for revising
     * @return String objectId of the new revision of the Workspace Vault
     * @throws Exception
     *             if the operation fails
     * @exclude
     */
    protected static String reviseObject(Context context, String objectId, Map map) throws Exception {
        String owner = (String) map.get("attribute_Owner");
        ...
        attributesMap.put(PropertyUtil.getSchemaProperty(context, "attribute_GlobalRead"), globalRead);
        ...
        try {
            ...
            newBo = new DomainObject(new DomainObject(objectId).revise(context, revision, context.getVault().getName()));
            newBo.open(context);
            ...
            if ((folderIds != null) && (folderIds.length() > 0)) {
                ...
                DomainRelationship.connect(context, newBo, PropertyUtil.getSchemaProperty(context, "relationship_SubVaults" // rel type
                ), true, // from dir?
                        folderIdsArray // from obj Ids
                );
            }
    ...
    public int mxMain(Context context, String[] args) throws Exception {
        if (true) {
            throw new Exception("Must specify method on emxWorkspaceVaultBase Invocation");
        }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments 0 - objectId
     * @return MapList with the access details
     * @throws Exception
     *             if the operation fails
     */
    public static MapList getObjectAccess(Context context, String[] args) throws Exception {
        if ((args == null) || (args.length < 1)) {
            throw (new IllegalArgumentException());
        }

        MapList mapList = getObjectAccess(context, (String) JPO.unpackArgs(args));
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments 0 - objectId the object ID 1 - memberids and access details Map
     * @return int 0
     * @throws Exception
     *             if the operation fails
     */
    public static int addGrantees(Context context, String[] args) throws Exception {
        if ((args == null) || (args.length < 1)) {
            throw (new IllegalArgumentException());
        }
        ...
        addGrantees(context, (String) map.get("objectId"), (Map) map.get("memberIdsAndAccess"));
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following argument 0 - objectId the object ID 1 - memberIds mebers whose acces has to be revoked
     * @return int 0
     * @throws Exception
     *             if the operation fails
     */
    public static int removeGrantees(Context context, String[] args) throws Exception {
        if ((args == null) || (args.length < 1)) {
            throw (new IllegalArgumentException());
        }
        ...
        removeGrantees(context, (String) map.get("objectId"), (String[]) map.get("memberIds"));
     ...
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            the Java <code>String</code>
     * @return MapList the menber access details
     * @throws Exception
     *             if the operation fails
     */
    static protected MapList getObjectAccess(Context context, String objectId) throws Exception {
        AccessUtil accessUtil = new AccessUtil();
        ...
        PersonItr personItr = new PersonItr(matrix.db.Person.getPersons(context));
        ...
        if (PersonName != null) {
            ...
            objectSelects.addElement(com.matrixone.apps.common.Person.SELECT_ID);
            objectSelects.addElement(com.matrixone.apps.common.Person.SELECT_NAME);
            objectSelects.addElement(com.matrixone.apps.common.Person.SELECT_FIRST_NAME);
            objectSelects.addElement(com.matrixone.apps.common.Person.SELECT_LAST_NAME);
            objectSelects.addElement(com.matrixone.apps.common.Person.SELECT_COMPANY_NAME);

            // execute and get the details
            MapList personMapList = DomainObject.findObjects(context, PropertyUtil.getSchemaProperty(context, "type_Person"), PersonName, "*", "*", "*", null, false, objectSelects);
            ...
            while (personDetailsItr.hasNext()) {
                ...
                String personName = (String) personHash.get(com.matrixone.apps.common.Person.SELECT_NAME);
                String personFirstName = (String) personHash.get(com.matrixone.apps.common.Person.SELECT_FIRST_NAME);
                String personLastName = (String) personHash.get(com.matrixone.apps.common.Person.SELECT_LAST_NAME);

                /*
                 * Logic for Displaying the User Id of the person if both the First & Last names are null or empty.Also display only the Last Name if the First name is null or empty and the
                 * vice-versa.
                 */

                if (personFirstName == null || personFirstName.equals("null") || (personFirstName.trim().equals(""))) {
                    personFirstName = "";
                }

                if (personLastName.equals(null) || personLastName.equals("null") || (personLastName.trim().equals(""))) {
                    personLastName = "";
                }

                if ((personFirstName.trim().equals("")) && (personLastName.trim().equals(""))) {
                    Name = personName;
                } else if ((personFirstName.trim().equals("")) && !(personLastName.trim().equals(""))) {
                    Name = personLastName;
                } else if (!(personFirstName.trim().equals("")) && (personLastName.trim().equals(""))) {
                ...
                PersonDetails.put(DomainConstants.SELECT_NAME, Name);
                PersonDetails.put("PERSON_ID", personHash.get(com.matrixone.apps.common.Person.SELECT_ID));
                PersonDetails.put(DomainConstants.SELECT_ID, personName);
                PersonDetails.put("Organization", personHash.get(com.matrixone.apps.common.Person.SELECT_COMPANY_NAME));
        ...
        while (itr.hasNext()) {
            ...
            allMap.put(DomainConstants.SELECT_NAME, Name);
            allMap.put(DomainConstants.SELECT_ID, Name);
     ...
     * @param memberIdsAndAccess
     *            the Java <code>Map</code>Object
     * @return int 0
     * @throws Exception
     *             if the operation fails
     */
    static protected int addGrantees(Context context, String objectId, Map memberIdsAndAccess) throws Exception {
        try {
            AccessUtil accessUtil = new AccessUtil();
            ...
            MapList contentList = domFolder.getRelatedObjects(context, PropertyUtil.getSchemaProperty(context, "relationship_VaultedDocumentsRev2"), "*", objSelects, null, false, true, (short) 1, "",
                    "");
            ...
            while (itr.hasNext()) {
                ...
                String methodAccess = (String) memberIdsAndAccess.get(memberName);
     ...
     *             if the operation fails
     */
    static protected int removeGrantees(Context context, String objectId, String[] args) throws Exception {
        try {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments 0 - objectID of the the Workspace Vault 1 - paramList Map with modify details of the Workspace Vault
     * @return String the modify result
     * @throws Exception
     *             if the operation fails
     */
    public static String modifyObject(Context context, String[] args) throws Exception {
        if ((args == null) || (args.length < 1)) {
            throw (new IllegalArgumentException());
        }

        Map map = (Map) JPO.unpackArgs(args);
        String result = modifyObject(context, (String) map.get("objectId"), (Map) map.get("paramList"));
     ...
     *            the Java <code>String<code> object
     * @param map
     *            the Map with the modify details
     * @return String the modify Result
     * @throws Exception
     *             if the operation fails
     */
    protected static String modifyObject(Context context, String objectId, Map map) throws Exception {
        ...
        try {
            ...
            String globalChange = new DomainObject(bo).getInfo(context, "attribute[" + PropertyUtil.getSchemaProperty(context, "attribute_GlobalRead") + "]");

            if (globalRead != null && globalRead.length() > 0 && !(globalRead.equalsIgnoreCase(globalChange))) {
                // set attributes
                AttributeList attribList = new AttributeList(1);

                attribList.addElement(new Attribute(new AttributeType(PropertyUtil.getSchemaProperty(context, "attribute_GlobalRead")), globalRead));
            ...
            sendEventIconMail(context, EventConstants.EVENT_FOLDER_MODIFIED, objectId, objectId);
            ...
            if (domObj != null && domObj.getType(context).equals(TYPE_WORKSPACE_VAULT)) {
                ...
                if (parentVaultId != null && !"".equals(parentVaultId)) {
                    sendEventIconMail(context, EventConstants.EVENT_CONTENT_MODIFIED, parentVaultId, parentVaultId);
                }
            }
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following arguments 0 - Array containing ParentIds 1 - Array containing childIds
     * @return String of containg names of objects not added
     * @throws FrameworkException
     *             if operation fails
     */
    public static String addToFolders(Context context, String[] args) throws Exception {
        if ((args == null) || (args.length < 1)) {
            throw (new IllegalArgumentException());
        }
        ...
        if (ChildIdsWithAccessList.size() > 0) {
            ...
            for (int i = 0; i < parentIds.length; i++) {
                try {
                    WorkspaceVault workspaceVaultObj = new WorkspaceVault(parentIds[i]);
                    ...
                    if (children.size() > 0) {
                        ...
                        while (childItr.hasNext()) {
                            ...
                            sendEventIconMail(context, LibraryCentralConstants.EVENT_CONTENT_ADDED, parentIds[i], (String) childItr.next());
     ...
     *            the objectId
     * @param objAtt
     *            used to embed in the mail
     */
    protected static void sendEventIconMail(Context context, String event, String objId, String objAtt) throws Exception {
    ...
    public String removeToObjects(Context context, String[] args) throws Exception {
        if ((args == null) || (args.length < 1)) {
            throw (new IllegalArgumentException());
        }
        ...
        for (int i = 0; i < childIds.length; i++) {
            ...
            String strType = tempChildObj.getInfo(context, DomainObject.SELECT_TYPE);
            ...
            if (strType.equalsIgnoreCase(strWorkSpaceVault)) {
                relationship = PropertyUtil.getSchemaProperty(context, "relationship_SubVaults");
                folderRemoved = true;
            } else {
                relationship = PropertyUtil.getSchemaProperty(context, "relationship_VaultedDocumentsRev2");
            }
            ...
            if (checkAccess(context, parentId)) {
                ...
                sChildName = tempChildObj.getInfo(context, DomainObject.SELECT_NAME);
            ...
            if (removed) {
                ...
                // if(folderRemoved)
                // {
                sendEventIconMail(context, LibraryCentralConstants.EVENT_CONTENT_REMOVED, parentId, childIds[i]);
     ...
     *             if the operation fails
     */
    protected static boolean checkAccess(Context context, String childId) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId - object Id
     * @return boolean - true if user has Grant access - false if user does not have Grant access
     * @throws Exception
     *             if a major failure occurs
     */
    public boolean hasGrantAccess(Context context, String[] args) throws Exception {
     ...
     * @param args
     *            holds the following input arguments: objectId - object Id
     * @return boolean - true if user has Revoke access - false if user does not have Revoke access
     * @throws Exception
     *             if a major failure occurs
     */
    public boolean hasRevokeAccess(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        String objectId = (String) programMap.get(LibraryCentralConstants.OBJECT_ID);
        DomainObject doObj = new DomainObject(objectId);
        Access access = doObj.getAccessMask(context);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectList - existing access list requestMap - should have object id
     * @return true (for all the rows) - if user has grant and revoke access false (for all the rows) - if user does not have grant and revoke access
     * @throws Exception
     *             if a major failure occurs
     */
    public StringList hasGrantAndRevokeAccess(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        ...
        DomainObject doObj = new DomainObject(objectId);
        Access access = doObj.getAccessMask(context);
        hasEditAccess = (access.hasGrantAccess() && access.hasRevokeAccess()) ? new Boolean(true) : new Boolean(false);
     ...
     *             if a major failure occurs
     */
    public MapList filterFolderAccessDetails(Context context, String objectId, String filterValue) throws Exception {
    ...
    /**
     * This method returns existing access (Role/Group/Person) grantees based on given filter value
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param objectId
     *            - object Id of folder
     ...
     *             if a major failure occurs
     */
    public StringList excludeExistingAccessGrantees(Context context, String objectId, String filterValue) throws Exception {
    ...
    /**
     * This method returns list of person object ids who have the access to the context folder
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectId - object Id
    ...
    public StringList excludeExistingPersonAccess(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        String objectId = (String) programMap.get(LibraryCentralConstants.OBJECT_ID);
    ...
    public MapList getFolderAllAccessDetails(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        String objectId = (String) programMap.get(LibraryCentralConstants.OBJECT_ID);
     ...
     *             if a major failure occurs
     */
    public MapList getFolderPersonAccessDetails(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        String objectId = (String) programMap.get(LibraryCentralConstants.OBJECT_ID);
     ...
     *             if a major failure occurs
     */
    public MapList getFolderRoleAccessDetails(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        String objectId = (String) programMap.get(LibraryCentralConstants.OBJECT_ID);
     ...
     *             if a major failure occurs
     */
    public MapList getFolderGroupAccessDetails(Context context, String[] args) throws Exception {
        Map programMap = (Map) JPO.unpackArgs(args);
        String objectId = (String) programMap.get(LibraryCentralConstants.OBJECT_ID);
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectList - List of All members Details
     * @return Vector with All the member Names
     * @throws Exception
     *             if a major failure occurs
     */
    public Vector getAccessMemberName(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: objectList - List of All members Details paramList - should have languageStr
     * @return Vector with All the member Types (Person/Role/Group)
     * @throws Exception
     *             if a major failure occurs
     */
    public Vector getAccessMemberType(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objList = (MapList) programMap.get("objectList");
        HashMap paramList = (HashMap) programMap.get("paramList");
        String languageStr = (String) paramList.get("languageStr");
     ...
     *             if a major failure occurs
     */
    public MapList getAccessMemberTypeIcon(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
     ...
     *             if a major failure occurs
     */
    public Vector getAccessMemberOrganization(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        MapList objList = (MapList) programMap.get("objectList");
        Vector columnVals = new Vector(objList.size());
        Iterator itr = objList.iterator();
     ...
     *             if a major failure occurs
     */
    public Vector getMemberAccess(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        HashMap paramList = (HashMap) programMap.get("paramList");
        String languageStr = (String) paramList.get("languageStr");
        MapList objList = (MapList) programMap.get("objectList");
     ...
     * @param args
     *            holds the following input arguments: requestMap - should have languageStr & accessChoice (e.g. Add,Add_Remove,Read..)
     * @return HashMap with the valid Access Choices
     * @throws Exception
     *             if a major failure occurs
     */
    public HashMap getAccessRangeValues(Context context, String[] args) throws Exception {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
     ...
     *            the eMatrix <code>Context</code> object
     * @param String
     *            access passed as comma separated values
    ...
    /**
     * This method is used to search the roles (in add Roles)/ groups( in add groups)based on given criteria
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: RequestValuesMap - should contain the following values LBCTopLevelCheckboxFilter - Top Level Roles LBCSublevelCheckBoxFilter - Sublevel Roles
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getRoleGroupSearchResults(Context context, String[] args) throws FrameworkException {
        try {
            Map programMap = (Map) JPO.unpackArgs(args);
     ...
     * @param objectId
     * @param namePattern
     *            - search criteria value for name field
     * @param sSubChecked
     ...
     *             if a major failure occurs
     */
    public MapList getAllRoleGroupList(Context context, String objectId, String namePattern, String sSubChecked, String sTopChecked, String sAction) throws Exception {
        Role role = null;
        Group group = null;
     ...
     *             if a major failure occurs
     */
    protected List getRoleNameList(RoleList rolesList) throws Exception {
     ...
     *             if a major failure occurs
     */
    protected List getGroupNameList(GroupList groupsList) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: parentOID - parentOID contextData - Will have the XML data of the newly Added or Removed Members
     * @return HashMap with Success/Error and the modified Data
     * @throws Exception
     *             if a major failure occurs
     */
    @com.matrixone.apps.framework.ui.ConnectionProgramCallable
    public HashMap inlineAddRemoveAccess(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: RequestMap - should have object id tableData - Will have the XML data of the newly Added or Removed Members
     * @return HashMap with Success/Error and the modified Data
     * @throws Exception
     *             if a major failure occurs
     */
    @com.matrixone.apps.framework.ui.PostProcessCallable
    public HashMap editMemberAccess(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - HashMap Containing following value paramMap - HashMap containing following values objectId - String containing Object Id of the Folder New Value - String containing
     *            GlobalReadAccess Field value (Allowed values : "true" or "false")
     * @throws Exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - HashMap Containing following value paramMap - HashMap containing following values objectId - String containing Object Id of the Folder New Value - String containing name of the new
     *            owner
     * @throws Exception
     *             if the operation fails
     */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            - HashMap Containing following value id - String containing Object Id of the Folder to be deleted
     * @throws Exception
     *             if the operation fails
     */
    public static String deleteObject(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            MapList folderContents = folderObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_SUBVAULTS + "," + DomainConstants.RELATIONSHIP_VAULTED_OBJECTS_REV2, "*", new StringList("id"),
                    null, false, true, new Short("1"), "", "", 0);
            if (folderContents.size() == 0) {
                ContextUtil.startTransaction(context, true);
                sendEventIconMail(context, LibraryCentralConstants.EVENT_FOLDER_REMOVED, objectId, "");
                MapList parentFolders = folderObj.getRelatedObjects(context, DomainConstants.RELATIONSHIP_SUBVAULTS, DomainConstants.TYPE_WORKSPACE_VAULT, new StringList("id"), null, true, false,
                        new Short("1"), "", "", 0);
    ...
    /**
     * Method to add/remove Organization as SOV with Read so all the users in the organization will have Read access on this folder as per Global Read access attribute
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param id
     *            - String containing Object Id of the Folder
     * @throws Exception
     *             if the operation fails
     */
