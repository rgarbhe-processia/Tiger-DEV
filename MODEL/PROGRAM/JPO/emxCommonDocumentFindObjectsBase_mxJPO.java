...
public class emxCommonDocumentFindObjectsBase_mxJPO {
     ...
     * @grade 0
     */
    public emxCommonDocumentFindObjectsBase_mxJPO(Context context, String[] args) throws Exception {
    ...
    public void getIds(Context context, int chunkSize) throws Exception {
        ...
        String command = "temp query bus '" + TYPE_DOCUMENTS + "' '*' '*'  vault '" + vaultList
                + "' limit 1 where 'program[emxCommonDocumentMigration -method writeOID ${OBJECTID} \"${TYPE}\"] == true'";
        String result = "";
