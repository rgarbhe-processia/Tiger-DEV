...
/**
 * The <code>emxAdminCache</code> class contains method for the "Collection" Common Component.
 * @version AEF 10.Next - Copyright (c) 2003, MatrixOne, Inc.
 */

public class emxAdminCache_mxJPO extends emxAdminCacheBase_mxJPO {
    ...
    public emxAdminCache_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
