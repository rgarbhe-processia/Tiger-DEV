...
/**
 * The <code>emxMemberRelationship</code> class represents the Member relationship JPO functionality for the AEF type.
...
public class emxCommonMemberRelationship_mxJPO extends emxCommonMemberRelationshipBase_mxJPO {
     ...
     * @grade 0
     */
    public emxCommonMemberRelationship_mxJPO(Context context, String[] args) throws Exception {
        super(context, args);
    }
}
