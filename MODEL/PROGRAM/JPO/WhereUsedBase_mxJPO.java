...
public class WhereUsedBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     * @param xmlFileDefinition
     *            - the name of the XML Definition program
        ...
        try {
            ...
            if (objectId != null && !objectId.isEmpty()) {
                ...
                if (xmlFileDefinition != null && !xmlFileDefinition.isEmpty()) {
                    mql.executeCommand(context, "print page '" + xmlFileDefinition + "' select content dump");
                } else {
                    mql.executeCommand(context, "print page '" + DEFAULT_FILE_DEFINITION + "' select content dump");
                }
                ...
                if (mql.getResult() != null && !mql.getResult().isEmpty()) {
                    ...
                    while (derivedType != null && !derivedType.isEmpty()) {
                        ...
                        derivedType = MqlUtil.mqlCommand(context, "print type '" + derivedType + "' select derived dump");
                    }
                    ...
                    for (Iterator iterator = derivedTypes.iterator(); iterator.hasNext();) {
     ...
     *            - the eMatrix Context object
     * @param args
     *            - Holds the HashMap containing the following arguments paramMap - contains ObjectId and dataType which are required for further processing.
    ...
    private MapList getWhereUsedHierarchial(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            if (objectId != null && !objectId.isEmpty()) {
                ...
                for (Iterator iterator = derivedTypeList.iterator(); iterator.hasNext();) {
                ...
                if (UIUtil.isNotNullAndNotEmpty(strRelPattern.toString())) {
                    ...
                    MapList tempMapList = domContextBus.getRelatedObjects(context, strRelPattern.toString(), // rel pattern
                            ...
                            "", // rel where clause
                            (short) 0, // limit
                            DomainObject.CHECK_HIDDEN, DomainObject.PREVENT_DUPLICATES, (short) DomainObject.PAGE_SIZE, null, null, null, DomainObject.EMPTY_STRING, "",
     ...
     *            - the eMatrix Context object
     * @param args
     *            - Holds the HashMap containing the following arguments paramMap - contains ObjectId
     * @return MapList - containing the WhereUsed objects Id
     * @throws Exception
     *             if the operation fails
     * @since R212
     ...
     * @param context
     * @param args
     *            contains a map whihc key value expandlevel
     * @return
     * @throws Exception
     */
    ...
    /**
     * process aand load XML data into the class variable whereUsedXMLMap ,LabelMethodMap which will be used to retrieved data from database. this method is used in to massage Hierarchialdata
     */
     ...
     *            -XML Doucment
     * @param strType
     *            - fromTypes corresponding to this type will be added to Set
     */
     ...
     *            -XML Doucment
     * @param strType
     *            - relationships corresponding to this type will be added to Set "relset"
     */
     ...
     *            - the eMatrix Context object
     * @param domainObject
     *            -> object for which we need teh derived types
     * @return List of
     * @throws Exception
     */
