...
public class emxSubscriptionUtilBase_mxJPO extends emxDomainObject_mxJPO {
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getPushSubscribersList(Context context, String[] args) throws Exception {
        // unpacking the Arguments from variable args
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        // Initializing the return type
        MapList subscribersList = new MapList();
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            contains a Map with the following entries: userName - a String of specified criteria user name lastName - a String of specified criteria last name firstName - a String of specified
     *            criteria first name orgId - a String of specified criteria Organization QueryLimit - a String of limit on the number of objects found
    ...
    public MapList getSubscriptionPersonSearchResult(Context context, String[] args) throws Exception {
        ...
        MapList mapList = DomainObject.findObjects(context, DomainConstants.TYPE_PERSON, strUserName, null, null, "*", strRelWhere, null, true, selectStmts, Short.parseShort(queryLimit));
     ...
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
    public MapList getPushSubscriptionPersonSearchResult(Context context, String[] args) throws Exception {
     ...
     *            the eMatrix <code>Context</code> object
     * @param xml
     *            - Document object containing the xml
     * @return HTML String
     * @throws Exception
     *             if the operation fails
     * @since AEF 10-7
     ...
     *            the eMatrix <code>Context</code> object
     * @param elmt
     *            - Element which is a section of the message
     ...
     *            the eMatrix <code>Context</code> object
     * @param headerInfo
     *            - Map containing information about the heading section
     * @param bodyInfo
     *            - Map containing information about the body section
     * @param footerInfo
     *            - Map containing information about the footer section
            ...
            while (i.hasNext()) {
                ...
                if (sectionInfo != null && sectionInfo.size() > 0) {
                    ...
                    while (ii.hasNext()) {
                        ...
                        setElementContent(context, value, valueText);
    ...
    /**
     * Gets all the notifications (Icon Mails) matching the criteria passed as the arguments. Icon mails are filterd based on Type Pattern (Type of the object attached), Event Pattern (Event that
     * generated this mail), From Date and To Date
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Type Pattern - Type pattern. To filter the icon mails based on the type of the objects attached. It accepts comma ',' separated type names
     *            e.g. "ECR,Part" and . '*' and '' to get all events. 1 - Event Pattern - Event pattern. To filter the icon mails based on the Events for which they are generated. It accepts comma ','
     *            separated type names e.g. "ECR,Part" and . '*' and '' to get all events. 2 - From Date - Date string, of format "MM/DD/YYYY" 3 - To Date - Date string, of format "MM/DD/YYYY" 4 -
     *            canDelete - String with true/false. true - Delete the added icon mails. False - Do not delete
    ...
    public MapList getTypeNotifications(Context context, String[] args) throws MatrixException {
        if (args.length < 5) {
            String errMsg = "";
            try {
                errMsg = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(context.getSession().getLanguage()),
                        "emxComponents.Common.GetNotificationWorongParameters");
            } catch (Exception e) {
    ...
    /**
     * Gets all the notifications (Icon Mails) matching the criteria passed as the arguments. Icon mails are filterd based on Object Id, Event Pattern (Event that generated this mail), From Date and
     * To Date
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Object Id - Type pattern. To filter the icon mails based on the object id attached. It accepts comma ',' separated type names e.g. "ECR,Part"
     *            and . '*' and '' to get all events. 1 - Event Pattern - Event pattern. To filter the icon mails based on the Events for which they are generated. It accepts comma ',' separated type
     *            names e.g. "ECR,Part" and . '*' and '' to get all events. 2 - From Date - Date string, of format "MM/DD/YYYY" 3 - To Date - Date string, of format "MM/DD/YYYY" 4 - canDelete - String
     *            with true/false. true - Delete the added icon mails. False - Do not delete
     * @returns MapList List of the map containing the information of the Iconmails
     * @throws MatrixException
     *             if the operation fails
     * @since Common vX2
    ...
    /**
     * Gets all the notifications (Icon Mails) matching the criteria passed as the arguments. Icon mails are filterd based on Type Pattern, Event Pattern, Start Date and End Date
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param typePatternOrOID
     *            - Type pattern or Object Id string. It accepts comma ',' separated type names e.g. "ECR,Part" and . '*' and '' to get all events (or) Object ID, this will be distinguished based on
     *            the forObject boolean argument.
     * @param eventPattern
     *            - Event pattern. To filter the icon mails based on the Events for which they are generated. It accepts comma ',' separated type names e.g. "Part Deleted,Part Revised" and . '*' and
     *            '' to get all events.
     * @param fromDate
     *            - Date string, of format "MM/DD/YYYY"
     * @param toDate
     *            - Date string, of format "MM/DD/YYYY"
     * @param canDelete
     *            - String argument that is true if user wants to delete the added icon mail, false if user doesnt want the added icon mail to be deleted
     * @param forObject
     *            - A boolena argument that desides whether typePatternOrOID argument contains type pattern or object id typePatternOrOID has Object Id if true typePatternOrOID has Type Pattern if
     *            false
     * @returns MapList List of the map containing the information of the Iconmails
     * @throws MatrixException
     *             if the operation fails
     ...
     *            false
     * @param idType
     *            - String contains Relationship or Object to identify the arg typePatternOrOID is Interface/Relationship or Type/Object
     * @returns MapList List of the map containing the information of the Iconmails
     * @throws MatrixException
     *             if the operation fails
     ...
     * @grade 0
     */
    public MapList getNotifications(Context context, String typePatternOrOID, String eventPattern, String fromDate, String toDate, String canDelete, boolean forObject, String idType)
            throws MatrixException {
        ...
        if (strEndDate != null && !"".equals(strEndDate.trim())) {
            try {
                ...
                if (endDate.compareTo(currentDate) > 0) {
                    ...
                    try {
                        errMsg = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(context.getSession().getLanguage()),
                                "emxComponents.Common.NotificationDateException");
                    } catch (Exception e) {
                        throw new MatrixException(e);
                    }
                    throw new MatrixException(errMsg);
        ...
        /*
         * As we are not capturing the time stamp, date will take 00 hrs time i.e. 06/07/2007 00:00:00 thats why we are incrementing date by 1 day and so that it will get all the notifications
         * generated before 06/08/2007 00:00:00 i.e. 06/07/2007 23:59:59
         */
                ...
                if (itrUserIconMail != null) {
                    ...
                    while (itrUserIconMail.hasNext()) {
                        try {
                            ...
                            /*
                             * check, if Icon mail subject matches the event pattern as subject contains Event Name and if it is sent between start date and end date
                             */
                            if (("*".equals(strEventPattern) || strEventPattern.indexOf(iconMailSubject) != -1) && (startDate == null || iconMailDate.compareTo(startDate) >= 0)
                                    && iconMailDate.compareTo(endDate) < 0) {
                                HashMap iconMailInfo = null;

                                /*
                                 * Validate if the incoming id is for object or relationship. if it is for relationship then we can't find the objects attached in IconMail. Get the rel id from the
                                ...
                                if (idType.equals(OBJECT)) {
                                        ...
                                        if (attachedBusObjList != null && attachedBusObjList.size() > 0) {
                                            ...
                                            if (itrAttachedBusObject != null) {
                                                while (itrAttachedBusObject.hasNext()) {
                                                    ...
                                                    if ("*".equals(strTypePatternOrOIDPattern) || (forObject && attachedObjetId.equals(strObjectId))
                                                            || (!forObject || strTypePattern.indexOf(attachedObjetType) != -1)) {
                                            ...
                                            /*
                                             * If an icon mail has attached bus object and is deleted from it then userIconMail.hasObjects() will retun true even though there are no objects remaining
                                             * in attachements. So the following boolean variable is used to handle such situations
                                             */
                                    ...
                                    if (strMessage.indexOf("relationshipID=") != -1) {
                                        ...
                                        if ("*".equals(strTypePatternOrOIDPattern) || (forObject && strRelId.equals(strObjectId))
                                                || (!forObject && (relName != null || !"".equals(relName)) && strTypePattern.indexOf(relName) != -1)) {
                            ...
                            if (iconMailAdded && "true".equalsIgnoreCase(canDelete)) {
                                ...
                                mqlQuery.append("delete mail ");
                                mqlQuery.append(iconMailNumber);
                                try {
                                    MqlUtil.mqlCommand(context, mqlQuery.toString());
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Type of the Object
    ...
    /**
     * Allows user to subscribe for a global event on a type. Creates subscription object model for the context user, i.e it creates Publish Subscribe object with symbolic name of the type passed as
     * its name and then creates and connects Event object to it and then Event object is connected to context user
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 Type 1 Event Name 2 Notification Type
     * @returns void
     * @throws MatrixException
     *             if the operation fails
     * @since Common vX2
    ...
    /**
     * Allows user to subscribe for a global event on a type of the object passed and if event is not global then subscribes on that particular object. Creates subscription object model for the
     * context user, i.e it creates Publish Subscribe object with symbolic name of the type passed as its name and then creates and connects Event object to it and then Event object is connected to
     * context user
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 Object id 1 Event Name 2 Notification Type
     * @returns void
     * @throws MatrixException
     *             if the operation fails
     * @since Common x+2
     ...
     *            the eMatrix <code>Context</code> object
     * @param typeOrObjId
     *            - Type or Object Id string. this will be distinguished based on the forObject boolean argument.
     * @param eventName
     *            - Event Name
     * @param notificationType
     *            - Notification Type
     * @param forObject
     *            - Used to determine if typeOrObjId contains Type or Object Id true - typeOrObjId is objectId false - typeOrObjId is type of the object
     * @returns void
     * @throws MatrixException
     *             if the operation fails
     * @since Common vX2
    ...
    /**
     * Delets global events subscription on the type or non global events on object Deletes the subscribed event for the context user, i.e disconnect the context user from the event and if the event
     * dont have any subscribers the delete the Event object
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 objectid of the Object 1 Event Name pattern 2 Type of the notification, which user wants to unsubscribe for. Notification Types are Email,
     *            IconMail, Both
     * @returns void
     * @throws MatrixException
     *             if the operation fails
    ...
    /**
     * Delets global events subscription on the type Deletes the subscribed event for the context user, i.e disconnect the context user from the event and if the event dont have any subscribers the
     ...
     *            - Notification Type
     * @param forObject
     *            - Used to determine if typeOrObjId contains Type or Object Id true - typeOrObjId has objectId false - typeOrObjId has type of the object
     * @param notificationType
     *            - Type of the notification, which user wants to unsubscribe for. Notification Types are Email, IconMail, Both
     * @returns void
     * @throws MatrixException
     *             if the operation fails
     * @since Common vX2
     * @deprecated for unSubscribeEvents use unSubscribeEvents method with idType <code>
     ...
     *            - Type of the notification, which user wants to unsubscribe for. Notification Types are Email, IconMail, Both
     * @param idType
     *            - String contains Relationship or Object to identify the arg typePatternOrOID is Relationship/Type or Object or Rel Id
     * @returns void
     * @throws MatrixException
     *             if the operation fails
     * @since Common V6R2009x
     ...
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param strPubSubObjId
     *            - Publish Subscribe object id
     * @param strEventPattern
     *            - Event pattern. To filter the icon mails based on the Events for which they are generated. It accepts comma ',' separated type names e.g. "Part Deleted,Part Revised" and . '*' and
     *            '' to get all events.
     * @param eventMenuCommands
     *            - Maplist containing event command information (A MapList returned by UIMenu.getMenu() method)
     * @param forObject
     *            - Used to determine whether to unsubscribe on type or object true - Unsubscribe on Object false - Unsubscribe on Type
     * @param notificationType
     *            - Type of the notification, which user wants to unsubscribe for. Notification Types are Email, IconMail, Both
     * @returns void
     * @throws MatrixException
     *             if the operation fails
     * @since Common vX2
     * @deprecated for delete subscriptions use <code>
     ...
     * </code>  this method will disconnect the event from Event object.
     */
    public void disconnectEvents(Context context, String strPubSubObjId, String strEventPattern, MapList eventMenuCommands, boolean forObject, String notificationType) throws MatrixException {
        ...
        MapList psEventList = objPubSub.getRelatedObjects(context, DomainConstants.RELATIONSHIP_PUBLISH, DomainConstants.TYPE_EVENT, selectStmts, null, false, true, (short) 1, whereClause.toString(),
                null, null, null, null);
        if (psEventList != null && psEventList.size() > 0) {
            ...
            while (itrEventList.hasNext()) {
                ...
                if (subscribersList != null) {
                    ...
                    if (notificationType == null || "null".equalsIgnoreCase(notificationType) || "".equalsIgnoreCase(notificationType.trim()) || both.equalsIgnoreCase(notificationType)
                            || personNotificationType.equalsIgnoreCase(notificationType)) {
                        /*
                         * following if-else block ensures that the person is disconnected from the event if it is delete subscription on type and the event is global or it is delete subscription on
                         * object
                         */
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 Type /ObjectId 1 User Name (optional)
     * @returns void
     * @throws MatrixException
     *             if the operation fails
     * @since Common vX2
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 Interface /ConnectionId 1 User Name (optional)
    ...
    /**
     * This method is called when userName is not specified(assumes Context user as the required user) This internally calls the overloaded method with context user as the user Parameter. Returns the
     * StringList of events and their notification types on a particular Type/Object for the specified User
     * @param context
     *            - the eMatrix <code>Context</code> object
     * @param userName
     *            - User who needs the list of events and notification Types
     * @param typeOrObjId
     *            - Type or Object Id whose subscribed events and Notifications are to be retrieved based on the user.
     * @returns StringList Containing the list of Events and their Notification Types
     * @since Common vX2
     * @deprecated Use <code>
    ...
    /**
     * This method is called when userName is not specified(assumes Context user as the required user) This internally calls the overloaded method with context user as the user Parameter. Returns the
     * StringList of events and their notification types on a particular Interface/Connection for the specified User
     * @param context
     *            - the eMatrix <code>Context</code> object
     * @param typeOrObjId
     *            - Interface or Connection Id whose subscribed events and Notifications are to be retrieved based on the user.
     * @returns StringList Containing the list of Events and their Notification Types
     * @since V6R2009x
     * @deprecated Interface related subscriptions are deprecated from V6R2011x, use Subscription on Relationships
     */
    ...
    /**
     * This method is called when user is explicitly specified. Returns the StringList of events and their notification types on a particular Type/Object for the specified User
     * @param context
     *            - the eMatrix <code>Context</code> object
     * @param userName
     *            - User who needs the list of events and notification Types
    ...
    protected StringList getSubscribedEventsAndNotificationTypes(Context context, String id, String userName, String idType) throws Exception {
        ...
        if (userName == null || "".equals(userName) || "*".equals(userName)) {
            ...
            if (!userName.equals(MqlUtil.mqlCommand(context, "list user '" + userName + "'", true))) {
                return finalList;
            }
        }
        ...
        if (!globalSubscription) {
            ...
            /*
             * For type level (global) subscriptions, get the list if publish subscribe Id's with the name that of the symbolic name of that Type and its Parent Types
             */
            ...
            while (id != null && !"".equals(id)) {
                ...
                id = MqlUtil.mqlCommand(context, "print " + adminObjType + " '" + id + "' select derived dump", true);
            }

            /**
             * When we add "a", "b" to list, list.toString returns the value as [a, b] using regular expression we are replacing ", " with "," After that deleting the char at first and last index
             */
            ...
            MapList objMapList = DomainObject.findObjects(context, DomainConstants.TYPE_PUBLISH_SUBSCRIBE, symbolicNamesPattern.toString(), "*", null, null, "revision == last", false,
                    slObjectSelects);
    ...
    protected StringList getFinalList(Context context, String pubSubObjId, String userName) throws Exception {
        ...
        try {
            ...
            eventsList = pubSubObject.getRelatedObjects(context, DomainConstants.RELATIONSHIP_PUBLISH, DomainConstants.TYPE_EVENT, selectlist, null, false, true, (short) 1, null, null, 0, null, null,
                    null);
        } catch (Exception e) {
            throw e;
        } finally {
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Interface Name associated with the Object
    ...
    /**
     * Gets all the notifications (Icon Mails) matching the criteria passed as the arguments. Icon mails are filterd based on Connection Id, Event Pattern (Event that generated this mail), From Date
     * and To Date
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Connection Id - To filter the icon mails based on the connection id attached. It accepts comma ',' separated type names e.g. "ECR,Part" and .
     *            '*' and '' to get all events. 1 - Event Pattern - Event pattern. To filter the icon mails based on the Events for which they are generated. It accepts comma ',' separated type names
     *            e.g. "ECR,Part" and . '*' and '' to get all events. 2 - From Date - Date string, of format "MM/DD/YYYY" 3 - To Date - Date string, of format "MM/DD/YYYY" 4 - canDelete - String with
     *            true/false. true - Delete the added icon mails. False - Do not delete
     * @returns MapList List of the map containing the information of the Iconmails
     * @throws MatrixException
     *             if the operation fails
     * @since Common V6R2009x
    ...
    /**
     * Gets all the notifications (Icon Mails) matching the criteria passed as the arguments. Icon mails are filterd based on Interface Name (interface name associated with the connection id), Event
     * Pattern (Event that generated this mail), From Date and To Date
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Interface name- Interface. To filter the icon mails based on the type of interface associated with connection id. It accepts comma ','
     *            separated type names e.g. "InterfaceI1,Interface I2" and . '*' and '' to get all events. 1 - Event Pattern - Event pattern. To filter the icon mails based on the Events for which
     *            they are generated. It accepts comma ',' separated type names e.g. "Attribute Modified,Modify Description" and . '*' and '' to get all events. 2 - From Date - Date string, of format
     *            "MM/DD/YYYY" 3 - To Date - Date string, of format "MM/DD/YYYY" 4 - canDelete - String with true/false. true - Delete the added icon mails. False - Do not delete
     * @returns MapList List of the map containing the information of the Iconmails
     * @throws MatrixException
     *             if the operation fails
     * @since Common V6R2009x
    ...
    /**
     * Delets events subscription on the connection id Deletes the subscribed event for the context user, i.e disconnect the context user from the event and if the event dont have any subscribers the
     * delete the Event object
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 connection id 1 Event Name pattern 2 Type of the notification, which user wants to unsubscribe for. Notification Types are Email, IconMail,
     *            Both
     * @returns void
     * @throws MatrixException
     *             if the operation fails
    ...
    /**
     * Delets global events subscription for the interface passed Deletes the subscribed event for the context user, i.e disconnect the context user from the event and if the event dont have any
     * subscribers the delete the Event object
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 interface name 1 Event Name Pattern 2 Type of the notification, which user wants to unsubscribe for. Notification Types are Email, IconMail,
     *            Both
     * @returns void
     * @throws MatrixException
     *             if the operation fails
    ...
    /**
     * Allows user to subscribe for a particular relationship instance (connection id) passed and subscribe notification particular interface associated with that instance. Creates subscription object
     * model for the context user, i.e it creates Publish Subscribe object with auto generated name and then creates and connects Event object to it and then Event object is connected to context user
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 Connection id 1 Event Name 2 Notification Type
     * @returns void
     * @throws MatrixException
     *             if the operation fails
     * @since Common V6R2009x
    ...
    /**
     * Allows user to subscribe for a global event on a interface. Creates subscription object model for the context user, i.e it creates Publish Subscribe object with symbolic name of the interface
     * passed as its name and then creates and connects Event object to it and then Event object is connected to context user
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 Interface name 1 Event Name 2 Notification Type
     * @returns void
     * @throws MatrixException
     *             if the operation fails
     * @since Common V6R2009x
     ...
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param interfaceOrConnectionId
     *            - Interface name or Object Id string. this will be distinguished based on the forInterfaceInstance boolean argument.
     * @param eventName
     *            - Event Name
     * @param notificationType
     *            - Notification Type
     * @param forInterfaceInstance
     *            - Used to determine if interfaceOrConnectionId contains Interface or Object Id true - interfaceOrConnectionId is objectId false - interfaceOrConnectionId is interface name.
     * @returns void
     * @throws MatrixException
     *             if the operation fails
     * @since Common V6R2009x
    ...
    public void createSubscriptionOnInterface(Context context, String interfaceOrConnectionId, String eventName, String notificationType, boolean forInterfaceInstance) throws MatrixException {
        ...
        try {
            if (commandMap != null) {
                if (forInterfaceInstance) {
                    /*
                     * if it is subscription on Inteface Instance then continue with the existing subscription functionality i.e Subscribe for an event on the object passed as argument, but not on
                     * interface
                     */
                    ...
                    if ("true".equalsIgnoreCase(settingGlobal)) {
                        ...
                        if (pubSubObjList.size() == 0) {
                            ...
                            try {
                                ...
                                psEventList = objPubSub.getRelatedObjects(context, DomainConstants.RELATIONSHIP_PUBLISH, DomainConstants.TYPE_EVENT, selectStmts, null, false, true, (short) 1,
                                        whereclause, null);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                            ...
                            if (isEvtNew) {
                                ...
                                MapList personList = boEvent.getRelatedObjects(context, DomainConstants.RELATIONSHIP_SUBSCRIBED_PERSON, DomainConstants.TYPE_PERSON, null, selects, false, true,
                                        (short) 1, strwhere, null);
    ...
    /**
     * Method will gets invoked when pub sub object gets created. Used to udpate the cache variable if it contains any of the child type name.
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 Pub Sub object id 1 Pub Sub object name
     * @returns void
     * @throws Exception
     *             if the operation fails
     * @since Common V6R2009x
     ...
     *            - whether to create global subscription or object/connection level subscription
     * @param id
     *            - if globalSubscription pass admin object name(i.e. business type/relationship name e.g. "Part") otherwise pass object id or rel id
     * @param idType
     *            - Whether creating subscription for business type/ business object/relationship type/relationship connection Pass 'Object' if creating global subscription for business type or
     *            creating object level subscription Pass 'Relationship' if creating global subscription for relationship or creating connection level subscription
     * @param eventType
     *            - Event Type for which subscription need to be created for the user
     * @param notificationType
     *            - Notification Type, valid values are Both, IconMail, Email Takes the default value Both, if it is null or invalid value is passed.
     * @returns void
     * @throws MatrixException
     *             if the operation fails
     */
    ...
    /**
     * This method used to get the entire events list that can be subscribed by the context user on the given relationship. args[0] -> Relationship Id - Mandatory
     * @param context
     * @param args
     * @return
     * @throws Exception
    ...
    public MapList getRelationshipSubscribableEvents(Context context, String[] args) throws Exception {
        if (args == null || args[0] == null || "".equals(args[0])) {
            throw new Exception(EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", new Locale(context.getSession().getLanguage()),
                    "emxComponents.Subscription.EventsList.Relationship.WrongParameters"));
        }
    ...
    /**
     * This method is used to create subscription for an event on a relationship instance/ relationship type (for context user). Whenever the event occurs on that relationship instance/relationship
     * type, system sends notifications to the user. args[0] -> Relationship Id or Relationship type - Mandatory args[1] -> Boolean to indicate whether creating subscription for relationship instance/
     * relationship type - Mandatory ( true for relationship type and false for relationship instance) args[2] -> Event Type - Mandatory args[3] -> Notification Type - Optional (default it takes Both
     * as notification type, if no value is passed or invalid notification type is passed).
     * @param context
     * @param args
     * @throws Exception
     *             if Arguments are not passed properly Invalid relationship id/name is given Event (that is passed in ) is not configured on Relation (or its hierarchy)
     */
    ...
    /**
     * Delete subscriptions created by the context user on the connection (instance of this relationship) for passed in events. args[0] -> Rel id / Relationship Name - Mandatory args[1] -> Boolean to
     * indicate whether creating deleting subscription for relationship instance/ relationship type - Mandatory ( true for relationship type and false for relationship instance) args[2] -> Event Type
     * Pattern - Mandatory Get all the matching events (for passed in Event Pattern) and removes the subscription if user has subscribed for that event. We can pass multiple events with a comma
     * separated value e.g. Part Deleted, Part Revised you can pass "Part*" or "*" args[3] -> Notification Type - Optional (default it takes Both as notification type, if no value is passed or invalid
     * notification type is passed). Notification Type passed is null or Both - Context user is unsubscribed for both the notification types and disconnected from Event Object Notification Type passed
     * is Email - o If context user has subscribed for only Email then the context user is unsubscribed for Email notification type and disconnected from the Event Object o If context user has
     * subscribed for Both the types then the context user is unsubscribed for Email notification type and updates the notification type i.e. Notification Type attribute on the Subscribed Person with
     * IconMail o If context user has subscribed for only IconMail , (just returns without doing any change for this Subscription). Notification Type passed is IconMail - o If context user has
     * subscribed for only IconMail then the context user is unsubscribed for IconMail notification type and disconnected from the Event Object o If context user has subscribed for Both the types then
     * the context user is unsubscribed for IconMail notification type and updates the notification type i.e. Notification Type attribute on the Subscribed Person with Email o If context user has
     * subscribed for only Email , (just returns without doing any change for this Subscription).
     * @param context
     * @param args
     * @throws Exception
     *             if If arguments length is not proper If invalid rel id/rel name is passed.
     */
    ...
    /**
     * Get all the notifications (Icon Mails) matching the criteria passed as the arguments, Icon mails are filtered based on rel Id, Event Pattern (Event that generated this mail), From Date and To
     * Date args[0] -> Rel Id /Rel Name - Mandatory, If not provided method will raise an exception, just pass empty string like "" if result is not to be constrained on the connection id. args[1] ->
     * Boolean to indicate whether creating subscription getting notifications for relationship instance/ relationship type - Mandatory ( true for relationship type and false for relationship
     * instance) args[2] -> Event Name Pattern - Mandatory, If not provided method will raise exception. It accepts comma "," separated event names e.g. "Attribute Modified,Modify Description" "*" and
     * "" to get all events args[3] -> Start Date - Mandatory, If not provided method will raise exception, just pass empty string i.e. "" if result is not to be constrained on the start date. Date
     * Format must be MM/DD/YYYY args[4] -> End Date - Mandatory, If not provided method will raise exception just pass empty string i.e. "" if result is not to be constrained on the end date, If
     * empty string is passed then current date is taken as end date. Date Format must be MM/DD/YYYY args[5] -> can Delete - string with true/false should be passed. If true delete the icon mails.
     * @param context
     * @param args
     * @return
     * @throws Exception
     ...
     *            the eMatrix <code>Context</code> object
     * @param args
     *            holds the following input arguments: 0 - Relationship Name or Rel Id
     * @returns MapList - List of the Maps containing the information of all the commands configured on the interface
     * @throws MatrixException
     *             if the operation fails
     * @since V6R2009x
        ...
        for (Iterator objectListItr = objectList.iterator(); objectListItr.hasNext();) {
            ...
            if ((isExportFormat || isPrinterFriendly) && !columnName.equals("newWindow")) {
                ...
                if (columnName.equals("newWindow")) {
                    ...
                    treeUrl = "<a href=\"" + buffer.toString() + "\" target=\"content\" ><img src=\"images/" + typeIcon + "\" border=\"0\"/>" + XSSUtil.encodeForXML(context, name) + "</a>";
                }
            }
