...
proc pAnalyzeAttribute {} {
   ...
   if {$bOverlay} {
         pOverlay [list 2 4 6 8 9 10 11 15]
   ...
   if {$bAdd} {
	  ...
	  if {$sMxVersion > 2010.1} {
	     if {$aCol(11) > 0} {
			...
			if { $aCol(4) == "binary" } {
				if { $aCol(2) == "" && $aCol(3) == "" } {					
					pMqlCmd "escape add attr \042$aCol(0)\042 type $aCol(4) default \042$aCol(6)\042 maxlength $aCol(11) $aCol(12) $aCol(13) $sHidden"
				} else {
					pMqlCmd "escape add attr \042$aCol(0)\042 type $aCol(4) default \042$aCol(6)\042 maxlength $aCol(11) $aCol(12) $aCol(13) $sHidden owner $aCol(2) \042$aCol(3)\042"
				}
			} else {
				if { $aCol(2) == "" && $aCol(3) == "" } {					
					pMqlCmd "escape add attr \042$aCol(0)\042 type $aCol(4) default \042$aCol(6)\042 maxlength $aCol(11) $aCol(8) $aCol(12) $aCol(13) $sHidden"
				} else {
					pMqlCmd "escape add attr \042$aCol(0)\042 type $aCol(4) default \042$aCol(6)\042 maxlength $aCol(11) $aCol(8) $aCol(12) $aCol(13) $sHidden owner $aCol(2) \042$aCol(3)\042"						
				}
			}			
		 } else {
			if { $aCol(4) == "binary" } {
				if { $aCol(2) == "" && $aCol(3) == "" } {					
					pMqlCmd "escape add attr \042$aCol(0)\042 type $aCol(4) default \042$aCol(6)\042 $aCol(12) $aCol(13) $sHidden"
				} else {
					pMqlCmd "escape add attr \042$aCol(0)\042 type $aCol(4) default \042$aCol(6)\042 $aCol(12) $aCol(13) $sHidden owner $aCol(2) \042$aCol(3)\042"						
				}
			} else {
				if { $aCol(2) == "" && $aCol(3) == "" } {					
					pMqlCmd "escape add attr \042$aCol(0)\042 type $aCol(4) default \042$aCol(6)\042 $aCol(8) $aCol(12) $aCol(13) $sHidden"
				} else {
					pMqlCmd "escape add attr \042$aCol(0)\042 type $aCol(4) default \042$aCol(6)\042 $aCol(8) $aCol(12) $aCol(13) $sHidden owner $aCol(2) \042$aCol(3)\042"						
				}
			}
